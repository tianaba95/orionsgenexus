/*
               File: alm_tipo_almacenalm_tipo_movimientowc_impl
        Description: ALM_TIPO_ALMACENALM_TIPO_MOVIMIENTOWC
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:16:37.69
...
public final  class alm_tipo_almacenalm_tipo_movimientowc_impl extends GXWebComponent
{
   public alm_tipo_almacenalm_tipo_movimientowc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public alm_tipo_almacenalm_tipo_movimientowc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( alm_tipo_almacenalm_tipo_movimientowc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV7Tpmo_AlmacenOrigenId = GXutil.lval( httpContext.GetNextPar( )) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Tpmo_AlmacenOrigenId", GXutil.ltrim( GXutil.str( AV7Tpmo_AlmacenOrigenId, 11, 0)));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,new Long(AV7Tpmo_AlmacenOrigenId)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Tpmo_AlmacenOrigenId, AV12Update, AV13Delete, A38Tpmo_Codigo, A33Tipo_Codigo, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "ALM_TIPO_ALMACENALM_TIPO_MOVIMIENTOWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414163777");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.alm_tipo_almacenalm_tipo_movimientowc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Tpmo_AlmacenOrigenId,11,0)))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV7Tpmo_AlmacenOrigenId", GXutil.ltrim( localUtil.ntoc( wcpOAV7Tpmo_AlmacenOrigenId, (byte)(11), (byte)(0), ",", "")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vTPMO_ALMACENORIGENID", GXutil.ltrim( localUtil.ntoc( AV7Tpmo_AlmacenOrigenId, (byte)(11), (byte)(0), ",", "")));
   ...
   public void renderHtmlCloseForm4V2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("alm_tipo_almacenalm_tipo_movimientowc.js", "?201861414163779");
      }
   ...
   {
      return "ALM_TIPO_ALMACENALM_TIPO_MOVIMIENTOWC" ;
   }
   ...
   public void wb4V0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.alm_tipo_almacenalm_tipo_movimientowc");
         }
         /* Div Control */
   ...
   public void start4V2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "ALM_TIPO_ALMACENALM_TIPO_MOVIMIENTOWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TPMO_ALMACENDESTINOID", GXutil.ltrim( localUtil.ntoc( A40Tpmo_AlmacenDestinoId, (byte)(11), (byte)(0), ".", "")));
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "ALM_TIPO_ALMACENALM_TIPO_MOVIMIENTOWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf4V2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H004V2 */
         pr_default.execute(0, new Object[] {new Long(AV7Tpmo_AlmacenOrigenId), new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_20_idx = (short)(1) ;
         sGXsfl_20_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_20_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_202( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A39Tpmo_AlmacenOrigenId = H004V2_A39Tpmo_AlmacenOrigenId[0] ;
            ...
            A718Tmpo_ImprimeResponsable = H004V2_A718Tmpo_ImprimeResponsable[0] ;
            n718Tmpo_ImprimeResponsable = H004V2_n718Tmpo_ImprimeResponsable[0] ;
            A717Tpmo_ImprimeDestino = H004V2_A717Tpmo_ImprimeDestino[0] ;
            n717Tpmo_ImprimeDestino = H004V2_n717Tpmo_ImprimeDestino[0] ;
            A716Tpmo_ImprimeOrigen = H004V2_A716Tpmo_ImprimeOrigen[0] ;
            n716Tpmo_ImprimeOrigen = H004V2_n716Tpmo_ImprimeOrigen[0] ;
            A706Tpmo_SolicitaCentroDestino = H004V2_A706Tpmo_SolicitaCentroDestino[0] ;
            n706Tpmo_SolicitaCentroDestino = H004V2_n706Tpmo_SolicitaCentroDestino[0] ;
            A705Tpmo_SolicitaRegionDestino = H004V2_A705Tpmo_SolicitaRegionDestino[0] ;
            n705Tpmo_SolicitaRegionDestino = H004V2_n705Tpmo_SolicitaRegionDestino[0] ;
            A680Tpmo_CuentaResponsabilidad = H004V2_A680Tpmo_CuentaResponsabilidad[0] ;
            n680Tpmo_CuentaResponsabilidad = H004V2_n680Tpmo_CuentaResponsabilidad[0] ;
            A679Tpmo_Estado = H004V2_A679Tpmo_Estado[0] ;
            n679Tpmo_Estado = H004V2_n679Tpmo_Estado[0] ;
            A641Tpmo_VidaUtil = H004V2_A641Tpmo_VidaUtil[0] ;
            n641Tpmo_VidaUtil = H004V2_n641Tpmo_VidaUtil[0] ;
            A633Tpmo_Controlado = H004V2_A633Tpmo_Controlado[0] ;
            n633Tpmo_Controlado = H004V2_n633Tpmo_Controlado[0] ;
            A595Tpmo_ConsecutivoTrans = H004V2_A595Tpmo_ConsecutivoTrans[0] ;
            n595Tpmo_ConsecutivoTrans = H004V2_n595Tpmo_ConsecutivoTrans[0] ;
            A480Tipo_Tipo = H004V2_A480Tipo_Tipo[0] ;
            A441Tpmo_IngresaCurso = H004V2_A441Tpmo_IngresaCurso[0] ;
            A440Tpmo_IngresaAredante = H004V2_A440Tpmo_IngresaAredante[0] ;
            A316Tpmo_Modulo = H004V2_A316Tpmo_Modulo[0] ;
            A320Tpmo_FechaModifica = H004V2_A320Tpmo_FechaModifica[0] ;
            n320Tpmo_FechaModifica = H004V2_n320Tpmo_FechaModifica[0] ;
            A319Tpmo_UsuarioModifica = H004V2_A319Tpmo_UsuarioModifica[0] ;
            n319Tpmo_UsuarioModifica = H004V2_n319Tpmo_UsuarioModifica[0] ;
            A318Tpmo_FechaCrea = H004V2_A318Tpmo_FechaCrea[0] ;
            A317Tpmo_UsuarioCrea = H004V2_A317Tpmo_UsuarioCrea[0] ;
            A315Tpmo_TipoE_S = H004V2_A315Tpmo_TipoE_S[0] ;
            A314Tpmo_AlmacenDestinoDescrip = H004V2_A314Tpmo_AlmacenDestinoDescrip[0] ;
            n314Tpmo_AlmacenDestinoDescrip = H004V2_n314Tpmo_AlmacenDestinoDescrip[0] ;
            A40Tpmo_AlmacenDestinoId = H004V2_A40Tpmo_AlmacenDestinoId[0] ;
            A253Tipo_Descripcion = H004V2_A253Tipo_Descripcion[0] ;
            A33Tipo_Codigo = H004V2_A33Tipo_Codigo[0] ;
            A313Tpmo_Descripcion = H004V2_A313Tpmo_Descripcion[0] ;
            A38Tpmo_Codigo = H004V2_A38Tpmo_Codigo[0] ;
            A314Tpmo_AlmacenDestinoDescrip = H004V2_A314Tpmo_AlmacenDestinoDescrip[0] ;
            n314Tpmo_AlmacenDestinoDescrip = H004V2_n314Tpmo_AlmacenDestinoDescrip[0] ;
            A480Tipo_Tipo = H004V2_A480Tipo_Tipo[0] ;
            A253Tipo_Descripcion = H004V2_A253Tipo_Descripcion[0] ;
   ...
   {
      /* Using cursor H004V3 */
      pr_default.execute(1, new Object[] {new Long(AV7Tpmo_AlmacenOrigenId)});
   ...
   public void strup4V0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV7Tpmo_AlmacenOrigenId = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV7Tpmo_AlmacenOrigenId"), ",", ".") ;
   ...
   public void e124V2( )
   {
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext, !bGXsfl_20_Refreshing);
      edtTpmo_AlmacenOrigenId_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtTpmo_AlmacenOrigenId_Internalname, "Visible", GXutil.ltrim( GXutil.str( edtTpmo_AlmacenOrigenId_Visible, 5, 0)), true);
   ...
   public void S112( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributename( "Tpmo_AlmacenOrigenId" );
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( GXutil.str( AV7Tpmo_AlmacenOrigenId, 11, 0) );
   ...
   {
      AV7Tpmo_AlmacenOrigenId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Tpmo_AlmacenOrigenId", GXutil.ltrim( GXutil.str( AV7Tpmo_AlmacenOrigenId, 11, 0)));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV7Tpmo_AlmacenOrigenId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "alm_tipo_almacenalm_tipo_movimientowc");
      ...
      {
         AV7Tpmo_AlmacenOrigenId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Tpmo_AlmacenOrigenId", GXutil.ltrim( GXutil.str( AV7Tpmo_AlmacenOrigenId, 11, 0)));
      }
      wcpOAV7Tpmo_AlmacenOrigenId = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV7Tpmo_AlmacenOrigenId"), ",", ".") ;
      if ( ! GetJustCreated( ) && ( ( AV7Tpmo_AlmacenOrigenId != wcpOAV7Tpmo_AlmacenOrigenId ) ) )
      {
         setjustcreated();
      }
      wcpOAV7Tpmo_AlmacenOrigenId = AV7Tpmo_AlmacenOrigenId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV7Tpmo_AlmacenOrigenId = httpContext.cgiGet( sPrefix+"AV7Tpmo_AlmacenOrigenId_CTRL") ;
      if ( GXutil.len( sCtrlAV7Tpmo_AlmacenOrigenId) > 0 )
      {
         AV7Tpmo_AlmacenOrigenId = localUtil.ctol( httpContext.cgiGet( sCtrlAV7Tpmo_AlmacenOrigenId), ",", ".") ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Tpmo_AlmacenOrigenId", GXutil.ltrim( GXutil.str( AV7Tpmo_AlmacenOrigenId, 11, 0)));
      }
      else
      {
         AV7Tpmo_AlmacenOrigenId = localUtil.ctol( httpContext.cgiGet( sPrefix+"AV7Tpmo_AlmacenOrigenId_PARM"), ",", ".") ;
      }
   }
   ...
   {
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Tpmo_AlmacenOrigenId_PARM", GXutil.ltrim( localUtil.ntoc( AV7Tpmo_AlmacenOrigenId, (byte)(11), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV7Tpmo_AlmacenOrigenId)) > 0 )
      {
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Tpmo_AlmacenOrigenId_CTRL", GXutil.rtrim( sCtrlAV7Tpmo_AlmacenOrigenId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414163869");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("alm_tipo_almacenalm_tipo_movimientowc.js", "?201861414163869");
      }
   ...
   public void sendrow_202( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TPMO_ALMACENDESTINOID"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, localUtil.format( DecimalUtil.doubleToDec(A40Tpmo_AlmacenDestinoId), "ZZZZZZZZZZ9")));
   ...
   public void initialize_properties( )
   {
      ...
      edtTpmo_AlmacenOrigenId_Visible = 1 ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Tpmo_AlmacenOrigenId',fld:'vTPMO_ALMACENORIGENID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV12Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV13Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A38Tpmo_Codigo',fld:'TPMO_CODIGO',pic:'',hsh:true,nv:''},{av:'A33Tipo_Codigo',fld:'TIPO_CODIGO',pic:'ZZZZZZZZZZZZZZZZZ9',hsh:true,nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e134V2',iparms:[{av:'A38Tpmo_Codigo',fld:'TPMO_CODIGO',pic:'',hsh:true,nv:''},{av:'A33Tipo_Codigo',fld:'TIPO_CODIGO',pic:'ZZZZZZZZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtTpmo_Descripcion_Link',ctrl:'TPMO_DESCRIPCION',prop:'Link'},{av:'edtTipo_Descripcion_Link',ctrl:'TIPO_DESCRIPCION',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e114V2',iparms:[{av:'A38Tpmo_Codigo',fld:'TPMO_CODIGO',pic:'',hsh:true,nv:''}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H004V2_A39Tpmo_AlmacenOrigenId = new long[1] ;
      H004V2_A718Tmpo_ImprimeResponsable = new String[] {""} ;
      H004V2_n718Tmpo_ImprimeResponsable = new boolean[] {false} ;
      H004V2_A717Tpmo_ImprimeDestino = new String[] {""} ;
      H004V2_n717Tpmo_ImprimeDestino = new boolean[] {false} ;
      H004V2_A716Tpmo_ImprimeOrigen = new String[] {""} ;
      H004V2_n716Tpmo_ImprimeOrigen = new boolean[] {false} ;
      H004V2_A706Tpmo_SolicitaCentroDestino = new String[] {""} ;
      H004V2_n706Tpmo_SolicitaCentroDestino = new boolean[] {false} ;
      H004V2_A705Tpmo_SolicitaRegionDestino = new String[] {""} ;
      H004V2_n705Tpmo_SolicitaRegionDestino = new boolean[] {false} ;
      H004V2_A680Tpmo_CuentaResponsabilidad = new String[] {""} ;
      H004V2_n680Tpmo_CuentaResponsabilidad = new boolean[] {false} ;
      H004V2_A679Tpmo_Estado = new String[] {""} ;
      H004V2_n679Tpmo_Estado = new boolean[] {false} ;
      H004V2_A641Tpmo_VidaUtil = new String[] {""} ;
      H004V2_n641Tpmo_VidaUtil = new boolean[] {false} ;
      H004V2_A633Tpmo_Controlado = new String[] {""} ;
      H004V2_n633Tpmo_Controlado = new boolean[] {false} ;
      H004V2_A595Tpmo_ConsecutivoTrans = new long[1] ;
      H004V2_n595Tpmo_ConsecutivoTrans = new boolean[] {false} ;
      H004V2_A480Tipo_Tipo = new String[] {""} ;
      H004V2_A441Tpmo_IngresaCurso = new String[] {""} ;
      H004V2_A440Tpmo_IngresaAredante = new String[] {""} ;
      H004V2_A316Tpmo_Modulo = new String[] {""} ;
      H004V2_A320Tpmo_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H004V2_n320Tpmo_FechaModifica = new boolean[] {false} ;
      H004V2_A319Tpmo_UsuarioModifica = new String[] {""} ;
      H004V2_n319Tpmo_UsuarioModifica = new boolean[] {false} ;
      H004V2_A318Tpmo_FechaCrea = new java.util.Date[] {GXutil.nullDate()} ;
      H004V2_A317Tpmo_UsuarioCrea = new String[] {""} ;
      H004V2_A315Tpmo_TipoE_S = new String[] {""} ;
      H004V2_A314Tpmo_AlmacenDestinoDescrip = new String[] {""} ;
      H004V2_n314Tpmo_AlmacenDestinoDescrip = new boolean[] {false} ;
      H004V2_A40Tpmo_AlmacenDestinoId = new long[1] ;
      H004V2_A253Tipo_Descripcion = new String[] {""} ;
      H004V2_A33Tipo_Codigo = new long[1] ;
      H004V2_A313Tpmo_Descripcion = new String[] {""} ;
      H004V2_A38Tpmo_Codigo = new String[] {""} ;
      ...
      sCtrlAV7Tpmo_AlmacenOrigenId = "" ;
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.alm_tipo_almacenalm_tipo_movimientowc__default(),
         new Object[] {
             new Object[] {
            H004V2_A39Tpmo_AlmacenOrigenId, H004V2_A718Tmpo_ImprimeResponsable, H004V2_n718Tmpo_ImprimeResponsable, H004V2_A717Tpmo_ImprimeDestino, H004V2_n717Tpmo_ImprimeDestino, H004V2_A716Tpmo_ImprimeOrigen, H004V2_n716Tpmo_ImprimeOrigen, H004V2_A706Tpmo_SolicitaCentroDestino, H004V2_n706Tpmo_SolicitaCentroDestino, H004V2_A705Tpmo_SolicitaRegionDestino,
            H004V2_n705Tpmo_SolicitaRegionDestino, H004V2_A680Tpmo_CuentaResponsabilidad, H004V2_n680Tpmo_CuentaResponsabilidad, H004V2_A679Tpmo_Estado, H004V2_n679Tpmo_Estado, H004V2_A641Tpmo_VidaUtil, H004V2_n641Tpmo_VidaUtil, H004V2_A633Tpmo_Controlado, H004V2_n633Tpmo_Controlado, H004V2_A595Tpmo_ConsecutivoTrans,
            H004V2_n595Tpmo_ConsecutivoTrans, H004V2_A480Tipo_Tipo, H004V2_A441Tpmo_IngresaCurso, H004V2_A440Tpmo_IngresaAredante, H004V2_A316Tpmo_Modulo, H004V2_A320Tpmo_FechaModifica, H004V2_n320Tpmo_FechaModifica, H004V2_A319Tpmo_UsuarioModifica, H004V2_n319Tpmo_UsuarioModifica, H004V2_A318Tpmo_FechaCrea,
            H004V2_A317Tpmo_UsuarioCrea, H004V2_A315Tpmo_TipoE_S, H004V2_A314Tpmo_AlmacenDestinoDescrip, H004V2_n314Tpmo_AlmacenDestinoDescrip, H004V2_A40Tpmo_AlmacenDestinoId, H004V2_A253Tipo_Descripcion, H004V2_A33Tipo_Codigo, H004V2_A313Tpmo_Descripcion, H004V2_A38Tpmo_Codigo
            }
            , new Object[] {
   ...
   private int edtTpmo_AlmacenOrigenId_Visible ;
   private int subGrid_Islastpage ;
   private int GXPagingFrom2 ;
   private int GXPagingTo2 ;
   private int idxLst ;
   private int subGrid_Backcolor ;
   private long wcpOAV7Tpmo_AlmacenOrigenId ;
   private long AV7Tpmo_AlmacenOrigenId ;
   ...
   private String sCtrlAV7Tpmo_AlmacenOrigenId ;
   ...
   private long[] H004V2_A39Tpmo_AlmacenOrigenId ;
   private String[] H004V2_A718Tmpo_ImprimeResponsable ;
   private boolean[] H004V2_n718Tmpo_ImprimeResponsable ;
   private String[] H004V2_A717Tpmo_ImprimeDestino ;
   private boolean[] H004V2_n717Tpmo_ImprimeDestino ;
   private String[] H004V2_A716Tpmo_ImprimeOrigen ;
   private boolean[] H004V2_n716Tpmo_ImprimeOrigen ;
   private String[] H004V2_A706Tpmo_SolicitaCentroDestino ;
   private boolean[] H004V2_n706Tpmo_SolicitaCentroDestino ;
   private String[] H004V2_A705Tpmo_SolicitaRegionDestino ;
   private boolean[] H004V2_n705Tpmo_SolicitaRegionDestino ;
   private String[] H004V2_A680Tpmo_CuentaResponsabilidad ;
   private boolean[] H004V2_n680Tpmo_CuentaResponsabilidad ;
   private String[] H004V2_A679Tpmo_Estado ;
   private boolean[] H004V2_n679Tpmo_Estado ;
   private String[] H004V2_A641Tpmo_VidaUtil ;
   private boolean[] H004V2_n641Tpmo_VidaUtil ;
   private String[] H004V2_A633Tpmo_Controlado ;
   private boolean[] H004V2_n633Tpmo_Controlado ;
   private long[] H004V2_A595Tpmo_ConsecutivoTrans ;
   private boolean[] H004V2_n595Tpmo_ConsecutivoTrans ;
   private String[] H004V2_A480Tipo_Tipo ;
   private String[] H004V2_A441Tpmo_IngresaCurso ;
   private String[] H004V2_A440Tpmo_IngresaAredante ;
   private String[] H004V2_A316Tpmo_Modulo ;
   private java.util.Date[] H004V2_A320Tpmo_FechaModifica ;
   private boolean[] H004V2_n320Tpmo_FechaModifica ;
   private String[] H004V2_A319Tpmo_UsuarioModifica ;
   private boolean[] H004V2_n319Tpmo_UsuarioModifica ;
   private java.util.Date[] H004V2_A318Tpmo_FechaCrea ;
   private String[] H004V2_A317Tpmo_UsuarioCrea ;
   private String[] H004V2_A315Tpmo_TipoE_S ;
   private String[] H004V2_A314Tpmo_AlmacenDestinoDescrip ;
   private boolean[] H004V2_n314Tpmo_AlmacenDestinoDescrip ;
   private long[] H004V2_A40Tpmo_AlmacenDestinoId ;
   private String[] H004V2_A253Tipo_Descripcion ;
   private long[] H004V2_A33Tipo_Codigo ;
   private String[] H004V2_A313Tpmo_Descripcion ;
   private String[] H004V2_A38Tpmo_Codigo ;
...
final  class alm_tipo_almacenalm_tipo_movimientowc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H004V2", "SELECT T1.Tpmo_AlmacenOrigenId, T1.Tmpo_ImprimeResponsable, T1.Tpmo_ImprimeDestino, T1.Tpmo_ImprimeOrigen, T1.Tpmo_SolicitaCentroDestino, T1.Tpmo_SolicitaRegionDestino, T1.Tpmo_CuentaResponsabilidad, T1.Tpmo_Estado, T1.Tpmo_VidaUtil, T1.Tpmo_Controlado, T1.Tpmo_ConsecutivoTrans, T3.Tipo_Tipo, T1.Tpmo_IngresaCurso, T1.Tpmo_IngresaAredante, T1.Tpmo_Modulo, T1.Tpmo_FechaModifica, T1.Tpmo_UsuarioModifica, T1.Tpmo_FechaCrea, T1.Tpmo_UsuarioCrea, T1.Tpmo_TipoE_S, T2.Tpal_Descripcion AS Tpmo_AlmacenDestinoDescrip, T1.Tpmo_AlmacenDestinoId AS Tpmo_AlmacenDestinoId, T3.Tipo_Descripcion, T1.Tipo_Codigo, T1.Tpmo_Descripcion, T1.Tpmo_Codigo FROM ((ALM_TIPO_MOVIMIENTO T1 INNER JOIN ALM_TIPO_ALMACEN T2 ON T2.Tpal_Id = T1.Tpmo_AlmacenDestinoId) INNER JOIN ALM_TIPO_ELEMENTO T3 ON T3.Tipo_Codigo = T1.Tipo_Codigo) WHERE T1.Tpmo_AlmacenOrigenId = ? ORDER BY T1.Tpmo_AlmacenOrigenId  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H004V3", "SELECT COUNT(*) FROM ((ALM_TIPO_MOVIMIENTO T1 INNER JOIN ALM_TIPO_ALMACEN T3 ON T3.Tpal_Id = T1.Tpmo_AlmacenDestinoId) INNER JOIN ALM_TIPO_ELEMENTO T2 ON T2.Tipo_Codigo = T1.Tipo_Codigo) WHERE T1.Tpmo_AlmacenOrigenId = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
