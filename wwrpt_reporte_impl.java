...
public final  class wwrpt_reporte_impl extends GXDataArea
{
   public wwrpt_reporte_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wwrpt_reporte_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wwrpt_reporte_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
         {
            ...
            AV14RPT_REP_NOMBRE = httpContext.GetNextPar( ) ;
            AV15Update = httpContext.GetNextPar( ) ;
            edtavUpdate_Tooltiptext = httpContext.GetNextPar( ) ;
            httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Tooltiptext", edtavUpdate_Tooltiptext, !bGXsfl_25_Refreshing);
            AV16Delete = httpContext.GetNextPar( ) ;
            ...
            gxgrgrid_refresh( subGrid_Rows, AV14RPT_REP_NOMBRE, AV15Update, AV16Delete, AV20Pgmname, A843RPT_REP_ID) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414235135");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( nGXWrapped != 1 )
      {
         httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.wwrpt_reporte") +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "GXH_vRPT_REP_NOMBRE", AV14RPT_REP_NOMBRE);
      /* Send saved values. */
   ...
   {
      return formatLink("com.orions2.wwrpt_reporte")  ;
   }

   public String getPgmname( )
   {
      return "WWRPT_REPORTE" ;
   }
   ...
   public void wb9R0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblTitletext_Internalname, "Reportes", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_WWRPT_REPORTE.htm");
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 25, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWRPT_REPORTE.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_label_element( httpContext, edtavRpt_rep_nombre_Internalname, "RPT_REP_NOMBRE", "col-sm-3 FilterSearchAttributeLabel", 0, true);
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"" ;
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavRpt_rep_nombre_Internalname, AV14RPT_REP_NOMBRE, GXutil.rtrim( localUtil.format( AV14RPT_REP_NOMBRE, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Nombre del reporte", edtavRpt_rep_nombre_Jsonclick, 0, "FilterSearchAttribute", "", "", "", 1, edtavRpt_rep_nombre_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_WWRPT_REPORTE.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            httpContext.writeValue( "Fecha de Creación") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
            httpContext.writeValue( "Usuario de Creación") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
            httpContext.writeValue( "Fecha de Modificación") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
   ...
   public void start9R2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Work With REPORTES", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 {
                                    Rfr0gs = false ;
                                    /* Set Refresh If Rpt_rep_nombre Changed */
                                    if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vRPT_REP_NOMBRE"), AV14RPT_REP_NOMBRE) != 0 )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    if ( ! Rfr0gs )
   ...
   public void pa9R2( )
   {
      if ( nDonePA == 0 )
      {
         ...
         GXCCtl = "RPT_REP_FORMATO_" + sGXsfl_25_idx ;
         ...
         GXCCtl = "RPT_REP_ESTADO_" + sGXsfl_25_idx ;
         ...
         if ( ! httpContext.isAjaxRequest( ) )
         {
            GX_FocusControl = edtavRpt_rep_nombre_Internalname ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_REP_FECHA_CREACION", getSecureSignedToken( "", localUtil.format( A847RPT_REP_FECHA_CREACION, "99/99/99 99:99")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "RPT_REP_FECHA_CREACION", localUtil.ttoc( A847RPT_REP_FECHA_CREACION, 10, 8, 0, 3, "/", ":", " "));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_REP_USUARIO_CREACION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A848RPT_REP_USUARIO_CREACION, "@!"))));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "RPT_REP_USUARIO_CREACION", A848RPT_REP_USUARIO_CREACION);
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_REP_FECHA_MODIFICA", getSecureSignedToken( "", localUtil.format( A849RPT_REP_FECHA_MODIFICA, "99/99/99 99:99")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "RPT_REP_FECHA_MODIFICA", localUtil.ttoc( A849RPT_REP_FECHA_MODIFICA, 10, 8, 0, 3, "/", ":", " "));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_REP_USUARIO_MODIFICA", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A850RPT_REP_USUARIO_MODIFICA, "@!"))));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "RPT_REP_USUARIO_MODIFICA", A850RPT_REP_USUARIO_MODIFICA);
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_REP_ESTADO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A851RPT_REP_ESTADO, ""))));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "RPT_REP_ESTADO", GXutil.rtrim( A851RPT_REP_ESTADO));
   }
   ...
   public void rf9R2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A851RPT_REP_ESTADO = H009R2_A851RPT_REP_ESTADO[0] ;
            n851RPT_REP_ESTADO = H009R2_n851RPT_REP_ESTADO[0] ;
            A850RPT_REP_USUARIO_MODIFICA = H009R2_A850RPT_REP_USUARIO_MODIFICA[0] ;
            n850RPT_REP_USUARIO_MODIFICA = H009R2_n850RPT_REP_USUARIO_MODIFICA[0] ;
            A849RPT_REP_FECHA_MODIFICA = H009R2_A849RPT_REP_FECHA_MODIFICA[0] ;
            n849RPT_REP_FECHA_MODIFICA = H009R2_n849RPT_REP_FECHA_MODIFICA[0] ;
            A848RPT_REP_USUARIO_CREACION = H009R2_A848RPT_REP_USUARIO_CREACION[0] ;
            n848RPT_REP_USUARIO_CREACION = H009R2_n848RPT_REP_USUARIO_CREACION[0] ;
            A847RPT_REP_FECHA_CREACION = H009R2_A847RPT_REP_FECHA_CREACION[0] ;
            n847RPT_REP_FECHA_CREACION = H009R2_n847RPT_REP_FECHA_CREACION[0] ;
            A846RPT_REP_FORMATO = H009R2_A846RPT_REP_FORMATO[0] ;
            n846RPT_REP_FORMATO = H009R2_n846RPT_REP_FORMATO[0] ;
            A845RPT_REP_DESCRIPCION = H009R2_A845RPT_REP_DESCRIPCION[0] ;
            n845RPT_REP_DESCRIPCION = H009R2_n845RPT_REP_DESCRIPCION[0] ;
            A844RPT_REP_NOMBRE = H009R2_A844RPT_REP_NOMBRE[0] ;
            n844RPT_REP_NOMBRE = H009R2_n844RPT_REP_NOMBRE[0] ;
            A843RPT_REP_ID = H009R2_A843RPT_REP_ID[0] ;
            if ( (GXutil.strcmp("", AV14RPT_REP_NOMBRE)==0) || ( GXutil.like( GXutil.upper( A844RPT_REP_NOMBRE) , GXutil.padr( GXutil.concat( "%", GXutil.upper( AV14RPT_REP_NOMBRE), "") , 254 , "%"),  ' ' ) ) )
            {
               e149R2 ();
            }
   ...
   public void strup9R0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV14RPT_REP_NOMBRE = httpContext.cgiGet( edtavRpt_rep_nombre_Internalname) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV14RPT_REP_NOMBRE", AV14RPT_REP_NOMBRE);
         /* Read saved values. */
   ...
   public void S122( )
   {
      ...
      if ( GXutil.strcmp(AV8HTTPRequest.getMethod(), "GET") == 0 )
      {
         ...
         {
            AV14RPT_REP_NOMBRE = ((com.orions2.SdtGridState_FilterValue)AV9GridState.getgxTv_SdtGridState_Filtervalues().elementAt(-1+1)).getgxTv_SdtGridState_FilterValue_Value() ;
            httpContext.ajax_rsp_assign_attri("", false, "AV14RPT_REP_NOMBRE", AV14RPT_REP_NOMBRE);
         }
   ...
   public void S132( )
   {
      ...
      AV10GridStateFilterValue.setgxTv_SdtGridState_FilterValue_Value( AV14RPT_REP_NOMBRE );
   ...
   public void S112( )
   {
      ...
      AV12TrnContext.setgxTv_SdtTransactionContext_Transactionname( "Reporte" );
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414235188");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         ...
         httpContext.AddJavascriptSource("wwrpt_reporte.js", "?201861414235190");
      }
   ...
   {
      edtRPT_REP_ID_Internalname = "RPT_REP_ID_"+sGXsfl_25_idx ;
      edtRPT_REP_NOMBRE_Internalname = "RPT_REP_NOMBRE_"+sGXsfl_25_idx ;
      edtRPT_REP_DESCRIPCION_Internalname = "RPT_REP_DESCRIPCION_"+sGXsfl_25_idx ;
      cmbRPT_REP_FORMATO.setInternalname( "RPT_REP_FORMATO_"+sGXsfl_25_idx );
      edtRPT_REP_FECHA_CREACION_Internalname = "RPT_REP_FECHA_CREACION_"+sGXsfl_25_idx ;
      edtRPT_REP_USUARIO_CREACION_Internalname = "RPT_REP_USUARIO_CREACION_"+sGXsfl_25_idx ;
      edtRPT_REP_FECHA_MODIFICA_Internalname = "RPT_REP_FECHA_MODIFICA_"+sGXsfl_25_idx ;
      edtRPT_REP_USUARIO_MODIFICA_Internalname = "RPT_REP_USUARIO_MODIFICA_"+sGXsfl_25_idx ;
      cmbRPT_REP_ESTADO.setInternalname( "RPT_REP_ESTADO_"+sGXsfl_25_idx );
   ...
   {
      edtRPT_REP_ID_Internalname = "RPT_REP_ID_"+sGXsfl_25_fel_idx ;
      edtRPT_REP_NOMBRE_Internalname = "RPT_REP_NOMBRE_"+sGXsfl_25_fel_idx ;
      edtRPT_REP_DESCRIPCION_Internalname = "RPT_REP_DESCRIPCION_"+sGXsfl_25_fel_idx ;
      cmbRPT_REP_FORMATO.setInternalname( "RPT_REP_FORMATO_"+sGXsfl_25_fel_idx );
      edtRPT_REP_FECHA_CREACION_Internalname = "RPT_REP_FECHA_CREACION_"+sGXsfl_25_fel_idx ;
      edtRPT_REP_USUARIO_CREACION_Internalname = "RPT_REP_USUARIO_CREACION_"+sGXsfl_25_fel_idx ;
      edtRPT_REP_FECHA_MODIFICA_Internalname = "RPT_REP_FECHA_MODIFICA_"+sGXsfl_25_fel_idx ;
      edtRPT_REP_USUARIO_MODIFICA_Internalname = "RPT_REP_USUARIO_MODIFICA_"+sGXsfl_25_fel_idx ;
      cmbRPT_REP_ESTADO.setInternalname( "RPT_REP_ESTADO_"+sGXsfl_25_fel_idx );
   ...
   public void sendrow_252( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRPT_REP_ID_Internalname,GXutil.ltrim( localUtil.ntoc( A843RPT_REP_ID, (byte)(4), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A843RPT_REP_ID), "ZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtRPT_REP_ID_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(4),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRPT_REP_NOMBRE_Internalname,A844RPT_REP_NOMBRE,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtRPT_REP_NOMBRE_Jsonclick,new Integer(0),"DescriptionAttribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRPT_REP_DESCRIPCION_Internalname,A845RPT_REP_DESCRIPCION,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtRPT_REP_DESCRIPCION_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbRPT_REP_FORMATO,cmbRPT_REP_FORMATO.getInternalname(),GXutil.rtrim( A846RPT_REP_FORMATO),new Integer(1),cmbRPT_REP_FORMATO.getJsonclick(),new Integer(0),"'"+""+"'"+",false,"+"'"+""+"'","svchar","",new Integer(-1),new Integer(0),new Integer(0),new Integer(0),new Integer(0),"px",new Integer(0),"px","","Attribute","WWColumn","","",new Boolean(true)});
         cmbRPT_REP_FORMATO.setValue( GXutil.rtrim( A846RPT_REP_FORMATO) );
         httpContext.ajax_rsp_assign_prop("", false, cmbRPT_REP_FORMATO.getInternalname(), "Values", cmbRPT_REP_FORMATO.ToJavascriptSource(), !bGXsfl_25_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRPT_REP_FECHA_CREACION_Internalname,localUtil.ttoc( A847RPT_REP_FECHA_CREACION, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A847RPT_REP_FECHA_CREACION, "99/99/99 99:99"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtRPT_REP_FECHA_CREACION_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRPT_REP_USUARIO_CREACION_Internalname,A848RPT_REP_USUARIO_CREACION,GXutil.rtrim( localUtil.format( A848RPT_REP_USUARIO_CREACION, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtRPT_REP_USUARIO_CREACION_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRPT_REP_FECHA_MODIFICA_Internalname,localUtil.ttoc( A849RPT_REP_FECHA_MODIFICA, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A849RPT_REP_FECHA_MODIFICA, "99/99/99 99:99"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtRPT_REP_FECHA_MODIFICA_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRPT_REP_USUARIO_MODIFICA_Internalname,A850RPT_REP_USUARIO_MODIFICA,GXutil.rtrim( localUtil.format( A850RPT_REP_USUARIO_MODIFICA, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtRPT_REP_USUARIO_MODIFICA_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         httpContext.ajax_rsp_assign_prop("", false, cmbRPT_REP_ESTADO.getInternalname(), "Values", cmbRPT_REP_ESTADO.ToJavascriptSource(), !bGXsfl_25_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_REP_ID"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, localUtil.format( DecimalUtil.doubleToDec(A843RPT_REP_ID), "ZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_REP_NOMBRE"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, GXutil.rtrim( localUtil.format( A844RPT_REP_NOMBRE, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_REP_DESCRIPCION"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, GXutil.rtrim( localUtil.format( A845RPT_REP_DESCRIPCION, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_REP_FORMATO"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, GXutil.rtrim( localUtil.format( A846RPT_REP_FORMATO, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_REP_FECHA_CREACION"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, localUtil.format( A847RPT_REP_FECHA_CREACION, "99/99/99 99:99")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_REP_USUARIO_CREACION"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, GXutil.rtrim( localUtil.format( A848RPT_REP_USUARIO_CREACION, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_REP_FECHA_MODIFICA"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, localUtil.format( A849RPT_REP_FECHA_MODIFICA, "99/99/99 99:99")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_REP_USUARIO_MODIFICA"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, GXutil.rtrim( localUtil.format( A850RPT_REP_USUARIO_MODIFICA, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_REP_ESTADO"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, GXutil.rtrim( localUtil.format( A851RPT_REP_ESTADO, ""))));
   ...
   public void init_default_properties( )
   {
      ...
      edtavRpt_rep_nombre_Internalname = "vRPT_REP_NOMBRE" ;
      ...
      edtRPT_REP_FECHA_CREACION_Internalname = "RPT_REP_FECHA_CREACION" ;
      edtRPT_REP_USUARIO_CREACION_Internalname = "RPT_REP_USUARIO_CREACION" ;
      edtRPT_REP_FECHA_MODIFICA_Internalname = "RPT_REP_FECHA_MODIFICA" ;
      edtRPT_REP_USUARIO_MODIFICA_Internalname = "RPT_REP_USUARIO_MODIFICA" ;
   ...
   public void initialize_properties( )
   {
      ...
      edtavRpt_rep_nombre_Jsonclick = "" ;
      edtavRpt_rep_nombre_Enabled = 1 ;
      Form.setHeaderrawhtml( "" );
      Form.setBackground( "" );
      Form.setTextcolor( 0 );
      Form.setIBackground( (int)(0xFFFFFF) );
      Form.setCaption( "Work With REPORTES" );
      subGrid_Rows = 0 ;
      edtavDelete_Tooltiptext = "Eliminar" ;
      edtavUpdate_Tooltiptext = "Modificar" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV15Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV16Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A843RPT_REP_ID',fld:'RPT_REP_ID',pic:'ZZZ9',hsh:true,nv:0},{av:'AV20Pgmname',fld:'vPGMNAME',pic:'',nv:''},{av:'AV14RPT_REP_NOMBRE',fld:'vRPT_REP_NOMBRE',pic:'',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e149R2',iparms:[{av:'A843RPT_REP_ID',fld:'RPT_REP_ID',pic:'ZZZ9',hsh:true,nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e119R2',iparms:[{av:'A843RPT_REP_ID',fld:'RPT_REP_ID',pic:'ZZZ9',hsh:true,nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      GXCCtl = "" ;
      scmdbuf = "" ;
      H009R2_A851RPT_REP_ESTADO = new String[] {""} ;
      H009R2_n851RPT_REP_ESTADO = new boolean[] {false} ;
      H009R2_A850RPT_REP_USUARIO_MODIFICA = new String[] {""} ;
      H009R2_n850RPT_REP_USUARIO_MODIFICA = new boolean[] {false} ;
      H009R2_A849RPT_REP_FECHA_MODIFICA = new java.util.Date[] {GXutil.nullDate()} ;
      H009R2_n849RPT_REP_FECHA_MODIFICA = new boolean[] {false} ;
      H009R2_A848RPT_REP_USUARIO_CREACION = new String[] {""} ;
      H009R2_n848RPT_REP_USUARIO_CREACION = new boolean[] {false} ;
      H009R2_A847RPT_REP_FECHA_CREACION = new java.util.Date[] {GXutil.nullDate()} ;
      H009R2_n847RPT_REP_FECHA_CREACION = new boolean[] {false} ;
      H009R2_A846RPT_REP_FORMATO = new String[] {""} ;
      H009R2_n846RPT_REP_FORMATO = new boolean[] {false} ;
      H009R2_A845RPT_REP_DESCRIPCION = new String[] {""} ;
      H009R2_n845RPT_REP_DESCRIPCION = new boolean[] {false} ;
      H009R2_A844RPT_REP_NOMBRE = new String[] {""} ;
      H009R2_n844RPT_REP_NOMBRE = new boolean[] {false} ;
      H009R2_A843RPT_REP_ID = new short[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.wwrpt_reporte__default(),
         new Object[] {
             new Object[] {
            H009R2_A851RPT_REP_ESTADO, H009R2_n851RPT_REP_ESTADO, H009R2_A850RPT_REP_USUARIO_MODIFICA, H009R2_n850RPT_REP_USUARIO_MODIFICA, H009R2_A849RPT_REP_FECHA_MODIFICA, H009R2_n849RPT_REP_FECHA_MODIFICA, H009R2_A848RPT_REP_USUARIO_CREACION, H009R2_n848RPT_REP_USUARIO_CREACION, H009R2_A847RPT_REP_FECHA_CREACION, H009R2_n847RPT_REP_FECHA_CREACION,
            H009R2_A846RPT_REP_FORMATO, H009R2_n846RPT_REP_FORMATO, H009R2_A845RPT_REP_DESCRIPCION, H009R2_n845RPT_REP_DESCRIPCION, H009R2_A844RPT_REP_NOMBRE, H009R2_n844RPT_REP_NOMBRE, H009R2_A843RPT_REP_ID
            }
         }
      );
      AV20Pgmname = "WWRPT_REPORTE" ;
   ...
   private int edtavRpt_rep_nombre_Enabled ;
   ...
   private String edtavRpt_rep_nombre_Internalname ;
   private String edtavRpt_rep_nombre_Jsonclick ;
   ...
   private String AV14RPT_REP_NOMBRE ;
   ...
   private String[] H009R2_A851RPT_REP_ESTADO ;
   private boolean[] H009R2_n851RPT_REP_ESTADO ;
   private String[] H009R2_A850RPT_REP_USUARIO_MODIFICA ;
   private boolean[] H009R2_n850RPT_REP_USUARIO_MODIFICA ;
   private java.util.Date[] H009R2_A849RPT_REP_FECHA_MODIFICA ;
   private boolean[] H009R2_n849RPT_REP_FECHA_MODIFICA ;
   private String[] H009R2_A848RPT_REP_USUARIO_CREACION ;
   private boolean[] H009R2_n848RPT_REP_USUARIO_CREACION ;
   private java.util.Date[] H009R2_A847RPT_REP_FECHA_CREACION ;
   private boolean[] H009R2_n847RPT_REP_FECHA_CREACION ;
   private String[] H009R2_A846RPT_REP_FORMATO ;
   private boolean[] H009R2_n846RPT_REP_FORMATO ;
   private String[] H009R2_A845RPT_REP_DESCRIPCION ;
   private boolean[] H009R2_n845RPT_REP_DESCRIPCION ;
   private String[] H009R2_A844RPT_REP_NOMBRE ;
   private boolean[] H009R2_n844RPT_REP_NOMBRE ;
   private short[] H009R2_A843RPT_REP_ID ;
...
final  class wwrpt_reporte__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H009R2", "SELECT RPT_REP_ESTADO, RPT_REP_USUARIO_MODIFICA, RPT_REP_FECHA_MODIFICA, RPT_REP_USUARIO_CREACION, RPT_REP_FECHA_CREACION, RPT_REP_FORMATO, RPT_REP_DESCRIPCION, RPT_REP_NOMBRE, RPT_REP_ID FROM RPT_REPORTE ORDER BY RPT_REP_NOMBRE ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
      };
   }
