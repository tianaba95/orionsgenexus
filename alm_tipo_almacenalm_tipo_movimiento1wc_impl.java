/*
               File: alm_tipo_almacenalm_tipo_movimiento1wc_impl
...
public final  class alm_tipo_almacenalm_tipo_movimiento1wc_impl extends GXWebComponent
{
   public alm_tipo_almacenalm_tipo_movimiento1wc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public alm_tipo_almacenalm_tipo_movimiento1wc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( alm_tipo_almacenalm_tipo_movimiento1wc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV7Tpmo_AlmacenDestinoId = GXutil.lval( httpContext.GetNextPar( )) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Tpmo_AlmacenDestinoId", GXutil.ltrim( GXutil.str( AV7Tpmo_AlmacenDestinoId, 11, 0)));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,new Long(AV7Tpmo_AlmacenDestinoId)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Tpmo_AlmacenDestinoId, AV12Update, AV13Delete, A38Tpmo_Codigo, A33Tipo_Codigo, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "ALM_TIPO_ALMACENALM_TIPO_MOVIMIENTO1 WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414163578");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.alm_tipo_almacenalm_tipo_movimiento1wc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Tpmo_AlmacenDestinoId,11,0)))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV7Tpmo_AlmacenDestinoId", GXutil.ltrim( localUtil.ntoc( wcpOAV7Tpmo_AlmacenDestinoId, (byte)(11), (byte)(0), ",", "")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vTPMO_ALMACENDESTINOID", GXutil.ltrim( localUtil.ntoc( AV7Tpmo_AlmacenDestinoId, (byte)(11), (byte)(0), ",", "")));
   ...
   public void renderHtmlCloseForm4W2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("alm_tipo_almacenalm_tipo_movimiento1wc.js", "?201861414163581");
      }
   ...
   {
      return "ALM_TIPO_ALMACENALM_TIPO_MOVIMIENTO1WC" ;
   }
   ...
   public void wb4W0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.alm_tipo_almacenalm_tipo_movimiento1wc");
         }
         /* Div Control */
   ...
   public void start4W2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "ALM_TIPO_ALMACENALM_TIPO_MOVIMIENTO1 WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TIPO_CODIGO", GXutil.ltrim( localUtil.ntoc( A33Tipo_Codigo, (byte)(18), (byte)(0), ".", "")));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TPMO_ALMACENORIGENID", GXutil.ltrim( localUtil.ntoc( A39Tpmo_AlmacenOrigenId, (byte)(11), (byte)(0), ".", "")));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TPMO_TIPOE_S", A315Tpmo_TipoE_S);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TPMO_USUARIOCREA", A317Tpmo_UsuarioCrea);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TPMO_FECHACREA", localUtil.ttoc( A318Tpmo_FechaCrea, 10, 8, 0, 3, "/", ":", " "));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TPMO_USUARIOMODIFICA", A319Tpmo_UsuarioModifica);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TPMO_FECHAMODIFICA", localUtil.ttoc( A320Tpmo_FechaModifica, 10, 8, 0, 3, "/", ":", " "));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TPMO_MODULO", A316Tpmo_Modulo);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TPMO_INGRESAAREDANTE", A440Tpmo_IngresaAredante);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TPMO_INGRESACURSO", A441Tpmo_IngresaCurso);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TPMO_CONSECUTIVOTRANS", GXutil.ltrim( localUtil.ntoc( A595Tpmo_ConsecutivoTrans, (byte)(18), (byte)(0), ".", "")));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TPMO_CONTROLADO", A633Tpmo_Controlado);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TPMO_VIDAUTIL", A641Tpmo_VidaUtil);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TPMO_ESTADO", GXutil.rtrim( A679Tpmo_Estado));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TPMO_CUENTARESPONSABILIDAD", A680Tpmo_CuentaResponsabilidad);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TPMO_SOLICITAREGIONDESTINO", A705Tpmo_SolicitaRegionDestino);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TPMO_SOLICITACENTRODESTINO", A706Tpmo_SolicitaCentroDestino);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TPMO_IMPRIMEORIGEN", A716Tpmo_ImprimeOrigen);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TPMO_IMPRIMEDESTINO", A717Tpmo_ImprimeDestino);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TMPO_IMPRIMERESPONSABLE", A718Tmpo_ImprimeResponsable);
   }
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "ALM_TIPO_ALMACENALM_TIPO_MOVIMIENTO1WC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf4W2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H004W2 */
         pr_default.execute(0, new Object[] {new Long(AV7Tpmo_AlmacenDestinoId), new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_20_idx = (short)(1) ;
         sGXsfl_20_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_20_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_202( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A40Tpmo_AlmacenDestinoId = H004W2_A40Tpmo_AlmacenDestinoId[0] ;
            ...
            A718Tmpo_ImprimeResponsable = H004W2_A718Tmpo_ImprimeResponsable[0] ;
            n718Tmpo_ImprimeResponsable = H004W2_n718Tmpo_ImprimeResponsable[0] ;
            A717Tpmo_ImprimeDestino = H004W2_A717Tpmo_ImprimeDestino[0] ;
            n717Tpmo_ImprimeDestino = H004W2_n717Tpmo_ImprimeDestino[0] ;
            A716Tpmo_ImprimeOrigen = H004W2_A716Tpmo_ImprimeOrigen[0] ;
            n716Tpmo_ImprimeOrigen = H004W2_n716Tpmo_ImprimeOrigen[0] ;
            A706Tpmo_SolicitaCentroDestino = H004W2_A706Tpmo_SolicitaCentroDestino[0] ;
            n706Tpmo_SolicitaCentroDestino = H004W2_n706Tpmo_SolicitaCentroDestino[0] ;
            A705Tpmo_SolicitaRegionDestino = H004W2_A705Tpmo_SolicitaRegionDestino[0] ;
            n705Tpmo_SolicitaRegionDestino = H004W2_n705Tpmo_SolicitaRegionDestino[0] ;
            A680Tpmo_CuentaResponsabilidad = H004W2_A680Tpmo_CuentaResponsabilidad[0] ;
            n680Tpmo_CuentaResponsabilidad = H004W2_n680Tpmo_CuentaResponsabilidad[0] ;
            A679Tpmo_Estado = H004W2_A679Tpmo_Estado[0] ;
            n679Tpmo_Estado = H004W2_n679Tpmo_Estado[0] ;
            A641Tpmo_VidaUtil = H004W2_A641Tpmo_VidaUtil[0] ;
            n641Tpmo_VidaUtil = H004W2_n641Tpmo_VidaUtil[0] ;
            A633Tpmo_Controlado = H004W2_A633Tpmo_Controlado[0] ;
            n633Tpmo_Controlado = H004W2_n633Tpmo_Controlado[0] ;
            A595Tpmo_ConsecutivoTrans = H004W2_A595Tpmo_ConsecutivoTrans[0] ;
            n595Tpmo_ConsecutivoTrans = H004W2_n595Tpmo_ConsecutivoTrans[0] ;
            A480Tipo_Tipo = H004W2_A480Tipo_Tipo[0] ;
            A441Tpmo_IngresaCurso = H004W2_A441Tpmo_IngresaCurso[0] ;
            A440Tpmo_IngresaAredante = H004W2_A440Tpmo_IngresaAredante[0] ;
            A316Tpmo_Modulo = H004W2_A316Tpmo_Modulo[0] ;
            A320Tpmo_FechaModifica = H004W2_A320Tpmo_FechaModifica[0] ;
            n320Tpmo_FechaModifica = H004W2_n320Tpmo_FechaModifica[0] ;
            A319Tpmo_UsuarioModifica = H004W2_A319Tpmo_UsuarioModifica[0] ;
            n319Tpmo_UsuarioModifica = H004W2_n319Tpmo_UsuarioModifica[0] ;
            A318Tpmo_FechaCrea = H004W2_A318Tpmo_FechaCrea[0] ;
            A317Tpmo_UsuarioCrea = H004W2_A317Tpmo_UsuarioCrea[0] ;
            A315Tpmo_TipoE_S = H004W2_A315Tpmo_TipoE_S[0] ;
            A312Tpmo_AlmacenOrigenDescrip = H004W2_A312Tpmo_AlmacenOrigenDescrip[0] ;
            n312Tpmo_AlmacenOrigenDescrip = H004W2_n312Tpmo_AlmacenOrigenDescrip[0] ;
            A39Tpmo_AlmacenOrigenId = H004W2_A39Tpmo_AlmacenOrigenId[0] ;
            A253Tipo_Descripcion = H004W2_A253Tipo_Descripcion[0] ;
            A33Tipo_Codigo = H004W2_A33Tipo_Codigo[0] ;
            A313Tpmo_Descripcion = H004W2_A313Tpmo_Descripcion[0] ;
            A38Tpmo_Codigo = H004W2_A38Tpmo_Codigo[0] ;
            A312Tpmo_AlmacenOrigenDescrip = H004W2_A312Tpmo_AlmacenOrigenDescrip[0] ;
            n312Tpmo_AlmacenOrigenDescrip = H004W2_n312Tpmo_AlmacenOrigenDescrip[0] ;
            A480Tipo_Tipo = H004W2_A480Tipo_Tipo[0] ;
            A253Tipo_Descripcion = H004W2_A253Tipo_Descripcion[0] ;
   ...
   {
      /* Using cursor H004W3 */
      pr_default.execute(1, new Object[] {new Long(AV7Tpmo_AlmacenDestinoId)});
   ...
   public void strup4W0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV7Tpmo_AlmacenDestinoId = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV7Tpmo_AlmacenDestinoId"), ",", ".") ;
   ...
   public void e124W2( )
   {
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext, !bGXsfl_20_Refreshing);
      edtTpmo_AlmacenDestinoId_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtTpmo_AlmacenDestinoId_Internalname, "Visible", GXutil.ltrim( GXutil.str( edtTpmo_AlmacenDestinoId_Visible, 5, 0)), true);
   ...
   public void S112( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributename( "Tpmo_AlmacenDestinoId" );
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( GXutil.str( AV7Tpmo_AlmacenDestinoId, 11, 0) );
   ...
   {
      AV7Tpmo_AlmacenDestinoId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Tpmo_AlmacenDestinoId", GXutil.ltrim( GXutil.str( AV7Tpmo_AlmacenDestinoId, 11, 0)));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV7Tpmo_AlmacenDestinoId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "alm_tipo_almacenalm_tipo_movimiento1wc");
      ...
      {
         AV7Tpmo_AlmacenDestinoId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Tpmo_AlmacenDestinoId", GXutil.ltrim( GXutil.str( AV7Tpmo_AlmacenDestinoId, 11, 0)));
      }
      wcpOAV7Tpmo_AlmacenDestinoId = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV7Tpmo_AlmacenDestinoId"), ",", ".") ;
      if ( ! GetJustCreated( ) && ( ( AV7Tpmo_AlmacenDestinoId != wcpOAV7Tpmo_AlmacenDestinoId ) ) )
      {
         setjustcreated();
      }
      wcpOAV7Tpmo_AlmacenDestinoId = AV7Tpmo_AlmacenDestinoId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV7Tpmo_AlmacenDestinoId = httpContext.cgiGet( sPrefix+"AV7Tpmo_AlmacenDestinoId_CTRL") ;
      if ( GXutil.len( sCtrlAV7Tpmo_AlmacenDestinoId) > 0 )
      {
         AV7Tpmo_AlmacenDestinoId = localUtil.ctol( httpContext.cgiGet( sCtrlAV7Tpmo_AlmacenDestinoId), ",", ".") ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Tpmo_AlmacenDestinoId", GXutil.ltrim( GXutil.str( AV7Tpmo_AlmacenDestinoId, 11, 0)));
      }
      else
      {
         AV7Tpmo_AlmacenDestinoId = localUtil.ctol( httpContext.cgiGet( sPrefix+"AV7Tpmo_AlmacenDestinoId_PARM"), ",", ".") ;
      }
   }
   ...
   {
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Tpmo_AlmacenDestinoId_PARM", GXutil.ltrim( localUtil.ntoc( AV7Tpmo_AlmacenDestinoId, (byte)(11), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV7Tpmo_AlmacenDestinoId)) > 0 )
      {
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Tpmo_AlmacenDestinoId_CTRL", GXutil.rtrim( sCtrlAV7Tpmo_AlmacenDestinoId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414163672");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("alm_tipo_almacenalm_tipo_movimiento1wc.js", "?201861414163672");
      }
   ...
   public void sendrow_202( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbTpmo_TipoE_S,cmbTpmo_TipoE_S.getInternalname(),GXutil.rtrim( A315Tpmo_TipoE_S),new Integer(1),cmbTpmo_TipoE_S.getJsonclick(),new Integer(0),"'"+sPrefix+"'"+",false,"+"'"+""+"'","svchar","",new Integer(-1),new Integer(0),new Integer(0),new Integer(0),new Integer(0),"px",new Integer(0),"px","","Attribute","WWColumn WWOptionalColumn","","",new Boolean(true)});
         ...
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbTpmo_Modulo,cmbTpmo_Modulo.getInternalname(),GXutil.rtrim( A316Tpmo_Modulo),new Integer(1),cmbTpmo_Modulo.getJsonclick(),new Integer(0),"'"+sPrefix+"'"+",false,"+"'"+""+"'","svchar","",new Integer(-1),new Integer(0),new Integer(0),new Integer(0),new Integer(0),"px",new Integer(0),"px","","Attribute","WWColumn WWOptionalColumn","","",new Boolean(true)});
         ...
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbTpmo_IngresaAredante,cmbTpmo_IngresaAredante.getInternalname(),GXutil.rtrim( A440Tpmo_IngresaAredante),new Integer(1),cmbTpmo_IngresaAredante.getJsonclick(),new Integer(0),"'"+sPrefix+"'"+",false,"+"'"+""+"'","svchar","",new Integer(-1),new Integer(0),new Integer(0),new Integer(0),new Integer(0),"px",new Integer(0),"px","","Attribute","WWColumn WWOptionalColumn","","",new Boolean(true)});
         ...
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbTpmo_Controlado,cmbTpmo_Controlado.getInternalname(),GXutil.rtrim( A633Tpmo_Controlado),new Integer(1),cmbTpmo_Controlado.getJsonclick(),new Integer(0),"'"+sPrefix+"'"+",false,"+"'"+""+"'","svchar","",new Integer(-1),new Integer(0),new Integer(0),new Integer(0),new Integer(0),"px",new Integer(0),"px","","Attribute","WWColumn WWOptionalColumn","","",new Boolean(true)});
         ...
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbTpmo_VidaUtil,cmbTpmo_VidaUtil.getInternalname(),GXutil.rtrim( A641Tpmo_VidaUtil),new Integer(1),cmbTpmo_VidaUtil.getJsonclick(),new Integer(0),"'"+sPrefix+"'"+",false,"+"'"+""+"'","svchar","",new Integer(-1),new Integer(0),new Integer(0),new Integer(0),new Integer(0),"px",new Integer(0),"px","","Attribute","WWColumn WWOptionalColumn","","",new Boolean(true)});
         ...
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbTpmo_CuentaResponsabilidad,cmbTpmo_CuentaResponsabilidad.getInternalname(),GXutil.rtrim( A680Tpmo_CuentaResponsabilidad),new Integer(1),cmbTpmo_CuentaResponsabilidad.getJsonclick(),new Integer(0),"'"+sPrefix+"'"+",false,"+"'"+""+"'","svchar","",new Integer(-1),new Integer(0),new Integer(0),new Integer(0),new Integer(0),"px",new Integer(0),"px","","Attribute","WWColumn WWOptionalColumn","","",new Boolean(true)});
         ...
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbTpmo_SolicitaRegionDestino,cmbTpmo_SolicitaRegionDestino.getInternalname(),GXutil.rtrim( A705Tpmo_SolicitaRegionDestino),new Integer(1),cmbTpmo_SolicitaRegionDestino.getJsonclick(),new Integer(0),"'"+sPrefix+"'"+",false,"+"'"+""+"'","svchar","",new Integer(-1),new Integer(0),new Integer(0),new Integer(0),new Integer(0),"px",new Integer(0),"px","","Attribute","WWColumn WWOptionalColumn","","",new Boolean(true)});
         ...
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbTpmo_ImprimeOrigen,cmbTpmo_ImprimeOrigen.getInternalname(),GXutil.rtrim( A716Tpmo_ImprimeOrigen),new Integer(1),cmbTpmo_ImprimeOrigen.getJsonclick(),new Integer(0),"'"+sPrefix+"'"+",false,"+"'"+""+"'","svchar","",new Integer(-1),new Integer(0),new Integer(0),new Integer(0),new Integer(0),"px",new Integer(0),"px","","Attribute","WWColumn WWOptionalColumn","","",new Boolean(true)});
         ...
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbTpmo_ImprimeDestino,cmbTpmo_ImprimeDestino.getInternalname(),GXutil.rtrim( A717Tpmo_ImprimeDestino),new Integer(1),cmbTpmo_ImprimeDestino.getJsonclick(),new Integer(0),"'"+sPrefix+"'"+",false,"+"'"+""+"'","svchar","",new Integer(-1),new Integer(0),new Integer(0),new Integer(0),new Integer(0),"px",new Integer(0),"px","","Attribute","WWColumn WWOptionalColumn","","",new Boolean(true)});
         ...
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TIPO_CODIGO"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, localUtil.format( DecimalUtil.doubleToDec(A33Tipo_Codigo), "ZZZZZZZZZZZZZZZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TPMO_ALMACENORIGENID"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, localUtil.format( DecimalUtil.doubleToDec(A39Tpmo_AlmacenOrigenId), "ZZZZZZZZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TPMO_TIPOE_S"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A315Tpmo_TipoE_S, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TPMO_USUARIOCREA"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A317Tpmo_UsuarioCrea, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TPMO_FECHACREA"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, localUtil.format( A318Tpmo_FechaCrea, "99/99/99 99:99")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TPMO_USUARIOMODIFICA"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A319Tpmo_UsuarioModifica, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TPMO_FECHAMODIFICA"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, localUtil.format( A320Tpmo_FechaModifica, "99/99/99 99:99")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TPMO_MODULO"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A316Tpmo_Modulo, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TPMO_INGRESAAREDANTE"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A440Tpmo_IngresaAredante, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TPMO_INGRESACURSO"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A441Tpmo_IngresaCurso, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TPMO_CONSECUTIVOTRANS"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, localUtil.format( DecimalUtil.doubleToDec(A595Tpmo_ConsecutivoTrans), "ZZZZZZZZZZZZZZZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TPMO_CONTROLADO"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A633Tpmo_Controlado, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TPMO_VIDAUTIL"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A641Tpmo_VidaUtil, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TPMO_ESTADO"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A679Tpmo_Estado, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TPMO_CUENTARESPONSABILIDAD"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A680Tpmo_CuentaResponsabilidad, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TPMO_SOLICITAREGIONDESTINO"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A705Tpmo_SolicitaRegionDestino, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TPMO_SOLICITACENTRODESTINO"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A706Tpmo_SolicitaCentroDestino, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TPMO_IMPRIMEORIGEN"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A716Tpmo_ImprimeOrigen, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TPMO_IMPRIMEDESTINO"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A717Tpmo_ImprimeDestino, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TMPO_IMPRIMERESPONSABLE"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A718Tmpo_ImprimeResponsable, ""))));
   ...
   public void initialize_properties( )
   {
      ...
      edtTpmo_AlmacenDestinoId_Visible = 1 ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Tpmo_AlmacenDestinoId',fld:'vTPMO_ALMACENDESTINOID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV12Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV13Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A38Tpmo_Codigo',fld:'TPMO_CODIGO',pic:'',hsh:true,nv:''},{av:'A33Tipo_Codigo',fld:'TIPO_CODIGO',pic:'ZZZZZZZZZZZZZZZZZ9',hsh:true,nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e134W2',iparms:[{av:'A38Tpmo_Codigo',fld:'TPMO_CODIGO',pic:'',hsh:true,nv:''},{av:'A33Tipo_Codigo',fld:'TIPO_CODIGO',pic:'ZZZZZZZZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtTpmo_Descripcion_Link',ctrl:'TPMO_DESCRIPCION',prop:'Link'},{av:'edtTipo_Descripcion_Link',ctrl:'TIPO_DESCRIPCION',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e114W2',iparms:[{av:'A38Tpmo_Codigo',fld:'TPMO_CODIGO',pic:'',hsh:true,nv:''}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H004W2_A40Tpmo_AlmacenDestinoId = new long[1] ;
      H004W2_A718Tmpo_ImprimeResponsable = new String[] {""} ;
      H004W2_n718Tmpo_ImprimeResponsable = new boolean[] {false} ;
      H004W2_A717Tpmo_ImprimeDestino = new String[] {""} ;
      H004W2_n717Tpmo_ImprimeDestino = new boolean[] {false} ;
      H004W2_A716Tpmo_ImprimeOrigen = new String[] {""} ;
      H004W2_n716Tpmo_ImprimeOrigen = new boolean[] {false} ;
      H004W2_A706Tpmo_SolicitaCentroDestino = new String[] {""} ;
      H004W2_n706Tpmo_SolicitaCentroDestino = new boolean[] {false} ;
      H004W2_A705Tpmo_SolicitaRegionDestino = new String[] {""} ;
      H004W2_n705Tpmo_SolicitaRegionDestino = new boolean[] {false} ;
      H004W2_A680Tpmo_CuentaResponsabilidad = new String[] {""} ;
      H004W2_n680Tpmo_CuentaResponsabilidad = new boolean[] {false} ;
      H004W2_A679Tpmo_Estado = new String[] {""} ;
      H004W2_n679Tpmo_Estado = new boolean[] {false} ;
      H004W2_A641Tpmo_VidaUtil = new String[] {""} ;
      H004W2_n641Tpmo_VidaUtil = new boolean[] {false} ;
      H004W2_A633Tpmo_Controlado = new String[] {""} ;
      H004W2_n633Tpmo_Controlado = new boolean[] {false} ;
      H004W2_A595Tpmo_ConsecutivoTrans = new long[1] ;
      H004W2_n595Tpmo_ConsecutivoTrans = new boolean[] {false} ;
      H004W2_A480Tipo_Tipo = new String[] {""} ;
      H004W2_A441Tpmo_IngresaCurso = new String[] {""} ;
      H004W2_A440Tpmo_IngresaAredante = new String[] {""} ;
      H004W2_A316Tpmo_Modulo = new String[] {""} ;
      H004W2_A320Tpmo_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H004W2_n320Tpmo_FechaModifica = new boolean[] {false} ;
      H004W2_A319Tpmo_UsuarioModifica = new String[] {""} ;
      H004W2_n319Tpmo_UsuarioModifica = new boolean[] {false} ;
      H004W2_A318Tpmo_FechaCrea = new java.util.Date[] {GXutil.nullDate()} ;
      H004W2_A317Tpmo_UsuarioCrea = new String[] {""} ;
      H004W2_A315Tpmo_TipoE_S = new String[] {""} ;
      H004W2_A312Tpmo_AlmacenOrigenDescrip = new String[] {""} ;
      H004W2_n312Tpmo_AlmacenOrigenDescrip = new boolean[] {false} ;
      H004W2_A39Tpmo_AlmacenOrigenId = new long[1] ;
      H004W2_A253Tipo_Descripcion = new String[] {""} ;
      H004W2_A33Tipo_Codigo = new long[1] ;
      H004W2_A313Tpmo_Descripcion = new String[] {""} ;
      H004W2_A38Tpmo_Codigo = new String[] {""} ;
      ...
      sCtrlAV7Tpmo_AlmacenDestinoId = "" ;
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.alm_tipo_almacenalm_tipo_movimiento1wc__default(),
         new Object[] {
             new Object[] {
            H004W2_A40Tpmo_AlmacenDestinoId, H004W2_A718Tmpo_ImprimeResponsable, H004W2_n718Tmpo_ImprimeResponsable, H004W2_A717Tpmo_ImprimeDestino, H004W2_n717Tpmo_ImprimeDestino, H004W2_A716Tpmo_ImprimeOrigen, H004W2_n716Tpmo_ImprimeOrigen, H004W2_A706Tpmo_SolicitaCentroDestino, H004W2_n706Tpmo_SolicitaCentroDestino, H004W2_A705Tpmo_SolicitaRegionDestino,
            H004W2_n705Tpmo_SolicitaRegionDestino, H004W2_A680Tpmo_CuentaResponsabilidad, H004W2_n680Tpmo_CuentaResponsabilidad, H004W2_A679Tpmo_Estado, H004W2_n679Tpmo_Estado, H004W2_A641Tpmo_VidaUtil, H004W2_n641Tpmo_VidaUtil, H004W2_A633Tpmo_Controlado, H004W2_n633Tpmo_Controlado, H004W2_A595Tpmo_ConsecutivoTrans,
            H004W2_n595Tpmo_ConsecutivoTrans, H004W2_A480Tipo_Tipo, H004W2_A441Tpmo_IngresaCurso, H004W2_A440Tpmo_IngresaAredante, H004W2_A316Tpmo_Modulo, H004W2_A320Tpmo_FechaModifica, H004W2_n320Tpmo_FechaModifica, H004W2_A319Tpmo_UsuarioModifica, H004W2_n319Tpmo_UsuarioModifica, H004W2_A318Tpmo_FechaCrea,
            H004W2_A317Tpmo_UsuarioCrea, H004W2_A315Tpmo_TipoE_S, H004W2_A312Tpmo_AlmacenOrigenDescrip, H004W2_n312Tpmo_AlmacenOrigenDescrip, H004W2_A39Tpmo_AlmacenOrigenId, H004W2_A253Tipo_Descripcion, H004W2_A33Tipo_Codigo, H004W2_A313Tpmo_Descripcion, H004W2_A38Tpmo_Codigo
            }
            , new Object[] {
   ...
   private int edtTpmo_AlmacenDestinoId_Visible ;
   private int subGrid_Islastpage ;
   private int GXPagingFrom2 ;
   private int GXPagingTo2 ;
   private int idxLst ;
   private int subGrid_Backcolor ;
   private long wcpOAV7Tpmo_AlmacenDestinoId ;
   private long AV7Tpmo_AlmacenDestinoId ;
   ...
   private String sCtrlAV7Tpmo_AlmacenDestinoId ;
   ...
   private long[] H004W2_A40Tpmo_AlmacenDestinoId ;
   private String[] H004W2_A718Tmpo_ImprimeResponsable ;
   private boolean[] H004W2_n718Tmpo_ImprimeResponsable ;
   private String[] H004W2_A717Tpmo_ImprimeDestino ;
   private boolean[] H004W2_n717Tpmo_ImprimeDestino ;
   private String[] H004W2_A716Tpmo_ImprimeOrigen ;
   private boolean[] H004W2_n716Tpmo_ImprimeOrigen ;
   private String[] H004W2_A706Tpmo_SolicitaCentroDestino ;
   private boolean[] H004W2_n706Tpmo_SolicitaCentroDestino ;
   private String[] H004W2_A705Tpmo_SolicitaRegionDestino ;
   private boolean[] H004W2_n705Tpmo_SolicitaRegionDestino ;
   private String[] H004W2_A680Tpmo_CuentaResponsabilidad ;
   private boolean[] H004W2_n680Tpmo_CuentaResponsabilidad ;
   private String[] H004W2_A679Tpmo_Estado ;
   private boolean[] H004W2_n679Tpmo_Estado ;
   private String[] H004W2_A641Tpmo_VidaUtil ;
   private boolean[] H004W2_n641Tpmo_VidaUtil ;
   private String[] H004W2_A633Tpmo_Controlado ;
   private boolean[] H004W2_n633Tpmo_Controlado ;
   private long[] H004W2_A595Tpmo_ConsecutivoTrans ;
   private boolean[] H004W2_n595Tpmo_ConsecutivoTrans ;
   private String[] H004W2_A480Tipo_Tipo ;
   private String[] H004W2_A441Tpmo_IngresaCurso ;
   private String[] H004W2_A440Tpmo_IngresaAredante ;
   private String[] H004W2_A316Tpmo_Modulo ;
   private java.util.Date[] H004W2_A320Tpmo_FechaModifica ;
   private boolean[] H004W2_n320Tpmo_FechaModifica ;
   private String[] H004W2_A319Tpmo_UsuarioModifica ;
   private boolean[] H004W2_n319Tpmo_UsuarioModifica ;
   private java.util.Date[] H004W2_A318Tpmo_FechaCrea ;
   private String[] H004W2_A317Tpmo_UsuarioCrea ;
   private String[] H004W2_A315Tpmo_TipoE_S ;
   private String[] H004W2_A312Tpmo_AlmacenOrigenDescrip ;
   private boolean[] H004W2_n312Tpmo_AlmacenOrigenDescrip ;
   private long[] H004W2_A39Tpmo_AlmacenOrigenId ;
   private String[] H004W2_A253Tipo_Descripcion ;
   private long[] H004W2_A33Tipo_Codigo ;
   private String[] H004W2_A313Tpmo_Descripcion ;
   private String[] H004W2_A38Tpmo_Codigo ;
...
final  class alm_tipo_almacenalm_tipo_movimiento1wc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H004W2", "SELECT T1.Tpmo_AlmacenDestinoId, T1.Tmpo_ImprimeResponsable, T1.Tpmo_ImprimeDestino, T1.Tpmo_ImprimeOrigen, T1.Tpmo_SolicitaCentroDestino, T1.Tpmo_SolicitaRegionDestino, T1.Tpmo_CuentaResponsabilidad, T1.Tpmo_Estado, T1.Tpmo_VidaUtil, T1.Tpmo_Controlado, T1.Tpmo_ConsecutivoTrans, T3.Tipo_Tipo, T1.Tpmo_IngresaCurso, T1.Tpmo_IngresaAredante, T1.Tpmo_Modulo, T1.Tpmo_FechaModifica, T1.Tpmo_UsuarioModifica, T1.Tpmo_FechaCrea, T1.Tpmo_UsuarioCrea, T1.Tpmo_TipoE_S, T2.Tpal_Descripcion AS Tpmo_AlmacenOrigenDescrip, T1.Tpmo_AlmacenOrigenId AS Tpmo_AlmacenOrigenId, T3.Tipo_Descripcion, T1.Tipo_Codigo, T1.Tpmo_Descripcion, T1.Tpmo_Codigo FROM ((ALM_TIPO_MOVIMIENTO T1 INNER JOIN ALM_TIPO_ALMACEN T2 ON T2.Tpal_Id = T1.Tpmo_AlmacenOrigenId) INNER JOIN ALM_TIPO_ELEMENTO T3 ON T3.Tipo_Codigo = T1.Tipo_Codigo) WHERE T1.Tpmo_AlmacenDestinoId = ? ORDER BY T1.Tpmo_AlmacenDestinoId  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H004W3", "SELECT COUNT(*) FROM ((ALM_TIPO_MOVIMIENTO T1 INNER JOIN ALM_TIPO_ALMACEN T3 ON T3.Tpal_Id = T1.Tpmo_AlmacenOrigenId) INNER JOIN ALM_TIPO_ELEMENTO T2 ON T2.Tipo_Codigo = T1.Tipo_Codigo) WHERE T1.Tpmo_AlmacenDestinoId = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
