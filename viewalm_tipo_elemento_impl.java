/*
               File: viewalm_tipo_elemento_impl
        Description: View ALM_TIPO_ELEMENTO
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:19:34.36
...
public final  class viewalm_tipo_elemento_impl extends GXDataArea
{
   public viewalm_tipo_elemento_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public viewalm_tipo_elemento_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( viewalm_tipo_elemento_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV13Tipo_Codigo = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV13Tipo_Codigo", GXutil.ltrim( GXutil.str( AV13Tipo_Codigo, 18, 0)));
            httpContext.ajax_rsp_assign_attri("", false, "gxhash_vTIPO_CODIGO", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV13Tipo_Codigo), "ZZZZZZZZZZZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414193439");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.viewalm_tipo_elemento") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13Tipo_Codigo,18,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV7TabCode))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vTIPO_CODIGO", GXutil.ltrim( localUtil.ntoc( AV13Tipo_Codigo, (byte)(18), (byte)(0), ",", "")));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTIPO_CODIGO", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV13Tipo_Codigo), "ZZZZZZZZZZZZZZZZZ9")));
      ...
      forbiddenHiddens = "hsh" + "ViewALM_TIPO_ELEMENTO" ;
      forbiddenHiddens = forbiddenHiddens + GXutil.rtrim( localUtil.format( A253Tipo_Descripcion, "@!")) ;
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "hsh", GXutil.getEncryptedSignature( forbiddenHiddens, GXKey));
      GXutil.writeLogln("viewalm_tipo_elemento:[SendSecurityCheck]"+forbiddenHiddens);
   }
   ...
   {
      return formatLink("com.orions2.viewalm_tipo_elemento") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13Tipo_Codigo,18,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV7TabCode)) ;
   }

   public String getPgmname( )
   {
      return "ViewALM_TIPO_ELEMENTO" ;
   }

   public String getPgmdesc( )
   {
      return "View ALM_TIPO_ELEMENTO" ;
   }
   ...
   public void wb450( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, "Tipo de elemento Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_ViewALM_TIPO_ELEMENTO.htm");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblViewall_Internalname, "Lista tipo elementos", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, (short)(0), "HLP_ViewALM_TIPO_ELEMENTO.htm");
         ...
         com.orions2.GxWebStd.gx_label_element( httpContext, edtTipo_Descripcion_Internalname, "Elemento", "col-sm-3 ReadonlyAttributeLabel", 1, true);
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtTipo_Descripcion_Internalname, A253Tipo_Descripcion, GXutil.rtrim( localUtil.format( A253Tipo_Descripcion, "@!")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTipo_Descripcion_Jsonclick, 0, "ReadonlyAttribute", "", "", "", 1, edtTipo_Descripcion_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "Nombres", "left", true, "HLP_ViewALM_TIPO_ELEMENTO.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewALM_TIPO_ELEMENTO.htm");
         /* Div Control */
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblAlm_tipo_movimiento_title_Internalname, "Tipo de movimiento", "", "", lblAlm_tipo_movimiento_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewALM_TIPO_ELEMENTO.htm");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblAlm_elemento_title_Internalname, "Elemento", "", "", lblAlm_elemento_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewALM_TIPO_ELEMENTO.htm");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         ...
         {
            /* WebComponent */
            com.orions2.GxWebStd.gx_hidden_field( httpContext, "W0045"+"", GXutil.rtrim( WebComp_Alm_elementowc_Component));
            httpContext.writeText( "<div") ;
            com.orions2.GxWebStd.classAttribute( httpContext, "gxwebcomponent");
   ...
   public void start452( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "View ALM_TIPO_ELEMENTO", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
            ...
            if ( GXutil.len( sEvt) > 0 )
            {
               ...
               if ( GXutil.strcmp(sEvtType, "M") != 0 )
               {
                  ...
                  else if ( GXutil.strcmp(sEvtType, "W") == 0 )
                  {
                     ...
                     {
                        OldAlm_elementowc = httpContext.cgiGet( "W0045") ;
                        ...
                        if ( GXutil.len( WebComp_Alm_elementowc_Component) != 0 )
                        {
                           WebComp_Alm_elementowc.componentprocess("W0045", "", sEvt);
                        }
                        WebComp_Alm_elementowc_Component = OldAlm_elementowc ;
                     }
                  }
   ...
   {
      /* GeneXus formulas. */
      AV16Pgmname = "ViewALM_TIPO_ELEMENTO" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf452( )
   {
      ...
      {
         /* Using cursor H00452 */
         pr_default.execute(0, new Object[] {new Long(AV13Tipo_Codigo)});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A33Tipo_Codigo = H00452_A33Tipo_Codigo[0] ;
            A253Tipo_Descripcion = H00452_A253Tipo_Descripcion[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A253Tipo_Descripcion", A253Tipo_Descripcion);
            httpContext.ajax_rsp_assign_attri("", false, "gxhash_TIPO_DESCRIPCION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A253Tipo_Descripcion, "@!"))));
            /* Execute user event: Load */
            e12452 ();
   ...
   public void strup450( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         httpContext.ajax_rsp_assign_attri("", false, "gxhash_TIPO_DESCRIPCION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A253Tipo_Descripcion, "@!"))));
         /* Read saved values. */
         AV13Tipo_Codigo = localUtil.ctol( httpContext.cgiGet( "vTIPO_CODIGO"), ",", ".") ;
         ...
         GXKey = com.genexus.util.Encryption.decrypt64( httpContext.getCookie( "GX_SESSION_ID"), context.getServerKey( )) ;
         forbiddenHiddens = "hsh" + "ViewALM_TIPO_ELEMENTO" ;
         A253Tipo_Descripcion = httpContext.cgiGet( edtTipo_Descripcion_Internalname) ;
         httpContext.ajax_rsp_assign_attri("", false, "A253Tipo_Descripcion", A253Tipo_Descripcion);
         httpContext.ajax_rsp_assign_attri("", false, "gxhash_TIPO_DESCRIPCION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A253Tipo_Descripcion, "@!"))));
         forbiddenHiddens = forbiddenHiddens + GXutil.rtrim( localUtil.format( A253Tipo_Descripcion, "@!")) ;
         ...
         if ( ! GXutil.checkEncryptedSignature( forbiddenHiddens, hsh, GXKey) )
         {
            ...
            GXutil.writeLog("viewalm_tipo_elemento:[SecurityCheckFailed]"+forbiddenHiddens);
            return  ;
         }
      }
      else
   ...
   public void e11452( )
   {
      ...
      AV17GXLvl6 = (byte)(0) ;
      /* Using cursor H00453 */
      pr_default.execute(1, new Object[] {new Long(AV13Tipo_Codigo)});
      while ( (pr_default.getStatus(1) != 101) )
      {
         A33Tipo_Codigo = H00453_A33Tipo_Codigo[0] ;
         A253Tipo_Descripcion = H00453_A253Tipo_Descripcion[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A253Tipo_Descripcion", A253Tipo_Descripcion);
         httpContext.ajax_rsp_assign_attri("", false, "gxhash_TIPO_DESCRIPCION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A253Tipo_Descripcion, "@!"))));
         AV17GXLvl6 = (byte)(1) ;
         Form.setCaption( A253Tipo_Descripcion );
         httpContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.getCaption(), true);
         lblViewall_Link = formatLink("com.orions2.wwalm_tipo_elemento")  ;
   ...
   public void S112( )
   {
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "ALM_TIPO_ELEMENTOGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.orions2.alm_tipo_elementogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "ALM_TIPO_ELEMENTOGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0029","",new Long(AV13Tipo_Codigo)});
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Alm_tipo_movimientowc_Component), GXutil.lower( "ALM_TIPO_ELEMENTOALM_TIPO_MOVIMIENTOWC")) != 0 )
         {
            WebComp_Alm_tipo_movimientowc = WebUtils.getWebComponent(getClass(), "com.orions2.alm_tipo_elementoalm_tipo_movimientowc_impl", remoteHandle, context);
            WebComp_Alm_tipo_movimientowc_Component = "ALM_TIPO_ELEMENTOALM_TIPO_MOVIMIENTOWC" ;
         }
         if ( GXutil.len( WebComp_Alm_tipo_movimientowc_Component) != 0 )
         {
            WebComp_Alm_tipo_movimientowc.setjustcreated();
            WebComp_Alm_tipo_movimientowc.componentprepare(new Object[] {"W0037","",new Long(AV13Tipo_Codigo)});
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Alm_elementowc_Component), GXutil.lower( "ALM_TIPO_ELEMENTOALM_ELEMENTOWC")) != 0 )
         {
            WebComp_Alm_elementowc = WebUtils.getWebComponent(getClass(), "com.orions2.alm_tipo_elementoalm_elementowc_impl", remoteHandle, context);
            WebComp_Alm_elementowc_Component = "ALM_TIPO_ELEMENTOALM_ELEMENTOWC" ;
         }
         if ( GXutil.len( WebComp_Alm_elementowc_Component) != 0 )
         {
            WebComp_Alm_elementowc.setjustcreated();
            WebComp_Alm_elementowc.componentprepare(new Object[] {"W0045","",new Long(AV13Tipo_Codigo)});
   ...
   {
      AV13Tipo_Codigo = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV13Tipo_Codigo", GXutil.ltrim( GXutil.str( AV13Tipo_Codigo, 18, 0)));
      httpContext.ajax_rsp_assign_attri("", false, "gxhash_vTIPO_CODIGO", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV13Tipo_Codigo), "ZZZZZZZZZZZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414193477");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("viewalm_tipo_elemento.js", "?201861414193477");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "");
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "View ALM_TIPO_ELEMENTO" );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   public void initialize( )
   {
      ...
      AV16Pgmname = "" ;
      scmdbuf = "" ;
      H00452_A33Tipo_Codigo = new long[1] ;
      H00452_A253Tipo_Descripcion = new String[] {""} ;
      hsh = "" ;
      H00453_A33Tipo_Codigo = new long[1] ;
      H00453_A253Tipo_Descripcion = new String[] {""} ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.viewalm_tipo_elemento__default(),
         new Object[] {
             new Object[] {
            H00452_A33Tipo_Codigo, H00452_A253Tipo_Descripcion
            }
            , new Object[] {
            H00453_A33Tipo_Codigo, H00453_A253Tipo_Descripcion
            }
         }
      );
      AV16Pgmname = "ViewALM_TIPO_ELEMENTO" ;
   ...
   private int idxLst ;
   private long wcpOAV13Tipo_Codigo ;
   private long AV13Tipo_Codigo ;
   ...
   private long[] H00452_A33Tipo_Codigo ;
   private String[] H00452_A253Tipo_Descripcion ;
   private long[] H00453_A33Tipo_Codigo ;
   private String[] H00453_A253Tipo_Descripcion ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class viewalm_tipo_elemento__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00452", "SELECT Tipo_Codigo, Tipo_Descripcion FROM ALM_TIPO_ELEMENTO WHERE Tipo_Codigo = ? ORDER BY Tipo_Codigo ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H00453", "SELECT Tipo_Codigo, Tipo_Descripcion FROM ALM_TIPO_ELEMENTO WHERE Tipo_Codigo = ? ORDER BY Tipo_Codigo ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
