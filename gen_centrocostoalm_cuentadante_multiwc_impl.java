/*
               File: gen_centrocostoalm_cuentadante_multiwc_impl
        Description: GEN_CENTROCOSTOALM_CUENTADANTE_MULTIWC
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:14:41.48
...
public final  class gen_centrocostoalm_cuentadante_multiwc_impl extends GXWebComponent
{
   public gen_centrocostoalm_cuentadante_multiwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public gen_centrocostoalm_cuentadante_multiwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( gen_centrocostoalm_cuentadante_multiwc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Cent_Id, AV12Update, AV13Delete, A43Cuen_Identificacion, A42Tpte_Codigo, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "GEN_CENTROCOSTOALM_CUENTADANTE_MULTIWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414144152");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.gen_centrocostoalm_cuentadante_multiwc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Cent_Id,11,0)))+"\">") ;
   ...
   public void renderHtmlCloseForm0K2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("gen_centrocostoalm_cuentadante_multiwc.js", "?201861414144156");
      }
   ...
   {
      return "GEN_CENTROCOSTOALM_CUENTADANTE_MULTIWC" ;
   }
   ...
   public void wb0K0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.gen_centrocostoalm_cuentadante_multiwc");
         }
         /* Div Control */
      ...
      if ( wbEnd == 20 )
      {
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtCent_Id_Internalname, GXutil.ltrim( localUtil.ntoc( A1Cent_Id, (byte)(11), (byte)(0), ",", "")), ((edtCent_Id_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1Cent_Id), "ZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A1Cent_Id), "ZZZZZZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCent_Id_Jsonclick, 0, "Attribute", "", "", "", edtCent_Id_Visible, edtCent_Id_Enabled, 0, "text", "", 11, "chr", 1, "row", 11, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Identificador", "right", false, "HLP_GEN_CENTROCOSTOALM_CUENTADANTE_MULTIWC.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start0K2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "GEN_CENTROCOSTOALM_CUENTADANTE_MULTIWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "GEN_CENTROCOSTOALM_CUENTADANTE_MULTIWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf0K2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A1Cent_Id = H000K2_A1Cent_Id[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1Cent_Id", GXutil.ltrim( GXutil.str( A1Cent_Id, 11, 0)));
            A340Cuen_FechaModifica = H000K2_A340Cuen_FechaModifica[0] ;
            n340Cuen_FechaModifica = H000K2_n340Cuen_FechaModifica[0] ;
            A339Cuen_UsuarioModifica = H000K2_A339Cuen_UsuarioModifica[0] ;
            n339Cuen_UsuarioModifica = H000K2_n339Cuen_UsuarioModifica[0] ;
            A338Cuen_FechaCrea = H000K2_A338Cuen_FechaCrea[0] ;
            A337Cuen_UsuarioCrea = H000K2_A337Cuen_UsuarioCrea[0] ;
            A336Cuen_Email = H000K2_A336Cuen_Email[0] ;
            n336Cuen_Email = H000K2_n336Cuen_Email[0] ;
            A335Cuen_Telefono = H000K2_A335Cuen_Telefono[0] ;
            n335Cuen_Telefono = H000K2_n335Cuen_Telefono[0] ;
            A334Cuen_Direccion = H000K2_A334Cuen_Direccion[0] ;
            n334Cuen_Direccion = H000K2_n334Cuen_Direccion[0] ;
            A333Cuen_Estado = H000K2_A333Cuen_Estado[0] ;
            n333Cuen_Estado = H000K2_n333Cuen_Estado[0] ;
            A328Cuen_Clase = H000K2_A328Cuen_Clase[0] ;
            n328Cuen_Clase = H000K2_n328Cuen_Clase[0] ;
            A321Tpte_Descripcion = H000K2_A321Tpte_Descripcion[0] ;
            A42Tpte_Codigo = H000K2_A42Tpte_Codigo[0] ;
            A44Cuen_Nombre = H000K2_A44Cuen_Nombre[0] ;
            n44Cuen_Nombre = H000K2_n44Cuen_Nombre[0] ;
            A330Cuen_SegundoApellido = H000K2_A330Cuen_SegundoApellido[0] ;
            n330Cuen_SegundoApellido = H000K2_n330Cuen_SegundoApellido[0] ;
            A329Cuen_PrimerApellido = H000K2_A329Cuen_PrimerApellido[0] ;
            n329Cuen_PrimerApellido = H000K2_n329Cuen_PrimerApellido[0] ;
            A332Cuen_SegundoNombre = H000K2_A332Cuen_SegundoNombre[0] ;
            n332Cuen_SegundoNombre = H000K2_n332Cuen_SegundoNombre[0] ;
            A331Cuen_PrimerNombre = H000K2_A331Cuen_PrimerNombre[0] ;
            n331Cuen_PrimerNombre = H000K2_n331Cuen_PrimerNombre[0] ;
            A326Cuen_DigitoVerificacion = H000K2_A326Cuen_DigitoVerificacion[0] ;
            n326Cuen_DigitoVerificacion = H000K2_n326Cuen_DigitoVerificacion[0] ;
            A688Cuen_Cedula = H000K2_A688Cuen_Cedula[0] ;
            A43Cuen_Identificacion = H000K2_A43Cuen_Identificacion[0] ;
            A321Tpte_Descripcion = H000K2_A321Tpte_Descripcion[0] ;
            e130K2 ();
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "gen_centrocostoalm_cuentadante_multiwc");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414144226");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("gen_centrocostoalm_cuentadante_multiwc.js", "?201861414144226");
      }
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H000K2_A1Cent_Id = new long[1] ;
      H000K2_A340Cuen_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H000K2_n340Cuen_FechaModifica = new boolean[] {false} ;
      H000K2_A339Cuen_UsuarioModifica = new String[] {""} ;
      H000K2_n339Cuen_UsuarioModifica = new boolean[] {false} ;
      H000K2_A338Cuen_FechaCrea = new java.util.Date[] {GXutil.nullDate()} ;
      H000K2_A337Cuen_UsuarioCrea = new String[] {""} ;
      H000K2_A336Cuen_Email = new String[] {""} ;
      H000K2_n336Cuen_Email = new boolean[] {false} ;
      H000K2_A335Cuen_Telefono = new String[] {""} ;
      H000K2_n335Cuen_Telefono = new boolean[] {false} ;
      H000K2_A334Cuen_Direccion = new String[] {""} ;
      H000K2_n334Cuen_Direccion = new boolean[] {false} ;
      H000K2_A333Cuen_Estado = new String[] {""} ;
      H000K2_n333Cuen_Estado = new boolean[] {false} ;
      H000K2_A328Cuen_Clase = new String[] {""} ;
      H000K2_n328Cuen_Clase = new boolean[] {false} ;
      H000K2_A321Tpte_Descripcion = new String[] {""} ;
      H000K2_A42Tpte_Codigo = new String[] {""} ;
      H000K2_A44Cuen_Nombre = new String[] {""} ;
      H000K2_n44Cuen_Nombre = new boolean[] {false} ;
      H000K2_A330Cuen_SegundoApellido = new String[] {""} ;
      H000K2_n330Cuen_SegundoApellido = new boolean[] {false} ;
      H000K2_A329Cuen_PrimerApellido = new String[] {""} ;
      H000K2_n329Cuen_PrimerApellido = new boolean[] {false} ;
      H000K2_A332Cuen_SegundoNombre = new String[] {""} ;
      H000K2_n332Cuen_SegundoNombre = new boolean[] {false} ;
      H000K2_A331Cuen_PrimerNombre = new String[] {""} ;
      H000K2_n331Cuen_PrimerNombre = new boolean[] {false} ;
      H000K2_A326Cuen_DigitoVerificacion = new byte[1] ;
      H000K2_n326Cuen_DigitoVerificacion = new boolean[] {false} ;
      H000K2_A688Cuen_Cedula = new long[1] ;
      H000K2_A43Cuen_Identificacion = new long[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.gen_centrocostoalm_cuentadante_multiwc__default(),
         new Object[] {
             new Object[] {
            H000K2_A1Cent_Id, H000K2_A340Cuen_FechaModifica, H000K2_n340Cuen_FechaModifica, H000K2_A339Cuen_UsuarioModifica, H000K2_n339Cuen_UsuarioModifica, H000K2_A338Cuen_FechaCrea, H000K2_A337Cuen_UsuarioCrea, H000K2_A336Cuen_Email, H000K2_n336Cuen_Email, H000K2_A335Cuen_Telefono,
            H000K2_n335Cuen_Telefono, H000K2_A334Cuen_Direccion, H000K2_n334Cuen_Direccion, H000K2_A333Cuen_Estado, H000K2_n333Cuen_Estado, H000K2_A328Cuen_Clase, H000K2_n328Cuen_Clase, H000K2_A321Tpte_Descripcion, H000K2_A42Tpte_Codigo, H000K2_A44Cuen_Nombre,
            H000K2_n44Cuen_Nombre, H000K2_A330Cuen_SegundoApellido, H000K2_n330Cuen_SegundoApellido, H000K2_A329Cuen_PrimerApellido, H000K2_n329Cuen_PrimerApellido, H000K2_A332Cuen_SegundoNombre, H000K2_n332Cuen_SegundoNombre, H000K2_A331Cuen_PrimerNombre, H000K2_n331Cuen_PrimerNombre, H000K2_A326Cuen_DigitoVerificacion,
            H000K2_n326Cuen_DigitoVerificacion, H000K2_A688Cuen_Cedula, H000K2_A43Cuen_Identificacion
            }
            , new Object[] {
   ...
   private long[] H000K2_A1Cent_Id ;
   private java.util.Date[] H000K2_A340Cuen_FechaModifica ;
   private boolean[] H000K2_n340Cuen_FechaModifica ;
   private String[] H000K2_A339Cuen_UsuarioModifica ;
   private boolean[] H000K2_n339Cuen_UsuarioModifica ;
   private java.util.Date[] H000K2_A338Cuen_FechaCrea ;
   private String[] H000K2_A337Cuen_UsuarioCrea ;
   private String[] H000K2_A336Cuen_Email ;
   private boolean[] H000K2_n336Cuen_Email ;
   private String[] H000K2_A335Cuen_Telefono ;
   private boolean[] H000K2_n335Cuen_Telefono ;
   private String[] H000K2_A334Cuen_Direccion ;
   private boolean[] H000K2_n334Cuen_Direccion ;
   private String[] H000K2_A333Cuen_Estado ;
   private boolean[] H000K2_n333Cuen_Estado ;
   private String[] H000K2_A328Cuen_Clase ;
   private boolean[] H000K2_n328Cuen_Clase ;
   private String[] H000K2_A321Tpte_Descripcion ;
   private String[] H000K2_A42Tpte_Codigo ;
   private String[] H000K2_A44Cuen_Nombre ;
   private boolean[] H000K2_n44Cuen_Nombre ;
   private String[] H000K2_A330Cuen_SegundoApellido ;
   private boolean[] H000K2_n330Cuen_SegundoApellido ;
   private String[] H000K2_A329Cuen_PrimerApellido ;
   private boolean[] H000K2_n329Cuen_PrimerApellido ;
   private String[] H000K2_A332Cuen_SegundoNombre ;
   private boolean[] H000K2_n332Cuen_SegundoNombre ;
   private String[] H000K2_A331Cuen_PrimerNombre ;
   private boolean[] H000K2_n331Cuen_PrimerNombre ;
   private byte[] H000K2_A326Cuen_DigitoVerificacion ;
   private boolean[] H000K2_n326Cuen_DigitoVerificacion ;
   private long[] H000K2_A688Cuen_Cedula ;
   private long[] H000K2_A43Cuen_Identificacion ;
