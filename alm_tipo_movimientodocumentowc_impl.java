/*
               File: alm_tipo_movimientodocumentowc_impl
        Description: ALM_TIPO_MOVIMIENTODOCUMENTOWC
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:10:32.35
...
public final  class alm_tipo_movimientodocumentowc_impl extends GXWebComponent
{
   public alm_tipo_movimientodocumentowc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public alm_tipo_movimientodocumentowc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( alm_tipo_movimientodocumentowc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Tpmo_Codigo, A819Docu_Nro, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "ALM_TIPO_MOVIMIENTODOCUMENTOWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414103238");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.alm_tipo_movimientodocumentowc") + "?" + GXutil.URLEncode(GXutil.rtrim(AV7Tpmo_Codigo))+"\">") ;
   ...
   public void renderHtmlCloseForm962( )
   {
      ...
      {
         httpContext.AddJavascriptSource("alm_tipo_movimientodocumentowc.js", "?201861414103240");
      }
   ...
   public void wb960( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.alm_tipo_movimientodocumentowc");
         }
         /* Div Control */
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Link", GXutil.rtrim( edtDocu_Descripcion_Link));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
      ...
      if ( wbEnd == 12 )
      {
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtTpmo_Codigo_Internalname, A38Tpmo_Codigo, GXutil.rtrim( localUtil.format( A38Tpmo_Codigo, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTpmo_Codigo_Jsonclick, 0, "Attribute", "", "", "", edtTpmo_Codigo_Visible, edtTpmo_Codigo_Enabled, 0, "text", "", 3, "chr", 1, "row", 3, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_ALM_TIPO_MOVIMIENTODOCUMENTOWC.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start962( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "ALM_TIPO_MOVIMIENTODOCUMENTOWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_DOCU_NRO", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(A819Docu_Nro), "ZZZ9")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"DOCU_NRO", GXutil.ltrim( localUtil.ntoc( A819Docu_Nro, (byte)(4), (byte)(0), ".", "")));
   }
   ...
   {
      /* GeneXus formulas. */
      AV15Pgmname = "ALM_TIPO_MOVIMIENTODOCUMENTOWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf962( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A38Tpmo_Codigo = H00962_A38Tpmo_Codigo[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A38Tpmo_Codigo", A38Tpmo_Codigo);
            A821Docu_Prefijo = H00962_A821Docu_Prefijo[0] ;
            n821Docu_Prefijo = H00962_n821Docu_Prefijo[0] ;
            A820Docu_Descripcion = H00962_A820Docu_Descripcion[0] ;
            n820Docu_Descripcion = H00962_n820Docu_Descripcion[0] ;
            A819Docu_Nro = H00962_A819Docu_Nro[0] ;
            A821Docu_Prefijo = H00962_A821Docu_Prefijo[0] ;
            n821Docu_Prefijo = H00962_n821Docu_Prefijo[0] ;
            A820Docu_Descripcion = H00962_A820Docu_Descripcion[0] ;
            n820Docu_Descripcion = H00962_n820Docu_Descripcion[0] ;
   ...
   public int subgrid_recordcount( )
   {
      ...
      GRID_nRecordCount = H00963_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   {
      /* Grid_Load Routine */
      edtDocu_Descripcion_Link = formatLink("com.orions2.viewalm_documentos") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A819Docu_Nro,4,0))) + "," + GXutil.URLEncode(GXutil.rtrim("")) ;
      /* Load Method */
      if ( wbStart != -1 )
      {
         wbStart = (short)(12) ;
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "alm_tipo_movimientodocumentowc");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414103269");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("alm_tipo_movimientodocumentowc.js", "?201861414103269");
      }
   ...
   {
      edtDocu_Nro_Internalname = sPrefix+"DOCU_NRO_"+sGXsfl_12_idx ;
      edtDocu_Descripcion_Internalname = sPrefix+"DOCU_DESCRIPCION_"+sGXsfl_12_idx ;
      edtDocu_Prefijo_Internalname = sPrefix+"DOCU_PREFIJO_"+sGXsfl_12_idx ;
   }

   public void subsflControlProps_fel_122( )
   {
      edtDocu_Nro_Internalname = sPrefix+"DOCU_NRO_"+sGXsfl_12_fel_idx ;
      edtDocu_Descripcion_Internalname = sPrefix+"DOCU_DESCRIPCION_"+sGXsfl_12_fel_idx ;
      edtDocu_Prefijo_Internalname = sPrefix+"DOCU_PREFIJO_"+sGXsfl_12_fel_idx ;
   }
   ...
   public void sendrow_122( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_12_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtDocu_Nro_Internalname,GXutil.ltrim( localUtil.ntoc( A819Docu_Nro, (byte)(4), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A819Docu_Nro), "ZZZ9"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtDocu_Nro_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(4),new Integer(0),new Integer(0),new Integer(12),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtDocu_Prefijo_Internalname,A821Docu_Prefijo,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtDocu_Prefijo_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(12),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_DOCU_NRO"+"_"+sGXsfl_12_idx, getSecureSignedToken( sPrefix+sGXsfl_12_idx, localUtil.format( DecimalUtil.doubleToDec(A819Docu_Nro), "ZZZ9")));
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Tpmo_Codigo',fld:'vTPMO_CODIGO',pic:'',nv:''},{av:'A819Docu_Nro',fld:'DOCU_NRO',pic:'ZZZ9',hsh:true,nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e12962',iparms:[{av:'A819Docu_Nro',fld:'DOCU_NRO',pic:'ZZZ9',hsh:true,nv:0}],oparms:[{av:'edtDocu_Descripcion_Link',ctrl:'DOCU_DESCRIPCION',prop:'Link'}]}");
      setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Tpmo_Codigo',fld:'vTPMO_CODIGO',pic:'',nv:''},{av:'A819Docu_Nro',fld:'DOCU_NRO',pic:'ZZZ9',hsh:true,nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Tpmo_Codigo',fld:'vTPMO_CODIGO',pic:'',nv:''},{av:'A819Docu_Nro',fld:'DOCU_NRO',pic:'ZZZ9',hsh:true,nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Tpmo_Codigo',fld:'vTPMO_CODIGO',pic:'',nv:''},{av:'A819Docu_Nro',fld:'DOCU_NRO',pic:'ZZZ9',hsh:true,nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Tpmo_Codigo',fld:'vTPMO_CODIGO',pic:'',nv:''},{av:'A819Docu_Nro',fld:'DOCU_NRO',pic:'ZZZ9',hsh:true,nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
   }
   ...
   public void initialize( )
   {
      ...
      AV15Pgmname = "" ;
      scmdbuf = "" ;
      H00962_A38Tpmo_Codigo = new String[] {""} ;
      H00962_A821Docu_Prefijo = new String[] {""} ;
      H00962_n821Docu_Prefijo = new boolean[] {false} ;
      H00962_A820Docu_Descripcion = new String[] {""} ;
      H00962_n820Docu_Descripcion = new boolean[] {false} ;
      H00962_A819Docu_Nro = new short[1] ;
      H00963_AGRID_nRecordCount = new long[1] ;
      ...
      sCtrlAV7Tpmo_Codigo = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.alm_tipo_movimientodocumentowc__default(),
         new Object[] {
             new Object[] {
            H00962_A38Tpmo_Codigo, H00962_A821Docu_Prefijo, H00962_n821Docu_Prefijo, H00962_A820Docu_Descripcion, H00962_n820Docu_Descripcion, H00962_A819Docu_Nro
            }
            , new Object[] {
            H00963_AGRID_nRecordCount
            }
         }
      );
      AV15Pgmname = "ALM_TIPO_MOVIMIENTODOCUMENTOWC" ;
   ...
   private String[] H00962_A38Tpmo_Codigo ;
   private String[] H00962_A821Docu_Prefijo ;
   private boolean[] H00962_n821Docu_Prefijo ;
   private String[] H00962_A820Docu_Descripcion ;
   private boolean[] H00962_n820Docu_Descripcion ;
   private short[] H00962_A819Docu_Nro ;
   private long[] H00963_AGRID_nRecordCount ;
...
final  class alm_tipo_movimientodocumentowc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00962", "SELECT T1.Tpmo_Codigo, T2.Docu_Prefijo, T2.Docu_Descripcion, T1.Docu_Nro FROM (ALM_TIPO_MOVIMIENTO_DOCUMENTO T1 INNER JOIN ALM_DOCUMENTOS T2 ON T2.Docu_Nro = T1.Docu_Nro) WHERE T1.Tpmo_Codigo = ? ORDER BY T1.Tpmo_Codigo  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H00963", "SELECT COUNT(*) FROM (ALM_TIPO_MOVIMIENTO_DOCUMENTO T1 INNER JOIN ALM_DOCUMENTOS T2 ON T2.Docu_Nro = T1.Docu_Nro) WHERE T1.Tpmo_Codigo = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
