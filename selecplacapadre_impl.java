/*
               File: selecplacapadre_impl
        Description: Seleccionar Placas
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:23:6.47
...
public final  class selecplacapadre_impl extends GXDataArea
{
   public selecplacapadre_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public selecplacapadre_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( selecplacapadre_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
         {
            ...
            AV45Tipo = httpContext.GetNextPar( ) ;
            AV46Regi_Id = GXutil.lval( httpContext.GetNextPar( )) ;
            AV47PlacaSelecc = httpContext.GetNextPar( ) ;
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV45Tipo = httpContext.GetNextPar( ) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV45Tipo", AV45Tipo);
               AV46Regi_Id = GXutil.lval( httpContext.GetNextPar( )) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV46Regi_Id", GXutil.ltrim( GXutil.str( AV46Regi_Id, 11, 0)));
               AV41Tran_IdEntrada = GXutil.lval( httpContext.GetNextPar( )) ;
               ...
               AV47PlacaSelecc = httpContext.GetNextPar( ) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV47PlacaSelecc", AV47PlacaSelecc);
            }
         }
         if ( httpContext.isSpaRequest( ) )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20186141423662");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.selecplacapadre") + "?" + GXutil.URLEncode(GXutil.rtrim(AV29Placa)) + "," + GXutil.URLEncode(GXutil.rtrim(AV45Tipo)) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV46Regi_Id,11,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV41Tran_IdEntrada,11,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV25Nro_Linea,8,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV47PlacaSelecc))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vTIPO", GXutil.rtrim( AV45Tipo));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vREGI_ID", GXutil.ltrim( localUtil.ntoc( AV46Regi_Id, (byte)(11), (byte)(0), ",", "")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vPLACASELECC", AV47PlacaSelecc);
   ...
   {
      return formatLink("com.orions2.selecplacapadre") + "?" + GXutil.URLEncode(GXutil.rtrim(AV29Placa)) + "," + GXutil.URLEncode(GXutil.rtrim(AV45Tipo)) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV46Regi_Id,11,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV41Tran_IdEntrada,11,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV25Nro_Linea,8,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV47PlacaSelecc)) ;
   }

   public String getPgmname( )
   {
      return "SelecPlacaPadre" ;
   }

   public String getPgmdesc( )
   {
      return "Seleccionar Placas" ;
   }
   ...
   public void wb7Z0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblinvd_numeroplacafilter_Internalname, "Número de placa", "", "", lblLblinvd_numeroplacafilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e117z1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_SelecPlacaPadre.htm");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavCinvd_numeroplaca_Internalname, AV14cInvd_NumeroPlaca, GXutil.rtrim( localUtil.format( AV14cInvd_NumeroPlaca, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCinvd_numeroplaca_Jsonclick, 0, "Attribute", "", "", "", edtavCinvd_numeroplaca_Visible, edtavCinvd_numeroplaca_Enabled, 0, "text", "", 30, "chr", 1, "row", 30, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_SelecPlacaPadre.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblinvd_descripcionidfilter_Internalname, "Descripción", "", "", lblLblinvd_descripcionidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e127z1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_SelecPlacaPadre.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblelem_consecutivofilter_Internalname, "Consecutivo", "", "", lblLblelem_consecutivofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e137z1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_SelecPlacaPadre.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavCelem_consecutivo_Internalname, AV7cElem_Consecutivo, GXutil.rtrim( localUtil.format( AV7cElem_Consecutivo, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCelem_consecutivo_Jsonclick, 0, "Attribute", "", "", "", edtavCelem_consecutivo_Visible, edtavCelem_consecutivo_Enabled, 0, "text", "", 9, "chr", 1, "row", 9, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_SelecPlacaPadre.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblinvd_placapadrefilter_Internalname, "Placa Padre", "", "", lblLblinvd_placapadrefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e147z1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_SelecPlacaPadre.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavCinvd_placapadre_Internalname, AV15cInvd_PlacaPadre, GXutil.rtrim( localUtil.format( AV15cInvd_PlacaPadre, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCinvd_placapadre_Jsonclick, 0, "Attribute", "", "", "", edtavCinvd_placapadre_Visible, edtavCinvd_placapadre_Enabled, 0, "text", "", 30, "chr", 1, "row", 30, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_SelecPlacaPadre.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblfechafilter_Internalname, "Fecha de Adquisición", "", "", lblLblfechafilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e157z1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_SelecPlacaPadre.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblmarcafilter_Internalname, "Marca", "", "", lblLblmarcafilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e167z1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_SelecPlacaPadre.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblmodelofilter_Internalname, "Modelo", "", "", lblLblmodelofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e177z1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_SelecPlacaPadre.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavCmodelo_Internalname, AV19cModelo, GXutil.rtrim( localUtil.format( AV19cModelo, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,76);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCmodelo_Jsonclick, 0, "Attribute", "", "", "", edtavCmodelo_Visible, edtavCmodelo_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_SelecPlacaPadre.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblserialfilter_Internalname, "Serial", "", "", lblLblserialfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e187z1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_SelecPlacaPadre.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 94, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e197z1_client"+"'", TempTags, "", 2, "HLP_SelecPlacaPadre.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      if ( wbEnd == 94 )
      {
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 94, 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_SelecPlacaPadre.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start7Z2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Seleccionar Placas", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 4), "LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) )
                        {
                           ...
                           httpContext.ajax_rsp_assign_prop("", false, edtavLinkselection_Internalname, "Bitmap", ((GXutil.strcmp("", AV22LinkSelection)==0) ? AV50Linkselection_GXI : httpContext.convertURL( httpContext.getResourceRelative(AV22LinkSelection))), !bGXsfl_94_Refreshing);
   ...
   public void rf7Z2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              new Long(AV46Regi_Id) } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.DATE, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.DATE,
                                              TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.LONG, TypeConstants.LONG
                                              }
         } ) ;
         ...
         /* Using cursor H007Z2 */
         pr_default.execute(0, new Object[] {new Long(AV46Regi_Id), lV14cInvd_NumeroPlaca, lV15cInvd_PlacaPadre, lV7cElem_Consecutivo, AV12cInvd_FechaAdquisicion, AV47PlacaSelecc});
         nGXsfl_94_idx = (short)(1) ;
         sGXsfl_94_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_94_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_942( ) ;
         GRID1_nEOF = (byte)(0) ;
         ...
         {
            brk7Z2 = false ;
            A37Cata_Codigo = H007Z2_A37Cata_Codigo[0] ;
            A298Cata_Descripcion = H007Z2_A298Cata_Descripcion[0] ;
            A463Invd_Estado = H007Z2_A463Invd_Estado[0] ;
            n463Invd_Estado = H007Z2_n463Invd_Estado[0] ;
            A68Invd_PlacaPadre = H007Z2_A68Invd_PlacaPadre[0] ;
            n68Invd_PlacaPadre = H007Z2_n68Invd_PlacaPadre[0] ;
            A66Elem_Consecutivo = H007Z2_A66Elem_Consecutivo[0] ;
            A466Invd_FechaAdquisicion = H007Z2_A466Invd_FechaAdquisicion[0] ;
            n466Invd_FechaAdquisicion = H007Z2_n466Invd_FechaAdquisicion[0] ;
            A501Invd_EsPlacaPadre = H007Z2_A501Invd_EsPlacaPadre[0] ;
            n501Invd_EsPlacaPadre = H007Z2_n501Invd_EsPlacaPadre[0] ;
            A410Invd_RegionalId = H007Z2_A410Invd_RegionalId[0] ;
            A67Invd_NumeroPlaca = H007Z2_A67Invd_NumeroPlaca[0] ;
            A631Vida_Util_Actual = H007Z2_A631Vida_Util_Actual[0] ;
            n631Vida_Util_Actual = H007Z2_n631Vida_Util_Actual[0] ;
            A628Otros_Costos_Dev = H007Z2_A628Otros_Costos_Dev[0] ;
            n628Otros_Costos_Dev = H007Z2_n628Otros_Costos_Dev[0] ;
            A626Variable_I = H007Z2_A626Variable_I[0] ;
            n626Variable_I = H007Z2_n626Variable_I[0] ;
            A627Variable_N = H007Z2_A627Variable_N[0] ;
            n627Variable_N = H007Z2_n627Variable_N[0] ;
            A625Variable_VF = H007Z2_A625Variable_VF[0] ;
            n625Variable_VF = H007Z2_n625Variable_VF[0] ;
            A465Invd_ValorAdquisicion = H007Z2_A465Invd_ValorAdquisicion[0] ;
            n465Invd_ValorAdquisicion = H007Z2_n465Invd_ValorAdquisicion[0] ;
            A414Invd_BodegaCodigo = H007Z2_A414Invd_BodegaCodigo[0] ;
            A413Invd_AlmacenCodigo = H007Z2_A413Invd_AlmacenCodigo[0] ;
            A412Invd_ModuloAlmacen = H007Z2_A412Invd_ModuloAlmacen[0] ;
            A411Invd_CentroCostoId = H007Z2_A411Invd_CentroCostoId[0] ;
            A629Costo_Total_Dev = H007Z2_A629Costo_Total_Dev[0] ;
            A37Cata_Codigo = H007Z2_A37Cata_Codigo[0] ;
            A298Cata_Descripcion = H007Z2_A298Cata_Descripcion[0] ;
   ...
   private void e217Z2( )
   {
      ...
      AV50Linkselection_GXI = GXDbFile.pathToUrl( context.getHttpContext().getImagePath( "3914535b-0c03-44c5-9538-906a99cdd2bc", "", context.getHttpContext().getTheme( )), context.getHttpContext()) ;
      GRID1_nEOF = (byte)(0) ;
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "GRID1_nEOF", GXutil.ltrim( localUtil.ntoc( GRID1_nEOF, (byte)(1), (byte)(0), ".", "")));
      while ( ( (pr_default.getStatus(0) != 101) && ( GXutil.strcmp(H007Z2_A67Invd_NumeroPlaca[0], A67Invd_NumeroPlaca) == 0 ) && ( H007Z2_A410Invd_RegionalId[0] == AV46Regi_Id ) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < GRID1_nFirstRecordOnPage + subgrid1_recordsperpage( ) ) ) ) )
      {
         brk7Z2 = false ;
         A37Cata_Codigo = H007Z2_A37Cata_Codigo[0] ;
         A298Cata_Descripcion = H007Z2_A298Cata_Descripcion[0] ;
         ...
         if ( (GXutil.strcmp("", AV11cInvd_DescripcionDevolutivo)==0) || ( GXutil.like( GXutil.upper( A298Cata_Descripcion) , GXutil.padr( GXutil.concat( "%", GXutil.upper( AV11cInvd_DescripcionDevolutivo), "") , 254 , "%"),  ' ' ) ) )
         {
            if ( GXutil.strcmp(A463Invd_Estado, "R") == 0 )
            {
               ...
               selecplacapadre_impl.this.AV29Placa = GXv_char1[0] ;
               selecplacapadre_impl.this.AV23Marca = GXv_char2[0] ;
               selecplacapadre_impl.this.AV24Modelo = GXv_char3[0] ;
               selecplacapadre_impl.this.AV38Serial = GXv_char4[0] ;
               selecplacapadre_impl.this.AV26Observaciones = GXv_char5[0] ;
               selecplacapadre_impl.this.AV41Tran_IdEntrada = GXv_int6[0] ;
               selecplacapadre_impl.this.AV25Nro_Linea = GXv_int7[0] ;
               httpContext.ajax_rsp_assign_attri("", false, "AV29Placa", AV29Placa);
               httpContext.ajax_rsp_assign_attri("", false, "AV41Tran_IdEntrada", GXutil.ltrim( GXutil.str( AV41Tran_IdEntrada, 11, 0)));
               httpContext.ajax_rsp_assign_attri("", false, "AV25Nro_Linea", GXutil.ltrim( GXutil.str( AV25Nro_Linea, 8, 0)));
   ...
   public void e227Z2( )
   {
      ...
      AV29Placa = A67Invd_NumeroPlaca ;
      httpContext.ajax_rsp_assign_attri("", false, "AV29Placa", AV29Placa);
      httpContext.setWebReturnParms(new Object[] {AV29Placa,AV45Tipo,new Long(AV46Regi_Id),new Long(AV41Tran_IdEntrada),new Integer(AV25Nro_Linea),AV47PlacaSelecc});
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV29Placa", AV29Placa);
      AV45Tipo = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV45Tipo", AV45Tipo);
      AV46Regi_Id = ((Number) GXutil.testNumericType( getParm(obj,2), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV46Regi_Id", GXutil.ltrim( GXutil.str( AV46Regi_Id, 11, 0)));
      AV41Tran_IdEntrada = ((Number) GXutil.testNumericType( getParm(obj,3), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV41Tran_IdEntrada", GXutil.ltrim( GXutil.str( AV41Tran_IdEntrada, 11, 0)));
      AV25Nro_Linea = ((Number) GXutil.testNumericType( getParm(obj,4), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV25Nro_Linea", GXutil.ltrim( GXutil.str( AV25Nro_Linea, 8, 0)));
      AV47PlacaSelecc = (String)getParm(obj,5) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV47PlacaSelecc", AV47PlacaSelecc);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2018614142398");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("selecplacapadre.js", "?2018614142398");
   ...
   public void sendrow_942( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_94_idx <= subgrid1_recordsperpage( ) * 1 ) )
      {
         ...
         StyleString = "" ;
         AV22LinkSelection_IsBlob = (boolean)(((GXutil.strcmp("", AV22LinkSelection)==0)&&(GXutil.strcmp("", AV50Linkselection_GXI)==0))||!(GXutil.strcmp("", AV22LinkSelection)==0)) ;
         sImgUrl = ((GXutil.strcmp("", AV22LinkSelection)==0) ? AV50Linkselection_GXI : httpContext.getResourceRelative(AV22LinkSelection)) ;
         ...
         edtInvd_RegionalId_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( AV29Placa)+"'"+", "+"'"+PrivateUtilities.encodeJSConstant( GXutil.rtrim( AV45Tipo))+"'"+", "+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( AV46Regi_Id, (byte)(11), (byte)(0), ",", "")))+"'"+", "+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( AV41Tran_IdEntrada, (byte)(11), (byte)(0), ",", "")))+"'"+", "+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( AV25Nro_Linea, (byte)(8), (byte)(0), ",", "")))+"'"+", "+"'"+PrivateUtilities.encodeJSConstant( AV47PlacaSelecc)+"'"+"]);" ;
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Seleccionar Placas" );
      subGrid1_Rows = 10 ;
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID1_nFirstRecordOnPage',nv:0},{av:'GRID1_nEOF',nv:0},{av:'subGrid1_Rows',nv:0},{av:'AV14cInvd_NumeroPlaca',fld:'vCINVD_NUMEROPLACA',pic:'',nv:''},{av:'AV11cInvd_DescripcionDevolutivo',fld:'vCINVD_DESCRIPCIONDEVOLUTIVO',pic:'',nv:''},{av:'AV7cElem_Consecutivo',fld:'vCELEM_CONSECUTIVO',pic:'',nv:''},{av:'AV15cInvd_PlacaPadre',fld:'vCINVD_PLACAPADRE',pic:'',nv:''},{av:'AV12cInvd_FechaAdquisicion',fld:'vCINVD_FECHAADQUISICION',pic:'',nv:''},{av:'AV45Tipo',fld:'vTIPO',pic:'',nv:''},{av:'AV46Regi_Id',fld:'vREGI_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV47PlacaSelecc',fld:'vPLACASELECC',pic:'',nv:''},{av:'A67Invd_NumeroPlaca',fld:'INVD_NUMEROPLACA',pic:'',hsh:true,nv:''},{av:'AV23Marca',fld:'vMARCA',pic:'',hsh:true,nv:''},{av:'AV24Modelo',fld:'vMODELO',pic:'',hsh:true,nv:''},{av:'AV38Serial',fld:'vSERIAL',pic:'',hsh:true,nv:''},{av:'AV26Observaciones',fld:'vOBSERVACIONES',pic:'',hsh:true,nv:''},{av:'AV41Tran_IdEntrada',fld:'vTRAN_IDENTRADA',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV25Nro_Linea',fld:'vNRO_LINEA',pic:'ZZZZZZZ9',nv:0},{av:'AV20cSerial',fld:'vCSERIAL',pic:'',nv:''},{av:'AV19cModelo',fld:'vCMODELO',pic:'',nv:''},{av:'AV18cMarca',fld:'vCMARCA',pic:'',nv:''}],oparms:[]}");
      setEventMetadata("'TOGGLE'","{handler:'e197Z1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}],oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
      setEventMetadata("LBLINVD_NUMEROPLACAFILTER.CLICK","{handler:'e117Z1',iparms:[{av:'divInvd_numeroplacafiltercontainer_Class',ctrl:'INVD_NUMEROPLACAFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divInvd_numeroplacafiltercontainer_Class',ctrl:'INVD_NUMEROPLACAFILTERCONTAINER',prop:'Class'},{av:'edtavCinvd_numeroplaca_Visible',ctrl:'vCINVD_NUMEROPLACA',prop:'Visible'}]}");
      setEventMetadata("LBLINVD_DESCRIPCIONIDFILTER.CLICK","{handler:'e127Z1',iparms:[{av:'divInvd_descripcionidfiltercontainer_Class',ctrl:'INVD_DESCRIPCIONIDFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divInvd_descripcionidfiltercontainer_Class',ctrl:'INVD_DESCRIPCIONIDFILTERCONTAINER',prop:'Class'},{av:'edtavCinvd_descripciondevolutivo_Visible',ctrl:'vCINVD_DESCRIPCIONDEVOLUTIVO',prop:'Visible'}]}");
      setEventMetadata("LBLINVD_PLACAPADREFILTER.CLICK","{handler:'e147Z1',iparms:[{av:'divInvd_placapadrefiltercontainer_Class',ctrl:'INVD_PLACAPADREFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divInvd_placapadrefiltercontainer_Class',ctrl:'INVD_PLACAPADREFILTERCONTAINER',prop:'Class'},{av:'edtavCinvd_placapadre_Visible',ctrl:'vCINVD_PLACAPADRE',prop:'Visible'}]}");
      setEventMetadata("LBLELEM_CONSECUTIVOFILTER.CLICK","{handler:'e137Z1',iparms:[{av:'divElem_consecutivofiltercontainer_Class',ctrl:'ELEM_CONSECUTIVOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divElem_consecutivofiltercontainer_Class',ctrl:'ELEM_CONSECUTIVOFILTERCONTAINER',prop:'Class'},{av:'edtavCelem_consecutivo_Visible',ctrl:'vCELEM_CONSECUTIVO',prop:'Visible'}]}");
      setEventMetadata("LBLFECHAFILTER.CLICK","{handler:'e157Z1',iparms:[{av:'divInvd_fechafiltercontainer_Class',ctrl:'INVD_FECHAFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divInvd_fechafiltercontainer_Class',ctrl:'INVD_FECHAFILTERCONTAINER',prop:'Class'},{av:'edtavCinvd_fechaadquisicion_Visible',ctrl:'vCINVD_FECHAADQUISICION',prop:'Visible'}]}");
      setEventMetadata("LBLMARCAFILTER.CLICK","{handler:'e167Z1',iparms:[{av:'divInvd_marcafiltercontainer_Class',ctrl:'INVD_MARCAFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divInvd_marcafiltercontainer_Class',ctrl:'INVD_MARCAFILTERCONTAINER',prop:'Class'},{av:'edtavCmarca_Visible',ctrl:'vCMARCA',prop:'Visible'}]}");
      setEventMetadata("LBLMODELOFILTER.CLICK","{handler:'e177Z1',iparms:[{av:'divInvd_modelofiltercontainer_Class',ctrl:'INVD_MODELOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divInvd_modelofiltercontainer_Class',ctrl:'INVD_MODELOFILTERCONTAINER',prop:'Class'},{av:'edtavCmodelo_Visible',ctrl:'vCMODELO',prop:'Visible'}]}");
      setEventMetadata("LBLSERIALFILTER.CLICK","{handler:'e187Z1',iparms:[{av:'divInvd_serialfiltercontainer_Class',ctrl:'INVD_SERIALFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divInvd_serialfiltercontainer_Class',ctrl:'INVD_SERIALFILTERCONTAINER',prop:'Class'},{av:'edtavCserial_Visible',ctrl:'vCSERIAL',prop:'Visible'}]}");
      setEventMetadata("ENTER","{handler:'e227Z2',iparms:[{av:'A67Invd_NumeroPlaca',fld:'INVD_NUMEROPLACA',pic:'',hsh:true,nv:''},{av:'AV47PlacaSelecc',fld:'vPLACASELECC',pic:'',nv:''},{av:'AV25Nro_Linea',fld:'vNRO_LINEA',pic:'ZZZZZZZ9',nv:0},{av:'AV41Tran_IdEntrada',fld:'vTRAN_IDENTRADA',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV46Regi_Id',fld:'vREGI_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV45Tipo',fld:'vTIPO',pic:'',nv:''}],oparms:[{av:'AV29Placa',fld:'vPLACA',pic:'',nv:''}]}");
   ...
   public void initialize( )
   {
      ...
      A501Invd_EsPlacaPadre = "" ;
      H007Z2_A37Cata_Codigo = new String[] {""} ;
      H007Z2_A298Cata_Descripcion = new String[] {""} ;
      H007Z2_A463Invd_Estado = new String[] {""} ;
      H007Z2_n463Invd_Estado = new boolean[] {false} ;
      H007Z2_A68Invd_PlacaPadre = new String[] {""} ;
      H007Z2_n68Invd_PlacaPadre = new boolean[] {false} ;
      H007Z2_A66Elem_Consecutivo = new String[] {""} ;
      H007Z2_A466Invd_FechaAdquisicion = new java.util.Date[] {GXutil.nullDate()} ;
      H007Z2_n466Invd_FechaAdquisicion = new boolean[] {false} ;
      H007Z2_A501Invd_EsPlacaPadre = new String[] {""} ;
      H007Z2_n501Invd_EsPlacaPadre = new boolean[] {false} ;
      H007Z2_A410Invd_RegionalId = new long[1] ;
      H007Z2_A67Invd_NumeroPlaca = new String[] {""} ;
      H007Z2_A631Vida_Util_Actual = new short[1] ;
      H007Z2_n631Vida_Util_Actual = new boolean[] {false} ;
      H007Z2_A628Otros_Costos_Dev = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H007Z2_n628Otros_Costos_Dev = new boolean[] {false} ;
      H007Z2_A626Variable_I = new short[1] ;
      H007Z2_n626Variable_I = new boolean[] {false} ;
      H007Z2_A627Variable_N = new short[1] ;
      H007Z2_n627Variable_N = new boolean[] {false} ;
      H007Z2_A625Variable_VF = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H007Z2_n625Variable_VF = new boolean[] {false} ;
      H007Z2_A465Invd_ValorAdquisicion = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H007Z2_n465Invd_ValorAdquisicion = new boolean[] {false} ;
      H007Z2_A414Invd_BodegaCodigo = new String[] {""} ;
      H007Z2_A413Invd_AlmacenCodigo = new String[] {""} ;
      H007Z2_A412Invd_ModuloAlmacen = new String[] {""} ;
      H007Z2_A411Invd_CentroCostoId = new long[1] ;
      H007Z2_A629Costo_Total_Dev = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      A37Cata_Codigo = "" ;
      ...
      sImgUrl = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.selecplacapadre__default(),
         new Object[] {
             new Object[] {
            H007Z2_A37Cata_Codigo, H007Z2_A298Cata_Descripcion, H007Z2_A463Invd_Estado, H007Z2_n463Invd_Estado, H007Z2_A68Invd_PlacaPadre, H007Z2_n68Invd_PlacaPadre, H007Z2_A66Elem_Consecutivo, H007Z2_A466Invd_FechaAdquisicion, H007Z2_n466Invd_FechaAdquisicion, H007Z2_A501Invd_EsPlacaPadre,
            H007Z2_n501Invd_EsPlacaPadre, H007Z2_A410Invd_RegionalId, H007Z2_A67Invd_NumeroPlaca, H007Z2_A631Vida_Util_Actual, H007Z2_n631Vida_Util_Actual, H007Z2_A628Otros_Costos_Dev, H007Z2_n628Otros_Costos_Dev, H007Z2_A626Variable_I, H007Z2_n626Variable_I, H007Z2_A627Variable_N,
            H007Z2_n627Variable_N, H007Z2_A625Variable_VF, H007Z2_n625Variable_VF, H007Z2_A465Invd_ValorAdquisicion, H007Z2_n465Invd_ValorAdquisicion, H007Z2_A414Invd_BodegaCodigo, H007Z2_A413Invd_AlmacenCodigo, H007Z2_A412Invd_ModuloAlmacen, H007Z2_A411Invd_CentroCostoId, H007Z2_A629Costo_Total_Dev
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private long wcpOAV46Regi_Id ;
   private long AV46Regi_Id ;
   ...
   private String AV50Linkselection_GXI ;
   ...
   private String[] H007Z2_A37Cata_Codigo ;
   private String[] H007Z2_A298Cata_Descripcion ;
   private String[] H007Z2_A463Invd_Estado ;
   private boolean[] H007Z2_n463Invd_Estado ;
   private String[] H007Z2_A68Invd_PlacaPadre ;
   private boolean[] H007Z2_n68Invd_PlacaPadre ;
   private String[] H007Z2_A66Elem_Consecutivo ;
   private java.util.Date[] H007Z2_A466Invd_FechaAdquisicion ;
   private boolean[] H007Z2_n466Invd_FechaAdquisicion ;
   private String[] H007Z2_A501Invd_EsPlacaPadre ;
   private boolean[] H007Z2_n501Invd_EsPlacaPadre ;
   private long[] H007Z2_A410Invd_RegionalId ;
   private String[] H007Z2_A67Invd_NumeroPlaca ;
   private short[] H007Z2_A631Vida_Util_Actual ;
   private boolean[] H007Z2_n631Vida_Util_Actual ;
   private java.math.BigDecimal[] H007Z2_A628Otros_Costos_Dev ;
   private boolean[] H007Z2_n628Otros_Costos_Dev ;
   private short[] H007Z2_A626Variable_I ;
   private boolean[] H007Z2_n626Variable_I ;
   private short[] H007Z2_A627Variable_N ;
   private boolean[] H007Z2_n627Variable_N ;
   private java.math.BigDecimal[] H007Z2_A625Variable_VF ;
   private boolean[] H007Z2_n625Variable_VF ;
   private java.math.BigDecimal[] H007Z2_A465Invd_ValorAdquisicion ;
   private boolean[] H007Z2_n465Invd_ValorAdquisicion ;
   private String[] H007Z2_A414Invd_BodegaCodigo ;
   private String[] H007Z2_A413Invd_AlmacenCodigo ;
   private String[] H007Z2_A412Invd_ModuloAlmacen ;
   private long[] H007Z2_A411Invd_CentroCostoId ;
   private java.math.BigDecimal[] H007Z2_A629Costo_Total_Dev ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class selecplacapadre__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H007Z2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          long AV46Regi_Id )
   {
      ...
      scmdbuf = scmdbuf + " T1.Invd_PlacaPadre, T1.Elem_Consecutivo, T1.Invd_FechaAdquisicion, T1.Invd_EsPlacaPadre," ;
      scmdbuf = scmdbuf + " T1.Invd_RegionalId, T1.Invd_NumeroPlaca, T1.Vida_Util_Actual, T1.Otros_Costos_Dev," ;
      scmdbuf = scmdbuf + " T1.Variable_I, T1.Variable_N, T1.Variable_VF, T1.Invd_ValorAdquisicion, T1.Invd_BodegaCodigo," ;
      scmdbuf = scmdbuf + " T1.Invd_AlmacenCodigo, T1.Invd_ModuloAlmacen, T1.Invd_CentroCostoId, T1.Costo_Total_Dev" ;
      scmdbuf = scmdbuf + " FROM ((ALM_INVENTARIO_DEVOLUTIVO T1 INNER JOIN ALM_ELEMENTO T2 ON T2.Elem_Consecutivo" ;
      ...
      if ( GXutil.strcmp(AV45Tipo, "D") == 0 )
      {
         sWhereString = sWhereString + " and (T1.Invd_EsPlacaPadre = 'SI')" ;
      }
      if ( GXutil.strcmp(AV45Tipo, "A") == 0 )
      {
         sWhereString = sWhereString + " and (T1.Invd_EsPlacaPadre = 'SI' or T1.Invd_EsPlacaPadre = 'NA')" ;
      }
      if ( GXutil.strcmp(AV45Tipo, "I") == 0 )
      {
         sWhereString = sWhereString + " and (T1.Invd_EsPlacaPadre = 'NA')" ;
      }
      if ( GXutil.strcmp(AV45Tipo, "I") == 0 )
      {
         sWhereString = sWhereString + " and (T1.Invd_NumeroPlaca <> ?)" ;
      }
      else
      {
         GXv_int8[5] = (byte)(1) ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H007Z2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , (java.util.Date)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , (java.util.Date)dynConstraints[8] , (String)dynConstraints[9] , (String)dynConstraints[10] , (String)dynConstraints[11] , (String)dynConstraints[12] , (String)dynConstraints[13] , ((Number) dynConstraints[14]).longValue() , ((Number) dynConstraints[15]).longValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H007Z2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
      };
   }
