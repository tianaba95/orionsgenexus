/*
               File: wwalm_area_impl
        Description: Work With ALAMCEN AREA
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:17:59.82
...
public final  class wwalm_area_impl extends GXDataArea
{
   public wwalm_area_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wwalm_area_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wwalm_area_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
         {
            ...
            AV14BArea_Descripcion = httpContext.GetNextPar( ) ;
            AV15Update = httpContext.GetNextPar( ) ;
            edtavUpdate_Tooltiptext = httpContext.GetNextPar( ) ;
            httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Tooltiptext", edtavUpdate_Tooltiptext, !bGXsfl_25_Refreshing);
            AV16Delete = httpContext.GetNextPar( ) ;
            ...
            gxgrgrid_refresh( subGrid_Rows, AV14BArea_Descripcion, AV15Update, AV16Delete, AV20Pgmname, A32BArea_Codigo, A1Cent_Id) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414175989");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( nGXWrapped != 1 )
      {
         httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.wwalm_area") +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "GXH_vBAREA_DESCRIPCION", AV14BArea_Descripcion);
      /* Send saved values. */
   ...
   {
      return formatLink("com.orions2.wwalm_area")  ;
   }
   ...
   public void wb150( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblTitletext_Internalname, "Work With ALAMCEN AREAS", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_WWALM_AREA.htm");
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 25, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWALM_AREA.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_label_element( httpContext, edtavBarea_descripcion_Internalname, "BArea_Descripcion", "col-sm-3 FilterSearchAttributeLabel", 0, true);
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"" ;
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavBarea_descripcion_Internalname, AV14BArea_Descripcion, GXutil.rtrim( localUtil.format( AV14BArea_Descripcion, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "BArea_Descripcion", edtavBarea_descripcion_Jsonclick, 0, "FilterSearchAttribute", "", "", "", 1, edtavBarea_descripcion_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_WWALM_AREA.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
            httpContext.writeValue( "BArea_Usuario_Modifica") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.rtrim( A611BArea_Estado));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", A612BArea_Usuario_Crea);
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", localUtil.ttoc( A613BArea_Fecha_Crea, 10, 8, 0, 3, "/", ":", " "));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", A614BArea_Usuario_Modifica);
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", localUtil.format(A615BArea_Fecha, "99/99/99"));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
   ...
   public void start152( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Work With ALAMCEN AREA", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 {
                                    Rfr0gs = false ;
                                    /* Set Refresh If Barea_descripcion Changed */
                                    if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vBAREA_DESCRIPCION"), AV14BArea_Descripcion) != 0 )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    if ( ! Rfr0gs )
   ...
   public void pa152( )
   {
      if ( nDonePA == 0 )
      {
         ...
         GXCCtl = "BAREA_ESTADO_" + sGXsfl_25_idx ;
         ...
         if ( ! httpContext.isAjaxRequest( ) )
         {
            GX_FocusControl = edtavBarea_descripcion_Internalname ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_BAREA_USUARIO_MODIFICA", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A614BArea_Usuario_Modifica, "@!"))));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "BAREA_USUARIO_MODIFICA", A614BArea_Usuario_Modifica);
   ...
   public void rf152( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV14BArea_Descripcion ,
                                              A610BArea_Descripcion } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.STRING
                                              }
         } ) ;
         lV14BArea_Descripcion = GXutil.concat( GXutil.rtrim( AV14BArea_Descripcion), "%", "") ;
         httpContext.ajax_rsp_assign_attri("", false, "AV14BArea_Descripcion", AV14BArea_Descripcion);
         /* Using cursor H00152 */
         pr_default.execute(0, new Object[] {lV14BArea_Descripcion, new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_25_idx = (short)(1) ;
         sGXsfl_25_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_25_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_252( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A4Cent_Descripcion = H00152_A4Cent_Descripcion[0] ;
            A3Cent_Codigo = H00152_A3Cent_Codigo[0] ;
            A1Cent_Id = H00152_A1Cent_Id[0] ;
            A615BArea_Fecha = H00152_A615BArea_Fecha[0] ;
            n615BArea_Fecha = H00152_n615BArea_Fecha[0] ;
            A614BArea_Usuario_Modifica = H00152_A614BArea_Usuario_Modifica[0] ;
            n614BArea_Usuario_Modifica = H00152_n614BArea_Usuario_Modifica[0] ;
            A613BArea_Fecha_Crea = H00152_A613BArea_Fecha_Crea[0] ;
            n613BArea_Fecha_Crea = H00152_n613BArea_Fecha_Crea[0] ;
            A612BArea_Usuario_Crea = H00152_A612BArea_Usuario_Crea[0] ;
            n612BArea_Usuario_Crea = H00152_n612BArea_Usuario_Crea[0] ;
            A611BArea_Estado = H00152_A611BArea_Estado[0] ;
            A610BArea_Descripcion = H00152_A610BArea_Descripcion[0] ;
            A32BArea_Codigo = H00152_A32BArea_Codigo[0] ;
            A4Cent_Descripcion = H00152_A4Cent_Descripcion[0] ;
            A3Cent_Codigo = H00152_A3Cent_Codigo[0] ;
            e14152 ();
   ...
   public int subgrid_recordcount( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV14BArea_Descripcion", AV14BArea_Descripcion);
      /* Using cursor H00153 */
      pr_default.execute(1, new Object[] {lV14BArea_Descripcion});
   ...
   public void strup150( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV14BArea_Descripcion = httpContext.cgiGet( edtavBarea_descripcion_Internalname) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV14BArea_Descripcion", AV14BArea_Descripcion);
         /* Read saved values. */
   ...
   public void e12152( )
   {
      ...
      httpContext.ajax_rsp_assign_prop("", false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext, !bGXsfl_25_Refreshing);
      Form.setCaption( "Work With ALAMCEN AREAS" );
   ...
   {
      /* Grid_Load Routine */
      edtavUpdate_Link = formatLink("com.orions2.alm_area") + "?" + GXutil.URLEncode(GXutil.rtrim("UPD")) + "," + GXutil.URLEncode(GXutil.rtrim(A32BArea_Codigo)) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A1Cent_Id,11,0))) ;
      edtavDelete_Link = formatLink("com.orions2.alm_area") + "?" + GXutil.URLEncode(GXutil.rtrim("DLT")) + "," + GXutil.URLEncode(GXutil.rtrim(A32BArea_Codigo)) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A1Cent_Id,11,0))) ;
   ...
   {
      /* 'DoInsert' Routine */
      callWebObject(formatLink("com.orions2.alm_area") + "?" + GXutil.URLEncode(GXutil.rtrim("INS")) + "," + GXutil.URLEncode(GXutil.rtrim("")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(0,9,0))));
      httpContext.wjLocDisableFrm = (byte)(1) ;
   }
   ...
   public void S122( )
   {
      ...
      if ( GXutil.strcmp(AV8HTTPRequest.getMethod(), "GET") == 0 )
      {
         ...
         {
            AV14BArea_Descripcion = ((com.orions2.SdtGridState_FilterValue)AV9GridState.getgxTv_SdtGridState_Filtervalues().elementAt(-1+1)).getgxTv_SdtGridState_FilterValue_Value() ;
            httpContext.ajax_rsp_assign_attri("", false, "AV14BArea_Descripcion", AV14BArea_Descripcion);
         }
   ...
   public void S132( )
   {
      ...
      AV10GridStateFilterValue.setgxTv_SdtGridState_FilterValue_Value( AV14BArea_Descripcion );
   ...
   public void S112( )
   {
      ...
      AV12TrnContext.setgxTv_SdtTransactionContext_Transactionname( "ALM_AREA" );
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20186141418046");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         ...
         httpContext.AddJavascriptSource("wwalm_area.js", "?20186141418046");
      }
   ...
   {
      edtBArea_Codigo_Internalname = "BAREA_CODIGO_"+sGXsfl_25_idx ;
      edtBArea_Descripcion_Internalname = "BAREA_DESCRIPCION_"+sGXsfl_25_idx ;
      cmbBArea_Estado.setInternalname( "BAREA_ESTADO_"+sGXsfl_25_idx );
      edtBArea_Usuario_Crea_Internalname = "BAREA_USUARIO_CREA_"+sGXsfl_25_idx ;
      edtBArea_Fecha_Crea_Internalname = "BAREA_FECHA_CREA_"+sGXsfl_25_idx ;
      edtBArea_Usuario_Modifica_Internalname = "BAREA_USUARIO_MODIFICA_"+sGXsfl_25_idx ;
      edtBArea_Fecha_Internalname = "BAREA_FECHA_"+sGXsfl_25_idx ;
      edtCent_Id_Internalname = "CENT_ID_"+sGXsfl_25_idx ;
      edtCent_Codigo_Internalname = "CENT_CODIGO_"+sGXsfl_25_idx ;
      edtCent_Descripcion_Internalname = "CENT_DESCRIPCION_"+sGXsfl_25_idx ;
   ...
   {
      edtBArea_Codigo_Internalname = "BAREA_CODIGO_"+sGXsfl_25_fel_idx ;
      edtBArea_Descripcion_Internalname = "BAREA_DESCRIPCION_"+sGXsfl_25_fel_idx ;
      cmbBArea_Estado.setInternalname( "BAREA_ESTADO_"+sGXsfl_25_fel_idx );
      edtBArea_Usuario_Crea_Internalname = "BAREA_USUARIO_CREA_"+sGXsfl_25_fel_idx ;
      edtBArea_Fecha_Crea_Internalname = "BAREA_FECHA_CREA_"+sGXsfl_25_fel_idx ;
      edtBArea_Usuario_Modifica_Internalname = "BAREA_USUARIO_MODIFICA_"+sGXsfl_25_fel_idx ;
      edtBArea_Fecha_Internalname = "BAREA_FECHA_"+sGXsfl_25_fel_idx ;
      edtCent_Id_Internalname = "CENT_ID_"+sGXsfl_25_fel_idx ;
      edtCent_Codigo_Internalname = "CENT_CODIGO_"+sGXsfl_25_fel_idx ;
      edtCent_Descripcion_Internalname = "CENT_DESCRIPCION_"+sGXsfl_25_fel_idx ;
   ...
   public void sendrow_252( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtBArea_Codigo_Internalname,A32BArea_Codigo,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtBArea_Codigo_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(16),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbBArea_Estado,cmbBArea_Estado.getInternalname(),GXutil.rtrim( A611BArea_Estado),new Integer(1),cmbBArea_Estado.getJsonclick(),new Integer(0),"'"+""+"'"+",false,"+"'"+""+"'","char","",new Integer(-1),new Integer(0),new Integer(0),new Integer(0),new Integer(0),"px",new Integer(0),"px","","Attribute","WWColumn WWOptionalColumn","","",new Boolean(true)});
         cmbBArea_Estado.setValue( GXutil.rtrim( A611BArea_Estado) );
         httpContext.ajax_rsp_assign_prop("", false, cmbBArea_Estado.getInternalname(), "Values", cmbBArea_Estado.ToJavascriptSource(), !bGXsfl_25_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtBArea_Usuario_Crea_Internalname,A612BArea_Usuario_Crea,GXutil.rtrim( localUtil.format( A612BArea_Usuario_Crea, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtBArea_Usuario_Crea_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtBArea_Fecha_Internalname,localUtil.format(A615BArea_Fecha, "99/99/99"),localUtil.format( A615BArea_Fecha, "99/99/99"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtBArea_Fecha_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(8),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"Fecha","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCent_Id_Internalname,GXutil.ltrim( localUtil.ntoc( A1Cent_Id, (byte)(11), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A1Cent_Id), "ZZZZZZZZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCent_Id_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(11),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"Identificador","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCent_Descripcion_Internalname,A4Cent_Descripcion,"","","'"+""+"'"+",false,"+"'"+""+"'",edtCent_Descripcion_Link,"","","",edtCent_Descripcion_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_BAREA_CODIGO"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, GXutil.rtrim( localUtil.format( A32BArea_Codigo, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_BAREA_ESTADO"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, GXutil.rtrim( localUtil.format( A611BArea_Estado, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_BAREA_USUARIO_CREA"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, GXutil.rtrim( localUtil.format( A612BArea_Usuario_Crea, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_BAREA_FECHA_CREA"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, localUtil.format( A613BArea_Fecha_Crea, "99/99/99 99:99")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_BAREA_USUARIO_MODIFICA"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, GXutil.rtrim( localUtil.format( A614BArea_Usuario_Modifica, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_BAREA_FECHA"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, A615BArea_Fecha));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CENT_ID"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, localUtil.format( DecimalUtil.doubleToDec(A1Cent_Id), "ZZZZZZZZZZ9")));
   ...
   public void init_default_properties( )
   {
      ...
      edtavBarea_descripcion_Internalname = "vBAREA_DESCRIPCION" ;
   ...
   public void initialize_properties( )
   {
      ...
      edtavBarea_descripcion_Jsonclick = "" ;
      edtavBarea_descripcion_Enabled = 1 ;
      Form.setHeaderrawhtml( "" );
      Form.setBackground( "" );
      Form.setTextcolor( 0 );
      Form.setIBackground( (int)(0xFFFFFF) );
      Form.setCaption( "Work With ALAMCEN AREA" );
      subGrid_Rows = 0 ;
      edtavDelete_Tooltiptext = "Eliminar" ;
      edtavUpdate_Tooltiptext = "Modificar" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV15Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV16Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A32BArea_Codigo',fld:'BAREA_CODIGO',pic:'',hsh:true,nv:''},{av:'A1Cent_Id',fld:'CENT_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'AV20Pgmname',fld:'vPGMNAME',pic:'',nv:''},{av:'AV14BArea_Descripcion',fld:'vBAREA_DESCRIPCION',pic:'',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e14152',iparms:[{av:'A32BArea_Codigo',fld:'BAREA_CODIGO',pic:'',hsh:true,nv:''},{av:'A1Cent_Id',fld:'CENT_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtBArea_Descripcion_Link',ctrl:'BAREA_DESCRIPCION',prop:'Link'},{av:'edtCent_Descripcion_Link',ctrl:'CENT_DESCRIPCION',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e11152',iparms:[{av:'A32BArea_Codigo',fld:'BAREA_CODIGO',pic:'',hsh:true,nv:''},{av:'A1Cent_Id',fld:'CENT_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      GXCCtl = "" ;
      scmdbuf = "" ;
      lV14BArea_Descripcion = "" ;
      H00152_A4Cent_Descripcion = new String[] {""} ;
      H00152_A3Cent_Codigo = new String[] {""} ;
      H00152_A1Cent_Id = new long[1] ;
      H00152_A615BArea_Fecha = new java.util.Date[] {GXutil.nullDate()} ;
      H00152_n615BArea_Fecha = new boolean[] {false} ;
      H00152_A614BArea_Usuario_Modifica = new String[] {""} ;
      H00152_n614BArea_Usuario_Modifica = new boolean[] {false} ;
      H00152_A613BArea_Fecha_Crea = new java.util.Date[] {GXutil.nullDate()} ;
      H00152_n613BArea_Fecha_Crea = new boolean[] {false} ;
      H00152_A612BArea_Usuario_Crea = new String[] {""} ;
      H00152_n612BArea_Usuario_Crea = new boolean[] {false} ;
      H00152_A611BArea_Estado = new String[] {""} ;
      H00152_A610BArea_Descripcion = new String[] {""} ;
      H00152_A32BArea_Codigo = new String[] {""} ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.wwalm_area__default(),
         new Object[] {
             new Object[] {
            H00152_A4Cent_Descripcion, H00152_A3Cent_Codigo, H00152_A1Cent_Id, H00152_A615BArea_Fecha, H00152_n615BArea_Fecha, H00152_A614BArea_Usuario_Modifica, H00152_n614BArea_Usuario_Modifica, H00152_A613BArea_Fecha_Crea, H00152_n613BArea_Fecha_Crea, H00152_A612BArea_Usuario_Crea,
            H00152_n612BArea_Usuario_Crea, H00152_A611BArea_Estado, H00152_A610BArea_Descripcion, H00152_A32BArea_Codigo
            }
            , new Object[] {
   ...
   private int edtavBarea_descripcion_Enabled ;
   ...
   private String edtavBarea_descripcion_Internalname ;
   private String edtavBarea_descripcion_Jsonclick ;
   ...
   private String AV14BArea_Descripcion ;
   ...
   private String lV14BArea_Descripcion ;
   ...
   private String[] H00152_A4Cent_Descripcion ;
   private String[] H00152_A3Cent_Codigo ;
   private long[] H00152_A1Cent_Id ;
   private java.util.Date[] H00152_A615BArea_Fecha ;
   private boolean[] H00152_n615BArea_Fecha ;
   private String[] H00152_A614BArea_Usuario_Modifica ;
   private boolean[] H00152_n614BArea_Usuario_Modifica ;
   private java.util.Date[] H00152_A613BArea_Fecha_Crea ;
   private boolean[] H00152_n613BArea_Fecha_Crea ;
   private String[] H00152_A612BArea_Usuario_Crea ;
   private boolean[] H00152_n612BArea_Usuario_Crea ;
   private String[] H00152_A611BArea_Estado ;
   private String[] H00152_A610BArea_Descripcion ;
   private String[] H00152_A32BArea_Codigo ;
...
final  class wwalm_area__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          String A610BArea_Descripcion )
   {
      ...
      String sFromString ;
      String sOrderString ;
      sSelectString = " T2.Cent_Descripcion, T2.Cent_Codigo, T1.Cent_Id, T1.BArea_Fecha, T1.BArea_Usuario_Modifica," ;
      sSelectString = sSelectString + " T1.BArea_Fecha_Crea, T1.BArea_Usuario_Crea, T1.BArea_Estado, T1.BArea_Descripcion," ;
      sSelectString = sSelectString + " T1.BArea_Codigo" ;
      sFromString = " FROM (ALM_AREA T1 INNER JOIN GEN_CENTROCOSTO T2 ON T2.Cent_Id = T1.Cent_Id)" ;
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV14BArea_Descripcion)==0) )
      {
         if ( GXutil.strcmp("", sWhereString) != 0 )
         {
            sWhereString = sWhereString + " and (T1.BArea_Descripcion like ?)" ;
         }
         else
         {
            sWhereString = sWhereString + " (T1.BArea_Descripcion like ?)" ;
         }
      }
      else
      {
      ...
      sOrderString = sOrderString + " ORDER BY T1.BArea_Descripcion" ;
                                          ...
                                          String A610BArea_Descripcion )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM (ALM_AREA T1 INNER JOIN GEN_CENTROCOSTO T2 ON T2.Cent_Id = T1.Cent_Id)" ;
      if ( ! (GXutil.strcmp("", AV14BArea_Descripcion)==0) )
      {
         if ( GXutil.strcmp("", sWhereString) != 0 )
         {
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00152(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
            case 1 :
                  return conditional_H00153(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
      }
