/*
               File: seg_rolseg_usuario_rolwc_impl
        Description: SEG_ROLSEG_USUARIO_ROLWC
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:16:16.44
...
public final  class seg_rolseg_usuario_rolwc_impl extends GXWebComponent
{
   public seg_rolseg_usuario_rolwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public seg_rolseg_usuario_rolwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( seg_rolseg_usuario_rolwc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV9Rol_Id, AV13Update, AV6Delete, A23Usua_Id, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "SEG_ROLSEG_USUARIO_ROLWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414161647");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.seg_rolseg_usuario_rolwc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV9Rol_Id,11,0)))+"\">") ;
   ...
   public void renderHtmlCloseForm692( )
   {
      ...
      {
         httpContext.AddJavascriptSource("seg_rolseg_usuario_rolwc.js", "?201861414161649");
      }
   ...
   {
      return "SEG_ROLSEG_USUARIO_ROLWC" ;
   }
   ...
   public void wb690( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.seg_rolseg_usuario_rolwc");
         }
         /* Div Control */
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_SEG_ROLSEG_USUARIO_ROLWC.htm");
      ...
      if ( wbEnd == 20 )
      {
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtRol_Id_Internalname, GXutil.ltrim( localUtil.ntoc( A21Rol_Id, (byte)(11), (byte)(0), ",", "")), ((edtRol_Id_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A21Rol_Id), "ZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A21Rol_Id), "ZZZZZZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtRol_Id_Jsonclick, 0, "Attribute", "", "", "", edtRol_Id_Visible, edtRol_Id_Enabled, 0, "text", "", 11, "chr", 1, "row", 11, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Identificador", "right", false, "HLP_SEG_ROLSEG_USUARIO_ROLWC.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start692( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "SEG_ROLSEG_USUARIO_ROLWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "SEG_ROLSEG_USUARIO_ROLWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf692( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A21Rol_Id = H00692_A21Rol_Id[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A21Rol_Id", GXutil.ltrim( GXutil.str( A21Rol_Id, 11, 0)));
            A26Usua_Cedula = H00692_A26Usua_Cedula[0] ;
            A219Usua_Email = H00692_A219Usua_Email[0] ;
            A25Usua_Nombre = H00692_A25Usua_Nombre[0] ;
            A24Usua_Codigo = H00692_A24Usua_Codigo[0] ;
            A23Usua_Id = H00692_A23Usua_Id[0] ;
            A26Usua_Cedula = H00692_A26Usua_Cedula[0] ;
            A219Usua_Email = H00692_A219Usua_Email[0] ;
            A25Usua_Nombre = H00692_A25Usua_Nombre[0] ;
            A24Usua_Codigo = H00692_A24Usua_Codigo[0] ;
   ...
   {
      /* Grid_Load Routine */
      edtUsua_Nombre_Link = formatLink("com.orions2.viewseg_usuario") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A23Usua_Id,18,0))) + "," + GXutil.URLEncode(GXutil.rtrim("")) ;
      /* Load Method */
      if ( wbStart != -1 )
      {
         wbStart = (short)(20) ;
   ...
   public void S112( )
   {
      ...
      AV11TrnContext.setgxTv_SdtTransactionContext_Transactionname( "SEG_USUARIO" );
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "seg_rolseg_usuario_rolwc");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414161689");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("seg_rolseg_usuario_rolwc.js", "?201861414161689");
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV9Rol_Id',fld:'vROL_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV13Update',fld:'vUPDATE',pic:'',nv:''},{av:'AV6Delete',fld:'vDELETE',pic:'',nv:''},{av:'A23Usua_Id',fld:'USUA_ID',pic:'ZZZZZZZZZZZZZZZZZ9',hsh:true,nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e13692',iparms:[{av:'A23Usua_Id',fld:'USUA_ID',pic:'ZZZZZZZZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'edtUsua_Nombre_Link',ctrl:'USUA_NOMBRE',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e11692',iparms:[{av:'A23Usua_Id',fld:'USUA_ID',pic:'ZZZZZZZZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H00692_A21Rol_Id = new long[1] ;
      H00692_A26Usua_Cedula = new long[1] ;
      H00692_A219Usua_Email = new String[] {""} ;
      H00692_A25Usua_Nombre = new String[] {""} ;
      H00692_A24Usua_Codigo = new String[] {""} ;
      H00692_A23Usua_Id = new long[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.seg_rolseg_usuario_rolwc__default(),
         new Object[] {
             new Object[] {
            H00692_A21Rol_Id, H00692_A26Usua_Cedula, H00692_A219Usua_Email, H00692_A25Usua_Nombre, H00692_A24Usua_Codigo, H00692_A23Usua_Id
            }
            , new Object[] {
   ...
   private long[] H00692_A21Rol_Id ;
   private long[] H00692_A26Usua_Cedula ;
   private String[] H00692_A219Usua_Email ;
   private String[] H00692_A25Usua_Nombre ;
   private String[] H00692_A24Usua_Codigo ;
   private long[] H00692_A23Usua_Id ;
...
final  class seg_rolseg_usuario_rolwc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00692", "SELECT T1.Rol_Id, T2.Usua_Cedula, T2.Usua_Email, T2.Usua_Nombre, T2.Usua_Codigo, T1.Usua_Id FROM (SEG_USUARIO_ROL T1 INNER JOIN SEG_USUARIO T2 ON T2.Usua_Id = T1.Usua_Id) WHERE T1.Rol_Id = ? ORDER BY T1.Rol_Id  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H00693", "SELECT COUNT(*) FROM (SEG_USUARIO_ROL T1 INNER JOIN SEG_USUARIO T2 ON T2.Usua_Id = T1.Usua_Id) WHERE T1.Rol_Id = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
