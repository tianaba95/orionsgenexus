/*
               File: seg_pantallaseg_rol_pantallawc_impl
...
public final  class seg_pantallaseg_rol_pantallawc_impl extends GXWebComponent
{
   public seg_pantallaseg_rol_pantallawc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public seg_pantallaseg_rol_pantallawc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( seg_pantallaseg_rol_pantallawc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV9Pant_Id = (int)(GXutil.lval( httpContext.GetNextPar( ))) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV9Pant_Id", GXutil.ltrim( GXutil.str( AV9Pant_Id, 6, 0)));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,new Integer(AV9Pant_Id)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV9Pant_Id, AV13Update, AV6Delete, A21Rol_Id, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "PANTALLA_ROL_PANTALLA") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20186141416472");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.seg_pantallaseg_rol_pantallawc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV9Pant_Id,6,0)))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV9Pant_Id", GXutil.ltrim( localUtil.ntoc( wcpOAV9Pant_Id, (byte)(6), (byte)(0), ",", "")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPANT_ID", GXutil.ltrim( localUtil.ntoc( AV9Pant_Id, (byte)(6), (byte)(0), ",", "")));
   ...
   public void renderHtmlCloseForm322( )
   {
      sendCloseFormHiddens( ) ;
      if ( ( GXutil.len( sPrefix) != 0 ) && httpContext.isAjaxRequest( ) )
      {
         httpContext.AddJavascriptSource("seg_pantallaseg_rol_pantallawc.js", "?20186141416475");
      }
   ...
   {
      return "SEG_PANTALLASEG_ROL_PANTALLAWC" ;
   }
   ...
   public void wb320( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.seg_pantallaseg_rol_pantallawc");
         }
         /* Div Control */
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_SEG_PANTALLASEG_ROL_PANTALLAWC.htm");
         ...
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            httpContext.writeValue( "Descrip Rol") ;
            httpContext.writeTextNL( "</th>") ;
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Link", GXutil.rtrim( edtRol_Descripcion_Link));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
      ...
      if ( wbEnd == 20 )
      {
         ...
         com.orions2.GxWebStd.gx_label_element( httpContext, edtPant_Id_Internalname, "Identificador Pantalla", "col-sm-3 AttributeLabel", 0, true);
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtPant_Id_Internalname, GXutil.ltrim( localUtil.ntoc( A18Pant_Id, (byte)(6), (byte)(0), ",", "")), ((edtPant_Id_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A18Pant_Id), "ZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A18Pant_Id), "ZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPant_Id_Jsonclick, 0, "Attribute", "", "", "", edtPant_Id_Visible, edtPant_Id_Enabled, 0, "text", "", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Codigo", "right", false, "HLP_SEG_PANTALLASEG_ROL_PANTALLAWC.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start322( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "PANTALLA_ROL_PANTALLA", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_ROL_ID", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(A21Rol_Id), "ZZZZZZZZZZ9")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"ROL_ID", GXutil.ltrim( localUtil.ntoc( A21Rol_Id, (byte)(11), (byte)(0), ".", "")));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"ROLP_USUARIOCREA", A215RolP_UsuarioCrea);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"ROLP_FECHACREA", localUtil.ttoc( A216RolP_FechaCrea, 10, 8, 0, 3, "/", ":", " "));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"ROLP_USUARIOMODIFICA", A217RolP_UsuarioModifica);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"ROLP_FECHAMODIFICA", localUtil.ttoc( A218RolP_FechaModifica, 10, 8, 0, 3, "/", ":", " "));
   }
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "SEG_PANTALLASEG_ROL_PANTALLAWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf322( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H00322 */
         pr_default.execute(0, new Object[] {new Integer(AV9Pant_Id), new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_20_idx = (short)(1) ;
         sGXsfl_20_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_20_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_202( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A18Pant_Id = H00322_A18Pant_Id[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A18Pant_Id", GXutil.ltrim( GXutil.str( A18Pant_Id, 6, 0)));
            A218RolP_FechaModifica = H00322_A218RolP_FechaModifica[0] ;
            A217RolP_UsuarioModifica = H00322_A217RolP_UsuarioModifica[0] ;
            A216RolP_FechaCrea = H00322_A216RolP_FechaCrea[0] ;
            A215RolP_UsuarioCrea = H00322_A215RolP_UsuarioCrea[0] ;
            A22Rol_Descripcion = H00322_A22Rol_Descripcion[0] ;
            A21Rol_Id = H00322_A21Rol_Id[0] ;
            A22Rol_Descripcion = H00322_A22Rol_Descripcion[0] ;
            e13322 ();
   ...
   {
      /* Using cursor H00323 */
      pr_default.execute(1, new Object[] {new Integer(AV9Pant_Id)});
   ...
   public void strup320( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV9Pant_Id = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV9Pant_Id"), ",", ".")) ;
   ...
   public void e12322( )
   {
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext, !bGXsfl_20_Refreshing);
      edtPant_Id_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtPant_Id_Internalname, "Visible", GXutil.ltrim( GXutil.str( edtPant_Id_Visible, 5, 0)), true);
   ...
   {
      /* Grid_Load Routine */
      edtavUpdate_Link = formatLink("com.orions2.seg_rol_pantalla") + "?" + GXutil.URLEncode(GXutil.rtrim("UPD")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A21Rol_Id,11,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV9Pant_Id,6,0))) ;
      edtavDelete_Link = formatLink("com.orions2.seg_rol_pantalla") + "?" + GXutil.URLEncode(GXutil.rtrim("DLT")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A21Rol_Id,11,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV9Pant_Id,6,0))) ;
      edtRol_Descripcion_Link = formatLink("com.orions2.viewseg_rol") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A21Rol_Id,11,0))) + "," + GXutil.URLEncode(GXutil.rtrim("")) ;
      /* Load Method */
      if ( wbStart != -1 )
      {
         wbStart = (short)(20) ;
   ...
   {
      /* 'DoInsert' Routine */
      callWebObject(formatLink("com.orions2.seg_rol_pantalla") + "?" + GXutil.URLEncode(GXutil.rtrim("INS")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(0,9,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV9Pant_Id,6,0))));
      httpContext.wjLocDisableFrm = (byte)(1) ;
   }
   ...
   public void S112( )
   {
      ...
      AV11TrnContext.setgxTv_SdtTransactionContext_Transactionname( "SEG_ROL_PANTALLA" );
      ...
      AV12TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributename( "Pant_Id" );
      AV12TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( GXutil.str( AV9Pant_Id, 6, 0) );
   ...
   {
      AV9Pant_Id = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.INT), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV9Pant_Id", GXutil.ltrim( GXutil.str( AV9Pant_Id, 6, 0)));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV9Pant_Id = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "seg_pantallaseg_rol_pantallawc");
      ...
      {
         AV9Pant_Id = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.INT), TypeConstants.INT)).intValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV9Pant_Id", GXutil.ltrim( GXutil.str( AV9Pant_Id, 6, 0)));
      }
      wcpOAV9Pant_Id = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV9Pant_Id"), ",", ".")) ;
      if ( ! GetJustCreated( ) && ( ( AV9Pant_Id != wcpOAV9Pant_Id ) ) )
      {
         setjustcreated();
      }
      wcpOAV9Pant_Id = AV9Pant_Id ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV9Pant_Id = httpContext.cgiGet( sPrefix+"AV9Pant_Id_CTRL") ;
      if ( GXutil.len( sCtrlAV9Pant_Id) > 0 )
      {
         AV9Pant_Id = (int)(localUtil.ctol( httpContext.cgiGet( sCtrlAV9Pant_Id), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV9Pant_Id", GXutil.ltrim( GXutil.str( AV9Pant_Id, 6, 0)));
      }
      else
      {
         AV9Pant_Id = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV9Pant_Id_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV9Pant_Id_PARM", GXutil.ltrim( localUtil.ntoc( AV9Pant_Id, (byte)(6), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV9Pant_Id)) > 0 )
      {
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV9Pant_Id_CTRL", GXutil.rtrim( sCtrlAV9Pant_Id));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20186141416517");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("seg_pantallaseg_rol_pantallawc.js", "?20186141416517");
      }
   ...
   {
      edtRol_Id_Internalname = sPrefix+"ROL_ID_"+sGXsfl_20_idx ;
      edtRol_Descripcion_Internalname = sPrefix+"ROL_DESCRIPCION_"+sGXsfl_20_idx ;
      edtRolP_UsuarioCrea_Internalname = sPrefix+"ROLP_USUARIOCREA_"+sGXsfl_20_idx ;
      edtRolP_FechaCrea_Internalname = sPrefix+"ROLP_FECHACREA_"+sGXsfl_20_idx ;
      edtRolP_UsuarioModifica_Internalname = sPrefix+"ROLP_USUARIOMODIFICA_"+sGXsfl_20_idx ;
      edtRolP_FechaModifica_Internalname = sPrefix+"ROLP_FECHAMODIFICA_"+sGXsfl_20_idx ;
   ...
   {
      edtRol_Id_Internalname = sPrefix+"ROL_ID_"+sGXsfl_20_fel_idx ;
      edtRol_Descripcion_Internalname = sPrefix+"ROL_DESCRIPCION_"+sGXsfl_20_fel_idx ;
      edtRolP_UsuarioCrea_Internalname = sPrefix+"ROLP_USUARIOCREA_"+sGXsfl_20_fel_idx ;
      edtRolP_FechaCrea_Internalname = sPrefix+"ROLP_FECHACREA_"+sGXsfl_20_fel_idx ;
      edtRolP_UsuarioModifica_Internalname = sPrefix+"ROLP_USUARIOMODIFICA_"+sGXsfl_20_fel_idx ;
      edtRolP_FechaModifica_Internalname = sPrefix+"ROLP_FECHAMODIFICA_"+sGXsfl_20_fel_idx ;
   ...
   public void sendrow_202( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRol_Id_Internalname,GXutil.ltrim( localUtil.ntoc( A21Rol_Id, (byte)(11), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A21Rol_Id), "ZZZZZZZZZZ9"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtRol_Id_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(11),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"Identificador","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRol_Descripcion_Internalname,A22Rol_Descripcion,GXutil.rtrim( localUtil.format( A22Rol_Descripcion, "@!")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'",edtRol_Descripcion_Link,"","","",edtRol_Descripcion_Jsonclick,new Integer(0),"DescriptionAttribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRolP_UsuarioCrea_Internalname,A215RolP_UsuarioCrea,GXutil.rtrim( localUtil.format( A215RolP_UsuarioCrea, "@!")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtRolP_UsuarioCrea_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRolP_FechaCrea_Internalname,localUtil.ttoc( A216RolP_FechaCrea, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A216RolP_FechaCrea, "99/99/99 99:99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtRolP_FechaCrea_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRolP_UsuarioModifica_Internalname,A217RolP_UsuarioModifica,GXutil.rtrim( localUtil.format( A217RolP_UsuarioModifica, "@!")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtRolP_UsuarioModifica_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRolP_FechaModifica_Internalname,localUtil.ttoc( A218RolP_FechaModifica, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A218RolP_FechaModifica, "99/99/99 99:99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtRolP_FechaModifica_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_ROL_ID"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, localUtil.format( DecimalUtil.doubleToDec(A21Rol_Id), "ZZZZZZZZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_ROLP_USUARIOCREA"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A215RolP_UsuarioCrea, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_ROLP_FECHACREA"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, localUtil.format( A216RolP_FechaCrea, "99/99/99 99:99")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_ROLP_USUARIOMODIFICA"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A217RolP_UsuarioModifica, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_ROLP_FECHAMODIFICA"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, localUtil.format( A218RolP_FechaModifica, "99/99/99 99:99")));
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV9Pant_Id',fld:'vPANT_ID',pic:'ZZZZZ9',nv:0},{av:'AV13Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV6Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A21Rol_Id',fld:'ROL_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e13322',iparms:[{av:'A21Rol_Id',fld:'ROL_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'AV9Pant_Id',fld:'vPANT_ID',pic:'ZZZZZ9',nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtRol_Descripcion_Link',ctrl:'ROL_DESCRIPCION',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e11322',iparms:[{av:'A21Rol_Id',fld:'ROL_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'AV9Pant_Id',fld:'vPANT_ID',pic:'ZZZZZ9',nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H00322_A18Pant_Id = new int[1] ;
      H00322_A218RolP_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H00322_A217RolP_UsuarioModifica = new String[] {""} ;
      H00322_A216RolP_FechaCrea = new java.util.Date[] {GXutil.nullDate()} ;
      H00322_A215RolP_UsuarioCrea = new String[] {""} ;
      H00322_A22Rol_Descripcion = new String[] {""} ;
      H00322_A21Rol_Id = new long[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.seg_pantallaseg_rol_pantallawc__default(),
         new Object[] {
             new Object[] {
            H00322_A18Pant_Id, H00322_A218RolP_FechaModifica, H00322_A217RolP_UsuarioModifica, H00322_A216RolP_FechaCrea, H00322_A215RolP_UsuarioCrea, H00322_A22Rol_Descripcion, H00322_A21Rol_Id
            }
            , new Object[] {
   ...
   private int wcpOAV9Pant_Id ;
   private int AV9Pant_Id ;
   ...
   private int edtPant_Id_Visible ;
   ...
   private String sCtrlAV9Pant_Id ;
   ...
   private int[] H00322_A18Pant_Id ;
   private java.util.Date[] H00322_A218RolP_FechaModifica ;
   private String[] H00322_A217RolP_UsuarioModifica ;
   private java.util.Date[] H00322_A216RolP_FechaCrea ;
   private String[] H00322_A215RolP_UsuarioCrea ;
   private String[] H00322_A22Rol_Descripcion ;
   private long[] H00322_A21Rol_Id ;
...
final  class seg_pantallaseg_rol_pantallawc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00322", "SELECT T1.Pant_Id, T1.RolP_FechaModifica, T1.RolP_UsuarioModifica, T1.RolP_FechaCrea, T1.RolP_UsuarioCrea, T2.Rol_Descripcion, T1.Rol_Id FROM (SEG_ROL_PANTALLA T1 INNER JOIN SEG_ROL T2 ON T2.Rol_Id = T1.Rol_Id) WHERE T1.Pant_Id = ? ORDER BY T1.Pant_Id  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H00323", "SELECT COUNT(*) FROM (SEG_ROL_PANTALLA T1 INNER JOIN SEG_ROL T2 ON T2.Rol_Id = T1.Rol_Id) WHERE T1.Pant_Id = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
