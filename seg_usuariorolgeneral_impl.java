/*
               File: seg_usuariorolgeneral_impl
...
public final  class seg_usuariorolgeneral_impl extends GXWebComponent
{
   public seg_usuariorolgeneral_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public seg_usuariorolgeneral_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( seg_usuariorolgeneral_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "SEG_USUARIOROLGeneral") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414114942");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.seg_usuariorolgeneral") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A23Usua_Id,18,0)))+"\">") ;
   ...
   public void renderHtmlCloseForm0R2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("seg_usuariorolgeneral.js", "?201861414114943");
      }
   ...
   public void wb0R0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.seg_usuariorolgeneral");
         }
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtnupdate_Internalname, "", "Modificar", bttBtnupdate_Jsonclick, 7, "Modificar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e110r1_client"+"'", TempTags, "", 2, "HLP_SEG_USUARIOROLGeneral.htm");
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtndelete_Internalname, "", "Eliminar", bttBtndelete_Jsonclick, 7, "Eliminar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e120r1_client"+"'", TempTags, "", 2, "HLP_SEG_USUARIOROLGeneral.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtUsua_Id_Internalname, GXutil.ltrim( localUtil.ntoc( A23Usua_Id, (byte)(18), (byte)(0), ",", "")), ((edtUsua_Id_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A23Usua_Id), "ZZZZZZZZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A23Usua_Id), "ZZZZZZZZZZZZZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtUsua_Id_Jsonclick, 0, "ReadonlyAttribute", "", "", "", 1, edtUsua_Id_Enabled, 0, "text", "", 18, "chr", 1, "row", 18, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "IdLargo", "right", false, "HLP_SEG_USUARIOROLGeneral.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtUsua_Codigo_Internalname, A24Usua_Codigo, GXutil.rtrim( localUtil.format( A24Usua_Codigo, "@!")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtUsua_Codigo_Jsonclick, 0, "ReadonlyAttribute", "", "", "", 1, edtUsua_Codigo_Enabled, 0, "text", "", 30, "chr", 1, "row", 30, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_SEG_USUARIOROLGeneral.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
   ...
   public void start0R2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "SEG_USUARIOROLGeneral", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV14Pgmname = "SEG_USUARIOROLGeneral" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf0R2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A26Usua_Cedula = H000R2_A26Usua_Cedula[0] ;
            ...
            A219Usua_Email = H000R2_A219Usua_Email[0] ;
            ...
            A25Usua_Nombre = H000R2_A25Usua_Nombre[0] ;
            ...
            A24Usua_Codigo = H000R2_A24Usua_Codigo[0] ;
   ...
   public void S112( )
   {
      ...
      AV8TrnContext.setgxTv_SdtTransactionContext_Transactionname( "SEG_USUARIOROL" );
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "seg_usuariorolgeneral");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414114970");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   {
      httpContext.AddJavascriptSource("seg_usuariorolgeneral.js", "?201861414114970");
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("'DOUPDATE'","{handler:'e110R1',iparms:[{av:'A23Usua_Id',fld:'USUA_ID',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0}],oparms:[]}");
      setEventMetadata("'DODELETE'","{handler:'e120R1',iparms:[{av:'A23Usua_Id',fld:'USUA_ID',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0}],oparms:[]}");
   }
   ...
   public void initialize( )
   {
      ...
      AV14Pgmname = "" ;
      scmdbuf = "" ;
      H000R2_A23Usua_Id = new long[1] ;
      H000R2_A26Usua_Cedula = new long[1] ;
      H000R2_A219Usua_Email = new String[] {""} ;
      H000R2_A25Usua_Nombre = new String[] {""} ;
      H000R2_A24Usua_Codigo = new String[] {""} ;
      ...
      sCtrlA23Usua_Id = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.seg_usuariorolgeneral__default(),
         new Object[] {
             new Object[] {
            H000R2_A23Usua_Id, H000R2_A26Usua_Cedula, H000R2_A219Usua_Email, H000R2_A25Usua_Nombre, H000R2_A24Usua_Codigo
            }
         }
      );
      AV14Pgmname = "SEG_USUARIOROLGeneral" ;
   ...
   private long[] H000R2_A23Usua_Id ;
   private long[] H000R2_A26Usua_Cedula ;
   private String[] H000R2_A219Usua_Email ;
   private String[] H000R2_A25Usua_Nombre ;
   private String[] H000R2_A24Usua_Codigo ;
...
final  class seg_usuariorolgeneral__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H000R2", "SELECT Usua_Id, Usua_Cedula, Usua_Email, Usua_Nombre, Usua_Codigo FROM SEG_USUARIO WHERE Usua_Id = ? ORDER BY Usua_Id ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
