/*
               File: seg_usuarioalm_transaccionwc_impl
...
public final  class seg_usuarioalm_transaccionwc_impl extends GXWebComponent
{
   public seg_usuarioalm_transaccionwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public seg_usuarioalm_transaccionwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( seg_usuarioalm_transaccionwc_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "SEG_USUARIOALM_TRANSACCIONWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414121036");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.seg_usuarioalm_transaccionwc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Tran_UsuarioId,18,0)))+"\">") ;
   ...
   public void renderHtmlCloseForm3R2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("seg_usuarioalm_transaccionwc.js", "?201861414121041");
      }
   ...
   public void wb3R0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.seg_usuarioalm_transaccionwc");
         }
         /* Div Control */
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_SEG_USUARIOALM_TRANSACCIONWC.htm");
      ...
      if ( wbEnd == 20 )
      {
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtTran_UsuarioId_Internalname, GXutil.ltrim( localUtil.ntoc( A47Tran_UsuarioId, (byte)(18), (byte)(0), ",", "")), ((edtTran_UsuarioId_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A47Tran_UsuarioId), "ZZZZZZZZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A47Tran_UsuarioId), "ZZZZZZZZZZZZZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTran_UsuarioId_Jsonclick, 0, "Attribute", "", "", "", edtTran_UsuarioId_Visible, edtTran_UsuarioId_Enabled, 0, "text", "", 18, "chr", 1, "row", 18, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "IdLargo", "right", false, "HLP_SEG_USUARIOALM_TRANSACCIONWC.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start3R2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "SEG_USUARIOALM_TRANSACCIONWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "SEG_USUARIOALM_TRANSACCIONWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf3R2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A416Tran_Observaciones = H003R2_A416Tran_Observaciones[0] ;
            n416Tran_Observaciones = H003R2_n416Tran_Observaciones[0] ;
            A47Tran_UsuarioId = H003R2_A47Tran_UsuarioId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A47Tran_UsuarioId", GXutil.ltrim( GXutil.str( A47Tran_UsuarioId, 18, 0)));
            n47Tran_UsuarioId = H003R2_n47Tran_UsuarioId[0] ;
            A859Tran_EntidadGobierno = H003R2_A859Tran_EntidadGobierno[0] ;
            n859Tran_EntidadGobierno = H003R2_n859Tran_EntidadGobierno[0] ;
            A759Tran_CedulaResponsabilidad = H003R2_A759Tran_CedulaResponsabilidad[0] ;
            n759Tran_CedulaResponsabilidad = H003R2_n759Tran_CedulaResponsabilidad[0] ;
            A758Tran_TablaResponsabilidad = H003R2_A758Tran_TablaResponsabilidad[0] ;
            n758Tran_TablaResponsabilidad = H003R2_n758Tran_TablaResponsabilidad[0] ;
            A756Tran_Abreviado = H003R2_A756Tran_Abreviado[0] ;
            n756Tran_Abreviado = H003R2_n756Tran_Abreviado[0] ;
            A754Tran_CuentaResponsabilidad = H003R2_A754Tran_CuentaResponsabilidad[0] ;
            n754Tran_CuentaResponsabilidad = H003R2_n754Tran_CuentaResponsabilidad[0] ;
            A721Tran_NombreCuentadanteResponsa = H003R2_A721Tran_NombreCuentadanteResponsa[0] ;
            n721Tran_NombreCuentadanteResponsa = H003R2_n721Tran_NombreCuentadanteResponsa[0] ;
            A720Tran_FechaResponsabilidad = H003R2_A720Tran_FechaResponsabilidad[0] ;
            n720Tran_FechaResponsabilidad = H003R2_n720Tran_FechaResponsabilidad[0] ;
            A719Tran_TransaccResponsabilidad = H003R2_A719Tran_TransaccResponsabilidad[0] ;
            n719Tran_TransaccResponsabilidad = H003R2_n719Tran_TransaccResponsabilidad[0] ;
            A56Tran_IdCuentadanteResponsabili = H003R2_A56Tran_IdCuentadanteResponsabili[0] ;
            n56Tran_IdCuentadanteResponsabili = H003R2_n56Tran_IdCuentadanteResponsabili[0] ;
            A715Tran_EmailCuentadanteDestino = H003R2_A715Tran_EmailCuentadanteDestino[0] ;
            n715Tran_EmailCuentadanteDestino = H003R2_n715Tran_EmailCuentadanteDestino[0] ;
            A714Tran_EmailCuentadanteOrigen = H003R2_A714Tran_EmailCuentadanteOrigen[0] ;
            n714Tran_EmailCuentadanteOrigen = H003R2_n714Tran_EmailCuentadanteOrigen[0] ;
            A708Tran_SolicitaRegionDestino = H003R2_A708Tran_SolicitaRegionDestino[0] ;
            n708Tran_SolicitaRegionDestino = H003R2_n708Tran_SolicitaRegionDestino[0] ;
            A707Tran_SolicitaCCDestino = H003R2_A707Tran_SolicitaCCDestino[0] ;
            n707Tran_SolicitaCCDestino = H003R2_n707Tran_SolicitaCCDestino[0] ;
            A704Tran_CedulaCuentadanteDestino = H003R2_A704Tran_CedulaCuentadanteDestino[0] ;
            n704Tran_CedulaCuentadanteDestino = H003R2_n704Tran_CedulaCuentadanteDestino[0] ;
            A703Tran_CedulaProveedor = H003R2_A703Tran_CedulaProveedor[0] ;
            n703Tran_CedulaProveedor = H003R2_n703Tran_CedulaProveedor[0] ;
            A702Tran_CedulaCuentadanteOrigen = H003R2_A702Tran_CedulaCuentadanteOrigen[0] ;
            n702Tran_CedulaCuentadanteOrigen = H003R2_n702Tran_CedulaCuentadanteOrigen[0] ;
            A672Tran_NombreIngreso = H003R2_A672Tran_NombreIngreso[0] ;
            n672Tran_NombreIngreso = H003R2_n672Tran_NombreIngreso[0] ;
            A389Tran_NombCuentadanteDestino = H003R2_A389Tran_NombCuentadanteDestino[0] ;
            n389Tran_NombCuentadanteDestino = H003R2_n389Tran_NombCuentadanteDestino[0] ;
            A575Tran_NombreProveedor = H003R2_A575Tran_NombreProveedor[0] ;
            n575Tran_NombreProveedor = H003R2_n575Tran_NombreProveedor[0] ;
            A384Tran_NombCuentadanteOrigen = H003R2_A384Tran_NombCuentadanteOrigen[0] ;
            n384Tran_NombCuentadanteOrigen = H003R2_n384Tran_NombCuentadanteOrigen[0] ;
            A670Tran_ObservacionesAnula = H003R2_A670Tran_ObservacionesAnula[0] ;
            n670Tran_ObservacionesAnula = H003R2_n670Tran_ObservacionesAnula[0] ;
            A669Tran_FechaEliminaoAnula = H003R2_A669Tran_FechaEliminaoAnula[0] ;
            n669Tran_FechaEliminaoAnula = H003R2_n669Tran_FechaEliminaoAnula[0] ;
            A668Tran_UsuarioEliminaoAnula = H003R2_A668Tran_UsuarioEliminaoAnula[0] ;
            n668Tran_UsuarioEliminaoAnula = H003R2_n668Tran_UsuarioEliminaoAnula[0] ;
            A667Tran_NumeroGrupo = H003R2_A667Tran_NumeroGrupo[0] ;
            n667Tran_NumeroGrupo = H003R2_n667Tran_NumeroGrupo[0] ;
            A524Tran_Detalle = H003R2_A524Tran_Detalle[0] ;
            n524Tran_Detalle = H003R2_n524Tran_Detalle[0] ;
            A608Tran_RegionAbrevDestino = H003R2_A608Tran_RegionAbrevDestino[0] ;
            n608Tran_RegionAbrevDestino = H003R2_n608Tran_RegionAbrevDestino[0] ;
            A594Tran_RegionAbrev = H003R2_A594Tran_RegionAbrev[0] ;
            n594Tran_RegionAbrev = H003R2_n594Tran_RegionAbrev[0] ;
            A53Tran_IdProveedor = H003R2_A53Tran_IdProveedor[0] ;
            n53Tran_IdProveedor = H003R2_n53Tran_IdProveedor[0] ;
            A568Tran_CantidadPadres = H003R2_A568Tran_CantidadPadres[0] ;
            n568Tran_CantidadPadres = H003R2_n568Tran_CantidadPadres[0] ;
            A527Tran_TipoEntra = H003R2_A527Tran_TipoEntra[0] ;
            n527Tran_TipoEntra = H003R2_n527Tran_TipoEntra[0] ;
            A520Tran_RegionDescripcionDestino = H003R2_A520Tran_RegionDescripcionDestino[0] ;
            n520Tran_RegionDescripcionDestino = H003R2_n520Tran_RegionDescripcionDestino[0] ;
            A519Tran_RegionCodigoDestino = H003R2_A519Tran_RegionCodigoDestino[0] ;
            n519Tran_RegionCodigoDestino = H003R2_n519Tran_RegionCodigoDestino[0] ;
            A518Tran_RegionIdDestino = H003R2_A518Tran_RegionIdDestino[0] ;
            n518Tran_RegionIdDestino = H003R2_n518Tran_RegionIdDestino[0] ;
            A517Tran_CentroCostoDescripcionDes = H003R2_A517Tran_CentroCostoDescripcionDes[0] ;
            n517Tran_CentroCostoDescripcionDes = H003R2_n517Tran_CentroCostoDescripcionDes[0] ;
            A516Tran_CentroCostoCodigoDestino = H003R2_A516Tran_CentroCostoCodigoDestino[0] ;
            n516Tran_CentroCostoCodigoDestino = H003R2_n516Tran_CentroCostoCodigoDestino[0] ;
            A50Tran_CentroCostoIdDestino = H003R2_A50Tran_CentroCostoIdDestino[0] ;
            n50Tran_CentroCostoIdDestino = H003R2_n50Tran_CentroCostoIdDestino[0] ;
            A515Tran_FechaIngreso = H003R2_A515Tran_FechaIngreso[0] ;
            n515Tran_FechaIngreso = H003R2_n515Tran_FechaIngreso[0] ;
            A514Tran_NumeroIngreso = H003R2_A514Tran_NumeroIngreso[0] ;
            n514Tran_NumeroIngreso = H003R2_n514Tran_NumeroIngreso[0] ;
            A54Tran_TipoIngreso = H003R2_A54Tran_TipoIngreso[0] ;
            n54Tran_TipoIngreso = H003R2_n54Tran_TipoIngreso[0] ;
            A513Tran_ConsecutivoCC = H003R2_A513Tran_ConsecutivoCC[0] ;
            n513Tran_ConsecutivoCC = H003R2_n513Tran_ConsecutivoCC[0] ;
            A482Tran_TipoElemento = H003R2_A482Tran_TipoElemento[0] ;
            A499Tran_CodTipoElemento = H003R2_A499Tran_CodTipoElemento[0] ;
            n499Tran_CodTipoElemento = H003R2_n499Tran_CodTipoElemento[0] ;
            A498Tran_NumeroLineas = H003R2_A498Tran_NumeroLineas[0] ;
            n498Tran_NumeroLineas = H003R2_n498Tran_NumeroLineas[0] ;
            A483Tran_ValorTransaccion = H003R2_A483Tran_ValorTransaccion[0] ;
            n483Tran_ValorTransaccion = H003R2_n483Tran_ValorTransaccion[0] ;
            A481Tran_IndE_S = H003R2_A481Tran_IndE_S[0] ;
            n481Tran_IndE_S = H003R2_n481Tran_IndE_S[0] ;
            A479Tran_IndCurso = H003R2_A479Tran_IndCurso[0] ;
            n479Tran_IndCurso = H003R2_n479Tran_IndCurso[0] ;
            A478Tran_IndAreadante = H003R2_A478Tran_IndAreadante[0] ;
            n478Tran_IndAreadante = H003R2_n478Tran_IndAreadante[0] ;
            A408Tran_CursoCodigo = H003R2_A408Tran_CursoCodigo[0] ;
            n408Tran_CursoCodigo = H003R2_n408Tran_CursoCodigo[0] ;
            A407Tran_AreadanteCodigo = H003R2_A407Tran_AreadanteCodigo[0] ;
            n407Tran_AreadanteCodigo = H003R2_n407Tran_AreadanteCodigo[0] ;
            A391Tran_UsuarioRatifica = H003R2_A391Tran_UsuarioRatifica[0] ;
            n391Tran_UsuarioRatifica = H003R2_n391Tran_UsuarioRatifica[0] ;
            A390Tran_FechaRatificacion = H003R2_A390Tran_FechaRatificacion[0] ;
            n390Tran_FechaRatificacion = H003R2_n390Tran_FechaRatificacion[0] ;
            A58Tran_Estado = H003R2_A58Tran_Estado[0] ;
            n58Tran_Estado = H003R2_n58Tran_Estado[0] ;
            A52Tran_IdCuentadanteDestino = H003R2_A52Tran_IdCuentadanteDestino[0] ;
            n52Tran_IdCuentadanteDestino = H003R2_n52Tran_IdCuentadanteDestino[0] ;
            A387Tran_CodBodeDestino = H003R2_A387Tran_CodBodeDestino[0] ;
            A111Tran_CodAlmaDestino = H003R2_A111Tran_CodAlmaDestino[0] ;
            A385Tran_ModuloDestino = H003R2_A385Tran_ModuloDestino[0] ;
            A51Tran_IdCuentadanteOrigen = H003R2_A51Tran_IdCuentadanteOrigen[0] ;
            n51Tran_IdCuentadanteOrigen = H003R2_n51Tran_IdCuentadanteOrigen[0] ;
            A112Tran_CodBodeOrigen = H003R2_A112Tran_CodBodeOrigen[0] ;
            A109Tran_CodAlmaOrigen = H003R2_A109Tran_CodAlmaOrigen[0] ;
            A110Tran_ModuloOrigen = H003R2_A110Tran_ModuloOrigen[0] ;
            A381Tran_DescripcionMovimiento = H003R2_A381Tran_DescripcionMovimiento[0] ;
            n381Tran_DescripcionMovimiento = H003R2_n381Tran_DescripcionMovimiento[0] ;
            A49Tran_CodigoMovimiento = H003R2_A49Tran_CodigoMovimiento[0] ;
            A422Tran_RegionDescripcion = H003R2_A422Tran_RegionDescripcion[0] ;
            n422Tran_RegionDescripcion = H003R2_n422Tran_RegionDescripcion[0] ;
            A421Tran_RegionCodigo = H003R2_A421Tran_RegionCodigo[0] ;
            n421Tran_RegionCodigo = H003R2_n421Tran_RegionCodigo[0] ;
            A57Tran_RegionId = H003R2_A57Tran_RegionId[0] ;
            n57Tran_RegionId = H003R2_n57Tran_RegionId[0] ;
            A420Tran_CentroCostoDescripcion = H003R2_A420Tran_CentroCostoDescripcion[0] ;
            n420Tran_CentroCostoDescripcion = H003R2_n420Tran_CentroCostoDescripcion[0] ;
            A419Tran_CentroCostoCodigo = H003R2_A419Tran_CentroCostoCodigo[0] ;
            n419Tran_CentroCostoCodigo = H003R2_n419Tran_CentroCostoCodigo[0] ;
            A48Tran_CentroCostoId = H003R2_A48Tran_CentroCostoId[0] ;
            A55Tran_FechaRegistro = H003R2_A55Tran_FechaRegistro[0] ;
            A46Tran_Id = H003R2_A46Tran_Id[0] ;
            A759Tran_CedulaResponsabilidad = H003R2_A759Tran_CedulaResponsabilidad[0] ;
            n759Tran_CedulaResponsabilidad = H003R2_n759Tran_CedulaResponsabilidad[0] ;
            A721Tran_NombreCuentadanteResponsa = H003R2_A721Tran_NombreCuentadanteResponsa[0] ;
            n721Tran_NombreCuentadanteResponsa = H003R2_n721Tran_NombreCuentadanteResponsa[0] ;
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "seg_usuarioalm_transaccionwc");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414121311");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("seg_usuarioalm_transaccionwc.js", "?201861414121311");
      }
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e133R2',iparms:[{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtTran_ConsecutivoCC_Link',ctrl:'TRAN_CONSECUTIVOCC',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e113R2',iparms:[{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H003R2_A416Tran_Observaciones = new String[] {""} ;
      H003R2_n416Tran_Observaciones = new boolean[] {false} ;
      H003R2_A47Tran_UsuarioId = new long[1] ;
      H003R2_n47Tran_UsuarioId = new boolean[] {false} ;
      H003R2_A859Tran_EntidadGobierno = new String[] {""} ;
      H003R2_n859Tran_EntidadGobierno = new boolean[] {false} ;
      H003R2_A759Tran_CedulaResponsabilidad = new long[1] ;
      H003R2_n759Tran_CedulaResponsabilidad = new boolean[] {false} ;
      H003R2_A758Tran_TablaResponsabilidad = new short[1] ;
      H003R2_n758Tran_TablaResponsabilidad = new boolean[] {false} ;
      H003R2_A756Tran_Abreviado = new String[] {""} ;
      H003R2_n756Tran_Abreviado = new boolean[] {false} ;
      H003R2_A754Tran_CuentaResponsabilidad = new String[] {""} ;
      H003R2_n754Tran_CuentaResponsabilidad = new boolean[] {false} ;
      H003R2_A721Tran_NombreCuentadanteResponsa = new String[] {""} ;
      H003R2_n721Tran_NombreCuentadanteResponsa = new boolean[] {false} ;
      H003R2_A720Tran_FechaResponsabilidad = new java.util.Date[] {GXutil.nullDate()} ;
      H003R2_n720Tran_FechaResponsabilidad = new boolean[] {false} ;
      H003R2_A719Tran_TransaccResponsabilidad = new long[1] ;
      H003R2_n719Tran_TransaccResponsabilidad = new boolean[] {false} ;
      H003R2_A56Tran_IdCuentadanteResponsabili = new long[1] ;
      H003R2_n56Tran_IdCuentadanteResponsabili = new boolean[] {false} ;
      H003R2_A715Tran_EmailCuentadanteDestino = new String[] {""} ;
      H003R2_n715Tran_EmailCuentadanteDestino = new boolean[] {false} ;
      H003R2_A714Tran_EmailCuentadanteOrigen = new String[] {""} ;
      H003R2_n714Tran_EmailCuentadanteOrigen = new boolean[] {false} ;
      H003R2_A708Tran_SolicitaRegionDestino = new String[] {""} ;
      H003R2_n708Tran_SolicitaRegionDestino = new boolean[] {false} ;
      H003R2_A707Tran_SolicitaCCDestino = new String[] {""} ;
      H003R2_n707Tran_SolicitaCCDestino = new boolean[] {false} ;
      H003R2_A704Tran_CedulaCuentadanteDestino = new long[1] ;
      H003R2_n704Tran_CedulaCuentadanteDestino = new boolean[] {false} ;
      H003R2_A703Tran_CedulaProveedor = new long[1] ;
      H003R2_n703Tran_CedulaProveedor = new boolean[] {false} ;
      H003R2_A702Tran_CedulaCuentadanteOrigen = new long[1] ;
      H003R2_n702Tran_CedulaCuentadanteOrigen = new boolean[] {false} ;
      H003R2_A672Tran_NombreIngreso = new String[] {""} ;
      H003R2_n672Tran_NombreIngreso = new boolean[] {false} ;
      H003R2_A389Tran_NombCuentadanteDestino = new String[] {""} ;
      H003R2_n389Tran_NombCuentadanteDestino = new boolean[] {false} ;
      H003R2_A575Tran_NombreProveedor = new String[] {""} ;
      H003R2_n575Tran_NombreProveedor = new boolean[] {false} ;
      H003R2_A384Tran_NombCuentadanteOrigen = new String[] {""} ;
      H003R2_n384Tran_NombCuentadanteOrigen = new boolean[] {false} ;
      H003R2_A670Tran_ObservacionesAnula = new String[] {""} ;
      H003R2_n670Tran_ObservacionesAnula = new boolean[] {false} ;
      H003R2_A669Tran_FechaEliminaoAnula = new java.util.Date[] {GXutil.nullDate()} ;
      H003R2_n669Tran_FechaEliminaoAnula = new boolean[] {false} ;
      H003R2_A668Tran_UsuarioEliminaoAnula = new String[] {""} ;
      H003R2_n668Tran_UsuarioEliminaoAnula = new boolean[] {false} ;
      H003R2_A667Tran_NumeroGrupo = new short[1] ;
      H003R2_n667Tran_NumeroGrupo = new boolean[] {false} ;
      H003R2_A524Tran_Detalle = new String[] {""} ;
      H003R2_n524Tran_Detalle = new boolean[] {false} ;
      H003R2_A608Tran_RegionAbrevDestino = new String[] {""} ;
      H003R2_n608Tran_RegionAbrevDestino = new boolean[] {false} ;
      H003R2_A594Tran_RegionAbrev = new String[] {""} ;
      H003R2_n594Tran_RegionAbrev = new boolean[] {false} ;
      H003R2_A53Tran_IdProveedor = new long[1] ;
      H003R2_n53Tran_IdProveedor = new boolean[] {false} ;
      H003R2_A568Tran_CantidadPadres = new int[1] ;
      H003R2_n568Tran_CantidadPadres = new boolean[] {false} ;
      H003R2_A527Tran_TipoEntra = new String[] {""} ;
      H003R2_n527Tran_TipoEntra = new boolean[] {false} ;
      H003R2_A520Tran_RegionDescripcionDestino = new String[] {""} ;
      H003R2_n520Tran_RegionDescripcionDestino = new boolean[] {false} ;
      H003R2_A519Tran_RegionCodigoDestino = new short[1] ;
      H003R2_n519Tran_RegionCodigoDestino = new boolean[] {false} ;
      H003R2_A518Tran_RegionIdDestino = new long[1] ;
      H003R2_n518Tran_RegionIdDestino = new boolean[] {false} ;
      H003R2_A517Tran_CentroCostoDescripcionDes = new String[] {""} ;
      H003R2_n517Tran_CentroCostoDescripcionDes = new boolean[] {false} ;
      H003R2_A516Tran_CentroCostoCodigoDestino = new String[] {""} ;
      H003R2_n516Tran_CentroCostoCodigoDestino = new boolean[] {false} ;
      H003R2_A50Tran_CentroCostoIdDestino = new long[1] ;
      H003R2_n50Tran_CentroCostoIdDestino = new boolean[] {false} ;
      H003R2_A515Tran_FechaIngreso = new java.util.Date[] {GXutil.nullDate()} ;
      H003R2_n515Tran_FechaIngreso = new boolean[] {false} ;
      H003R2_A514Tran_NumeroIngreso = new String[] {""} ;
      H003R2_n514Tran_NumeroIngreso = new boolean[] {false} ;
      H003R2_A54Tran_TipoIngreso = new long[1] ;
      H003R2_n54Tran_TipoIngreso = new boolean[] {false} ;
      H003R2_A513Tran_ConsecutivoCC = new long[1] ;
      H003R2_n513Tran_ConsecutivoCC = new boolean[] {false} ;
      H003R2_A482Tran_TipoElemento = new String[] {""} ;
      H003R2_A499Tran_CodTipoElemento = new long[1] ;
      H003R2_n499Tran_CodTipoElemento = new boolean[] {false} ;
      H003R2_A498Tran_NumeroLineas = new long[1] ;
      H003R2_n498Tran_NumeroLineas = new boolean[] {false} ;
      H003R2_A483Tran_ValorTransaccion = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H003R2_n483Tran_ValorTransaccion = new boolean[] {false} ;
      H003R2_A481Tran_IndE_S = new String[] {""} ;
      H003R2_n481Tran_IndE_S = new boolean[] {false} ;
      H003R2_A479Tran_IndCurso = new String[] {""} ;
      H003R2_n479Tran_IndCurso = new boolean[] {false} ;
      H003R2_A478Tran_IndAreadante = new String[] {""} ;
      H003R2_n478Tran_IndAreadante = new boolean[] {false} ;
      H003R2_A408Tran_CursoCodigo = new String[] {""} ;
      H003R2_n408Tran_CursoCodigo = new boolean[] {false} ;
      H003R2_A407Tran_AreadanteCodigo = new String[] {""} ;
      H003R2_n407Tran_AreadanteCodigo = new boolean[] {false} ;
      H003R2_A391Tran_UsuarioRatifica = new String[] {""} ;
      H003R2_n391Tran_UsuarioRatifica = new boolean[] {false} ;
      H003R2_A390Tran_FechaRatificacion = new java.util.Date[] {GXutil.nullDate()} ;
      H003R2_n390Tran_FechaRatificacion = new boolean[] {false} ;
      H003R2_A58Tran_Estado = new String[] {""} ;
      H003R2_n58Tran_Estado = new boolean[] {false} ;
      H003R2_A52Tran_IdCuentadanteDestino = new long[1] ;
      H003R2_n52Tran_IdCuentadanteDestino = new boolean[] {false} ;
      H003R2_A387Tran_CodBodeDestino = new String[] {""} ;
      H003R2_A111Tran_CodAlmaDestino = new String[] {""} ;
      H003R2_A385Tran_ModuloDestino = new String[] {""} ;
      H003R2_A51Tran_IdCuentadanteOrigen = new long[1] ;
      H003R2_n51Tran_IdCuentadanteOrigen = new boolean[] {false} ;
      H003R2_A112Tran_CodBodeOrigen = new String[] {""} ;
      H003R2_A109Tran_CodAlmaOrigen = new String[] {""} ;
      H003R2_A110Tran_ModuloOrigen = new String[] {""} ;
      H003R2_A381Tran_DescripcionMovimiento = new String[] {""} ;
      H003R2_n381Tran_DescripcionMovimiento = new boolean[] {false} ;
      H003R2_A49Tran_CodigoMovimiento = new String[] {""} ;
      H003R2_A422Tran_RegionDescripcion = new String[] {""} ;
      H003R2_n422Tran_RegionDescripcion = new boolean[] {false} ;
      H003R2_A421Tran_RegionCodigo = new short[1] ;
      H003R2_n421Tran_RegionCodigo = new boolean[] {false} ;
      H003R2_A57Tran_RegionId = new long[1] ;
      H003R2_n57Tran_RegionId = new boolean[] {false} ;
      H003R2_A420Tran_CentroCostoDescripcion = new String[] {""} ;
      H003R2_n420Tran_CentroCostoDescripcion = new boolean[] {false} ;
      H003R2_A419Tran_CentroCostoCodigo = new String[] {""} ;
      H003R2_n419Tran_CentroCostoCodigo = new boolean[] {false} ;
      H003R2_A48Tran_CentroCostoId = new long[1] ;
      H003R2_A55Tran_FechaRegistro = new java.util.Date[] {GXutil.nullDate()} ;
      H003R2_A46Tran_Id = new long[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.seg_usuarioalm_transaccionwc__default(),
         new Object[] {
             new Object[] {
            H003R2_A416Tran_Observaciones, H003R2_n416Tran_Observaciones, H003R2_A47Tran_UsuarioId, H003R2_n47Tran_UsuarioId, H003R2_A859Tran_EntidadGobierno, H003R2_n859Tran_EntidadGobierno, H003R2_A759Tran_CedulaResponsabilidad, H003R2_n759Tran_CedulaResponsabilidad, H003R2_A758Tran_TablaResponsabilidad, H003R2_n758Tran_TablaResponsabilidad,
            H003R2_A756Tran_Abreviado, H003R2_n756Tran_Abreviado, H003R2_A754Tran_CuentaResponsabilidad, H003R2_n754Tran_CuentaResponsabilidad, H003R2_A721Tran_NombreCuentadanteResponsa, H003R2_n721Tran_NombreCuentadanteResponsa, H003R2_A720Tran_FechaResponsabilidad, H003R2_n720Tran_FechaResponsabilidad, H003R2_A719Tran_TransaccResponsabilidad, H003R2_n719Tran_TransaccResponsabilidad,
            H003R2_A56Tran_IdCuentadanteResponsabili, H003R2_n56Tran_IdCuentadanteResponsabili, H003R2_A715Tran_EmailCuentadanteDestino, H003R2_n715Tran_EmailCuentadanteDestino, H003R2_A714Tran_EmailCuentadanteOrigen, H003R2_n714Tran_EmailCuentadanteOrigen, H003R2_A708Tran_SolicitaRegionDestino, H003R2_n708Tran_SolicitaRegionDestino, H003R2_A707Tran_SolicitaCCDestino, H003R2_n707Tran_SolicitaCCDestino,
            H003R2_A704Tran_CedulaCuentadanteDestino, H003R2_n704Tran_CedulaCuentadanteDestino, H003R2_A703Tran_CedulaProveedor, H003R2_n703Tran_CedulaProveedor, H003R2_A702Tran_CedulaCuentadanteOrigen, H003R2_n702Tran_CedulaCuentadanteOrigen, H003R2_A672Tran_NombreIngreso, H003R2_n672Tran_NombreIngreso, H003R2_A389Tran_NombCuentadanteDestino, H003R2_n389Tran_NombCuentadanteDestino,
            H003R2_A575Tran_NombreProveedor, H003R2_n575Tran_NombreProveedor, H003R2_A384Tran_NombCuentadanteOrigen, H003R2_n384Tran_NombCuentadanteOrigen, H003R2_A670Tran_ObservacionesAnula, H003R2_n670Tran_ObservacionesAnula, H003R2_A669Tran_FechaEliminaoAnula, H003R2_n669Tran_FechaEliminaoAnula, H003R2_A668Tran_UsuarioEliminaoAnula, H003R2_n668Tran_UsuarioEliminaoAnula,
            H003R2_A667Tran_NumeroGrupo, H003R2_n667Tran_NumeroGrupo, H003R2_A524Tran_Detalle, H003R2_n524Tran_Detalle, H003R2_A608Tran_RegionAbrevDestino, H003R2_n608Tran_RegionAbrevDestino, H003R2_A594Tran_RegionAbrev, H003R2_n594Tran_RegionAbrev, H003R2_A53Tran_IdProveedor, H003R2_n53Tran_IdProveedor,
            H003R2_A568Tran_CantidadPadres, H003R2_n568Tran_CantidadPadres, H003R2_A527Tran_TipoEntra, H003R2_n527Tran_TipoEntra, H003R2_A520Tran_RegionDescripcionDestino, H003R2_n520Tran_RegionDescripcionDestino, H003R2_A519Tran_RegionCodigoDestino, H003R2_n519Tran_RegionCodigoDestino, H003R2_A518Tran_RegionIdDestino, H003R2_n518Tran_RegionIdDestino,
            H003R2_A517Tran_CentroCostoDescripcionDes, H003R2_n517Tran_CentroCostoDescripcionDes, H003R2_A516Tran_CentroCostoCodigoDestino, H003R2_n516Tran_CentroCostoCodigoDestino, H003R2_A50Tran_CentroCostoIdDestino, H003R2_n50Tran_CentroCostoIdDestino, H003R2_A515Tran_FechaIngreso, H003R2_n515Tran_FechaIngreso, H003R2_A514Tran_NumeroIngreso, H003R2_n514Tran_NumeroIngreso,
            H003R2_A54Tran_TipoIngreso, H003R2_n54Tran_TipoIngreso, H003R2_A513Tran_ConsecutivoCC, H003R2_n513Tran_ConsecutivoCC, H003R2_A482Tran_TipoElemento, H003R2_A499Tran_CodTipoElemento, H003R2_n499Tran_CodTipoElemento, H003R2_A498Tran_NumeroLineas, H003R2_n498Tran_NumeroLineas, H003R2_A483Tran_ValorTransaccion,
            H003R2_n483Tran_ValorTransaccion, H003R2_A481Tran_IndE_S, H003R2_n481Tran_IndE_S, H003R2_A479Tran_IndCurso, H003R2_n479Tran_IndCurso, H003R2_A478Tran_IndAreadante, H003R2_n478Tran_IndAreadante, H003R2_A408Tran_CursoCodigo, H003R2_n408Tran_CursoCodigo, H003R2_A407Tran_AreadanteCodigo,
            H003R2_n407Tran_AreadanteCodigo, H003R2_A391Tran_UsuarioRatifica, H003R2_n391Tran_UsuarioRatifica, H003R2_A390Tran_FechaRatificacion, H003R2_n390Tran_FechaRatificacion, H003R2_A58Tran_Estado, H003R2_n58Tran_Estado, H003R2_A52Tran_IdCuentadanteDestino, H003R2_n52Tran_IdCuentadanteDestino, H003R2_A387Tran_CodBodeDestino,
            H003R2_A111Tran_CodAlmaDestino, H003R2_A385Tran_ModuloDestino, H003R2_A51Tran_IdCuentadanteOrigen, H003R2_n51Tran_IdCuentadanteOrigen, H003R2_A112Tran_CodBodeOrigen, H003R2_A109Tran_CodAlmaOrigen, H003R2_A110Tran_ModuloOrigen, H003R2_A381Tran_DescripcionMovimiento, H003R2_n381Tran_DescripcionMovimiento, H003R2_A49Tran_CodigoMovimiento,
            H003R2_A422Tran_RegionDescripcion, H003R2_n422Tran_RegionDescripcion, H003R2_A421Tran_RegionCodigo, H003R2_n421Tran_RegionCodigo, H003R2_A57Tran_RegionId, H003R2_n57Tran_RegionId, H003R2_A420Tran_CentroCostoDescripcion, H003R2_n420Tran_CentroCostoDescripcion, H003R2_A419Tran_CentroCostoCodigo, H003R2_n419Tran_CentroCostoCodigo,
            H003R2_A48Tran_CentroCostoId, H003R2_A55Tran_FechaRegistro, H003R2_A46Tran_Id
            }
            , new Object[] {
   ...
   private String[] H003R2_A416Tran_Observaciones ;
   private boolean[] H003R2_n416Tran_Observaciones ;
   private long[] H003R2_A47Tran_UsuarioId ;
   private boolean[] H003R2_n47Tran_UsuarioId ;
   private String[] H003R2_A859Tran_EntidadGobierno ;
   private boolean[] H003R2_n859Tran_EntidadGobierno ;
   private long[] H003R2_A759Tran_CedulaResponsabilidad ;
   private boolean[] H003R2_n759Tran_CedulaResponsabilidad ;
   private short[] H003R2_A758Tran_TablaResponsabilidad ;
   private boolean[] H003R2_n758Tran_TablaResponsabilidad ;
   private String[] H003R2_A756Tran_Abreviado ;
   private boolean[] H003R2_n756Tran_Abreviado ;
   private String[] H003R2_A754Tran_CuentaResponsabilidad ;
   private boolean[] H003R2_n754Tran_CuentaResponsabilidad ;
   private String[] H003R2_A721Tran_NombreCuentadanteResponsa ;
   private boolean[] H003R2_n721Tran_NombreCuentadanteResponsa ;
   private java.util.Date[] H003R2_A720Tran_FechaResponsabilidad ;
   private boolean[] H003R2_n720Tran_FechaResponsabilidad ;
   private long[] H003R2_A719Tran_TransaccResponsabilidad ;
   private boolean[] H003R2_n719Tran_TransaccResponsabilidad ;
   private long[] H003R2_A56Tran_IdCuentadanteResponsabili ;
   private boolean[] H003R2_n56Tran_IdCuentadanteResponsabili ;
   private String[] H003R2_A715Tran_EmailCuentadanteDestino ;
   private boolean[] H003R2_n715Tran_EmailCuentadanteDestino ;
   private String[] H003R2_A714Tran_EmailCuentadanteOrigen ;
   private boolean[] H003R2_n714Tran_EmailCuentadanteOrigen ;
   private String[] H003R2_A708Tran_SolicitaRegionDestino ;
   private boolean[] H003R2_n708Tran_SolicitaRegionDestino ;
   private String[] H003R2_A707Tran_SolicitaCCDestino ;
   private boolean[] H003R2_n707Tran_SolicitaCCDestino ;
   private long[] H003R2_A704Tran_CedulaCuentadanteDestino ;
   private boolean[] H003R2_n704Tran_CedulaCuentadanteDestino ;
   private long[] H003R2_A703Tran_CedulaProveedor ;
   private boolean[] H003R2_n703Tran_CedulaProveedor ;
   private long[] H003R2_A702Tran_CedulaCuentadanteOrigen ;
   private boolean[] H003R2_n702Tran_CedulaCuentadanteOrigen ;
   private String[] H003R2_A672Tran_NombreIngreso ;
   private boolean[] H003R2_n672Tran_NombreIngreso ;
   private String[] H003R2_A389Tran_NombCuentadanteDestino ;
   private boolean[] H003R2_n389Tran_NombCuentadanteDestino ;
   private String[] H003R2_A575Tran_NombreProveedor ;
   private boolean[] H003R2_n575Tran_NombreProveedor ;
   private String[] H003R2_A384Tran_NombCuentadanteOrigen ;
   private boolean[] H003R2_n384Tran_NombCuentadanteOrigen ;
   private String[] H003R2_A670Tran_ObservacionesAnula ;
   private boolean[] H003R2_n670Tran_ObservacionesAnula ;
   private java.util.Date[] H003R2_A669Tran_FechaEliminaoAnula ;
   private boolean[] H003R2_n669Tran_FechaEliminaoAnula ;
   private String[] H003R2_A668Tran_UsuarioEliminaoAnula ;
   private boolean[] H003R2_n668Tran_UsuarioEliminaoAnula ;
   private short[] H003R2_A667Tran_NumeroGrupo ;
   private boolean[] H003R2_n667Tran_NumeroGrupo ;
   private String[] H003R2_A524Tran_Detalle ;
   private boolean[] H003R2_n524Tran_Detalle ;
   private String[] H003R2_A608Tran_RegionAbrevDestino ;
   private boolean[] H003R2_n608Tran_RegionAbrevDestino ;
   private String[] H003R2_A594Tran_RegionAbrev ;
   private boolean[] H003R2_n594Tran_RegionAbrev ;
   private long[] H003R2_A53Tran_IdProveedor ;
   private boolean[] H003R2_n53Tran_IdProveedor ;
   private int[] H003R2_A568Tran_CantidadPadres ;
   private boolean[] H003R2_n568Tran_CantidadPadres ;
   private String[] H003R2_A527Tran_TipoEntra ;
   private boolean[] H003R2_n527Tran_TipoEntra ;
   private String[] H003R2_A520Tran_RegionDescripcionDestino ;
   private boolean[] H003R2_n520Tran_RegionDescripcionDestino ;
   private short[] H003R2_A519Tran_RegionCodigoDestino ;
   private boolean[] H003R2_n519Tran_RegionCodigoDestino ;
   private long[] H003R2_A518Tran_RegionIdDestino ;
   private boolean[] H003R2_n518Tran_RegionIdDestino ;
   private String[] H003R2_A517Tran_CentroCostoDescripcionDes ;
   private boolean[] H003R2_n517Tran_CentroCostoDescripcionDes ;
   private String[] H003R2_A516Tran_CentroCostoCodigoDestino ;
   private boolean[] H003R2_n516Tran_CentroCostoCodigoDestino ;
   private long[] H003R2_A50Tran_CentroCostoIdDestino ;
   private boolean[] H003R2_n50Tran_CentroCostoIdDestino ;
   private java.util.Date[] H003R2_A515Tran_FechaIngreso ;
   private boolean[] H003R2_n515Tran_FechaIngreso ;
   private String[] H003R2_A514Tran_NumeroIngreso ;
   private boolean[] H003R2_n514Tran_NumeroIngreso ;
   private long[] H003R2_A54Tran_TipoIngreso ;
   private boolean[] H003R2_n54Tran_TipoIngreso ;
   private long[] H003R2_A513Tran_ConsecutivoCC ;
   private boolean[] H003R2_n513Tran_ConsecutivoCC ;
   private String[] H003R2_A482Tran_TipoElemento ;
   private long[] H003R2_A499Tran_CodTipoElemento ;
   private boolean[] H003R2_n499Tran_CodTipoElemento ;
   private long[] H003R2_A498Tran_NumeroLineas ;
   private boolean[] H003R2_n498Tran_NumeroLineas ;
   private java.math.BigDecimal[] H003R2_A483Tran_ValorTransaccion ;
   private boolean[] H003R2_n483Tran_ValorTransaccion ;
   private String[] H003R2_A481Tran_IndE_S ;
   private boolean[] H003R2_n481Tran_IndE_S ;
   private String[] H003R2_A479Tran_IndCurso ;
   private boolean[] H003R2_n479Tran_IndCurso ;
   private String[] H003R2_A478Tran_IndAreadante ;
   private boolean[] H003R2_n478Tran_IndAreadante ;
   private String[] H003R2_A408Tran_CursoCodigo ;
   private boolean[] H003R2_n408Tran_CursoCodigo ;
   private String[] H003R2_A407Tran_AreadanteCodigo ;
   private boolean[] H003R2_n407Tran_AreadanteCodigo ;
   private String[] H003R2_A391Tran_UsuarioRatifica ;
   private boolean[] H003R2_n391Tran_UsuarioRatifica ;
   private java.util.Date[] H003R2_A390Tran_FechaRatificacion ;
   private boolean[] H003R2_n390Tran_FechaRatificacion ;
   private String[] H003R2_A58Tran_Estado ;
   private boolean[] H003R2_n58Tran_Estado ;
   private long[] H003R2_A52Tran_IdCuentadanteDestino ;
   private boolean[] H003R2_n52Tran_IdCuentadanteDestino ;
   private String[] H003R2_A387Tran_CodBodeDestino ;
   private String[] H003R2_A111Tran_CodAlmaDestino ;
   private String[] H003R2_A385Tran_ModuloDestino ;
   private long[] H003R2_A51Tran_IdCuentadanteOrigen ;
   private boolean[] H003R2_n51Tran_IdCuentadanteOrigen ;
   private String[] H003R2_A112Tran_CodBodeOrigen ;
   private String[] H003R2_A109Tran_CodAlmaOrigen ;
   private String[] H003R2_A110Tran_ModuloOrigen ;
   private String[] H003R2_A381Tran_DescripcionMovimiento ;
   private boolean[] H003R2_n381Tran_DescripcionMovimiento ;
   private String[] H003R2_A49Tran_CodigoMovimiento ;
   private String[] H003R2_A422Tran_RegionDescripcion ;
   private boolean[] H003R2_n422Tran_RegionDescripcion ;
   private short[] H003R2_A421Tran_RegionCodigo ;
   private boolean[] H003R2_n421Tran_RegionCodigo ;
   private long[] H003R2_A57Tran_RegionId ;
   private boolean[] H003R2_n57Tran_RegionId ;
   private String[] H003R2_A420Tran_CentroCostoDescripcion ;
   private boolean[] H003R2_n420Tran_CentroCostoDescripcion ;
   private String[] H003R2_A419Tran_CentroCostoCodigo ;
   private boolean[] H003R2_n419Tran_CentroCostoCodigo ;
   private long[] H003R2_A48Tran_CentroCostoId ;
   private java.util.Date[] H003R2_A55Tran_FechaRegistro ;
   private long[] H003R2_A46Tran_Id ;
