...
public final  class gx01m2_impl extends GXDataArea
{
   ...
   public void wb930( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbldocu_nrofilter_Internalname, "Número de documento", "", "", lblLbldocu_nrofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11931_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx01M2.htm");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbldocu_descripcionfilter_Internalname, "Descripción", "", "", lblLbldocu_descripcionfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e12931_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx01M2.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
   ...
   public void start932( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selection List Documentos del tipo de orígen", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   {
      /* Start Routine */
      Form.setCaption( GXutil.format( "Lista de Selección %1", "Documentos del tipo de orígen", "", "", "", "", "", "", "", "") );
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Selection List Documentos del tipo de orígen" );
      subGrid1_Rows = 10 ;
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
