/*
               File: wwgen_ciudad_impl
        Description: Work With Ciudad
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:18:58.81
...
public final  class wwgen_ciudad_impl extends GXDataArea
{
   public wwgen_ciudad_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wwgen_ciudad_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wwgen_ciudad_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
         {
            ...
            AV5Ciud_Descripcion = httpContext.GetNextPar( ) ;
            AV18Update = httpContext.GetNextPar( ) ;
            edtavUpdate_Tooltiptext = httpContext.GetNextPar( ) ;
            httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Tooltiptext", edtavUpdate_Tooltiptext, !bGXsfl_27_Refreshing);
            AV7Delete = httpContext.GetNextPar( ) ;
            ...
            gxgrgrid_refresh( subGrid_Rows, AV5Ciud_Descripcion, AV18Update, AV7Delete, AV22Pgmname, A5Ciud_Codigo, A6Dept_Codigo, A9Pais_Codigo) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414185886");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( nGXWrapped != 1 )
      {
         httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.wwgen_ciudad") +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "GXH_vCIUD_DESCRIPCION", AV5Ciud_Descripcion);
      /* Send saved values. */
   ...
   {
      return formatLink("com.orions2.wwgen_ciudad")  ;
   }
   ...
   public void wb2F0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblTitletext_Internalname, "Ciudad", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_WWGEN_CIUDAD.htm");
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 27, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWGEN_CIUDAD.htm");
         httpContext.writeText( "</li>") ;
         httpContext.writeText( "<li>") ;
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 15,'',false,'',0)\"" ;
         ClassString = "ActionButtons" ;
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtnexport_Internalname, "gx.evt.setGridEvt("+GXutil.str( 27, 2, 0)+","+"null"+");", "Export", bttBtnexport_Jsonclick, 5, "Export to Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOEXPORT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWGEN_CIUDAD.htm");
         httpContext.writeText( "</li>") ;
         ...
         com.orions2.GxWebStd.gx_label_element( httpContext, edtavCiud_descripcion_Internalname, "Ciud_Descripcion", "col-sm-3 FilterSearchAttributeLabel", 0, true);
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"" ;
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavCiud_descripcion_Internalname, AV5Ciud_Descripcion, GXutil.rtrim( localUtil.format( AV5Ciud_Descripcion, "@!")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Descripción Ciudad", edtavCiud_descripcion_Jsonclick, 0, "FilterSearchAttribute", "", "", "", 1, edtavCiud_descripcion_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_WWGEN_CIUDAD.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            httpContext.writeValue( "Fecha Creación Ciudad") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
            httpContext.writeValue( "Usuario Modifica Ciudad") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
            httpContext.writeValue( "Fecha Modifica Ciudad") ;
            httpContext.writeTextNL( "</th>") ;
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", A127Ciud_UsuarioCrea);
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", localUtil.ttoc( A128Ciud_FechaCrea, 10, 8, 0, 3, "/", ":", " "));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", A129Ciud_UsuarioModifica);
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", localUtil.ttoc( A130Ciud_FechaModifica, 10, 8, 0, 3, "/", ":", " "));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
   ...
   public void start2F2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Work With Ciudad", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           httpContext.ajax_rsp_assign_prop("", false, edtavDelete_Internalname, "Bitmap", ((GXutil.strcmp("", AV7Delete)==0) ? AV24Delete_GXI : httpContext.convertURL( httpContext.getResourceRelative(AV7Delete))), !bGXsfl_27_Refreshing);
                           ...
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 {
                                    Rfr0gs = false ;
                                    /* Set Refresh If Ciud_descripcion Changed */
                                    if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vCIUD_DESCRIPCION"), AV5Ciud_Descripcion) != 0 )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    if ( ! Rfr0gs )
   ...
   public void pa2F2( )
   {
      if ( nDonePA == 0 )
      {
         ...
         if ( ! httpContext.isAjaxRequest( ) )
         {
            GX_FocusControl = edtavCiud_descripcion_Internalname ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CIUD_FECHACREA", getSecureSignedToken( "", localUtil.format( A128Ciud_FechaCrea, "99/99/99 99:99")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "CIUD_FECHACREA", localUtil.ttoc( A128Ciud_FechaCrea, 10, 8, 0, 3, "/", ":", " "));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CIUD_USUARIOMODIFICA", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A129Ciud_UsuarioModifica, "@!"))));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "CIUD_USUARIOMODIFICA", A129Ciud_UsuarioModifica);
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CIUD_FECHAMODIFICA", getSecureSignedToken( "", localUtil.format( A130Ciud_FechaModifica, "99/99/99 99:99")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "CIUD_FECHAMODIFICA", localUtil.ttoc( A130Ciud_FechaModifica, 10, 8, 0, 3, "/", ":", " "));
   }
   ...
   public void rf2F2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV5Ciud_Descripcion = GXutil.concat( GXutil.rtrim( AV5Ciud_Descripcion), "%", "") ;
         httpContext.ajax_rsp_assign_attri("", false, "AV5Ciud_Descripcion", AV5Ciud_Descripcion);
         /* Using cursor H002F2 */
         pr_default.execute(0, new Object[] {lV5Ciud_Descripcion, new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_27_idx = (short)(1) ;
         sGXsfl_27_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_27_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_272( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A130Ciud_FechaModifica = H002F2_A130Ciud_FechaModifica[0] ;
            A129Ciud_UsuarioModifica = H002F2_A129Ciud_UsuarioModifica[0] ;
            A128Ciud_FechaCrea = H002F2_A128Ciud_FechaCrea[0] ;
            A127Ciud_UsuarioCrea = H002F2_A127Ciud_UsuarioCrea[0] ;
            A11Pais_Descripcion = H002F2_A11Pais_Descripcion[0] ;
            A9Pais_Codigo = H002F2_A9Pais_Codigo[0] ;
            A10Dept_Descripcion = H002F2_A10Dept_Descripcion[0] ;
            A6Dept_Codigo = H002F2_A6Dept_Codigo[0] ;
            A7Ciud_Descripcion = H002F2_A7Ciud_Descripcion[0] ;
            A5Ciud_Codigo = H002F2_A5Ciud_Codigo[0] ;
            A9Pais_Codigo = H002F2_A9Pais_Codigo[0] ;
            A10Dept_Descripcion = H002F2_A10Dept_Descripcion[0] ;
            A11Pais_Descripcion = H002F2_A11Pais_Descripcion[0] ;
            e152F2 ();
   ...
   public int subgrid_recordcount( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV5Ciud_Descripcion", AV5Ciud_Descripcion);
      /* Using cursor H002F3 */
      pr_default.execute(1, new Object[] {lV5Ciud_Descripcion});
   ...
   public void strup2F0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV5Ciud_Descripcion = GXutil.upper( httpContext.cgiGet( edtavCiud_descripcion_Internalname)) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV5Ciud_Descripcion", AV5Ciud_Descripcion);
         /* Read saved values. */
   ...
   {
      /* Grid_Load Routine */
      edtavUpdate_Link = formatLink("com.orions2.gen_ciudad") + "?" + GXutil.URLEncode(GXutil.rtrim("UPD")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A5Ciud_Codigo,4,0))) ;
      edtavDelete_Link = formatLink("com.orions2.gen_ciudad") + "?" + GXutil.URLEncode(GXutil.rtrim("DLT")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A5Ciud_Codigo,4,0))) ;
   ...
   {
      /* 'DoInsert' Routine */
      callWebObject(formatLink("com.orions2.gen_ciudad") + "?" + GXutil.URLEncode(GXutil.rtrim("INS")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(0,9,0))));
      httpContext.wjLocDisableFrm = (byte)(1) ;
   }
   ...
   public void S122( )
   {
      ...
      if ( GXutil.strcmp(AV13HTTPRequest.getMethod(), "GET") == 0 )
      {
         ...
         {
            AV5Ciud_Descripcion = ((com.orions2.SdtGridState_FilterValue)AV11GridState.getgxTv_SdtGridState_Filtervalues().elementAt(-1+1)).getgxTv_SdtGridState_FilterValue_Value() ;
            httpContext.ajax_rsp_assign_attri("", false, "AV5Ciud_Descripcion", AV5Ciud_Descripcion);
         }
   ...
   public void S132( )
   {
      ...
      AV12GridStateFilterValue.setgxTv_SdtGridState_FilterValue_Value( AV5Ciud_Descripcion );
   ...
   public void S112( )
   {
      ...
      AV16TrnContext.setgxTv_SdtTransactionContext_Transactionname( "GEN_CIUDAD" );
   ...
   public void e122F2( )
   {
      ...
      new com.orions2.exportwwgen_ciudad(remoteHandle, context).execute( AV5Ciud_Descripcion, GXv_char1, GXv_char2) ;
      wwgen_ciudad_impl.this.AV9ExcelFilename = GXv_char1[0] ;
      wwgen_ciudad_impl.this.AV8ErrorMessage = GXv_char2[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "AV5Ciud_Descripcion", AV5Ciud_Descripcion);
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414185952");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         ...
         httpContext.AddJavascriptSource("wwgen_ciudad.js", "?201861414185952");
      }
   ...
   public void subsflControlProps_272( )
   {
      ...
      edtCiud_UsuarioCrea_Internalname = "CIUD_USUARIOCREA_"+sGXsfl_27_idx ;
      edtCiud_FechaCrea_Internalname = "CIUD_FECHACREA_"+sGXsfl_27_idx ;
      edtCiud_UsuarioModifica_Internalname = "CIUD_USUARIOMODIFICA_"+sGXsfl_27_idx ;
      edtCiud_FechaModifica_Internalname = "CIUD_FECHAMODIFICA_"+sGXsfl_27_idx ;
   ...
   public void subsflControlProps_fel_272( )
   {
      ...
      edtCiud_UsuarioCrea_Internalname = "CIUD_USUARIOCREA_"+sGXsfl_27_fel_idx ;
      edtCiud_FechaCrea_Internalname = "CIUD_FECHACREA_"+sGXsfl_27_fel_idx ;
      edtCiud_UsuarioModifica_Internalname = "CIUD_USUARIOMODIFICA_"+sGXsfl_27_fel_idx ;
      edtCiud_FechaModifica_Internalname = "CIUD_FECHAMODIFICA_"+sGXsfl_27_fel_idx ;
   ...
   public void sendrow_272( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCiud_Descripcion_Internalname,A7Ciud_Descripcion,GXutil.rtrim( localUtil.format( A7Ciud_Descripcion, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'",edtCiud_Descripcion_Link,"","","",edtCiud_Descripcion_Jsonclick,new Integer(0),"DescriptionAttribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(27),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCiud_UsuarioCrea_Internalname,A127Ciud_UsuarioCrea,GXutil.rtrim( localUtil.format( A127Ciud_UsuarioCrea, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCiud_UsuarioCrea_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(27),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCiud_FechaCrea_Internalname,localUtil.ttoc( A128Ciud_FechaCrea, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A128Ciud_FechaCrea, "99/99/99 99:99"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCiud_FechaCrea_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(27),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCiud_UsuarioModifica_Internalname,A129Ciud_UsuarioModifica,GXutil.rtrim( localUtil.format( A129Ciud_UsuarioModifica, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCiud_UsuarioModifica_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(27),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCiud_FechaModifica_Internalname,localUtil.ttoc( A130Ciud_FechaModifica, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A130Ciud_FechaModifica, "99/99/99 99:99"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCiud_FechaModifica_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(27),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CIUD_USUARIOCREA"+"_"+sGXsfl_27_idx, getSecureSignedToken( sGXsfl_27_idx, GXutil.rtrim( localUtil.format( A127Ciud_UsuarioCrea, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CIUD_FECHACREA"+"_"+sGXsfl_27_idx, getSecureSignedToken( sGXsfl_27_idx, localUtil.format( A128Ciud_FechaCrea, "99/99/99 99:99")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CIUD_USUARIOMODIFICA"+"_"+sGXsfl_27_idx, getSecureSignedToken( sGXsfl_27_idx, GXutil.rtrim( localUtil.format( A129Ciud_UsuarioModifica, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CIUD_FECHAMODIFICA"+"_"+sGXsfl_27_idx, getSecureSignedToken( sGXsfl_27_idx, localUtil.format( A130Ciud_FechaModifica, "99/99/99 99:99")));
   ...
   public void init_default_properties( )
   {
      ...
      edtavCiud_descripcion_Internalname = "vCIUD_DESCRIPCION" ;
      ...
      edtCiud_FechaCrea_Internalname = "CIUD_FECHACREA" ;
      edtCiud_UsuarioModifica_Internalname = "CIUD_USUARIOMODIFICA" ;
      edtCiud_FechaModifica_Internalname = "CIUD_FECHAMODIFICA" ;
   ...
   public void initialize_properties( )
   {
      ...
      edtavCiud_descripcion_Jsonclick = "" ;
      edtavCiud_descripcion_Enabled = 1 ;
      Form.setHeaderrawhtml( "" );
      Form.setBackground( "" );
      Form.setTextcolor( 0 );
      Form.setIBackground( (int)(0xFFFFFF) );
      Form.setCaption( "Work With Ciudad" );
      subGrid_Rows = 0 ;
      edtavDelete_Tooltiptext = "Eliminar" ;
      edtavUpdate_Tooltiptext = "Modificar" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV18Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV7Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A5Ciud_Codigo',fld:'CIUD_CODIGO',pic:'ZZZ9',hsh:true,nv:0},{av:'A6Dept_Codigo',fld:'DEPT_CODIGO',pic:'ZZZ9',hsh:true,nv:0},{av:'A9Pais_Codigo',fld:'PAIS_CODIGO',pic:'',nv:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',nv:''},{av:'AV5Ciud_Descripcion',fld:'vCIUD_DESCRIPCION',pic:'@!',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e152F2',iparms:[{av:'A5Ciud_Codigo',fld:'CIUD_CODIGO',pic:'ZZZ9',hsh:true,nv:0},{av:'A6Dept_Codigo',fld:'DEPT_CODIGO',pic:'ZZZ9',hsh:true,nv:0},{av:'A9Pais_Codigo',fld:'PAIS_CODIGO',pic:'',nv:''}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtCiud_Descripcion_Link',ctrl:'CIUD_DESCRIPCION',prop:'Link'},{av:'edtDept_Descripcion_Link',ctrl:'DEPT_DESCRIPCION',prop:'Link'},{av:'edtPais_Descripcion_Link',ctrl:'PAIS_DESCRIPCION',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e112F2',iparms:[{av:'A5Ciud_Codigo',fld:'CIUD_CODIGO',pic:'ZZZ9',hsh:true,nv:0}],oparms:[]}");
      setEventMetadata("'DOEXPORT'","{handler:'e122F2',iparms:[{av:'AV5Ciud_Descripcion',fld:'vCIUD_DESCRIPCION',pic:'@!',nv:''}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV5Ciud_Descripcion = "" ;
      H002F2_A130Ciud_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H002F2_A129Ciud_UsuarioModifica = new String[] {""} ;
      H002F2_A128Ciud_FechaCrea = new java.util.Date[] {GXutil.nullDate()} ;
      H002F2_A127Ciud_UsuarioCrea = new String[] {""} ;
      H002F2_A11Pais_Descripcion = new String[] {""} ;
      H002F2_A9Pais_Codigo = new String[] {""} ;
      H002F2_A10Dept_Descripcion = new String[] {""} ;
      H002F2_A6Dept_Codigo = new short[1] ;
      H002F2_A7Ciud_Descripcion = new String[] {""} ;
      H002F2_A5Ciud_Codigo = new short[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.wwgen_ciudad__default(),
         new Object[] {
             new Object[] {
            H002F2_A130Ciud_FechaModifica, H002F2_A129Ciud_UsuarioModifica, H002F2_A128Ciud_FechaCrea, H002F2_A127Ciud_UsuarioCrea, H002F2_A11Pais_Descripcion, H002F2_A9Pais_Codigo, H002F2_A10Dept_Descripcion, H002F2_A6Dept_Codigo, H002F2_A7Ciud_Descripcion, H002F2_A5Ciud_Codigo
            }
            , new Object[] {
   ...
   private int edtavCiud_descripcion_Enabled ;
   ...
   private String edtavCiud_descripcion_Internalname ;
   private String edtavCiud_descripcion_Jsonclick ;
   ...
   private String AV5Ciud_Descripcion ;
   ...
   private String lV5Ciud_Descripcion ;
   ...
   private java.util.Date[] H002F2_A130Ciud_FechaModifica ;
   private String[] H002F2_A129Ciud_UsuarioModifica ;
   private java.util.Date[] H002F2_A128Ciud_FechaCrea ;
   private String[] H002F2_A127Ciud_UsuarioCrea ;
   private String[] H002F2_A11Pais_Descripcion ;
   private String[] H002F2_A9Pais_Codigo ;
   private String[] H002F2_A10Dept_Descripcion ;
   private short[] H002F2_A6Dept_Codigo ;
   private String[] H002F2_A7Ciud_Descripcion ;
   private short[] H002F2_A5Ciud_Codigo ;
...
final  class wwgen_ciudad__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          String A7Ciud_Descripcion )
   {
      ...
      String sFromString ;
      String sOrderString ;
      sSelectString = " T1.Ciud_FechaModifica, T1.Ciud_UsuarioModifica, T1.Ciud_FechaCrea, T1.Ciud_UsuarioCrea," ;
      sSelectString = sSelectString + " T3.Pais_Descripcion, T2.Pais_Codigo, T2.Dept_Descripcion, T1.Dept_Codigo, T1.Ciud_Descripcion," ;
      sSelectString = sSelectString + " T1.Ciud_Codigo" ;
      sFromString = " FROM ((GEN_CIUDAD T1 INNER JOIN GEN_DEPARTAMENTO T2 ON T2.Dept_Codigo = T1.Dept_Codigo)" ;
      sFromString = sFromString + " INNER JOIN GEN_PAIS T3 ON T3.Pais_Codigo = T2.Pais_Codigo)" ;
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV5Ciud_Descripcion)==0) )
      {
      ...
      sOrderString = sOrderString + " ORDER BY T1.Ciud_Descripcion" ;
                                          ...
                                          String A7Ciud_Descripcion )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM ((GEN_CIUDAD T1 INNER JOIN GEN_DEPARTAMENTO T2 ON T2.Dept_Codigo" ;
      scmdbuf = scmdbuf + " = T1.Dept_Codigo) INNER JOIN GEN_PAIS T3 ON T3.Pais_Codigo = T2.Pais_Codigo)" ;
      if ( ! (GXutil.strcmp("", AV5Ciud_Descripcion)==0) )
      {
         if ( GXutil.strcmp("", sWhereString) != 0 )
         {
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H002F2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
            case 1 :
                  return conditional_H002F3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H002F2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H002F3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
