/*
               File: gen_centrocostoalm_transaccion1wc_impl
        Description: GEN_CENTROCOSTOALM_TRANSACCION1 WC
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:13:47.60
...
public final  class gen_centrocostoalm_transaccion1wc_impl extends GXWebComponent
{
   public gen_centrocostoalm_transaccion1wc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public gen_centrocostoalm_transaccion1wc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( gen_centrocostoalm_transaccion1wc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV7Tran_CentroCostoIdDestino = GXutil.lval( httpContext.GetNextPar( )) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Tran_CentroCostoIdDestino", GXutil.ltrim( GXutil.str( AV7Tran_CentroCostoIdDestino, 11, 0)));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,new Long(AV7Tran_CentroCostoIdDestino)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Tran_CentroCostoIdDestino, AV12Update, AV13Delete, A46Tran_Id, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "GEN_CENTROCOSTOALM_TRANSACCION1 WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414134776");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.gen_centrocostoalm_transaccion1wc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Tran_CentroCostoIdDestino,11,0)))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV7Tran_CentroCostoIdDestino", GXutil.ltrim( localUtil.ntoc( wcpOAV7Tran_CentroCostoIdDestino, (byte)(11), (byte)(0), ",", "")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vTRAN_CENTROCOSTOIDDESTINO", GXutil.ltrim( localUtil.ntoc( AV7Tran_CentroCostoIdDestino, (byte)(11), (byte)(0), ",", "")));
   ...
   public void renderHtmlCloseForm0G2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("gen_centrocostoalm_transaccion1wc.js", "?201861414134780");
      }
   ...
   {
      return "GEN_CENTROCOSTOALM_TRANSACCION1WC" ;
   }

   public String getPgmdesc( )
   {
      return "GEN_CENTROCOSTOALM_TRANSACCION1 WC" ;
   }
   ...
   public void wb0G0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.gen_centrocostoalm_transaccion1wc");
         }
         /* Div Control */
      ...
      if ( wbEnd == 20 )
      {
         ...
         com.orions2.GxWebStd.gx_label_element( httpContext, edtTran_CentroCostoIdDestino_Internalname, "Id Centro Costo Destino", "col-sm-3 AttributeLabel", 0, true);
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtTran_CentroCostoIdDestino_Internalname, GXutil.ltrim( localUtil.ntoc( A50Tran_CentroCostoIdDestino, (byte)(11), (byte)(0), ",", "")), ((edtTran_CentroCostoIdDestino_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A50Tran_CentroCostoIdDestino), "ZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A50Tran_CentroCostoIdDestino), "ZZZZZZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTran_CentroCostoIdDestino_Jsonclick, 0, "Attribute", "", "", "", edtTran_CentroCostoIdDestino_Visible, edtTran_CentroCostoIdDestino_Enabled, 0, "text", "", 11, "chr", 1, "row", 11, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Identificador", "right", false, "HLP_GEN_CENTROCOSTOALM_TRANSACCION1WC.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start0G2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "GEN_CENTROCOSTOALM_TRANSACCION1 WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 long AV7Tran_CentroCostoIdDestino ,
                                 String AV12Update ,
                                 String AV13Delete ,
                                 long A46Tran_Id ,
                                 String sPrefix )
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "GEN_CENTROCOSTOALM_TRANSACCION1WC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf0G2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H000G2 */
         pr_default.execute(0, new Object[] {new Long(AV7Tran_CentroCostoIdDestino), new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_20_idx = (short)(1) ;
         sGXsfl_20_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_20_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_202( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A416Tran_Observaciones = H000G2_A416Tran_Observaciones[0] ;
            n416Tran_Observaciones = H000G2_n416Tran_Observaciones[0] ;
            A518Tran_RegionIdDestino = H000G2_A518Tran_RegionIdDestino[0] ;
            n518Tran_RegionIdDestino = H000G2_n518Tran_RegionIdDestino[0] ;
            A50Tran_CentroCostoIdDestino = H000G2_A50Tran_CentroCostoIdDestino[0] ;
            ...
            n50Tran_CentroCostoIdDestino = H000G2_n50Tran_CentroCostoIdDestino[0] ;
            A859Tran_EntidadGobierno = H000G2_A859Tran_EntidadGobierno[0] ;
            n859Tran_EntidadGobierno = H000G2_n859Tran_EntidadGobierno[0] ;
            A759Tran_CedulaResponsabilidad = H000G2_A759Tran_CedulaResponsabilidad[0] ;
            n759Tran_CedulaResponsabilidad = H000G2_n759Tran_CedulaResponsabilidad[0] ;
            A758Tran_TablaResponsabilidad = H000G2_A758Tran_TablaResponsabilidad[0] ;
            n758Tran_TablaResponsabilidad = H000G2_n758Tran_TablaResponsabilidad[0] ;
            A756Tran_Abreviado = H000G2_A756Tran_Abreviado[0] ;
            n756Tran_Abreviado = H000G2_n756Tran_Abreviado[0] ;
            A754Tran_CuentaResponsabilidad = H000G2_A754Tran_CuentaResponsabilidad[0] ;
            n754Tran_CuentaResponsabilidad = H000G2_n754Tran_CuentaResponsabilidad[0] ;
            A721Tran_NombreCuentadanteResponsa = H000G2_A721Tran_NombreCuentadanteResponsa[0] ;
            n721Tran_NombreCuentadanteResponsa = H000G2_n721Tran_NombreCuentadanteResponsa[0] ;
            A720Tran_FechaResponsabilidad = H000G2_A720Tran_FechaResponsabilidad[0] ;
            n720Tran_FechaResponsabilidad = H000G2_n720Tran_FechaResponsabilidad[0] ;
            A719Tran_TransaccResponsabilidad = H000G2_A719Tran_TransaccResponsabilidad[0] ;
            n719Tran_TransaccResponsabilidad = H000G2_n719Tran_TransaccResponsabilidad[0] ;
            A56Tran_IdCuentadanteResponsabili = H000G2_A56Tran_IdCuentadanteResponsabili[0] ;
            n56Tran_IdCuentadanteResponsabili = H000G2_n56Tran_IdCuentadanteResponsabili[0] ;
            A715Tran_EmailCuentadanteDestino = H000G2_A715Tran_EmailCuentadanteDestino[0] ;
            n715Tran_EmailCuentadanteDestino = H000G2_n715Tran_EmailCuentadanteDestino[0] ;
            A714Tran_EmailCuentadanteOrigen = H000G2_A714Tran_EmailCuentadanteOrigen[0] ;
            n714Tran_EmailCuentadanteOrigen = H000G2_n714Tran_EmailCuentadanteOrigen[0] ;
            A708Tran_SolicitaRegionDestino = H000G2_A708Tran_SolicitaRegionDestino[0] ;
            n708Tran_SolicitaRegionDestino = H000G2_n708Tran_SolicitaRegionDestino[0] ;
            A707Tran_SolicitaCCDestino = H000G2_A707Tran_SolicitaCCDestino[0] ;
            n707Tran_SolicitaCCDestino = H000G2_n707Tran_SolicitaCCDestino[0] ;
            A704Tran_CedulaCuentadanteDestino = H000G2_A704Tran_CedulaCuentadanteDestino[0] ;
            n704Tran_CedulaCuentadanteDestino = H000G2_n704Tran_CedulaCuentadanteDestino[0] ;
            A703Tran_CedulaProveedor = H000G2_A703Tran_CedulaProveedor[0] ;
            n703Tran_CedulaProveedor = H000G2_n703Tran_CedulaProveedor[0] ;
            A702Tran_CedulaCuentadanteOrigen = H000G2_A702Tran_CedulaCuentadanteOrigen[0] ;
            n702Tran_CedulaCuentadanteOrigen = H000G2_n702Tran_CedulaCuentadanteOrigen[0] ;
            A670Tran_ObservacionesAnula = H000G2_A670Tran_ObservacionesAnula[0] ;
            n670Tran_ObservacionesAnula = H000G2_n670Tran_ObservacionesAnula[0] ;
            A669Tran_FechaEliminaoAnula = H000G2_A669Tran_FechaEliminaoAnula[0] ;
            n669Tran_FechaEliminaoAnula = H000G2_n669Tran_FechaEliminaoAnula[0] ;
            A668Tran_UsuarioEliminaoAnula = H000G2_A668Tran_UsuarioEliminaoAnula[0] ;
            n668Tran_UsuarioEliminaoAnula = H000G2_n668Tran_UsuarioEliminaoAnula[0] ;
            A667Tran_NumeroGrupo = H000G2_A667Tran_NumeroGrupo[0] ;
            n667Tran_NumeroGrupo = H000G2_n667Tran_NumeroGrupo[0] ;
            A568Tran_CantidadPadres = H000G2_A568Tran_CantidadPadres[0] ;
            n568Tran_CantidadPadres = H000G2_n568Tran_CantidadPadres[0] ;
            A527Tran_TipoEntra = H000G2_A527Tran_TipoEntra[0] ;
            n527Tran_TipoEntra = H000G2_n527Tran_TipoEntra[0] ;
            A524Tran_Detalle = H000G2_A524Tran_Detalle[0] ;
            n524Tran_Detalle = H000G2_n524Tran_Detalle[0] ;
            A608Tran_RegionAbrevDestino = H000G2_A608Tran_RegionAbrevDestino[0] ;
            n608Tran_RegionAbrevDestino = H000G2_n608Tran_RegionAbrevDestino[0] ;
            A515Tran_FechaIngreso = H000G2_A515Tran_FechaIngreso[0] ;
            n515Tran_FechaIngreso = H000G2_n515Tran_FechaIngreso[0] ;
            A514Tran_NumeroIngreso = H000G2_A514Tran_NumeroIngreso[0] ;
            n514Tran_NumeroIngreso = H000G2_n514Tran_NumeroIngreso[0] ;
            A672Tran_NombreIngreso = H000G2_A672Tran_NombreIngreso[0] ;
            n672Tran_NombreIngreso = H000G2_n672Tran_NombreIngreso[0] ;
            A54Tran_TipoIngreso = H000G2_A54Tran_TipoIngreso[0] ;
            n54Tran_TipoIngreso = H000G2_n54Tran_TipoIngreso[0] ;
            A513Tran_ConsecutivoCC = H000G2_A513Tran_ConsecutivoCC[0] ;
            n513Tran_ConsecutivoCC = H000G2_n513Tran_ConsecutivoCC[0] ;
            A391Tran_UsuarioRatifica = H000G2_A391Tran_UsuarioRatifica[0] ;
            n391Tran_UsuarioRatifica = H000G2_n391Tran_UsuarioRatifica[0] ;
            A390Tran_FechaRatificacion = H000G2_A390Tran_FechaRatificacion[0] ;
            n390Tran_FechaRatificacion = H000G2_n390Tran_FechaRatificacion[0] ;
            A58Tran_Estado = H000G2_A58Tran_Estado[0] ;
            n58Tran_Estado = H000G2_n58Tran_Estado[0] ;
            A498Tran_NumeroLineas = H000G2_A498Tran_NumeroLineas[0] ;
            n498Tran_NumeroLineas = H000G2_n498Tran_NumeroLineas[0] ;
            A483Tran_ValorTransaccion = H000G2_A483Tran_ValorTransaccion[0] ;
            n483Tran_ValorTransaccion = H000G2_n483Tran_ValorTransaccion[0] ;
            A408Tran_CursoCodigo = H000G2_A408Tran_CursoCodigo[0] ;
            n408Tran_CursoCodigo = H000G2_n408Tran_CursoCodigo[0] ;
            A407Tran_AreadanteCodigo = H000G2_A407Tran_AreadanteCodigo[0] ;
            n407Tran_AreadanteCodigo = H000G2_n407Tran_AreadanteCodigo[0] ;
            A389Tran_NombCuentadanteDestino = H000G2_A389Tran_NombCuentadanteDestino[0] ;
            n389Tran_NombCuentadanteDestino = H000G2_n389Tran_NombCuentadanteDestino[0] ;
            A52Tran_IdCuentadanteDestino = H000G2_A52Tran_IdCuentadanteDestino[0] ;
            n52Tran_IdCuentadanteDestino = H000G2_n52Tran_IdCuentadanteDestino[0] ;
            A387Tran_CodBodeDestino = H000G2_A387Tran_CodBodeDestino[0] ;
            A111Tran_CodAlmaDestino = H000G2_A111Tran_CodAlmaDestino[0] ;
            A385Tran_ModuloDestino = H000G2_A385Tran_ModuloDestino[0] ;
            A575Tran_NombreProveedor = H000G2_A575Tran_NombreProveedor[0] ;
            n575Tran_NombreProveedor = H000G2_n575Tran_NombreProveedor[0] ;
            A53Tran_IdProveedor = H000G2_A53Tran_IdProveedor[0] ;
            n53Tran_IdProveedor = H000G2_n53Tran_IdProveedor[0] ;
            A384Tran_NombCuentadanteOrigen = H000G2_A384Tran_NombCuentadanteOrigen[0] ;
            n384Tran_NombCuentadanteOrigen = H000G2_n384Tran_NombCuentadanteOrigen[0] ;
            A51Tran_IdCuentadanteOrigen = H000G2_A51Tran_IdCuentadanteOrigen[0] ;
            n51Tran_IdCuentadanteOrigen = H000G2_n51Tran_IdCuentadanteOrigen[0] ;
            A112Tran_CodBodeOrigen = H000G2_A112Tran_CodBodeOrigen[0] ;
            A109Tran_CodAlmaOrigen = H000G2_A109Tran_CodAlmaOrigen[0] ;
            A110Tran_ModuloOrigen = H000G2_A110Tran_ModuloOrigen[0] ;
            A482Tran_TipoElemento = H000G2_A482Tran_TipoElemento[0] ;
            A499Tran_CodTipoElemento = H000G2_A499Tran_CodTipoElemento[0] ;
            n499Tran_CodTipoElemento = H000G2_n499Tran_CodTipoElemento[0] ;
            A479Tran_IndCurso = H000G2_A479Tran_IndCurso[0] ;
            n479Tran_IndCurso = H000G2_n479Tran_IndCurso[0] ;
            A481Tran_IndE_S = H000G2_A481Tran_IndE_S[0] ;
            n481Tran_IndE_S = H000G2_n481Tran_IndE_S[0] ;
            A478Tran_IndAreadante = H000G2_A478Tran_IndAreadante[0] ;
            n478Tran_IndAreadante = H000G2_n478Tran_IndAreadante[0] ;
            A381Tran_DescripcionMovimiento = H000G2_A381Tran_DescripcionMovimiento[0] ;
            n381Tran_DescripcionMovimiento = H000G2_n381Tran_DescripcionMovimiento[0] ;
            A49Tran_CodigoMovimiento = H000G2_A49Tran_CodigoMovimiento[0] ;
            A594Tran_RegionAbrev = H000G2_A594Tran_RegionAbrev[0] ;
            n594Tran_RegionAbrev = H000G2_n594Tran_RegionAbrev[0] ;
            A422Tran_RegionDescripcion = H000G2_A422Tran_RegionDescripcion[0] ;
            n422Tran_RegionDescripcion = H000G2_n422Tran_RegionDescripcion[0] ;
            A421Tran_RegionCodigo = H000G2_A421Tran_RegionCodigo[0] ;
            n421Tran_RegionCodigo = H000G2_n421Tran_RegionCodigo[0] ;
            A57Tran_RegionId = H000G2_A57Tran_RegionId[0] ;
            n57Tran_RegionId = H000G2_n57Tran_RegionId[0] ;
            A420Tran_CentroCostoDescripcion = H000G2_A420Tran_CentroCostoDescripcion[0] ;
            n420Tran_CentroCostoDescripcion = H000G2_n420Tran_CentroCostoDescripcion[0] ;
            A419Tran_CentroCostoCodigo = H000G2_A419Tran_CentroCostoCodigo[0] ;
            n419Tran_CentroCostoCodigo = H000G2_n419Tran_CentroCostoCodigo[0] ;
            A48Tran_CentroCostoId = H000G2_A48Tran_CentroCostoId[0] ;
            A418Tran_UsuarioNombre = H000G2_A418Tran_UsuarioNombre[0] ;
            n418Tran_UsuarioNombre = H000G2_n418Tran_UsuarioNombre[0] ;
            A417Tran_UsuarioCodigo = H000G2_A417Tran_UsuarioCodigo[0] ;
            n417Tran_UsuarioCodigo = H000G2_n417Tran_UsuarioCodigo[0] ;
            A47Tran_UsuarioId = H000G2_A47Tran_UsuarioId[0] ;
            n47Tran_UsuarioId = H000G2_n47Tran_UsuarioId[0] ;
            A55Tran_FechaRegistro = H000G2_A55Tran_FechaRegistro[0] ;
            A46Tran_Id = H000G2_A46Tran_Id[0] ;
            A608Tran_RegionAbrevDestino = H000G2_A608Tran_RegionAbrevDestino[0] ;
            n608Tran_RegionAbrevDestino = H000G2_n608Tran_RegionAbrevDestino[0] ;
            A759Tran_CedulaResponsabilidad = H000G2_A759Tran_CedulaResponsabilidad[0] ;
            n759Tran_CedulaResponsabilidad = H000G2_n759Tran_CedulaResponsabilidad[0] ;
   ...
   {
      /* Using cursor H000G3 */
      pr_default.execute(1, new Object[] {new Long(AV7Tran_CentroCostoIdDestino)});
   ...
   public void strup0G0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV7Tran_CentroCostoIdDestino = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV7Tran_CentroCostoIdDestino"), ",", ".") ;
   ...
   public void e120G2( )
   {
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext, !bGXsfl_20_Refreshing);
      edtTran_CentroCostoIdDestino_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtTran_CentroCostoIdDestino_Internalname, "Visible", GXutil.ltrim( GXutil.str( edtTran_CentroCostoIdDestino_Visible, 5, 0)), true);
   ...
   public void S112( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributename( "Tran_CentroCostoIdDestino" );
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( GXutil.str( AV7Tran_CentroCostoIdDestino, 11, 0) );
   ...
   {
      AV7Tran_CentroCostoIdDestino = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Tran_CentroCostoIdDestino", GXutil.ltrim( GXutil.str( AV7Tran_CentroCostoIdDestino, 11, 0)));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV7Tran_CentroCostoIdDestino = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "gen_centrocostoalm_transaccion1wc");
      ...
      {
         AV7Tran_CentroCostoIdDestino = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Tran_CentroCostoIdDestino", GXutil.ltrim( GXutil.str( AV7Tran_CentroCostoIdDestino, 11, 0)));
      }
      wcpOAV7Tran_CentroCostoIdDestino = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV7Tran_CentroCostoIdDestino"), ",", ".") ;
      if ( ! GetJustCreated( ) && ( ( AV7Tran_CentroCostoIdDestino != wcpOAV7Tran_CentroCostoIdDestino ) ) )
      {
         setjustcreated();
      }
      wcpOAV7Tran_CentroCostoIdDestino = AV7Tran_CentroCostoIdDestino ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV7Tran_CentroCostoIdDestino = httpContext.cgiGet( sPrefix+"AV7Tran_CentroCostoIdDestino_CTRL") ;
      if ( GXutil.len( sCtrlAV7Tran_CentroCostoIdDestino) > 0 )
      {
         AV7Tran_CentroCostoIdDestino = localUtil.ctol( httpContext.cgiGet( sCtrlAV7Tran_CentroCostoIdDestino), ",", ".") ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Tran_CentroCostoIdDestino", GXutil.ltrim( GXutil.str( AV7Tran_CentroCostoIdDestino, 11, 0)));
      }
      else
      {
         AV7Tran_CentroCostoIdDestino = localUtil.ctol( httpContext.cgiGet( sPrefix+"AV7Tran_CentroCostoIdDestino_PARM"), ",", ".") ;
      }
   }
   ...
   {
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Tran_CentroCostoIdDestino_PARM", GXutil.ltrim( localUtil.ntoc( AV7Tran_CentroCostoIdDestino, (byte)(11), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV7Tran_CentroCostoIdDestino)) > 0 )
      {
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Tran_CentroCostoIdDestino_CTRL", GXutil.rtrim( sCtrlAV7Tran_CentroCostoIdDestino));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414135029");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("gen_centrocostoalm_transaccion1wc.js", "?201861414135029");
      }
   ...
   public void initialize_properties( )
   {
      ...
      edtTran_CentroCostoIdDestino_Visible = 1 ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Tran_CentroCostoIdDestino',fld:'vTRAN_CENTROCOSTOIDDESTINO',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV12Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV13Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e130G2',iparms:[{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtTran_ConsecutivoCC_Link',ctrl:'TRAN_CONSECUTIVOCC',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e110G2',iparms:[{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H000G2_A416Tran_Observaciones = new String[] {""} ;
      H000G2_n416Tran_Observaciones = new boolean[] {false} ;
      H000G2_A518Tran_RegionIdDestino = new long[1] ;
      H000G2_n518Tran_RegionIdDestino = new boolean[] {false} ;
      H000G2_A50Tran_CentroCostoIdDestino = new long[1] ;
      H000G2_n50Tran_CentroCostoIdDestino = new boolean[] {false} ;
      H000G2_A859Tran_EntidadGobierno = new String[] {""} ;
      H000G2_n859Tran_EntidadGobierno = new boolean[] {false} ;
      H000G2_A759Tran_CedulaResponsabilidad = new long[1] ;
      H000G2_n759Tran_CedulaResponsabilidad = new boolean[] {false} ;
      H000G2_A758Tran_TablaResponsabilidad = new short[1] ;
      H000G2_n758Tran_TablaResponsabilidad = new boolean[] {false} ;
      H000G2_A756Tran_Abreviado = new String[] {""} ;
      H000G2_n756Tran_Abreviado = new boolean[] {false} ;
      H000G2_A754Tran_CuentaResponsabilidad = new String[] {""} ;
      H000G2_n754Tran_CuentaResponsabilidad = new boolean[] {false} ;
      H000G2_A721Tran_NombreCuentadanteResponsa = new String[] {""} ;
      H000G2_n721Tran_NombreCuentadanteResponsa = new boolean[] {false} ;
      H000G2_A720Tran_FechaResponsabilidad = new java.util.Date[] {GXutil.nullDate()} ;
      H000G2_n720Tran_FechaResponsabilidad = new boolean[] {false} ;
      H000G2_A719Tran_TransaccResponsabilidad = new long[1] ;
      H000G2_n719Tran_TransaccResponsabilidad = new boolean[] {false} ;
      H000G2_A56Tran_IdCuentadanteResponsabili = new long[1] ;
      H000G2_n56Tran_IdCuentadanteResponsabili = new boolean[] {false} ;
      H000G2_A715Tran_EmailCuentadanteDestino = new String[] {""} ;
      H000G2_n715Tran_EmailCuentadanteDestino = new boolean[] {false} ;
      H000G2_A714Tran_EmailCuentadanteOrigen = new String[] {""} ;
      H000G2_n714Tran_EmailCuentadanteOrigen = new boolean[] {false} ;
      H000G2_A708Tran_SolicitaRegionDestino = new String[] {""} ;
      H000G2_n708Tran_SolicitaRegionDestino = new boolean[] {false} ;
      H000G2_A707Tran_SolicitaCCDestino = new String[] {""} ;
      H000G2_n707Tran_SolicitaCCDestino = new boolean[] {false} ;
      H000G2_A704Tran_CedulaCuentadanteDestino = new long[1] ;
      H000G2_n704Tran_CedulaCuentadanteDestino = new boolean[] {false} ;
      H000G2_A703Tran_CedulaProveedor = new long[1] ;
      H000G2_n703Tran_CedulaProveedor = new boolean[] {false} ;
      H000G2_A702Tran_CedulaCuentadanteOrigen = new long[1] ;
      H000G2_n702Tran_CedulaCuentadanteOrigen = new boolean[] {false} ;
      H000G2_A670Tran_ObservacionesAnula = new String[] {""} ;
      H000G2_n670Tran_ObservacionesAnula = new boolean[] {false} ;
      H000G2_A669Tran_FechaEliminaoAnula = new java.util.Date[] {GXutil.nullDate()} ;
      H000G2_n669Tran_FechaEliminaoAnula = new boolean[] {false} ;
      H000G2_A668Tran_UsuarioEliminaoAnula = new String[] {""} ;
      H000G2_n668Tran_UsuarioEliminaoAnula = new boolean[] {false} ;
      H000G2_A667Tran_NumeroGrupo = new short[1] ;
      H000G2_n667Tran_NumeroGrupo = new boolean[] {false} ;
      H000G2_A568Tran_CantidadPadres = new int[1] ;
      H000G2_n568Tran_CantidadPadres = new boolean[] {false} ;
      H000G2_A527Tran_TipoEntra = new String[] {""} ;
      H000G2_n527Tran_TipoEntra = new boolean[] {false} ;
      H000G2_A524Tran_Detalle = new String[] {""} ;
      H000G2_n524Tran_Detalle = new boolean[] {false} ;
      H000G2_A608Tran_RegionAbrevDestino = new String[] {""} ;
      H000G2_n608Tran_RegionAbrevDestino = new boolean[] {false} ;
      H000G2_A515Tran_FechaIngreso = new java.util.Date[] {GXutil.nullDate()} ;
      H000G2_n515Tran_FechaIngreso = new boolean[] {false} ;
      H000G2_A514Tran_NumeroIngreso = new String[] {""} ;
      H000G2_n514Tran_NumeroIngreso = new boolean[] {false} ;
      H000G2_A672Tran_NombreIngreso = new String[] {""} ;
      H000G2_n672Tran_NombreIngreso = new boolean[] {false} ;
      H000G2_A54Tran_TipoIngreso = new long[1] ;
      H000G2_n54Tran_TipoIngreso = new boolean[] {false} ;
      H000G2_A513Tran_ConsecutivoCC = new long[1] ;
      H000G2_n513Tran_ConsecutivoCC = new boolean[] {false} ;
      H000G2_A391Tran_UsuarioRatifica = new String[] {""} ;
      H000G2_n391Tran_UsuarioRatifica = new boolean[] {false} ;
      H000G2_A390Tran_FechaRatificacion = new java.util.Date[] {GXutil.nullDate()} ;
      H000G2_n390Tran_FechaRatificacion = new boolean[] {false} ;
      H000G2_A58Tran_Estado = new String[] {""} ;
      H000G2_n58Tran_Estado = new boolean[] {false} ;
      H000G2_A498Tran_NumeroLineas = new long[1] ;
      H000G2_n498Tran_NumeroLineas = new boolean[] {false} ;
      H000G2_A483Tran_ValorTransaccion = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H000G2_n483Tran_ValorTransaccion = new boolean[] {false} ;
      H000G2_A408Tran_CursoCodigo = new String[] {""} ;
      H000G2_n408Tran_CursoCodigo = new boolean[] {false} ;
      H000G2_A407Tran_AreadanteCodigo = new String[] {""} ;
      H000G2_n407Tran_AreadanteCodigo = new boolean[] {false} ;
      H000G2_A389Tran_NombCuentadanteDestino = new String[] {""} ;
      H000G2_n389Tran_NombCuentadanteDestino = new boolean[] {false} ;
      H000G2_A52Tran_IdCuentadanteDestino = new long[1] ;
      H000G2_n52Tran_IdCuentadanteDestino = new boolean[] {false} ;
      H000G2_A387Tran_CodBodeDestino = new String[] {""} ;
      H000G2_A111Tran_CodAlmaDestino = new String[] {""} ;
      H000G2_A385Tran_ModuloDestino = new String[] {""} ;
      H000G2_A575Tran_NombreProveedor = new String[] {""} ;
      H000G2_n575Tran_NombreProveedor = new boolean[] {false} ;
      H000G2_A53Tran_IdProveedor = new long[1] ;
      H000G2_n53Tran_IdProveedor = new boolean[] {false} ;
      H000G2_A384Tran_NombCuentadanteOrigen = new String[] {""} ;
      H000G2_n384Tran_NombCuentadanteOrigen = new boolean[] {false} ;
      H000G2_A51Tran_IdCuentadanteOrigen = new long[1] ;
      H000G2_n51Tran_IdCuentadanteOrigen = new boolean[] {false} ;
      H000G2_A112Tran_CodBodeOrigen = new String[] {""} ;
      H000G2_A109Tran_CodAlmaOrigen = new String[] {""} ;
      H000G2_A110Tran_ModuloOrigen = new String[] {""} ;
      H000G2_A482Tran_TipoElemento = new String[] {""} ;
      H000G2_A499Tran_CodTipoElemento = new long[1] ;
      H000G2_n499Tran_CodTipoElemento = new boolean[] {false} ;
      H000G2_A479Tran_IndCurso = new String[] {""} ;
      H000G2_n479Tran_IndCurso = new boolean[] {false} ;
      H000G2_A481Tran_IndE_S = new String[] {""} ;
      H000G2_n481Tran_IndE_S = new boolean[] {false} ;
      H000G2_A478Tran_IndAreadante = new String[] {""} ;
      H000G2_n478Tran_IndAreadante = new boolean[] {false} ;
      H000G2_A381Tran_DescripcionMovimiento = new String[] {""} ;
      H000G2_n381Tran_DescripcionMovimiento = new boolean[] {false} ;
      H000G2_A49Tran_CodigoMovimiento = new String[] {""} ;
      H000G2_A594Tran_RegionAbrev = new String[] {""} ;
      H000G2_n594Tran_RegionAbrev = new boolean[] {false} ;
      H000G2_A422Tran_RegionDescripcion = new String[] {""} ;
      H000G2_n422Tran_RegionDescripcion = new boolean[] {false} ;
      H000G2_A421Tran_RegionCodigo = new short[1] ;
      H000G2_n421Tran_RegionCodigo = new boolean[] {false} ;
      H000G2_A57Tran_RegionId = new long[1] ;
      H000G2_n57Tran_RegionId = new boolean[] {false} ;
      H000G2_A420Tran_CentroCostoDescripcion = new String[] {""} ;
      H000G2_n420Tran_CentroCostoDescripcion = new boolean[] {false} ;
      H000G2_A419Tran_CentroCostoCodigo = new String[] {""} ;
      H000G2_n419Tran_CentroCostoCodigo = new boolean[] {false} ;
      H000G2_A48Tran_CentroCostoId = new long[1] ;
      H000G2_A418Tran_UsuarioNombre = new String[] {""} ;
      H000G2_n418Tran_UsuarioNombre = new boolean[] {false} ;
      H000G2_A417Tran_UsuarioCodigo = new String[] {""} ;
      H000G2_n417Tran_UsuarioCodigo = new boolean[] {false} ;
      H000G2_A47Tran_UsuarioId = new long[1] ;
      H000G2_n47Tran_UsuarioId = new boolean[] {false} ;
      H000G2_A55Tran_FechaRegistro = new java.util.Date[] {GXutil.nullDate()} ;
      H000G2_A46Tran_Id = new long[1] ;
      ...
      sCtrlAV7Tran_CentroCostoIdDestino = "" ;
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.gen_centrocostoalm_transaccion1wc__default(),
         new Object[] {
             new Object[] {
            H000G2_A416Tran_Observaciones, H000G2_n416Tran_Observaciones, H000G2_A518Tran_RegionIdDestino, H000G2_n518Tran_RegionIdDestino, H000G2_A50Tran_CentroCostoIdDestino, H000G2_n50Tran_CentroCostoIdDestino, H000G2_A859Tran_EntidadGobierno, H000G2_n859Tran_EntidadGobierno, H000G2_A759Tran_CedulaResponsabilidad, H000G2_n759Tran_CedulaResponsabilidad,
            H000G2_A758Tran_TablaResponsabilidad, H000G2_n758Tran_TablaResponsabilidad, H000G2_A756Tran_Abreviado, H000G2_n756Tran_Abreviado, H000G2_A754Tran_CuentaResponsabilidad, H000G2_n754Tran_CuentaResponsabilidad, H000G2_A721Tran_NombreCuentadanteResponsa, H000G2_n721Tran_NombreCuentadanteResponsa, H000G2_A720Tran_FechaResponsabilidad, H000G2_n720Tran_FechaResponsabilidad,
            H000G2_A719Tran_TransaccResponsabilidad, H000G2_n719Tran_TransaccResponsabilidad, H000G2_A56Tran_IdCuentadanteResponsabili, H000G2_n56Tran_IdCuentadanteResponsabili, H000G2_A715Tran_EmailCuentadanteDestino, H000G2_n715Tran_EmailCuentadanteDestino, H000G2_A714Tran_EmailCuentadanteOrigen, H000G2_n714Tran_EmailCuentadanteOrigen, H000G2_A708Tran_SolicitaRegionDestino, H000G2_n708Tran_SolicitaRegionDestino,
            H000G2_A707Tran_SolicitaCCDestino, H000G2_n707Tran_SolicitaCCDestino, H000G2_A704Tran_CedulaCuentadanteDestino, H000G2_n704Tran_CedulaCuentadanteDestino, H000G2_A703Tran_CedulaProveedor, H000G2_n703Tran_CedulaProveedor, H000G2_A702Tran_CedulaCuentadanteOrigen, H000G2_n702Tran_CedulaCuentadanteOrigen, H000G2_A670Tran_ObservacionesAnula, H000G2_n670Tran_ObservacionesAnula,
            H000G2_A669Tran_FechaEliminaoAnula, H000G2_n669Tran_FechaEliminaoAnula, H000G2_A668Tran_UsuarioEliminaoAnula, H000G2_n668Tran_UsuarioEliminaoAnula, H000G2_A667Tran_NumeroGrupo, H000G2_n667Tran_NumeroGrupo, H000G2_A568Tran_CantidadPadres, H000G2_n568Tran_CantidadPadres, H000G2_A527Tran_TipoEntra, H000G2_n527Tran_TipoEntra,
            H000G2_A524Tran_Detalle, H000G2_n524Tran_Detalle, H000G2_A608Tran_RegionAbrevDestino, H000G2_n608Tran_RegionAbrevDestino, H000G2_A515Tran_FechaIngreso, H000G2_n515Tran_FechaIngreso, H000G2_A514Tran_NumeroIngreso, H000G2_n514Tran_NumeroIngreso, H000G2_A672Tran_NombreIngreso, H000G2_n672Tran_NombreIngreso,
            H000G2_A54Tran_TipoIngreso, H000G2_n54Tran_TipoIngreso, H000G2_A513Tran_ConsecutivoCC, H000G2_n513Tran_ConsecutivoCC, H000G2_A391Tran_UsuarioRatifica, H000G2_n391Tran_UsuarioRatifica, H000G2_A390Tran_FechaRatificacion, H000G2_n390Tran_FechaRatificacion, H000G2_A58Tran_Estado, H000G2_n58Tran_Estado,
            H000G2_A498Tran_NumeroLineas, H000G2_n498Tran_NumeroLineas, H000G2_A483Tran_ValorTransaccion, H000G2_n483Tran_ValorTransaccion, H000G2_A408Tran_CursoCodigo, H000G2_n408Tran_CursoCodigo, H000G2_A407Tran_AreadanteCodigo, H000G2_n407Tran_AreadanteCodigo, H000G2_A389Tran_NombCuentadanteDestino, H000G2_n389Tran_NombCuentadanteDestino,
            H000G2_A52Tran_IdCuentadanteDestino, H000G2_n52Tran_IdCuentadanteDestino, H000G2_A387Tran_CodBodeDestino, H000G2_A111Tran_CodAlmaDestino, H000G2_A385Tran_ModuloDestino, H000G2_A575Tran_NombreProveedor, H000G2_n575Tran_NombreProveedor, H000G2_A53Tran_IdProveedor, H000G2_n53Tran_IdProveedor, H000G2_A384Tran_NombCuentadanteOrigen,
            H000G2_n384Tran_NombCuentadanteOrigen, H000G2_A51Tran_IdCuentadanteOrigen, H000G2_n51Tran_IdCuentadanteOrigen, H000G2_A112Tran_CodBodeOrigen, H000G2_A109Tran_CodAlmaOrigen, H000G2_A110Tran_ModuloOrigen, H000G2_A482Tran_TipoElemento, H000G2_A499Tran_CodTipoElemento, H000G2_n499Tran_CodTipoElemento, H000G2_A479Tran_IndCurso,
            H000G2_n479Tran_IndCurso, H000G2_A481Tran_IndE_S, H000G2_n481Tran_IndE_S, H000G2_A478Tran_IndAreadante, H000G2_n478Tran_IndAreadante, H000G2_A381Tran_DescripcionMovimiento, H000G2_n381Tran_DescripcionMovimiento, H000G2_A49Tran_CodigoMovimiento, H000G2_A594Tran_RegionAbrev, H000G2_n594Tran_RegionAbrev,
            H000G2_A422Tran_RegionDescripcion, H000G2_n422Tran_RegionDescripcion, H000G2_A421Tran_RegionCodigo, H000G2_n421Tran_RegionCodigo, H000G2_A57Tran_RegionId, H000G2_n57Tran_RegionId, H000G2_A420Tran_CentroCostoDescripcion, H000G2_n420Tran_CentroCostoDescripcion, H000G2_A419Tran_CentroCostoCodigo, H000G2_n419Tran_CentroCostoCodigo,
            H000G2_A48Tran_CentroCostoId, H000G2_A418Tran_UsuarioNombre, H000G2_n418Tran_UsuarioNombre, H000G2_A417Tran_UsuarioCodigo, H000G2_n417Tran_UsuarioCodigo, H000G2_A47Tran_UsuarioId, H000G2_n47Tran_UsuarioId, H000G2_A55Tran_FechaRegistro, H000G2_A46Tran_Id
            }
            , new Object[] {
   ...
   private int edtTran_CentroCostoIdDestino_Visible ;
   private int subGrid_Islastpage ;
   private int GXPagingFrom2 ;
   private int GXPagingTo2 ;
   private int idxLst ;
   private int subGrid_Backcolor ;
   private long wcpOAV7Tran_CentroCostoIdDestino ;
   private long AV7Tran_CentroCostoIdDestino ;
   ...
   private String sCtrlAV7Tran_CentroCostoIdDestino ;
   ...
   private String[] H000G2_A416Tran_Observaciones ;
   private boolean[] H000G2_n416Tran_Observaciones ;
   private long[] H000G2_A518Tran_RegionIdDestino ;
   private boolean[] H000G2_n518Tran_RegionIdDestino ;
   private long[] H000G2_A50Tran_CentroCostoIdDestino ;
   private boolean[] H000G2_n50Tran_CentroCostoIdDestino ;
   private String[] H000G2_A859Tran_EntidadGobierno ;
   private boolean[] H000G2_n859Tran_EntidadGobierno ;
   private long[] H000G2_A759Tran_CedulaResponsabilidad ;
   private boolean[] H000G2_n759Tran_CedulaResponsabilidad ;
   private short[] H000G2_A758Tran_TablaResponsabilidad ;
   private boolean[] H000G2_n758Tran_TablaResponsabilidad ;
   private String[] H000G2_A756Tran_Abreviado ;
   private boolean[] H000G2_n756Tran_Abreviado ;
   private String[] H000G2_A754Tran_CuentaResponsabilidad ;
   private boolean[] H000G2_n754Tran_CuentaResponsabilidad ;
   private String[] H000G2_A721Tran_NombreCuentadanteResponsa ;
   private boolean[] H000G2_n721Tran_NombreCuentadanteResponsa ;
   private java.util.Date[] H000G2_A720Tran_FechaResponsabilidad ;
   private boolean[] H000G2_n720Tran_FechaResponsabilidad ;
   private long[] H000G2_A719Tran_TransaccResponsabilidad ;
   private boolean[] H000G2_n719Tran_TransaccResponsabilidad ;
   private long[] H000G2_A56Tran_IdCuentadanteResponsabili ;
   private boolean[] H000G2_n56Tran_IdCuentadanteResponsabili ;
   private String[] H000G2_A715Tran_EmailCuentadanteDestino ;
   private boolean[] H000G2_n715Tran_EmailCuentadanteDestino ;
   private String[] H000G2_A714Tran_EmailCuentadanteOrigen ;
   private boolean[] H000G2_n714Tran_EmailCuentadanteOrigen ;
   private String[] H000G2_A708Tran_SolicitaRegionDestino ;
   private boolean[] H000G2_n708Tran_SolicitaRegionDestino ;
   private String[] H000G2_A707Tran_SolicitaCCDestino ;
   private boolean[] H000G2_n707Tran_SolicitaCCDestino ;
   private long[] H000G2_A704Tran_CedulaCuentadanteDestino ;
   private boolean[] H000G2_n704Tran_CedulaCuentadanteDestino ;
   private long[] H000G2_A703Tran_CedulaProveedor ;
   private boolean[] H000G2_n703Tran_CedulaProveedor ;
   private long[] H000G2_A702Tran_CedulaCuentadanteOrigen ;
   private boolean[] H000G2_n702Tran_CedulaCuentadanteOrigen ;
   private String[] H000G2_A670Tran_ObservacionesAnula ;
   private boolean[] H000G2_n670Tran_ObservacionesAnula ;
   private java.util.Date[] H000G2_A669Tran_FechaEliminaoAnula ;
   private boolean[] H000G2_n669Tran_FechaEliminaoAnula ;
   private String[] H000G2_A668Tran_UsuarioEliminaoAnula ;
   private boolean[] H000G2_n668Tran_UsuarioEliminaoAnula ;
   private short[] H000G2_A667Tran_NumeroGrupo ;
   private boolean[] H000G2_n667Tran_NumeroGrupo ;
   private int[] H000G2_A568Tran_CantidadPadres ;
   private boolean[] H000G2_n568Tran_CantidadPadres ;
   private String[] H000G2_A527Tran_TipoEntra ;
   private boolean[] H000G2_n527Tran_TipoEntra ;
   private String[] H000G2_A524Tran_Detalle ;
   private boolean[] H000G2_n524Tran_Detalle ;
   private String[] H000G2_A608Tran_RegionAbrevDestino ;
   private boolean[] H000G2_n608Tran_RegionAbrevDestino ;
   private java.util.Date[] H000G2_A515Tran_FechaIngreso ;
   private boolean[] H000G2_n515Tran_FechaIngreso ;
   private String[] H000G2_A514Tran_NumeroIngreso ;
   private boolean[] H000G2_n514Tran_NumeroIngreso ;
   private String[] H000G2_A672Tran_NombreIngreso ;
   private boolean[] H000G2_n672Tran_NombreIngreso ;
   private long[] H000G2_A54Tran_TipoIngreso ;
   private boolean[] H000G2_n54Tran_TipoIngreso ;
   private long[] H000G2_A513Tran_ConsecutivoCC ;
   private boolean[] H000G2_n513Tran_ConsecutivoCC ;
   private String[] H000G2_A391Tran_UsuarioRatifica ;
   private boolean[] H000G2_n391Tran_UsuarioRatifica ;
   private java.util.Date[] H000G2_A390Tran_FechaRatificacion ;
   private boolean[] H000G2_n390Tran_FechaRatificacion ;
   private String[] H000G2_A58Tran_Estado ;
   private boolean[] H000G2_n58Tran_Estado ;
   private long[] H000G2_A498Tran_NumeroLineas ;
   private boolean[] H000G2_n498Tran_NumeroLineas ;
   private java.math.BigDecimal[] H000G2_A483Tran_ValorTransaccion ;
   private boolean[] H000G2_n483Tran_ValorTransaccion ;
   private String[] H000G2_A408Tran_CursoCodigo ;
   private boolean[] H000G2_n408Tran_CursoCodigo ;
   private String[] H000G2_A407Tran_AreadanteCodigo ;
   private boolean[] H000G2_n407Tran_AreadanteCodigo ;
   private String[] H000G2_A389Tran_NombCuentadanteDestino ;
   private boolean[] H000G2_n389Tran_NombCuentadanteDestino ;
   private long[] H000G2_A52Tran_IdCuentadanteDestino ;
   private boolean[] H000G2_n52Tran_IdCuentadanteDestino ;
   private String[] H000G2_A387Tran_CodBodeDestino ;
   private String[] H000G2_A111Tran_CodAlmaDestino ;
   private String[] H000G2_A385Tran_ModuloDestino ;
   private String[] H000G2_A575Tran_NombreProveedor ;
   private boolean[] H000G2_n575Tran_NombreProveedor ;
   private long[] H000G2_A53Tran_IdProveedor ;
   private boolean[] H000G2_n53Tran_IdProveedor ;
   private String[] H000G2_A384Tran_NombCuentadanteOrigen ;
   private boolean[] H000G2_n384Tran_NombCuentadanteOrigen ;
   private long[] H000G2_A51Tran_IdCuentadanteOrigen ;
   private boolean[] H000G2_n51Tran_IdCuentadanteOrigen ;
   private String[] H000G2_A112Tran_CodBodeOrigen ;
   private String[] H000G2_A109Tran_CodAlmaOrigen ;
   private String[] H000G2_A110Tran_ModuloOrigen ;
   private String[] H000G2_A482Tran_TipoElemento ;
   private long[] H000G2_A499Tran_CodTipoElemento ;
   private boolean[] H000G2_n499Tran_CodTipoElemento ;
   private String[] H000G2_A479Tran_IndCurso ;
   private boolean[] H000G2_n479Tran_IndCurso ;
   private String[] H000G2_A481Tran_IndE_S ;
   private boolean[] H000G2_n481Tran_IndE_S ;
   private String[] H000G2_A478Tran_IndAreadante ;
   private boolean[] H000G2_n478Tran_IndAreadante ;
   private String[] H000G2_A381Tran_DescripcionMovimiento ;
   private boolean[] H000G2_n381Tran_DescripcionMovimiento ;
   private String[] H000G2_A49Tran_CodigoMovimiento ;
   private String[] H000G2_A594Tran_RegionAbrev ;
   private boolean[] H000G2_n594Tran_RegionAbrev ;
   private String[] H000G2_A422Tran_RegionDescripcion ;
   private boolean[] H000G2_n422Tran_RegionDescripcion ;
   private short[] H000G2_A421Tran_RegionCodigo ;
   private boolean[] H000G2_n421Tran_RegionCodigo ;
   private long[] H000G2_A57Tran_RegionId ;
   private boolean[] H000G2_n57Tran_RegionId ;
   private String[] H000G2_A420Tran_CentroCostoDescripcion ;
   private boolean[] H000G2_n420Tran_CentroCostoDescripcion ;
   private String[] H000G2_A419Tran_CentroCostoCodigo ;
   private boolean[] H000G2_n419Tran_CentroCostoCodigo ;
   private long[] H000G2_A48Tran_CentroCostoId ;
   private String[] H000G2_A418Tran_UsuarioNombre ;
   private boolean[] H000G2_n418Tran_UsuarioNombre ;
   private String[] H000G2_A417Tran_UsuarioCodigo ;
   private boolean[] H000G2_n417Tran_UsuarioCodigo ;
   private long[] H000G2_A47Tran_UsuarioId ;
   private boolean[] H000G2_n47Tran_UsuarioId ;
   private java.util.Date[] H000G2_A55Tran_FechaRegistro ;
   private long[] H000G2_A46Tran_Id ;
                           ...
                           Object[] buf ) throws SQLException
   {
      switch ( cursor )
      {
            case 0 :
               ...
               ((java.util.Date[]) buf[40])[0] = rslt.getGXDateTime(21) ;
               ...
               ((String[]) buf[48])[0] = rslt.getString(25, 4) ;
               ((boolean[]) buf[49])[0] = rslt.wasNull();
               ((String[]) buf[50])[0] = rslt.getString(26, 1) ;
               ((boolean[]) buf[51])[0] = rslt.wasNull();
               ((String[]) buf[52])[0] = rslt.getVarchar(27) ;
               ((boolean[]) buf[53])[0] = rslt.wasNull();
               ((java.util.Date[]) buf[54])[0] = rslt.getGXDate(28) ;
               ((boolean[]) buf[55])[0] = rslt.wasNull();
               ((String[]) buf[56])[0] = rslt.getString(29, 30) ;
               ...
               ((java.util.Date[]) buf[66])[0] = rslt.getGXDateTime(34) ;
               ((boolean[]) buf[67])[0] = rslt.wasNull();
               ((String[]) buf[68])[0] = rslt.getString(35, 1) ;
               ((boolean[]) buf[69])[0] = rslt.wasNull();
               ((long[]) buf[70])[0] = rslt.getLong(36) ;
               ((boolean[]) buf[71])[0] = rslt.wasNull();
               ((java.math.BigDecimal[]) buf[72])[0] = rslt.getBigDecimal(37,2) ;
               ...
               ((String[]) buf[96])[0] = rslt.getString(52, 1) ;
               ((long[]) buf[97])[0] = rslt.getLong(53) ;
               ...
               ((long[]) buf[114])[0] = rslt.getLong(62) ;
               ...
               ((long[]) buf[120])[0] = rslt.getLong(65) ;
