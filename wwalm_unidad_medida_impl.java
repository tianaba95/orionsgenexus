...
public final  class wwalm_unidad_medida_impl extends GXDataArea
{
   public wwalm_unidad_medida_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wwalm_unidad_medida_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wwalm_unidad_medida_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
         {
            ...
            AV14UNIMED_DES = httpContext.GetNextPar( ) ;
            AV15Update = httpContext.GetNextPar( ) ;
            edtavUpdate_Tooltiptext = httpContext.GetNextPar( ) ;
            httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Tooltiptext", edtavUpdate_Tooltiptext, !bGXsfl_25_Refreshing);
            AV16Delete = httpContext.GetNextPar( ) ;
            ...
            gxgrgrid_refresh( subGrid_Rows, AV14UNIMED_DES, AV15Update, AV16Delete, AV20Pgmname, A77UNIMED_COD) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20186141420022");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( nGXWrapped != 1 )
      {
         httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.wwalm_unidad_medida") +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "GXH_vUNIMED_DES", AV14UNIMED_DES);
      /* Send saved values. */
   ...
   {
      return formatLink("com.orions2.wwalm_unidad_medida")  ;
   }

   public String getPgmname( )
   {
      return "WWALM_UNIDAD_MEDIDA" ;
   }
   ...
   public void wb5O0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblTitletext_Internalname, "Unidad de medida", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_WWALM_UNIDAD_MEDIDA.htm");
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 25, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWALM_UNIDAD_MEDIDA.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_label_element( httpContext, edtavUnimed_des_Internalname, "UNIMED_DES", "col-sm-3 FilterSearchAttributeLabel", 0, true);
         /* Multiple line edit */
         ...
         ClassString = "FilterSearchAttribute" ;
         StyleString = "" ;
         com.orions2.GxWebStd.gx_html_textarea( httpContext, edtavUnimed_des_Internalname, AV14UNIMED_DES, "", TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", (short)(0), 1, edtavUnimed_des_Enabled, 0, 80, "chr", 3, "row", StyleString, ClassString, "", "200", -1, 0, "", "MEDIDA DESCRIPCION", (byte)(-1), true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_WWALM_UNIDAD_MEDIDA.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            httpContext.writeValue( "MEDIDA DESCRIPCION") ;
            httpContext.writeTextNL( "</th>") ;
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.rtrim( A497UNIMED_EST));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
   ...
   public void start5O2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Work With Unidad de medida", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 {
                                    Rfr0gs = false ;
                                    /* Set Refresh If Unimed_des Changed */
                                    if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vUNIMED_DES"), AV14UNIMED_DES) != 0 )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    if ( ! Rfr0gs )
   ...
   public void pa5O2( )
   {
      if ( nDonePA == 0 )
      {
         ...
         GXCCtl = "UNIMED_EST_" + sGXsfl_25_idx ;
         ...
         if ( ! httpContext.isAjaxRequest( ) )
         {
            GX_FocusControl = edtavUnimed_des_Internalname ;
   ...
   {
      /* GeneXus formulas. */
      AV20Pgmname = "WWALM_UNIDAD_MEDIDA" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf5O2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV14UNIMED_DES = GXutil.concat( GXutil.rtrim( AV14UNIMED_DES), "%", "") ;
         httpContext.ajax_rsp_assign_attri("", false, "AV14UNIMED_DES", AV14UNIMED_DES);
         /* Using cursor H005O2 */
         pr_default.execute(0, new Object[] {lV14UNIMED_DES, new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_25_idx = (short)(1) ;
         sGXsfl_25_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_25_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_252( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A497UNIMED_EST = H005O2_A497UNIMED_EST[0] ;
            A496UNIMED_DES = H005O2_A496UNIMED_DES[0] ;
            A77UNIMED_COD = H005O2_A77UNIMED_COD[0] ;
            e145O2 ();
   ...
   public int subgrid_recordcount( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV14UNIMED_DES", AV14UNIMED_DES);
      /* Using cursor H005O3 */
      pr_default.execute(1, new Object[] {lV14UNIMED_DES});
   ...
   public void strup5O0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV14UNIMED_DES = httpContext.cgiGet( edtavUnimed_des_Internalname) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV14UNIMED_DES", AV14UNIMED_DES);
         /* Read saved values. */
   ...
   {
      /* Grid_Load Routine */
      edtavUpdate_Link = formatLink("com.orions2.alm_unidad_medida") + "?" + GXutil.URLEncode(GXutil.rtrim("UPD")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A77UNIMED_COD,6,0))) ;
      edtavDelete_Link = formatLink("com.orions2.alm_unidad_medida") + "?" + GXutil.URLEncode(GXutil.rtrim("DLT")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A77UNIMED_COD,6,0))) ;
   ...
   {
      /* 'DoInsert' Routine */
      callWebObject(formatLink("com.orions2.alm_unidad_medida") + "?" + GXutil.URLEncode(GXutil.rtrim("INS")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(0,9,0))));
      httpContext.wjLocDisableFrm = (byte)(1) ;
   }
   ...
   public void S122( )
   {
      ...
      if ( GXutil.strcmp(AV8HTTPRequest.getMethod(), "GET") == 0 )
      {
         ...
         {
            AV14UNIMED_DES = ((com.orions2.SdtGridState_FilterValue)AV9GridState.getgxTv_SdtGridState_Filtervalues().elementAt(-1+1)).getgxTv_SdtGridState_FilterValue_Value() ;
            httpContext.ajax_rsp_assign_attri("", false, "AV14UNIMED_DES", AV14UNIMED_DES);
         }
   ...
   public void S132( )
   {
      ...
      AV10GridStateFilterValue.setgxTv_SdtGridState_FilterValue_Value( AV14UNIMED_DES );
   ...
   public void S112( )
   {
      ...
      AV12TrnContext.setgxTv_SdtTransactionContext_Transactionname( "ALM_UNIDAD_MEDIDA" );
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20186141420066");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         ...
         httpContext.AddJavascriptSource("wwalm_unidad_medida.js", "?20186141420066");
      }
   ...
   {
      edtUNIMED_COD_Internalname = "UNIMED_COD_"+sGXsfl_25_idx ;
      edtUNIMED_DES_Internalname = "UNIMED_DES_"+sGXsfl_25_idx ;
      cmbUNIMED_EST.setInternalname( "UNIMED_EST_"+sGXsfl_25_idx );
   ...
   {
      edtUNIMED_COD_Internalname = "UNIMED_COD_"+sGXsfl_25_fel_idx ;
      edtUNIMED_DES_Internalname = "UNIMED_DES_"+sGXsfl_25_fel_idx ;
      cmbUNIMED_EST.setInternalname( "UNIMED_EST_"+sGXsfl_25_fel_idx );
   ...
   public void sendrow_252( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtUNIMED_COD_Internalname,GXutil.ltrim( localUtil.ntoc( A77UNIMED_COD, (byte)(6), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A77UNIMED_COD), "ZZZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtUNIMED_COD_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(6),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtUNIMED_DES_Internalname,A496UNIMED_DES,"","","'"+""+"'"+",false,"+"'"+""+"'",edtUNIMED_DES_Link,"","","",edtUNIMED_DES_Jsonclick,new Integer(0),"DescriptionAttribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(200),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbUNIMED_EST,cmbUNIMED_EST.getInternalname(),GXutil.rtrim( A497UNIMED_EST),new Integer(1),cmbUNIMED_EST.getJsonclick(),new Integer(0),"'"+""+"'"+",false,"+"'"+""+"'","char","",new Integer(-1),new Integer(0),new Integer(0),new Integer(0),new Integer(0),"px",new Integer(0),"px","","Attribute","WWColumn WWOptionalColumn","","",new Boolean(true)});
         cmbUNIMED_EST.setValue( GXutil.rtrim( A497UNIMED_EST) );
         httpContext.ajax_rsp_assign_prop("", false, cmbUNIMED_EST.getInternalname(), "Values", cmbUNIMED_EST.ToJavascriptSource(), !bGXsfl_25_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_UNIMED_COD"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, localUtil.format( DecimalUtil.doubleToDec(A77UNIMED_COD), "ZZZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_UNIMED_EST"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, GXutil.rtrim( localUtil.format( A497UNIMED_EST, ""))));
   ...
   public void init_default_properties( )
   {
      ...
      edtavUnimed_des_Internalname = "vUNIMED_DES" ;
   ...
   public void initialize_properties( )
   {
      ...
      edtavUnimed_des_Enabled = 1 ;
      Form.setHeaderrawhtml( "" );
      Form.setBackground( "" );
      Form.setTextcolor( 0 );
      Form.setIBackground( (int)(0xFFFFFF) );
      Form.setCaption( "Work With Unidad de medida" );
      subGrid_Rows = 0 ;
      edtavDelete_Tooltiptext = "Eliminar" ;
      edtavUpdate_Tooltiptext = "Modificar" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV15Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV16Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A77UNIMED_COD',fld:'UNIMED_COD',pic:'ZZZZZ9',hsh:true,nv:0},{av:'AV20Pgmname',fld:'vPGMNAME',pic:'',nv:''},{av:'AV14UNIMED_DES',fld:'vUNIMED_DES',pic:'',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e145O2',iparms:[{av:'A77UNIMED_COD',fld:'UNIMED_COD',pic:'ZZZZZ9',hsh:true,nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtUNIMED_DES_Link',ctrl:'UNIMED_DES',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e115O2',iparms:[{av:'A77UNIMED_COD',fld:'UNIMED_COD',pic:'ZZZZZ9',hsh:true,nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV14UNIMED_DES = "" ;
      H005O2_A497UNIMED_EST = new String[] {""} ;
      H005O2_A496UNIMED_DES = new String[] {""} ;
      H005O2_A77UNIMED_COD = new int[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.wwalm_unidad_medida__default(),
         new Object[] {
             new Object[] {
            H005O2_A497UNIMED_EST, H005O2_A496UNIMED_DES, H005O2_A77UNIMED_COD
            }
            , new Object[] {
   ...
   private int edtavUnimed_des_Enabled ;
   ...
   private String edtavUnimed_des_Internalname ;
   ...
   private String[] H005O2_A497UNIMED_EST ;
   private String[] H005O2_A496UNIMED_DES ;
   private int[] H005O2_A77UNIMED_COD ;
...
final  class wwalm_unidad_medida__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H005O2( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.internet.HttpContext httpContext ,
                                          String AV14UNIMED_DES ,
                                          String A496UNIMED_DES )
   {
      String sWhereString = "" ;
      String scmdbuf ;
      byte[] GXv_int1 ;
      ...
      String sFromString ;
      String sOrderString ;
      sSelectString = " UNIMED_EST, UNIMED_DES, UNIMED_COD" ;
      sFromString = " FROM ALM_UNIDAD_MEDIDA" ;
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV14UNIMED_DES)==0) )
      {
         if ( GXutil.strcmp("", sWhereString) != 0 )
         {
            sWhereString = sWhereString + " and (UNIMED_DES like ?)" ;
         }
         else
         {
            sWhereString = sWhereString + " (UNIMED_DES like ?)" ;
         }
      }
      else
      {
      ...
      sOrderString = sOrderString + " ORDER BY UNIMED_DES" ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H005O2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
            case 1 :
                  return conditional_H005O3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H005O2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H005O3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
