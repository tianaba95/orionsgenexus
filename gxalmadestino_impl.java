...
public final  class gxalmadestino_impl extends GXDataArea
{
   public gxalmadestino_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public gxalmadestino_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( gxalmadestino_impl.class ));
   }
      ...
      if ( nGotPars == 0 )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               ...
               AV29Tran_CodAlmaOrigen = httpContext.GetNextPar( ) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV29Tran_CodAlmaOrigen", AV29Tran_CodAlmaOrigen);
               httpContext.ajax_rsp_assign_attri("", false, "gxhash_vTRAN_CODALMAORIGEN", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV29Tran_CodAlmaOrigen, ""))));
               AV36Tran_CodBodeOrigen = httpContext.GetNextPar( ) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV36Tran_CodBodeOrigen", AV36Tran_CodBodeOrigen);
               httpContext.ajax_rsp_assign_attri("", false, "gxhash_vTRAN_CODBODEORIGEN", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV36Tran_CodBodeOrigen, ""))));
               AV35Tran_ModuloDestino = httpContext.GetNextPar( ) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV35Tran_ModuloDestino", AV35Tran_ModuloDestino);
               httpContext.ajax_rsp_assign_attri("", false, "gxhash_vTRAN_MODULODESTINO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV35Tran_ModuloDestino, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414214643");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.gxalmadestino") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV23Tran_RegionId,11,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV24Tran_CentroCostoId,11,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV25Tran_CodigoMovimiento)) + "," + GXutil.URLEncode(GXutil.rtrim(AV26Tran_ModuloOrigen)) + "," + GXutil.URLEncode(GXutil.rtrim(AV29Tran_CodAlmaOrigen)) + "," + GXutil.URLEncode(GXutil.rtrim(AV36Tran_CodBodeOrigen)) + "," + GXutil.URLEncode(GXutil.rtrim(AV35Tran_ModuloDestino)) + "," + GXutil.URLEncode(GXutil.rtrim(AV34pAlma_Codigo)) + "," + GXutil.URLEncode(GXutil.rtrim(AV33pAlma_Descripcion)) + "," + GXutil.URLEncode(GXutil.rtrim(AV34pAlma_Codigo))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vTRAN_CODALMAORIGEN", AV29Tran_CodAlmaOrigen);
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vTRAN_CODBODEORIGEN", AV36Tran_CodBodeOrigen);
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vTRAN_MODULODESTINO", AV35Tran_ModuloDestino);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTRAN_CODALMAORIGEN", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV29Tran_CodAlmaOrigen, ""))));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTRAN_CODBODEORIGEN", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV36Tran_CodBodeOrigen, ""))));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTRAN_MODULODESTINO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV35Tran_ModuloDestino, ""))));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTRAN_REGIONID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV23Tran_RegionId), "ZZZZZZZZZZ9")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTRAN_CENTROCOSTOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV24Tran_CentroCostoId), "ZZZZZZZZZZ9")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTRAN_CODIGOMOVIMIENTO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV25Tran_CodigoMovimiento, ""))));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTRAN_MODULOORIGEN", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV26Tran_ModuloOrigen, ""))));
   ...
   {
      return formatLink("com.orions2.gxalmadestino") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV23Tran_RegionId,11,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV24Tran_CentroCostoId,11,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV25Tran_CodigoMovimiento)) + "," + GXutil.URLEncode(GXutil.rtrim(AV26Tran_ModuloOrigen)) + "," + GXutil.URLEncode(GXutil.rtrim(AV29Tran_CodAlmaOrigen)) + "," + GXutil.URLEncode(GXutil.rtrim(AV36Tran_CodBodeOrigen)) + "," + GXutil.URLEncode(GXutil.rtrim(AV35Tran_ModuloDestino)) + "," + GXutil.URLEncode(GXutil.rtrim(AV34pAlma_Codigo)) + "," + GXutil.URLEncode(GXutil.rtrim(AV33pAlma_Descripcion)) + "," + GXutil.URLEncode(GXutil.rtrim(AV34pAlma_Codigo)) ;
   }

   public String getPgmname( )
   {
      return "GxAlmaDestino" ;
   }
   ...
   public void wb6Y0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltpmo_codigofilter_Internalname, "Código Almacen", "", "", lblLbltpmo_codigofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e116y1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_GxAlmaDestino.htm");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltpmo_descripcionfilter_Internalname, "Descripción Almacen", "", "", lblLbltpmo_descripcionfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e126y1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_GxAlmaDestino.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 34, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e136y1_client"+"'", TempTags, "", 2, "HLP_GxAlmaDestino.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      if ( wbEnd == 34 )
      {
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 34, 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_GxAlmaDestino.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start6Y2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Alma Destino", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
               ...
               if ( GXutil.strcmp(sEvtType, "M") != 0 )
               {
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 10), "GRID1.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 10), "'RETORNAR'") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 10), "'RETORNAR'") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 10), "'RETORNAR'") == 0 ) )
                        {
                           ...
                           httpContext.ajax_rsp_assign_prop("", false, edtavLinkselection_Internalname, "Bitmap", ((GXutil.strcmp("", AV5LinkSelection)==0) ? AV40Linkselection_GXI : httpContext.convertURL( httpContext.getResourceRelative(AV5LinkSelection))), !bGXsfl_34_Refreshing);
   ...
   public void e146Y2( )
   {
      ...
      GXv_char6[0] = AV29Tran_CodAlmaOrigen ;
      GXv_char7[0] = AV36Tran_CodBodeOrigen ;
      GXv_char8[0] = AV35Tran_ModuloDestino ;
      GXv_objcol_SdtSDTAlma_Origen_SDTAlma_OrigenItem9[0] = GXt_objcol_SdtSDTAlma_Origen_SDTAlma_OrigenItem1 ;
      new com.orions2.palma_destino(remoteHandle, context).execute( GXv_int2, GXv_int3, GXv_char4, GXv_char5, GXv_char6, GXv_char7, GXv_char8, GXv_objcol_SdtSDTAlma_Origen_SDTAlma_OrigenItem9) ;
      gxalmadestino_impl.this.AV23Tran_RegionId = GXv_int2[0] ;
      gxalmadestino_impl.this.AV24Tran_CentroCostoId = GXv_int3[0] ;
      gxalmadestino_impl.this.AV25Tran_CodigoMovimiento = GXv_char4[0] ;
      gxalmadestino_impl.this.AV26Tran_ModuloOrigen = GXv_char5[0] ;
      gxalmadestino_impl.this.AV29Tran_CodAlmaOrigen = GXv_char6[0] ;
      gxalmadestino_impl.this.AV36Tran_CodBodeOrigen = GXv_char7[0] ;
      gxalmadestino_impl.this.AV35Tran_ModuloDestino = GXv_char8[0] ;
      GXt_objcol_SdtSDTAlma_Origen_SDTAlma_OrigenItem1 = GXv_objcol_SdtSDTAlma_Origen_SDTAlma_OrigenItem9[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "AV23Tran_RegionId", GXutil.ltrim( GXutil.str( AV23Tran_RegionId, 11, 0)));
      httpContext.ajax_rsp_assign_attri("", false, "gxhash_vTRAN_REGIONID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV23Tran_RegionId), "ZZZZZZZZZZ9")));
      httpContext.ajax_rsp_assign_attri("", false, "AV24Tran_CentroCostoId", GXutil.ltrim( GXutil.str( AV24Tran_CentroCostoId, 11, 0)));
      httpContext.ajax_rsp_assign_attri("", false, "gxhash_vTRAN_CENTROCOSTOID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV24Tran_CentroCostoId), "ZZZZZZZZZZ9")));
   ...
   private void e156Y2( )
   {
      ...
      {
         AV39GXV1 = 1 ;
         while ( AV39GXV1 <= AV27SDTAlma_Origen.size() )
         {
            AV28SDTAlma_OrigenItem = (com.orions2.SdtSDTAlma_Origen_SDTAlma_OrigenItem)((com.orions2.SdtSDTAlma_Origen_SDTAlma_OrigenItem)AV27SDTAlma_Origen.elementAt(-1+AV39GXV1));
            AV5LinkSelection = context.getHttpContext().getImagePath( "3914535b-0c03-44c5-9538-906a99cdd2bc", "", context.getHttpContext().getTheme( )) ;
            AV40Linkselection_GXI = GXDbFile.pathToUrl( context.getHttpContext().getImagePath( "3914535b-0c03-44c5-9538-906a99cdd2bc", "", context.getHttpContext().getTheme( )), context.getHttpContext()) ;
      ...
      {
         AV41GXV2 = 1 ;
         while ( AV41GXV2 <= AV21SDTTipoMovimiento.size() )
         {
            AV22SDTTipoMovimientoItem = (com.orions2.SdtSDTTipoMovimiento_SDTTipoMovimientoItem)((com.orions2.SdtSDTTipoMovimiento_SDTTipoMovimientoItem)AV21SDTTipoMovimiento.elementAt(-1+AV41GXV2));
      ...
      {
         AV42GXV3 = 1 ;
         while ( AV42GXV3 <= AV21SDTTipoMovimiento.size() )
         {
            AV22SDTTipoMovimientoItem = (com.orions2.SdtSDTTipoMovimiento_SDTTipoMovimientoItem)((com.orions2.SdtSDTTipoMovimiento_SDTTipoMovimientoItem)AV21SDTTipoMovimiento.elementAt(-1+AV42GXV3));
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV26Tran_ModuloOrigen", AV26Tran_ModuloOrigen);
      httpContext.ajax_rsp_assign_attri("", false, "gxhash_vTRAN_MODULOORIGEN", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV26Tran_ModuloOrigen, ""))));
      AV29Tran_CodAlmaOrigen = (String)getParm(obj,4) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV29Tran_CodAlmaOrigen", AV29Tran_CodAlmaOrigen);
      httpContext.ajax_rsp_assign_attri("", false, "gxhash_vTRAN_CODALMAORIGEN", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV29Tran_CodAlmaOrigen, ""))));
      AV36Tran_CodBodeOrigen = (String)getParm(obj,5) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV36Tran_CodBodeOrigen", AV36Tran_CodBodeOrigen);
      httpContext.ajax_rsp_assign_attri("", false, "gxhash_vTRAN_CODBODEORIGEN", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV36Tran_CodBodeOrigen, ""))));
      AV35Tran_ModuloDestino = (String)getParm(obj,6) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV35Tran_ModuloDestino", AV35Tran_ModuloDestino);
      httpContext.ajax_rsp_assign_attri("", false, "gxhash_vTRAN_MODULODESTINO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV35Tran_ModuloDestino, ""))));
      AV34pAlma_Codigo = (String)getParm(obj,7) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV34pAlma_Codigo", AV34pAlma_Codigo);
      AV33pAlma_Descripcion = (String)getParm(obj,8) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV33pAlma_Descripcion", AV33pAlma_Descripcion);
      AV34pAlma_Codigo = (String)getParm(obj,7) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV34pAlma_Codigo", AV34pAlma_Codigo);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414214698");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gxalmadestino.js", "?201861414214698");
   ...
   public void sendrow_342( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_34_idx <= subgrid1_recordsperpage( ) * 1 ) )
      {
         ...
         StyleString = "" ;
         AV5LinkSelection_IsBlob = (boolean)(((GXutil.strcmp("", AV5LinkSelection)==0)&&(GXutil.strcmp("", AV40Linkselection_GXI)==0))||!(GXutil.strcmp("", AV5LinkSelection)==0)) ;
         sImgUrl = ((GXutil.strcmp("", AV5LinkSelection)==0) ? AV40Linkselection_GXI : httpContext.getResourceRelative(AV5LinkSelection)) ;
         ...
         ROClassString = "Attribute" ;
         edtavAlma_descripcion_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( AV34pAlma_Codigo)+"'"+", "+"'"+PrivateUtilities.encodeJSConstant( AV33pAlma_Descripcion)+"'"+", "+"'"+PrivateUtilities.encodeJSConstant( AV34pAlma_Codigo)+"'"+"]);" ;
         ...
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavAlma_descripcion_Internalname,AV32Alma_Descripcion,GXutil.rtrim( localUtil.format( AV32Alma_Descripcion, "@!")),TempTags+((edtavAlma_descripcion_Enabled!=0)&&(edtavAlma_descripcion_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavAlma_descripcion_Enabled!=0)&&(edtavAlma_descripcion_Visible!=0) ? " onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,37);\"" : " "),"'"+""+"'"+",false,"+"'"+"E\\'RETORNAR\\'."+sGXsfl_34_idx+"'",edtavAlma_descripcion_Link,"","","",edtavAlma_descripcion_Jsonclick,new Integer(5),"Attribute","",ROClassString,"",new Integer(-1),new Integer(edtavAlma_descripcion_Enabled),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(100),new Integer(0),new Integer(0),new Integer(34),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("'TOGGLE'","{handler:'e136Y1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}],oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
      setEventMetadata("LBLTPMO_CODIGOFILTER.CLICK","{handler:'e116Y1',iparms:[{av:'divTpmo_codigofiltercontainer_Class',ctrl:'TPMO_CODIGOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTpmo_codigofiltercontainer_Class',ctrl:'TPMO_CODIGOFILTERCONTAINER',prop:'Class'},{av:'edtavCtpmo_codigo_Visible',ctrl:'vCTPMO_CODIGO',prop:'Visible'}]}");
      setEventMetadata("LBLTPMO_DESCRIPCIONFILTER.CLICK","{handler:'e126Y1',iparms:[{av:'divTpmo_descripcionfiltercontainer_Class',ctrl:'TPMO_DESCRIPCIONFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTpmo_descripcionfiltercontainer_Class',ctrl:'TPMO_DESCRIPCIONFILTERCONTAINER',prop:'Class'},{av:'edtavCtpmo_descripcion_Visible',ctrl:'vCTPMO_DESCRIPCION',prop:'Visible'}]}");
      setEventMetadata("GRID1.LOAD","{handler:'e156Y2',iparms:[{av:'AV6cTpmo_Codigo',fld:'vCTPMO_CODIGO',pic:'',nv:''},{av:'AV7cTpmo_Descripcion',fld:'vCTPMO_DESCRIPCION',pic:'',nv:''},{av:'AV27SDTAlma_Origen',fld:'vSDTALMA_ORIGEN',pic:'',nv:null},{av:'AV21SDTTipoMovimiento',fld:'vSDTTIPOMOVIMIENTO',pic:'',nv:null},{av:'AV28SDTAlma_OrigenItem',fld:'vSDTALMA_ORIGENITEM',pic:'',nv:null}],oparms:[{av:'AV28SDTAlma_OrigenItem',fld:'vSDTALMA_ORIGENITEM',pic:'',nv:null},{av:'AV5LinkSelection',fld:'vLINKSELECTION',pic:'',nv:''},{av:'AV31Alma_Codigo',fld:'vALMA_CODIGO',pic:'',nv:''},{av:'AV32Alma_Descripcion',fld:'vALMA_DESCRIPCION',pic:'@!',nv:''}]}");
      setEventMetadata("'RETORNAR'","{handler:'e166Y2',iparms:[{av:'AV31Alma_Codigo',fld:'vALMA_CODIGO',pic:'',nv:''},{av:'AV32Alma_Descripcion',fld:'vALMA_DESCRIPCION',pic:'@!',nv:''}],oparms:[{av:'AV34pAlma_Codigo',fld:'vPALMA_CODIGO',pic:'',nv:''},{av:'AV33pAlma_Descripcion',fld:'vPALMA_DESCRIPCION',pic:'@!',nv:''}]}");
   ...
   public void initialize( )
   {
      ...
      wcpOAV29Tran_CodAlmaOrigen = "" ;
      wcpOAV36Tran_CodBodeOrigen = "" ;
      wcpOAV35Tran_ModuloDestino = "" ;
      gxfirstwebparm = "" ;
      gxfirstwebparm_bkp = "" ;
      AV6cTpmo_Codigo = "" ;
      ...
      AV29Tran_CodAlmaOrigen = "" ;
      AV36Tran_CodBodeOrigen = "" ;
      AV35Tran_ModuloDestino = "" ;
      AV34pAlma_Codigo = "" ;
      ...
      GXv_objcol_SdtSDTAlma_Origen_SDTAlma_OrigenItem9 = new GXBaseCollection [1] ;
   ...
   private String wcpOAV29Tran_CodAlmaOrigen ;
   private String wcpOAV36Tran_CodBodeOrigen ;
   private String wcpOAV35Tran_ModuloDestino ;
   ...
   private String AV29Tran_CodAlmaOrigen ;
   private String AV36Tran_CodBodeOrigen ;
   private String AV35Tran_ModuloDestino ;
   ...
   private String AV40Linkselection_GXI ;
   ...
   private GXBaseCollection<com.orions2.SdtSDTAlma_Origen_SDTAlma_OrigenItem> GXv_objcol_SdtSDTAlma_Origen_SDTAlma_OrigenItem9[] ;
