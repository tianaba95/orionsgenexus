/*
               File: seg_rolypantallaroleswc_impl
...
public final  class seg_rolypantallaroleswc_impl extends GXWebComponent
{
   public seg_rolypantallaroleswc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public seg_rolypantallaroleswc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( seg_rolypantallaroleswc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV12Update, AV13Delete, A104TNov_Codigo, A106Nove_Identificador, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "SEG_ROLYPANTALLAROLESWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20184914522717");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.seg_rolypantallaroleswc") +"\">") ;
   ...
   public void renderHtmlCloseForm3C2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("seg_rolypantallaroleswc.js", "?20184914522718");
      }
   ...
   public void wb3C0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.seg_rolypantallaroleswc");
         }
         /* Div Control */
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_SEG_ROLYPANTALLAROLESWC.htm");
   ...
   public void start3C2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "SEG_ROLYPANTALLAROLESWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void pa3C2( )
   {
      if ( nDonePA == 0 )
      {
         ...
         GXCCtl = "TNOV_ESTADO_" + sGXsfl_20_idx ;
         ...
         cmbTNov_Estado.addItem("C", "Confirmada", (short)(0));
         cmbTNov_Estado.addItem("E", "Error", (short)(0));
         if ( cmbTNov_Estado.getItemCount() > 0 )
         {
            A773TNov_Estado = cmbTNov_Estado.getValidValue(A773TNov_Estado) ;
            n773TNov_Estado = false ;
         }
         GXCCtl = "TNOV_INGRESOMASIVO_" + sGXsfl_20_idx ;
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "SEG_ROLYPANTALLAROLESWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf3C2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H003C2 */
         pr_default.execute(0, new Object[] {new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_20_idx = (short)(1) ;
         sGXsfl_20_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_20_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_202( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A106Nove_Identificador = H003C2_A106Nove_Identificador[0] ;
            A813TNov_IngresoMasivo = H003C2_A813TNov_IngresoMasivo[0] ;
            n813TNov_IngresoMasivo = H003C2_n813TNov_IngresoMasivo[0] ;
            A778TNov_FechaModifica = H003C2_A778TNov_FechaModifica[0] ;
            n778TNov_FechaModifica = H003C2_n778TNov_FechaModifica[0] ;
            A777TNov_UsuarioModifica = H003C2_A777TNov_UsuarioModifica[0] ;
            n777TNov_UsuarioModifica = H003C2_n777TNov_UsuarioModifica[0] ;
            A776TNov_FechaCrea = H003C2_A776TNov_FechaCrea[0] ;
            n776TNov_FechaCrea = H003C2_n776TNov_FechaCrea[0] ;
            A775TNov_UsuarioCrea = H003C2_A775TNov_UsuarioCrea[0] ;
            n775TNov_UsuarioCrea = H003C2_n775TNov_UsuarioCrea[0] ;
            A774TNov_Nombre_Campo = H003C2_A774TNov_Nombre_Campo[0] ;
            n774TNov_Nombre_Campo = H003C2_n774TNov_Nombre_Campo[0] ;
            A773TNov_Estado = H003C2_A773TNov_Estado[0] ;
            n773TNov_Estado = H003C2_n773TNov_Estado[0] ;
            A772TNov_Procedimiento = H003C2_A772TNov_Procedimiento[0] ;
            n772TNov_Procedimiento = H003C2_n772TNov_Procedimiento[0] ;
            A771TNov_Nro_Cambios = H003C2_A771TNov_Nro_Cambios[0] ;
            n771TNov_Nro_Cambios = H003C2_n771TNov_Nro_Cambios[0] ;
            A770TNov_Tipo = H003C2_A770TNov_Tipo[0] ;
            n770TNov_Tipo = H003C2_n770TNov_Tipo[0] ;
            A769TNov_Descripcion = H003C2_A769TNov_Descripcion[0] ;
            n769TNov_Descripcion = H003C2_n769TNov_Descripcion[0] ;
            A104TNov_Codigo = H003C2_A104TNov_Codigo[0] ;
            n104TNov_Codigo = H003C2_n104TNov_Codigo[0] ;
            A813TNov_IngresoMasivo = H003C2_A813TNov_IngresoMasivo[0] ;
            n813TNov_IngresoMasivo = H003C2_n813TNov_IngresoMasivo[0] ;
            A778TNov_FechaModifica = H003C2_A778TNov_FechaModifica[0] ;
            n778TNov_FechaModifica = H003C2_n778TNov_FechaModifica[0] ;
   ...
   private void e133C2( )
   {
      ...
      edtavDelete_Link = formatLink("com.orions2.alm_tipo_novedad") + "?" + GXutil.URLEncode(GXutil.rtrim("DLT")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A104TNov_Codigo,6,0))) ;
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "seg_rolypantallaroleswc");
   ...
   public void define_styles( )
   {
      ...
      httpContext.AddThemeStyleSheetFile("", context.getHttpContext().getTheme( )+".css", "?14285086");
      idxLst = 1 ;
      while ( idxLst <= Form.getJscriptsrc().getCount() )
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20184914522768");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("seg_rolypantallaroleswc.js", "?20184914522768");
      }
   ...
   public void subsflControlProps_202( )
   {
      ...
      edtTNov_Nro_Cambios_Internalname = sPrefix+"TNOV_NRO_CAMBIOS_"+sGXsfl_20_idx ;
      edtTNov_Procedimiento_Internalname = sPrefix+"TNOV_PROCEDIMIENTO_"+sGXsfl_20_idx ;
      cmbTNov_Estado.setInternalname( sPrefix+"TNOV_ESTADO_"+sGXsfl_20_idx );
      edtTNov_Nombre_Campo_Internalname = sPrefix+"TNOV_NOMBRE_CAMPO_"+sGXsfl_20_idx ;
      edtTNov_UsuarioCrea_Internalname = sPrefix+"TNOV_USUARIOCREA_"+sGXsfl_20_idx ;
      edtTNov_FechaCrea_Internalname = sPrefix+"TNOV_FECHACREA_"+sGXsfl_20_idx ;
      edtTNov_UsuarioModifica_Internalname = sPrefix+"TNOV_USUARIOMODIFICA_"+sGXsfl_20_idx ;
      edtTNov_FechaModifica_Internalname = sPrefix+"TNOV_FECHAMODIFICA_"+sGXsfl_20_idx ;
      cmbTNov_IngresoMasivo.setInternalname( sPrefix+"TNOV_INGRESOMASIVO_"+sGXsfl_20_idx );
   ...
   public void subsflControlProps_fel_202( )
   {
      ...
      edtTNov_Nro_Cambios_Internalname = sPrefix+"TNOV_NRO_CAMBIOS_"+sGXsfl_20_fel_idx ;
      edtTNov_Procedimiento_Internalname = sPrefix+"TNOV_PROCEDIMIENTO_"+sGXsfl_20_fel_idx ;
      cmbTNov_Estado.setInternalname( sPrefix+"TNOV_ESTADO_"+sGXsfl_20_fel_idx );
      edtTNov_Nombre_Campo_Internalname = sPrefix+"TNOV_NOMBRE_CAMPO_"+sGXsfl_20_fel_idx ;
      edtTNov_UsuarioCrea_Internalname = sPrefix+"TNOV_USUARIOCREA_"+sGXsfl_20_fel_idx ;
      edtTNov_FechaCrea_Internalname = sPrefix+"TNOV_FECHACREA_"+sGXsfl_20_fel_idx ;
      edtTNov_UsuarioModifica_Internalname = sPrefix+"TNOV_USUARIOMODIFICA_"+sGXsfl_20_fel_idx ;
      edtTNov_FechaModifica_Internalname = sPrefix+"TNOV_FECHAMODIFICA_"+sGXsfl_20_fel_idx ;
      cmbTNov_IngresoMasivo.setInternalname( sPrefix+"TNOV_INGRESOMASIVO_"+sGXsfl_20_fel_idx );
   ...
   public void sendrow_202( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTNov_Nro_Cambios_Internalname,GXutil.ltrim( localUtil.ntoc( A771TNov_Nro_Cambios, (byte)(4), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A771TNov_Nro_Cambios), "ZZZ9"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtTNov_Nro_Cambios_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(4),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbTNov_Estado,cmbTNov_Estado.getInternalname(),GXutil.rtrim( A773TNov_Estado),new Integer(1),cmbTNov_Estado.getJsonclick(),new Integer(0),"'"+sPrefix+"'"+",false,"+"'"+""+"'","char","",new Integer(-1),new Integer(0),new Integer(1),new Integer(0),new Integer(0),"px",new Integer(0),"px","","Attribute","WWColumn WWOptionalColumn","","",new Boolean(true)});
         cmbTNov_Estado.setValue( GXutil.rtrim( A773TNov_Estado) );
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbTNov_Estado.getInternalname(), "Values", cmbTNov_Estado.ToJavascriptSource(), !bGXsfl_20_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTNov_UsuarioCrea_Internalname,A775TNov_UsuarioCrea,GXutil.rtrim( localUtil.format( A775TNov_UsuarioCrea, "@!")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtTNov_UsuarioCrea_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTNov_FechaCrea_Internalname,localUtil.ttoc( A776TNov_FechaCrea, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A776TNov_FechaCrea, "99/99/99 99:99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtTNov_FechaCrea_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbTNov_IngresoMasivo.getInternalname(), "Values", cmbTNov_IngresoMasivo.ToJavascriptSource(), !bGXsfl_20_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV12Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV13Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A104TNov_Codigo',fld:'TNOV_CODIGO',pic:'ZZZZZ9',hsh:true,nv:0},{av:'A106Nove_Identificador',fld:'NOVE_IDENTIFICADOR',pic:'ZZZZZZZZZZ9',nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e133C2',iparms:[{av:'A104TNov_Codigo',fld:'TNOV_CODIGO',pic:'ZZZZZ9',hsh:true,nv:0},{av:'A106Nove_Identificador',fld:'NOVE_IDENTIFICADOR',pic:'ZZZZZZZZZZ9',nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtTNov_Descripcion_Link',ctrl:'TNOV_DESCRIPCION',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e113C2',iparms:[{av:'A104TNov_Codigo',fld:'TNOV_CODIGO',pic:'ZZZZZ9',hsh:true,nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H003C2_A106Nove_Identificador = new long[1] ;
      H003C2_A813TNov_IngresoMasivo = new String[] {""} ;
      H003C2_n813TNov_IngresoMasivo = new boolean[] {false} ;
      H003C2_A778TNov_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H003C2_n778TNov_FechaModifica = new boolean[] {false} ;
      H003C2_A777TNov_UsuarioModifica = new String[] {""} ;
      H003C2_n777TNov_UsuarioModifica = new boolean[] {false} ;
      H003C2_A776TNov_FechaCrea = new java.util.Date[] {GXutil.nullDate()} ;
      H003C2_n776TNov_FechaCrea = new boolean[] {false} ;
      H003C2_A775TNov_UsuarioCrea = new String[] {""} ;
      H003C2_n775TNov_UsuarioCrea = new boolean[] {false} ;
      H003C2_A774TNov_Nombre_Campo = new String[] {""} ;
      H003C2_n774TNov_Nombre_Campo = new boolean[] {false} ;
      H003C2_A773TNov_Estado = new String[] {""} ;
      H003C2_n773TNov_Estado = new boolean[] {false} ;
      H003C2_A772TNov_Procedimiento = new String[] {""} ;
      H003C2_n772TNov_Procedimiento = new boolean[] {false} ;
      H003C2_A771TNov_Nro_Cambios = new short[1] ;
      H003C2_n771TNov_Nro_Cambios = new boolean[] {false} ;
      H003C2_A770TNov_Tipo = new String[] {""} ;
      H003C2_n770TNov_Tipo = new boolean[] {false} ;
      H003C2_A769TNov_Descripcion = new String[] {""} ;
      H003C2_n769TNov_Descripcion = new boolean[] {false} ;
      H003C2_A104TNov_Codigo = new int[1] ;
      H003C2_n104TNov_Codigo = new boolean[] {false} ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.seg_rolypantallaroleswc__default(),
         new Object[] {
             new Object[] {
            H003C2_A106Nove_Identificador, H003C2_A813TNov_IngresoMasivo, H003C2_n813TNov_IngresoMasivo, H003C2_A778TNov_FechaModifica, H003C2_n778TNov_FechaModifica, H003C2_A777TNov_UsuarioModifica, H003C2_n777TNov_UsuarioModifica, H003C2_A776TNov_FechaCrea, H003C2_n776TNov_FechaCrea, H003C2_A775TNov_UsuarioCrea,
            H003C2_n775TNov_UsuarioCrea, H003C2_A774TNov_Nombre_Campo, H003C2_n774TNov_Nombre_Campo, H003C2_A773TNov_Estado, H003C2_n773TNov_Estado, H003C2_A772TNov_Procedimiento, H003C2_n772TNov_Procedimiento, H003C2_A771TNov_Nro_Cambios, H003C2_n771TNov_Nro_Cambios, H003C2_A770TNov_Tipo,
            H003C2_n770TNov_Tipo, H003C2_A769TNov_Descripcion, H003C2_n769TNov_Descripcion, H003C2_A104TNov_Codigo, H003C2_n104TNov_Codigo
            }
            , new Object[] {
   ...
   private long[] H003C2_A106Nove_Identificador ;
   private String[] H003C2_A813TNov_IngresoMasivo ;
   private boolean[] H003C2_n813TNov_IngresoMasivo ;
   private java.util.Date[] H003C2_A778TNov_FechaModifica ;
   private boolean[] H003C2_n778TNov_FechaModifica ;
   private String[] H003C2_A777TNov_UsuarioModifica ;
   private boolean[] H003C2_n777TNov_UsuarioModifica ;
   private java.util.Date[] H003C2_A776TNov_FechaCrea ;
   private boolean[] H003C2_n776TNov_FechaCrea ;
   private String[] H003C2_A775TNov_UsuarioCrea ;
   private boolean[] H003C2_n775TNov_UsuarioCrea ;
   private String[] H003C2_A774TNov_Nombre_Campo ;
   private boolean[] H003C2_n774TNov_Nombre_Campo ;
   private String[] H003C2_A773TNov_Estado ;
   private boolean[] H003C2_n773TNov_Estado ;
   private String[] H003C2_A772TNov_Procedimiento ;
   private boolean[] H003C2_n772TNov_Procedimiento ;
   private short[] H003C2_A771TNov_Nro_Cambios ;
   private boolean[] H003C2_n771TNov_Nro_Cambios ;
   private String[] H003C2_A770TNov_Tipo ;
   private boolean[] H003C2_n770TNov_Tipo ;
   private String[] H003C2_A769TNov_Descripcion ;
   private boolean[] H003C2_n769TNov_Descripcion ;
   private int[] H003C2_A104TNov_Codigo ;
   private boolean[] H003C2_n104TNov_Codigo ;
...
final  class seg_rolypantallaroleswc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H003C2", "SELECT T1.Nove_Identificador, T2.TNov_IngresoMasivo, T2.TNov_FechaModifica, T2.TNov_UsuarioModifica, T2.TNov_FechaCrea, T2.TNov_UsuarioCrea, T2.TNov_Nombre_Campo, T2.TNov_Estado, T2.TNov_Procedimiento, T2.TNov_Nro_Cambios, T2.TNov_Tipo, T2.TNov_Descripcion, T1.TNov_Codigo FROM (ALM_NOVEDAD T1 LEFT JOIN ALM_TIPO_NOVEDAD T2 ON T2.TNov_Codigo = T1.TNov_Codigo) ORDER BY T1.Nove_Identificador  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H003C3", "SELECT COUNT(*) FROM (ALM_NOVEDAD T1 LEFT JOIN ALM_TIPO_NOVEDAD T2 ON T2.TNov_Codigo = T1.TNov_Codigo) ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
