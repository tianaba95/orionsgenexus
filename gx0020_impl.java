...
public final  class gx0020_impl extends GXDataArea
{
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
         {
            ...
            AV6cCent_Id = GXutil.lval( httpContext.GetNextPar( )) ;
            AV7cAlma_Modulo = httpContext.GetNextPar( ) ;
            AV8cAlma_Codigo = httpContext.GetNextPar( ) ;
            AV9cAlma_Descripcion = httpContext.GetNextPar( ) ;
            AV10cTpal_Id = GXutil.lval( httpContext.GetNextPar( )) ;
            AV11cAlma_Telefono1 = GXutil.lval( httpContext.GetNextPar( )) ;
            AV12cAlma_Telefono2 = GXutil.lval( httpContext.GetNextPar( )) ;
            httpContext.setAjaxCallMode();
            if ( ! httpContext.IsValidAjaxCall( true) )
            {
               GxWebError = (byte)(1) ;
            ...
            gxgrgrid1_refresh( subGrid1_Rows, AV6cCent_Id, AV7cAlma_Modulo, AV8cAlma_Codigo, AV9cAlma_Descripcion, AV10cTpal_Id, AV11cAlma_Telefono1, AV12cAlma_Telefono2) ;
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV14pAlma_Modulo = httpContext.GetNextPar( ) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV14pAlma_Modulo", AV14pAlma_Modulo);
               AV15pAlma_Codigo = httpContext.GetNextPar( ) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV15pAlma_Codigo", AV15pAlma_Codigo);
            }
         }
         if ( httpContext.isSpaRequest( ) )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20186141424349");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.gx0020") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13pCent_Id,11,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV14pAlma_Modulo)) + "," + GXutil.URLEncode(GXutil.rtrim(AV15pAlma_Codigo))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "GXH_vCCENT_ID", GXutil.ltrim( localUtil.ntoc( AV6cCent_Id, (byte)(11), (byte)(0), ",", "")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "GXH_vCALMA_MODULO", AV7cAlma_Modulo);
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "GXH_vCALMA_CODIGO", AV8cAlma_Codigo);
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "GXH_vCALMA_DESCRIPCION", AV9cAlma_Descripcion);
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "GXH_vCTPAL_ID", GXutil.ltrim( localUtil.ntoc( AV10cTpal_Id, (byte)(11), (byte)(0), ",", "")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "GXH_vCALMA_TELEFONO1", GXutil.ltrim( localUtil.ntoc( AV11cAlma_Telefono1, (byte)(18), (byte)(0), ",", "")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "GXH_vCALMA_TELEFONO2", GXutil.ltrim( localUtil.ntoc( AV12cAlma_Telefono2, (byte)(18), (byte)(0), ",", "")));
      /* Send saved values. */
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vPALMA_MODULO", AV14pAlma_Modulo);
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vPALMA_CODIGO", AV15pAlma_Codigo);
   ...
   {
      return formatLink("com.orions2.gx0020") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13pCent_Id,11,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV14pAlma_Modulo)) + "," + GXutil.URLEncode(GXutil.rtrim(AV15pAlma_Codigo)) ;
   }
   ...
   public void wb830( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblcent_idfilter_Internalname, "Identificador Centro de Costo", "", "", lblLblcent_idfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11831_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0020.htm");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavCcent_id_Internalname, GXutil.ltrim( localUtil.ntoc( AV6cCent_Id, (byte)(11), (byte)(0), ",", "")), ((edtavCcent_id_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV6cCent_Id), "ZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV6cCent_Id), "ZZZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcent_id_Jsonclick, 0, "Attribute", "", "", "", edtavCcent_id_Visible, edtavCcent_id_Enabled, 0, "text", "", 11, "chr", 1, "row", 11, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "HLP_Gx0020.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblalma_modulofilter_Internalname, "Modulo", "", "", lblLblalma_modulofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e12831_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0020.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         /* ComboBox */
         com.orions2.GxWebStd.gx_combobox_ctrl1( httpContext, cmbavCalma_modulo, cmbavCalma_modulo.getInternalname(), GXutil.rtrim( AV7cAlma_Modulo), 1, cmbavCalma_modulo.getJsonclick(), 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", cmbavCalma_modulo.getVisible(), cmbavCalma_modulo.getEnabled(), 0, (short)(0), 0, "em", 0, "", "", "Attribute", "", TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,26);\"", "", true, "HLP_Gx0020.htm");
         cmbavCalma_modulo.setValue( GXutil.rtrim( AV7cAlma_Modulo) );
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblalma_codigofilter_Internalname, "Código Almacén", "", "", lblLblalma_codigofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e13831_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0020.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavCalma_codigo_Internalname, AV8cAlma_Codigo, GXutil.rtrim( localUtil.format( AV8cAlma_Codigo, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCalma_codigo_Jsonclick, 0, "Attribute", "", "", "", edtavCalma_codigo_Visible, edtavCalma_codigo_Enabled, 0, "text", "", 2, "chr", 1, "row", 2, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_Gx0020.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblalma_descripcionfilter_Internalname, "Descripción Almacén", "", "", lblLblalma_descripcionfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e14831_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0020.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavCalma_descripcion_Internalname, AV9cAlma_Descripcion, GXutil.rtrim( localUtil.format( AV9cAlma_Descripcion, "@!")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCalma_descripcion_Jsonclick, 0, "Attribute", "", "", "", edtavCalma_descripcion_Visible, edtavCalma_descripcion_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_Gx0020.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltpal_idfilter_Internalname, "Id Tipo Almacén", "", "", lblLbltpal_idfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e15831_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0020.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavCtpal_id_Internalname, GXutil.ltrim( localUtil.ntoc( AV10cTpal_Id, (byte)(11), (byte)(0), ",", "")), ((edtavCtpal_id_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV10cTpal_Id), "ZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV10cTpal_Id), "ZZZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,56);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCtpal_id_Jsonclick, 0, "Attribute", "", "", "", edtavCtpal_id_Visible, edtavCtpal_id_Enabled, 0, "text", "", 11, "chr", 1, "row", 11, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "HLP_Gx0020.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblalma_telefono1filter_Internalname, "Telefono1", "", "", lblLblalma_telefono1filter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e16831_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0020.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavCalma_telefono1_Internalname, GXutil.ltrim( localUtil.ntoc( AV11cAlma_Telefono1, (byte)(18), (byte)(0), ",", "")), ((edtavCalma_telefono1_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV11cAlma_Telefono1), "ZZZZZZZZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV11cAlma_Telefono1), "ZZZZZZZZZZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCalma_telefono1_Jsonclick, 0, "Attribute", "", "", "", edtavCalma_telefono1_Visible, edtavCalma_telefono1_Enabled, 0, "text", "", 18, "chr", 1, "row", 18, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "HLP_Gx0020.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblalma_telefono2filter_Internalname, "Telefono2", "", "", lblLblalma_telefono2filter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e17831_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0020.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavCalma_telefono2_Internalname, GXutil.ltrim( localUtil.ntoc( AV12cAlma_Telefono2, (byte)(18), (byte)(0), ",", "")), ((edtavCalma_telefono2_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV12cAlma_Telefono2), "ZZZZZZZZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV12cAlma_Telefono2), "ZZZZZZZZZZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,76);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCalma_telefono2_Jsonclick, 0, "Attribute", "", "", "", edtavCalma_telefono2_Visible, edtavCalma_telefono2_Enabled, 0, "text", "", 18, "chr", 1, "row", 18, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "HLP_Gx0020.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 84, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e18831_client"+"'", TempTags, "", 2, "HLP_Gx0020.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      if ( wbEnd == 84 )
      {
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 84, 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Gx0020.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start832( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selection List ALMACÉN", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 4), "LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) )
                        {
                           ...
                           httpContext.ajax_rsp_assign_prop("", false, edtavLinkselection_Internalname, "Bitmap", ((GXutil.strcmp("", AV5LinkSelection)==0) ? AV19Linkselection_GXI : httpContext.convertURL( httpContext.getResourceRelative(AV5LinkSelection))), !bGXsfl_84_Refreshing);
                           ...
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 if ( ! wbErr )
                                 {
                                    ...
                                    if ( localUtil.ctol( httpContext.cgiGet( "GXH_vCCENT_ID"), ",", ".") != AV6cCent_Id )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    /* Set Refresh If Calma_modulo Changed */
                                    if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vCALMA_MODULO"), AV7cAlma_Modulo) != 0 )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    /* Set Refresh If Calma_codigo Changed */
                                    if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vCALMA_CODIGO"), AV8cAlma_Codigo) != 0 )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    /* Set Refresh If Calma_descripcion Changed */
                                    if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vCALMA_DESCRIPCION"), AV9cAlma_Descripcion) != 0 )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    /* Set Refresh If Ctpal_id Changed */
                                    if ( localUtil.ctol( httpContext.cgiGet( "GXH_vCTPAL_ID"), ",", ".") != AV10cTpal_Id )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    /* Set Refresh If Calma_telefono1 Changed */
                                    if ( localUtil.ctol( httpContext.cgiGet( "GXH_vCALMA_TELEFONO1"), ",", ".") != AV11cAlma_Telefono1 )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    /* Set Refresh If Calma_telefono2 Changed */
                                    if ( localUtil.ctol( httpContext.cgiGet( "GXH_vCALMA_TELEFONO2"), ",", ".") != AV12cAlma_Telefono2 )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    if ( ! Rfr0gs )
   ...
   public void pa832( )
   {
      if ( nDonePA == 0 )
      {
         ...
         {
            AV7cAlma_Modulo = cmbavCalma_modulo.getValidValue(AV7cAlma_Modulo) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV7cAlma_Modulo", AV7cAlma_Modulo);
         }
   ...
   public void gxgrgrid1_refresh( int subGrid1_Rows ,
                                  long AV6cCent_Id ,
                                  String AV7cAlma_Modulo ,
                                  String AV8cAlma_Codigo ,
                                  String AV9cAlma_Descripcion ,
                                  long AV10cTpal_Id ,
                                  long AV11cAlma_Telefono1 ,
                                  long AV12cAlma_Telefono2 )
   {
      initialize_formulas( ) ;
      com.orions2.GxWebStd.set_html_headers( httpContext, 0, "", "");
   ...
   public void rf832( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV9cAlma_Descripcion ,
                                              new Long(AV10cTpal_Id) ,
                                              new Long(AV11cAlma_Telefono1) ,
                                              new Long(AV12cAlma_Telefono2) ,
         ...
         lV7cAlma_Modulo = GXutil.concat( GXutil.rtrim( AV7cAlma_Modulo), "%", "") ;
         httpContext.ajax_rsp_assign_attri("", false, "AV7cAlma_Modulo", AV7cAlma_Modulo);
         lV8cAlma_Codigo = GXutil.concat( GXutil.rtrim( AV8cAlma_Codigo), "%", "") ;
         httpContext.ajax_rsp_assign_attri("", false, "AV8cAlma_Codigo", AV8cAlma_Codigo);
         lV9cAlma_Descripcion = GXutil.concat( GXutil.rtrim( AV9cAlma_Descripcion), "%", "") ;
         httpContext.ajax_rsp_assign_attri("", false, "AV9cAlma_Descripcion", AV9cAlma_Descripcion);
         /* Using cursor H00832 */
         pr_default.execute(0, new Object[] {new Long(AV6cCent_Id), lV7cAlma_Modulo, lV8cAlma_Codigo, lV9cAlma_Descripcion, new Long(AV10cTpal_Id), new Long(AV11cAlma_Telefono1), new Long(AV12cAlma_Telefono2), new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_84_idx = (short)(1) ;
         sGXsfl_84_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_84_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_842( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subgrid1_recordsperpage( ) ) ) ) )
         {
            A252Alma_Descripcion = H00832_A252Alma_Descripcion[0] ;
            A262Alma_Fax = H00832_A262Alma_Fax[0] ;
            n262Alma_Fax = H00832_n262Alma_Fax[0] ;
            A261Alma_Telefono2 = H00832_A261Alma_Telefono2[0] ;
            n261Alma_Telefono2 = H00832_n261Alma_Telefono2[0] ;
            A260Alma_Telefono1 = H00832_A260Alma_Telefono1[0] ;
            n260Alma_Telefono1 = H00832_n260Alma_Telefono1[0] ;
            A29Tpal_Id = H00832_A29Tpal_Id[0] ;
            A28Alma_Codigo = H00832_A28Alma_Codigo[0] ;
            A27Alma_Modulo = H00832_A27Alma_Modulo[0] ;
            A1Cent_Id = H00832_A1Cent_Id[0] ;
            /* Execute user event: Load */
            e20832 ();
   ...
   public int subgrid1_recordcount( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV9cAlma_Descripcion", AV9cAlma_Descripcion);
      /* Using cursor H00833 */
      pr_default.execute(1, new Object[] {new Long(AV6cCent_Id), lV7cAlma_Modulo, lV8cAlma_Codigo, lV9cAlma_Descripcion, new Long(AV10cTpal_Id), new Long(AV11cAlma_Telefono1), new Long(AV12cAlma_Telefono2)});
      GRID1_nRecordCount = H00833_AGRID1_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void strup830( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         if ( ( ( localUtil.ctol( httpContext.cgiGet( edtavCcent_id_Internalname), ",", ".") < 0 ) ) || ( ( localUtil.ctol( httpContext.cgiGet( edtavCcent_id_Internalname), ",", ".") > 99999999999L ) ) )
         {
            ...
            wbErr = true ;
            AV6cCent_Id = 0 ;
            httpContext.ajax_rsp_assign_attri("", false, "AV6cCent_Id", GXutil.ltrim( GXutil.str( AV6cCent_Id, 11, 0)));
         }
         else
         {
            AV6cCent_Id = localUtil.ctol( httpContext.cgiGet( edtavCcent_id_Internalname), ",", ".") ;
            httpContext.ajax_rsp_assign_attri("", false, "AV6cCent_Id", GXutil.ltrim( GXutil.str( AV6cCent_Id, 11, 0)));
         }
         ...
         AV7cAlma_Modulo = httpContext.cgiGet( cmbavCalma_modulo.getInternalname()) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV7cAlma_Modulo", AV7cAlma_Modulo);
         AV8cAlma_Codigo = httpContext.cgiGet( edtavCalma_codigo_Internalname) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV8cAlma_Codigo", AV8cAlma_Codigo);
         AV9cAlma_Descripcion = GXutil.upper( httpContext.cgiGet( edtavCalma_descripcion_Internalname)) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV9cAlma_Descripcion", AV9cAlma_Descripcion);
         if ( ( ( localUtil.ctol( httpContext.cgiGet( edtavCtpal_id_Internalname), ",", ".") < 0 ) ) || ( ( localUtil.ctol( httpContext.cgiGet( edtavCtpal_id_Internalname), ",", ".") > 99999999999L ) ) )
         {
            ...
            wbErr = true ;
            AV10cTpal_Id = 0 ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10cTpal_Id", GXutil.ltrim( GXutil.str( AV10cTpal_Id, 11, 0)));
         }
         else
         {
            AV10cTpal_Id = localUtil.ctol( httpContext.cgiGet( edtavCtpal_id_Internalname), ",", ".") ;
            httpContext.ajax_rsp_assign_attri("", false, "AV10cTpal_Id", GXutil.ltrim( GXutil.str( AV10cTpal_Id, 11, 0)));
         }
         if ( ( ( localUtil.ctol( httpContext.cgiGet( edtavCalma_telefono1_Internalname), ",", ".") < 0 ) ) || ( ( localUtil.ctol( httpContext.cgiGet( edtavCalma_telefono1_Internalname), ",", ".") > 999999999999999999L ) ) )
         {
            ...
            httpContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
            wbErr = true ;
            AV11cAlma_Telefono1 = 0 ;
            httpContext.ajax_rsp_assign_attri("", false, "AV11cAlma_Telefono1", GXutil.ltrim( GXutil.str( AV11cAlma_Telefono1, 18, 0)));
         }
         else
         {
            AV11cAlma_Telefono1 = localUtil.ctol( httpContext.cgiGet( edtavCalma_telefono1_Internalname), ",", ".") ;
            httpContext.ajax_rsp_assign_attri("", false, "AV11cAlma_Telefono1", GXutil.ltrim( GXutil.str( AV11cAlma_Telefono1, 18, 0)));
         }
         if ( ( ( localUtil.ctol( httpContext.cgiGet( edtavCalma_telefono2_Internalname), ",", ".") < 0 ) ) || ( ( localUtil.ctol( httpContext.cgiGet( edtavCalma_telefono2_Internalname), ",", ".") > 999999999999999999L ) ) )
         {
            ...
            httpContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
            wbErr = true ;
            AV12cAlma_Telefono2 = 0 ;
            httpContext.ajax_rsp_assign_attri("", false, "AV12cAlma_Telefono2", GXutil.ltrim( GXutil.str( AV12cAlma_Telefono2, 18, 0)));
         }
         else
         {
            AV12cAlma_Telefono2 = localUtil.ctol( httpContext.cgiGet( edtavCalma_telefono2_Internalname), ",", ".") ;
            httpContext.ajax_rsp_assign_attri("", false, "AV12cAlma_Telefono2", GXutil.ltrim( GXutil.str( AV12cAlma_Telefono2, 18, 0)));
         }
         /* Read saved values. */
   ...
   public void e21832( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV13pCent_Id", GXutil.ltrim( GXutil.str( AV13pCent_Id, 11, 0)));
      AV14pAlma_Modulo = A27Alma_Modulo ;
      httpContext.ajax_rsp_assign_attri("", false, "AV14pAlma_Modulo", AV14pAlma_Modulo);
      AV15pAlma_Codigo = A28Alma_Codigo ;
      httpContext.ajax_rsp_assign_attri("", false, "AV15pAlma_Codigo", AV15pAlma_Codigo);
      httpContext.setWebReturnParms(new Object[] {new Long(AV13pCent_Id),AV14pAlma_Modulo,AV15pAlma_Codigo});
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV13pCent_Id", GXutil.ltrim( GXutil.str( AV13pCent_Id, 11, 0)));
      AV14pAlma_Modulo = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV14pAlma_Modulo", AV14pAlma_Modulo);
      AV15pAlma_Codigo = (String)getParm(obj,2) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV15pAlma_Codigo", AV15pAlma_Codigo);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20186141424484");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gx0020.js", "?20186141424484");
   ...
   public void sendrow_842( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_84_idx <= subgrid1_recordsperpage( ) * 1 ) )
      {
         ...
         StyleString = "" ;
         AV5LinkSelection_IsBlob = (boolean)(((GXutil.strcmp("", AV5LinkSelection)==0)&&(GXutil.strcmp("", AV19Linkselection_GXI)==0))||!(GXutil.strcmp("", AV5LinkSelection)==0)) ;
         sImgUrl = ((GXutil.strcmp("", AV5LinkSelection)==0) ? AV19Linkselection_GXI : httpContext.getResourceRelative(AV5LinkSelection)) ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTpal_Id_Internalname,GXutil.ltrim( localUtil.ntoc( A29Tpal_Id, (byte)(11), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A29Tpal_Id), "ZZZZZZZZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTpal_Id_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn OptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(11),new Integer(0),new Integer(0),new Integer(84),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"Identificador","right",new Boolean(false)});
         /* Subfile cell */
         if ( Grid1Container.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtAlma_Telefono1_Internalname,GXutil.ltrim( localUtil.ntoc( A260Alma_Telefono1, (byte)(18), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A260Alma_Telefono1), "ZZZZZZZZZZZZZZZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtAlma_Telefono1_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn OptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(18),new Integer(0),new Integer(0),new Integer(84),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
         /* Subfile cell */
         if ( Grid1Container.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtAlma_Fax_Internalname,GXutil.ltrim( localUtil.ntoc( A262Alma_Fax, (byte)(18), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A262Alma_Fax), "ZZZZZZZZZZZZZZZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtAlma_Fax_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn OptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(18),new Integer(0),new Integer(0),new Integer(84),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Selection List ALMACÉN" );
      subGrid1_Rows = 10 ;
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID1_nFirstRecordOnPage',nv:0},{av:'GRID1_nEOF',nv:0},{av:'subGrid1_Rows',nv:0},{av:'AV6cCent_Id',fld:'vCCENT_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'cmbavCalma_modulo'},{av:'AV7cAlma_Modulo',fld:'vCALMA_MODULO',pic:'',nv:''},{av:'AV8cAlma_Codigo',fld:'vCALMA_CODIGO',pic:'',nv:''},{av:'AV9cAlma_Descripcion',fld:'vCALMA_DESCRIPCION',pic:'@!',nv:''},{av:'AV10cTpal_Id',fld:'vCTPAL_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV11cAlma_Telefono1',fld:'vCALMA_TELEFONO1',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV12cAlma_Telefono2',fld:'vCALMA_TELEFONO2',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0}],oparms:[]}");
      setEventMetadata("'TOGGLE'","{handler:'e18831',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}],oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
      setEventMetadata("LBLCENT_IDFILTER.CLICK","{handler:'e11831',iparms:[{av:'divCent_idfiltercontainer_Class',ctrl:'CENT_IDFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divCent_idfiltercontainer_Class',ctrl:'CENT_IDFILTERCONTAINER',prop:'Class'},{av:'edtavCcent_id_Visible',ctrl:'vCCENT_ID',prop:'Visible'}]}");
      setEventMetadata("LBLALMA_MODULOFILTER.CLICK","{handler:'e12831',iparms:[{av:'divAlma_modulofiltercontainer_Class',ctrl:'ALMA_MODULOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divAlma_modulofiltercontainer_Class',ctrl:'ALMA_MODULOFILTERCONTAINER',prop:'Class'},{av:'cmbavCalma_modulo'}]}");
      setEventMetadata("LBLALMA_CODIGOFILTER.CLICK","{handler:'e13831',iparms:[{av:'divAlma_codigofiltercontainer_Class',ctrl:'ALMA_CODIGOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divAlma_codigofiltercontainer_Class',ctrl:'ALMA_CODIGOFILTERCONTAINER',prop:'Class'},{av:'edtavCalma_codigo_Visible',ctrl:'vCALMA_CODIGO',prop:'Visible'}]}");
      setEventMetadata("LBLALMA_DESCRIPCIONFILTER.CLICK","{handler:'e14831',iparms:[{av:'divAlma_descripcionfiltercontainer_Class',ctrl:'ALMA_DESCRIPCIONFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divAlma_descripcionfiltercontainer_Class',ctrl:'ALMA_DESCRIPCIONFILTERCONTAINER',prop:'Class'},{av:'edtavCalma_descripcion_Visible',ctrl:'vCALMA_DESCRIPCION',prop:'Visible'}]}");
      setEventMetadata("LBLTPAL_IDFILTER.CLICK","{handler:'e15831',iparms:[{av:'divTpal_idfiltercontainer_Class',ctrl:'TPAL_IDFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTpal_idfiltercontainer_Class',ctrl:'TPAL_IDFILTERCONTAINER',prop:'Class'},{av:'edtavCtpal_id_Visible',ctrl:'vCTPAL_ID',prop:'Visible'}]}");
      setEventMetadata("LBLALMA_TELEFONO1FILTER.CLICK","{handler:'e16831',iparms:[{av:'divAlma_telefono1filtercontainer_Class',ctrl:'ALMA_TELEFONO1FILTERCONTAINER',prop:'Class'}],oparms:[{av:'divAlma_telefono1filtercontainer_Class',ctrl:'ALMA_TELEFONO1FILTERCONTAINER',prop:'Class'},{av:'edtavCalma_telefono1_Visible',ctrl:'vCALMA_TELEFONO1',prop:'Visible'}]}");
      setEventMetadata("LBLALMA_TELEFONO2FILTER.CLICK","{handler:'e17831',iparms:[{av:'divAlma_telefono2filtercontainer_Class',ctrl:'ALMA_TELEFONO2FILTERCONTAINER',prop:'Class'}],oparms:[{av:'divAlma_telefono2filtercontainer_Class',ctrl:'ALMA_TELEFONO2FILTERCONTAINER',prop:'Class'},{av:'edtavCalma_telefono2_Visible',ctrl:'vCALMA_TELEFONO2',prop:'Visible'}]}");
      setEventMetadata("ENTER","{handler:'e21832',iparms:[{av:'A1Cent_Id',fld:'CENT_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'cmbAlma_Modulo'},{av:'A27Alma_Modulo',fld:'ALMA_MODULO',pic:'',hsh:true,nv:''},{av:'A28Alma_Codigo',fld:'ALMA_CODIGO',pic:'',hsh:true,nv:''}],oparms:[{av:'AV13pCent_Id',fld:'vPCENT_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV14pAlma_Modulo',fld:'vPALMA_MODULO',pic:'',nv:''},{av:'AV15pAlma_Codigo',fld:'vPALMA_CODIGO',pic:'',nv:''}]}");
      setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage',nv:0},{av:'GRID1_nEOF',nv:0},{av:'subGrid1_Rows',nv:0},{av:'AV6cCent_Id',fld:'vCCENT_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'cmbavCalma_modulo'},{av:'AV7cAlma_Modulo',fld:'vCALMA_MODULO',pic:'',nv:''},{av:'AV8cAlma_Codigo',fld:'vCALMA_CODIGO',pic:'',nv:''},{av:'AV9cAlma_Descripcion',fld:'vCALMA_DESCRIPCION',pic:'@!',nv:''},{av:'AV10cTpal_Id',fld:'vCTPAL_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV11cAlma_Telefono1',fld:'vCALMA_TELEFONO1',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV12cAlma_Telefono2',fld:'vCALMA_TELEFONO2',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0}],oparms:[]}");
      setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage',nv:0},{av:'GRID1_nEOF',nv:0},{av:'subGrid1_Rows',nv:0},{av:'AV6cCent_Id',fld:'vCCENT_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'cmbavCalma_modulo'},{av:'AV7cAlma_Modulo',fld:'vCALMA_MODULO',pic:'',nv:''},{av:'AV8cAlma_Codigo',fld:'vCALMA_CODIGO',pic:'',nv:''},{av:'AV9cAlma_Descripcion',fld:'vCALMA_DESCRIPCION',pic:'@!',nv:''},{av:'AV10cTpal_Id',fld:'vCTPAL_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV11cAlma_Telefono1',fld:'vCALMA_TELEFONO1',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV12cAlma_Telefono2',fld:'vCALMA_TELEFONO2',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0}],oparms:[]}");
      setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage',nv:0},{av:'GRID1_nEOF',nv:0},{av:'subGrid1_Rows',nv:0},{av:'AV6cCent_Id',fld:'vCCENT_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'cmbavCalma_modulo'},{av:'AV7cAlma_Modulo',fld:'vCALMA_MODULO',pic:'',nv:''},{av:'AV8cAlma_Codigo',fld:'vCALMA_CODIGO',pic:'',nv:''},{av:'AV9cAlma_Descripcion',fld:'vCALMA_DESCRIPCION',pic:'@!',nv:''},{av:'AV10cTpal_Id',fld:'vCTPAL_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV11cAlma_Telefono1',fld:'vCALMA_TELEFONO1',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV12cAlma_Telefono2',fld:'vCALMA_TELEFONO2',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0}],oparms:[]}");
      setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage',nv:0},{av:'GRID1_nEOF',nv:0},{av:'subGrid1_Rows',nv:0},{av:'AV6cCent_Id',fld:'vCCENT_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'cmbavCalma_modulo'},{av:'AV7cAlma_Modulo',fld:'vCALMA_MODULO',pic:'',nv:''},{av:'AV8cAlma_Codigo',fld:'vCALMA_CODIGO',pic:'',nv:''},{av:'AV9cAlma_Descripcion',fld:'vCALMA_DESCRIPCION',pic:'@!',nv:''},{av:'AV10cTpal_Id',fld:'vCTPAL_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV11cAlma_Telefono1',fld:'vCALMA_TELEFONO1',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV12cAlma_Telefono2',fld:'vCALMA_TELEFONO2',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0}],oparms:[]}");
   }
   ...
   public void initialize( )
   {
      ...
      lV7cAlma_Modulo = "" ;
      lV8cAlma_Codigo = "" ;
      lV9cAlma_Descripcion = "" ;
      A252Alma_Descripcion = "" ;
      H00832_A252Alma_Descripcion = new String[] {""} ;
      H00832_A262Alma_Fax = new long[1] ;
      H00832_n262Alma_Fax = new boolean[] {false} ;
      H00832_A261Alma_Telefono2 = new long[1] ;
      H00832_n261Alma_Telefono2 = new boolean[] {false} ;
      H00832_A260Alma_Telefono1 = new long[1] ;
      H00832_n260Alma_Telefono1 = new boolean[] {false} ;
      H00832_A29Tpal_Id = new long[1] ;
      H00832_A28Alma_Codigo = new String[] {""} ;
      H00832_A27Alma_Modulo = new String[] {""} ;
      H00832_A1Cent_Id = new long[1] ;
      H00833_AGRID1_nRecordCount = new long[1] ;
      ...
      sImgUrl = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.gx0020__default(),
         new Object[] {
             new Object[] {
            H00832_A252Alma_Descripcion, H00832_A262Alma_Fax, H00832_n262Alma_Fax, H00832_A261Alma_Telefono2, H00832_n261Alma_Telefono2, H00832_A260Alma_Telefono1, H00832_n260Alma_Telefono1, H00832_A29Tpal_Id, H00832_A28Alma_Codigo, H00832_A27Alma_Modulo,
            H00832_A1Cent_Id
            }
            , new Object[] {
            H00833_AGRID1_nRecordCount
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private long AV6cCent_Id ;
   private long AV10cTpal_Id ;
   private long AV11cAlma_Telefono1 ;
   private long AV12cAlma_Telefono2 ;
   ...
   private String AV7cAlma_Modulo ;
   private String AV8cAlma_Codigo ;
   private String AV9cAlma_Descripcion ;
   private String AV14pAlma_Modulo ;
   private String AV15pAlma_Codigo ;
   private String A27Alma_Modulo ;
   private String A28Alma_Codigo ;
   private String AV19Linkselection_GXI ;
   private String lV7cAlma_Modulo ;
   private String lV8cAlma_Codigo ;
   private String lV9cAlma_Descripcion ;
   ...
   private String[] H00832_A252Alma_Descripcion ;
   private long[] H00832_A262Alma_Fax ;
   private boolean[] H00832_n262Alma_Fax ;
   private long[] H00832_A261Alma_Telefono2 ;
   private boolean[] H00832_n261Alma_Telefono2 ;
   private long[] H00832_A260Alma_Telefono1 ;
   private boolean[] H00832_n260Alma_Telefono1 ;
   private long[] H00832_A29Tpal_Id ;
   private String[] H00832_A28Alma_Codigo ;
   private String[] H00832_A27Alma_Modulo ;
   private long[] H00832_A1Cent_Id ;
   private long[] H00833_AGRID1_nRecordCount ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class gx0020__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00832( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          long AV6cCent_Id )
   {
      ...
      String sFromString ;
      String sOrderString ;
      sSelectString = " /*+ FIRST_ROWS(11) */ Alma_Descripcion, Alma_Fax, Alma_Telefono2, Alma_Telefono1," ;
      ...
      if ( ! (GXutil.strcmp("", AV9cAlma_Descripcion)==0) )
      {
   ...
   protected Object[] conditional_H00833( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.internet.HttpContext httpContext ,
                                          String AV9cAlma_Descripcion ,
                                          long AV10cTpal_Id ,
                                         ...
                                         Object [] dynConstraints )
   {
      switch ( cursor )
      {
            ...
            case 1 :
                  return conditional_H00833(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).longValue() , ((Number) dynConstraints[2]).longValue() , ((Number) dynConstraints[3]).longValue() , (String)dynConstraints[4] , ((Number) dynConstraints[5]).longValue() , ((Number) dynConstraints[6]).longValue() , ((Number) dynConstraints[7]).longValue() , (String)dynConstraints[8] , (String)dynConstraints[9] , (String)dynConstraints[10] , (String)dynConstraints[11] , ((Number) dynConstraints[12]).longValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00832", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H00833", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
