/*
               File: seg_rolypantallapantwc_impl
        Description: SEG_ROLYPANTALLAPant WC
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:10:46.78
...
public final  class seg_rolypantallapantwc_impl extends GXWebComponent
{
   public seg_rolypantallapantwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public seg_rolypantallapantwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( seg_rolypantallapantwc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Rol_Id, A18Pant_Id, A16Modu_Id, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "SEG_ROLYPANTALLAPant WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414104680");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.seg_rolypantallapantwc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Rol_Id,11,0)))+"\">") ;
   ...
   public void renderHtmlCloseForm3A2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("seg_rolypantallapantwc.js", "?201861414104682");
      }
   ...
   {
      return "SEG_ROLYPANTALLAPantWC" ;
   }

   public String getPgmdesc( )
   {
      return "SEG_ROLYPANTALLAPant WC" ;
   }
   ...
   public void wb3A0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.seg_rolypantallapantwc");
         }
         /* Div Control */
      ...
      if ( wbEnd == 12 )
      {
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtRol_Id_Internalname, GXutil.ltrim( localUtil.ntoc( A21Rol_Id, (byte)(11), (byte)(0), ",", "")), ((edtRol_Id_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A21Rol_Id), "ZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A21Rol_Id), "ZZZZZZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtRol_Id_Jsonclick, 0, "Attribute", "", "", "", edtRol_Id_Visible, edtRol_Id_Enabled, 0, "text", "", 11, "chr", 1, "row", 11, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Identificador", "right", false, "HLP_SEG_ROLYPANTALLAPantWC.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start3A2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "SEG_ROLYPANTALLAPant WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV15Pgmname = "SEG_ROLYPANTALLAPantWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf3A2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A21Rol_Id = H003A2_A21Rol_Id[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A21Rol_Id", GXutil.ltrim( GXutil.str( A21Rol_Id, 11, 0)));
            A218RolP_FechaModifica = H003A2_A218RolP_FechaModifica[0] ;
            A216RolP_FechaCrea = H003A2_A216RolP_FechaCrea[0] ;
            A217RolP_UsuarioModifica = H003A2_A217RolP_UsuarioModifica[0] ;
            A215RolP_UsuarioCrea = H003A2_A215RolP_UsuarioCrea[0] ;
            A17Modu_Descripcion = H003A2_A17Modu_Descripcion[0] ;
            A16Modu_Id = H003A2_A16Modu_Id[0] ;
            A19Pant_Descripcion = H003A2_A19Pant_Descripcion[0] ;
            A18Pant_Id = H003A2_A18Pant_Id[0] ;
            A16Modu_Id = H003A2_A16Modu_Id[0] ;
            A19Pant_Descripcion = H003A2_A19Pant_Descripcion[0] ;
            A17Modu_Descripcion = H003A2_A17Modu_Descripcion[0] ;
            e123A2 ();
   ...
   public void S112( )
   {
      ...
      AV10TrnContext.setgxTv_SdtTransactionContext_Transactionname( "SEG_ROLYPANTALLA" );
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "seg_rolypantallapantwc");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414104720");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("seg_rolypantallapantwc.js", "?201861414104720");
      }
   ...
   {
      edtPant_Id_Internalname = sPrefix+"PANT_ID_"+sGXsfl_12_idx ;
      edtPant_Descripcion_Internalname = sPrefix+"PANT_DESCRIPCION_"+sGXsfl_12_idx ;
      edtModu_Id_Internalname = sPrefix+"MODU_ID_"+sGXsfl_12_idx ;
      edtModu_Descripcion_Internalname = sPrefix+"MODU_DESCRIPCION_"+sGXsfl_12_idx ;
      edtRolP_UsuarioCrea_Internalname = sPrefix+"ROLP_USUARIOCREA_"+sGXsfl_12_idx ;
      edtRolP_UsuarioModifica_Internalname = sPrefix+"ROLP_USUARIOMODIFICA_"+sGXsfl_12_idx ;
      edtRolP_FechaCrea_Internalname = sPrefix+"ROLP_FECHACREA_"+sGXsfl_12_idx ;
      edtRolP_FechaModifica_Internalname = sPrefix+"ROLP_FECHAMODIFICA_"+sGXsfl_12_idx ;
   }

   public void subsflControlProps_fel_122( )
   {
      edtPant_Id_Internalname = sPrefix+"PANT_ID_"+sGXsfl_12_fel_idx ;
      edtPant_Descripcion_Internalname = sPrefix+"PANT_DESCRIPCION_"+sGXsfl_12_fel_idx ;
      edtModu_Id_Internalname = sPrefix+"MODU_ID_"+sGXsfl_12_fel_idx ;
      edtModu_Descripcion_Internalname = sPrefix+"MODU_DESCRIPCION_"+sGXsfl_12_fel_idx ;
      edtRolP_UsuarioCrea_Internalname = sPrefix+"ROLP_USUARIOCREA_"+sGXsfl_12_fel_idx ;
      edtRolP_UsuarioModifica_Internalname = sPrefix+"ROLP_USUARIOMODIFICA_"+sGXsfl_12_fel_idx ;
      edtRolP_FechaCrea_Internalname = sPrefix+"ROLP_FECHACREA_"+sGXsfl_12_fel_idx ;
      edtRolP_FechaModifica_Internalname = sPrefix+"ROLP_FECHAMODIFICA_"+sGXsfl_12_fel_idx ;
   }
   ...
   public void sendrow_122( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_12_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPant_Id_Internalname,GXutil.ltrim( localUtil.ntoc( A18Pant_Id, (byte)(6), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A18Pant_Id), "ZZZZZ9"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtPant_Id_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(6),new Integer(0),new Integer(0),new Integer(12),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"Codigo","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtModu_Id_Internalname,GXutil.ltrim( localUtil.ntoc( A16Modu_Id, (byte)(11), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A16Modu_Id), "ZZZZZZZZZZ9"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtModu_Id_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(11),new Integer(0),new Integer(0),new Integer(12),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"Identificador","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtModu_Descripcion_Internalname,A17Modu_Descripcion,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'",edtModu_Descripcion_Link,"","","",edtModu_Descripcion_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(12),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRolP_UsuarioCrea_Internalname,A215RolP_UsuarioCrea,GXutil.rtrim( localUtil.format( A215RolP_UsuarioCrea, "@!")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtRolP_UsuarioCrea_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(12),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRolP_UsuarioModifica_Internalname,A217RolP_UsuarioModifica,GXutil.rtrim( localUtil.format( A217RolP_UsuarioModifica, "@!")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtRolP_UsuarioModifica_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(12),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRolP_FechaCrea_Internalname,localUtil.ttoc( A216RolP_FechaCrea, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A216RolP_FechaCrea, "99/99/99 99:99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtRolP_FechaCrea_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(12),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRolP_FechaModifica_Internalname,localUtil.ttoc( A218RolP_FechaModifica, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A218RolP_FechaModifica, "99/99/99 99:99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtRolP_FechaModifica_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(12),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_PANT_ID"+"_"+sGXsfl_12_idx, getSecureSignedToken( sPrefix+sGXsfl_12_idx, localUtil.format( DecimalUtil.doubleToDec(A18Pant_Id), "ZZZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_ROLP_USUARIOCREA"+"_"+sGXsfl_12_idx, getSecureSignedToken( sPrefix+sGXsfl_12_idx, GXutil.rtrim( localUtil.format( A215RolP_UsuarioCrea, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_ROLP_USUARIOMODIFICA"+"_"+sGXsfl_12_idx, getSecureSignedToken( sPrefix+sGXsfl_12_idx, GXutil.rtrim( localUtil.format( A217RolP_UsuarioModifica, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_ROLP_FECHACREA"+"_"+sGXsfl_12_idx, getSecureSignedToken( sPrefix+sGXsfl_12_idx, localUtil.format( A216RolP_FechaCrea, "99/99/99 99:99")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_ROLP_FECHAMODIFICA"+"_"+sGXsfl_12_idx, getSecureSignedToken( sPrefix+sGXsfl_12_idx, localUtil.format( A218RolP_FechaModifica, "99/99/99 99:99")));
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Rol_Id',fld:'vROL_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'A18Pant_Id',fld:'PANT_ID',pic:'ZZZZZ9',hsh:true,nv:0},{av:'A16Modu_Id',fld:'MODU_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e123A2',iparms:[{av:'A18Pant_Id',fld:'PANT_ID',pic:'ZZZZZ9',hsh:true,nv:0},{av:'A16Modu_Id',fld:'MODU_ID',pic:'ZZZZZZZZZZ9',nv:0}],oparms:[{av:'edtPant_Descripcion_Link',ctrl:'PANT_DESCRIPCION',prop:'Link'},{av:'edtModu_Descripcion_Link',ctrl:'MODU_DESCRIPCION',prop:'Link'}]}");
      setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Rol_Id',fld:'vROL_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'A18Pant_Id',fld:'PANT_ID',pic:'ZZZZZ9',hsh:true,nv:0},{av:'A16Modu_Id',fld:'MODU_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Rol_Id',fld:'vROL_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'A18Pant_Id',fld:'PANT_ID',pic:'ZZZZZ9',hsh:true,nv:0},{av:'A16Modu_Id',fld:'MODU_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Rol_Id',fld:'vROL_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'A18Pant_Id',fld:'PANT_ID',pic:'ZZZZZ9',hsh:true,nv:0},{av:'A16Modu_Id',fld:'MODU_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Rol_Id',fld:'vROL_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'A18Pant_Id',fld:'PANT_ID',pic:'ZZZZZ9',hsh:true,nv:0},{av:'A16Modu_Id',fld:'MODU_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
   }
   ...
   public void initialize( )
   {
      ...
      AV15Pgmname = "" ;
      scmdbuf = "" ;
      H003A2_A21Rol_Id = new long[1] ;
      H003A2_A218RolP_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H003A2_A216RolP_FechaCrea = new java.util.Date[] {GXutil.nullDate()} ;
      H003A2_A217RolP_UsuarioModifica = new String[] {""} ;
      H003A2_A215RolP_UsuarioCrea = new String[] {""} ;
      H003A2_A17Modu_Descripcion = new String[] {""} ;
      H003A2_A16Modu_Id = new long[1] ;
      H003A2_A19Pant_Descripcion = new String[] {""} ;
      H003A2_A18Pant_Id = new int[1] ;
      ...
      sCtrlAV7Rol_Id = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.seg_rolypantallapantwc__default(),
         new Object[] {
             new Object[] {
            H003A2_A21Rol_Id, H003A2_A218RolP_FechaModifica, H003A2_A216RolP_FechaCrea, H003A2_A217RolP_UsuarioModifica, H003A2_A215RolP_UsuarioCrea, H003A2_A17Modu_Descripcion, H003A2_A16Modu_Id, H003A2_A19Pant_Descripcion, H003A2_A18Pant_Id
            }
            , new Object[] {
   ...
   private long[] H003A2_A21Rol_Id ;
   private java.util.Date[] H003A2_A218RolP_FechaModifica ;
   private java.util.Date[] H003A2_A216RolP_FechaCrea ;
   private String[] H003A2_A217RolP_UsuarioModifica ;
   private String[] H003A2_A215RolP_UsuarioCrea ;
   private String[] H003A2_A17Modu_Descripcion ;
   private long[] H003A2_A16Modu_Id ;
   private String[] H003A2_A19Pant_Descripcion ;
   private int[] H003A2_A18Pant_Id ;
...
final  class seg_rolypantallapantwc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H003A2", "SELECT T1.Rol_Id, T1.RolP_FechaModifica, T1.RolP_FechaCrea, T1.RolP_UsuarioModifica, T1.RolP_UsuarioCrea, T3.Modu_Descripcion, T2.Modu_Id, T2.Pant_Descripcion, T1.Pant_Id FROM ((SEG_ROL_PANTALLA T1 INNER JOIN SEG_PANTALLA T2 ON T2.Pant_Id = T1.Pant_Id) INNER JOIN SEG_MODULO_MENU T3 ON T3.Modu_Id = T2.Modu_Id) WHERE T1.Rol_Id = ? ORDER BY T1.Rol_Id  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H003A3", "SELECT COUNT(*) FROM ((SEG_ROL_PANTALLA T1 INNER JOIN SEG_PANTALLA T2 ON T2.Pant_Id = T1.Pant_Id) INNER JOIN SEG_MODULO_MENU T3 ON T3.Modu_Id = T2.Modu_Id) WHERE T1.Rol_Id = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
