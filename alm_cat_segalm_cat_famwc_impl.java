/*
               File: alm_cat_segalm_cat_famwc_impl
        Description: ALM_CAT_SEGALM_CAT_FAMWC
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:17:20.33
...
public final  class alm_cat_segalm_cat_famwc_impl extends GXWebComponent
{
   public alm_cat_segalm_cat_famwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public alm_cat_segalm_cat_famwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( alm_cat_segalm_cat_famwc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV7SEG_Codigo = httpContext.GetNextPar( ) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7SEG_Codigo", AV7SEG_Codigo);
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,AV7SEG_Codigo});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7SEG_Codigo, AV12Update, AV13Delete, A35FAM_Codigo, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "ALM_CAT_SEGALM_CAT_FAMWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414172038");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.alm_cat_segalm_cat_famwc") + "?" + GXutil.URLEncode(GXutil.rtrim(AV7SEG_Codigo))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV7SEG_Codigo", wcpOAV7SEG_Codigo);
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vSEG_CODIGO", AV7SEG_Codigo);
   ...
   public void renderHtmlCloseForm5F2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("alm_cat_segalm_cat_famwc.js", "?201861414172040");
      }
   ...
   {
      return "ALM_CAT_SEGALM_CAT_FAMWC" ;
   }
   ...
   public void wb5F0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.alm_cat_segalm_cat_famwc");
         }
         /* Div Control */
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_ALM_CAT_SEGALM_CAT_FAMWC.htm");
      ...
      if ( wbEnd == 20 )
      {
         ...
         com.orions2.GxWebStd.gx_label_element( httpContext, edtSEG_Codigo_Internalname, "Segmento Codigo", "col-sm-3 AttributeLabel", 0, true);
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtSEG_Codigo_Internalname, A75SEG_Codigo, GXutil.rtrim( localUtil.format( A75SEG_Codigo, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSEG_Codigo_Jsonclick, 0, "Attribute", "", "", "", edtSEG_Codigo_Visible, edtSEG_Codigo_Enabled, 0, "text", "", 3, "chr", 1, "row", 3, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_ALM_CAT_SEGALM_CAT_FAMWC.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start5F2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "ALM_CAT_SEGALM_CAT_FAMWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"FAM_CODIGO", A35FAM_Codigo);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"FAM_USUARIOCREACION", A448FAM_UsuarioCreacion);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"FAM_FECHACREACION", localUtil.ttoc( A449FAM_FechaCreacion, 10, 8, 0, 3, "/", ":", " "));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"FAM_USUARIOMODIFICA", A450FAM_UsuarioModifica);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"FAM_FECHAMODIFICA", localUtil.ttoc( A451FAM_FechaModifica, 10, 8, 0, 3, "/", ":", " "));
   }
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "ALM_CAT_SEGALM_CAT_FAMWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf5F2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H005F2 */
         pr_default.execute(0, new Object[] {AV7SEG_Codigo, new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_20_idx = (short)(1) ;
         sGXsfl_20_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_20_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_202( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A75SEG_Codigo = H005F2_A75SEG_Codigo[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A75SEG_Codigo", A75SEG_Codigo);
            A451FAM_FechaModifica = H005F2_A451FAM_FechaModifica[0] ;
            A450FAM_UsuarioModifica = H005F2_A450FAM_UsuarioModifica[0] ;
            A449FAM_FechaCreacion = H005F2_A449FAM_FechaCreacion[0] ;
            A448FAM_UsuarioCreacion = H005F2_A448FAM_UsuarioCreacion[0] ;
            A447FAM_Descripcion = H005F2_A447FAM_Descripcion[0] ;
            A35FAM_Codigo = H005F2_A35FAM_Codigo[0] ;
            e135F2 ();
   ...
   {
      /* Using cursor H005F3 */
      pr_default.execute(1, new Object[] {AV7SEG_Codigo});
   ...
   public void strup5F0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV7SEG_Codigo = httpContext.cgiGet( sPrefix+"wcpOAV7SEG_Codigo") ;
   ...
   public void e125F2( )
   {
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext, !bGXsfl_20_Refreshing);
      edtSEG_Codigo_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtSEG_Codigo_Internalname, "Visible", GXutil.ltrim( GXutil.str( edtSEG_Codigo_Visible, 5, 0)), true);
   ...
   public void S112( )
   {
      ...
      AV10TrnContext.setgxTv_SdtTransactionContext_Transactionname( "ALM_CAT_FAM" );
      ...
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributename( "SEG_Codigo" );
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( AV7SEG_Codigo );
   ...
   {
      AV7SEG_Codigo = (String)getParm(obj,0,TypeConstants.STRING) ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7SEG_Codigo", AV7SEG_Codigo);
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV7SEG_Codigo = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "alm_cat_segalm_cat_famwc");
      ...
      {
         AV7SEG_Codigo = (String)getParm(obj,2,TypeConstants.STRING) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7SEG_Codigo", AV7SEG_Codigo);
      }
      wcpOAV7SEG_Codigo = httpContext.cgiGet( sPrefix+"wcpOAV7SEG_Codigo") ;
      if ( ! GetJustCreated( ) && ( ( GXutil.strcmp(AV7SEG_Codigo, wcpOAV7SEG_Codigo) != 0 ) ) )
      {
         setjustcreated();
      }
      wcpOAV7SEG_Codigo = AV7SEG_Codigo ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV7SEG_Codigo = httpContext.cgiGet( sPrefix+"AV7SEG_Codigo_CTRL") ;
      if ( GXutil.len( sCtrlAV7SEG_Codigo) > 0 )
      {
         AV7SEG_Codigo = httpContext.cgiGet( sCtrlAV7SEG_Codigo) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7SEG_Codigo", AV7SEG_Codigo);
      }
      else
      {
         AV7SEG_Codigo = httpContext.cgiGet( sPrefix+"AV7SEG_Codigo_PARM") ;
      }
   }
   ...
   {
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7SEG_Codigo_PARM", AV7SEG_Codigo);
      if ( GXutil.len( GXutil.rtrim( sCtrlAV7SEG_Codigo)) > 0 )
      {
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7SEG_Codigo_CTRL", GXutil.rtrim( sCtrlAV7SEG_Codigo));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414172081");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("alm_cat_segalm_cat_famwc.js", "?201861414172081");
      }
   ...
   public void subsflControlProps_202( )
   {
      ...
      edtFAM_UsuarioCreacion_Internalname = sPrefix+"FAM_USUARIOCREACION_"+sGXsfl_20_idx ;
      edtFAM_FechaCreacion_Internalname = sPrefix+"FAM_FECHACREACION_"+sGXsfl_20_idx ;
      edtFAM_UsuarioModifica_Internalname = sPrefix+"FAM_USUARIOMODIFICA_"+sGXsfl_20_idx ;
      edtFAM_FechaModifica_Internalname = sPrefix+"FAM_FECHAMODIFICA_"+sGXsfl_20_idx ;
   ...
   public void subsflControlProps_fel_202( )
   {
      ...
      edtFAM_UsuarioCreacion_Internalname = sPrefix+"FAM_USUARIOCREACION_"+sGXsfl_20_fel_idx ;
      edtFAM_FechaCreacion_Internalname = sPrefix+"FAM_FECHACREACION_"+sGXsfl_20_fel_idx ;
      edtFAM_UsuarioModifica_Internalname = sPrefix+"FAM_USUARIOMODIFICA_"+sGXsfl_20_fel_idx ;
      edtFAM_FechaModifica_Internalname = sPrefix+"FAM_FECHAMODIFICA_"+sGXsfl_20_fel_idx ;
   ...
   public void sendrow_202( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtFAM_Descripcion_Internalname,A447FAM_Descripcion,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'",edtFAM_Descripcion_Link,"","","",edtFAM_Descripcion_Jsonclick,new Integer(0),"DescriptionAttribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(70),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtFAM_FechaCreacion_Internalname,localUtil.ttoc( A449FAM_FechaCreacion, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A449FAM_FechaCreacion, "99/99/99 99:99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtFAM_FechaCreacion_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtFAM_UsuarioModifica_Internalname,A450FAM_UsuarioModifica,GXutil.rtrim( localUtil.format( A450FAM_UsuarioModifica, "@!")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtFAM_UsuarioModifica_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtFAM_FechaModifica_Internalname,localUtil.ttoc( A451FAM_FechaModifica, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A451FAM_FechaModifica, "99/99/99 99:99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtFAM_FechaModifica_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_FAM_CODIGO"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A35FAM_Codigo, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_FAM_USUARIOCREACION"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A448FAM_UsuarioCreacion, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_FAM_FECHACREACION"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, localUtil.format( A449FAM_FechaCreacion, "99/99/99 99:99")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_FAM_USUARIOMODIFICA"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A450FAM_UsuarioModifica, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_FAM_FECHAMODIFICA"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, localUtil.format( A451FAM_FechaModifica, "99/99/99 99:99")));
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7SEG_Codigo',fld:'vSEG_CODIGO',pic:'',nv:''},{av:'AV12Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV13Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A35FAM_Codigo',fld:'FAM_CODIGO',pic:'',hsh:true,nv:''},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e135F2',iparms:[{av:'A35FAM_Codigo',fld:'FAM_CODIGO',pic:'',hsh:true,nv:''}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtFAM_Descripcion_Link',ctrl:'FAM_DESCRIPCION',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e115F2',iparms:[{av:'A35FAM_Codigo',fld:'FAM_CODIGO',pic:'',hsh:true,nv:''}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H005F2_A75SEG_Codigo = new String[] {""} ;
      H005F2_A451FAM_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H005F2_A450FAM_UsuarioModifica = new String[] {""} ;
      H005F2_A449FAM_FechaCreacion = new java.util.Date[] {GXutil.nullDate()} ;
      H005F2_A448FAM_UsuarioCreacion = new String[] {""} ;
      H005F2_A447FAM_Descripcion = new String[] {""} ;
      H005F2_A35FAM_Codigo = new String[] {""} ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.alm_cat_segalm_cat_famwc__default(),
         new Object[] {
             new Object[] {
            H005F2_A75SEG_Codigo, H005F2_A451FAM_FechaModifica, H005F2_A450FAM_UsuarioModifica, H005F2_A449FAM_FechaCreacion, H005F2_A448FAM_UsuarioCreacion, H005F2_A447FAM_Descripcion, H005F2_A35FAM_Codigo
            }
            , new Object[] {
   ...
   private int edtSEG_Codigo_Visible ;
   ...
   private String sCtrlAV7SEG_Codigo ;
   ...
   private String wcpOAV7SEG_Codigo ;
   ...
   private String[] H005F2_A75SEG_Codigo ;
   private java.util.Date[] H005F2_A451FAM_FechaModifica ;
   private String[] H005F2_A450FAM_UsuarioModifica ;
   private java.util.Date[] H005F2_A449FAM_FechaCreacion ;
   private String[] H005F2_A448FAM_UsuarioCreacion ;
   private String[] H005F2_A447FAM_Descripcion ;
   private String[] H005F2_A35FAM_Codigo ;
...
final  class alm_cat_segalm_cat_famwc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H005F2", "SELECT SEG_Codigo, FAM_FechaModifica, FAM_UsuarioModifica, FAM_FechaCreacion, FAM_UsuarioCreacion, FAM_Descripcion, FAM_Codigo FROM ALM_CAT_FAM WHERE SEG_Codigo = ? ORDER BY SEG_Codigo  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H005F3", "SELECT COUNT(*) FROM ALM_CAT_FAM WHERE SEG_Codigo = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
