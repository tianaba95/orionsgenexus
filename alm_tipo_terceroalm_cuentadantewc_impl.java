/*
               File: alm_tipo_terceroalm_cuentadantewc_impl
        Description: ALM_TIPO_TERCEROALM_CUENTADANTEWC
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:10:38.34
...
public final  class alm_tipo_terceroalm_cuentadantewc_impl extends GXWebComponent
{
   public alm_tipo_terceroalm_cuentadantewc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public alm_tipo_terceroalm_cuentadantewc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( alm_tipo_terceroalm_cuentadantewc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Tpte_Codigo, A5Ciud_Codigo, A6Dept_Codigo, A1Cent_Id, A2Regi_Id, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "ALM_TIPO_TERCEROALM_CUENTADANTEWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414103840");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.alm_tipo_terceroalm_cuentadantewc") + "?" + GXutil.URLEncode(GXutil.rtrim(AV7Tpte_Codigo))+"\">") ;
   ...
   public void renderHtmlCloseForm512( )
   {
      ...
      {
         httpContext.AddJavascriptSource("alm_tipo_terceroalm_cuentadantewc.js", "?201861414103842");
      }
   ...
   {
      return "ALM_TIPO_TERCEROALM_CUENTADANTEWC" ;
   }
   ...
   public void wb510( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.alm_tipo_terceroalm_cuentadantewc");
         }
         /* Div Control */
   ...
   public void start512( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "ALM_TIPO_TERCEROALM_CUENTADANTEWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "ALM_TIPO_TERCEROALM_CUENTADANTEWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf512( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A42Tpte_Codigo = H00512_A42Tpte_Codigo[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A42Tpte_Codigo", A42Tpte_Codigo);
            A12Regi_Cod = H00512_A12Regi_Cod[0] ;
            A13Regi_Descripcion = H00512_A13Regi_Descripcion[0] ;
            A2Regi_Id = H00512_A2Regi_Id[0] ;
            A4Cent_Descripcion = H00512_A4Cent_Descripcion[0] ;
            A3Cent_Codigo = H00512_A3Cent_Codigo[0] ;
            A1Cent_Id = H00512_A1Cent_Id[0] ;
            A688Cuen_Cedula = H00512_A688Cuen_Cedula[0] ;
            A340Cuen_FechaModifica = H00512_A340Cuen_FechaModifica[0] ;
            n340Cuen_FechaModifica = H00512_n340Cuen_FechaModifica[0] ;
            A339Cuen_UsuarioModifica = H00512_A339Cuen_UsuarioModifica[0] ;
            n339Cuen_UsuarioModifica = H00512_n339Cuen_UsuarioModifica[0] ;
            A338Cuen_FechaCrea = H00512_A338Cuen_FechaCrea[0] ;
            A337Cuen_UsuarioCrea = H00512_A337Cuen_UsuarioCrea[0] ;
            A10Dept_Descripcion = H00512_A10Dept_Descripcion[0] ;
            A6Dept_Codigo = H00512_A6Dept_Codigo[0] ;
            A7Ciud_Descripcion = H00512_A7Ciud_Descripcion[0] ;
            A5Ciud_Codigo = H00512_A5Ciud_Codigo[0] ;
            A336Cuen_Email = H00512_A336Cuen_Email[0] ;
            n336Cuen_Email = H00512_n336Cuen_Email[0] ;
            A335Cuen_Telefono = H00512_A335Cuen_Telefono[0] ;
            n335Cuen_Telefono = H00512_n335Cuen_Telefono[0] ;
            A334Cuen_Direccion = H00512_A334Cuen_Direccion[0] ;
            n334Cuen_Direccion = H00512_n334Cuen_Direccion[0] ;
            A333Cuen_Estado = H00512_A333Cuen_Estado[0] ;
            n333Cuen_Estado = H00512_n333Cuen_Estado[0] ;
            A328Cuen_Clase = H00512_A328Cuen_Clase[0] ;
            n328Cuen_Clase = H00512_n328Cuen_Clase[0] ;
            A332Cuen_SegundoNombre = H00512_A332Cuen_SegundoNombre[0] ;
            n332Cuen_SegundoNombre = H00512_n332Cuen_SegundoNombre[0] ;
            A331Cuen_PrimerNombre = H00512_A331Cuen_PrimerNombre[0] ;
            n331Cuen_PrimerNombre = H00512_n331Cuen_PrimerNombre[0] ;
            A330Cuen_SegundoApellido = H00512_A330Cuen_SegundoApellido[0] ;
            n330Cuen_SegundoApellido = H00512_n330Cuen_SegundoApellido[0] ;
            A329Cuen_PrimerApellido = H00512_A329Cuen_PrimerApellido[0] ;
            n329Cuen_PrimerApellido = H00512_n329Cuen_PrimerApellido[0] ;
            A44Cuen_Nombre = H00512_A44Cuen_Nombre[0] ;
            n44Cuen_Nombre = H00512_n44Cuen_Nombre[0] ;
            A326Cuen_DigitoVerificacion = H00512_A326Cuen_DigitoVerificacion[0] ;
            n326Cuen_DigitoVerificacion = H00512_n326Cuen_DigitoVerificacion[0] ;
            A43Cuen_Identificacion = H00512_A43Cuen_Identificacion[0] ;
            A12Regi_Cod = H00512_A12Regi_Cod[0] ;
            A13Regi_Descripcion = H00512_A13Regi_Descripcion[0] ;
            A5Ciud_Codigo = H00512_A5Ciud_Codigo[0] ;
            A6Dept_Codigo = H00512_A6Dept_Codigo[0] ;
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "alm_tipo_terceroalm_cuentadantewc");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414103930");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("alm_tipo_terceroalm_cuentadantewc.js", "?201861414103930");
      }
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H00512_A42Tpte_Codigo = new String[] {""} ;
      H00512_A12Regi_Cod = new short[1] ;
      H00512_A13Regi_Descripcion = new String[] {""} ;
      H00512_A2Regi_Id = new long[1] ;
      H00512_A4Cent_Descripcion = new String[] {""} ;
      H00512_A3Cent_Codigo = new String[] {""} ;
      H00512_A1Cent_Id = new long[1] ;
      H00512_A688Cuen_Cedula = new long[1] ;
      H00512_A340Cuen_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H00512_n340Cuen_FechaModifica = new boolean[] {false} ;
      H00512_A339Cuen_UsuarioModifica = new String[] {""} ;
      H00512_n339Cuen_UsuarioModifica = new boolean[] {false} ;
      H00512_A338Cuen_FechaCrea = new java.util.Date[] {GXutil.nullDate()} ;
      H00512_A337Cuen_UsuarioCrea = new String[] {""} ;
      H00512_A10Dept_Descripcion = new String[] {""} ;
      H00512_A6Dept_Codigo = new short[1] ;
      H00512_A7Ciud_Descripcion = new String[] {""} ;
      H00512_A5Ciud_Codigo = new short[1] ;
      H00512_A336Cuen_Email = new String[] {""} ;
      H00512_n336Cuen_Email = new boolean[] {false} ;
      H00512_A335Cuen_Telefono = new String[] {""} ;
      H00512_n335Cuen_Telefono = new boolean[] {false} ;
      H00512_A334Cuen_Direccion = new String[] {""} ;
      H00512_n334Cuen_Direccion = new boolean[] {false} ;
      H00512_A333Cuen_Estado = new String[] {""} ;
      H00512_n333Cuen_Estado = new boolean[] {false} ;
      H00512_A328Cuen_Clase = new String[] {""} ;
      H00512_n328Cuen_Clase = new boolean[] {false} ;
      H00512_A332Cuen_SegundoNombre = new String[] {""} ;
      H00512_n332Cuen_SegundoNombre = new boolean[] {false} ;
      H00512_A331Cuen_PrimerNombre = new String[] {""} ;
      H00512_n331Cuen_PrimerNombre = new boolean[] {false} ;
      H00512_A330Cuen_SegundoApellido = new String[] {""} ;
      H00512_n330Cuen_SegundoApellido = new boolean[] {false} ;
      H00512_A329Cuen_PrimerApellido = new String[] {""} ;
      H00512_n329Cuen_PrimerApellido = new boolean[] {false} ;
      H00512_A44Cuen_Nombre = new String[] {""} ;
      H00512_n44Cuen_Nombre = new boolean[] {false} ;
      H00512_A326Cuen_DigitoVerificacion = new byte[1] ;
      H00512_n326Cuen_DigitoVerificacion = new boolean[] {false} ;
      H00512_A43Cuen_Identificacion = new long[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.alm_tipo_terceroalm_cuentadantewc__default(),
         new Object[] {
             new Object[] {
            H00512_A42Tpte_Codigo, H00512_A12Regi_Cod, H00512_A13Regi_Descripcion, H00512_A2Regi_Id, H00512_A4Cent_Descripcion, H00512_A3Cent_Codigo, H00512_A1Cent_Id, H00512_A688Cuen_Cedula, H00512_A340Cuen_FechaModifica, H00512_n340Cuen_FechaModifica,
            H00512_A339Cuen_UsuarioModifica, H00512_n339Cuen_UsuarioModifica, H00512_A338Cuen_FechaCrea, H00512_A337Cuen_UsuarioCrea, H00512_A10Dept_Descripcion, H00512_A6Dept_Codigo, H00512_A7Ciud_Descripcion, H00512_A5Ciud_Codigo, H00512_A336Cuen_Email, H00512_n336Cuen_Email,
            H00512_A335Cuen_Telefono, H00512_n335Cuen_Telefono, H00512_A334Cuen_Direccion, H00512_n334Cuen_Direccion, H00512_A333Cuen_Estado, H00512_n333Cuen_Estado, H00512_A328Cuen_Clase, H00512_n328Cuen_Clase, H00512_A332Cuen_SegundoNombre, H00512_n332Cuen_SegundoNombre,
            H00512_A331Cuen_PrimerNombre, H00512_n331Cuen_PrimerNombre, H00512_A330Cuen_SegundoApellido, H00512_n330Cuen_SegundoApellido, H00512_A329Cuen_PrimerApellido, H00512_n329Cuen_PrimerApellido, H00512_A44Cuen_Nombre, H00512_n44Cuen_Nombre, H00512_A326Cuen_DigitoVerificacion, H00512_n326Cuen_DigitoVerificacion,
            H00512_A43Cuen_Identificacion
            }
            , new Object[] {
   ...
   private String[] H00512_A42Tpte_Codigo ;
   private short[] H00512_A12Regi_Cod ;
   private String[] H00512_A13Regi_Descripcion ;
   private long[] H00512_A2Regi_Id ;
   private String[] H00512_A4Cent_Descripcion ;
   private String[] H00512_A3Cent_Codigo ;
   private long[] H00512_A1Cent_Id ;
   private long[] H00512_A688Cuen_Cedula ;
   private java.util.Date[] H00512_A340Cuen_FechaModifica ;
   private boolean[] H00512_n340Cuen_FechaModifica ;
   private String[] H00512_A339Cuen_UsuarioModifica ;
   private boolean[] H00512_n339Cuen_UsuarioModifica ;
   private java.util.Date[] H00512_A338Cuen_FechaCrea ;
   private String[] H00512_A337Cuen_UsuarioCrea ;
   private String[] H00512_A10Dept_Descripcion ;
   private short[] H00512_A6Dept_Codigo ;
   private String[] H00512_A7Ciud_Descripcion ;
   private short[] H00512_A5Ciud_Codigo ;
   private String[] H00512_A336Cuen_Email ;
   private boolean[] H00512_n336Cuen_Email ;
   private String[] H00512_A335Cuen_Telefono ;
   private boolean[] H00512_n335Cuen_Telefono ;
   private String[] H00512_A334Cuen_Direccion ;
   private boolean[] H00512_n334Cuen_Direccion ;
   private String[] H00512_A333Cuen_Estado ;
   private boolean[] H00512_n333Cuen_Estado ;
   private String[] H00512_A328Cuen_Clase ;
   private boolean[] H00512_n328Cuen_Clase ;
   private String[] H00512_A332Cuen_SegundoNombre ;
   private boolean[] H00512_n332Cuen_SegundoNombre ;
   private String[] H00512_A331Cuen_PrimerNombre ;
   private boolean[] H00512_n331Cuen_PrimerNombre ;
   private String[] H00512_A330Cuen_SegundoApellido ;
   private boolean[] H00512_n330Cuen_SegundoApellido ;
   private String[] H00512_A329Cuen_PrimerApellido ;
   private boolean[] H00512_n329Cuen_PrimerApellido ;
   private String[] H00512_A44Cuen_Nombre ;
   private boolean[] H00512_n44Cuen_Nombre ;
   private byte[] H00512_A326Cuen_DigitoVerificacion ;
   private boolean[] H00512_n326Cuen_DigitoVerificacion ;
   private long[] H00512_A43Cuen_Identificacion ;
   private long[] H00513_AGRID_nRecordCount ;
}

final  class alm_tipo_terceroalm_cuentadantewc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00512", "SELECT T1.Tpte_Codigo, T2.Regi_Cod, T2.Regi_Descripcion, T1.Regi_Id, T5.Cent_Descripcion, T5.Cent_Codigo, T1.Cent_Id, T1.Cuen_Cedula, T1.Cuen_FechaModifica, T1.Cuen_UsuarioModifica, T1.Cuen_FechaCrea, T1.Cuen_UsuarioCrea, T4.Dept_Descripcion, T3.Dept_Codigo, T3.Ciud_Descripcion, T2.Ciud_Codigo, T1.Cuen_Email, T1.Cuen_Telefono, T1.Cuen_Direccion, T1.Cuen_Estado, T1.Cuen_Clase, T1.Cuen_SegundoNombre, T1.Cuen_PrimerNombre, T1.Cuen_SegundoApellido, T1.Cuen_PrimerApellido, T1.Cuen_Nombre, T1.Cuen_DigitoVerificacion, T1.Cuen_Identificacion FROM ((((ALM_CUENTADANTE T1 INNER JOIN GEN_REGIONAL T2 ON T2.Regi_Id = T1.Regi_Id) INNER JOIN GEN_CIUDAD T3 ON T3.Ciud_Codigo = T2.Ciud_Codigo) INNER JOIN GEN_DEPARTAMENTO T4 ON T4.Dept_Codigo = T3.Dept_Codigo) INNER JOIN GEN_CENTROCOSTO T5 ON T5.Cent_Id = T1.Cent_Id) WHERE T1.Tpte_Codigo = ? ORDER BY T1.Tpte_Codigo  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H00513", "SELECT COUNT(*) FROM ((((ALM_CUENTADANTE T1 INNER JOIN GEN_REGIONAL T3 ON T3.Regi_Id = T1.Regi_Id) INNER JOIN GEN_CIUDAD T4 ON T4.Ciud_Codigo = T3.Ciud_Codigo) INNER JOIN GEN_DEPARTAMENTO T5 ON T5.Dept_Codigo = T4.Dept_Codigo) INNER JOIN GEN_CENTROCOSTO T2 ON T2.Cent_Id = T1.Cent_Id) WHERE T1.Tpte_Codigo = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
