/*
               File: alm_bodegabodegaswc_impl
        Description: ALM_BODEGABODEGASWC
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:11:25.51
...
public final  class alm_bodegabodegaswc_impl extends GXWebComponent
{
   public alm_bodegabodegaswc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public alm_bodegabodegaswc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( alm_bodegabodegaswc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Bode_Codigo, AV12Update, AV13Delete, A1Cent_Id, A27Alma_Modulo, A28Alma_Codigo, A29Tpal_Id, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "ALM_BODEGABODEGASWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414112558");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.alm_bodegabodegaswc") + "?" + GXutil.URLEncode(GXutil.rtrim(AV7Bode_Codigo))+"\">") ;
   ...
   public void renderHtmlCloseForm3W2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("alm_bodegabodegaswc.js", "?201861414112559");
      }
   ...
   public void wb3W0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.alm_bodegabodegaswc");
         }
         /* Div Control */
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_ALM_BODEGABODEGASWC.htm");
         ...
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            httpContext.writeValue( "Descripción Tipo Almacén") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
   ...
   public void start3W2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "ALM_BODEGABODEGASWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "ALM_BODEGABODEGASWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf3W2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A31Bode_Codigo = H003W2_A31Bode_Codigo[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A31Bode_Codigo", A31Bode_Codigo);
            A673Alma_Estado = H003W2_A673Alma_Estado[0] ;
            n673Alma_Estado = H003W2_n673Alma_Estado[0] ;
            A258Alma_UsuarioModifica = H003W2_A258Alma_UsuarioModifica[0] ;
            n258Alma_UsuarioModifica = H003W2_n258Alma_UsuarioModifica[0] ;
            A257Alma_FechaModifica = H003W2_A257Alma_FechaModifica[0] ;
            n257Alma_FechaModifica = H003W2_n257Alma_FechaModifica[0] ;
            A256Alma_UsuarioCrea = H003W2_A256Alma_UsuarioCrea[0] ;
            n256Alma_UsuarioCrea = H003W2_n256Alma_UsuarioCrea[0] ;
            A255Alma_FechaCrea = H003W2_A255Alma_FechaCrea[0] ;
            n255Alma_FechaCrea = H003W2_n255Alma_FechaCrea[0] ;
            A264Alma_CuentaCredito = H003W2_A264Alma_CuentaCredito[0] ;
            n264Alma_CuentaCredito = H003W2_n264Alma_CuentaCredito[0] ;
            A263Alma_CuentaDebito = H003W2_A263Alma_CuentaDebito[0] ;
            n263Alma_CuentaDebito = H003W2_n263Alma_CuentaDebito[0] ;
            A265Alma_CedulaResponsable = H003W2_A265Alma_CedulaResponsable[0] ;
            n265Alma_CedulaResponsable = H003W2_n265Alma_CedulaResponsable[0] ;
            A268Alma_EmailResponsable = H003W2_A268Alma_EmailResponsable[0] ;
            n268Alma_EmailResponsable = H003W2_n268Alma_EmailResponsable[0] ;
            A266Alma_NombreResponsable = H003W2_A266Alma_NombreResponsable[0] ;
            n266Alma_NombreResponsable = H003W2_n266Alma_NombreResponsable[0] ;
            A30Alma_IdResponsable = H003W2_A30Alma_IdResponsable[0] ;
            A262Alma_Fax = H003W2_A262Alma_Fax[0] ;
            n262Alma_Fax = H003W2_n262Alma_Fax[0] ;
            A261Alma_Telefono2 = H003W2_A261Alma_Telefono2[0] ;
            n261Alma_Telefono2 = H003W2_n261Alma_Telefono2[0] ;
            A260Alma_Telefono1 = H003W2_A260Alma_Telefono1[0] ;
            n260Alma_Telefono1 = H003W2_n260Alma_Telefono1[0] ;
            A259Alma_Direccion = H003W2_A259Alma_Direccion[0] ;
            n259Alma_Direccion = H003W2_n259Alma_Direccion[0] ;
            A307Tpal_Descripcion = H003W2_A307Tpal_Descripcion[0] ;
            A29Tpal_Id = H003W2_A29Tpal_Id[0] ;
            A252Alma_Descripcion = H003W2_A252Alma_Descripcion[0] ;
            A28Alma_Codigo = H003W2_A28Alma_Codigo[0] ;
            A27Alma_Modulo = H003W2_A27Alma_Modulo[0] ;
            A4Cent_Descripcion = H003W2_A4Cent_Descripcion[0] ;
            A3Cent_Codigo = H003W2_A3Cent_Codigo[0] ;
            A1Cent_Id = H003W2_A1Cent_Id[0] ;
            A4Cent_Descripcion = H003W2_A4Cent_Descripcion[0] ;
            A3Cent_Codigo = H003W2_A3Cent_Codigo[0] ;
            A673Alma_Estado = H003W2_A673Alma_Estado[0] ;
            n673Alma_Estado = H003W2_n673Alma_Estado[0] ;
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "alm_bodegabodegaswc");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414112645");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("alm_bodegabodegaswc.js", "?201861414112645");
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Bode_Codigo',fld:'vBODE_CODIGO',pic:'',nv:''},{av:'AV12Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV13Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A1Cent_Id',fld:'CENT_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'cmbAlma_Modulo'},{av:'A27Alma_Modulo',fld:'ALMA_MODULO',pic:'',hsh:true,nv:''},{av:'A28Alma_Codigo',fld:'ALMA_CODIGO',pic:'',hsh:true,nv:''},{av:'A29Tpal_Id',fld:'TPAL_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e133W2',iparms:[{av:'A1Cent_Id',fld:'CENT_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'cmbAlma_Modulo'},{av:'A27Alma_Modulo',fld:'ALMA_MODULO',pic:'',hsh:true,nv:''},{av:'A28Alma_Codigo',fld:'ALMA_CODIGO',pic:'',hsh:true,nv:''},{av:'A29Tpal_Id',fld:'TPAL_ID',pic:'ZZZZZZZZZZ9',nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtCent_Descripcion_Link',ctrl:'CENT_DESCRIPCION',prop:'Link'},{av:'edtAlma_Descripcion_Link',ctrl:'ALMA_DESCRIPCION',prop:'Link'},{av:'edtTpal_Descripcion_Link',ctrl:'TPAL_DESCRIPCION',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e113W2',iparms:[{av:'A1Cent_Id',fld:'CENT_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'cmbAlma_Modulo'},{av:'A27Alma_Modulo',fld:'ALMA_MODULO',pic:'',hsh:true,nv:''},{av:'A28Alma_Codigo',fld:'ALMA_CODIGO',pic:'',hsh:true,nv:''}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H003W2_A31Bode_Codigo = new String[] {""} ;
      H003W2_A673Alma_Estado = new String[] {""} ;
      H003W2_n673Alma_Estado = new boolean[] {false} ;
      H003W2_A258Alma_UsuarioModifica = new String[] {""} ;
      H003W2_n258Alma_UsuarioModifica = new boolean[] {false} ;
      H003W2_A257Alma_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H003W2_n257Alma_FechaModifica = new boolean[] {false} ;
      H003W2_A256Alma_UsuarioCrea = new String[] {""} ;
      H003W2_n256Alma_UsuarioCrea = new boolean[] {false} ;
      H003W2_A255Alma_FechaCrea = new java.util.Date[] {GXutil.nullDate()} ;
      H003W2_n255Alma_FechaCrea = new boolean[] {false} ;
      H003W2_A264Alma_CuentaCredito = new String[] {""} ;
      H003W2_n264Alma_CuentaCredito = new boolean[] {false} ;
      H003W2_A263Alma_CuentaDebito = new String[] {""} ;
      H003W2_n263Alma_CuentaDebito = new boolean[] {false} ;
      H003W2_A265Alma_CedulaResponsable = new long[1] ;
      H003W2_n265Alma_CedulaResponsable = new boolean[] {false} ;
      H003W2_A268Alma_EmailResponsable = new String[] {""} ;
      H003W2_n268Alma_EmailResponsable = new boolean[] {false} ;
      H003W2_A266Alma_NombreResponsable = new String[] {""} ;
      H003W2_n266Alma_NombreResponsable = new boolean[] {false} ;
      H003W2_A30Alma_IdResponsable = new long[1] ;
      H003W2_A262Alma_Fax = new long[1] ;
      H003W2_n262Alma_Fax = new boolean[] {false} ;
      H003W2_A261Alma_Telefono2 = new long[1] ;
      H003W2_n261Alma_Telefono2 = new boolean[] {false} ;
      H003W2_A260Alma_Telefono1 = new long[1] ;
      H003W2_n260Alma_Telefono1 = new boolean[] {false} ;
      H003W2_A259Alma_Direccion = new String[] {""} ;
      H003W2_n259Alma_Direccion = new boolean[] {false} ;
      H003W2_A307Tpal_Descripcion = new String[] {""} ;
      H003W2_A29Tpal_Id = new long[1] ;
      H003W2_A252Alma_Descripcion = new String[] {""} ;
      H003W2_A28Alma_Codigo = new String[] {""} ;
      H003W2_A27Alma_Modulo = new String[] {""} ;
      H003W2_A4Cent_Descripcion = new String[] {""} ;
      H003W2_A3Cent_Codigo = new String[] {""} ;
      H003W2_A1Cent_Id = new long[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.alm_bodegabodegaswc__default(),
         new Object[] {
             new Object[] {
            H003W2_A31Bode_Codigo, H003W2_A673Alma_Estado, H003W2_n673Alma_Estado, H003W2_A258Alma_UsuarioModifica, H003W2_n258Alma_UsuarioModifica, H003W2_A257Alma_FechaModifica, H003W2_n257Alma_FechaModifica, H003W2_A256Alma_UsuarioCrea, H003W2_n256Alma_UsuarioCrea, H003W2_A255Alma_FechaCrea,
            H003W2_n255Alma_FechaCrea, H003W2_A264Alma_CuentaCredito, H003W2_n264Alma_CuentaCredito, H003W2_A263Alma_CuentaDebito, H003W2_n263Alma_CuentaDebito, H003W2_A265Alma_CedulaResponsable, H003W2_n265Alma_CedulaResponsable, H003W2_A268Alma_EmailResponsable, H003W2_n268Alma_EmailResponsable, H003W2_A266Alma_NombreResponsable,
            H003W2_n266Alma_NombreResponsable, H003W2_A30Alma_IdResponsable, H003W2_A262Alma_Fax, H003W2_n262Alma_Fax, H003W2_A261Alma_Telefono2, H003W2_n261Alma_Telefono2, H003W2_A260Alma_Telefono1, H003W2_n260Alma_Telefono1, H003W2_A259Alma_Direccion, H003W2_n259Alma_Direccion,
            H003W2_A307Tpal_Descripcion, H003W2_A29Tpal_Id, H003W2_A252Alma_Descripcion, H003W2_A28Alma_Codigo, H003W2_A27Alma_Modulo, H003W2_A4Cent_Descripcion, H003W2_A3Cent_Codigo, H003W2_A1Cent_Id
            }
            , new Object[] {
   ...
   private String[] H003W2_A31Bode_Codigo ;
   private String[] H003W2_A673Alma_Estado ;
   private boolean[] H003W2_n673Alma_Estado ;
   private String[] H003W2_A258Alma_UsuarioModifica ;
   private boolean[] H003W2_n258Alma_UsuarioModifica ;
   private java.util.Date[] H003W2_A257Alma_FechaModifica ;
   private boolean[] H003W2_n257Alma_FechaModifica ;
   private String[] H003W2_A256Alma_UsuarioCrea ;
   private boolean[] H003W2_n256Alma_UsuarioCrea ;
   private java.util.Date[] H003W2_A255Alma_FechaCrea ;
   private boolean[] H003W2_n255Alma_FechaCrea ;
   private String[] H003W2_A264Alma_CuentaCredito ;
   private boolean[] H003W2_n264Alma_CuentaCredito ;
   private String[] H003W2_A263Alma_CuentaDebito ;
   private boolean[] H003W2_n263Alma_CuentaDebito ;
   private long[] H003W2_A265Alma_CedulaResponsable ;
   private boolean[] H003W2_n265Alma_CedulaResponsable ;
   private String[] H003W2_A268Alma_EmailResponsable ;
   private boolean[] H003W2_n268Alma_EmailResponsable ;
   private String[] H003W2_A266Alma_NombreResponsable ;
   private boolean[] H003W2_n266Alma_NombreResponsable ;
   private long[] H003W2_A30Alma_IdResponsable ;
   private long[] H003W2_A262Alma_Fax ;
   private boolean[] H003W2_n262Alma_Fax ;
   private long[] H003W2_A261Alma_Telefono2 ;
   private boolean[] H003W2_n261Alma_Telefono2 ;
   private long[] H003W2_A260Alma_Telefono1 ;
   private boolean[] H003W2_n260Alma_Telefono1 ;
   private String[] H003W2_A259Alma_Direccion ;
   private boolean[] H003W2_n259Alma_Direccion ;
   private String[] H003W2_A307Tpal_Descripcion ;
   private long[] H003W2_A29Tpal_Id ;
   private String[] H003W2_A252Alma_Descripcion ;
   private String[] H003W2_A28Alma_Codigo ;
   private String[] H003W2_A27Alma_Modulo ;
   private String[] H003W2_A4Cent_Descripcion ;
   private String[] H003W2_A3Cent_Codigo ;
   private long[] H003W2_A1Cent_Id ;
...
final  class alm_bodegabodegaswc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H003W2", "SELECT T1.Bode_Codigo, T3.Alma_Estado, T3.Alma_UsuarioModifica, T3.Alma_FechaModifica, T3.Alma_UsuarioCrea, T3.Alma_FechaCrea, T3.Alma_CuentaCredito, T3.Alma_CuentaDebito, T4.Cuen_Cedula AS Alma_CedulaResponsable, T4.Cuen_Email AS Alma_EmailResponsable, T4.Cuen_Nombre AS Alma_NombreResponsable, T3.Alma_IdResponsable AS Alma_IdResponsable, T3.Alma_Fax, T3.Alma_Telefono2, T3.Alma_Telefono1, T3.Alma_Direccion, T5.Tpal_Descripcion, T3.Tpal_Id, T3.Alma_Descripcion, T1.Alma_Codigo, T1.Alma_Modulo, T2.Cent_Descripcion, T2.Cent_Codigo, T1.Cent_Id FROM ((((ALM_ALMACEN_BODEGAS T1 INNER JOIN GEN_CENTROCOSTO T2 ON T2.Cent_Id = T1.Cent_Id) INNER JOIN ALM_ALMACEN T3 ON T3.Cent_Id = T1.Cent_Id AND T3.Alma_Modulo = T1.Alma_Modulo AND T3.Alma_Codigo = T1.Alma_Codigo) INNER JOIN ALM_CUENTADANTE T4 ON T4.Cuen_Identificacion = T3.Alma_IdResponsable) INNER JOIN ALM_TIPO_ALMACEN T5 ON T5.Tpal_Id = T3.Tpal_Id) WHERE T1.Bode_Codigo = ? ORDER BY T1.Bode_Codigo  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H003W3", "SELECT COUNT(*) FROM ((((ALM_ALMACEN_BODEGAS T1 INNER JOIN GEN_CENTROCOSTO T2 ON T2.Cent_Id = T1.Cent_Id) INNER JOIN ALM_ALMACEN T3 ON T3.Cent_Id = T1.Cent_Id AND T3.Alma_Modulo = T1.Alma_Modulo AND T3.Alma_Codigo = T1.Alma_Codigo) INNER JOIN ALM_CUENTADANTE T5 ON T5.Cuen_Identificacion = T3.Alma_IdResponsable) INNER JOIN ALM_TIPO_ALMACEN T4 ON T4.Tpal_Id = T3.Tpal_Id) WHERE T1.Bode_Codigo = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
