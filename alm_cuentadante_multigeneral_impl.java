/*
               File: alm_cuentadante_multigeneral_impl
        Description: ALM_CUENTADANTE_MULTIGeneral
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:14:42.96
...
public final  class alm_cuentadante_multigeneral_impl extends GXWebComponent
{
   public alm_cuentadante_multigeneral_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public alm_cuentadante_multigeneral_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( alm_cuentadante_multigeneral_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "ALM_CUENTADANTE_MULTIGeneral") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20186141414433");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.alm_cuentadante_multigeneral") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A43Cuen_Identificacion,18,0)))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      forbiddenHiddens = sPrefix + "hsh" + "ALM_CUENTADANTE_MULTIGeneral" ;
      ...
      GXutil.writeLogln("alm_cuentadante_multigeneral:[SendSecurityCheck]"+forbiddenHiddens);
   }
   ...
   public void renderHtmlCloseForm1K2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("alm_cuentadante_multigeneral.js", "?20186141414437");
      }
   ...
   {
      return "ALM_CUENTADANTE_MULTIGeneral" ;
   }
   ...
   public void wb1K0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.alm_cuentadante_multigeneral");
         }
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtnupdate_Internalname, "", "Modificar", bttBtnupdate_Jsonclick, 7, "Modificar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e111k1_client"+"'", TempTags, "", 2, "HLP_ALM_CUENTADANTE_MULTIGeneral.htm");
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtndelete_Internalname, "", "Eliminar", bttBtndelete_Jsonclick, 7, "Eliminar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e121k1_client"+"'", TempTags, "", 2, "HLP_ALM_CUENTADANTE_MULTIGeneral.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtCuen_Cedula_Internalname, GXutil.ltrim( localUtil.ntoc( A688Cuen_Cedula, (byte)(18), (byte)(0), ",", "")), ((edtCuen_Cedula_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A688Cuen_Cedula), "ZZZZZZZZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A688Cuen_Cedula), "ZZZZZZZZZZZZZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCuen_Cedula_Jsonclick, 0, "ReadonlyAttribute", "", "", "", 1, edtCuen_Cedula_Enabled, 0, "text", "", 18, "chr", 1, "row", 18, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "HLP_ALM_CUENTADANTE_MULTIGeneral.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtCuen_PrimerNombre_Internalname, A331Cuen_PrimerNombre, GXutil.rtrim( localUtil.format( A331Cuen_PrimerNombre, "@!")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCuen_PrimerNombre_Jsonclick, 0, "ReadonlyAttribute", "", "", "", 1, edtCuen_PrimerNombre_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "Descripcion", "left", true, "HLP_ALM_CUENTADANTE_MULTIGeneral.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtCuen_PrimerApellido_Internalname, A329Cuen_PrimerApellido, GXutil.rtrim( localUtil.format( A329Cuen_PrimerApellido, "@!")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCuen_PrimerApellido_Jsonclick, 0, "ReadonlyAttribute", "", "", "", 1, edtCuen_PrimerApellido_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "Descripcion", "left", true, "HLP_ALM_CUENTADANTE_MULTIGeneral.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         /* ComboBox */
         com.orions2.GxWebStd.gx_combobox_ctrl1( httpContext, cmbCuen_Estado, cmbCuen_Estado.getInternalname(), GXutil.rtrim( A333Cuen_Estado), 1, cmbCuen_Estado.getJsonclick(), 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "char", "", 1, cmbCuen_Estado.getEnabled(), 0, (short)(0), 0, "em", 0, "", "", "ReadonlyAttribute", "", "", "", true, "HLP_ALM_CUENTADANTE_MULTIGeneral.htm");
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtCuen_Email_Internalname, A336Cuen_Email, GXutil.rtrim( localUtil.format( A336Cuen_Email, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "mailto:"+A336Cuen_Email, "", "", "", edtCuen_Email_Jsonclick, 0, "ReadonlyAttribute", "", "", "", 1, edtCuen_Email_Enabled, 0, "email", "", 80, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "GeneXus\\Email", "left", true, "HLP_ALM_CUENTADANTE_MULTIGeneral.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtCiud_Descripcion_Internalname, A7Ciud_Descripcion, GXutil.rtrim( localUtil.format( A7Ciud_Descripcion, "@!")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", edtCiud_Descripcion_Link, "", "", "", edtCiud_Descripcion_Jsonclick, 0, "ReadonlyAttribute", "", "", "", 1, edtCiud_Descripcion_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "Descripcion", "left", true, "HLP_ALM_CUENTADANTE_MULTIGeneral.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtDept_Codigo_Internalname, GXutil.ltrim( localUtil.ntoc( A6Dept_Codigo, (byte)(4), (byte)(0), ",", "")), ((edtDept_Codigo_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A6Dept_Codigo), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A6Dept_Codigo), "ZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtDept_Codigo_Jsonclick, 0, "ReadonlyAttribute", "", "", "", 1, edtDept_Codigo_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "HLP_ALM_CUENTADANTE_MULTIGeneral.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtDept_Descripcion_Internalname, A10Dept_Descripcion, GXutil.rtrim( localUtil.format( A10Dept_Descripcion, "@!")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", edtDept_Descripcion_Link, "", "", "", edtDept_Descripcion_Jsonclick, 0, "ReadonlyAttribute", "", "", "", 1, edtDept_Descripcion_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "Descripcion", "left", true, "HLP_ALM_CUENTADANTE_MULTIGeneral.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Attribute/Variable Label */
         com.orions2.GxWebStd.gx_label_element( httpContext, edtRegi_Descripcion_Internalname, "Regional", "col-sm-3 ReadonlyAttributeLabel", 1, true);
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtRegi_Descripcion_Internalname, A13Regi_Descripcion, GXutil.rtrim( localUtil.format( A13Regi_Descripcion, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtRegi_Descripcion_Jsonclick, 0, "ReadonlyAttribute", "", "", "", 1, edtRegi_Descripcion_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "Descripcion", "left", true, "HLP_ALM_CUENTADANTE_MULTIGeneral.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtCuen_UsuarioCrea_Internalname, A337Cuen_UsuarioCrea, GXutil.rtrim( localUtil.format( A337Cuen_UsuarioCrea, "@!")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCuen_UsuarioCrea_Jsonclick, 0, "ReadonlyAttribute", "", "", "", 1, edtCuen_UsuarioCrea_Enabled, 0, "text", "", 30, "chr", 1, "row", 30, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "Usuario", "left", true, "HLP_ALM_CUENTADANTE_MULTIGeneral.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
         /* Attribute/Variable Label */
         com.orions2.GxWebStd.gx_label_element( httpContext, edtCuen_FechaCrea_Internalname, "Fecha Creación", "col-sm-3 AttributeLabel", 0, true);
         /* Single line edit */
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtCuen_FechaCrea_Internalname, localUtil.ttoc( A338Cuen_FechaCrea, 10, 8, 0, 3, "/", ":", " "), localUtil.format( A338Cuen_FechaCrea, "99/99/99 99:99"), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCuen_FechaCrea_Jsonclick, 0, "Attribute", "", "", "", edtCuen_FechaCrea_Visible, edtCuen_FechaCrea_Enabled, 0, "text", "", 14, "chr", 1, "row", 14, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "FechaHora", "right", false, "HLP_ALM_CUENTADANTE_MULTIGeneral.htm");
         com.orions2.GxWebStd.gx_bitmap( httpContext, edtCuen_FechaCrea_Internalname+"_dp_trigger", context.getHttpContext().getImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.getHttpContext().getTheme( )), "", "", "", "", ((edtCuen_FechaCrea_Visible==0)||(edtCuen_FechaCrea_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", 1, false, false, "", "HLP_ALM_CUENTADANTE_MULTIGeneral.htm");
         httpContext.writeTextNL( "</div>") ;
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start1K2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "ALM_CUENTADANTE_MULTIGeneral", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV14Pgmname = "ALM_CUENTADANTE_MULTIGeneral" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf1K2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A338Cuen_FechaCrea = H001K2_A338Cuen_FechaCrea[0] ;
            ...
            A340Cuen_FechaModifica = H001K2_A340Cuen_FechaModifica[0] ;
            ...
            n340Cuen_FechaModifica = H001K2_n340Cuen_FechaModifica[0] ;
            A339Cuen_UsuarioModifica = H001K2_A339Cuen_UsuarioModifica[0] ;
            ...
            n339Cuen_UsuarioModifica = H001K2_n339Cuen_UsuarioModifica[0] ;
            A337Cuen_UsuarioCrea = H001K2_A337Cuen_UsuarioCrea[0] ;
            ...
            n336Cuen_Email = H001K2_n336Cuen_Email[0] ;
            A335Cuen_Telefono = H001K2_A335Cuen_Telefono[0] ;
            ...
            n335Cuen_Telefono = H001K2_n335Cuen_Telefono[0] ;
            A334Cuen_Direccion = H001K2_A334Cuen_Direccion[0] ;
            ...
            n334Cuen_Direccion = H001K2_n334Cuen_Direccion[0] ;
            A333Cuen_Estado = H001K2_A333Cuen_Estado[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A333Cuen_Estado", A333Cuen_Estado);
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "gxhash_CUEN_ESTADO", getSecureSignedToken( sPrefix, GXutil.rtrim( localUtil.format( A333Cuen_Estado, ""))));
            n333Cuen_Estado = H001K2_n333Cuen_Estado[0] ;
            A328Cuen_Clase = H001K2_A328Cuen_Clase[0] ;
            ...
            n328Cuen_Clase = H001K2_n328Cuen_Clase[0] ;
            A321Tpte_Descripcion = H001K2_A321Tpte_Descripcion[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A321Tpte_Descripcion", A321Tpte_Descripcion);
            A42Tpte_Codigo = H001K2_A42Tpte_Codigo[0] ;
            ...
            A44Cuen_Nombre = H001K2_A44Cuen_Nombre[0] ;
            ...
            n44Cuen_Nombre = H001K2_n44Cuen_Nombre[0] ;
            A330Cuen_SegundoApellido = H001K2_A330Cuen_SegundoApellido[0] ;
            ...
            n330Cuen_SegundoApellido = H001K2_n330Cuen_SegundoApellido[0] ;
            A329Cuen_PrimerApellido = H001K2_A329Cuen_PrimerApellido[0] ;
            ...
            n329Cuen_PrimerApellido = H001K2_n329Cuen_PrimerApellido[0] ;
            A332Cuen_SegundoNombre = H001K2_A332Cuen_SegundoNombre[0] ;
            ...
            n332Cuen_SegundoNombre = H001K2_n332Cuen_SegundoNombre[0] ;
            A331Cuen_PrimerNombre = H001K2_A331Cuen_PrimerNombre[0] ;
            ...
            n331Cuen_PrimerNombre = H001K2_n331Cuen_PrimerNombre[0] ;
            A326Cuen_DigitoVerificacion = H001K2_A326Cuen_DigitoVerificacion[0] ;
            ...
            n326Cuen_DigitoVerificacion = H001K2_n326Cuen_DigitoVerificacion[0] ;
            A688Cuen_Cedula = H001K2_A688Cuen_Cedula[0] ;
   ...
   public void strup1K0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         if ( ! GXutil.checkEncryptedSignature( forbiddenHiddens, hsh, GXKey) )
         {
            ...
            GXutil.writeLog("alm_cuentadante_multigeneral:[SecurityCheckFailed]"+forbiddenHiddens);
            return  ;
         }
      }
      else
   ...
   protected void e141K2( )
   {
      ...
      edtRegi_Cod_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtRegi_Cod_Internalname, "Visible", GXutil.ltrim( GXutil.str( edtRegi_Cod_Visible, 5, 0)), true);
      edtCuen_FechaCrea_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtCuen_FechaCrea_Internalname, "Visible", GXutil.ltrim( GXutil.str( edtCuen_FechaCrea_Visible, 5, 0)), true);
   }
   ...
   public void S112( )
   {
      ...
      AV8TrnContext.setgxTv_SdtTransactionContext_Transactionname( "ALM_CUENTADANTE_MULTI" );
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "alm_cuentadante_multigeneral");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414144488");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   {
      httpContext.AddJavascriptSource("alm_cuentadante_multigeneral.js", "?201861414144488");
   ...
   public void initialize_properties( )
   {
      ...
      edtCuen_FechaCrea_Visible = 1 ;
      edtRegi_Cod_Jsonclick = "" ;
      edtRegi_Cod_Enabled = 0 ;
      edtRegi_Cod_Visible = 1 ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("'DOUPDATE'","{handler:'e111K1',iparms:[{av:'A43Cuen_Identificacion',fld:'CUEN_IDENTIFICACION',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0}],oparms:[]}");
      setEventMetadata("'DODELETE'","{handler:'e121K1',iparms:[{av:'A43Cuen_Identificacion',fld:'CUEN_IDENTIFICACION',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0}],oparms:[]}");
   }
   ...
   public void initialize( )
   {
      ...
      AV14Pgmname = "" ;
      scmdbuf = "" ;
      H001K2_A43Cuen_Identificacion = new long[1] ;
      H001K2_A338Cuen_FechaCrea = new java.util.Date[] {GXutil.nullDate()} ;
      H001K2_A12Regi_Cod = new short[1] ;
      H001K2_A2Regi_Id = new long[1] ;
      H001K2_A340Cuen_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H001K2_n340Cuen_FechaModifica = new boolean[] {false} ;
      H001K2_A339Cuen_UsuarioModifica = new String[] {""} ;
      H001K2_n339Cuen_UsuarioModifica = new boolean[] {false} ;
      H001K2_A337Cuen_UsuarioCrea = new String[] {""} ;
      H001K2_A13Regi_Descripcion = new String[] {""} ;
      H001K2_A4Cent_Descripcion = new String[] {""} ;
      H001K2_A3Cent_Codigo = new String[] {""} ;
      H001K2_A1Cent_Id = new long[1] ;
      H001K2_A10Dept_Descripcion = new String[] {""} ;
      H001K2_A6Dept_Codigo = new short[1] ;
      H001K2_A7Ciud_Descripcion = new String[] {""} ;
      H001K2_A5Ciud_Codigo = new short[1] ;
      H001K2_A336Cuen_Email = new String[] {""} ;
      H001K2_n336Cuen_Email = new boolean[] {false} ;
      H001K2_A335Cuen_Telefono = new String[] {""} ;
      H001K2_n335Cuen_Telefono = new boolean[] {false} ;
      H001K2_A334Cuen_Direccion = new String[] {""} ;
      H001K2_n334Cuen_Direccion = new boolean[] {false} ;
      H001K2_A333Cuen_Estado = new String[] {""} ;
      H001K2_n333Cuen_Estado = new boolean[] {false} ;
      H001K2_A328Cuen_Clase = new String[] {""} ;
      H001K2_n328Cuen_Clase = new boolean[] {false} ;
      H001K2_A321Tpte_Descripcion = new String[] {""} ;
      H001K2_A42Tpte_Codigo = new String[] {""} ;
      H001K2_A44Cuen_Nombre = new String[] {""} ;
      H001K2_n44Cuen_Nombre = new boolean[] {false} ;
      H001K2_A330Cuen_SegundoApellido = new String[] {""} ;
      H001K2_n330Cuen_SegundoApellido = new boolean[] {false} ;
      H001K2_A329Cuen_PrimerApellido = new String[] {""} ;
      H001K2_n329Cuen_PrimerApellido = new boolean[] {false} ;
      H001K2_A332Cuen_SegundoNombre = new String[] {""} ;
      H001K2_n332Cuen_SegundoNombre = new boolean[] {false} ;
      H001K2_A331Cuen_PrimerNombre = new String[] {""} ;
      H001K2_n331Cuen_PrimerNombre = new boolean[] {false} ;
      H001K2_A326Cuen_DigitoVerificacion = new byte[1] ;
      H001K2_n326Cuen_DigitoVerificacion = new boolean[] {false} ;
      H001K2_A688Cuen_Cedula = new long[1] ;
      hsh = "" ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.alm_cuentadante_multigeneral__default(),
         new Object[] {
             new Object[] {
            H001K2_A43Cuen_Identificacion, H001K2_A338Cuen_FechaCrea, H001K2_A12Regi_Cod, H001K2_A2Regi_Id, H001K2_A340Cuen_FechaModifica, H001K2_n340Cuen_FechaModifica, H001K2_A339Cuen_UsuarioModifica, H001K2_n339Cuen_UsuarioModifica, H001K2_A337Cuen_UsuarioCrea, H001K2_A13Regi_Descripcion,
            H001K2_A4Cent_Descripcion, H001K2_A3Cent_Codigo, H001K2_A1Cent_Id, H001K2_A10Dept_Descripcion, H001K2_A6Dept_Codigo, H001K2_A7Ciud_Descripcion, H001K2_A5Ciud_Codigo, H001K2_A336Cuen_Email, H001K2_n336Cuen_Email, H001K2_A335Cuen_Telefono,
            H001K2_n335Cuen_Telefono, H001K2_A334Cuen_Direccion, H001K2_n334Cuen_Direccion, H001K2_A333Cuen_Estado, H001K2_n333Cuen_Estado, H001K2_A328Cuen_Clase, H001K2_n328Cuen_Clase, H001K2_A321Tpte_Descripcion, H001K2_A42Tpte_Codigo, H001K2_A44Cuen_Nombre,
            H001K2_n44Cuen_Nombre, H001K2_A330Cuen_SegundoApellido, H001K2_n330Cuen_SegundoApellido, H001K2_A329Cuen_PrimerApellido, H001K2_n329Cuen_PrimerApellido, H001K2_A332Cuen_SegundoNombre, H001K2_n332Cuen_SegundoNombre, H001K2_A331Cuen_PrimerNombre, H001K2_n331Cuen_PrimerNombre, H001K2_A326Cuen_DigitoVerificacion,
            H001K2_n326Cuen_DigitoVerificacion, H001K2_A688Cuen_Cedula
            }
         }
      );
      AV14Pgmname = "ALM_CUENTADANTE_MULTIGeneral" ;
   ...
   private int edtRegi_Cod_Visible ;
   private int edtCuen_FechaCrea_Visible ;
   ...
   private long[] H001K2_A43Cuen_Identificacion ;
   private java.util.Date[] H001K2_A338Cuen_FechaCrea ;
   private short[] H001K2_A12Regi_Cod ;
   private long[] H001K2_A2Regi_Id ;
   private java.util.Date[] H001K2_A340Cuen_FechaModifica ;
   private boolean[] H001K2_n340Cuen_FechaModifica ;
   private String[] H001K2_A339Cuen_UsuarioModifica ;
   private boolean[] H001K2_n339Cuen_UsuarioModifica ;
   private String[] H001K2_A337Cuen_UsuarioCrea ;
   private String[] H001K2_A13Regi_Descripcion ;
   private String[] H001K2_A4Cent_Descripcion ;
   private String[] H001K2_A3Cent_Codigo ;
   private long[] H001K2_A1Cent_Id ;
   private String[] H001K2_A10Dept_Descripcion ;
   private short[] H001K2_A6Dept_Codigo ;
   private String[] H001K2_A7Ciud_Descripcion ;
   private short[] H001K2_A5Ciud_Codigo ;
   private String[] H001K2_A336Cuen_Email ;
   private boolean[] H001K2_n336Cuen_Email ;
   private String[] H001K2_A335Cuen_Telefono ;
   private boolean[] H001K2_n335Cuen_Telefono ;
   private String[] H001K2_A334Cuen_Direccion ;
   private boolean[] H001K2_n334Cuen_Direccion ;
   private String[] H001K2_A333Cuen_Estado ;
   private boolean[] H001K2_n333Cuen_Estado ;
   private String[] H001K2_A328Cuen_Clase ;
   private boolean[] H001K2_n328Cuen_Clase ;
   private String[] H001K2_A321Tpte_Descripcion ;
   private String[] H001K2_A42Tpte_Codigo ;
   private String[] H001K2_A44Cuen_Nombre ;
   private boolean[] H001K2_n44Cuen_Nombre ;
   private String[] H001K2_A330Cuen_SegundoApellido ;
   private boolean[] H001K2_n330Cuen_SegundoApellido ;
   private String[] H001K2_A329Cuen_PrimerApellido ;
   private boolean[] H001K2_n329Cuen_PrimerApellido ;
   private String[] H001K2_A332Cuen_SegundoNombre ;
   private boolean[] H001K2_n332Cuen_SegundoNombre ;
   private String[] H001K2_A331Cuen_PrimerNombre ;
   private boolean[] H001K2_n331Cuen_PrimerNombre ;
   private byte[] H001K2_A326Cuen_DigitoVerificacion ;
   private boolean[] H001K2_n326Cuen_DigitoVerificacion ;
   private long[] H001K2_A688Cuen_Cedula ;
