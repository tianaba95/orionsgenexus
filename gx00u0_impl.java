...
public final  class gx00u0_impl extends GXDataArea
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414215842");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.gx00u0") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13pTipo_Codigo,18,0)))+"\">") ;
   ...
   {
      return formatLink("com.orions2.gx00u0") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13pTipo_Codigo,18,0))) ;
   }
   ...
   public void wb7C0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltipo_codigofilter_Internalname, "Codigo Tipo de Elemento", "", "", lblLbltipo_codigofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e117c1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx00U0.htm");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltipo_descripcionfilter_Internalname, "Tipo de Elemento", "", "", lblLbltipo_descripcionfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e127c1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx00U0.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 34, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e137c1_client"+"'", TempTags, "", 2, "HLP_Gx00U0.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      if ( wbEnd == 34 )
      {
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 34, 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Gx00U0.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start7C2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selection List TIPO DE ELEMENTO", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf7C2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A253Tipo_Descripcion = H007C2_A253Tipo_Descripcion[0] ;
            A33Tipo_Codigo = H007C2_A33Tipo_Codigo[0] ;
   ...
   {
      /* Start Routine */
      Form.setCaption( GXutil.format( "Lista de Selección %1", "TIPO DE ELEMENTO", "", "", "", "", "", "", "", "") );
   ...
   public void e167C2( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV13pTipo_Codigo", GXutil.ltrim( GXutil.str( AV13pTipo_Codigo, 18, 0)));
      httpContext.setWebReturnParms(new Object[] {new Long(AV13pTipo_Codigo)});
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414215884");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gx00u0.js", "?201861414215884");
   ...
   public void sendrow_342( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_34_idx <= subgrid1_recordsperpage( ) * 1 ) )
      {
         ...
         edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( A33Tipo_Codigo, (byte)(18), (byte)(0), ",", "")))+"'"+"]);" ;
         ...
         edtTipo_Descripcion_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( A33Tipo_Codigo, (byte)(18), (byte)(0), ",", "")))+"'"+"]);" ;
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Selection List TIPO DE ELEMENTO" );
      subGrid1_Rows = 10 ;
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("'TOGGLE'","{handler:'e137C1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}],oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
      setEventMetadata("LBLTIPO_CODIGOFILTER.CLICK","{handler:'e117C1',iparms:[{av:'divTipo_codigofiltercontainer_Class',ctrl:'TIPO_CODIGOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTipo_codigofiltercontainer_Class',ctrl:'TIPO_CODIGOFILTERCONTAINER',prop:'Class'},{av:'edtavCtipo_codigo_Visible',ctrl:'vCTIPO_CODIGO',prop:'Visible'}]}");
      setEventMetadata("LBLTIPO_DESCRIPCIONFILTER.CLICK","{handler:'e127C1',iparms:[{av:'divTipo_descripcionfiltercontainer_Class',ctrl:'TIPO_DESCRIPCIONFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTipo_descripcionfiltercontainer_Class',ctrl:'TIPO_DESCRIPCIONFILTERCONTAINER',prop:'Class'},{av:'edtavCtipo_descripcion_Visible',ctrl:'vCTIPO_DESCRIPCION',prop:'Visible'}]}");
      setEventMetadata("ENTER","{handler:'e167C2',iparms:[{av:'A33Tipo_Codigo',fld:'TIPO_CODIGO',pic:'ZZZZZZZZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'AV13pTipo_Codigo',fld:'vPTIPO_CODIGO',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0}]}");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H007C2_A253Tipo_Descripcion = new String[] {""} ;
      H007C2_A33Tipo_Codigo = new long[1] ;
      ...
      sImgUrl = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.gx00u0__default(),
         new Object[] {
             new Object[] {
            H007C2_A253Tipo_Descripcion, H007C2_A33Tipo_Codigo
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String[] H007C2_A253Tipo_Descripcion ;
   private long[] H007C2_A33Tipo_Codigo ;
...
final  class gx00u0__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H007C2", "SELECT /*+ FIRST_ROWS(11) */ Tipo_Descripcion, Tipo_Codigo FROM ALM_TIPO_ELEMENTO WHERE Tipo_Codigo >= ? ORDER BY Tipo_Codigo ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
      };
   }
