/*
               File: alm_documentosdocumentoswc_impl
...
public final  class alm_documentosdocumentoswc_impl extends GXWebComponent
{
   public alm_documentosdocumentoswc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public alm_documentosdocumentoswc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( alm_documentosdocumentoswc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV7Tran_Nro_Documento = (short)(GXutil.lval( httpContext.GetNextPar( ))) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Tran_Nro_Documento", GXutil.ltrim( GXutil.str( AV7Tran_Nro_Documento, 4, 0)));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,new Short(AV7Tran_Nro_Documento)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Tran_Nro_Documento, AV12Update, AV13Delete, A46Tran_Id, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "ALM_DOCUMENTOSDocumentos WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414115077");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.alm_documentosdocumentoswc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Tran_Nro_Documento,4,0)))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV7Tran_Nro_Documento", GXutil.ltrim( localUtil.ntoc( wcpOAV7Tran_Nro_Documento, (byte)(4), (byte)(0), ",", "")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vTRAN_NRO_DOCUMENTO", GXutil.ltrim( localUtil.ntoc( AV7Tran_Nro_Documento, (byte)(4), (byte)(0), ",", "")));
   ...
   public void renderHtmlCloseForm9E2( )
   {
      sendCloseFormHiddens( ) ;
      if ( ( GXutil.len( sPrefix) != 0 ) && httpContext.isAjaxRequest( ) )
      {
         httpContext.AddJavascriptSource("alm_documentosdocumentoswc.js", "?201861414115081");
      }
   ...
   {
      return "ALM_DOCUMENTOSDocumentosWC" ;
   }
   ...
   public void wb9E0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.alm_documentosdocumentoswc");
         }
         /* Div Control */
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_ALM_DOCUMENTOSDocumentosWC.htm");
      ...
      if ( wbEnd == 20 )
      {
         ...
         com.orions2.GxWebStd.gx_label_element( httpContext, edtTran_Nro_Documento_Internalname, "Nro Documento", "col-sm-3 AttributeLabel", 0, true);
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtTran_Nro_Documento_Internalname, GXutil.ltrim( localUtil.ntoc( A827Tran_Nro_Documento, (byte)(4), (byte)(0), ",", "")), ((edtTran_Nro_Documento_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A827Tran_Nro_Documento), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A827Tran_Nro_Documento), "ZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTran_Nro_Documento_Jsonclick, 0, "Attribute", "", "", "", edtTran_Nro_Documento_Visible, edtTran_Nro_Documento_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "HLP_ALM_DOCUMENTOSDocumentosWC.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start9E2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "ALM_DOCUMENTOSDocumentos WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "ALM_DOCUMENTOSDocumentosWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf9E2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H009E2 */
         pr_default.execute(0, new Object[] {new Short(AV7Tran_Nro_Documento), new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_20_idx = (short)(1) ;
         sGXsfl_20_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_20_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_202( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A416Tran_Observaciones = H009E2_A416Tran_Observaciones[0] ;
            n416Tran_Observaciones = H009E2_n416Tran_Observaciones[0] ;
            A827Tran_Nro_Documento = H009E2_A827Tran_Nro_Documento[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A827Tran_Nro_Documento", GXutil.ltrim( GXutil.str( A827Tran_Nro_Documento, 4, 0)));
            A859Tran_EntidadGobierno = H009E2_A859Tran_EntidadGobierno[0] ;
            n859Tran_EntidadGobierno = H009E2_n859Tran_EntidadGobierno[0] ;
            A758Tran_TablaResponsabilidad = H009E2_A758Tran_TablaResponsabilidad[0] ;
            n758Tran_TablaResponsabilidad = H009E2_n758Tran_TablaResponsabilidad[0] ;
            A720Tran_FechaResponsabilidad = H009E2_A720Tran_FechaResponsabilidad[0] ;
            n720Tran_FechaResponsabilidad = H009E2_n720Tran_FechaResponsabilidad[0] ;
            A719Tran_TransaccResponsabilidad = H009E2_A719Tran_TransaccResponsabilidad[0] ;
            n719Tran_TransaccResponsabilidad = H009E2_n719Tran_TransaccResponsabilidad[0] ;
            A721Tran_NombreCuentadanteResponsa = H009E2_A721Tran_NombreCuentadanteResponsa[0] ;
            n721Tran_NombreCuentadanteResponsa = H009E2_n721Tran_NombreCuentadanteResponsa[0] ;
            A759Tran_CedulaResponsabilidad = H009E2_A759Tran_CedulaResponsabilidad[0] ;
            n759Tran_CedulaResponsabilidad = H009E2_n759Tran_CedulaResponsabilidad[0] ;
            A56Tran_IdCuentadanteResponsabili = H009E2_A56Tran_IdCuentadanteResponsabili[0] ;
            n56Tran_IdCuentadanteResponsabili = H009E2_n56Tran_IdCuentadanteResponsabili[0] ;
            A670Tran_ObservacionesAnula = H009E2_A670Tran_ObservacionesAnula[0] ;
            n670Tran_ObservacionesAnula = H009E2_n670Tran_ObservacionesAnula[0] ;
            A669Tran_FechaEliminaoAnula = H009E2_A669Tran_FechaEliminaoAnula[0] ;
            n669Tran_FechaEliminaoAnula = H009E2_n669Tran_FechaEliminaoAnula[0] ;
            A668Tran_UsuarioEliminaoAnula = H009E2_A668Tran_UsuarioEliminaoAnula[0] ;
            n668Tran_UsuarioEliminaoAnula = H009E2_n668Tran_UsuarioEliminaoAnula[0] ;
            A667Tran_NumeroGrupo = H009E2_A667Tran_NumeroGrupo[0] ;
            n667Tran_NumeroGrupo = H009E2_n667Tran_NumeroGrupo[0] ;
            A568Tran_CantidadPadres = H009E2_A568Tran_CantidadPadres[0] ;
            n568Tran_CantidadPadres = H009E2_n568Tran_CantidadPadres[0] ;
            A527Tran_TipoEntra = H009E2_A527Tran_TipoEntra[0] ;
            n527Tran_TipoEntra = H009E2_n527Tran_TipoEntra[0] ;
            A524Tran_Detalle = H009E2_A524Tran_Detalle[0] ;
            n524Tran_Detalle = H009E2_n524Tran_Detalle[0] ;
            A608Tran_RegionAbrevDestino = H009E2_A608Tran_RegionAbrevDestino[0] ;
            n608Tran_RegionAbrevDestino = H009E2_n608Tran_RegionAbrevDestino[0] ;
            A520Tran_RegionDescripcionDestino = H009E2_A520Tran_RegionDescripcionDestino[0] ;
            n520Tran_RegionDescripcionDestino = H009E2_n520Tran_RegionDescripcionDestino[0] ;
            A519Tran_RegionCodigoDestino = H009E2_A519Tran_RegionCodigoDestino[0] ;
            n519Tran_RegionCodigoDestino = H009E2_n519Tran_RegionCodigoDestino[0] ;
            A518Tran_RegionIdDestino = H009E2_A518Tran_RegionIdDestino[0] ;
            n518Tran_RegionIdDestino = H009E2_n518Tran_RegionIdDestino[0] ;
            A517Tran_CentroCostoDescripcionDes = H009E2_A517Tran_CentroCostoDescripcionDes[0] ;
            n517Tran_CentroCostoDescripcionDes = H009E2_n517Tran_CentroCostoDescripcionDes[0] ;
            A516Tran_CentroCostoCodigoDestino = H009E2_A516Tran_CentroCostoCodigoDestino[0] ;
            n516Tran_CentroCostoCodigoDestino = H009E2_n516Tran_CentroCostoCodigoDestino[0] ;
            A50Tran_CentroCostoIdDestino = H009E2_A50Tran_CentroCostoIdDestino[0] ;
            n50Tran_CentroCostoIdDestino = H009E2_n50Tran_CentroCostoIdDestino[0] ;
            A515Tran_FechaIngreso = H009E2_A515Tran_FechaIngreso[0] ;
            n515Tran_FechaIngreso = H009E2_n515Tran_FechaIngreso[0] ;
            A514Tran_NumeroIngreso = H009E2_A514Tran_NumeroIngreso[0] ;
            n514Tran_NumeroIngreso = H009E2_n514Tran_NumeroIngreso[0] ;
            A756Tran_Abreviado = H009E2_A756Tran_Abreviado[0] ;
            n756Tran_Abreviado = H009E2_n756Tran_Abreviado[0] ;
            A672Tran_NombreIngreso = H009E2_A672Tran_NombreIngreso[0] ;
            n672Tran_NombreIngreso = H009E2_n672Tran_NombreIngreso[0] ;
            A54Tran_TipoIngreso = H009E2_A54Tran_TipoIngreso[0] ;
            n54Tran_TipoIngreso = H009E2_n54Tran_TipoIngreso[0] ;
            A513Tran_ConsecutivoCC = H009E2_A513Tran_ConsecutivoCC[0] ;
            n513Tran_ConsecutivoCC = H009E2_n513Tran_ConsecutivoCC[0] ;
            A391Tran_UsuarioRatifica = H009E2_A391Tran_UsuarioRatifica[0] ;
            n391Tran_UsuarioRatifica = H009E2_n391Tran_UsuarioRatifica[0] ;
            A390Tran_FechaRatificacion = H009E2_A390Tran_FechaRatificacion[0] ;
            n390Tran_FechaRatificacion = H009E2_n390Tran_FechaRatificacion[0] ;
            A58Tran_Estado = H009E2_A58Tran_Estado[0] ;
            n58Tran_Estado = H009E2_n58Tran_Estado[0] ;
            A498Tran_NumeroLineas = H009E2_A498Tran_NumeroLineas[0] ;
            n498Tran_NumeroLineas = H009E2_n498Tran_NumeroLineas[0] ;
            A483Tran_ValorTransaccion = H009E2_A483Tran_ValorTransaccion[0] ;
            n483Tran_ValorTransaccion = H009E2_n483Tran_ValorTransaccion[0] ;
            A408Tran_CursoCodigo = H009E2_A408Tran_CursoCodigo[0] ;
            n408Tran_CursoCodigo = H009E2_n408Tran_CursoCodigo[0] ;
            A407Tran_AreadanteCodigo = H009E2_A407Tran_AreadanteCodigo[0] ;
            n407Tran_AreadanteCodigo = H009E2_n407Tran_AreadanteCodigo[0] ;
            A715Tran_EmailCuentadanteDestino = H009E2_A715Tran_EmailCuentadanteDestino[0] ;
            n715Tran_EmailCuentadanteDestino = H009E2_n715Tran_EmailCuentadanteDestino[0] ;
            A704Tran_CedulaCuentadanteDestino = H009E2_A704Tran_CedulaCuentadanteDestino[0] ;
            n704Tran_CedulaCuentadanteDestino = H009E2_n704Tran_CedulaCuentadanteDestino[0] ;
            A389Tran_NombCuentadanteDestino = H009E2_A389Tran_NombCuentadanteDestino[0] ;
            n389Tran_NombCuentadanteDestino = H009E2_n389Tran_NombCuentadanteDestino[0] ;
            A52Tran_IdCuentadanteDestino = H009E2_A52Tran_IdCuentadanteDestino[0] ;
            n52Tran_IdCuentadanteDestino = H009E2_n52Tran_IdCuentadanteDestino[0] ;
            A387Tran_CodBodeDestino = H009E2_A387Tran_CodBodeDestino[0] ;
            A111Tran_CodAlmaDestino = H009E2_A111Tran_CodAlmaDestino[0] ;
            A385Tran_ModuloDestino = H009E2_A385Tran_ModuloDestino[0] ;
            A703Tran_CedulaProveedor = H009E2_A703Tran_CedulaProveedor[0] ;
            n703Tran_CedulaProveedor = H009E2_n703Tran_CedulaProveedor[0] ;
            A575Tran_NombreProveedor = H009E2_A575Tran_NombreProveedor[0] ;
            n575Tran_NombreProveedor = H009E2_n575Tran_NombreProveedor[0] ;
            A53Tran_IdProveedor = H009E2_A53Tran_IdProveedor[0] ;
            n53Tran_IdProveedor = H009E2_n53Tran_IdProveedor[0] ;
            A714Tran_EmailCuentadanteOrigen = H009E2_A714Tran_EmailCuentadanteOrigen[0] ;
            n714Tran_EmailCuentadanteOrigen = H009E2_n714Tran_EmailCuentadanteOrigen[0] ;
            A702Tran_CedulaCuentadanteOrigen = H009E2_A702Tran_CedulaCuentadanteOrigen[0] ;
            n702Tran_CedulaCuentadanteOrigen = H009E2_n702Tran_CedulaCuentadanteOrigen[0] ;
            A384Tran_NombCuentadanteOrigen = H009E2_A384Tran_NombCuentadanteOrigen[0] ;
            n384Tran_NombCuentadanteOrigen = H009E2_n384Tran_NombCuentadanteOrigen[0] ;
            A51Tran_IdCuentadanteOrigen = H009E2_A51Tran_IdCuentadanteOrigen[0] ;
            n51Tran_IdCuentadanteOrigen = H009E2_n51Tran_IdCuentadanteOrigen[0] ;
            A112Tran_CodBodeOrigen = H009E2_A112Tran_CodBodeOrigen[0] ;
            A109Tran_CodAlmaOrigen = H009E2_A109Tran_CodAlmaOrigen[0] ;
            A110Tran_ModuloOrigen = H009E2_A110Tran_ModuloOrigen[0] ;
            A754Tran_CuentaResponsabilidad = H009E2_A754Tran_CuentaResponsabilidad[0] ;
            n754Tran_CuentaResponsabilidad = H009E2_n754Tran_CuentaResponsabilidad[0] ;
            A708Tran_SolicitaRegionDestino = H009E2_A708Tran_SolicitaRegionDestino[0] ;
            n708Tran_SolicitaRegionDestino = H009E2_n708Tran_SolicitaRegionDestino[0] ;
            A707Tran_SolicitaCCDestino = H009E2_A707Tran_SolicitaCCDestino[0] ;
            n707Tran_SolicitaCCDestino = H009E2_n707Tran_SolicitaCCDestino[0] ;
            A482Tran_TipoElemento = H009E2_A482Tran_TipoElemento[0] ;
            A499Tran_CodTipoElemento = H009E2_A499Tran_CodTipoElemento[0] ;
            n499Tran_CodTipoElemento = H009E2_n499Tran_CodTipoElemento[0] ;
            A479Tran_IndCurso = H009E2_A479Tran_IndCurso[0] ;
            n479Tran_IndCurso = H009E2_n479Tran_IndCurso[0] ;
            A481Tran_IndE_S = H009E2_A481Tran_IndE_S[0] ;
            n481Tran_IndE_S = H009E2_n481Tran_IndE_S[0] ;
            A478Tran_IndAreadante = H009E2_A478Tran_IndAreadante[0] ;
            n478Tran_IndAreadante = H009E2_n478Tran_IndAreadante[0] ;
            A381Tran_DescripcionMovimiento = H009E2_A381Tran_DescripcionMovimiento[0] ;
            n381Tran_DescripcionMovimiento = H009E2_n381Tran_DescripcionMovimiento[0] ;
            A49Tran_CodigoMovimiento = H009E2_A49Tran_CodigoMovimiento[0] ;
            A594Tran_RegionAbrev = H009E2_A594Tran_RegionAbrev[0] ;
            n594Tran_RegionAbrev = H009E2_n594Tran_RegionAbrev[0] ;
            A422Tran_RegionDescripcion = H009E2_A422Tran_RegionDescripcion[0] ;
            n422Tran_RegionDescripcion = H009E2_n422Tran_RegionDescripcion[0] ;
            A421Tran_RegionCodigo = H009E2_A421Tran_RegionCodigo[0] ;
            n421Tran_RegionCodigo = H009E2_n421Tran_RegionCodigo[0] ;
            A57Tran_RegionId = H009E2_A57Tran_RegionId[0] ;
            n57Tran_RegionId = H009E2_n57Tran_RegionId[0] ;
            A420Tran_CentroCostoDescripcion = H009E2_A420Tran_CentroCostoDescripcion[0] ;
            n420Tran_CentroCostoDescripcion = H009E2_n420Tran_CentroCostoDescripcion[0] ;
            A419Tran_CentroCostoCodigo = H009E2_A419Tran_CentroCostoCodigo[0] ;
            n419Tran_CentroCostoCodigo = H009E2_n419Tran_CentroCostoCodigo[0] ;
            A48Tran_CentroCostoId = H009E2_A48Tran_CentroCostoId[0] ;
            A418Tran_UsuarioNombre = H009E2_A418Tran_UsuarioNombre[0] ;
            n418Tran_UsuarioNombre = H009E2_n418Tran_UsuarioNombre[0] ;
            A417Tran_UsuarioCodigo = H009E2_A417Tran_UsuarioCodigo[0] ;
            n417Tran_UsuarioCodigo = H009E2_n417Tran_UsuarioCodigo[0] ;
            A47Tran_UsuarioId = H009E2_A47Tran_UsuarioId[0] ;
            n47Tran_UsuarioId = H009E2_n47Tran_UsuarioId[0] ;
            A55Tran_FechaRegistro = H009E2_A55Tran_FechaRegistro[0] ;
            A46Tran_Id = H009E2_A46Tran_Id[0] ;
            A416Tran_Observaciones = H009E2_A416Tran_Observaciones[0] ;
            n416Tran_Observaciones = H009E2_n416Tran_Observaciones[0] ;
            A859Tran_EntidadGobierno = H009E2_A859Tran_EntidadGobierno[0] ;
            n859Tran_EntidadGobierno = H009E2_n859Tran_EntidadGobierno[0] ;
   ...
   {
      /* Using cursor H009E3 */
      pr_default.execute(1, new Object[] {new Short(AV7Tran_Nro_Documento)});
   ...
   public void strup9E0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV7Tran_Nro_Documento = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV7Tran_Nro_Documento"), ",", ".")) ;
   ...
   public void e129E2( )
   {
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext, !bGXsfl_20_Refreshing);
      edtTran_Nro_Documento_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtTran_Nro_Documento_Internalname, "Visible", GXutil.ltrim( GXutil.str( edtTran_Nro_Documento_Visible, 5, 0)), true);
   ...
   public void S112( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributename( "Tran_Nro_Documento" );
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( GXutil.str( AV7Tran_Nro_Documento, 4, 0) );
   ...
   {
      AV7Tran_Nro_Documento = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Tran_Nro_Documento", GXutil.ltrim( GXutil.str( AV7Tran_Nro_Documento, 4, 0)));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV7Tran_Nro_Documento = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "alm_documentosdocumentoswc");
      ...
      {
         AV7Tran_Nro_Documento = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Tran_Nro_Documento", GXutil.ltrim( GXutil.str( AV7Tran_Nro_Documento, 4, 0)));
      }
      wcpOAV7Tran_Nro_Documento = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV7Tran_Nro_Documento"), ",", ".")) ;
      if ( ! GetJustCreated( ) && ( ( AV7Tran_Nro_Documento != wcpOAV7Tran_Nro_Documento ) ) )
      {
         setjustcreated();
      }
      wcpOAV7Tran_Nro_Documento = AV7Tran_Nro_Documento ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV7Tran_Nro_Documento = httpContext.cgiGet( sPrefix+"AV7Tran_Nro_Documento_CTRL") ;
      if ( GXutil.len( sCtrlAV7Tran_Nro_Documento) > 0 )
      {
         AV7Tran_Nro_Documento = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlAV7Tran_Nro_Documento), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Tran_Nro_Documento", GXutil.ltrim( GXutil.str( AV7Tran_Nro_Documento, 4, 0)));
      }
      else
      {
         AV7Tran_Nro_Documento = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV7Tran_Nro_Documento_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Tran_Nro_Documento_PARM", GXutil.ltrim( localUtil.ntoc( AV7Tran_Nro_Documento, (byte)(4), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV7Tran_Nro_Documento)) > 0 )
      {
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Tran_Nro_Documento_CTRL", GXutil.rtrim( sCtrlAV7Tran_Nro_Documento));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414115370");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("alm_documentosdocumentoswc.js", "?201861414115370");
      }
   ...
   public void sendrow_202( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbTran_TipoIngreso,cmbTran_TipoIngreso.getInternalname(),GXutil.trim( GXutil.str( A54Tran_TipoIngreso, 11, 0)),new Integer(1),cmbTran_TipoIngreso.getJsonclick(),new Integer(0),"'"+sPrefix+"'"+",false,"+"'"+""+"'","int","",new Integer(-1),new Integer(0),new Integer(1),new Integer(0),new Integer(0),"px",new Integer(0),"px","","Attribute","WWColumn WWOptionalColumn","","",new Boolean(true)});
         ...
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbTran_EntidadGobierno,cmbTran_EntidadGobierno.getInternalname(),GXutil.rtrim( A859Tran_EntidadGobierno),new Integer(1),cmbTran_EntidadGobierno.getJsonclick(),new Integer(0),"'"+sPrefix+"'"+",false,"+"'"+""+"'","svchar","",new Integer(-1),new Integer(0),new Integer(1),new Integer(0),new Integer(0),"px",new Integer(0),"px","","Attribute","WWColumn WWOptionalColumn","","",new Boolean(true)});
   ...
   public void init_default_properties( )
   {
      ...
      edtTran_Nro_Documento_Internalname = sPrefix+"TRAN_NRO_DOCUMENTO" ;
   ...
   public void initialize_properties( )
   {
      ...
      edtTran_Nro_Documento_Visible = 1 ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Tran_Nro_Documento',fld:'vTRAN_NRO_DOCUMENTO',pic:'ZZZ9',nv:0},{av:'AV12Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV13Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e139E2',iparms:[{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtTran_ConsecutivoCC_Link',ctrl:'TRAN_CONSECUTIVOCC',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e119E2',iparms:[{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H009E2_A416Tran_Observaciones = new String[] {""} ;
      H009E2_n416Tran_Observaciones = new boolean[] {false} ;
      H009E2_A827Tran_Nro_Documento = new short[1] ;
      H009E2_A859Tran_EntidadGobierno = new String[] {""} ;
      H009E2_n859Tran_EntidadGobierno = new boolean[] {false} ;
      H009E2_A758Tran_TablaResponsabilidad = new short[1] ;
      H009E2_n758Tran_TablaResponsabilidad = new boolean[] {false} ;
      H009E2_A720Tran_FechaResponsabilidad = new java.util.Date[] {GXutil.nullDate()} ;
      H009E2_n720Tran_FechaResponsabilidad = new boolean[] {false} ;
      H009E2_A719Tran_TransaccResponsabilidad = new long[1] ;
      H009E2_n719Tran_TransaccResponsabilidad = new boolean[] {false} ;
      H009E2_A721Tran_NombreCuentadanteResponsa = new String[] {""} ;
      H009E2_n721Tran_NombreCuentadanteResponsa = new boolean[] {false} ;
      H009E2_A759Tran_CedulaResponsabilidad = new long[1] ;
      H009E2_n759Tran_CedulaResponsabilidad = new boolean[] {false} ;
      H009E2_A56Tran_IdCuentadanteResponsabili = new long[1] ;
      H009E2_n56Tran_IdCuentadanteResponsabili = new boolean[] {false} ;
      H009E2_A670Tran_ObservacionesAnula = new String[] {""} ;
      H009E2_n670Tran_ObservacionesAnula = new boolean[] {false} ;
      H009E2_A669Tran_FechaEliminaoAnula = new java.util.Date[] {GXutil.nullDate()} ;
      H009E2_n669Tran_FechaEliminaoAnula = new boolean[] {false} ;
      H009E2_A668Tran_UsuarioEliminaoAnula = new String[] {""} ;
      H009E2_n668Tran_UsuarioEliminaoAnula = new boolean[] {false} ;
      H009E2_A667Tran_NumeroGrupo = new short[1] ;
      H009E2_n667Tran_NumeroGrupo = new boolean[] {false} ;
      H009E2_A568Tran_CantidadPadres = new int[1] ;
      H009E2_n568Tran_CantidadPadres = new boolean[] {false} ;
      H009E2_A527Tran_TipoEntra = new String[] {""} ;
      H009E2_n527Tran_TipoEntra = new boolean[] {false} ;
      H009E2_A524Tran_Detalle = new String[] {""} ;
      H009E2_n524Tran_Detalle = new boolean[] {false} ;
      H009E2_A608Tran_RegionAbrevDestino = new String[] {""} ;
      H009E2_n608Tran_RegionAbrevDestino = new boolean[] {false} ;
      H009E2_A520Tran_RegionDescripcionDestino = new String[] {""} ;
      H009E2_n520Tran_RegionDescripcionDestino = new boolean[] {false} ;
      H009E2_A519Tran_RegionCodigoDestino = new short[1] ;
      H009E2_n519Tran_RegionCodigoDestino = new boolean[] {false} ;
      H009E2_A518Tran_RegionIdDestino = new long[1] ;
      H009E2_n518Tran_RegionIdDestino = new boolean[] {false} ;
      H009E2_A517Tran_CentroCostoDescripcionDes = new String[] {""} ;
      H009E2_n517Tran_CentroCostoDescripcionDes = new boolean[] {false} ;
      H009E2_A516Tran_CentroCostoCodigoDestino = new String[] {""} ;
      H009E2_n516Tran_CentroCostoCodigoDestino = new boolean[] {false} ;
      H009E2_A50Tran_CentroCostoIdDestino = new long[1] ;
      H009E2_n50Tran_CentroCostoIdDestino = new boolean[] {false} ;
      H009E2_A515Tran_FechaIngreso = new java.util.Date[] {GXutil.nullDate()} ;
      H009E2_n515Tran_FechaIngreso = new boolean[] {false} ;
      H009E2_A514Tran_NumeroIngreso = new String[] {""} ;
      H009E2_n514Tran_NumeroIngreso = new boolean[] {false} ;
      H009E2_A756Tran_Abreviado = new String[] {""} ;
      H009E2_n756Tran_Abreviado = new boolean[] {false} ;
      H009E2_A672Tran_NombreIngreso = new String[] {""} ;
      H009E2_n672Tran_NombreIngreso = new boolean[] {false} ;
      H009E2_A54Tran_TipoIngreso = new long[1] ;
      H009E2_n54Tran_TipoIngreso = new boolean[] {false} ;
      H009E2_A513Tran_ConsecutivoCC = new long[1] ;
      H009E2_n513Tran_ConsecutivoCC = new boolean[] {false} ;
      H009E2_A391Tran_UsuarioRatifica = new String[] {""} ;
      H009E2_n391Tran_UsuarioRatifica = new boolean[] {false} ;
      H009E2_A390Tran_FechaRatificacion = new java.util.Date[] {GXutil.nullDate()} ;
      H009E2_n390Tran_FechaRatificacion = new boolean[] {false} ;
      H009E2_A58Tran_Estado = new String[] {""} ;
      H009E2_n58Tran_Estado = new boolean[] {false} ;
      H009E2_A498Tran_NumeroLineas = new long[1] ;
      H009E2_n498Tran_NumeroLineas = new boolean[] {false} ;
      H009E2_A483Tran_ValorTransaccion = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H009E2_n483Tran_ValorTransaccion = new boolean[] {false} ;
      H009E2_A408Tran_CursoCodigo = new String[] {""} ;
      H009E2_n408Tran_CursoCodigo = new boolean[] {false} ;
      H009E2_A407Tran_AreadanteCodigo = new String[] {""} ;
      H009E2_n407Tran_AreadanteCodigo = new boolean[] {false} ;
      H009E2_A715Tran_EmailCuentadanteDestino = new String[] {""} ;
      H009E2_n715Tran_EmailCuentadanteDestino = new boolean[] {false} ;
      H009E2_A704Tran_CedulaCuentadanteDestino = new long[1] ;
      H009E2_n704Tran_CedulaCuentadanteDestino = new boolean[] {false} ;
      H009E2_A389Tran_NombCuentadanteDestino = new String[] {""} ;
      H009E2_n389Tran_NombCuentadanteDestino = new boolean[] {false} ;
      H009E2_A52Tran_IdCuentadanteDestino = new long[1] ;
      H009E2_n52Tran_IdCuentadanteDestino = new boolean[] {false} ;
      H009E2_A387Tran_CodBodeDestino = new String[] {""} ;
      H009E2_A111Tran_CodAlmaDestino = new String[] {""} ;
      H009E2_A385Tran_ModuloDestino = new String[] {""} ;
      H009E2_A703Tran_CedulaProveedor = new long[1] ;
      H009E2_n703Tran_CedulaProveedor = new boolean[] {false} ;
      H009E2_A575Tran_NombreProveedor = new String[] {""} ;
      H009E2_n575Tran_NombreProveedor = new boolean[] {false} ;
      H009E2_A53Tran_IdProveedor = new long[1] ;
      H009E2_n53Tran_IdProveedor = new boolean[] {false} ;
      H009E2_A714Tran_EmailCuentadanteOrigen = new String[] {""} ;
      H009E2_n714Tran_EmailCuentadanteOrigen = new boolean[] {false} ;
      H009E2_A702Tran_CedulaCuentadanteOrigen = new long[1] ;
      H009E2_n702Tran_CedulaCuentadanteOrigen = new boolean[] {false} ;
      H009E2_A384Tran_NombCuentadanteOrigen = new String[] {""} ;
      H009E2_n384Tran_NombCuentadanteOrigen = new boolean[] {false} ;
      H009E2_A51Tran_IdCuentadanteOrigen = new long[1] ;
      H009E2_n51Tran_IdCuentadanteOrigen = new boolean[] {false} ;
      H009E2_A112Tran_CodBodeOrigen = new String[] {""} ;
      H009E2_A109Tran_CodAlmaOrigen = new String[] {""} ;
      H009E2_A110Tran_ModuloOrigen = new String[] {""} ;
      H009E2_A754Tran_CuentaResponsabilidad = new String[] {""} ;
      H009E2_n754Tran_CuentaResponsabilidad = new boolean[] {false} ;
      H009E2_A708Tran_SolicitaRegionDestino = new String[] {""} ;
      H009E2_n708Tran_SolicitaRegionDestino = new boolean[] {false} ;
      H009E2_A707Tran_SolicitaCCDestino = new String[] {""} ;
      H009E2_n707Tran_SolicitaCCDestino = new boolean[] {false} ;
      H009E2_A482Tran_TipoElemento = new String[] {""} ;
      H009E2_A499Tran_CodTipoElemento = new long[1] ;
      H009E2_n499Tran_CodTipoElemento = new boolean[] {false} ;
      H009E2_A479Tran_IndCurso = new String[] {""} ;
      H009E2_n479Tran_IndCurso = new boolean[] {false} ;
      H009E2_A481Tran_IndE_S = new String[] {""} ;
      H009E2_n481Tran_IndE_S = new boolean[] {false} ;
      H009E2_A478Tran_IndAreadante = new String[] {""} ;
      H009E2_n478Tran_IndAreadante = new boolean[] {false} ;
      H009E2_A381Tran_DescripcionMovimiento = new String[] {""} ;
      H009E2_n381Tran_DescripcionMovimiento = new boolean[] {false} ;
      H009E2_A49Tran_CodigoMovimiento = new String[] {""} ;
      H009E2_A594Tran_RegionAbrev = new String[] {""} ;
      H009E2_n594Tran_RegionAbrev = new boolean[] {false} ;
      H009E2_A422Tran_RegionDescripcion = new String[] {""} ;
      H009E2_n422Tran_RegionDescripcion = new boolean[] {false} ;
      H009E2_A421Tran_RegionCodigo = new short[1] ;
      H009E2_n421Tran_RegionCodigo = new boolean[] {false} ;
      H009E2_A57Tran_RegionId = new long[1] ;
      H009E2_n57Tran_RegionId = new boolean[] {false} ;
      H009E2_A420Tran_CentroCostoDescripcion = new String[] {""} ;
      H009E2_n420Tran_CentroCostoDescripcion = new boolean[] {false} ;
      H009E2_A419Tran_CentroCostoCodigo = new String[] {""} ;
      H009E2_n419Tran_CentroCostoCodigo = new boolean[] {false} ;
      H009E2_A48Tran_CentroCostoId = new long[1] ;
      H009E2_A418Tran_UsuarioNombre = new String[] {""} ;
      H009E2_n418Tran_UsuarioNombre = new boolean[] {false} ;
      H009E2_A417Tran_UsuarioCodigo = new String[] {""} ;
      H009E2_n417Tran_UsuarioCodigo = new boolean[] {false} ;
      H009E2_A47Tran_UsuarioId = new long[1] ;
      H009E2_n47Tran_UsuarioId = new boolean[] {false} ;
      H009E2_A55Tran_FechaRegistro = new java.util.Date[] {GXutil.nullDate()} ;
      H009E2_A46Tran_Id = new long[1] ;
      ...
      sCtrlAV7Tran_Nro_Documento = "" ;
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.alm_documentosdocumentoswc__default(),
         new Object[] {
             new Object[] {
            H009E2_A416Tran_Observaciones, H009E2_n416Tran_Observaciones, H009E2_A827Tran_Nro_Documento, H009E2_A859Tran_EntidadGobierno, H009E2_n859Tran_EntidadGobierno, H009E2_A758Tran_TablaResponsabilidad, H009E2_n758Tran_TablaResponsabilidad, H009E2_A720Tran_FechaResponsabilidad, H009E2_n720Tran_FechaResponsabilidad, H009E2_A719Tran_TransaccResponsabilidad,
            H009E2_n719Tran_TransaccResponsabilidad, H009E2_A721Tran_NombreCuentadanteResponsa, H009E2_n721Tran_NombreCuentadanteResponsa, H009E2_A759Tran_CedulaResponsabilidad, H009E2_n759Tran_CedulaResponsabilidad, H009E2_A56Tran_IdCuentadanteResponsabili, H009E2_n56Tran_IdCuentadanteResponsabili, H009E2_A670Tran_ObservacionesAnula, H009E2_n670Tran_ObservacionesAnula, H009E2_A669Tran_FechaEliminaoAnula,
            H009E2_n669Tran_FechaEliminaoAnula, H009E2_A668Tran_UsuarioEliminaoAnula, H009E2_n668Tran_UsuarioEliminaoAnula, H009E2_A667Tran_NumeroGrupo, H009E2_n667Tran_NumeroGrupo, H009E2_A568Tran_CantidadPadres, H009E2_n568Tran_CantidadPadres, H009E2_A527Tran_TipoEntra, H009E2_n527Tran_TipoEntra, H009E2_A524Tran_Detalle,
            H009E2_n524Tran_Detalle, H009E2_A608Tran_RegionAbrevDestino, H009E2_n608Tran_RegionAbrevDestino, H009E2_A520Tran_RegionDescripcionDestino, H009E2_n520Tran_RegionDescripcionDestino, H009E2_A519Tran_RegionCodigoDestino, H009E2_n519Tran_RegionCodigoDestino, H009E2_A518Tran_RegionIdDestino, H009E2_n518Tran_RegionIdDestino, H009E2_A517Tran_CentroCostoDescripcionDes,
            H009E2_n517Tran_CentroCostoDescripcionDes, H009E2_A516Tran_CentroCostoCodigoDestino, H009E2_n516Tran_CentroCostoCodigoDestino, H009E2_A50Tran_CentroCostoIdDestino, H009E2_n50Tran_CentroCostoIdDestino, H009E2_A515Tran_FechaIngreso, H009E2_n515Tran_FechaIngreso, H009E2_A514Tran_NumeroIngreso, H009E2_n514Tran_NumeroIngreso, H009E2_A756Tran_Abreviado,
            H009E2_n756Tran_Abreviado, H009E2_A672Tran_NombreIngreso, H009E2_n672Tran_NombreIngreso, H009E2_A54Tran_TipoIngreso, H009E2_n54Tran_TipoIngreso, H009E2_A513Tran_ConsecutivoCC, H009E2_n513Tran_ConsecutivoCC, H009E2_A391Tran_UsuarioRatifica, H009E2_n391Tran_UsuarioRatifica, H009E2_A390Tran_FechaRatificacion,
            H009E2_n390Tran_FechaRatificacion, H009E2_A58Tran_Estado, H009E2_n58Tran_Estado, H009E2_A498Tran_NumeroLineas, H009E2_n498Tran_NumeroLineas, H009E2_A483Tran_ValorTransaccion, H009E2_n483Tran_ValorTransaccion, H009E2_A408Tran_CursoCodigo, H009E2_n408Tran_CursoCodigo, H009E2_A407Tran_AreadanteCodigo,
            H009E2_n407Tran_AreadanteCodigo, H009E2_A715Tran_EmailCuentadanteDestino, H009E2_n715Tran_EmailCuentadanteDestino, H009E2_A704Tran_CedulaCuentadanteDestino, H009E2_n704Tran_CedulaCuentadanteDestino, H009E2_A389Tran_NombCuentadanteDestino, H009E2_n389Tran_NombCuentadanteDestino, H009E2_A52Tran_IdCuentadanteDestino, H009E2_n52Tran_IdCuentadanteDestino, H009E2_A387Tran_CodBodeDestino,
            H009E2_A111Tran_CodAlmaDestino, H009E2_A385Tran_ModuloDestino, H009E2_A703Tran_CedulaProveedor, H009E2_n703Tran_CedulaProveedor, H009E2_A575Tran_NombreProveedor, H009E2_n575Tran_NombreProveedor, H009E2_A53Tran_IdProveedor, H009E2_n53Tran_IdProveedor, H009E2_A714Tran_EmailCuentadanteOrigen, H009E2_n714Tran_EmailCuentadanteOrigen,
            H009E2_A702Tran_CedulaCuentadanteOrigen, H009E2_n702Tran_CedulaCuentadanteOrigen, H009E2_A384Tran_NombCuentadanteOrigen, H009E2_n384Tran_NombCuentadanteOrigen, H009E2_A51Tran_IdCuentadanteOrigen, H009E2_n51Tran_IdCuentadanteOrigen, H009E2_A112Tran_CodBodeOrigen, H009E2_A109Tran_CodAlmaOrigen, H009E2_A110Tran_ModuloOrigen, H009E2_A754Tran_CuentaResponsabilidad,
            H009E2_n754Tran_CuentaResponsabilidad, H009E2_A708Tran_SolicitaRegionDestino, H009E2_n708Tran_SolicitaRegionDestino, H009E2_A707Tran_SolicitaCCDestino, H009E2_n707Tran_SolicitaCCDestino, H009E2_A482Tran_TipoElemento, H009E2_A499Tran_CodTipoElemento, H009E2_n499Tran_CodTipoElemento, H009E2_A479Tran_IndCurso, H009E2_n479Tran_IndCurso,
            H009E2_A481Tran_IndE_S, H009E2_n481Tran_IndE_S, H009E2_A478Tran_IndAreadante, H009E2_n478Tran_IndAreadante, H009E2_A381Tran_DescripcionMovimiento, H009E2_n381Tran_DescripcionMovimiento, H009E2_A49Tran_CodigoMovimiento, H009E2_A594Tran_RegionAbrev, H009E2_n594Tran_RegionAbrev, H009E2_A422Tran_RegionDescripcion,
            H009E2_n422Tran_RegionDescripcion, H009E2_A421Tran_RegionCodigo, H009E2_n421Tran_RegionCodigo, H009E2_A57Tran_RegionId, H009E2_n57Tran_RegionId, H009E2_A420Tran_CentroCostoDescripcion, H009E2_n420Tran_CentroCostoDescripcion, H009E2_A419Tran_CentroCostoCodigo, H009E2_n419Tran_CentroCostoCodigo, H009E2_A48Tran_CentroCostoId,
            H009E2_A418Tran_UsuarioNombre, H009E2_n418Tran_UsuarioNombre, H009E2_A417Tran_UsuarioCodigo, H009E2_n417Tran_UsuarioCodigo, H009E2_A47Tran_UsuarioId, H009E2_n47Tran_UsuarioId, H009E2_A55Tran_FechaRegistro, H009E2_A46Tran_Id
            }
            , new Object[] {
   ...
   private short wcpOAV7Tran_Nro_Documento ;
   private short AV7Tran_Nro_Documento ;
   ...
   private int edtTran_Nro_Documento_Visible ;
   ...
   private String sCtrlAV7Tran_Nro_Documento ;
   ...
   private String[] H009E2_A416Tran_Observaciones ;
   private boolean[] H009E2_n416Tran_Observaciones ;
   private short[] H009E2_A827Tran_Nro_Documento ;
   private String[] H009E2_A859Tran_EntidadGobierno ;
   private boolean[] H009E2_n859Tran_EntidadGobierno ;
   private short[] H009E2_A758Tran_TablaResponsabilidad ;
   private boolean[] H009E2_n758Tran_TablaResponsabilidad ;
   private java.util.Date[] H009E2_A720Tran_FechaResponsabilidad ;
   private boolean[] H009E2_n720Tran_FechaResponsabilidad ;
   private long[] H009E2_A719Tran_TransaccResponsabilidad ;
   private boolean[] H009E2_n719Tran_TransaccResponsabilidad ;
   private String[] H009E2_A721Tran_NombreCuentadanteResponsa ;
   private boolean[] H009E2_n721Tran_NombreCuentadanteResponsa ;
   private long[] H009E2_A759Tran_CedulaResponsabilidad ;
   private boolean[] H009E2_n759Tran_CedulaResponsabilidad ;
   private long[] H009E2_A56Tran_IdCuentadanteResponsabili ;
   private boolean[] H009E2_n56Tran_IdCuentadanteResponsabili ;
   private String[] H009E2_A670Tran_ObservacionesAnula ;
   private boolean[] H009E2_n670Tran_ObservacionesAnula ;
   private java.util.Date[] H009E2_A669Tran_FechaEliminaoAnula ;
   private boolean[] H009E2_n669Tran_FechaEliminaoAnula ;
   private String[] H009E2_A668Tran_UsuarioEliminaoAnula ;
   private boolean[] H009E2_n668Tran_UsuarioEliminaoAnula ;
   private short[] H009E2_A667Tran_NumeroGrupo ;
   private boolean[] H009E2_n667Tran_NumeroGrupo ;
   private int[] H009E2_A568Tran_CantidadPadres ;
   private boolean[] H009E2_n568Tran_CantidadPadres ;
   private String[] H009E2_A527Tran_TipoEntra ;
   private boolean[] H009E2_n527Tran_TipoEntra ;
   private String[] H009E2_A524Tran_Detalle ;
   private boolean[] H009E2_n524Tran_Detalle ;
   private String[] H009E2_A608Tran_RegionAbrevDestino ;
   private boolean[] H009E2_n608Tran_RegionAbrevDestino ;
   private String[] H009E2_A520Tran_RegionDescripcionDestino ;
   private boolean[] H009E2_n520Tran_RegionDescripcionDestino ;
   private short[] H009E2_A519Tran_RegionCodigoDestino ;
   private boolean[] H009E2_n519Tran_RegionCodigoDestino ;
   private long[] H009E2_A518Tran_RegionIdDestino ;
   private boolean[] H009E2_n518Tran_RegionIdDestino ;
   private String[] H009E2_A517Tran_CentroCostoDescripcionDes ;
   private boolean[] H009E2_n517Tran_CentroCostoDescripcionDes ;
   private String[] H009E2_A516Tran_CentroCostoCodigoDestino ;
   private boolean[] H009E2_n516Tran_CentroCostoCodigoDestino ;
   private long[] H009E2_A50Tran_CentroCostoIdDestino ;
   private boolean[] H009E2_n50Tran_CentroCostoIdDestino ;
   private java.util.Date[] H009E2_A515Tran_FechaIngreso ;
   private boolean[] H009E2_n515Tran_FechaIngreso ;
   private String[] H009E2_A514Tran_NumeroIngreso ;
   private boolean[] H009E2_n514Tran_NumeroIngreso ;
   private String[] H009E2_A756Tran_Abreviado ;
   private boolean[] H009E2_n756Tran_Abreviado ;
   private String[] H009E2_A672Tran_NombreIngreso ;
   private boolean[] H009E2_n672Tran_NombreIngreso ;
   private long[] H009E2_A54Tran_TipoIngreso ;
   private boolean[] H009E2_n54Tran_TipoIngreso ;
   private long[] H009E2_A513Tran_ConsecutivoCC ;
   private boolean[] H009E2_n513Tran_ConsecutivoCC ;
   private String[] H009E2_A391Tran_UsuarioRatifica ;
   private boolean[] H009E2_n391Tran_UsuarioRatifica ;
   private java.util.Date[] H009E2_A390Tran_FechaRatificacion ;
   private boolean[] H009E2_n390Tran_FechaRatificacion ;
   private String[] H009E2_A58Tran_Estado ;
   private boolean[] H009E2_n58Tran_Estado ;
   private long[] H009E2_A498Tran_NumeroLineas ;
   private boolean[] H009E2_n498Tran_NumeroLineas ;
   private java.math.BigDecimal[] H009E2_A483Tran_ValorTransaccion ;
   private boolean[] H009E2_n483Tran_ValorTransaccion ;
   private String[] H009E2_A408Tran_CursoCodigo ;
   private boolean[] H009E2_n408Tran_CursoCodigo ;
   private String[] H009E2_A407Tran_AreadanteCodigo ;
   private boolean[] H009E2_n407Tran_AreadanteCodigo ;
   private String[] H009E2_A715Tran_EmailCuentadanteDestino ;
   private boolean[] H009E2_n715Tran_EmailCuentadanteDestino ;
   private long[] H009E2_A704Tran_CedulaCuentadanteDestino ;
   private boolean[] H009E2_n704Tran_CedulaCuentadanteDestino ;
   private String[] H009E2_A389Tran_NombCuentadanteDestino ;
   private boolean[] H009E2_n389Tran_NombCuentadanteDestino ;
   private long[] H009E2_A52Tran_IdCuentadanteDestino ;
   private boolean[] H009E2_n52Tran_IdCuentadanteDestino ;
   private String[] H009E2_A387Tran_CodBodeDestino ;
   private String[] H009E2_A111Tran_CodAlmaDestino ;
   private String[] H009E2_A385Tran_ModuloDestino ;
   private long[] H009E2_A703Tran_CedulaProveedor ;
   private boolean[] H009E2_n703Tran_CedulaProveedor ;
   private String[] H009E2_A575Tran_NombreProveedor ;
   private boolean[] H009E2_n575Tran_NombreProveedor ;
   private long[] H009E2_A53Tran_IdProveedor ;
   private boolean[] H009E2_n53Tran_IdProveedor ;
   private String[] H009E2_A714Tran_EmailCuentadanteOrigen ;
   private boolean[] H009E2_n714Tran_EmailCuentadanteOrigen ;
   private long[] H009E2_A702Tran_CedulaCuentadanteOrigen ;
   private boolean[] H009E2_n702Tran_CedulaCuentadanteOrigen ;
   private String[] H009E2_A384Tran_NombCuentadanteOrigen ;
   private boolean[] H009E2_n384Tran_NombCuentadanteOrigen ;
   private long[] H009E2_A51Tran_IdCuentadanteOrigen ;
   private boolean[] H009E2_n51Tran_IdCuentadanteOrigen ;
   private String[] H009E2_A112Tran_CodBodeOrigen ;
   private String[] H009E2_A109Tran_CodAlmaOrigen ;
   private String[] H009E2_A110Tran_ModuloOrigen ;
   private String[] H009E2_A754Tran_CuentaResponsabilidad ;
   private boolean[] H009E2_n754Tran_CuentaResponsabilidad ;
   private String[] H009E2_A708Tran_SolicitaRegionDestino ;
   private boolean[] H009E2_n708Tran_SolicitaRegionDestino ;
   private String[] H009E2_A707Tran_SolicitaCCDestino ;
   private boolean[] H009E2_n707Tran_SolicitaCCDestino ;
   private String[] H009E2_A482Tran_TipoElemento ;
   private long[] H009E2_A499Tran_CodTipoElemento ;
   private boolean[] H009E2_n499Tran_CodTipoElemento ;
   private String[] H009E2_A479Tran_IndCurso ;
   private boolean[] H009E2_n479Tran_IndCurso ;
   private String[] H009E2_A481Tran_IndE_S ;
   private boolean[] H009E2_n481Tran_IndE_S ;
   private String[] H009E2_A478Tran_IndAreadante ;
   private boolean[] H009E2_n478Tran_IndAreadante ;
   private String[] H009E2_A381Tran_DescripcionMovimiento ;
   private boolean[] H009E2_n381Tran_DescripcionMovimiento ;
   private String[] H009E2_A49Tran_CodigoMovimiento ;
   private String[] H009E2_A594Tran_RegionAbrev ;
   private boolean[] H009E2_n594Tran_RegionAbrev ;
   private String[] H009E2_A422Tran_RegionDescripcion ;
   private boolean[] H009E2_n422Tran_RegionDescripcion ;
   private short[] H009E2_A421Tran_RegionCodigo ;
   private boolean[] H009E2_n421Tran_RegionCodigo ;
   private long[] H009E2_A57Tran_RegionId ;
   private boolean[] H009E2_n57Tran_RegionId ;
   private String[] H009E2_A420Tran_CentroCostoDescripcion ;
   private boolean[] H009E2_n420Tran_CentroCostoDescripcion ;
   private String[] H009E2_A419Tran_CentroCostoCodigo ;
   private boolean[] H009E2_n419Tran_CentroCostoCodigo ;
   private long[] H009E2_A48Tran_CentroCostoId ;
   private String[] H009E2_A418Tran_UsuarioNombre ;
   private boolean[] H009E2_n418Tran_UsuarioNombre ;
   private String[] H009E2_A417Tran_UsuarioCodigo ;
   private boolean[] H009E2_n417Tran_UsuarioCodigo ;
   private long[] H009E2_A47Tran_UsuarioId ;
   private boolean[] H009E2_n47Tran_UsuarioId ;
   private java.util.Date[] H009E2_A55Tran_FechaRegistro ;
   private long[] H009E2_A46Tran_Id ;
...
final  class alm_documentosdocumentoswc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H009E2", "SELECT T2.Tran_Observaciones, T1.Tran_Nro_Documento, T2.Tran_EntidadGobierno, T2.Tran_TablaResponsabilidad, T2.Tran_FechaResponsabilidad, T2.Tran_TransaccResponsabilidad, T3.Cuen_Nombre AS Tran_NombreCuentadanteResponsa, T3.Cuen_Cedula AS Tran_CedulaResponsabilidad, T2.Tran_IdCuentadanteResponsabili AS Tran_IdCuentadanteResponsabili, T2.Tran_ObservacionesAnula, T2.Tran_FechaEliminaoAnula, T2.Tran_UsuarioEliminaoAnula, T2.Tran_NumeroGrupo, T2.Tran_CantidadPadres, T2.Tran_TipoEntra, T2.Tran_Detalle, T4.Regi_Abrev AS Tran_RegionAbrevDestino, T4.Regi_Descripcion AS Tran_RegionDescripcionDestino, T4.Regi_Cod AS Tran_RegionCodigoDestino, T2.Tran_RegionIdDestino AS Tran_RegionIdDestino, T5.Cent_Descripcion AS Tran_CentroCostoDescripcionDes, T5.Cent_Codigo AS Tran_CentroCostoCodigoDestino, T2.Tran_CentroCostoIdDestino AS Tran_CentroCostoIdDestino, T2.Tran_FechaIngreso, T2.Tran_NumeroIngreso, T6.Orig_Descripcion_Abreviado AS Tran_Abreviado, T6.Orig_Descripcion AS Tran_NombreIngreso, T2.Tran_TipoIngreso AS Tran_TipoIngreso, T2.Tran_ConsecutivoCC, T2.Tran_UsuarioRatifica, T2.Tran_FechaRatificacion, T2.Tran_Estado, T2.Tran_NumeroLineas, T2.Tran_ValorTransaccion, T2.Tran_CursoCodigo, T2.Tran_AreadanteCodigo, T7.Cuen_Email AS Tran_EmailCuentadanteDestino, T7.Cuen_Cedula AS Tran_CedulaCuentadanteDestino, T7.Cuen_Nombre AS Tran_NombCuentadanteDestino, T2.Tran_IdCuentadanteDestino AS Tran_IdCuentadanteDestino, T2.Tran_CodBodeDestino, T2.Tran_CodAlmaDestino, T2.Tran_ModuloDestino, T8.Cuen_Cedula AS Tran_CedulaProveedor, T8.Cuen_Nombre AS Tran_NombreProveedor, T2.Tran_IdProveedor AS Tran_IdProveedor, T9.Cuen_Email AS Tran_EmailCuentadanteOrigen, T9.Cuen_Cedula AS Tran_CedulaCuentadanteOrigen, T9.Cuen_Nombre AS Tran_NombCuentadanteOrigen, T2.Tran_IdCuentadanteOrigen AS Tran_IdCuentadanteOrigen, T2.Tran_CodBodeOrigen, T2.Tran_CodAlmaOrigen, T2.Tran_ModuloOrigen, T10.Tpmo_CuentaResponsabilidad AS Tran_CuentaResponsabilidad, T10.Tpmo_SolicitaRegionDestino AS Tran_SolicitaRegionDestino, T10.Tpmo_SolicitaCentroDestino AS Tran_SolicitaCCDestino, T2.Tran_TipoElemento, T10.Tipo_Codigo AS Tran_CodTipoElemento, T10.Tpmo_IngresaCurso AS Tran_IndCurso, T2.Tran_IndE_S AS Tran_IndE_S, T10.Tpmo_IngresaAredante AS Tran_IndAreadante, T10.Tpmo_Descripcion AS Tran_DescripcionMovimiento, T2.Tran_CodigoMovimiento AS Tran_CodigoMovimiento, T11.Regi_Abrev AS Tran_RegionAbrev, T11.Regi_Descripcion AS Tran_RegionDescripcion, T11.Regi_Cod AS Tran_RegionCodigo, T2.Tran_RegionId AS Tran_RegionId, T12.Cent_Descripcion AS Tran_CentroCostoDescripcion, T12.Cent_Codigo AS Tran_CentroCostoCodigo, T2.Tran_CentroCostoId AS Tran_CentroCostoId, T13.Usua_Nombre AS Tran_UsuarioNombre, T13.Usua_Codigo AS Tran_UsuarioCodigo, T2.Tran_UsuarioId AS Tran_UsuarioId, T2.Tran_FechaRegistro, T1.Tran_Id FROM ((((((((((((ALM_TRANSACCION_DOCUM T1 INNER JOIN ALM_TRANSACCION T2 ON T2.Tran_Id = T1.Tran_Id) LEFT JOIN ALM_CUENTADANTE T3 ON T3.Cuen_Identificacion = T2.Tran_IdCuentadanteResponsabili) LEFT JOIN GEN_REGIONAL T4 ON T4.Regi_Id = T2.Tran_RegionIdDestino) LEFT JOIN GEN_CENTROCOSTO T5 ON T5.Cent_Id = T2.Tran_CentroCostoIdDestino) LEFT JOIN ALM_ORIGEN_BIENES T6 ON T6.Orig_Identificador = T2.Tran_TipoIngreso) LEFT JOIN ALM_CUENTADANTE T7 ON T7.Cuen_Identificacion = T2.Tran_IdCuentadanteDestino) LEFT JOIN ALM_CUENTADANTE T8 ON T8.Cuen_Identificacion = T2.Tran_IdProveedor) LEFT JOIN ALM_CUENTADANTE T9 ON T9.Cuen_Identificacion = T2.Tran_IdCuentadanteOrigen) INNER JOIN ALM_TIPO_MOVIMIENTO T10 ON T10.Tpmo_Codigo = T2.Tran_CodigoMovimiento) LEFT JOIN GEN_REGIONAL T11 ON T11.Regi_Id = T2.Tran_RegionId) INNER JOIN GEN_CENTROCOSTO T12 ON T12.Cent_Id = T2.Tran_CentroCostoId) LEFT JOIN SEG_USUARIO T13 ON T13.Usua_Id = T2.Tran_UsuarioId) WHERE T1.Tran_Nro_Documento = ? ORDER BY T1.Tran_Nro_Documento  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H009E3", "SELECT COUNT(*) FROM ((((((((((((ALM_TRANSACCION_DOCUM T1 INNER JOIN ALM_TRANSACCION T2 ON T2.Tran_Id = T1.Tran_Id) LEFT JOIN ALM_CUENTADANTE T12 ON T12.Cuen_Identificacion = T2.Tran_IdCuentadanteResponsabili) LEFT JOIN GEN_REGIONAL T7 ON T7.Regi_Id = T2.Tran_RegionIdDestino) LEFT JOIN GEN_CENTROCOSTO T5 ON T5.Cent_Id = T2.Tran_CentroCostoIdDestino) LEFT JOIN ALM_ORIGEN_BIENES T13 ON T13.Orig_Identificador = T2.Tran_TipoIngreso) LEFT JOIN ALM_CUENTADANTE T11 ON T11.Cuen_Identificacion = T2.Tran_IdCuentadanteDestino) LEFT JOIN ALM_CUENTADANTE T10 ON T10.Cuen_Identificacion = T2.Tran_IdProveedor) LEFT JOIN ALM_CUENTADANTE T9 ON T9.Cuen_Identificacion = T2.Tran_IdCuentadanteOrigen) INNER JOIN ALM_TIPO_MOVIMIENTO T8 ON T8.Tpmo_Codigo = T2.Tran_CodigoMovimiento) LEFT JOIN GEN_REGIONAL T6 ON T6.Regi_Id = T2.Tran_RegionId) INNER JOIN GEN_CENTROCOSTO T4 ON T4.Cent_Id = T2.Tran_CentroCostoId) LEFT JOIN SEG_USUARIO T3 ON T3.Usua_Id = T2.Tran_UsuarioId) WHERE T1.Tran_Nro_Documento = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
                           ...
                           Object[] buf ) throws SQLException
   {
      switch ( cursor )
      {
            case 0 :
               ...
               ((String[]) buf[105])[0] = rslt.getString(57, 1) ;
               ((long[]) buf[106])[0] = rslt.getLong(58) ;
               ((boolean[]) buf[107])[0] = rslt.wasNull();
               ((String[]) buf[108])[0] = rslt.getVarchar(59) ;
               ((boolean[]) buf[109])[0] = rslt.wasNull();
               ((String[]) buf[110])[0] = rslt.getVarchar(60) ;
               ...
               ((String[]) buf[116])[0] = rslt.getVarchar(63) ;
               ((String[]) buf[117])[0] = rslt.getVarchar(64) ;
               ((boolean[]) buf[118])[0] = rslt.wasNull();
               ((String[]) buf[119])[0] = rslt.getVarchar(65) ;
               ((boolean[]) buf[120])[0] = rslt.wasNull();
               ((short[]) buf[121])[0] = rslt.getShort(66) ;
               ((boolean[]) buf[122])[0] = rslt.wasNull();
               ((long[]) buf[123])[0] = rslt.getLong(67) ;
               ...
               ((String[]) buf[130])[0] = rslt.getVarchar(71) ;
               ((boolean[]) buf[131])[0] = rslt.wasNull();
               ((String[]) buf[132])[0] = rslt.getVarchar(72) ;
               ((boolean[]) buf[133])[0] = rslt.wasNull();
               ((long[]) buf[134])[0] = rslt.getLong(73) ;
               ((boolean[]) buf[135])[0] = rslt.wasNull();
               ((java.util.Date[]) buf[136])[0] = rslt.getGXDateTime(74) ;
               ((long[]) buf[137])[0] = rslt.getLong(75) ;
               return;
            case 1 :
