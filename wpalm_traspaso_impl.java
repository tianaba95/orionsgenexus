...
public final  class wpalm_traspaso_impl extends GXDataArea
{
   public wpalm_traspaso_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wpalm_traspaso_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wpalm_traspaso_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            nRC_GXsfl_47 = (short)(GXutil.lval( httpContext.GetNextPar( ))) ;
            nGXsfl_47_idx = (short)(GXutil.lval( httpContext.GetNextPar( ))) ;
            sGXsfl_47_idx = httpContext.GetNextPar( ) ;
            httpContext.setAjaxCallMode();
            if ( ! httpContext.IsValidAjaxCall( true) )
            {
               GxWebError = (byte)(1) ;
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
         {
            ...
            AV49ValorTotal = DecimalUtil.doubleToDec(GXutil.val( httpContext.GetNextPar( ), ".")) ;
            AV53Confirmar = (short)(GXutil.lval( httpContext.GetNextPar( ))) ;
            httpContext.setAjaxCallMode();
            if ( ! httpContext.IsValidAjaxCall( true) )
            {
               GxWebError = (byte)(1) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414221728");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( nGXWrapped != 1 )
      {
         httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.wpalm_traspaso") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13Tran_Id,11,0)))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      /* Send saved values. */
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "nRC_GXsfl_47", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_47, (byte)(4), (byte)(0), ",", "")));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vVALORTOTAL", GXutil.ltrim( localUtil.ntoc( AV49ValorTotal, (byte)(18), (byte)(2), ",", "")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vCONFIRMAR", GXutil.ltrim( localUtil.ntoc( AV53Confirmar, (byte)(4), (byte)(0), ",", "")));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vINVD_ESTADO", AV24Invd_Estado);
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vPLACAPADRE", AV29PlacaPadre);
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vVALORADQUISICION", GXutil.ltrim( localUtil.ntoc( AV47ValorAdquisicion, (byte)(18), (byte)(2), ",", "")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vESPLACAPADRE", GXutil.rtrim( AV23EsPlacaPadre));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vTRAN_IDENTRADA", GXutil.ltrim( localUtil.ntoc( AV45Tran_IdEntrada, (byte)(11), (byte)(0), ",", "")));
   ...
   {
      return formatLink("com.orions2.wpalm_traspaso") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13Tran_Id,11,0))) ;
   }

   public String getPgmname( )
   {
      return "WPALM_TRASPASO" ;
   }
   ...
   public void wb7Q0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavTran_descripcionmovimiento_Internalname, AV52Tran_DescripcionMovimiento, GXutil.rtrim( localUtil.format( AV52Tran_DescripcionMovimiento, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,10);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTran_descripcionmovimiento_Jsonclick, 0, "BlobContentAttSubTitle", "", "", "", 1, edtavTran_descripcionmovimiento_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_WPALM_TRASPASO.htm");
         ...
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 21,'',false,'" + sGXsfl_47_idx + "',0)\"" ;
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavTran_consecutivocc_Internalname, GXutil.ltrim( localUtil.ntoc( AV11TRan_ConsecutivoCC, (byte)(18), (byte)(0), ",", "")), GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV11TRan_ConsecutivoCC), "ZZZZZZZZZZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,21);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTran_consecutivocc_Jsonclick, 0, "Attribute", "", "", "", 1, edtavTran_consecutivocc_Enabled, 1, "text", "", 18, "chr", 1, "row", 18, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "HLP_WPALM_TRASPASO.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavPlaca_Internalname, AV28Placa, GXutil.rtrim( localUtil.format( AV28Placa, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,25);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Número de Placa", edtavPlaca_Jsonclick, 0, "Attribute", "", "", "", 1, edtavPlaca_Enabled, 0, "text", "", 30, "chr", 1, "row", 30, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "Placa", "left", true, "HLP_WPALM_TRASPASO.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         com.orions2.GxWebStd.gx_bitmap( httpContext, imgImage1_Internalname, sImgUrl, "", "", "", context.getHttpContext().getTheme( ), 1, 1, "Seleccionar Devolutivo", "Seleccionar", 0, 0, 0, "px", 0, "px", 0, 0, 5, imgImage1_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'BUSCARINVENTARIO\\'."+"'", StyleString, ClassString, "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.getHttpContext().getImageSrcSet( sImgUrl), "HLP_WPALM_TRASPASO.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 col-md-4 col-lg-3", "left", "top", "", "", "div");
         /* Div Control */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         com.orions2.GxWebStd.gx_html_textarea( httpContext, edtavObservaciones_Internalname, AV26Observaciones, "", TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,33);\"", (short)(0), 1, edtavObservaciones_Enabled, 0, 80, "chr", 3, "row", StyleString, ClassString, "", "200", -1, 0, "", "", (byte)(-1), true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_WPALM_TRASPASO.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Attribute/Variable Label */
         com.orions2.GxWebStd.gx_label_element( httpContext, edtavValorreposicion_Internalname, "Valor Reposicion", "col-sm-3 AttributeLabel", 1, true);
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 37,'',false,'" + sGXsfl_47_idx + "',0)\"" ;
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavValorreposicion_Internalname, GXutil.ltrim( localUtil.ntoc( AV48ValorReposicion, (byte)(24), (byte)(2), ",", "")), ((edtavValorreposicion_Enabled!=0) ? GXutil.ltrim( localUtil.format( AV48ValorReposicion, "$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")) : localUtil.format( AV48ValorReposicion, "$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_decimal( this, '.',',','2');"+";gx.evt.onblur(this,37);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavValorreposicion_Jsonclick, 0, "Attribute", "", "", "", edtavValorreposicion_Visible, edtavValorreposicion_Enabled, 0, "text", "", 24, "chr", 1, "row", 24, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Valor", "right", false, "HLP_WPALM_TRASPASO.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttAgregar_Internalname, "gx.evt.setGridEvt("+GXutil.str( 47, 2, 0)+","+"null"+");", "Agregar", bttAgregar_Jsonclick, 5, "Agregar", "", StyleString, ClassString, bttAgregar_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'AGREGAR\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WPALM_TRASPASO.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 44,'',false,'" + sGXsfl_47_idx + "',0)\"" ;
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavTran_valortransaccion_Internalname, GXutil.ltrim( localUtil.ntoc( AV15Tran_ValorTransaccion, (byte)(24), (byte)(2), ",", "")), ((edtavTran_valortransaccion_Enabled!=0) ? GXutil.ltrim( localUtil.format( AV15Tran_ValorTransaccion, "$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")) : localUtil.format( AV15Tran_ValorTransaccion, "$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_decimal( this, '.',',','2');"+";gx.evt.onblur(this,44);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTran_valortransaccion_Jsonclick, 0, "Attribute", "", "", "", 1, edtavTran_valortransaccion_Enabled, 0, "text", "", 24, "chr", 1, "row", 24, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "HLP_WPALM_TRASPASO.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         {
            httpContext.writeText( "<div id=\""+"Grid1Container"+"DivS\" data-gxgridid=\"47\">") ;
            sStyleString = "" ;
         ...
         else
         {
            ...
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            Grid1Column.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( AV41TDet_Valor_Futuro, (byte)(24), (byte)(2), ".", "")));
            Grid1Column.AddObjectProperty("Enabled", GXutil.ltrim( localUtil.ntoc( edtavTdet_valor_futuro_Enabled, (byte)(5), (byte)(0), ".", "")));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            Grid1Column.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( AV39TDet_Taza, (byte)(3), (byte)(0), ".", "")));
            Grid1Column.AddObjectProperty("Enabled", GXutil.ltrim( localUtil.ntoc( edtavTdet_taza_Enabled, (byte)(5), (byte)(0), ".", "")));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            Grid1Column.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( AV38TDet_Plazo_N, (byte)(2), (byte)(0), ".", "")));
      ...
      if ( wbEnd == 47 )
      {
         ...
         ClassString = "BtnEnter" ;
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttButton1_Internalname, "gx.evt.setGridEvt("+GXutil.str( 47, 2, 0)+","+"null"+");", "Confirmar", bttButton1_Jsonclick, 5, "Confirmar", "", StyleString, ClassString, bttButton1_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'CONFIRMAR\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WPALM_TRASPASO.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttButton2_Internalname, "gx.evt.setGridEvt("+GXutil.str( 47, 2, 0)+","+"null"+");", bttButton2_Caption, bttButton2_Jsonclick, 7, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e117q1_client"+"'", TempTags, "", 2, "HLP_WPALM_TRASPASO.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblUrl_Internalname, lblUrl_Caption, "", "", lblUrl_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", lblUrl_Visible, 1, (short)(1), "HLP_WPALM_TRASPASO.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start7Q2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Traspaso", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
               ...
               if ( GXutil.strcmp(sEvtType, "M") != 0 )
               {
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     if ( GXutil.strcmp(sEvtType, ".") == 0 )
                     {
                        ...
                        else if ( GXutil.strcmp(sEvt, "'BUSCARINVENTARIO'") == 0 )
                        {
                           httpContext.wbHandled = (byte)(1) ;
                           dynload_actions( ) ;
                           /* Execute user event: 'BuscarInventario' */
                           e137Q2 ();
                        }
                     ...
                     else
                     {
                        ...
                        {
                           nGXsfl_47_idx = (short)(GXutil.lval( sEvtType)) ;
                           sGXsfl_47_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_47_idx, 4, 0)), (short)(4), "0") ;
                           ...
                           {
                              AV41TDet_Valor_Futuro = localUtil.ctond( httpContext.cgiGet( edtavTdet_valor_futuro_Internalname)) ;
                           }
                           if ( ( ( localUtil.ctol( httpContext.cgiGet( edtavTdet_taza_Internalname), ",", ".") < 0 ) ) || ( ( localUtil.ctol( httpContext.cgiGet( edtavTdet_taza_Internalname), ",", ".") > 999 ) ) )
                           {
                              ...
                              httpContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
                              wbErr = true ;
                              AV39TDet_Taza = (short)(0) ;
                           }
                           else
                           {
                              AV39TDet_Taza = (short)(localUtil.ctol( httpContext.cgiGet( edtavTdet_taza_Internalname), ",", ".")) ;
                           }
                           if ( ( ( localUtil.ctol( httpContext.cgiGet( edtavTdet_plazo_n_Internalname), ",", ".") < 0 ) ) || ( ( localUtil.ctol( httpContext.cgiGet( edtavTdet_plazo_n_Internalname), ",", ".") > 99 ) ) )
                           {
                              ...
                              httpContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
                              wbErr = true ;
                              AV38TDet_Plazo_N = (byte)(0) ;
                           }
                           else
                           {
                              AV38TDet_Plazo_N = (byte)(localUtil.ctol( httpContext.cgiGet( edtavTdet_plazo_n_Internalname), ",", ".")) ;
                           }
                           ...
                           httpContext.ajax_rsp_assign_prop("", false, edtavAtributos_Internalname, "Bitmap", ((GXutil.strcmp("", AV17Atributos)==0) ? AV62Atributos_GXI : httpContext.convertURL( httpContext.getResourceRelative(AV17Atributos))), !bGXsfl_47_Refreshing);
                           ...
                           httpContext.ajax_rsp_assign_prop("", false, edtavEliminaritem_Internalname, "Bitmap", ((GXutil.strcmp("", AV21EliminarItem)==0) ? AV61Eliminaritem_GXI : httpContext.convertURL( httpContext.getResourceRelative(AV21EliminarItem))), !bGXsfl_47_Refreshing);
   ...
   public void gxnrgrid1_newrow( )
   {
      ...
      {
         sendrow_472( ) ;
         nGXsfl_47_idx = (short)(((subGrid1_Islastpage==1)&&(nGXsfl_47_idx+1>subgrid1_recordsperpage( )) ? 1 : nGXsfl_47_idx+1)) ;
         sGXsfl_47_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_47_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_472( ) ;
      }
   ...
   public void gxgrgrid1_refresh( java.math.BigDecimal AV15Tran_ValorTransaccion ,
                                  ...
                                  java.math.BigDecimal AV49ValorTotal ,
                                  short AV53Confirmar )
   {
      initialize_formulas( ) ;
      com.orions2.GxWebStd.set_html_headers( httpContext, 0, "", "");
   ...
   public void initialize_formulas( )
   {
      ...
      httpContext.ajax_rsp_assign_prop("", false, edtavTdet_consecutivo_Internalname, "Enabled", GXutil.ltrim( GXutil.str( edtavTdet_consecutivo_Enabled, 5, 0)), !bGXsfl_47_Refreshing);
      edtavElem_consecutivo_Enabled = 0 ;
      httpContext.ajax_rsp_assign_prop("", false, edtavElem_consecutivo_Internalname, "Enabled", GXutil.ltrim( GXutil.str( edtavElem_consecutivo_Enabled, 5, 0)), !bGXsfl_47_Refreshing);
      edtavCcata_descripcion_Enabled = 0 ;
      httpContext.ajax_rsp_assign_prop("", false, edtavCcata_descripcion_Internalname, "Enabled", GXutil.ltrim( GXutil.str( edtavCcata_descripcion_Enabled, 5, 0)), !bGXsfl_47_Refreshing);
      edtavTdet_placanumero_Enabled = 0 ;
      httpContext.ajax_rsp_assign_prop("", false, edtavTdet_placanumero_Internalname, "Enabled", GXutil.ltrim( GXutil.str( edtavTdet_placanumero_Enabled, 5, 0)), !bGXsfl_47_Refreshing);
      edtavTdet_espadre_Enabled = 0 ;
      httpContext.ajax_rsp_assign_prop("", false, edtavTdet_espadre_Internalname, "Enabled", GXutil.ltrim( GXutil.str( edtavTdet_espadre_Enabled, 5, 0)), !bGXsfl_47_Refreshing);
      edtavTdet_placapadre_Enabled = 0 ;
      httpContext.ajax_rsp_assign_prop("", false, edtavTdet_placapadre_Internalname, "Enabled", GXutil.ltrim( GXutil.str( edtavTdet_placapadre_Enabled, 5, 0)), !bGXsfl_47_Refreshing);
      edtavTdet_valorunitario_Enabled = 0 ;
      httpContext.ajax_rsp_assign_prop("", false, edtavTdet_valorunitario_Internalname, "Enabled", GXutil.ltrim( GXutil.str( edtavTdet_valorunitario_Enabled, 5, 0)), !bGXsfl_47_Refreshing);
      edtavTdet_otros_costos_Enabled = 0 ;
      httpContext.ajax_rsp_assign_prop("", false, edtavTdet_otros_costos_Internalname, "Enabled", GXutil.ltrim( GXutil.str( edtavTdet_otros_costos_Enabled, 5, 0)), !bGXsfl_47_Refreshing);
      edtavTdet_valor_futuro_Enabled = 0 ;
      httpContext.ajax_rsp_assign_prop("", false, edtavTdet_valor_futuro_Internalname, "Enabled", GXutil.ltrim( GXutil.str( edtavTdet_valor_futuro_Enabled, 5, 0)), !bGXsfl_47_Refreshing);
      edtavTdet_taza_Enabled = 0 ;
      httpContext.ajax_rsp_assign_prop("", false, edtavTdet_taza_Internalname, "Enabled", GXutil.ltrim( GXutil.str( edtavTdet_taza_Enabled, 5, 0)), !bGXsfl_47_Refreshing);
      edtavTdet_plazo_n_Enabled = 0 ;
      httpContext.ajax_rsp_assign_prop("", false, edtavTdet_plazo_n_Internalname, "Enabled", GXutil.ltrim( GXutil.str( edtavTdet_plazo_n_Enabled, 5, 0)), !bGXsfl_47_Refreshing);
      edtavTdet_valor_presente_Enabled = 0 ;
      httpContext.ajax_rsp_assign_prop("", false, edtavTdet_valor_presente_Internalname, "Enabled", GXutil.ltrim( GXutil.str( edtavTdet_valor_presente_Enabled, 5, 0)), !bGXsfl_47_Refreshing);
      edtavTdet_valortotal_Enabled = 0 ;
      httpContext.ajax_rsp_assign_prop("", false, edtavTdet_valortotal_Internalname, "Enabled", GXutil.ltrim( GXutil.str( edtavTdet_valortotal_Enabled, 5, 0)), !bGXsfl_47_Refreshing);
   }
   ...
   public void strup7Q0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV28Placa = httpContext.cgiGet( edtavPlaca_Internalname) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV28Placa", AV28Placa);
         ...
         httpContext.ajax_rsp_assign_attri("", false, "AV26Observaciones", AV26Observaciones);
         if ( ( ( localUtil.ctond( httpContext.cgiGet( edtavValorreposicion_Internalname)).doubleValue() < 0 ) ) || ( ( DecimalUtil.compareTo(localUtil.ctond( httpContext.cgiGet( edtavValorreposicion_Internalname)), DecimalUtil.stringToDec("999999999999999.99")) > 0 ) ) )
         {
            httpContext.GX_msglist.addItem(localUtil.getMessages().getMessage("GXM_badnum"), 1, "vVALORREPOSICION");
            GX_FocusControl = edtavValorreposicion_Internalname ;
            httpContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
            wbErr = true ;
            AV48ValorReposicion = DecimalUtil.ZERO ;
            httpContext.ajax_rsp_assign_attri("", false, "AV48ValorReposicion", GXutil.ltrim( GXutil.str( AV48ValorReposicion, 18, 2)));
         }
         else
         {
            AV48ValorReposicion = localUtil.ctond( httpContext.cgiGet( edtavValorreposicion_Internalname)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV48ValorReposicion", GXutil.ltrim( GXutil.str( AV48ValorReposicion, 18, 2)));
         }
         ...
         /* Read saved values. */
         nRC_GXsfl_47 = (short)(localUtil.ctol( httpContext.cgiGet( "nRC_GXsfl_47"), ",", ".")) ;
         ...
         if ( ! GXutil.checkEncryptedSignature( forbiddenHiddens, hsh, GXKey) )
         {
            ...
            GXutil.writeLog("wpalm_traspaso:[SecurityCheckFailed]"+forbiddenHiddens);
            return  ;
         }
      }
      else
   ...
   {
      /* Start Routine */
      AV53Confirmar = (short)(0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV53Confirmar", GXutil.ltrim( GXutil.str( AV53Confirmar, 4, 0)));
      lblUrl_Visible = 0 ;
      ...
      wpalm_traspaso_impl.this.AV13Tran_Id = GXv_int1[0] ;
      wpalm_traspaso_impl.this.AV9Regi_Id = GXv_int2[0] ;
      wpalm_traspaso_impl.this.AV8Cent_Id = GXv_int3[0] ;
      wpalm_traspaso_impl.this.AV6Alma_Modulo = GXv_char4[0] ;
      wpalm_traspaso_impl.this.AV5Alma_Codigo = GXv_char5[0] ;
      wpalm_traspaso_impl.this.AV7Bode_Codigo = GXv_char6[0] ;
      wpalm_traspaso_impl.this.AV11TRan_ConsecutivoCC = GXv_int7[0] ;
      wpalm_traspaso_impl.this.AV14Tran_IdCuentadanteOrigen = GXv_int8[0] ;
      wpalm_traspaso_impl.this.AV52Tran_DescripcionMovimiento = GXv_char9[0] ;
      wpalm_traspaso_impl.this.AV58Tran_Estado = GXv_char10[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "AV13Tran_Id", GXutil.ltrim( GXutil.str( AV13Tran_Id, 11, 0)));
      ...
      edtavValorreposicion_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop("", false, edtavValorreposicion_Internalname, "Visible", GXutil.ltrim( GXutil.str( edtavValorreposicion_Visible, 5, 0)), true);
   }

   public void e137Q2( )
   {
      /* 'BuscarInventario' Routine */
      httpContext.popup(formatLink("com.orions2.selecinventariocuentadante") + "?" + GXutil.URLEncode(GXutil.rtrim("")) + "," + GXutil.URLEncode(GXutil.rtrim("")) + "," + GXutil.URLEncode(GXutil.rtrim("")) + "," + GXutil.URLEncode(GXutil.rtrim("")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV9Regi_Id,11,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV8Cent_Id,11,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV6Alma_Modulo)) + "," + GXutil.URLEncode(GXutil.rtrim(AV5Alma_Codigo)) + "," + GXutil.URLEncode(GXutil.rtrim(AV7Bode_Codigo)) + "," + GXutil.URLEncode(GXutil.rtrim("")) + "," + GXutil.URLEncode(GXutil.rtrim("")) + "," + GXutil.URLEncode(GXutil.rtrim("")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV14Tran_IdCuentadanteOrigen,18,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV51Tran_CodTipoElemento,18,0))), new Object[] {"AV28Placa","AV27PCata_Descripcion","AV29PlacaPadre","AV23EsPlacaPadre","AV30pObservaciones","AV45Tran_IdEntrada","AV25Nro_Linea",});
      AV26Observaciones = AV30pObservaciones ;
      httpContext.ajax_rsp_assign_attri("", false, "AV26Observaciones", AV26Observaciones);
      AV18Cata_Descripcion = AV27PCata_Descripcion ;
      httpContext.ajax_rsp_assign_attri("", false, "AV18Cata_Descripcion", AV18Cata_Descripcion);
      AV24Invd_Estado = "R" ;
      httpContext.ajax_rsp_assign_attri("", false, "AV24Invd_Estado", AV24Invd_Estado);
      if ( GXutil.strcmp(AV23EsPlacaPadre, "SI") == 0 )
      {
         Alertify1_Type = "success" ;
         httpContext.ajax_rsp_assign_uc_prop("", false, Alertify1_Internalname, "Type", Alertify1_Type);
         Alertify1_Textmessage = "El elemento selecionado es placa padre, se cargarán todos los hijos" ;
      ...
      if ( GXutil.strcmp(AV29PlacaPadre, "") != 0 )
      {
         Alertify1_Type = "success" ;
         httpContext.ajax_rsp_assign_uc_prop("", false, Alertify1_Internalname, "Type", Alertify1_Type);
         Alertify1_Textmessage = "El elemento selecionado tiene placa Padre, se cargará el padre y todos los hijos" ;
         httpContext.ajax_rsp_assign_uc_prop("", false, Alertify1_Internalname, "TextMessage", Alertify1_Textmessage);
         this.executeUsercontrolMethod("", false, "ALERTIFY1Container", "Message", "", new Object[] {});
      }
   }
   ...
   public void e147Q2( )
   {
      ...
      {
         if ( GXutil.strcmp(AV24Invd_Estado, "R") == 0 )
         {
            GXv_int8[0] = AV13Tran_Id ;
            GXv_char10[0] = AV28Placa ;
            GXv_char9[0] = AV29PlacaPadre ;
            GXv_decimal11[0] = AV47ValorAdquisicion ;
            GXv_char6[0] = AV26Observaciones ;
            GXv_char5[0] = AV23EsPlacaPadre ;
            GXv_int7[0] = AV45Tran_IdEntrada ;
            GXv_int12[0] = AV25Nro_Linea ;
            ...
            wpalm_traspaso_impl.this.AV13Tran_Id = GXv_int8[0] ;
            wpalm_traspaso_impl.this.AV28Placa = GXv_char10[0] ;
            wpalm_traspaso_impl.this.AV29PlacaPadre = GXv_char9[0] ;
            wpalm_traspaso_impl.this.AV47ValorAdquisicion = GXv_decimal11[0] ;
            wpalm_traspaso_impl.this.AV26Observaciones = GXv_char6[0] ;
            wpalm_traspaso_impl.this.AV23EsPlacaPadre = GXv_char5[0] ;
            wpalm_traspaso_impl.this.AV45Tran_IdEntrada = GXv_int7[0] ;
            wpalm_traspaso_impl.this.AV25Nro_Linea = GXv_int12[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "AV13Tran_Id", GXutil.ltrim( GXutil.str( AV13Tran_Id, 11, 0)));
            httpContext.ajax_rsp_assign_attri("", false, "AV28Placa", AV28Placa);
            httpContext.ajax_rsp_assign_attri("", false, "AV29PlacaPadre", AV29PlacaPadre);
            httpContext.ajax_rsp_assign_attri("", false, "AV47ValorAdquisicion", GXutil.ltrim( GXutil.str( AV47ValorAdquisicion, 18, 2)));
            httpContext.ajax_rsp_assign_attri("", false, "AV26Observaciones", AV26Observaciones);
            httpContext.ajax_rsp_assign_attri("", false, "AV23EsPlacaPadre", AV23EsPlacaPadre);
            httpContext.ajax_rsp_assign_attri("", false, "AV45Tran_IdEntrada", GXutil.ltrim( GXutil.str( AV45Tran_IdEntrada, 11, 0)));
   ...
   private void e187Q2( )
   {
      ...
      AV17Atributos = context.getHttpContext().getImagePath( "7c63c2b9-483e-4035-b512-febf9186a274", "", context.getHttpContext().getTheme( )) ;
      AV62Atributos_GXI = GXDbFile.pathToUrl( context.getHttpContext().getImagePath( "7c63c2b9-483e-4035-b512-febf9186a274", "", context.getHttpContext().getTheme( )), context.getHttpContext()) ;
      AV15Tran_ValorTransaccion = DecimalUtil.ZERO ;
      httpContext.ajax_rsp_assign_attri("", false, "AV15Tran_ValorTransaccion", GXutil.ltrim( GXutil.str( AV15Tran_ValorTransaccion, 18, 2)));
      /* Using cursor H007Q2 */
      ...
      {
         A49Tran_CodigoMovimiento = H007Q2_A49Tran_CodigoMovimiento[0] ;
         A46Tran_Id = H007Q2_A46Tran_Id[0] ;
         A483Tran_ValorTransaccion = H007Q2_A483Tran_ValorTransaccion[0] ;
         n483Tran_ValorTransaccion = H007Q2_n483Tran_ValorTransaccion[0] ;
         A499Tran_CodTipoElemento = H007Q2_A499Tran_CodTipoElemento[0] ;
         n499Tran_CodTipoElemento = H007Q2_n499Tran_CodTipoElemento[0] ;
         A499Tran_CodTipoElemento = H007Q2_A499Tran_CodTipoElemento[0] ;
         n499Tran_CodTipoElemento = H007Q2_n499Tran_CodTipoElemento[0] ;
      ...
      {
         A37Cata_Codigo = H007Q3_A37Cata_Codigo[0] ;
         A46Tran_Id = H007Q3_A46Tran_Id[0] ;
         A66Elem_Consecutivo = H007Q3_A66Elem_Consecutivo[0] ;
         A487TDet_Cantidad = H007Q3_A487TDet_Cantidad[0] ;
         A488TDet_ValorUnitario = H007Q3_A488TDet_ValorUnitario[0] ;
         A489TDet_ValorTotal = H007Q3_A489TDet_ValorTotal[0] ;
         A490TDet_PlacaNumero = H007Q3_A490TDet_PlacaNumero[0] ;
         n490TDet_PlacaNumero = H007Q3_n490TDet_PlacaNumero[0] ;
         A491TDet_PlacaPadre = H007Q3_A491TDet_PlacaPadre[0] ;
         n491TDet_PlacaPadre = H007Q3_n491TDet_PlacaPadre[0] ;
         A505TDet_EsPadre = H007Q3_A505TDet_EsPadre[0] ;
         A298Cata_Descripcion = H007Q3_A298Cata_Descripcion[0] ;
         A483Tran_ValorTransaccion = H007Q3_A483Tran_ValorTransaccion[0] ;
         n483Tran_ValorTransaccion = H007Q3_n483Tran_ValorTransaccion[0] ;
         A654TDet_Valor_Futuro = H007Q3_A654TDet_Valor_Futuro[0] ;
         n654TDet_Valor_Futuro = H007Q3_n654TDet_Valor_Futuro[0] ;
         A653TDet_Valor_Presente = H007Q3_A653TDet_Valor_Presente[0] ;
         n653TDet_Valor_Presente = H007Q3_n653TDet_Valor_Presente[0] ;
         A656TDet_Plazo_N = H007Q3_A656TDet_Plazo_N[0] ;
         n656TDet_Plazo_N = H007Q3_n656TDet_Plazo_N[0] ;
         A655TDet_Taza = H007Q3_A655TDet_Taza[0] ;
         n655TDet_Taza = H007Q3_n655TDet_Taza[0] ;
         A657TDet_Otros_Costos = H007Q3_A657TDet_Otros_Costos[0] ;
         n657TDet_Otros_Costos = H007Q3_n657TDet_Otros_Costos[0] ;
         A69TDet_Consecutivo = H007Q3_A69TDet_Consecutivo[0] ;
         A483Tran_ValorTransaccion = H007Q3_A483Tran_ValorTransaccion[0] ;
         n483Tran_ValorTransaccion = H007Q3_n483Tran_ValorTransaccion[0] ;
         A37Cata_Codigo = H007Q3_A37Cata_Codigo[0] ;
         A298Cata_Descripcion = H007Q3_A298Cata_Descripcion[0] ;
         ...
         AV49ValorTotal = AV49ValorTotal.add(AV43TDet_ValorTotal) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV49ValorTotal", GXutil.ltrim( GXutil.str( AV49ValorTotal, 18, 2)));
         if ( AV53Confirmar == 1 )
         {
         ...
         {
            httpContext.doAjaxLoad(47, Grid1Row);
         }
   ...
   public void e157Q2( )
   {
      ...
      if ( GXutil.strcmp(AV28Placa, "") != 0 )
      {
         GXv_char10[0] = AV18Cata_Descripcion ;
         GXv_char9[0] = AV29PlacaPadre ;
         GXv_decimal11[0] = AV47ValorAdquisicion ;
         GXv_char6[0] = AV23EsPlacaPadre ;
         GXv_char5[0] = AV24Invd_Estado ;
         GXv_char4[0] = AV22Error ;
         GXv_char13[0] = AV26Observaciones ;
         GXv_int8[0] = AV45Tran_IdEntrada ;
         GXv_int12[0] = AV25Nro_Linea ;
         new com.orions2.verificaplaca(remoteHandle, context).execute( AV28Placa, GXv_char10, GXv_char9, GXv_decimal11, GXv_char6, GXv_char5, AV9Regi_Id, AV8Cent_Id, AV6Alma_Modulo, AV5Alma_Codigo, AV7Bode_Codigo, GXv_char4, GXv_char13, GXv_int8, GXv_int12) ;
         wpalm_traspaso_impl.this.AV18Cata_Descripcion = GXv_char10[0] ;
         wpalm_traspaso_impl.this.AV29PlacaPadre = GXv_char9[0] ;
         wpalm_traspaso_impl.this.AV47ValorAdquisicion = GXv_decimal11[0] ;
         wpalm_traspaso_impl.this.AV23EsPlacaPadre = GXv_char6[0] ;
         wpalm_traspaso_impl.this.AV24Invd_Estado = GXv_char5[0] ;
         wpalm_traspaso_impl.this.AV22Error = GXv_char4[0] ;
         wpalm_traspaso_impl.this.AV26Observaciones = GXv_char13[0] ;
         wpalm_traspaso_impl.this.AV45Tran_IdEntrada = GXv_int8[0] ;
         wpalm_traspaso_impl.this.AV25Nro_Linea = GXv_int12[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "AV28Placa", AV28Placa);
         httpContext.ajax_rsp_assign_attri("", false, "AV18Cata_Descripcion", AV18Cata_Descripcion);
         httpContext.ajax_rsp_assign_attri("", false, "AV29PlacaPadre", AV29PlacaPadre);
         ...
         {
            if ( GXutil.strcmp(AV24Invd_Estado, "P") == 0 )
            {
               Alertify1_Type = "error" ;
               httpContext.ajax_rsp_assign_uc_prop("", false, Alertify1_Internalname, "Type", Alertify1_Type);
         ...
         else if ( GXutil.strcmp(AV22Error, "E") == 0 )
         {
            Alertify1_Type = "error" ;
            httpContext.ajax_rsp_assign_uc_prop("", false, Alertify1_Internalname, "Type", Alertify1_Type);
         ...
         else if ( GXutil.strcmp(AV22Error, "S") == 0 )
         {
            Alertify1_Type = "error" ;
            httpContext.ajax_rsp_assign_uc_prop("", false, Alertify1_Internalname, "Type", Alertify1_Type);
   ...
   public void e197Q2( )
   {
      ...
      wpalm_traspaso_impl.this.AV13Tran_Id = GXv_int8[0] ;
      wpalm_traspaso_impl.this.AV34TDet_Consecutivo = GXv_int7[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "AV13Tran_Id", GXutil.ltrim( GXutil.str( AV13Tran_Id, 11, 0)));
      gxgrgrid1_refresh( AV15Tran_ValorTransaccion, A46Tran_Id, AV13Tran_Id, A483Tran_ValorTransaccion, A499Tran_CodTipoElemento, A69TDet_Consecutivo, A66Elem_Consecutivo, A487TDet_Cantidad, A488TDet_ValorUnitario, A489TDet_ValorTotal, A490TDet_PlacaNumero, A491TDet_PlacaPadre, A505TDet_EsPadre, A298Cata_Descripcion, A654TDet_Valor_Futuro, A653TDet_Valor_Presente, A656TDet_Plazo_N, A655TDet_Taza, A657TDet_Otros_Costos, AV49ValorTotal, AV53Confirmar) ;
      httpContext.doAjaxRefresh();
   }
   ...
   public void e167Q2( )
   {
      ...
      {
         A46Tran_Id = H007Q4_A46Tran_Id[0] ;
         A489TDet_ValorTotal = H007Q4_A489TDet_ValorTotal[0] ;
         AV65GXLvl149 = (byte)(1) ;
   ...
   public void e127Q2( )
   {
      ...
      wpalm_traspaso_impl.this.AV13Tran_Id = GXv_int8[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "AV13Tran_Id", GXutil.ltrim( GXutil.str( AV13Tran_Id, 11, 0)));
      AV55url = formatLink("com.orions2.aptrascuen") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13Tran_Id,11,0))) ;
      AV54WindowsId = (short)(GXutil.random( )*100000) ;
      lblUrl_Caption = "<script language=\"JavaScript\">window.open(\""+GXutil.trim( AV55url)+"\",\""+GXutil.trim( GXutil.str( AV54WindowsId, 10, 0))+"\",\"target=_top,top=10,left=10,width=600,height=500,scrollbars=yes,menubar=no,toolbar=no,resizable=yes,directories=no\");</script>" ;
   ...
   public void e207Q2( )
   {
      ...
      {
         A69TDet_Consecutivo = H007Q5_A69TDet_Consecutivo[0] ;
         A46Tran_Id = H007Q5_A46Tran_Id[0] ;
         A71Tran_Entrada = H007Q5_A71Tran_Entrada[0] ;
         A72Nro_Linea = H007Q5_A72Nro_Linea[0] ;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414221920");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         ...
         httpContext.AddJavascriptSource("wpalm_traspaso.js", "?201861414221920");
         httpContext.AddJavascriptSource("Shared/jquery/jquery-1.9.0.js", "");
         httpContext.AddJavascriptSource("Alertify/js/alertify.min.js", "");
         httpContext.AddJavascriptSource("Alertify/GlobalAlerts.js", "");
         httpContext.AddJavascriptSource("Alertify/AlertifyRender.js", "");
   ...
   {
      edtavTdet_consecutivo_Internalname = "vTDET_CONSECUTIVO_"+sGXsfl_47_idx ;
      edtavElem_consecutivo_Internalname = "vELEM_CONSECUTIVO_"+sGXsfl_47_idx ;
      edtavCcata_descripcion_Internalname = "vCCATA_DESCRIPCION_"+sGXsfl_47_idx ;
      edtavTdet_placanumero_Internalname = "vTDET_PLACANUMERO_"+sGXsfl_47_idx ;
      edtavTdet_espadre_Internalname = "vTDET_ESPADRE_"+sGXsfl_47_idx ;
      edtavTdet_placapadre_Internalname = "vTDET_PLACAPADRE_"+sGXsfl_47_idx ;
      edtavTdet_valorunitario_Internalname = "vTDET_VALORUNITARIO_"+sGXsfl_47_idx ;
      edtavTdet_otros_costos_Internalname = "vTDET_OTROS_COSTOS_"+sGXsfl_47_idx ;
      edtavTdet_valor_futuro_Internalname = "vTDET_VALOR_FUTURO_"+sGXsfl_47_idx ;
      edtavTdet_taza_Internalname = "vTDET_TAZA_"+sGXsfl_47_idx ;
      edtavTdet_plazo_n_Internalname = "vTDET_PLAZO_N_"+sGXsfl_47_idx ;
      edtavTdet_valor_presente_Internalname = "vTDET_VALOR_PRESENTE_"+sGXsfl_47_idx ;
      edtavTdet_valortotal_Internalname = "vTDET_VALORTOTAL_"+sGXsfl_47_idx ;
      edtavAtributos_Internalname = "vATRIBUTOS_"+sGXsfl_47_idx ;
      edtavEliminaritem_Internalname = "vELIMINARITEM_"+sGXsfl_47_idx ;
   }

   public void subsflControlProps_fel_472( )
   {
      edtavTdet_consecutivo_Internalname = "vTDET_CONSECUTIVO_"+sGXsfl_47_fel_idx ;
      edtavElem_consecutivo_Internalname = "vELEM_CONSECUTIVO_"+sGXsfl_47_fel_idx ;
      edtavCcata_descripcion_Internalname = "vCCATA_DESCRIPCION_"+sGXsfl_47_fel_idx ;
      edtavTdet_placanumero_Internalname = "vTDET_PLACANUMERO_"+sGXsfl_47_fel_idx ;
      edtavTdet_espadre_Internalname = "vTDET_ESPADRE_"+sGXsfl_47_fel_idx ;
      edtavTdet_placapadre_Internalname = "vTDET_PLACAPADRE_"+sGXsfl_47_fel_idx ;
      edtavTdet_valorunitario_Internalname = "vTDET_VALORUNITARIO_"+sGXsfl_47_fel_idx ;
      edtavTdet_otros_costos_Internalname = "vTDET_OTROS_COSTOS_"+sGXsfl_47_fel_idx ;
      edtavTdet_valor_futuro_Internalname = "vTDET_VALOR_FUTURO_"+sGXsfl_47_fel_idx ;
      edtavTdet_taza_Internalname = "vTDET_TAZA_"+sGXsfl_47_fel_idx ;
      edtavTdet_plazo_n_Internalname = "vTDET_PLAZO_N_"+sGXsfl_47_fel_idx ;
      edtavTdet_valor_presente_Internalname = "vTDET_VALOR_PRESENTE_"+sGXsfl_47_fel_idx ;
      edtavTdet_valortotal_Internalname = "vTDET_VALORTOTAL_"+sGXsfl_47_fel_idx ;
      edtavAtributos_Internalname = "vATRIBUTOS_"+sGXsfl_47_fel_idx ;
      edtavEliminaritem_Internalname = "vELIMINARITEM_"+sGXsfl_47_fel_idx ;
   }
   ...
   public void sendrow_472( )
   {
      ...
      /* Single line edit */
      TempTags = " " + ((edtavTdet_consecutivo_Enabled!=0)&&(edtavTdet_consecutivo_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 48,'',false,'"+sGXsfl_47_idx+"',47)\"" : " ") ;
      ROClassString = "Attribute" ;
      Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavTdet_consecutivo_Internalname,GXutil.ltrim( localUtil.ntoc( AV34TDet_Consecutivo, (byte)(18), (byte)(0), ",", "")),((edtavTdet_consecutivo_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV34TDet_Consecutivo), "ZZZZZZZZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV34TDet_Consecutivo), "ZZZZZZZZZZZZZZZZZ9")),TempTags+((edtavTdet_consecutivo_Enabled!=0)&&(edtavTdet_consecutivo_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavTdet_consecutivo_Enabled!=0)&&(edtavTdet_consecutivo_Visible!=0) ? " onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,48);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavTdet_consecutivo_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(0),new Integer(edtavTdet_consecutivo_Enabled),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(18),new Integer(0),new Integer(0),new Integer(47),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
      /* Subfile cell */
      if ( Grid1Container.GetWrapped() == 1 )
      {
      ...
      /* Single line edit */
      TempTags = " " + ((edtavElem_consecutivo_Enabled!=0)&&(edtavElem_consecutivo_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 49,'',false,'"+sGXsfl_47_idx+"',47)\"" : " ") ;
      ROClassString = "Attribute" ;
      Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavElem_consecutivo_Internalname,AV20Elem_Consecutivo,"",TempTags+((edtavElem_consecutivo_Enabled!=0)&&(edtavElem_consecutivo_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavElem_consecutivo_Enabled!=0)&&(edtavElem_consecutivo_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(this,49);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavElem_consecutivo_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(-1),new Integer(edtavElem_consecutivo_Enabled),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(9),new Integer(0),new Integer(0),new Integer(47),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
      /* Subfile cell */
      if ( Grid1Container.GetWrapped() == 1 )
      {
         httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      /* Single line edit */
      TempTags = " " + ((edtavCcata_descripcion_Enabled!=0)&&(edtavCcata_descripcion_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 50,'',false,'"+sGXsfl_47_idx+"',47)\"" : " ") ;
      ROClassString = "Attribute" ;
      Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavCcata_descripcion_Internalname,AV19cCata_Descripcion,GXutil.rtrim( localUtil.format( AV19cCata_Descripcion, "@!")),TempTags+((edtavCcata_descripcion_Enabled!=0)&&(edtavCcata_descripcion_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavCcata_descripcion_Enabled!=0)&&(edtavCcata_descripcion_Visible!=0) ? " onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,50);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavCcata_descripcion_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(-1),new Integer(edtavCcata_descripcion_Enabled),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(200),new Integer(0),new Integer(0),new Integer(47),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
      /* Subfile cell */
      if ( Grid1Container.GetWrapped() == 1 )
      {
         httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      /* Single line edit */
      TempTags = " " + ((edtavTdet_placanumero_Enabled!=0)&&(edtavTdet_placanumero_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 51,'',false,'"+sGXsfl_47_idx+"',47)\"" : " ") ;
      ROClassString = "Attribute" ;
      Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavTdet_placanumero_Internalname,AV36TDet_PlacaNumero,"",TempTags+((edtavTdet_placanumero_Enabled!=0)&&(edtavTdet_placanumero_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavTdet_placanumero_Enabled!=0)&&(edtavTdet_placanumero_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(this,51);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavTdet_placanumero_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(-1),new Integer(edtavTdet_placanumero_Enabled),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(47),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
      /* Subfile cell */
      if ( Grid1Container.GetWrapped() == 1 )
      {
      ...
      /* Single line edit */
      TempTags = " " + ((edtavTdet_espadre_Enabled!=0)&&(edtavTdet_espadre_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 52,'',false,'"+sGXsfl_47_idx+"',47)\"" : " ") ;
      ROClassString = "Attribute" ;
      Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavTdet_espadre_Internalname,AV35TDet_EsPadre,"",TempTags+((edtavTdet_espadre_Enabled!=0)&&(edtavTdet_espadre_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavTdet_espadre_Enabled!=0)&&(edtavTdet_espadre_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(this,52);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavTdet_espadre_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(0),new Integer(edtavTdet_espadre_Enabled),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(2),new Integer(0),new Integer(0),new Integer(47),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
      /* Subfile cell */
      if ( Grid1Container.GetWrapped() == 1 )
      {
         httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      /* Single line edit */
      TempTags = " " + ((edtavTdet_placapadre_Enabled!=0)&&(edtavTdet_placapadre_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 53,'',false,'"+sGXsfl_47_idx+"',47)\"" : " ") ;
      ROClassString = "Attribute" ;
      Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavTdet_placapadre_Internalname,AV37TDet_PlacaPadre,"",TempTags+((edtavTdet_placapadre_Enabled!=0)&&(edtavTdet_placapadre_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavTdet_placapadre_Enabled!=0)&&(edtavTdet_placapadre_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(this,53);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavTdet_placapadre_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(-1),new Integer(edtavTdet_placapadre_Enabled),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(47),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
      /* Subfile cell */
      if ( Grid1Container.GetWrapped() == 1 )
      {
      ...
      /* Single line edit */
      TempTags = " " + ((edtavTdet_valorunitario_Enabled!=0)&&(edtavTdet_valorunitario_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 54,'',false,'"+sGXsfl_47_idx+"',47)\"" : " ") ;
      ROClassString = "Attribute" ;
      Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavTdet_valorunitario_Internalname,GXutil.ltrim( localUtil.ntoc( AV44TDet_ValorUnitario, (byte)(22), (byte)(2), ",", "")),((edtavTdet_valorunitario_Enabled!=0) ? GXutil.ltrim( localUtil.format( AV44TDet_ValorUnitario, "ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")) : localUtil.format( AV44TDet_ValorUnitario, "ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),TempTags+((edtavTdet_valorunitario_Enabled!=0)&&(edtavTdet_valorunitario_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavTdet_valorunitario_Enabled!=0)&&(edtavTdet_valorunitario_Visible!=0) ? " onblur=\""+"gx.num.valid_decimal( this, '.',',','2');"+";gx.evt.onblur(this,54);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavTdet_valorunitario_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(-1),new Integer(edtavTdet_valorunitario_Enabled),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(22),new Integer(0),new Integer(0),new Integer(47),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
      /* Subfile cell */
      if ( Grid1Container.GetWrapped() == 1 )
      {
         httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
      ...
      /* Single line edit */
      TempTags = " " + ((edtavTdet_otros_costos_Enabled!=0)&&(edtavTdet_otros_costos_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 55,'',false,'"+sGXsfl_47_idx+"',47)\"" : " ") ;
      ROClassString = "Attribute" ;
      Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavTdet_otros_costos_Internalname,GXutil.ltrim( localUtil.ntoc( AV10TDet_Otros_Costos, (byte)(24), (byte)(2), ",", "")),((edtavTdet_otros_costos_Enabled!=0) ? GXutil.ltrim( localUtil.format( AV10TDet_Otros_Costos, "$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")) : localUtil.format( AV10TDet_Otros_Costos, "$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),TempTags+((edtavTdet_otros_costos_Enabled!=0)&&(edtavTdet_otros_costos_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavTdet_otros_costos_Enabled!=0)&&(edtavTdet_otros_costos_Visible!=0) ? " onblur=\""+"gx.num.valid_decimal( this, '.',',','2');"+";gx.evt.onblur(this,55);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavTdet_otros_costos_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(-1),new Integer(edtavTdet_otros_costos_Enabled),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(24),new Integer(0),new Integer(0),new Integer(47),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
      /* Subfile cell */
      if ( Grid1Container.GetWrapped() == 1 )
      {
         httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
      ...
      /* Single line edit */
      TempTags = " " + ((edtavTdet_valor_futuro_Enabled!=0)&&(edtavTdet_valor_futuro_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 56,'',false,'"+sGXsfl_47_idx+"',47)\"" : " ") ;
      ROClassString = "Attribute" ;
      Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavTdet_valor_futuro_Internalname,GXutil.ltrim( localUtil.ntoc( AV41TDet_Valor_Futuro, (byte)(24), (byte)(2), ",", "")),((edtavTdet_valor_futuro_Enabled!=0) ? GXutil.ltrim( localUtil.format( AV41TDet_Valor_Futuro, "$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")) : localUtil.format( AV41TDet_Valor_Futuro, "$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),TempTags+((edtavTdet_valor_futuro_Enabled!=0)&&(edtavTdet_valor_futuro_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavTdet_valor_futuro_Enabled!=0)&&(edtavTdet_valor_futuro_Visible!=0) ? " onblur=\""+"gx.num.valid_decimal( this, '.',',','2');"+";gx.evt.onblur(this,56);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavTdet_valor_futuro_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(-1),new Integer(edtavTdet_valor_futuro_Enabled),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(24),new Integer(0),new Integer(0),new Integer(47),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
      /* Subfile cell */
      if ( Grid1Container.GetWrapped() == 1 )
      {
         httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
      ...
      /* Single line edit */
      TempTags = " " + ((edtavTdet_taza_Enabled!=0)&&(edtavTdet_taza_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 57,'',false,'"+sGXsfl_47_idx+"',47)\"" : " ") ;
      ROClassString = "Attribute" ;
      Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavTdet_taza_Internalname,GXutil.ltrim( localUtil.ntoc( AV39TDet_Taza, (byte)(3), (byte)(0), ",", "")),((edtavTdet_taza_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV39TDet_Taza), "ZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV39TDet_Taza), "ZZ9")),TempTags+((edtavTdet_taza_Enabled!=0)&&(edtavTdet_taza_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavTdet_taza_Enabled!=0)&&(edtavTdet_taza_Visible!=0) ? " onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,57);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavTdet_taza_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(-1),new Integer(edtavTdet_taza_Enabled),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(3),new Integer(0),new Integer(0),new Integer(47),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
      /* Subfile cell */
      if ( Grid1Container.GetWrapped() == 1 )
      {
         httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
      ...
      /* Single line edit */
      TempTags = " " + ((edtavTdet_plazo_n_Enabled!=0)&&(edtavTdet_plazo_n_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 58,'',false,'"+sGXsfl_47_idx+"',47)\"" : " ") ;
      ROClassString = "Attribute" ;
      Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavTdet_plazo_n_Internalname,GXutil.ltrim( localUtil.ntoc( AV38TDet_Plazo_N, (byte)(2), (byte)(0), ",", "")),((edtavTdet_plazo_n_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV38TDet_Plazo_N), "Z9")) : localUtil.format( DecimalUtil.doubleToDec(AV38TDet_Plazo_N), "Z9")),TempTags+((edtavTdet_plazo_n_Enabled!=0)&&(edtavTdet_plazo_n_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavTdet_plazo_n_Enabled!=0)&&(edtavTdet_plazo_n_Visible!=0) ? " onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,58);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavTdet_plazo_n_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(-1),new Integer(edtavTdet_plazo_n_Enabled),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(2),new Integer(0),new Integer(0),new Integer(47),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
      /* Subfile cell */
      if ( Grid1Container.GetWrapped() == 1 )
      {
         httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
      ...
      /* Single line edit */
      TempTags = " " + ((edtavTdet_valor_presente_Enabled!=0)&&(edtavTdet_valor_presente_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 59,'',false,'"+sGXsfl_47_idx+"',47)\"" : " ") ;
      ROClassString = "Attribute" ;
      Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavTdet_valor_presente_Internalname,GXutil.ltrim( localUtil.ntoc( AV42TDet_Valor_Presente, (byte)(24), (byte)(2), ",", "")),((edtavTdet_valor_presente_Enabled!=0) ? GXutil.ltrim( localUtil.format( AV42TDet_Valor_Presente, "$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")) : localUtil.format( AV42TDet_Valor_Presente, "$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),TempTags+((edtavTdet_valor_presente_Enabled!=0)&&(edtavTdet_valor_presente_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavTdet_valor_presente_Enabled!=0)&&(edtavTdet_valor_presente_Visible!=0) ? " onblur=\""+"gx.num.valid_decimal( this, '.',',','2');"+";gx.evt.onblur(this,59);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavTdet_valor_presente_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(-1),new Integer(edtavTdet_valor_presente_Enabled),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(24),new Integer(0),new Integer(0),new Integer(47),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
      /* Subfile cell */
      if ( Grid1Container.GetWrapped() == 1 )
      {
         httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
      ...
      /* Single line edit */
      TempTags = " " + ((edtavTdet_valortotal_Enabled!=0)&&(edtavTdet_valortotal_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 60,'',false,'"+sGXsfl_47_idx+"',47)\"" : " ") ;
      ROClassString = "Attribute" ;
      Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavTdet_valortotal_Internalname,GXutil.ltrim( localUtil.ntoc( AV43TDet_ValorTotal, (byte)(22), (byte)(2), ",", "")),((edtavTdet_valortotal_Enabled!=0) ? GXutil.ltrim( localUtil.format( AV43TDet_ValorTotal, "ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")) : localUtil.format( AV43TDet_ValorTotal, "ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")),TempTags+((edtavTdet_valortotal_Enabled!=0)&&(edtavTdet_valortotal_Visible!=0) ? " onchange=\"gx.evt.onchange(this)\" " : " ")+((edtavTdet_valortotal_Enabled!=0)&&(edtavTdet_valortotal_Visible!=0) ? " onblur=\""+"gx.num.valid_decimal( this, '.',',','2');"+";gx.evt.onblur(this,60);\"" : " "),"'"+""+"'"+",false,"+"'"+""+"'","","","","",edtavTdet_valortotal_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(-1),new Integer(edtavTdet_valortotal_Enabled),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(22),new Integer(0),new Integer(0),new Integer(47),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
      /* Subfile cell */
      if ( Grid1Container.GetWrapped() == 1 )
      {
      ...
      TempTags = " " + ((edtavAtributos_Enabled!=0)&&(edtavAtributos_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 61,'',false,'',47)\"" : " ") ;
      ...
      /* Active Bitmap Variable */
      TempTags = " " + ((edtavEliminaritem_Enabled!=0)&&(edtavEliminaritem_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 62,'',false,'',47)\"" : " ") ;
   ...
   public void init_default_properties( )
   {
      ...
      edtavValorreposicion_Internalname = "vVALORREPOSICION" ;
   ...
   public void initialize_properties( )
   {
      ...
      edtavValorreposicion_Jsonclick = "" ;
      edtavValorreposicion_Enabled = 1 ;
      edtavValorreposicion_Visible = 1 ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID1_nFirstRecordOnPage',nv:0},{av:'GRID1_nEOF',nv:0},{av:'AV15Tran_ValorTransaccion',fld:'vTRAN_VALORTRANSACCION',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV13Tran_Id',fld:'vTRAN_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'A483Tran_ValorTransaccion',fld:'TRAN_VALORTRANSACCION',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A499Tran_CodTipoElemento',fld:'TRAN_CODTIPOELEMENTO',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'A69TDet_Consecutivo',fld:'TDET_CONSECUTIVO',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'A66Elem_Consecutivo',fld:'ELEM_CONSECUTIVO',pic:'',nv:''},{av:'A487TDet_Cantidad',fld:'TDET_CANTIDAD',pic:'ZZZZZZZZZ9',nv:0},{av:'A488TDet_ValorUnitario',fld:'TDET_VALORUNITARIO',pic:'ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A489TDet_ValorTotal',fld:'TDET_VALORTOTAL',pic:'ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A490TDet_PlacaNumero',fld:'TDET_PLACANUMERO',pic:'',nv:''},{av:'A491TDet_PlacaPadre',fld:'TDET_PLACAPADRE',pic:'',nv:''},{av:'A505TDet_EsPadre',fld:'TDET_ESPADRE',pic:'',nv:''},{av:'A298Cata_Descripcion',fld:'CATA_DESCRIPCION',pic:'@!',nv:''},{av:'A654TDet_Valor_Futuro',fld:'TDET_VALOR_FUTURO',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A653TDet_Valor_Presente',fld:'TDET_VALOR_PRESENTE',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A656TDet_Plazo_N',fld:'TDET_PLAZO_N',pic:'Z9',nv:0},{av:'A655TDet_Taza',fld:'TDET_TAZA',pic:'ZZ9',nv:0},{av:'A657TDet_Otros_Costos',fld:'TDET_OTROS_COSTOS',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'AV49ValorTotal',fld:'vVALORTOTAL',pic:'ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'AV53Confirmar',fld:'vCONFIRMAR',pic:'ZZZ9',nv:0}],oparms:[]}");
      setEventMetadata("'BUSCARINVENTARIO'","{handler:'e137Q2',iparms:[{av:'AV9Regi_Id',fld:'vREGI_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV8Cent_Id',fld:'vCENT_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV6Alma_Modulo',fld:'vALMA_MODULO',pic:'',nv:''},{av:'AV5Alma_Codigo',fld:'vALMA_CODIGO',pic:'',nv:''},{av:'AV7Bode_Codigo',fld:'vBODE_CODIGO',pic:'',nv:''},{av:'AV14Tran_IdCuentadanteOrigen',fld:'vTRAN_IDCUENTADANTEORIGEN',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV51Tran_CodTipoElemento',fld:'vTRAN_CODTIPOELEMENTO',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0}],oparms:[{av:'AV25Nro_Linea',fld:'vNRO_LINEA',pic:'ZZZZZZZ9',nv:0},{av:'AV45Tran_IdEntrada',fld:'vTRAN_IDENTRADA',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV23EsPlacaPadre',fld:'vESPLACAPADRE',pic:'',nv:''},{av:'AV29PlacaPadre',fld:'vPLACAPADRE',pic:'',nv:''},{av:'AV28Placa',fld:'vPLACA',pic:'',nv:''},{av:'AV26Observaciones',fld:'vOBSERVACIONES',pic:'',nv:''},{av:'AV18Cata_Descripcion',fld:'vCATA_DESCRIPCION',pic:'@!',nv:''},{av:'AV24Invd_Estado',fld:'vINVD_ESTADO',pic:'',nv:''},{av:'Alertify1_Type',ctrl:'ALERTIFY1',prop:'Type'},{av:'Alertify1_Textmessage',ctrl:'ALERTIFY1',prop:'TextMessage'}]}");
      setEventMetadata("'AGREGAR'","{handler:'e147Q2',iparms:[{av:'GRID1_nFirstRecordOnPage',nv:0},{av:'GRID1_nEOF',nv:0},{av:'AV15Tran_ValorTransaccion',fld:'vTRAN_VALORTRANSACCION',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV13Tran_Id',fld:'vTRAN_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'A483Tran_ValorTransaccion',fld:'TRAN_VALORTRANSACCION',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A499Tran_CodTipoElemento',fld:'TRAN_CODTIPOELEMENTO',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'A69TDet_Consecutivo',fld:'TDET_CONSECUTIVO',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'A66Elem_Consecutivo',fld:'ELEM_CONSECUTIVO',pic:'',nv:''},{av:'A487TDet_Cantidad',fld:'TDET_CANTIDAD',pic:'ZZZZZZZZZ9',nv:0},{av:'A488TDet_ValorUnitario',fld:'TDET_VALORUNITARIO',pic:'ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A489TDet_ValorTotal',fld:'TDET_VALORTOTAL',pic:'ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A490TDet_PlacaNumero',fld:'TDET_PLACANUMERO',pic:'',nv:''},{av:'A491TDet_PlacaPadre',fld:'TDET_PLACAPADRE',pic:'',nv:''},{av:'A505TDet_EsPadre',fld:'TDET_ESPADRE',pic:'',nv:''},{av:'A298Cata_Descripcion',fld:'CATA_DESCRIPCION',pic:'@!',nv:''},{av:'A654TDet_Valor_Futuro',fld:'TDET_VALOR_FUTURO',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A653TDet_Valor_Presente',fld:'TDET_VALOR_PRESENTE',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A656TDet_Plazo_N',fld:'TDET_PLAZO_N',pic:'Z9',nv:0},{av:'A655TDet_Taza',fld:'TDET_TAZA',pic:'ZZ9',nv:0},{av:'A657TDet_Otros_Costos',fld:'TDET_OTROS_COSTOS',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'AV49ValorTotal',fld:'vVALORTOTAL',pic:'ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'AV53Confirmar',fld:'vCONFIRMAR',pic:'ZZZ9',nv:0},{av:'AV28Placa',fld:'vPLACA',pic:'',nv:''},{av:'AV24Invd_Estado',fld:'vINVD_ESTADO',pic:'',nv:''},{av:'AV29PlacaPadre',fld:'vPLACAPADRE',pic:'',nv:''},{av:'AV47ValorAdquisicion',fld:'vVALORADQUISICION',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'AV26Observaciones',fld:'vOBSERVACIONES',pic:'',nv:''},{av:'AV23EsPlacaPadre',fld:'vESPLACAPADRE',pic:'',nv:''},{av:'AV45Tran_IdEntrada',fld:'vTRAN_IDENTRADA',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV25Nro_Linea',fld:'vNRO_LINEA',pic:'ZZZZZZZ9',nv:0},{av:'AV18Cata_Descripcion',fld:'vCATA_DESCRIPCION',pic:'@!',nv:''}],oparms:[{av:'Alertify1_Type',ctrl:'ALERTIFY1',prop:'Type'},{av:'Alertify1_Textmessage',ctrl:'ALERTIFY1',prop:'TextMessage'},{av:'AV25Nro_Linea',fld:'vNRO_LINEA',pic:'ZZZZZZZ9',nv:0},{av:'AV45Tran_IdEntrada',fld:'vTRAN_IDENTRADA',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV23EsPlacaPadre',fld:'vESPLACAPADRE',pic:'',nv:''},{av:'AV26Observaciones',fld:'vOBSERVACIONES',pic:'',nv:''},{av:'AV47ValorAdquisicion',fld:'vVALORADQUISICION',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'AV29PlacaPadre',fld:'vPLACAPADRE',pic:'',nv:''},{av:'AV28Placa',fld:'vPLACA',pic:'',nv:''},{av:'AV13Tran_Id',fld:'vTRAN_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV18Cata_Descripcion',fld:'vCATA_DESCRIPCION',pic:'@!',nv:''}]}");
      setEventMetadata("GRID1.LOAD","{handler:'e187Q2',iparms:[{av:'AV15Tran_ValorTransaccion',fld:'vTRAN_VALORTRANSACCION',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV13Tran_Id',fld:'vTRAN_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'A483Tran_ValorTransaccion',fld:'TRAN_VALORTRANSACCION',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A499Tran_CodTipoElemento',fld:'TRAN_CODTIPOELEMENTO',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'A69TDet_Consecutivo',fld:'TDET_CONSECUTIVO',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'A66Elem_Consecutivo',fld:'ELEM_CONSECUTIVO',pic:'',nv:''},{av:'A487TDet_Cantidad',fld:'TDET_CANTIDAD',pic:'ZZZZZZZZZ9',nv:0},{av:'A488TDet_ValorUnitario',fld:'TDET_VALORUNITARIO',pic:'ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A489TDet_ValorTotal',fld:'TDET_VALORTOTAL',pic:'ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A490TDet_PlacaNumero',fld:'TDET_PLACANUMERO',pic:'',nv:''},{av:'A491TDet_PlacaPadre',fld:'TDET_PLACAPADRE',pic:'',nv:''},{av:'A505TDet_EsPadre',fld:'TDET_ESPADRE',pic:'',nv:''},{av:'A298Cata_Descripcion',fld:'CATA_DESCRIPCION',pic:'@!',nv:''},{av:'A654TDet_Valor_Futuro',fld:'TDET_VALOR_FUTURO',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A653TDet_Valor_Presente',fld:'TDET_VALOR_PRESENTE',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A656TDet_Plazo_N',fld:'TDET_PLAZO_N',pic:'Z9',nv:0},{av:'A655TDet_Taza',fld:'TDET_TAZA',pic:'ZZ9',nv:0},{av:'A657TDet_Otros_Costos',fld:'TDET_OTROS_COSTOS',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'AV49ValorTotal',fld:'vVALORTOTAL',pic:'ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'AV53Confirmar',fld:'vCONFIRMAR',pic:'ZZZ9',nv:0}],oparms:[{av:'AV21EliminarItem',fld:'vELIMINARITEM',pic:'',nv:''},{av:'AV17Atributos',fld:'vATRIBUTOS',pic:'',nv:''},{av:'AV15Tran_ValorTransaccion',fld:'vTRAN_VALORTRANSACCION',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'AV51Tran_CodTipoElemento',fld:'vTRAN_CODTIPOELEMENTO',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV34TDet_Consecutivo',fld:'vTDET_CONSECUTIVO',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV20Elem_Consecutivo',fld:'vELEM_CONSECUTIVO',pic:'',nv:''},{av:'AV44TDet_ValorUnitario',fld:'vTDET_VALORUNITARIO',pic:'ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'AV43TDet_ValorTotal',fld:'vTDET_VALORTOTAL',pic:'ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'AV36TDet_PlacaNumero',fld:'vTDET_PLACANUMERO',pic:'',nv:''},{av:'AV37TDet_PlacaPadre',fld:'vTDET_PLACAPADRE',pic:'',nv:''},{av:'AV35TDet_EsPadre',fld:'vTDET_ESPADRE',pic:'',nv:''},{av:'AV19cCata_Descripcion',fld:'vCCATA_DESCRIPCION',pic:'@!',nv:''},{av:'AV41TDet_Valor_Futuro',fld:'vTDET_VALOR_FUTURO',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'AV42TDet_Valor_Presente',fld:'vTDET_VALOR_PRESENTE',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'AV38TDet_Plazo_N',fld:'vTDET_PLAZO_N',pic:'Z9',nv:0},{av:'AV39TDet_Taza',fld:'vTDET_TAZA',pic:'ZZ9',nv:0},{av:'AV10TDet_Otros_Costos',fld:'vTDET_OTROS_COSTOS',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'AV49ValorTotal',fld:'vVALORTOTAL',pic:'ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'edtavEliminaritem_Enabled',ctrl:'vELIMINARITEM',prop:'Enabled'},{av:'edtavAtributos_Enabled',ctrl:'vATRIBUTOS',prop:'Enabled'}]}");
      setEventMetadata("VPLACA.ISVALID","{handler:'e157Q2',iparms:[{av:'AV28Placa',fld:'vPLACA',pic:'',nv:''},{av:'AV9Regi_Id',fld:'vREGI_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV8Cent_Id',fld:'vCENT_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV6Alma_Modulo',fld:'vALMA_MODULO',pic:'',nv:''},{av:'AV5Alma_Codigo',fld:'vALMA_CODIGO',pic:'',nv:''},{av:'AV7Bode_Codigo',fld:'vBODE_CODIGO',pic:'',nv:''}],oparms:[{av:'AV25Nro_Linea',fld:'vNRO_LINEA',pic:'ZZZZZZZ9',nv:0},{av:'AV45Tran_IdEntrada',fld:'vTRAN_IDENTRADA',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV26Observaciones',fld:'vOBSERVACIONES',pic:'',nv:''},{av:'AV24Invd_Estado',fld:'vINVD_ESTADO',pic:'',nv:''},{av:'AV23EsPlacaPadre',fld:'vESPLACAPADRE',pic:'',nv:''},{av:'AV47ValorAdquisicion',fld:'vVALORADQUISICION',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'AV29PlacaPadre',fld:'vPLACAPADRE',pic:'',nv:''},{av:'AV18Cata_Descripcion',fld:'vCATA_DESCRIPCION',pic:'@!',nv:''},{av:'Alertify1_Type',ctrl:'ALERTIFY1',prop:'Type'},{av:'Alertify1_Textmessage',ctrl:'ALERTIFY1',prop:'TextMessage'},{av:'AV28Placa',fld:'vPLACA',pic:'',nv:''}]}");
      setEventMetadata("'ELIMINAR ITEM'","{handler:'e197Q2',iparms:[{av:'GRID1_nFirstRecordOnPage',nv:0},{av:'GRID1_nEOF',nv:0},{av:'AV15Tran_ValorTransaccion',fld:'vTRAN_VALORTRANSACCION',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV13Tran_Id',fld:'vTRAN_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'A483Tran_ValorTransaccion',fld:'TRAN_VALORTRANSACCION',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A499Tran_CodTipoElemento',fld:'TRAN_CODTIPOELEMENTO',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'A69TDet_Consecutivo',fld:'TDET_CONSECUTIVO',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'A66Elem_Consecutivo',fld:'ELEM_CONSECUTIVO',pic:'',nv:''},{av:'A487TDet_Cantidad',fld:'TDET_CANTIDAD',pic:'ZZZZZZZZZ9',nv:0},{av:'A488TDet_ValorUnitario',fld:'TDET_VALORUNITARIO',pic:'ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A489TDet_ValorTotal',fld:'TDET_VALORTOTAL',pic:'ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A490TDet_PlacaNumero',fld:'TDET_PLACANUMERO',pic:'',nv:''},{av:'A491TDet_PlacaPadre',fld:'TDET_PLACAPADRE',pic:'',nv:''},{av:'A505TDet_EsPadre',fld:'TDET_ESPADRE',pic:'',nv:''},{av:'A298Cata_Descripcion',fld:'CATA_DESCRIPCION',pic:'@!',nv:''},{av:'A654TDet_Valor_Futuro',fld:'TDET_VALOR_FUTURO',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A653TDet_Valor_Presente',fld:'TDET_VALOR_PRESENTE',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A656TDet_Plazo_N',fld:'TDET_PLAZO_N',pic:'Z9',nv:0},{av:'A655TDet_Taza',fld:'TDET_TAZA',pic:'ZZ9',nv:0},{av:'A657TDet_Otros_Costos',fld:'TDET_OTROS_COSTOS',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'AV49ValorTotal',fld:'vVALORTOTAL',pic:'ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'AV53Confirmar',fld:'vCONFIRMAR',pic:'ZZZ9',nv:0},{av:'AV35TDet_EsPadre',fld:'vTDET_ESPADRE',pic:'',nv:''},{av:'AV37TDet_PlacaPadre',fld:'vTDET_PLACAPADRE',pic:'',nv:''},{av:'AV34TDet_Consecutivo',fld:'vTDET_CONSECUTIVO',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0}],oparms:[{av:'Alertify1_Type',ctrl:'ALERTIFY1',prop:'Type'},{av:'Alertify1_Textmessage',ctrl:'ALERTIFY1',prop:'TextMessage'},{av:'AV34TDet_Consecutivo',fld:'vTDET_CONSECUTIVO',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV13Tran_Id',fld:'vTRAN_ID',pic:'ZZZZZZZZZZ9',nv:0}]}");
      setEventMetadata("'CONFIRMAR'","{handler:'e167Q2',iparms:[{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV13Tran_Id',fld:'vTRAN_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV57valor',fld:'vVALOR',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A489TDet_ValorTotal',fld:'TDET_VALORTOTAL',pic:'ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'AV56SWErrorRati',fld:'vSWERRORRATI',pic:'ZZZ9',nv:0},{av:'AV15Tran_ValorTransaccion',fld:'vTRAN_VALORTRANSACCION',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0}],oparms:[{av:'AV57valor',fld:'vVALOR',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'AV56SWErrorRati',fld:'vSWERRORRATI',pic:'ZZZ9',nv:0},{av:'Alertify1_Type',ctrl:'ALERTIFY1',prop:'Type'},{av:'Alertify1_Textmessage',ctrl:'ALERTIFY1',prop:'TextMessage'}]}");
      setEventMetadata("ALERTIFY1.OK","{handler:'e127Q2',iparms:[{av:'GRID1_nFirstRecordOnPage',nv:0},{av:'GRID1_nEOF',nv:0},{av:'AV15Tran_ValorTransaccion',fld:'vTRAN_VALORTRANSACCION',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV13Tran_Id',fld:'vTRAN_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'A483Tran_ValorTransaccion',fld:'TRAN_VALORTRANSACCION',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A499Tran_CodTipoElemento',fld:'TRAN_CODTIPOELEMENTO',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'A69TDet_Consecutivo',fld:'TDET_CONSECUTIVO',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'A66Elem_Consecutivo',fld:'ELEM_CONSECUTIVO',pic:'',nv:''},{av:'A487TDet_Cantidad',fld:'TDET_CANTIDAD',pic:'ZZZZZZZZZ9',nv:0},{av:'A488TDet_ValorUnitario',fld:'TDET_VALORUNITARIO',pic:'ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A489TDet_ValorTotal',fld:'TDET_VALORTOTAL',pic:'ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A490TDet_PlacaNumero',fld:'TDET_PLACANUMERO',pic:'',nv:''},{av:'A491TDet_PlacaPadre',fld:'TDET_PLACAPADRE',pic:'',nv:''},{av:'A505TDet_EsPadre',fld:'TDET_ESPADRE',pic:'',nv:''},{av:'A298Cata_Descripcion',fld:'CATA_DESCRIPCION',pic:'@!',nv:''},{av:'A654TDet_Valor_Futuro',fld:'TDET_VALOR_FUTURO',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A653TDet_Valor_Presente',fld:'TDET_VALOR_PRESENTE',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'A656TDet_Plazo_N',fld:'TDET_PLAZO_N',pic:'Z9',nv:0},{av:'A655TDet_Taza',fld:'TDET_TAZA',pic:'ZZ9',nv:0},{av:'A657TDet_Otros_Costos',fld:'TDET_OTROS_COSTOS',pic:'$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'AV49ValorTotal',fld:'vVALORTOTAL',pic:'ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99',nv:0.0},{av:'AV53Confirmar',fld:'vCONFIRMAR',pic:'ZZZ9',nv:0}],oparms:[{av:'AV13Tran_Id',fld:'vTRAN_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'lblUrl_Caption',ctrl:'URL',prop:'Caption'},{ctrl:'AGREGAR',prop:'Visible'},{ctrl:'BUTTON1',prop:'Visible'},{ctrl:'BUTTON2',prop:'Caption'},{av:'AV53Confirmar',fld:'vCONFIRMAR',pic:'ZZZ9',nv:0}]}");
      setEventMetadata("'ATRIBUTOS'","{handler:'e207Q2',iparms:[{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV13Tran_Id',fld:'vTRAN_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'A69TDet_Consecutivo',fld:'TDET_CONSECUTIVO',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV34TDet_Consecutivo',fld:'vTDET_CONSECUTIVO',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'A71Tran_Entrada',fld:'TRAN_ENTRADA',pic:'ZZZZZZZZZZ9',nv:0},{av:'A72Nro_Linea',fld:'NRO_LINEA',pic:'ZZZZZZZ9',nv:0}],oparms:[{av:'AV25Nro_Linea',fld:'vNRO_LINEA',pic:'ZZZZZZZ9',nv:0}]}");
      setEventMetadata("'CANCELAR'","{handler:'e117Q1',iparms:[],oparms:[]}");
   }
   ...
   public void initialize( )
   {
      ...
      AV49ValorTotal = DecimalUtil.ZERO ;
      GXKey = "" ;
      forbiddenHiddens = "" ;
      AV52Tran_DescripcionMovimiento = "" ;
      ...
      AV24Invd_Estado = "" ;
      AV29PlacaPadre = "" ;
      AV47ValorAdquisicion = DecimalUtil.ZERO ;
      AV23EsPlacaPadre = "" ;
      ...
      AV58Tran_Estado = "" ;
      AV30pObservaciones = "" ;
      AV27PCata_Descripcion = "" ;
      scmdbuf = "" ;
      H007Q2_A49Tran_CodigoMovimiento = new String[] {""} ;
      H007Q2_A46Tran_Id = new long[1] ;
      H007Q2_A483Tran_ValorTransaccion = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H007Q2_n483Tran_ValorTransaccion = new boolean[] {false} ;
      H007Q2_A499Tran_CodTipoElemento = new long[1] ;
      H007Q2_n499Tran_CodTipoElemento = new boolean[] {false} ;
      A49Tran_CodigoMovimiento = "" ;
      H007Q3_A37Cata_Codigo = new String[] {""} ;
      H007Q3_A46Tran_Id = new long[1] ;
      H007Q3_A66Elem_Consecutivo = new String[] {""} ;
      H007Q3_A487TDet_Cantidad = new long[1] ;
      H007Q3_A488TDet_ValorUnitario = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H007Q3_A489TDet_ValorTotal = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H007Q3_A490TDet_PlacaNumero = new String[] {""} ;
      H007Q3_n490TDet_PlacaNumero = new boolean[] {false} ;
      H007Q3_A491TDet_PlacaPadre = new String[] {""} ;
      H007Q3_n491TDet_PlacaPadre = new boolean[] {false} ;
      H007Q3_A505TDet_EsPadre = new String[] {""} ;
      H007Q3_A298Cata_Descripcion = new String[] {""} ;
      H007Q3_A483Tran_ValorTransaccion = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H007Q3_n483Tran_ValorTransaccion = new boolean[] {false} ;
      H007Q3_A654TDet_Valor_Futuro = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H007Q3_n654TDet_Valor_Futuro = new boolean[] {false} ;
      H007Q3_A653TDet_Valor_Presente = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H007Q3_n653TDet_Valor_Presente = new boolean[] {false} ;
      H007Q3_A656TDet_Plazo_N = new byte[1] ;
      H007Q3_n656TDet_Plazo_N = new boolean[] {false} ;
      H007Q3_A655TDet_Taza = new short[1] ;
      H007Q3_n655TDet_Taza = new boolean[] {false} ;
      H007Q3_A657TDet_Otros_Costos = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H007Q3_n657TDet_Otros_Costos = new boolean[] {false} ;
      H007Q3_A69TDet_Consecutivo = new long[1] ;
      A37Cata_Codigo = "" ;
      ...
      GXv_int12 = new int [1] ;
      GXv_int7 = new long [1] ;
      H007Q4_A69TDet_Consecutivo = new long[1] ;
      H007Q4_A46Tran_Id = new long[1] ;
      H007Q4_A489TDet_ValorTotal = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      GXv_int8 = new long [1] ;
      AV55url = "" ;
      H007Q5_A69TDet_Consecutivo = new long[1] ;
      H007Q5_A46Tran_Id = new long[1] ;
      H007Q5_A71Tran_Entrada = new long[1] ;
      H007Q5_A72Nro_Linea = new int[1] ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.wpalm_traspaso__default(),
         new Object[] {
             new Object[] {
            H007Q2_A49Tran_CodigoMovimiento, H007Q2_A46Tran_Id, H007Q2_A483Tran_ValorTransaccion, H007Q2_n483Tran_ValorTransaccion, H007Q2_A499Tran_CodTipoElemento, H007Q2_n499Tran_CodTipoElemento
            }
            , new Object[] {
            H007Q3_A37Cata_Codigo, H007Q3_A46Tran_Id, H007Q3_A66Elem_Consecutivo, H007Q3_A487TDet_Cantidad, H007Q3_A488TDet_ValorUnitario, H007Q3_A489TDet_ValorTotal, H007Q3_A490TDet_PlacaNumero, H007Q3_n490TDet_PlacaNumero, H007Q3_A491TDet_PlacaPadre, H007Q3_n491TDet_PlacaPadre,
            H007Q3_A505TDet_EsPadre, H007Q3_A298Cata_Descripcion, H007Q3_A483Tran_ValorTransaccion, H007Q3_n483Tran_ValorTransaccion, H007Q3_A654TDet_Valor_Futuro, H007Q3_n654TDet_Valor_Futuro, H007Q3_A653TDet_Valor_Presente, H007Q3_n653TDet_Valor_Presente, H007Q3_A656TDet_Plazo_N, H007Q3_n656TDet_Plazo_N,
            H007Q3_A655TDet_Taza, H007Q3_n655TDet_Taza, H007Q3_A657TDet_Otros_Costos, H007Q3_n657TDet_Otros_Costos, H007Q3_A69TDet_Consecutivo
            }
            , new Object[] {
            H007Q4_A69TDet_Consecutivo, H007Q4_A46Tran_Id, H007Q4_A489TDet_ValorTotal
            }
            , new Object[] {
            H007Q5_A69TDet_Consecutivo, H007Q5_A46Tran_Id, H007Q5_A71Tran_Entrada, H007Q5_A72Nro_Linea
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private int edtavValorreposicion_Enabled ;
   private int edtavValorreposicion_Visible ;
   ...
   private long AV45Tran_IdEntrada ;
   ...
   private java.math.BigDecimal AV49ValorTotal ;
   private java.math.BigDecimal AV47ValorAdquisicion ;
   private java.math.BigDecimal AV57valor ;
   private java.math.BigDecimal AV48ValorReposicion ;
   ...
   private String AV23EsPlacaPadre ;
   ...
   private String edtavValorreposicion_Internalname ;
   private String edtavValorreposicion_Jsonclick ;
   ...
   private String AV24Invd_Estado ;
   private String AV29PlacaPadre ;
   private String AV28Placa ;
   ...
   private String AV30pObservaciones ;
   private String AV27PCata_Descripcion ;
   private String A49Tran_CodigoMovimiento ;
   private String A37Cata_Codigo ;
   private String AV55url ;
   ...
   private String[] H007Q2_A49Tran_CodigoMovimiento ;
   private long[] H007Q2_A46Tran_Id ;
   private java.math.BigDecimal[] H007Q2_A483Tran_ValorTransaccion ;
   private boolean[] H007Q2_n483Tran_ValorTransaccion ;
   private long[] H007Q2_A499Tran_CodTipoElemento ;
   private boolean[] H007Q2_n499Tran_CodTipoElemento ;
   private String[] H007Q3_A37Cata_Codigo ;
   private long[] H007Q3_A46Tran_Id ;
   private String[] H007Q3_A66Elem_Consecutivo ;
   private long[] H007Q3_A487TDet_Cantidad ;
   private java.math.BigDecimal[] H007Q3_A488TDet_ValorUnitario ;
   private java.math.BigDecimal[] H007Q3_A489TDet_ValorTotal ;
   private String[] H007Q3_A490TDet_PlacaNumero ;
   private boolean[] H007Q3_n490TDet_PlacaNumero ;
   private String[] H007Q3_A491TDet_PlacaPadre ;
   private boolean[] H007Q3_n491TDet_PlacaPadre ;
   private String[] H007Q3_A505TDet_EsPadre ;
   private String[] H007Q3_A298Cata_Descripcion ;
   private java.math.BigDecimal[] H007Q3_A483Tran_ValorTransaccion ;
   private boolean[] H007Q3_n483Tran_ValorTransaccion ;
   private java.math.BigDecimal[] H007Q3_A654TDet_Valor_Futuro ;
   private boolean[] H007Q3_n654TDet_Valor_Futuro ;
   private java.math.BigDecimal[] H007Q3_A653TDet_Valor_Presente ;
   private boolean[] H007Q3_n653TDet_Valor_Presente ;
   private byte[] H007Q3_A656TDet_Plazo_N ;
   private boolean[] H007Q3_n656TDet_Plazo_N ;
   private short[] H007Q3_A655TDet_Taza ;
   private boolean[] H007Q3_n655TDet_Taza ;
   private java.math.BigDecimal[] H007Q3_A657TDet_Otros_Costos ;
   private boolean[] H007Q3_n657TDet_Otros_Costos ;
   private long[] H007Q3_A69TDet_Consecutivo ;
   private long[] H007Q4_A69TDet_Consecutivo ;
   private long[] H007Q4_A46Tran_Id ;
   private java.math.BigDecimal[] H007Q4_A489TDet_ValorTotal ;
   private long[] H007Q5_A69TDet_Consecutivo ;
   private long[] H007Q5_A46Tran_Id ;
   private long[] H007Q5_A71Tran_Entrada ;
   private int[] H007Q5_A72Nro_Linea ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class wpalm_traspaso__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H007Q2", "SELECT T1.Tran_CodigoMovimiento AS Tran_CodigoMovimiento, T1.Tran_Id, T1.Tran_ValorTransaccion, T2.Tipo_Codigo AS Tran_CodTipoElemento FROM (ALM_TRANSACCION T1 INNER JOIN ALM_TIPO_MOVIMIENTO T2 ON T2.Tpmo_Codigo = T1.Tran_CodigoMovimiento) WHERE T1.Tran_Id = ? ORDER BY T1.Tran_Id ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H007Q3", "SELECT T3.Cata_Codigo, T1.Tran_Id, T1.Elem_Consecutivo, T1.TDet_Cantidad, T1.TDet_ValorUnitario, T1.TDet_ValorTotal, T1.TDet_PlacaNumero, T1.TDet_PlacaPadre, T1.TDet_EsPadre, T4.Cata_Descripcion, T2.Tran_ValorTransaccion, T1.TDet_Valor_Futuro, T1.TDet_Valor_Presente, T1.TDet_Plazo_N, T1.TDet_Taza, T1.TDet_Otros_Costos, T1.TDet_Consecutivo FROM (((ALM_DETALLE_TRANSACCION T1 INNER JOIN ALM_TRANSACCION T2 ON T2.Tran_Id = T1.Tran_Id) INNER JOIN ALM_ELEMENTO T3 ON T3.Elem_Consecutivo = T1.Elem_Consecutivo) INNER JOIN ALM_CATALOGO T4 ON T4.Cata_Codigo = T3.Cata_Codigo) WHERE T1.Tran_Id = ? ORDER BY T1.Tran_Id, T1.TDet_Consecutivo ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100,0,false )
         ,new ForEachCursor("H007Q4", "SELECT TDet_Consecutivo, Tran_Id, TDet_ValorTotal FROM ALM_DETALLE_TRANSACCION WHERE Tran_Id = ? ORDER BY Tran_Id ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100,0,false )
         ,new ForEachCursor("H007Q5", "SELECT TDet_Consecutivo, Tran_Id, Tran_Entrada, Nro_Linea FROM ALM_DET_TRAN_DATOS_SALIDA WHERE Tran_Id = ? and TDet_Consecutivo = ? ORDER BY Tran_Id, TDet_Consecutivo ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100,0,false )
      };
   }
