/*
               File: alm_unidad_medidaalm_elementowc_impl
...
public final  class alm_unidad_medidaalm_elementowc_impl extends GXWebComponent
{
   public alm_unidad_medidaalm_elementowc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public alm_unidad_medidaalm_elementowc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( alm_unidad_medidaalm_elementowc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7UNIMED_COD", GXutil.ltrim( GXutil.str( AV7UNIMED_COD, 6, 0)));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,new Integer(AV7UNIMED_COD)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7UNIMED_COD, A37Cata_Codigo, A34Clas_Codigo, A35FAM_Codigo, A75SEG_Codigo, A74TIP_Codigo, A33Tipo_Codigo, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "ALM_UNIDAD_MEDIDAALM_ELEMENTOWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414103655");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.alm_unidad_medidaalm_elementowc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7UNIMED_COD,6,0)))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV7UNIMED_COD", GXutil.ltrim( localUtil.ntoc( wcpOAV7UNIMED_COD, (byte)(6), (byte)(0), ",", "")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vUNIMED_COD", GXutil.ltrim( localUtil.ntoc( AV7UNIMED_COD, (byte)(6), (byte)(0), ",", "")));
   ...
   public void renderHtmlCloseForm5Q2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("alm_unidad_medidaalm_elementowc.js", "?201861414103657");
      }
   ...
   public void wb5Q0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.alm_unidad_medidaalm_elementowc");
         }
         /* Div Control */
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_ALM_UNIDAD_MEDIDAALM_ELEMENTOWC.htm");
   ...
   public void start5Q2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "ALM_UNIDAD_MEDIDAALM_ELEMENTOWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "ALM_UNIDAD_MEDIDAALM_ELEMENTOWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf5Q2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H005Q2 */
         pr_default.execute(0, new Object[] {new Integer(AV7UNIMED_COD), new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_20_idx = (short)(1) ;
         sGXsfl_20_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_20_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_202( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A77UNIMED_COD = H005Q2_A77UNIMED_COD[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A77UNIMED_COD", GXutil.ltrim( GXutil.str( A77UNIMED_COD, 6, 0)));
            A632Vida_Util = H005Q2_A632Vida_Util[0] ;
            n632Vida_Util = H005Q2_n632Vida_Util[0] ;
            A573Elem_FechaModifica = H005Q2_A573Elem_FechaModifica[0] ;
            n573Elem_FechaModifica = H005Q2_n573Elem_FechaModifica[0] ;
            A572Elem_UsuarioModifica = H005Q2_A572Elem_UsuarioModifica[0] ;
            n572Elem_UsuarioModifica = H005Q2_n572Elem_UsuarioModifica[0] ;
            A571Elem_FechaCreacion = H005Q2_A571Elem_FechaCreacion[0] ;
            n571Elem_FechaCreacion = H005Q2_n571Elem_FechaCreacion[0] ;
            A570Elem_UsuarioCreacion = H005Q2_A570Elem_UsuarioCreacion[0] ;
            n570Elem_UsuarioCreacion = H005Q2_n570Elem_UsuarioCreacion[0] ;
            A253Tipo_Descripcion = H005Q2_A253Tipo_Descripcion[0] ;
            A33Tipo_Codigo = H005Q2_A33Tipo_Codigo[0] ;
            A558Elem_Estado = H005Q2_A558Elem_Estado[0] ;
            A435TIP_Descripcion = H005Q2_A435TIP_Descripcion[0] ;
            A74TIP_Codigo = H005Q2_A74TIP_Codigo[0] ;
            A442SEG_Descripcion = H005Q2_A442SEG_Descripcion[0] ;
            A75SEG_Codigo = H005Q2_A75SEG_Codigo[0] ;
            A447FAM_Descripcion = H005Q2_A447FAM_Descripcion[0] ;
            A35FAM_Codigo = H005Q2_A35FAM_Codigo[0] ;
            A291Clas_Descripcion = H005Q2_A291Clas_Descripcion[0] ;
            A34Clas_Codigo = H005Q2_A34Clas_Codigo[0] ;
            A298Cata_Descripcion = H005Q2_A298Cata_Descripcion[0] ;
            A37Cata_Codigo = H005Q2_A37Cata_Codigo[0] ;
            A557Elem_Descripcion = H005Q2_A557Elem_Descripcion[0] ;
            A66Elem_Consecutivo = H005Q2_A66Elem_Consecutivo[0] ;
            A253Tipo_Descripcion = H005Q2_A253Tipo_Descripcion[0] ;
            A34Clas_Codigo = H005Q2_A34Clas_Codigo[0] ;
            A298Cata_Descripcion = H005Q2_A298Cata_Descripcion[0] ;
            A35FAM_Codigo = H005Q2_A35FAM_Codigo[0] ;
   ...
   {
      /* Using cursor H005Q3 */
      pr_default.execute(1, new Object[] {new Integer(AV7UNIMED_COD)});
   ...
   public void strup5Q0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV7UNIMED_COD = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV7UNIMED_COD"), ",", ".")) ;
   ...
   {
      AV7UNIMED_COD = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.INT), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7UNIMED_COD", GXutil.ltrim( GXutil.str( AV7UNIMED_COD, 6, 0)));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV7UNIMED_COD = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "alm_unidad_medidaalm_elementowc");
      ...
      {
         AV7UNIMED_COD = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.INT), TypeConstants.INT)).intValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7UNIMED_COD", GXutil.ltrim( GXutil.str( AV7UNIMED_COD, 6, 0)));
      }
      wcpOAV7UNIMED_COD = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV7UNIMED_COD"), ",", ".")) ;
      if ( ! GetJustCreated( ) && ( ( AV7UNIMED_COD != wcpOAV7UNIMED_COD ) ) )
      {
         setjustcreated();
      }
      wcpOAV7UNIMED_COD = AV7UNIMED_COD ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV7UNIMED_COD = httpContext.cgiGet( sPrefix+"AV7UNIMED_COD_CTRL") ;
      if ( GXutil.len( sCtrlAV7UNIMED_COD) > 0 )
      {
         AV7UNIMED_COD = (int)(localUtil.ctol( httpContext.cgiGet( sCtrlAV7UNIMED_COD), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7UNIMED_COD", GXutil.ltrim( GXutil.str( AV7UNIMED_COD, 6, 0)));
      }
      else
      {
         AV7UNIMED_COD = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV7UNIMED_COD_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7UNIMED_COD_PARM", GXutil.ltrim( localUtil.ntoc( AV7UNIMED_COD, (byte)(6), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV7UNIMED_COD)) > 0 )
      {
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7UNIMED_COD_CTRL", GXutil.rtrim( sCtrlAV7UNIMED_COD));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414103757");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("alm_unidad_medidaalm_elementowc.js", "?201861414103757");
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7UNIMED_COD',fld:'vUNIMED_COD',pic:'ZZZZZ9',nv:0},{av:'A37Cata_Codigo',fld:'CATA_CODIGO',pic:'',hsh:true,nv:''},{av:'A34Clas_Codigo',fld:'CLAS_CODIGO',pic:'',nv:''},{av:'A35FAM_Codigo',fld:'FAM_CODIGO',pic:'',nv:''},{av:'A75SEG_Codigo',fld:'SEG_CODIGO',pic:'',nv:''},{av:'A74TIP_Codigo',fld:'TIP_CODIGO',pic:'',nv:''},{av:'A33Tipo_Codigo',fld:'TIPO_CODIGO',pic:'ZZZZZZZZZZZZZZZZZ9',hsh:true,nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e125Q2',iparms:[{av:'A37Cata_Codigo',fld:'CATA_CODIGO',pic:'',hsh:true,nv:''},{av:'A34Clas_Codigo',fld:'CLAS_CODIGO',pic:'',nv:''},{av:'A35FAM_Codigo',fld:'FAM_CODIGO',pic:'',nv:''},{av:'A75SEG_Codigo',fld:'SEG_CODIGO',pic:'',nv:''},{av:'A74TIP_Codigo',fld:'TIP_CODIGO',pic:'',nv:''},{av:'A33Tipo_Codigo',fld:'TIPO_CODIGO',pic:'ZZZZZZZZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'edtCata_Descripcion_Link',ctrl:'CATA_DESCRIPCION',prop:'Link'},{av:'edtClas_Descripcion_Link',ctrl:'CLAS_DESCRIPCION',prop:'Link'},{av:'edtFAM_Descripcion_Link',ctrl:'FAM_DESCRIPCION',prop:'Link'},{av:'edtSEG_Descripcion_Link',ctrl:'SEG_DESCRIPCION',prop:'Link'},{av:'edtTIP_Descripcion_Link',ctrl:'TIP_DESCRIPCION',prop:'Link'},{av:'edtTipo_Descripcion_Link',ctrl:'TIPO_DESCRIPCION',prop:'Link'}]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H005Q2_A77UNIMED_COD = new int[1] ;
      H005Q2_A632Vida_Util = new short[1] ;
      H005Q2_n632Vida_Util = new boolean[] {false} ;
      H005Q2_A573Elem_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H005Q2_n573Elem_FechaModifica = new boolean[] {false} ;
      H005Q2_A572Elem_UsuarioModifica = new String[] {""} ;
      H005Q2_n572Elem_UsuarioModifica = new boolean[] {false} ;
      H005Q2_A571Elem_FechaCreacion = new java.util.Date[] {GXutil.nullDate()} ;
      H005Q2_n571Elem_FechaCreacion = new boolean[] {false} ;
      H005Q2_A570Elem_UsuarioCreacion = new String[] {""} ;
      H005Q2_n570Elem_UsuarioCreacion = new boolean[] {false} ;
      H005Q2_A253Tipo_Descripcion = new String[] {""} ;
      H005Q2_A33Tipo_Codigo = new long[1] ;
      H005Q2_A558Elem_Estado = new String[] {""} ;
      H005Q2_A435TIP_Descripcion = new String[] {""} ;
      H005Q2_A74TIP_Codigo = new String[] {""} ;
      H005Q2_A442SEG_Descripcion = new String[] {""} ;
      H005Q2_A75SEG_Codigo = new String[] {""} ;
      H005Q2_A447FAM_Descripcion = new String[] {""} ;
      H005Q2_A35FAM_Codigo = new String[] {""} ;
      H005Q2_A291Clas_Descripcion = new String[] {""} ;
      H005Q2_A34Clas_Codigo = new String[] {""} ;
      H005Q2_A298Cata_Descripcion = new String[] {""} ;
      H005Q2_A37Cata_Codigo = new String[] {""} ;
      H005Q2_A557Elem_Descripcion = new String[] {""} ;
      H005Q2_A66Elem_Consecutivo = new String[] {""} ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.alm_unidad_medidaalm_elementowc__default(),
         new Object[] {
             new Object[] {
            H005Q2_A77UNIMED_COD, H005Q2_A632Vida_Util, H005Q2_n632Vida_Util, H005Q2_A573Elem_FechaModifica, H005Q2_n573Elem_FechaModifica, H005Q2_A572Elem_UsuarioModifica, H005Q2_n572Elem_UsuarioModifica, H005Q2_A571Elem_FechaCreacion, H005Q2_n571Elem_FechaCreacion, H005Q2_A570Elem_UsuarioCreacion,
            H005Q2_n570Elem_UsuarioCreacion, H005Q2_A253Tipo_Descripcion, H005Q2_A33Tipo_Codigo, H005Q2_A558Elem_Estado, H005Q2_A435TIP_Descripcion, H005Q2_A74TIP_Codigo, H005Q2_A442SEG_Descripcion, H005Q2_A75SEG_Codigo, H005Q2_A447FAM_Descripcion, H005Q2_A35FAM_Codigo,
            H005Q2_A291Clas_Descripcion, H005Q2_A34Clas_Codigo, H005Q2_A298Cata_Descripcion, H005Q2_A37Cata_Codigo, H005Q2_A557Elem_Descripcion, H005Q2_A66Elem_Consecutivo
            }
            , new Object[] {
   ...
   private String sCtrlAV7UNIMED_COD ;
   ...
   private int[] H005Q2_A77UNIMED_COD ;
   private short[] H005Q2_A632Vida_Util ;
   private boolean[] H005Q2_n632Vida_Util ;
   private java.util.Date[] H005Q2_A573Elem_FechaModifica ;
   private boolean[] H005Q2_n573Elem_FechaModifica ;
   private String[] H005Q2_A572Elem_UsuarioModifica ;
   private boolean[] H005Q2_n572Elem_UsuarioModifica ;
   private java.util.Date[] H005Q2_A571Elem_FechaCreacion ;
   private boolean[] H005Q2_n571Elem_FechaCreacion ;
   private String[] H005Q2_A570Elem_UsuarioCreacion ;
   private boolean[] H005Q2_n570Elem_UsuarioCreacion ;
   private String[] H005Q2_A253Tipo_Descripcion ;
   private long[] H005Q2_A33Tipo_Codigo ;
   private String[] H005Q2_A558Elem_Estado ;
   private String[] H005Q2_A435TIP_Descripcion ;
   private String[] H005Q2_A74TIP_Codigo ;
   private String[] H005Q2_A442SEG_Descripcion ;
   private String[] H005Q2_A75SEG_Codigo ;
   private String[] H005Q2_A447FAM_Descripcion ;
   private String[] H005Q2_A35FAM_Codigo ;
   private String[] H005Q2_A291Clas_Descripcion ;
   private String[] H005Q2_A34Clas_Codigo ;
   private String[] H005Q2_A298Cata_Descripcion ;
   private String[] H005Q2_A37Cata_Codigo ;
   private String[] H005Q2_A557Elem_Descripcion ;
   private String[] H005Q2_A66Elem_Consecutivo ;
   private long[] H005Q3_AGRID_nRecordCount ;
}

final  class alm_unidad_medidaalm_elementowc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H005Q2", "SELECT T1.UNIMED_COD, T1.Vida_Util, T1.Elem_FechaModifica, T1.Elem_UsuarioModifica, T1.Elem_FechaCreacion, T1.Elem_UsuarioCreacion, T2.Tipo_Descripcion, T1.Tipo_Codigo, T1.Elem_Estado, T7.TIP_Descripcion, T6.TIP_Codigo, T6.SEG_Descripcion, T5.SEG_Codigo, T5.FAM_Descripcion, T4.FAM_Codigo, T4.Clas_Descripcion, T3.Clas_Codigo, T3.Cata_Descripcion, T1.Cata_Codigo, T1.Elem_Descripcion, T1.Elem_Consecutivo FROM ((((((ALM_ELEMENTO T1 INNER JOIN ALM_TIPO_ELEMENTO T2 ON T2.Tipo_Codigo = T1.Tipo_Codigo) INNER JOIN ALM_CATALOGO T3 ON T3.Cata_Codigo = T1.Cata_Codigo) INNER JOIN ALM_CLASE T4 ON T4.Clas_Codigo = T3.Clas_Codigo) INNER JOIN ALM_CAT_FAM T5 ON T5.FAM_Codigo = T4.FAM_Codigo) INNER JOIN ALM_CAT_SEG T6 ON T6.SEG_Codigo = T5.SEG_Codigo) INNER JOIN ALM_CAT_TIP T7 ON T7.TIP_Codigo = T6.TIP_Codigo) WHERE T1.UNIMED_COD = ? ORDER BY T1.UNIMED_COD  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H005Q3", "SELECT COUNT(*) FROM ((((((ALM_ELEMENTO T1 INNER JOIN ALM_TIPO_ELEMENTO T7 ON T7.Tipo_Codigo = T1.Tipo_Codigo) INNER JOIN ALM_CATALOGO T2 ON T2.Cata_Codigo = T1.Cata_Codigo) INNER JOIN ALM_CLASE T3 ON T3.Clas_Codigo = T2.Clas_Codigo) INNER JOIN ALM_CAT_FAM T4 ON T4.FAM_Codigo = T3.FAM_Codigo) INNER JOIN ALM_CAT_SEG T5 ON T5.SEG_Codigo = T4.SEG_Codigo) INNER JOIN ALM_CAT_TIP T6 ON T6.TIP_Codigo = T5.TIP_Codigo) WHERE T1.UNIMED_COD = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
