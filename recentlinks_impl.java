/*
       ...
       Generated on: June 14, 2018 14:10:54.4
...
public final  class recentlinks_impl extends GXWebComponent
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20186141410547");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("com.orions2.recentlinks") + "?" + GXutil.URLEncode(GXutil.rtrim(AV6FormCaption)) + "," + GXutil.URLEncode(GXutil.rtrim(AV7FormPgmName))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      /* Send saved values. */
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"nRC_GXsfl_7", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_7, (byte)(4), (byte)(0), ",", "")));
   ...
   public void renderHtmlCloseForm022( )
   {
      ...
      {
         httpContext.AddJavascriptSource("recentlinks.js", "?20186141410547");
      }
   ...
   public void wb020( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.recentlinks");
         }
   ...
   public void wb_table2_14_022( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         sStyleString = "" ;
         com.orions2.GxWebStd.gx_table_start( httpContext, tblBottomline_Internalname, tblBottomline_Internalname, "", "TableHorizontalLine", 0, "", "", 0, 0, sStyleString, "none", 0);
   ...
   public void wb_table1_2_022( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         sStyleString = "" ;
         com.orions2.GxWebStd.gx_table_start( httpContext, tblTable_Internalname, tblTable_Internalname, "", "RecentLinksTable", 0, "", "", 0, 0, sStyleString, "none", 0);
         httpContext.writeText( "<tbody>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td style=\""+GXutil.CssPrettify( "width:1%")+"\">") ;
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblRecenttext_Internalname, "Recents: ", "", "", lblRecenttext_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "RecentLink", 0, "", 1, 1, (short)(0), "HLP_RecentLinks.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /*  Grid Control  */
         ...
         if ( LinksContainer.GetWrapped() == 1 )
         {
            ...
            sStyleString = "" ;
            com.orions2.GxWebStd.gx_table_start( httpContext, subLinks_Internalname, subLinks_Internalname, "", "RecentLinksTable", 0, "", "", 1, 2, sStyleString, "none", 0);
            LinksContainer.AddObjectProperty("GridName", "Links");
         }
         else
         {
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414105421");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("recentlinks.js", "?201861414105421");
      }
