/*
               File: bodegarest_impl
        Description: Bodega Rest
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:21:55.51
...
public final  class bodegarest_impl extends GXDataArea
{
   public bodegarest_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public bodegarest_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( bodegarest_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV12pBode_Codigo = gxfirstwebparm ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414215554");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.bodegarest") + "?" + GXutil.URLEncode(GXutil.rtrim(AV12pBode_Codigo)) + "," + GXutil.URLEncode(GXutil.rtrim(AV14pBode_Descripcion))+"\">") ;
   ...
   {
      return formatLink("com.orions2.bodegarest") + "?" + GXutil.URLEncode(GXutil.rtrim(AV12pBode_Codigo)) + "," + GXutil.URLEncode(GXutil.rtrim(AV14pBode_Descripcion)) ;
   }
   ...
   public void wb770( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblbode_codigofilter_Internalname, "Código Bodega", "", "", lblLblbode_codigofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11771_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_BodegaRest.htm");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblbode_descripcionfilter_Internalname, "Nombre Bodega", "", "", lblLblbode_descripcionfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e12771_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_BodegaRest.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavCbode_descripcion_Internalname, AV7cBode_Descripcion, GXutil.rtrim( localUtil.format( AV7cBode_Descripcion, "@!")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCbode_descripcion_Jsonclick, 0, "Attribute", "", "", "", edtavCbode_descripcion_Visible, edtavCbode_descripcion_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_BodegaRest.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 34, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e13771_client"+"'", TempTags, "", 2, "HLP_BodegaRest.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      if ( wbEnd == 34 )
      {
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 34, 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_BodegaRest.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start772( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Bodega Rest", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf772( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A251Bode_Descripcion = H00772_A251Bode_Descripcion[0] ;
            A31Bode_Codigo = H00772_A31Bode_Codigo[0] ;
            if ( (GXutil.strcmp("", AV6cBode_Codigo)==0) || ( GXutil.like( GXutil.upper( A31Bode_Codigo) , GXutil.padr( GXutil.concat( "%", GXutil.upper( AV6cBode_Codigo), "") , 254 , "%"),  ' ' ) ) )
            {
   ...
   public void e16772( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV14pBode_Descripcion", AV14pBode_Descripcion);
      httpContext.setWebReturnParms(new Object[] {AV12pBode_Codigo,AV14pBode_Descripcion});
   ...
   {
      AV12pBode_Codigo = (String)getParm(obj,0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV12pBode_Codigo", AV12pBode_Codigo);
      AV14pBode_Descripcion = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV14pBode_Descripcion", AV14pBode_Descripcion);
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414215595");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("bodegarest.js", "?201861414215595");
   ...
   public void sendrow_342( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_34_idx <= subgrid1_recordsperpage( ) * 1 ) )
      {
         ...
         edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( A31Bode_Codigo)+"'"+", "+"'"+PrivateUtilities.encodeJSConstant( A251Bode_Descripcion)+"'"+"]);" ;
         ...
         edtBode_Descripcion_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( A31Bode_Codigo)+"'"+", "+"'"+PrivateUtilities.encodeJSConstant( A251Bode_Descripcion)+"'"+"]);" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("'TOGGLE'","{handler:'e13771',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}],oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
      setEventMetadata("LBLBODE_CODIGOFILTER.CLICK","{handler:'e11771',iparms:[{av:'divBode_codigofiltercontainer_Class',ctrl:'BODE_CODIGOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divBode_codigofiltercontainer_Class',ctrl:'BODE_CODIGOFILTERCONTAINER',prop:'Class'},{av:'edtavCbode_codigo_Visible',ctrl:'vCBODE_CODIGO',prop:'Visible'}]}");
      setEventMetadata("LBLBODE_DESCRIPCIONFILTER.CLICK","{handler:'e12771',iparms:[{av:'divBode_descripcionfiltercontainer_Class',ctrl:'BODE_DESCRIPCIONFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divBode_descripcionfiltercontainer_Class',ctrl:'BODE_DESCRIPCIONFILTERCONTAINER',prop:'Class'},{av:'edtavCbode_descripcion_Visible',ctrl:'vCBODE_DESCRIPCION',prop:'Visible'}]}");
      setEventMetadata("ENTER","{handler:'e16772',iparms:[{av:'A31Bode_Codigo',fld:'BODE_CODIGO',pic:'',hsh:true,nv:''},{av:'A251Bode_Descripcion',fld:'BODE_DESCRIPCION',pic:'@!',hsh:true,nv:''}],oparms:[{av:'AV12pBode_Codigo',fld:'vPBODE_CODIGO',pic:'',nv:''},{av:'AV14pBode_Descripcion',fld:'vPBODE_DESCRIPCION',pic:'@!',nv:''}]}");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00772_A251Bode_Descripcion = new String[] {""} ;
      H00772_A31Bode_Codigo = new String[] {""} ;
      ...
      sImgUrl = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.bodegarest__default(),
         new Object[] {
             new Object[] {
            H00772_A251Bode_Descripcion, H00772_A31Bode_Codigo
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String[] H00772_A251Bode_Descripcion ;
   private String[] H00772_A31Bode_Codigo ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class bodegarest__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00772", "SELECT /*+ FIRST_ROWS(11) */ Bode_Descripcion, Bode_Codigo FROM ALM_BODEGA ORDER BY Bode_Codigo ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
      };
   }
