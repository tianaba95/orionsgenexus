...
public final  class prueba_impl extends GXDataArea
{
   public prueba_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public prueba_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( prueba_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
         {
            ...
            gxgrgrid1_refresh( subGrid1_Rows, AV19cClas_Descripcion, AV18cCata_Descripcion, AV23cElem_Descripcion, AV6cElem_Consecutivo) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201852514451131");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.prueba") + "?" + GXutil.URLEncode(GXutil.rtrim(AV11pElem_Consecutivo)) + "," + GXutil.URLEncode(GXutil.rtrim(AV13pCata_Descripcion))+"\">") ;
   ...
   {
      return formatLink("com.orions2.prueba") + "?" + GXutil.URLEncode(GXutil.rtrim(AV11pElem_Consecutivo)) + "," + GXutil.URLEncode(GXutil.rtrim(AV13pCata_Descripcion)) ;
   }
   ...
   public void wb9Z0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblclas_descripcionfilter_Internalname, "Clase", "", "", lblLblclas_descripcionfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e119z1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Prueba.htm");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblcata_descripcionfilter_Internalname, "Bien", "", "", lblLblcata_descripcionfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e129z1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Prueba.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblelm_descripcionfilter_Internalname, "Descripción", "", "", lblLblelm_descripcionfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e139z1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Prueba.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblelem_consecutivofilter_Internalname, "Consecutivo", "", "", lblLblelem_consecutivofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e149z1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Prueba.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavCelem_consecutivo_Internalname, AV6cElem_Consecutivo, GXutil.rtrim( localUtil.format( AV6cElem_Consecutivo, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCelem_consecutivo_Jsonclick, 0, "Attribute", "", "", "", edtavCelem_consecutivo_Visible, edtavCelem_consecutivo_Enabled, 0, "text", "", 9, "chr", 1, "row", 9, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_Prueba.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 55, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e159z1_client"+"'", TempTags, "", 2, "HLP_Prueba.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      if ( wbEnd == 55 )
      {
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 55, 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Prueba.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start9Z2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Prueba", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf9Z2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H009Z2 */
         pr_default.execute(0, new Object[] {lV6cElem_Consecutivo});
         nGXsfl_55_idx = (short)(1) ;
         sGXsfl_55_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_55_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_552( ) ;
         GRID1_nEOF = (byte)(0) ;
         ...
         {
            A34Clas_Codigo = H009Z2_A34Clas_Codigo[0] ;
            A35FAM_Codigo = H009Z2_A35FAM_Codigo[0] ;
            A75SEG_Codigo = H009Z2_A75SEG_Codigo[0] ;
            A33Tipo_Codigo = H009Z2_A33Tipo_Codigo[0] ;
            A557Elem_Descripcion = H009Z2_A557Elem_Descripcion[0] ;
            A298Cata_Descripcion = H009Z2_A298Cata_Descripcion[0] ;
            A291Clas_Descripcion = H009Z2_A291Clas_Descripcion[0] ;
            A37Cata_Codigo = H009Z2_A37Cata_Codigo[0] ;
            A66Elem_Consecutivo = H009Z2_A66Elem_Consecutivo[0] ;
            A34Clas_Codigo = H009Z2_A34Clas_Codigo[0] ;
            A298Cata_Descripcion = H009Z2_A298Cata_Descripcion[0] ;
            A35FAM_Codigo = H009Z2_A35FAM_Codigo[0] ;
            A291Clas_Descripcion = H009Z2_A291Clas_Descripcion[0] ;
   ...
   public void e189Z2( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV13pCata_Descripcion", AV13pCata_Descripcion);
      httpContext.setWebReturnParms(new Object[] {AV11pElem_Consecutivo,AV13pCata_Descripcion});
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV11pElem_Consecutivo", AV11pElem_Consecutivo);
      AV13pCata_Descripcion = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV13pCata_Descripcion", AV13pCata_Descripcion);
   }
   ...
   {
      httpContext.AddThemeStyleSheetFile("", context.getHttpContext().getTheme( )+".css", "?15184036");
      idxLst = 1 ;
      while ( idxLst <= Form.getJscriptsrc().getCount() )
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201852514451219");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("prueba.js", "?201852514451219");
   ...
   public void sendrow_552( )
   {
      ...
      if ( ( 7 * 1 == 0 ) || ( nGXsfl_55_idx <= subgrid1_recordsperpage( ) * 1 ) )
      {
         ...
         edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( A66Elem_Consecutivo)+"'"+", "+"'"+PrivateUtilities.encodeJSConstant( A298Cata_Descripcion)+"'"+"]);" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID1_nFirstRecordOnPage',nv:0},{av:'GRID1_nEOF',nv:0},{av:'subGrid1_Rows',nv:0},{av:'AV19cClas_Descripcion',fld:'vCCLAS_DESCRIPCION',pic:'',nv:''},{av:'AV18cCata_Descripcion',fld:'vCCATA_DESCRIPCION',pic:'@!',nv:''},{av:'AV23cElem_Descripcion',fld:'vCELEM_DESCRIPCION',pic:'',nv:''},{av:'AV6cElem_Consecutivo',fld:'vCELEM_CONSECUTIVO',pic:'',nv:''}],oparms:[]}");
      setEventMetadata("'TOGGLE'","{handler:'e159Z1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}],oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
      setEventMetadata("LBLELEM_CONSECUTIVOFILTER.CLICK","{handler:'e149Z1',iparms:[{av:'divElem_consecutivofiltercontainer_Class',ctrl:'ELEM_CONSECUTIVOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divElem_consecutivofiltercontainer_Class',ctrl:'ELEM_CONSECUTIVOFILTERCONTAINER',prop:'Class'},{av:'edtavCelem_consecutivo_Visible',ctrl:'vCELEM_CONSECUTIVO',prop:'Visible'}]}");
      setEventMetadata("LBLCATA_DESCRIPCIONFILTER.CLICK","{handler:'e129Z1',iparms:[{av:'divCata_descripcionfiltercontainer_Class',ctrl:'CATA_DESCRIPCIONFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divCata_descripcionfiltercontainer_Class',ctrl:'CATA_DESCRIPCIONFILTERCONTAINER',prop:'Class'},{av:'edtavCcata_descripcion_Visible',ctrl:'vCCATA_DESCRIPCION',prop:'Visible'}]}");
      setEventMetadata("LBLCLAS_DESCRIPCIONFILTER.CLICK","{handler:'e119Z1',iparms:[{av:'divClas_descripcionfiltercontainer_Class',ctrl:'CLAS_DESCRIPCIONFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divClas_descripcionfiltercontainer_Class',ctrl:'CLAS_DESCRIPCIONFILTERCONTAINER',prop:'Class'},{av:'edtavCclas_descripcion_Visible',ctrl:'vCCLAS_DESCRIPCION',prop:'Visible'}]}");
      setEventMetadata("LBLELM_DESCRIPCIONFILTER.CLICK","{handler:'e139Z1',iparms:[{av:'divElem_descripcionfiltercontainer_Class',ctrl:'ELEM_DESCRIPCIONFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divElem_descripcionfiltercontainer_Class',ctrl:'ELEM_DESCRIPCIONFILTERCONTAINER',prop:'Class'},{av:'edtavCelem_descripcion_Visible',ctrl:'vCELEM_DESCRIPCION',prop:'Visible'}]}");
      setEventMetadata("ENTER","{handler:'e189Z2',iparms:[{av:'A66Elem_Consecutivo',fld:'ELEM_CONSECUTIVO',pic:'',hsh:true,nv:''},{av:'A298Cata_Descripcion',fld:'CATA_DESCRIPCION',pic:'@!',nv:''}],oparms:[{av:'AV11pElem_Consecutivo',fld:'vPELEM_CONSECUTIVO',pic:'',nv:''},{av:'AV13pCata_Descripcion',fld:'vPCATA_DESCRIPCION',pic:'@!',nv:''}]}");
   ...
   public void initialize( )
   {
      ...
      H009Z2_A34Clas_Codigo = new String[] {""} ;
      H009Z2_A35FAM_Codigo = new String[] {""} ;
      H009Z2_A75SEG_Codigo = new String[] {""} ;
      H009Z2_A33Tipo_Codigo = new long[1] ;
      H009Z2_A557Elem_Descripcion = new String[] {""} ;
      H009Z2_A298Cata_Descripcion = new String[] {""} ;
      H009Z2_A291Clas_Descripcion = new String[] {""} ;
      H009Z2_A37Cata_Codigo = new String[] {""} ;
      H009Z2_A66Elem_Consecutivo = new String[] {""} ;
      ...
      sImgUrl = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.prueba__default(),
         new Object[] {
             new Object[] {
            H009Z2_A34Clas_Codigo, H009Z2_A35FAM_Codigo, H009Z2_A75SEG_Codigo, H009Z2_A33Tipo_Codigo, H009Z2_A557Elem_Descripcion, H009Z2_A298Cata_Descripcion, H009Z2_A291Clas_Descripcion, H009Z2_A37Cata_Codigo, H009Z2_A66Elem_Consecutivo
            }
         }
      );
      /* GeneXus formulas. */
   ...
   private String[] H009Z2_A34Clas_Codigo ;
   private String[] H009Z2_A35FAM_Codigo ;
   private String[] H009Z2_A75SEG_Codigo ;
   private long[] H009Z2_A33Tipo_Codigo ;
   private String[] H009Z2_A557Elem_Descripcion ;
   private String[] H009Z2_A298Cata_Descripcion ;
   private String[] H009Z2_A291Clas_Descripcion ;
   private String[] H009Z2_A37Cata_Codigo ;
   private String[] H009Z2_A66Elem_Consecutivo ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class prueba__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H009Z2", "SELECT /*+ FIRST_ROWS(8) */ T2.Clas_Codigo, T3.FAM_Codigo, T4.SEG_Codigo, T1.Tipo_Codigo, T1.Elem_Descripcion, T2.Cata_Descripcion, T3.Clas_Descripcion, T1.Cata_Codigo, T1.Elem_Consecutivo FROM (((ALM_ELEMENTO T1 INNER JOIN ALM_CATALOGO T2 ON T2.Cata_Codigo = T1.Cata_Codigo) INNER JOIN ALM_CLASE T3 ON T3.Clas_Codigo = T2.Clas_Codigo) INNER JOIN ALM_CAT_FAM T4 ON T4.FAM_Codigo = T3.FAM_Codigo) WHERE T1.Elem_Consecutivo like ? ORDER BY T1.Elem_Consecutivo ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,8,0,false )
      };
   }
