/*
               File: gen_departamentogen_ciudadwc_impl
...
public final  class gen_departamentogen_ciudadwc_impl extends GXWebComponent
{
   public gen_departamentogen_ciudadwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public gen_departamentogen_ciudadwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( gen_departamentogen_ciudadwc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Dept_Codigo", GXutil.ltrim( GXutil.str( AV7Dept_Codigo, 4, 0)));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,new Short(AV7Dept_Codigo)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Dept_Codigo, AV13Update, AV6Delete, A5Ciud_Codigo, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "GEN_DEPARTAMENTOGEN_CIUDADWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20186141415376");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.gen_departamentogen_ciudadwc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Dept_Codigo,4,0)))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV7Dept_Codigo", GXutil.ltrim( localUtil.ntoc( wcpOAV7Dept_Codigo, (byte)(4), (byte)(0), ",", "")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vDEPT_CODIGO", GXutil.ltrim( localUtil.ntoc( AV7Dept_Codigo, (byte)(4), (byte)(0), ",", "")));
   ...
   public void renderHtmlCloseForm2Q2( )
   {
      sendCloseFormHiddens( ) ;
      if ( ( GXutil.len( sPrefix) != 0 ) && httpContext.isAjaxRequest( ) )
      {
         httpContext.AddJavascriptSource("gen_departamentogen_ciudadwc.js", "?20186141415379");
      }
   ...
   public void wb2Q0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.gen_departamentogen_ciudadwc");
         }
         /* Div Control */
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_GEN_DEPARTAMENTOGEN_CIUDADWC.htm");
      ...
      if ( wbEnd == 20 )
      {
         ...
         com.orions2.GxWebStd.gx_label_element( httpContext, edtDept_Codigo_Internalname, "Código Departamento", "col-sm-3 AttributeLabel", 0, true);
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtDept_Codigo_Internalname, GXutil.ltrim( localUtil.ntoc( A6Dept_Codigo, (byte)(4), (byte)(0), ",", "")), ((edtDept_Codigo_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A6Dept_Codigo), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A6Dept_Codigo), "ZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtDept_Codigo_Jsonclick, 0, "Attribute", "", "", "", edtDept_Codigo_Visible, edtDept_Codigo_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "HLP_GEN_DEPARTAMENTOGEN_CIUDADWC.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start2Q2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "GEN_DEPARTAMENTOGEN_CIUDADWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"CIUD_CODIGO", GXutil.ltrim( localUtil.ntoc( A5Ciud_Codigo, (byte)(4), (byte)(0), ".", "")));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"CIUD_USUARIOCREA", A127Ciud_UsuarioCrea);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"CIUD_FECHACREA", localUtil.ttoc( A128Ciud_FechaCrea, 10, 8, 0, 3, "/", ":", " "));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"CIUD_USUARIOMODIFICA", A129Ciud_UsuarioModifica);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"CIUD_FECHAMODIFICA", localUtil.ttoc( A130Ciud_FechaModifica, 10, 8, 0, 3, "/", ":", " "));
   }
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "GEN_DEPARTAMENTOGEN_CIUDADWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf2Q2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H002Q2 */
         pr_default.execute(0, new Object[] {new Short(AV7Dept_Codigo), new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_20_idx = (short)(1) ;
         sGXsfl_20_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_20_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_202( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A6Dept_Codigo = H002Q2_A6Dept_Codigo[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A6Dept_Codigo", GXutil.ltrim( GXutil.str( A6Dept_Codigo, 4, 0)));
            A130Ciud_FechaModifica = H002Q2_A130Ciud_FechaModifica[0] ;
            A129Ciud_UsuarioModifica = H002Q2_A129Ciud_UsuarioModifica[0] ;
            A128Ciud_FechaCrea = H002Q2_A128Ciud_FechaCrea[0] ;
            A127Ciud_UsuarioCrea = H002Q2_A127Ciud_UsuarioCrea[0] ;
            A7Ciud_Descripcion = H002Q2_A7Ciud_Descripcion[0] ;
            A5Ciud_Codigo = H002Q2_A5Ciud_Codigo[0] ;
            e132Q2 ();
   ...
   {
      /* Using cursor H002Q3 */
      pr_default.execute(1, new Object[] {new Short(AV7Dept_Codigo)});
   ...
   public void strup2Q0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV7Dept_Codigo = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV7Dept_Codigo"), ",", ".")) ;
   ...
   public void e122Q2( )
   {
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext, !bGXsfl_20_Refreshing);
      edtDept_Codigo_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtDept_Codigo_Internalname, "Visible", GXutil.ltrim( GXutil.str( edtDept_Codigo_Visible, 5, 0)), true);
   ...
   public void S112( )
   {
      ...
      AV11TrnContext.setgxTv_SdtTransactionContext_Transactionname( "GEN_CIUDAD" );
      ...
      AV12TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributename( "Dept_Codigo" );
      AV12TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( GXutil.str( AV7Dept_Codigo, 4, 0) );
   ...
   {
      AV7Dept_Codigo = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Dept_Codigo", GXutil.ltrim( GXutil.str( AV7Dept_Codigo, 4, 0)));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV7Dept_Codigo = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "gen_departamentogen_ciudadwc");
      ...
      {
         AV7Dept_Codigo = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Dept_Codigo", GXutil.ltrim( GXutil.str( AV7Dept_Codigo, 4, 0)));
      }
      wcpOAV7Dept_Codigo = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV7Dept_Codigo"), ",", ".")) ;
      if ( ! GetJustCreated( ) && ( ( AV7Dept_Codigo != wcpOAV7Dept_Codigo ) ) )
      {
         setjustcreated();
      }
      wcpOAV7Dept_Codigo = AV7Dept_Codigo ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV7Dept_Codigo = httpContext.cgiGet( sPrefix+"AV7Dept_Codigo_CTRL") ;
      if ( GXutil.len( sCtrlAV7Dept_Codigo) > 0 )
      {
         AV7Dept_Codigo = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlAV7Dept_Codigo), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Dept_Codigo", GXutil.ltrim( GXutil.str( AV7Dept_Codigo, 4, 0)));
      }
      else
      {
         AV7Dept_Codigo = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV7Dept_Codigo_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Dept_Codigo_PARM", GXutil.ltrim( localUtil.ntoc( AV7Dept_Codigo, (byte)(4), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV7Dept_Codigo)) > 0 )
      {
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Dept_Codigo_CTRL", GXutil.rtrim( sCtrlAV7Dept_Codigo));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414153753");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("gen_departamentogen_ciudadwc.js", "?201861414153753");
      }
   ...
   public void subsflControlProps_202( )
   {
      ...
      edtCiud_UsuarioCrea_Internalname = sPrefix+"CIUD_USUARIOCREA_"+sGXsfl_20_idx ;
      edtCiud_FechaCrea_Internalname = sPrefix+"CIUD_FECHACREA_"+sGXsfl_20_idx ;
      edtCiud_UsuarioModifica_Internalname = sPrefix+"CIUD_USUARIOMODIFICA_"+sGXsfl_20_idx ;
      edtCiud_FechaModifica_Internalname = sPrefix+"CIUD_FECHAMODIFICA_"+sGXsfl_20_idx ;
   ...
   public void subsflControlProps_fel_202( )
   {
      ...
      edtCiud_UsuarioCrea_Internalname = sPrefix+"CIUD_USUARIOCREA_"+sGXsfl_20_fel_idx ;
      edtCiud_FechaCrea_Internalname = sPrefix+"CIUD_FECHACREA_"+sGXsfl_20_fel_idx ;
      edtCiud_UsuarioModifica_Internalname = sPrefix+"CIUD_USUARIOMODIFICA_"+sGXsfl_20_fel_idx ;
      edtCiud_FechaModifica_Internalname = sPrefix+"CIUD_FECHAMODIFICA_"+sGXsfl_20_fel_idx ;
   ...
   public void sendrow_202( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCiud_Descripcion_Internalname,A7Ciud_Descripcion,GXutil.rtrim( localUtil.format( A7Ciud_Descripcion, "@!")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'",edtCiud_Descripcion_Link,"","","",edtCiud_Descripcion_Jsonclick,new Integer(0),"DescriptionAttribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCiud_UsuarioCrea_Internalname,A127Ciud_UsuarioCrea,GXutil.rtrim( localUtil.format( A127Ciud_UsuarioCrea, "@!")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtCiud_UsuarioCrea_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCiud_FechaCrea_Internalname,localUtil.ttoc( A128Ciud_FechaCrea, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A128Ciud_FechaCrea, "99/99/99 99:99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtCiud_FechaCrea_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCiud_UsuarioModifica_Internalname,A129Ciud_UsuarioModifica,GXutil.rtrim( localUtil.format( A129Ciud_UsuarioModifica, "@!")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtCiud_UsuarioModifica_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCiud_FechaModifica_Internalname,localUtil.ttoc( A130Ciud_FechaModifica, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A130Ciud_FechaModifica, "99/99/99 99:99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtCiud_FechaModifica_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_CIUD_CODIGO"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, localUtil.format( DecimalUtil.doubleToDec(A5Ciud_Codigo), "ZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_CIUD_USUARIOCREA"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A127Ciud_UsuarioCrea, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_CIUD_FECHACREA"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, localUtil.format( A128Ciud_FechaCrea, "99/99/99 99:99")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_CIUD_USUARIOMODIFICA"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A129Ciud_UsuarioModifica, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_CIUD_FECHAMODIFICA"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, localUtil.format( A130Ciud_FechaModifica, "99/99/99 99:99")));
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Dept_Codigo',fld:'vDEPT_CODIGO',pic:'ZZZ9',nv:0},{av:'AV13Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV6Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A5Ciud_Codigo',fld:'CIUD_CODIGO',pic:'ZZZ9',hsh:true,nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e132Q2',iparms:[{av:'A5Ciud_Codigo',fld:'CIUD_CODIGO',pic:'ZZZ9',hsh:true,nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtCiud_Descripcion_Link',ctrl:'CIUD_DESCRIPCION',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e112Q2',iparms:[{av:'A5Ciud_Codigo',fld:'CIUD_CODIGO',pic:'ZZZ9',hsh:true,nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H002Q2_A6Dept_Codigo = new short[1] ;
      H002Q2_A130Ciud_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H002Q2_A129Ciud_UsuarioModifica = new String[] {""} ;
      H002Q2_A128Ciud_FechaCrea = new java.util.Date[] {GXutil.nullDate()} ;
      H002Q2_A127Ciud_UsuarioCrea = new String[] {""} ;
      H002Q2_A7Ciud_Descripcion = new String[] {""} ;
      H002Q2_A5Ciud_Codigo = new short[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.gen_departamentogen_ciudadwc__default(),
         new Object[] {
             new Object[] {
            H002Q2_A6Dept_Codigo, H002Q2_A130Ciud_FechaModifica, H002Q2_A129Ciud_UsuarioModifica, H002Q2_A128Ciud_FechaCrea, H002Q2_A127Ciud_UsuarioCrea, H002Q2_A7Ciud_Descripcion, H002Q2_A5Ciud_Codigo
            }
            , new Object[] {
   ...
   private int edtDept_Codigo_Visible ;
   ...
   private String sCtrlAV7Dept_Codigo ;
   ...
   private short[] H002Q2_A6Dept_Codigo ;
   private java.util.Date[] H002Q2_A130Ciud_FechaModifica ;
   private String[] H002Q2_A129Ciud_UsuarioModifica ;
   private java.util.Date[] H002Q2_A128Ciud_FechaCrea ;
   private String[] H002Q2_A127Ciud_UsuarioCrea ;
   private String[] H002Q2_A7Ciud_Descripcion ;
   private short[] H002Q2_A5Ciud_Codigo ;
...
final  class gen_departamentogen_ciudadwc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H002Q2", "SELECT Dept_Codigo, Ciud_FechaModifica, Ciud_UsuarioModifica, Ciud_FechaCrea, Ciud_UsuarioCrea, Ciud_Descripcion, Ciud_Codigo FROM GEN_CIUDAD WHERE Dept_Codigo = ? ORDER BY Dept_Codigo  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H002Q3", "SELECT COUNT(*) FROM GEN_CIUDAD WHERE Dept_Codigo = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
