/*
               File: seg_rolpantwc_impl
        Description: SEG_ROLPant WC
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:16:5.53
...
public final  class seg_rolpantwc_impl extends GXWebComponent
{
   public seg_rolpantwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public seg_rolpantwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( seg_rolpantwc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Rol_Id, AV12Update, AV13Delete, A21Rol_Id, sPrefix) ;
               GXKey = com.genexus.util.Encryption.decrypt64( httpContext.getCookie( "GX_SESSION_ID"), context.getServerKey( )) ;
               GXKey = com.genexus.util.Encryption.decrypt64( httpContext.getCookie( "GX_SESSION_ID"), context.getServerKey( )) ;
               forbiddenHiddens = sPrefix + "hsh" + "SEG_ROLPantWC" ;
               forbiddenHiddens = forbiddenHiddens + localUtil.format( DecimalUtil.doubleToDec(A21Rol_Id), "ZZZZZZZZZZ9") ;
               com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"hsh", GXutil.getEncryptedSignature( forbiddenHiddens, GXKey));
               GXutil.writeLogln("seg_rolpantwc:[SendSecurityCheck]"+forbiddenHiddens);
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "SEG_ROLPant WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20186141416556");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.seg_rolpantwc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Rol_Id,11,0)))+"\">") ;
   ...
   public void renderHtmlCloseForm6B2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("seg_rolpantwc.js", "?20186141416559");
      }
   ...
   {
      return "SEG_ROLPantWC" ;
   }

   public String getPgmdesc( )
   {
      return "SEG_ROLPant WC" ;
   }
   ...
   public void wb6B0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.seg_rolpantwc");
         }
         /* Div Control */
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 7, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e116b1_client"+"'", TempTags, "", 2, "HLP_SEG_ROLPantWC.htm");
      ...
      if ( wbEnd == 20 )
      {
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtRol_Id_Internalname, GXutil.ltrim( localUtil.ntoc( A21Rol_Id, (byte)(11), (byte)(0), ",", "")), ((edtRol_Id_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A21Rol_Id), "ZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A21Rol_Id), "ZZZZZZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtRol_Id_Jsonclick, 0, "Attribute", "", "", "", edtRol_Id_Visible, edtRol_Id_Enabled, 0, "text", "", 11, "chr", 1, "row", 11, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Identificador", "right", false, "HLP_SEG_ROLPantWC.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start6B2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "SEG_ROLPant WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void strup6B0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         AV7Rol_Id = localUtil.ctol( httpContext.cgiGet( sPrefix+"vROL_ID"), ",", ".") ;
         ...
         if ( ! GXutil.checkEncryptedSignature( forbiddenHiddens, hsh, GXKey) )
         {
            ...
            GXutil.writeLog("seg_rolpantwc:[SecurityCheckFailed]"+forbiddenHiddens);
            return  ;
         }
   ...
   {
      /* Grid_Load Routine */
      edtavUpdate_Link = formatLink("com.orions2.seg_rolypantalla") + "?" + GXutil.URLEncode(GXutil.rtrim("UPD")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Rol_Id,11,0))) ;
      edtavDelete_Link = formatLink("com.orions2.seg_rolypantalla") + "?" + GXutil.URLEncode(GXutil.rtrim("DLT")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Rol_Id,11,0))) ;
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "seg_rolpantwc");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20186141416592");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("seg_rolpantwc.js", "?20186141416592");
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Rol_Id',fld:'vROL_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV12Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV13Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A21Rol_Id',fld:'ROL_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e136B2',iparms:[{av:'AV7Rol_Id',fld:'vROL_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'A21Rol_Id',fld:'ROL_ID',pic:'ZZZZZZZZZZ9',nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtRol_Descripcion_Link',ctrl:'ROL_DESCRIPCION',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e116B1',iparms:[{av:'AV7Rol_Id',fld:'vROL_ID',pic:'ZZZZZZZZZZ9',nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H006B2_A21Rol_Id = new long[1] ;
      H006B2_A22Rol_Descripcion = new String[] {""} ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.seg_rolpantwc__default(),
         new Object[] {
             new Object[] {
            H006B2_A21Rol_Id, H006B2_A22Rol_Descripcion
            }
            , new Object[] {
   ...
   private long[] H006B2_A21Rol_Id ;
   private String[] H006B2_A22Rol_Descripcion ;
...
final  class seg_rolpantwc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H006B2", "SELECT Rol_Id, Rol_Descripcion FROM SEG_ROL WHERE Rol_Id = ? ORDER BY Rol_Id  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H006B3", "SELECT COUNT(*) FROM SEG_ROL WHERE Rol_Id = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
