/*
               File: viewalm_inventario_devolutivo_impl
...
public final  class viewalm_inventario_devolutivo_impl extends GXDataArea
{
   public viewalm_inventario_devolutivo_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public viewalm_inventario_devolutivo_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( viewalm_inventario_devolutivo_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV13Invd_NumeroPlaca = gxfirstwebparm ;
            httpContext.ajax_rsp_assign_attri("", false, "AV13Invd_NumeroPlaca", AV13Invd_NumeroPlaca);
            httpContext.ajax_rsp_assign_attri("", false, "gxhash_vINVD_NUMEROPLACA", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13Invd_NumeroPlaca, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414185839");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.viewalm_inventario_devolutivo") + "?" + GXutil.URLEncode(GXutil.rtrim(AV13Invd_NumeroPlaca)) + "," + GXutil.URLEncode(GXutil.rtrim(AV14Elem_Consecutivo)) + "," + GXutil.URLEncode(GXutil.rtrim(AV7TabCode))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vINVD_NUMEROPLACA", AV13Invd_NumeroPlaca);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_vINVD_NUMEROPLACA", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13Invd_NumeroPlaca, ""))));
      ...
      forbiddenHiddens = "hsh" + "ViewALM_INVENTARIO_DEVOLUTIVO" ;
      forbiddenHiddens = forbiddenHiddens + GXutil.rtrim( localUtil.format( A67Invd_NumeroPlaca, "")) ;
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "hsh", GXutil.getEncryptedSignature( forbiddenHiddens, GXKey));
      GXutil.writeLogln("viewalm_inventario_devolutivo:[SendSecurityCheck]"+forbiddenHiddens);
   }
   ...
   {
      return formatLink("com.orions2.viewalm_inventario_devolutivo") + "?" + GXutil.URLEncode(GXutil.rtrim(AV13Invd_NumeroPlaca)) + "," + GXutil.URLEncode(GXutil.rtrim(AV14Elem_Consecutivo)) + "," + GXutil.URLEncode(GXutil.rtrim(AV7TabCode)) ;
   }

   public String getPgmname( )
   {
      return "ViewALM_INVENTARIO_DEVOLUTIVO" ;
   }
   ...
   public void wb2E0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, "Inventario devolutivo Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_ViewALM_INVENTARIO_DEVOLUTIVO.htm");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblViewall_Internalname, "Work With Inventario devolutivoes", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, (short)(0), "HLP_ViewALM_INVENTARIO_DEVOLUTIVO.htm");
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtInvd_NumeroPlaca_Internalname, A67Invd_NumeroPlaca, GXutil.rtrim( localUtil.format( A67Invd_NumeroPlaca, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtInvd_NumeroPlaca_Jsonclick, 0, "ReadonlyAttribute", "", "", "", 1, edtInvd_NumeroPlaca_Enabled, 0, "text", "", 30, "chr", 1, "row", 30, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_ViewALM_INVENTARIO_DEVOLUTIVO.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewALM_INVENTARIO_DEVOLUTIVO.htm");
         /* Div Control */
   ...
   public void start2E2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "View ALM_INVENTARIO_DEVOLUTIVO", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "ViewALM_INVENTARIO_DEVOLUTIVO" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf2E2( )
   {
      ...
      {
         /* Using cursor H002E2 */
         pr_default.execute(0, new Object[] {AV14Elem_Consecutivo, AV13Invd_NumeroPlaca});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A66Elem_Consecutivo = H002E2_A66Elem_Consecutivo[0] ;
            A67Invd_NumeroPlaca = H002E2_A67Invd_NumeroPlaca[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A67Invd_NumeroPlaca", A67Invd_NumeroPlaca);
            httpContext.ajax_rsp_assign_attri("", false, "gxhash_INVD_NUMEROPLACA", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A67Invd_NumeroPlaca, ""))));
            /* Execute user event: Load */
            e122E2 ();
   ...
   public void strup2E0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         httpContext.ajax_rsp_assign_attri("", false, "gxhash_INVD_NUMEROPLACA", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A67Invd_NumeroPlaca, ""))));
         /* Read saved values. */
         AV13Invd_NumeroPlaca = httpContext.cgiGet( "vINVD_NUMEROPLACA") ;
         ...
         if ( ! GXutil.checkEncryptedSignature( forbiddenHiddens, hsh, GXKey) )
         {
            ...
            GXutil.writeLog("viewalm_inventario_devolutivo:[SecurityCheckFailed]"+forbiddenHiddens);
            return  ;
         }
      }
      else
   ...
   public void e112E2( )
   {
      ...
      AV18GXLvl6 = (byte)(0) ;
      /* Using cursor H002E3 */
      pr_default.execute(1, new Object[] {AV14Elem_Consecutivo, AV13Invd_NumeroPlaca, AV13Invd_NumeroPlaca, AV14Elem_Consecutivo});
      while ( (pr_default.getStatus(1) != 101) )
      {
         A66Elem_Consecutivo = H002E3_A66Elem_Consecutivo[0] ;
         A67Invd_NumeroPlaca = H002E3_A67Invd_NumeroPlaca[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A67Invd_NumeroPlaca", A67Invd_NumeroPlaca);
         httpContext.ajax_rsp_assign_attri("", false, "gxhash_INVD_NUMEROPLACA", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A67Invd_NumeroPlaca, ""))));
         AV18GXLvl6 = (byte)(1) ;
         Form.setCaption( A67Invd_NumeroPlaca );
         httpContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.getCaption(), true);
         lblViewall_Link = formatLink("com.orions2.wwalm_inventario_devolutivo")  ;
   ...
   public void S112( )
   {
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "ALM_INVENTARIO_DEVOLUTIVOGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.orions2.alm_inventario_devolutivogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "ALM_INVENTARIO_DEVOLUTIVOGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0029","",AV13Invd_NumeroPlaca,AV14Elem_Consecutivo});
   ...
   {
      AV13Invd_NumeroPlaca = (String)getParm(obj,0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV13Invd_NumeroPlaca", AV13Invd_NumeroPlaca);
      httpContext.ajax_rsp_assign_attri("", false, "gxhash_vINVD_NUMEROPLACA", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13Invd_NumeroPlaca, ""))));
      AV14Elem_Consecutivo = (String)getParm(obj,1) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV14Elem_Consecutivo", AV14Elem_Consecutivo);
      httpContext.ajax_rsp_assign_attri("", false, "gxhash_vELEM_CONSECUTIVO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV14Elem_Consecutivo, ""))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414185868");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("viewalm_inventario_devolutivo.js", "?201861414185868");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "");
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "View ALM_INVENTARIO_DEVOLUTIVO" );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H002E2_A66Elem_Consecutivo = new String[] {""} ;
      H002E2_A67Invd_NumeroPlaca = new String[] {""} ;
      A66Elem_Consecutivo = "" ;
      hsh = "" ;
      H002E3_A66Elem_Consecutivo = new String[] {""} ;
      H002E3_A67Invd_NumeroPlaca = new String[] {""} ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.viewalm_inventario_devolutivo__default(),
         new Object[] {
             new Object[] {
            H002E2_A66Elem_Consecutivo, H002E2_A67Invd_NumeroPlaca
            }
            , new Object[] {
            H002E3_A66Elem_Consecutivo, H002E3_A67Invd_NumeroPlaca
            }
         }
      );
      AV17Pgmname = "ViewALM_INVENTARIO_DEVOLUTIVO" ;
   ...
   private String wcpOAV13Invd_NumeroPlaca ;
   ...
   private String[] H002E2_A66Elem_Consecutivo ;
   private String[] H002E2_A67Invd_NumeroPlaca ;
   private String[] H002E3_A66Elem_Consecutivo ;
   private String[] H002E3_A67Invd_NumeroPlaca ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class viewalm_inventario_devolutivo__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H002E2", "SELECT Elem_Consecutivo, Invd_NumeroPlaca FROM ALM_INVENTARIO_DEVOLUTIVO WHERE Elem_Consecutivo = ? and Invd_NumeroPlaca = ? ORDER BY Elem_Consecutivo, Invd_NumeroPlaca ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H002E3", "SELECT Elem_Consecutivo, Invd_NumeroPlaca FROM ALM_INVENTARIO_DEVOLUTIVO WHERE (Elem_Consecutivo = ? and Invd_NumeroPlaca = ?) AND (Invd_NumeroPlaca = ? and Elem_Consecutivo = ?) ORDER BY Elem_Consecutivo, Invd_NumeroPlaca ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
                              ...
                              Object[] parms ) throws SQLException
   {
      switch ( cursor )
      {
            ...
            case 1 :
               ...
               stmt.setVarchar(4, (String)parms[3], 9);
               return;
      }
   }
