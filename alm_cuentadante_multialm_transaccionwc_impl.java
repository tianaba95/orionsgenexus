/*
               File: alm_cuentadante_multialm_transaccionwc_impl
        Description: ALM_CUENTADANTE_MULTIALM_TRANSACCIONWC
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:12:37.3
...
public final  class alm_cuentadante_multialm_transaccionwc_impl extends GXWebComponent
{
   public alm_cuentadante_multialm_transaccionwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public alm_cuentadante_multialm_transaccionwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( alm_cuentadante_multialm_transaccionwc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV7Tran_IdCuentadanteOrigen = GXutil.lval( httpContext.GetNextPar( )) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Tran_IdCuentadanteOrigen", GXutil.ltrim( GXutil.str( AV7Tran_IdCuentadanteOrigen, 18, 0)));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,new Long(AV7Tran_IdCuentadanteOrigen)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Tran_IdCuentadanteOrigen, AV12Update, AV13Delete, A46Tran_Id, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "ALM_CUENTADANTE_MULTIALM_TRANSACCIONWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414123721");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.alm_cuentadante_multialm_transaccionwc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Tran_IdCuentadanteOrigen,18,0)))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV7Tran_IdCuentadanteOrigen", GXutil.ltrim( localUtil.ntoc( wcpOAV7Tran_IdCuentadanteOrigen, (byte)(18), (byte)(0), ",", "")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vTRAN_IDCUENTADANTEORIGEN", GXutil.ltrim( localUtil.ntoc( AV7Tran_IdCuentadanteOrigen, (byte)(18), (byte)(0), ",", "")));
   ...
   public void renderHtmlCloseForm1N2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("alm_cuentadante_multialm_transaccionwc.js", "?201861414123723");
      }
   ...
   {
      return "ALM_CUENTADANTE_MULTIALM_TRANSACCIONWC" ;
   }
   ...
   public void wb1N0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.alm_cuentadante_multialm_transaccionwc");
         }
         /* Div Control */
      ...
      if ( wbEnd == 20 )
      {
         ...
         com.orions2.GxWebStd.gx_label_element( httpContext, edtTran_IdCuentadanteOrigen_Internalname, "Cuentadante Origen", "col-sm-3 AttributeLabel", 0, true);
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtTran_IdCuentadanteOrigen_Internalname, GXutil.ltrim( localUtil.ntoc( A51Tran_IdCuentadanteOrigen, (byte)(18), (byte)(0), ",", "")), ((edtTran_IdCuentadanteOrigen_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A51Tran_IdCuentadanteOrigen), "ZZZZZZZZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A51Tran_IdCuentadanteOrigen), "ZZZZZZZZZZZZZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTran_IdCuentadanteOrigen_Jsonclick, 0, "Attribute", "", "", "", edtTran_IdCuentadanteOrigen_Visible, edtTran_IdCuentadanteOrigen_Enabled, 0, "text", "", 18, "chr", 1, "row", 18, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "HLP_ALM_CUENTADANTE_MULTIALM_TRANSACCIONWC.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start1N2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "ALM_CUENTADANTE_MULTIALM_TRANSACCIONWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 long AV7Tran_IdCuentadanteOrigen ,
                                 String AV12Update ,
                                 String AV13Delete ,
                                 long A46Tran_Id ,
                                 String sPrefix )
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "ALM_CUENTADANTE_MULTIALM_TRANSACCIONWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf1N2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H001N2 */
         pr_default.execute(0, new Object[] {new Long(AV7Tran_IdCuentadanteOrigen), new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_20_idx = (short)(1) ;
         sGXsfl_20_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_20_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_202( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A416Tran_Observaciones = H001N2_A416Tran_Observaciones[0] ;
            n416Tran_Observaciones = H001N2_n416Tran_Observaciones[0] ;
            A51Tran_IdCuentadanteOrigen = H001N2_A51Tran_IdCuentadanteOrigen[0] ;
            ...
            n51Tran_IdCuentadanteOrigen = H001N2_n51Tran_IdCuentadanteOrigen[0] ;
            A859Tran_EntidadGobierno = H001N2_A859Tran_EntidadGobierno[0] ;
            n859Tran_EntidadGobierno = H001N2_n859Tran_EntidadGobierno[0] ;
            A758Tran_TablaResponsabilidad = H001N2_A758Tran_TablaResponsabilidad[0] ;
            n758Tran_TablaResponsabilidad = H001N2_n758Tran_TablaResponsabilidad[0] ;
            A720Tran_FechaResponsabilidad = H001N2_A720Tran_FechaResponsabilidad[0] ;
            n720Tran_FechaResponsabilidad = H001N2_n720Tran_FechaResponsabilidad[0] ;
            A719Tran_TransaccResponsabilidad = H001N2_A719Tran_TransaccResponsabilidad[0] ;
            n719Tran_TransaccResponsabilidad = H001N2_n719Tran_TransaccResponsabilidad[0] ;
            A721Tran_NombreCuentadanteResponsa = H001N2_A721Tran_NombreCuentadanteResponsa[0] ;
            n721Tran_NombreCuentadanteResponsa = H001N2_n721Tran_NombreCuentadanteResponsa[0] ;
            A759Tran_CedulaResponsabilidad = H001N2_A759Tran_CedulaResponsabilidad[0] ;
            n759Tran_CedulaResponsabilidad = H001N2_n759Tran_CedulaResponsabilidad[0] ;
            A56Tran_IdCuentadanteResponsabili = H001N2_A56Tran_IdCuentadanteResponsabili[0] ;
            n56Tran_IdCuentadanteResponsabili = H001N2_n56Tran_IdCuentadanteResponsabili[0] ;
            A670Tran_ObservacionesAnula = H001N2_A670Tran_ObservacionesAnula[0] ;
            n670Tran_ObservacionesAnula = H001N2_n670Tran_ObservacionesAnula[0] ;
            A669Tran_FechaEliminaoAnula = H001N2_A669Tran_FechaEliminaoAnula[0] ;
            n669Tran_FechaEliminaoAnula = H001N2_n669Tran_FechaEliminaoAnula[0] ;
            A668Tran_UsuarioEliminaoAnula = H001N2_A668Tran_UsuarioEliminaoAnula[0] ;
            n668Tran_UsuarioEliminaoAnula = H001N2_n668Tran_UsuarioEliminaoAnula[0] ;
            A667Tran_NumeroGrupo = H001N2_A667Tran_NumeroGrupo[0] ;
            n667Tran_NumeroGrupo = H001N2_n667Tran_NumeroGrupo[0] ;
            A568Tran_CantidadPadres = H001N2_A568Tran_CantidadPadres[0] ;
            n568Tran_CantidadPadres = H001N2_n568Tran_CantidadPadres[0] ;
            A527Tran_TipoEntra = H001N2_A527Tran_TipoEntra[0] ;
            n527Tran_TipoEntra = H001N2_n527Tran_TipoEntra[0] ;
            A524Tran_Detalle = H001N2_A524Tran_Detalle[0] ;
            n524Tran_Detalle = H001N2_n524Tran_Detalle[0] ;
            A608Tran_RegionAbrevDestino = H001N2_A608Tran_RegionAbrevDestino[0] ;
            n608Tran_RegionAbrevDestino = H001N2_n608Tran_RegionAbrevDestino[0] ;
            A520Tran_RegionDescripcionDestino = H001N2_A520Tran_RegionDescripcionDestino[0] ;
            n520Tran_RegionDescripcionDestino = H001N2_n520Tran_RegionDescripcionDestino[0] ;
            A519Tran_RegionCodigoDestino = H001N2_A519Tran_RegionCodigoDestino[0] ;
            n519Tran_RegionCodigoDestino = H001N2_n519Tran_RegionCodigoDestino[0] ;
            A518Tran_RegionIdDestino = H001N2_A518Tran_RegionIdDestino[0] ;
            n518Tran_RegionIdDestino = H001N2_n518Tran_RegionIdDestino[0] ;
            A517Tran_CentroCostoDescripcionDes = H001N2_A517Tran_CentroCostoDescripcionDes[0] ;
            n517Tran_CentroCostoDescripcionDes = H001N2_n517Tran_CentroCostoDescripcionDes[0] ;
            A516Tran_CentroCostoCodigoDestino = H001N2_A516Tran_CentroCostoCodigoDestino[0] ;
            n516Tran_CentroCostoCodigoDestino = H001N2_n516Tran_CentroCostoCodigoDestino[0] ;
            A50Tran_CentroCostoIdDestino = H001N2_A50Tran_CentroCostoIdDestino[0] ;
            n50Tran_CentroCostoIdDestino = H001N2_n50Tran_CentroCostoIdDestino[0] ;
            A515Tran_FechaIngreso = H001N2_A515Tran_FechaIngreso[0] ;
            n515Tran_FechaIngreso = H001N2_n515Tran_FechaIngreso[0] ;
            A514Tran_NumeroIngreso = H001N2_A514Tran_NumeroIngreso[0] ;
            n514Tran_NumeroIngreso = H001N2_n514Tran_NumeroIngreso[0] ;
            A756Tran_Abreviado = H001N2_A756Tran_Abreviado[0] ;
            n756Tran_Abreviado = H001N2_n756Tran_Abreviado[0] ;
            A672Tran_NombreIngreso = H001N2_A672Tran_NombreIngreso[0] ;
            n672Tran_NombreIngreso = H001N2_n672Tran_NombreIngreso[0] ;
            A54Tran_TipoIngreso = H001N2_A54Tran_TipoIngreso[0] ;
            n54Tran_TipoIngreso = H001N2_n54Tran_TipoIngreso[0] ;
            A513Tran_ConsecutivoCC = H001N2_A513Tran_ConsecutivoCC[0] ;
            n513Tran_ConsecutivoCC = H001N2_n513Tran_ConsecutivoCC[0] ;
            A391Tran_UsuarioRatifica = H001N2_A391Tran_UsuarioRatifica[0] ;
            n391Tran_UsuarioRatifica = H001N2_n391Tran_UsuarioRatifica[0] ;
            A390Tran_FechaRatificacion = H001N2_A390Tran_FechaRatificacion[0] ;
            n390Tran_FechaRatificacion = H001N2_n390Tran_FechaRatificacion[0] ;
            A58Tran_Estado = H001N2_A58Tran_Estado[0] ;
            n58Tran_Estado = H001N2_n58Tran_Estado[0] ;
            A498Tran_NumeroLineas = H001N2_A498Tran_NumeroLineas[0] ;
            n498Tran_NumeroLineas = H001N2_n498Tran_NumeroLineas[0] ;
            A483Tran_ValorTransaccion = H001N2_A483Tran_ValorTransaccion[0] ;
            n483Tran_ValorTransaccion = H001N2_n483Tran_ValorTransaccion[0] ;
            A408Tran_CursoCodigo = H001N2_A408Tran_CursoCodigo[0] ;
            n408Tran_CursoCodigo = H001N2_n408Tran_CursoCodigo[0] ;
            A407Tran_AreadanteCodigo = H001N2_A407Tran_AreadanteCodigo[0] ;
            n407Tran_AreadanteCodigo = H001N2_n407Tran_AreadanteCodigo[0] ;
            A715Tran_EmailCuentadanteDestino = H001N2_A715Tran_EmailCuentadanteDestino[0] ;
            n715Tran_EmailCuentadanteDestino = H001N2_n715Tran_EmailCuentadanteDestino[0] ;
            A704Tran_CedulaCuentadanteDestino = H001N2_A704Tran_CedulaCuentadanteDestino[0] ;
            n704Tran_CedulaCuentadanteDestino = H001N2_n704Tran_CedulaCuentadanteDestino[0] ;
            A389Tran_NombCuentadanteDestino = H001N2_A389Tran_NombCuentadanteDestino[0] ;
            n389Tran_NombCuentadanteDestino = H001N2_n389Tran_NombCuentadanteDestino[0] ;
            A52Tran_IdCuentadanteDestino = H001N2_A52Tran_IdCuentadanteDestino[0] ;
            n52Tran_IdCuentadanteDestino = H001N2_n52Tran_IdCuentadanteDestino[0] ;
            A387Tran_CodBodeDestino = H001N2_A387Tran_CodBodeDestino[0] ;
            A111Tran_CodAlmaDestino = H001N2_A111Tran_CodAlmaDestino[0] ;
            A385Tran_ModuloDestino = H001N2_A385Tran_ModuloDestino[0] ;
            A703Tran_CedulaProveedor = H001N2_A703Tran_CedulaProveedor[0] ;
            n703Tran_CedulaProveedor = H001N2_n703Tran_CedulaProveedor[0] ;
            A575Tran_NombreProveedor = H001N2_A575Tran_NombreProveedor[0] ;
            n575Tran_NombreProveedor = H001N2_n575Tran_NombreProveedor[0] ;
            A53Tran_IdProveedor = H001N2_A53Tran_IdProveedor[0] ;
            n53Tran_IdProveedor = H001N2_n53Tran_IdProveedor[0] ;
            A112Tran_CodBodeOrigen = H001N2_A112Tran_CodBodeOrigen[0] ;
            A109Tran_CodAlmaOrigen = H001N2_A109Tran_CodAlmaOrigen[0] ;
            A110Tran_ModuloOrigen = H001N2_A110Tran_ModuloOrigen[0] ;
            A754Tran_CuentaResponsabilidad = H001N2_A754Tran_CuentaResponsabilidad[0] ;
            n754Tran_CuentaResponsabilidad = H001N2_n754Tran_CuentaResponsabilidad[0] ;
            A708Tran_SolicitaRegionDestino = H001N2_A708Tran_SolicitaRegionDestino[0] ;
            n708Tran_SolicitaRegionDestino = H001N2_n708Tran_SolicitaRegionDestino[0] ;
            A707Tran_SolicitaCCDestino = H001N2_A707Tran_SolicitaCCDestino[0] ;
            n707Tran_SolicitaCCDestino = H001N2_n707Tran_SolicitaCCDestino[0] ;
            A482Tran_TipoElemento = H001N2_A482Tran_TipoElemento[0] ;
            A499Tran_CodTipoElemento = H001N2_A499Tran_CodTipoElemento[0] ;
            n499Tran_CodTipoElemento = H001N2_n499Tran_CodTipoElemento[0] ;
            A479Tran_IndCurso = H001N2_A479Tran_IndCurso[0] ;
            n479Tran_IndCurso = H001N2_n479Tran_IndCurso[0] ;
            A481Tran_IndE_S = H001N2_A481Tran_IndE_S[0] ;
            n481Tran_IndE_S = H001N2_n481Tran_IndE_S[0] ;
            A478Tran_IndAreadante = H001N2_A478Tran_IndAreadante[0] ;
            n478Tran_IndAreadante = H001N2_n478Tran_IndAreadante[0] ;
            A381Tran_DescripcionMovimiento = H001N2_A381Tran_DescripcionMovimiento[0] ;
            n381Tran_DescripcionMovimiento = H001N2_n381Tran_DescripcionMovimiento[0] ;
            A49Tran_CodigoMovimiento = H001N2_A49Tran_CodigoMovimiento[0] ;
            A594Tran_RegionAbrev = H001N2_A594Tran_RegionAbrev[0] ;
            n594Tran_RegionAbrev = H001N2_n594Tran_RegionAbrev[0] ;
            A422Tran_RegionDescripcion = H001N2_A422Tran_RegionDescripcion[0] ;
            n422Tran_RegionDescripcion = H001N2_n422Tran_RegionDescripcion[0] ;
            A421Tran_RegionCodigo = H001N2_A421Tran_RegionCodigo[0] ;
            n421Tran_RegionCodigo = H001N2_n421Tran_RegionCodigo[0] ;
            A57Tran_RegionId = H001N2_A57Tran_RegionId[0] ;
            n57Tran_RegionId = H001N2_n57Tran_RegionId[0] ;
            A420Tran_CentroCostoDescripcion = H001N2_A420Tran_CentroCostoDescripcion[0] ;
            n420Tran_CentroCostoDescripcion = H001N2_n420Tran_CentroCostoDescripcion[0] ;
            A419Tran_CentroCostoCodigo = H001N2_A419Tran_CentroCostoCodigo[0] ;
            n419Tran_CentroCostoCodigo = H001N2_n419Tran_CentroCostoCodigo[0] ;
            A48Tran_CentroCostoId = H001N2_A48Tran_CentroCostoId[0] ;
            A418Tran_UsuarioNombre = H001N2_A418Tran_UsuarioNombre[0] ;
            n418Tran_UsuarioNombre = H001N2_n418Tran_UsuarioNombre[0] ;
            A417Tran_UsuarioCodigo = H001N2_A417Tran_UsuarioCodigo[0] ;
            n417Tran_UsuarioCodigo = H001N2_n417Tran_UsuarioCodigo[0] ;
            A47Tran_UsuarioId = H001N2_A47Tran_UsuarioId[0] ;
            n47Tran_UsuarioId = H001N2_n47Tran_UsuarioId[0] ;
            A55Tran_FechaRegistro = H001N2_A55Tran_FechaRegistro[0] ;
            A46Tran_Id = H001N2_A46Tran_Id[0] ;
            A721Tran_NombreCuentadanteResponsa = H001N2_A721Tran_NombreCuentadanteResponsa[0] ;
            n721Tran_NombreCuentadanteResponsa = H001N2_n721Tran_NombreCuentadanteResponsa[0] ;
            A759Tran_CedulaResponsabilidad = H001N2_A759Tran_CedulaResponsabilidad[0] ;
            n759Tran_CedulaResponsabilidad = H001N2_n759Tran_CedulaResponsabilidad[0] ;
   ...
   {
      /* Using cursor H001N3 */
      pr_default.execute(1, new Object[] {new Long(AV7Tran_IdCuentadanteOrigen)});
   ...
   public void strup1N0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV7Tran_IdCuentadanteOrigen = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV7Tran_IdCuentadanteOrigen"), ",", ".") ;
   ...
   public void e121N2( )
   {
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext, !bGXsfl_20_Refreshing);
      edtTran_IdCuentadanteOrigen_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtTran_IdCuentadanteOrigen_Internalname, "Visible", GXutil.ltrim( GXutil.str( edtTran_IdCuentadanteOrigen_Visible, 5, 0)), true);
   ...
   public void S112( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributename( "Tran_IdCuentadanteOrigen" );
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( GXutil.str( AV7Tran_IdCuentadanteOrigen, 18, 0) );
   ...
   {
      AV7Tran_IdCuentadanteOrigen = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Tran_IdCuentadanteOrigen", GXutil.ltrim( GXutil.str( AV7Tran_IdCuentadanteOrigen, 18, 0)));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV7Tran_IdCuentadanteOrigen = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "alm_cuentadante_multialm_transaccionwc");
      ...
      {
         AV7Tran_IdCuentadanteOrigen = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Tran_IdCuentadanteOrigen", GXutil.ltrim( GXutil.str( AV7Tran_IdCuentadanteOrigen, 18, 0)));
      }
      wcpOAV7Tran_IdCuentadanteOrigen = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV7Tran_IdCuentadanteOrigen"), ",", ".") ;
      if ( ! GetJustCreated( ) && ( ( AV7Tran_IdCuentadanteOrigen != wcpOAV7Tran_IdCuentadanteOrigen ) ) )
      {
         setjustcreated();
      }
      wcpOAV7Tran_IdCuentadanteOrigen = AV7Tran_IdCuentadanteOrigen ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV7Tran_IdCuentadanteOrigen = httpContext.cgiGet( sPrefix+"AV7Tran_IdCuentadanteOrigen_CTRL") ;
      if ( GXutil.len( sCtrlAV7Tran_IdCuentadanteOrigen) > 0 )
      {
         AV7Tran_IdCuentadanteOrigen = localUtil.ctol( httpContext.cgiGet( sCtrlAV7Tran_IdCuentadanteOrigen), ",", ".") ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Tran_IdCuentadanteOrigen", GXutil.ltrim( GXutil.str( AV7Tran_IdCuentadanteOrigen, 18, 0)));
      }
      else
      {
         AV7Tran_IdCuentadanteOrigen = localUtil.ctol( httpContext.cgiGet( sPrefix+"AV7Tran_IdCuentadanteOrigen_PARM"), ",", ".") ;
      }
   }
   ...
   {
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Tran_IdCuentadanteOrigen_PARM", GXutil.ltrim( localUtil.ntoc( AV7Tran_IdCuentadanteOrigen, (byte)(18), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV7Tran_IdCuentadanteOrigen)) > 0 )
      {
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Tran_IdCuentadanteOrigen_CTRL", GXutil.rtrim( sCtrlAV7Tran_IdCuentadanteOrigen));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414123995");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("alm_cuentadante_multialm_transaccionwc.js", "?201861414123995");
      }
   ...
   public void initialize_properties( )
   {
      ...
      edtTran_IdCuentadanteOrigen_Visible = 1 ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Tran_IdCuentadanteOrigen',fld:'vTRAN_IDCUENTADANTEORIGEN',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV12Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV13Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e131N2',iparms:[{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtTran_ConsecutivoCC_Link',ctrl:'TRAN_CONSECUTIVOCC',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e111N2',iparms:[{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H001N2_A416Tran_Observaciones = new String[] {""} ;
      H001N2_n416Tran_Observaciones = new boolean[] {false} ;
      H001N2_A51Tran_IdCuentadanteOrigen = new long[1] ;
      H001N2_n51Tran_IdCuentadanteOrigen = new boolean[] {false} ;
      H001N2_A859Tran_EntidadGobierno = new String[] {""} ;
      H001N2_n859Tran_EntidadGobierno = new boolean[] {false} ;
      H001N2_A758Tran_TablaResponsabilidad = new short[1] ;
      H001N2_n758Tran_TablaResponsabilidad = new boolean[] {false} ;
      H001N2_A720Tran_FechaResponsabilidad = new java.util.Date[] {GXutil.nullDate()} ;
      H001N2_n720Tran_FechaResponsabilidad = new boolean[] {false} ;
      H001N2_A719Tran_TransaccResponsabilidad = new long[1] ;
      H001N2_n719Tran_TransaccResponsabilidad = new boolean[] {false} ;
      H001N2_A721Tran_NombreCuentadanteResponsa = new String[] {""} ;
      H001N2_n721Tran_NombreCuentadanteResponsa = new boolean[] {false} ;
      H001N2_A759Tran_CedulaResponsabilidad = new long[1] ;
      H001N2_n759Tran_CedulaResponsabilidad = new boolean[] {false} ;
      H001N2_A56Tran_IdCuentadanteResponsabili = new long[1] ;
      H001N2_n56Tran_IdCuentadanteResponsabili = new boolean[] {false} ;
      H001N2_A670Tran_ObservacionesAnula = new String[] {""} ;
      H001N2_n670Tran_ObservacionesAnula = new boolean[] {false} ;
      H001N2_A669Tran_FechaEliminaoAnula = new java.util.Date[] {GXutil.nullDate()} ;
      H001N2_n669Tran_FechaEliminaoAnula = new boolean[] {false} ;
      H001N2_A668Tran_UsuarioEliminaoAnula = new String[] {""} ;
      H001N2_n668Tran_UsuarioEliminaoAnula = new boolean[] {false} ;
      H001N2_A667Tran_NumeroGrupo = new short[1] ;
      H001N2_n667Tran_NumeroGrupo = new boolean[] {false} ;
      H001N2_A568Tran_CantidadPadres = new int[1] ;
      H001N2_n568Tran_CantidadPadres = new boolean[] {false} ;
      H001N2_A527Tran_TipoEntra = new String[] {""} ;
      H001N2_n527Tran_TipoEntra = new boolean[] {false} ;
      H001N2_A524Tran_Detalle = new String[] {""} ;
      H001N2_n524Tran_Detalle = new boolean[] {false} ;
      H001N2_A608Tran_RegionAbrevDestino = new String[] {""} ;
      H001N2_n608Tran_RegionAbrevDestino = new boolean[] {false} ;
      H001N2_A520Tran_RegionDescripcionDestino = new String[] {""} ;
      H001N2_n520Tran_RegionDescripcionDestino = new boolean[] {false} ;
      H001N2_A519Tran_RegionCodigoDestino = new short[1] ;
      H001N2_n519Tran_RegionCodigoDestino = new boolean[] {false} ;
      H001N2_A518Tran_RegionIdDestino = new long[1] ;
      H001N2_n518Tran_RegionIdDestino = new boolean[] {false} ;
      H001N2_A517Tran_CentroCostoDescripcionDes = new String[] {""} ;
      H001N2_n517Tran_CentroCostoDescripcionDes = new boolean[] {false} ;
      H001N2_A516Tran_CentroCostoCodigoDestino = new String[] {""} ;
      H001N2_n516Tran_CentroCostoCodigoDestino = new boolean[] {false} ;
      H001N2_A50Tran_CentroCostoIdDestino = new long[1] ;
      H001N2_n50Tran_CentroCostoIdDestino = new boolean[] {false} ;
      H001N2_A515Tran_FechaIngreso = new java.util.Date[] {GXutil.nullDate()} ;
      H001N2_n515Tran_FechaIngreso = new boolean[] {false} ;
      H001N2_A514Tran_NumeroIngreso = new String[] {""} ;
      H001N2_n514Tran_NumeroIngreso = new boolean[] {false} ;
      H001N2_A756Tran_Abreviado = new String[] {""} ;
      H001N2_n756Tran_Abreviado = new boolean[] {false} ;
      H001N2_A672Tran_NombreIngreso = new String[] {""} ;
      H001N2_n672Tran_NombreIngreso = new boolean[] {false} ;
      H001N2_A54Tran_TipoIngreso = new long[1] ;
      H001N2_n54Tran_TipoIngreso = new boolean[] {false} ;
      H001N2_A513Tran_ConsecutivoCC = new long[1] ;
      H001N2_n513Tran_ConsecutivoCC = new boolean[] {false} ;
      H001N2_A391Tran_UsuarioRatifica = new String[] {""} ;
      H001N2_n391Tran_UsuarioRatifica = new boolean[] {false} ;
      H001N2_A390Tran_FechaRatificacion = new java.util.Date[] {GXutil.nullDate()} ;
      H001N2_n390Tran_FechaRatificacion = new boolean[] {false} ;
      H001N2_A58Tran_Estado = new String[] {""} ;
      H001N2_n58Tran_Estado = new boolean[] {false} ;
      H001N2_A498Tran_NumeroLineas = new long[1] ;
      H001N2_n498Tran_NumeroLineas = new boolean[] {false} ;
      H001N2_A483Tran_ValorTransaccion = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H001N2_n483Tran_ValorTransaccion = new boolean[] {false} ;
      H001N2_A408Tran_CursoCodigo = new String[] {""} ;
      H001N2_n408Tran_CursoCodigo = new boolean[] {false} ;
      H001N2_A407Tran_AreadanteCodigo = new String[] {""} ;
      H001N2_n407Tran_AreadanteCodigo = new boolean[] {false} ;
      H001N2_A715Tran_EmailCuentadanteDestino = new String[] {""} ;
      H001N2_n715Tran_EmailCuentadanteDestino = new boolean[] {false} ;
      H001N2_A704Tran_CedulaCuentadanteDestino = new long[1] ;
      H001N2_n704Tran_CedulaCuentadanteDestino = new boolean[] {false} ;
      H001N2_A389Tran_NombCuentadanteDestino = new String[] {""} ;
      H001N2_n389Tran_NombCuentadanteDestino = new boolean[] {false} ;
      H001N2_A52Tran_IdCuentadanteDestino = new long[1] ;
      H001N2_n52Tran_IdCuentadanteDestino = new boolean[] {false} ;
      H001N2_A387Tran_CodBodeDestino = new String[] {""} ;
      H001N2_A111Tran_CodAlmaDestino = new String[] {""} ;
      H001N2_A385Tran_ModuloDestino = new String[] {""} ;
      H001N2_A703Tran_CedulaProveedor = new long[1] ;
      H001N2_n703Tran_CedulaProveedor = new boolean[] {false} ;
      H001N2_A575Tran_NombreProveedor = new String[] {""} ;
      H001N2_n575Tran_NombreProveedor = new boolean[] {false} ;
      H001N2_A53Tran_IdProveedor = new long[1] ;
      H001N2_n53Tran_IdProveedor = new boolean[] {false} ;
      H001N2_A112Tran_CodBodeOrigen = new String[] {""} ;
      H001N2_A109Tran_CodAlmaOrigen = new String[] {""} ;
      H001N2_A110Tran_ModuloOrigen = new String[] {""} ;
      H001N2_A754Tran_CuentaResponsabilidad = new String[] {""} ;
      H001N2_n754Tran_CuentaResponsabilidad = new boolean[] {false} ;
      H001N2_A708Tran_SolicitaRegionDestino = new String[] {""} ;
      H001N2_n708Tran_SolicitaRegionDestino = new boolean[] {false} ;
      H001N2_A707Tran_SolicitaCCDestino = new String[] {""} ;
      H001N2_n707Tran_SolicitaCCDestino = new boolean[] {false} ;
      H001N2_A482Tran_TipoElemento = new String[] {""} ;
      H001N2_A499Tran_CodTipoElemento = new long[1] ;
      H001N2_n499Tran_CodTipoElemento = new boolean[] {false} ;
      H001N2_A479Tran_IndCurso = new String[] {""} ;
      H001N2_n479Tran_IndCurso = new boolean[] {false} ;
      H001N2_A481Tran_IndE_S = new String[] {""} ;
      H001N2_n481Tran_IndE_S = new boolean[] {false} ;
      H001N2_A478Tran_IndAreadante = new String[] {""} ;
      H001N2_n478Tran_IndAreadante = new boolean[] {false} ;
      H001N2_A381Tran_DescripcionMovimiento = new String[] {""} ;
      H001N2_n381Tran_DescripcionMovimiento = new boolean[] {false} ;
      H001N2_A49Tran_CodigoMovimiento = new String[] {""} ;
      H001N2_A594Tran_RegionAbrev = new String[] {""} ;
      H001N2_n594Tran_RegionAbrev = new boolean[] {false} ;
      H001N2_A422Tran_RegionDescripcion = new String[] {""} ;
      H001N2_n422Tran_RegionDescripcion = new boolean[] {false} ;
      H001N2_A421Tran_RegionCodigo = new short[1] ;
      H001N2_n421Tran_RegionCodigo = new boolean[] {false} ;
      H001N2_A57Tran_RegionId = new long[1] ;
      H001N2_n57Tran_RegionId = new boolean[] {false} ;
      H001N2_A420Tran_CentroCostoDescripcion = new String[] {""} ;
      H001N2_n420Tran_CentroCostoDescripcion = new boolean[] {false} ;
      H001N2_A419Tran_CentroCostoCodigo = new String[] {""} ;
      H001N2_n419Tran_CentroCostoCodigo = new boolean[] {false} ;
      H001N2_A48Tran_CentroCostoId = new long[1] ;
      H001N2_A418Tran_UsuarioNombre = new String[] {""} ;
      H001N2_n418Tran_UsuarioNombre = new boolean[] {false} ;
      H001N2_A417Tran_UsuarioCodigo = new String[] {""} ;
      H001N2_n417Tran_UsuarioCodigo = new boolean[] {false} ;
      H001N2_A47Tran_UsuarioId = new long[1] ;
      H001N2_n47Tran_UsuarioId = new boolean[] {false} ;
      H001N2_A55Tran_FechaRegistro = new java.util.Date[] {GXutil.nullDate()} ;
      H001N2_A46Tran_Id = new long[1] ;
      ...
      sCtrlAV7Tran_IdCuentadanteOrigen = "" ;
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.alm_cuentadante_multialm_transaccionwc__default(),
         new Object[] {
             new Object[] {
            H001N2_A416Tran_Observaciones, H001N2_n416Tran_Observaciones, H001N2_A51Tran_IdCuentadanteOrigen, H001N2_n51Tran_IdCuentadanteOrigen, H001N2_A859Tran_EntidadGobierno, H001N2_n859Tran_EntidadGobierno, H001N2_A758Tran_TablaResponsabilidad, H001N2_n758Tran_TablaResponsabilidad, H001N2_A720Tran_FechaResponsabilidad, H001N2_n720Tran_FechaResponsabilidad,
            H001N2_A719Tran_TransaccResponsabilidad, H001N2_n719Tran_TransaccResponsabilidad, H001N2_A721Tran_NombreCuentadanteResponsa, H001N2_n721Tran_NombreCuentadanteResponsa, H001N2_A759Tran_CedulaResponsabilidad, H001N2_n759Tran_CedulaResponsabilidad, H001N2_A56Tran_IdCuentadanteResponsabili, H001N2_n56Tran_IdCuentadanteResponsabili, H001N2_A670Tran_ObservacionesAnula, H001N2_n670Tran_ObservacionesAnula,
            H001N2_A669Tran_FechaEliminaoAnula, H001N2_n669Tran_FechaEliminaoAnula, H001N2_A668Tran_UsuarioEliminaoAnula, H001N2_n668Tran_UsuarioEliminaoAnula, H001N2_A667Tran_NumeroGrupo, H001N2_n667Tran_NumeroGrupo, H001N2_A568Tran_CantidadPadres, H001N2_n568Tran_CantidadPadres, H001N2_A527Tran_TipoEntra, H001N2_n527Tran_TipoEntra,
            H001N2_A524Tran_Detalle, H001N2_n524Tran_Detalle, H001N2_A608Tran_RegionAbrevDestino, H001N2_n608Tran_RegionAbrevDestino, H001N2_A520Tran_RegionDescripcionDestino, H001N2_n520Tran_RegionDescripcionDestino, H001N2_A519Tran_RegionCodigoDestino, H001N2_n519Tran_RegionCodigoDestino, H001N2_A518Tran_RegionIdDestino, H001N2_n518Tran_RegionIdDestino,
            H001N2_A517Tran_CentroCostoDescripcionDes, H001N2_n517Tran_CentroCostoDescripcionDes, H001N2_A516Tran_CentroCostoCodigoDestino, H001N2_n516Tran_CentroCostoCodigoDestino, H001N2_A50Tran_CentroCostoIdDestino, H001N2_n50Tran_CentroCostoIdDestino, H001N2_A515Tran_FechaIngreso, H001N2_n515Tran_FechaIngreso, H001N2_A514Tran_NumeroIngreso, H001N2_n514Tran_NumeroIngreso,
            H001N2_A756Tran_Abreviado, H001N2_n756Tran_Abreviado, H001N2_A672Tran_NombreIngreso, H001N2_n672Tran_NombreIngreso, H001N2_A54Tran_TipoIngreso, H001N2_n54Tran_TipoIngreso, H001N2_A513Tran_ConsecutivoCC, H001N2_n513Tran_ConsecutivoCC, H001N2_A391Tran_UsuarioRatifica, H001N2_n391Tran_UsuarioRatifica,
            H001N2_A390Tran_FechaRatificacion, H001N2_n390Tran_FechaRatificacion, H001N2_A58Tran_Estado, H001N2_n58Tran_Estado, H001N2_A498Tran_NumeroLineas, H001N2_n498Tran_NumeroLineas, H001N2_A483Tran_ValorTransaccion, H001N2_n483Tran_ValorTransaccion, H001N2_A408Tran_CursoCodigo, H001N2_n408Tran_CursoCodigo,
            H001N2_A407Tran_AreadanteCodigo, H001N2_n407Tran_AreadanteCodigo, H001N2_A715Tran_EmailCuentadanteDestino, H001N2_n715Tran_EmailCuentadanteDestino, H001N2_A704Tran_CedulaCuentadanteDestino, H001N2_n704Tran_CedulaCuentadanteDestino, H001N2_A389Tran_NombCuentadanteDestino, H001N2_n389Tran_NombCuentadanteDestino, H001N2_A52Tran_IdCuentadanteDestino, H001N2_n52Tran_IdCuentadanteDestino,
            H001N2_A387Tran_CodBodeDestino, H001N2_A111Tran_CodAlmaDestino, H001N2_A385Tran_ModuloDestino, H001N2_A703Tran_CedulaProveedor, H001N2_n703Tran_CedulaProveedor, H001N2_A575Tran_NombreProveedor, H001N2_n575Tran_NombreProveedor, H001N2_A53Tran_IdProveedor, H001N2_n53Tran_IdProveedor, H001N2_A112Tran_CodBodeOrigen,
            H001N2_A109Tran_CodAlmaOrigen, H001N2_A110Tran_ModuloOrigen, H001N2_A754Tran_CuentaResponsabilidad, H001N2_n754Tran_CuentaResponsabilidad, H001N2_A708Tran_SolicitaRegionDestino, H001N2_n708Tran_SolicitaRegionDestino, H001N2_A707Tran_SolicitaCCDestino, H001N2_n707Tran_SolicitaCCDestino, H001N2_A482Tran_TipoElemento, H001N2_A499Tran_CodTipoElemento,
            H001N2_n499Tran_CodTipoElemento, H001N2_A479Tran_IndCurso, H001N2_n479Tran_IndCurso, H001N2_A481Tran_IndE_S, H001N2_n481Tran_IndE_S, H001N2_A478Tran_IndAreadante, H001N2_n478Tran_IndAreadante, H001N2_A381Tran_DescripcionMovimiento, H001N2_n381Tran_DescripcionMovimiento, H001N2_A49Tran_CodigoMovimiento,
            H001N2_A594Tran_RegionAbrev, H001N2_n594Tran_RegionAbrev, H001N2_A422Tran_RegionDescripcion, H001N2_n422Tran_RegionDescripcion, H001N2_A421Tran_RegionCodigo, H001N2_n421Tran_RegionCodigo, H001N2_A57Tran_RegionId, H001N2_n57Tran_RegionId, H001N2_A420Tran_CentroCostoDescripcion, H001N2_n420Tran_CentroCostoDescripcion,
            H001N2_A419Tran_CentroCostoCodigo, H001N2_n419Tran_CentroCostoCodigo, H001N2_A48Tran_CentroCostoId, H001N2_A418Tran_UsuarioNombre, H001N2_n418Tran_UsuarioNombre, H001N2_A417Tran_UsuarioCodigo, H001N2_n417Tran_UsuarioCodigo, H001N2_A47Tran_UsuarioId, H001N2_n47Tran_UsuarioId, H001N2_A55Tran_FechaRegistro,
            H001N2_A46Tran_Id
            }
            , new Object[] {
   ...
   private int edtTran_IdCuentadanteOrigen_Visible ;
   private int subGrid_Islastpage ;
   private int GXPagingFrom2 ;
   private int GXPagingTo2 ;
   private int idxLst ;
   private int subGrid_Backcolor ;
   private long wcpOAV7Tran_IdCuentadanteOrigen ;
   private long AV7Tran_IdCuentadanteOrigen ;
   ...
   private String sCtrlAV7Tran_IdCuentadanteOrigen ;
   ...
   private String[] H001N2_A416Tran_Observaciones ;
   private boolean[] H001N2_n416Tran_Observaciones ;
   private long[] H001N2_A51Tran_IdCuentadanteOrigen ;
   private boolean[] H001N2_n51Tran_IdCuentadanteOrigen ;
   private String[] H001N2_A859Tran_EntidadGobierno ;
   private boolean[] H001N2_n859Tran_EntidadGobierno ;
   private short[] H001N2_A758Tran_TablaResponsabilidad ;
   private boolean[] H001N2_n758Tran_TablaResponsabilidad ;
   private java.util.Date[] H001N2_A720Tran_FechaResponsabilidad ;
   private boolean[] H001N2_n720Tran_FechaResponsabilidad ;
   private long[] H001N2_A719Tran_TransaccResponsabilidad ;
   private boolean[] H001N2_n719Tran_TransaccResponsabilidad ;
   private String[] H001N2_A721Tran_NombreCuentadanteResponsa ;
   private boolean[] H001N2_n721Tran_NombreCuentadanteResponsa ;
   private long[] H001N2_A759Tran_CedulaResponsabilidad ;
   private boolean[] H001N2_n759Tran_CedulaResponsabilidad ;
   private long[] H001N2_A56Tran_IdCuentadanteResponsabili ;
   private boolean[] H001N2_n56Tran_IdCuentadanteResponsabili ;
   private String[] H001N2_A670Tran_ObservacionesAnula ;
   private boolean[] H001N2_n670Tran_ObservacionesAnula ;
   private java.util.Date[] H001N2_A669Tran_FechaEliminaoAnula ;
   private boolean[] H001N2_n669Tran_FechaEliminaoAnula ;
   private String[] H001N2_A668Tran_UsuarioEliminaoAnula ;
   private boolean[] H001N2_n668Tran_UsuarioEliminaoAnula ;
   private short[] H001N2_A667Tran_NumeroGrupo ;
   private boolean[] H001N2_n667Tran_NumeroGrupo ;
   private int[] H001N2_A568Tran_CantidadPadres ;
   private boolean[] H001N2_n568Tran_CantidadPadres ;
   private String[] H001N2_A527Tran_TipoEntra ;
   private boolean[] H001N2_n527Tran_TipoEntra ;
   private String[] H001N2_A524Tran_Detalle ;
   private boolean[] H001N2_n524Tran_Detalle ;
   private String[] H001N2_A608Tran_RegionAbrevDestino ;
   private boolean[] H001N2_n608Tran_RegionAbrevDestino ;
   private String[] H001N2_A520Tran_RegionDescripcionDestino ;
   private boolean[] H001N2_n520Tran_RegionDescripcionDestino ;
   private short[] H001N2_A519Tran_RegionCodigoDestino ;
   private boolean[] H001N2_n519Tran_RegionCodigoDestino ;
   private long[] H001N2_A518Tran_RegionIdDestino ;
   private boolean[] H001N2_n518Tran_RegionIdDestino ;
   private String[] H001N2_A517Tran_CentroCostoDescripcionDes ;
   private boolean[] H001N2_n517Tran_CentroCostoDescripcionDes ;
   private String[] H001N2_A516Tran_CentroCostoCodigoDestino ;
   private boolean[] H001N2_n516Tran_CentroCostoCodigoDestino ;
   private long[] H001N2_A50Tran_CentroCostoIdDestino ;
   private boolean[] H001N2_n50Tran_CentroCostoIdDestino ;
   private java.util.Date[] H001N2_A515Tran_FechaIngreso ;
   private boolean[] H001N2_n515Tran_FechaIngreso ;
   private String[] H001N2_A514Tran_NumeroIngreso ;
   private boolean[] H001N2_n514Tran_NumeroIngreso ;
   private String[] H001N2_A756Tran_Abreviado ;
   private boolean[] H001N2_n756Tran_Abreviado ;
   private String[] H001N2_A672Tran_NombreIngreso ;
   private boolean[] H001N2_n672Tran_NombreIngreso ;
   private long[] H001N2_A54Tran_TipoIngreso ;
   private boolean[] H001N2_n54Tran_TipoIngreso ;
   private long[] H001N2_A513Tran_ConsecutivoCC ;
   private boolean[] H001N2_n513Tran_ConsecutivoCC ;
   private String[] H001N2_A391Tran_UsuarioRatifica ;
   private boolean[] H001N2_n391Tran_UsuarioRatifica ;
   private java.util.Date[] H001N2_A390Tran_FechaRatificacion ;
   private boolean[] H001N2_n390Tran_FechaRatificacion ;
   private String[] H001N2_A58Tran_Estado ;
   private boolean[] H001N2_n58Tran_Estado ;
   private long[] H001N2_A498Tran_NumeroLineas ;
   private boolean[] H001N2_n498Tran_NumeroLineas ;
   private java.math.BigDecimal[] H001N2_A483Tran_ValorTransaccion ;
   private boolean[] H001N2_n483Tran_ValorTransaccion ;
   private String[] H001N2_A408Tran_CursoCodigo ;
   private boolean[] H001N2_n408Tran_CursoCodigo ;
   private String[] H001N2_A407Tran_AreadanteCodigo ;
   private boolean[] H001N2_n407Tran_AreadanteCodigo ;
   private String[] H001N2_A715Tran_EmailCuentadanteDestino ;
   private boolean[] H001N2_n715Tran_EmailCuentadanteDestino ;
   private long[] H001N2_A704Tran_CedulaCuentadanteDestino ;
   private boolean[] H001N2_n704Tran_CedulaCuentadanteDestino ;
   private String[] H001N2_A389Tran_NombCuentadanteDestino ;
   private boolean[] H001N2_n389Tran_NombCuentadanteDestino ;
   private long[] H001N2_A52Tran_IdCuentadanteDestino ;
   private boolean[] H001N2_n52Tran_IdCuentadanteDestino ;
   private String[] H001N2_A387Tran_CodBodeDestino ;
   private String[] H001N2_A111Tran_CodAlmaDestino ;
   private String[] H001N2_A385Tran_ModuloDestino ;
   private long[] H001N2_A703Tran_CedulaProveedor ;
   private boolean[] H001N2_n703Tran_CedulaProveedor ;
   private String[] H001N2_A575Tran_NombreProveedor ;
   private boolean[] H001N2_n575Tran_NombreProveedor ;
   private long[] H001N2_A53Tran_IdProveedor ;
   private boolean[] H001N2_n53Tran_IdProveedor ;
   private String[] H001N2_A112Tran_CodBodeOrigen ;
   private String[] H001N2_A109Tran_CodAlmaOrigen ;
   private String[] H001N2_A110Tran_ModuloOrigen ;
   private String[] H001N2_A754Tran_CuentaResponsabilidad ;
   private boolean[] H001N2_n754Tran_CuentaResponsabilidad ;
   private String[] H001N2_A708Tran_SolicitaRegionDestino ;
   private boolean[] H001N2_n708Tran_SolicitaRegionDestino ;
   private String[] H001N2_A707Tran_SolicitaCCDestino ;
   private boolean[] H001N2_n707Tran_SolicitaCCDestino ;
   private String[] H001N2_A482Tran_TipoElemento ;
   private long[] H001N2_A499Tran_CodTipoElemento ;
   private boolean[] H001N2_n499Tran_CodTipoElemento ;
   private String[] H001N2_A479Tran_IndCurso ;
   private boolean[] H001N2_n479Tran_IndCurso ;
   private String[] H001N2_A481Tran_IndE_S ;
   private boolean[] H001N2_n481Tran_IndE_S ;
   private String[] H001N2_A478Tran_IndAreadante ;
   private boolean[] H001N2_n478Tran_IndAreadante ;
   private String[] H001N2_A381Tran_DescripcionMovimiento ;
   private boolean[] H001N2_n381Tran_DescripcionMovimiento ;
   private String[] H001N2_A49Tran_CodigoMovimiento ;
   private String[] H001N2_A594Tran_RegionAbrev ;
   private boolean[] H001N2_n594Tran_RegionAbrev ;
   private String[] H001N2_A422Tran_RegionDescripcion ;
   private boolean[] H001N2_n422Tran_RegionDescripcion ;
   private short[] H001N2_A421Tran_RegionCodigo ;
   private boolean[] H001N2_n421Tran_RegionCodigo ;
   private long[] H001N2_A57Tran_RegionId ;
   private boolean[] H001N2_n57Tran_RegionId ;
   private String[] H001N2_A420Tran_CentroCostoDescripcion ;
   private boolean[] H001N2_n420Tran_CentroCostoDescripcion ;
   private String[] H001N2_A419Tran_CentroCostoCodigo ;
   private boolean[] H001N2_n419Tran_CentroCostoCodigo ;
   private long[] H001N2_A48Tran_CentroCostoId ;
   private String[] H001N2_A418Tran_UsuarioNombre ;
   private boolean[] H001N2_n418Tran_UsuarioNombre ;
   private String[] H001N2_A417Tran_UsuarioCodigo ;
   private boolean[] H001N2_n417Tran_UsuarioCodigo ;
   private long[] H001N2_A47Tran_UsuarioId ;
   private boolean[] H001N2_n47Tran_UsuarioId ;
   private java.util.Date[] H001N2_A55Tran_FechaRegistro ;
   private long[] H001N2_A46Tran_Id ;
...
final  class alm_cuentadante_multialm_transaccionwc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H001N2", "SELECT T1.Tran_Observaciones, T1.Tran_IdCuentadanteOrigen, T1.Tran_EntidadGobierno, T1.Tran_TablaResponsabilidad, T1.Tran_FechaResponsabilidad, T1.Tran_TransaccResponsabilidad, T2.Cuen_Nombre AS Tran_NombreCuentadanteResponsa, T2.Cuen_Cedula AS Tran_CedulaResponsabilidad, T1.Tran_IdCuentadanteResponsabili AS Tran_IdCuentadanteResponsabili, T1.Tran_ObservacionesAnula, T1.Tran_FechaEliminaoAnula, T1.Tran_UsuarioEliminaoAnula, T1.Tran_NumeroGrupo, T1.Tran_CantidadPadres, T1.Tran_TipoEntra, T1.Tran_Detalle, T3.Regi_Abrev AS Tran_RegionAbrevDestino, T3.Regi_Descripcion AS Tran_RegionDescripcionDestino, T3.Regi_Cod AS Tran_RegionCodigoDestino, T1.Tran_RegionIdDestino AS Tran_RegionIdDestino, T4.Cent_Descripcion AS Tran_CentroCostoDescripcionDes, T4.Cent_Codigo AS Tran_CentroCostoCodigoDestino, T1.Tran_CentroCostoIdDestino AS Tran_CentroCostoIdDestino, T1.Tran_FechaIngreso, T1.Tran_NumeroIngreso, T5.Orig_Descripcion_Abreviado AS Tran_Abreviado, T5.Orig_Descripcion AS Tran_NombreIngreso, T1.Tran_TipoIngreso AS Tran_TipoIngreso, T1.Tran_ConsecutivoCC, T1.Tran_UsuarioRatifica, T1.Tran_FechaRatificacion, T1.Tran_Estado, T1.Tran_NumeroLineas, T1.Tran_ValorTransaccion, T1.Tran_CursoCodigo, T1.Tran_AreadanteCodigo, T6.Cuen_Email AS Tran_EmailCuentadanteDestino, T6.Cuen_Cedula AS Tran_CedulaCuentadanteDestino, T6.Cuen_Nombre AS Tran_NombCuentadanteDestino, T1.Tran_IdCuentadanteDestino AS Tran_IdCuentadanteDestino, T1.Tran_CodBodeDestino, T1.Tran_CodAlmaDestino, T1.Tran_ModuloDestino, T7.Cuen_Cedula AS Tran_CedulaProveedor, T7.Cuen_Nombre AS Tran_NombreProveedor, T1.Tran_IdProveedor AS Tran_IdProveedor, T1.Tran_CodBodeOrigen, T1.Tran_CodAlmaOrigen, T1.Tran_ModuloOrigen, T8.Tpmo_CuentaResponsabilidad AS Tran_CuentaResponsabilidad, T8.Tpmo_SolicitaRegionDestino AS Tran_SolicitaRegionDestino, T8.Tpmo_SolicitaCentroDestino AS Tran_SolicitaCCDestino, T1.Tran_TipoElemento, T8.Tipo_Codigo AS Tran_CodTipoElemento, T8.Tpmo_IngresaCurso AS Tran_IndCurso, T1.Tran_IndE_S AS Tran_IndE_S, T8.Tpmo_IngresaAredante AS Tran_IndAreadante, T8.Tpmo_Descripcion AS Tran_DescripcionMovimiento, T1.Tran_CodigoMovimiento AS Tran_CodigoMovimiento, T9.Regi_Abrev AS Tran_RegionAbrev, T9.Regi_Descripcion AS Tran_RegionDescripcion, T9.Regi_Cod AS Tran_RegionCodigo, T1.Tran_RegionId AS Tran_RegionId, T10.Cent_Descripcion AS Tran_CentroCostoDescripcion, T10.Cent_Codigo AS Tran_CentroCostoCodigo, T1.Tran_CentroCostoId AS Tran_CentroCostoId, T11.Usua_Nombre AS Tran_UsuarioNombre, T11.Usua_Codigo AS Tran_UsuarioCodigo, T1.Tran_UsuarioId AS Tran_UsuarioId, T1.Tran_FechaRegistro, T1.Tran_Id FROM ((((((((((ALM_TRANSACCION T1 LEFT JOIN ALM_CUENTADANTE T2 ON T2.Cuen_Identificacion = T1.Tran_IdCuentadanteResponsabili) LEFT JOIN GEN_REGIONAL T3 ON T3.Regi_Id = T1.Tran_RegionIdDestino) LEFT JOIN GEN_CENTROCOSTO T4 ON T4.Cent_Id = T1.Tran_CentroCostoIdDestino) LEFT JOIN ALM_ORIGEN_BIENES T5 ON T5.Orig_Identificador = T1.Tran_TipoIngreso) LEFT JOIN ALM_CUENTADANTE T6 ON T6.Cuen_Identificacion = T1.Tran_IdCuentadanteDestino) LEFT JOIN ALM_CUENTADANTE T7 ON T7.Cuen_Identificacion = T1.Tran_IdProveedor) INNER JOIN ALM_TIPO_MOVIMIENTO T8 ON T8.Tpmo_Codigo = T1.Tran_CodigoMovimiento) LEFT JOIN GEN_REGIONAL T9 ON T9.Regi_Id = T1.Tran_RegionId) INNER JOIN GEN_CENTROCOSTO T10 ON T10.Cent_Id = T1.Tran_CentroCostoId) LEFT JOIN SEG_USUARIO T11 ON T11.Usua_Id = T1.Tran_UsuarioId) WHERE T1.Tran_IdCuentadanteOrigen = ? ORDER BY T1.Tran_IdCuentadanteOrigen  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H001N3", "SELECT COUNT(*) FROM ((((((((((ALM_TRANSACCION T1 LEFT JOIN ALM_CUENTADANTE T10 ON T10.Cuen_Identificacion = T1.Tran_IdCuentadanteResponsabili) LEFT JOIN GEN_REGIONAL T6 ON T6.Regi_Id = T1.Tran_RegionIdDestino) LEFT JOIN GEN_CENTROCOSTO T4 ON T4.Cent_Id = T1.Tran_CentroCostoIdDestino) LEFT JOIN ALM_ORIGEN_BIENES T11 ON T11.Orig_Identificador = T1.Tran_TipoIngreso) LEFT JOIN ALM_CUENTADANTE T9 ON T9.Cuen_Identificacion = T1.Tran_IdCuentadanteDestino) LEFT JOIN ALM_CUENTADANTE T8 ON T8.Cuen_Identificacion = T1.Tran_IdProveedor) INNER JOIN ALM_TIPO_MOVIMIENTO T7 ON T7.Tpmo_Codigo = T1.Tran_CodigoMovimiento) LEFT JOIN GEN_REGIONAL T5 ON T5.Regi_Id = T1.Tran_RegionId) INNER JOIN GEN_CENTROCOSTO T3 ON T3.Cent_Id = T1.Tran_CentroCostoId) LEFT JOIN SEG_USUARIO T2 ON T2.Usua_Id = T1.Tran_UsuarioId) WHERE T1.Tran_IdCuentadanteOrigen = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
                           ...
                           Object[] buf ) throws SQLException
   {
      switch ( cursor )
      {
            case 0 :
               ...
               ((java.util.Date[]) buf[46])[0] = rslt.getGXDate(24) ;
               ((boolean[]) buf[47])[0] = rslt.wasNull();
               ((String[]) buf[48])[0] = rslt.getString(25, 30) ;
               ...
               ((String[]) buf[62])[0] = rslt.getString(32, 1) ;
               ((boolean[]) buf[63])[0] = rslt.wasNull();
               ((long[]) buf[64])[0] = rslt.getLong(33) ;
               ((boolean[]) buf[65])[0] = rslt.wasNull();
               ((java.math.BigDecimal[]) buf[66])[0] = rslt.getBigDecimal(34,2) ;
               ...
               ((String[]) buf[91])[0] = rslt.getVarchar(49) ;
               ((String[]) buf[92])[0] = rslt.getVarchar(50) ;
               ...
               ((String[]) buf[98])[0] = rslt.getString(53, 1) ;
               ((long[]) buf[99])[0] = rslt.getLong(54) ;
