/*
               File: viewalm_cuentadante_impl
        Description: View ALM_CUENTADANTE
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:18:1.49
...
public final  class viewalm_cuentadante_impl extends GXDataArea
{
   public viewalm_cuentadante_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public viewalm_cuentadante_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( viewalm_cuentadante_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20186141418154");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.viewalm_cuentadante") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13Cuen_Identificacion,18,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV7TabCode))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      forbiddenHiddens = "hsh" + "ViewALM_CUENTADANTE" ;
      forbiddenHiddens = forbiddenHiddens + GXutil.rtrim( localUtil.format( A44Cuen_Nombre, "@!")) ;
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "hsh", GXutil.getEncryptedSignature( forbiddenHiddens, GXKey));
      GXutil.writeLogln("viewalm_cuentadante:[SendSecurityCheck]"+forbiddenHiddens);
   }
   ...
   {
      return formatLink("com.orions2.viewalm_cuentadante") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13Cuen_Identificacion,18,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV7TabCode)) ;
   }

   public String getPgmname( )
   {
      return "ViewALM_CUENTADANTE" ;
   }

   public String getPgmdesc( )
   {
      return "View ALM_CUENTADANTE" ;
   }
   ...
   public void wb1I0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, "Cuentadante Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_ViewALM_CUENTADANTE.htm");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblViewall_Internalname, "Lista Cuentadantes", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, (short)(0), "HLP_ViewALM_CUENTADANTE.htm");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewALM_CUENTADANTE.htm");
         /* Div Control */
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblMultiple_title_Internalname, "MULTIPLE", "", "", lblMultiple_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewALM_CUENTADANTE.htm");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblAlm_almacen_title_Internalname, "Responsable Almacen", "", "", lblAlm_almacen_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewALM_CUENTADANTE.htm");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         ...
         {
            /* WebComponent */
            com.orions2.GxWebStd.gx_hidden_field( httpContext, "W0045"+"", GXutil.rtrim( WebComp_Alm_almacenwc_Component));
            httpContext.writeText( "<div") ;
            com.orions2.GxWebStd.classAttribute( httpContext, "gxwebcomponent");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblAlm_inventario_devolutivo_title_Internalname, "Inventario devolutivo", "", "", lblAlm_inventario_devolutivo_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewALM_CUENTADANTE.htm");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         ...
         {
            /* WebComponent */
            com.orions2.GxWebStd.gx_hidden_field( httpContext, "W0053"+"", GXutil.rtrim( WebComp_Alm_inventario_devolutivowc_Component));
            httpContext.writeText( "<div") ;
            com.orions2.GxWebStd.classAttribute( httpContext, "gxwebcomponent");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblAlm_transaccion_title_Internalname, "Cuentadante Origen", "", "", lblAlm_transaccion_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewALM_CUENTADANTE.htm");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblAlm_transaccion1_title_Internalname, "Cuentadante Destino", "", "", lblAlm_transaccion1_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewALM_CUENTADANTE.htm");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblAlm_transaccion2_title_Internalname, "Proveedor", "", "", lblAlm_transaccion2_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewALM_CUENTADANTE.htm");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         ...
         {
            /* WebComponent */
            com.orions2.GxWebStd.gx_hidden_field( httpContext, "W0077"+"", GXutil.rtrim( WebComp_Alm_transaccion2wc_Component));
            httpContext.writeText( "<div") ;
            com.orions2.GxWebStd.classAttribute( httpContext, "gxwebcomponent");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblAlm_transaccion3_title_Internalname, "Cuentadante Responsabilidad", "", "", lblAlm_transaccion3_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewALM_CUENTADANTE.htm");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         ...
         {
            /* WebComponent */
            com.orions2.GxWebStd.gx_hidden_field( httpContext, "W0085"+"", GXutil.rtrim( WebComp_Alm_transaccion3wc_Component));
            httpContext.writeText( "<div") ;
            com.orions2.GxWebStd.classAttribute( httpContext, "gxwebcomponent");
   ...
   public void start1I2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "View ALM_CUENTADANTE", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
            ...
            if ( GXutil.len( sEvt) > 0 )
            {
               ...
               if ( GXutil.strcmp(sEvtType, "M") != 0 )
               {
                  ...
                  else if ( GXutil.strcmp(sEvtType, "W") == 0 )
                  {
                     ...
                     {
                        OldAlm_almacenwc = httpContext.cgiGet( "W0045") ;
                        ...
                        if ( GXutil.len( WebComp_Alm_almacenwc_Component) != 0 )
                        {
                           WebComp_Alm_almacenwc.componentprocess("W0045", "", sEvt);
                        }
                        WebComp_Alm_almacenwc_Component = OldAlm_almacenwc ;
                     }
                     else if ( nCmpId == 53 )
                     {
                        OldAlm_inventario_devolutivowc = httpContext.cgiGet( "W0053") ;
                        ...
                        if ( GXutil.len( WebComp_Alm_inventario_devolutivowc_Component) != 0 )
                        {
                           WebComp_Alm_inventario_devolutivowc.componentprocess("W0053", "", sEvt);
                        }
                        WebComp_Alm_inventario_devolutivowc_Component = OldAlm_inventario_devolutivowc ;
                     }
                     else if ( nCmpId == 61 )
                     ...
                     {
                        OldAlm_transaccion2wc = httpContext.cgiGet( "W0077") ;
                        ...
                        if ( GXutil.len( WebComp_Alm_transaccion2wc_Component) != 0 )
                        {
                           WebComp_Alm_transaccion2wc.componentprocess("W0077", "", sEvt);
                        }
                        WebComp_Alm_transaccion2wc_Component = OldAlm_transaccion2wc ;
                     }
                     else if ( nCmpId == 85 )
                     {
                        OldAlm_transaccion3wc = httpContext.cgiGet( "W0085") ;
                        ...
                        if ( GXutil.len( WebComp_Alm_transaccion3wc_Component) != 0 )
                        {
                           WebComp_Alm_transaccion3wc.componentprocess("W0085", "", sEvt);
                        }
                        WebComp_Alm_transaccion3wc_Component = OldAlm_transaccion3wc ;
                     }
                  }
   ...
   {
      /* GeneXus formulas. */
      AV16Pgmname = "ViewALM_CUENTADANTE" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf1I2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A43Cuen_Identificacion = H001I2_A43Cuen_Identificacion[0] ;
            A44Cuen_Nombre = H001I2_A44Cuen_Nombre[0] ;
            ...
            n44Cuen_Nombre = H001I2_n44Cuen_Nombre[0] ;
            /* Execute user event: Load */
            e121I2 ();
   ...
   public void strup1I0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         if ( ! GXutil.checkEncryptedSignature( forbiddenHiddens, hsh, GXKey) )
         {
            ...
            GXutil.writeLog("viewalm_cuentadante:[SecurityCheckFailed]"+forbiddenHiddens);
            return  ;
         }
      }
      else
   ...
   public void e111I2( )
   {
      ...
      {
         A43Cuen_Identificacion = H001I3_A43Cuen_Identificacion[0] ;
         A44Cuen_Nombre = H001I3_A44Cuen_Nombre[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A44Cuen_Nombre", A44Cuen_Nombre);
         httpContext.ajax_rsp_assign_attri("", false, "gxhash_CUEN_NOMBRE", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A44Cuen_Nombre, "@!"))));
         n44Cuen_Nombre = H001I3_n44Cuen_Nombre[0] ;
         AV17GXLvl6 = (byte)(1) ;
         Form.setCaption( A44Cuen_Nombre );
         httpContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.getCaption(), true);
         lblViewall_Link = formatLink("com.orions2.wwalm_cuentadante")  ;
   ...
   public void S112( )
   {
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "ALM_CUENTADANTEGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.orions2.alm_cuentadantegeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "ALM_CUENTADANTEGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Multiplewc_Component), GXutil.lower( "ALM_CUENTADANTEMULTIPLEWC")) != 0 )
         {
            WebComp_Multiplewc = WebUtils.getWebComponent(getClass(), "com.orions2.alm_cuentadantemultiplewc_impl", remoteHandle, context);
            WebComp_Multiplewc_Component = "ALM_CUENTADANTEMULTIPLEWC" ;
         }
         if ( GXutil.len( WebComp_Multiplewc_Component) != 0 )
         {
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Alm_almacenwc_Component), GXutil.lower( "ALM_CUENTADANTEALM_ALMACENWC")) != 0 )
         {
            WebComp_Alm_almacenwc = WebUtils.getWebComponent(getClass(), "com.orions2.alm_cuentadantealm_almacenwc_impl", remoteHandle, context);
            WebComp_Alm_almacenwc_Component = "ALM_CUENTADANTEALM_ALMACENWC" ;
         }
         if ( GXutil.len( WebComp_Alm_almacenwc_Component) != 0 )
         {
            WebComp_Alm_almacenwc.setjustcreated();
            WebComp_Alm_almacenwc.componentprepare(new Object[] {"W0045","",new Long(AV13Cuen_Identificacion)});
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Alm_inventario_devolutivowc_Component), GXutil.lower( "ALM_CUENTADANTEALM_INVENTARIO_DEVOLUTIVOWC")) != 0 )
         {
            WebComp_Alm_inventario_devolutivowc = WebUtils.getWebComponent(getClass(), "com.orions2.alm_cuentadantealm_inventario_devolutivowc_impl", remoteHandle, context);
            WebComp_Alm_inventario_devolutivowc_Component = "ALM_CUENTADANTEALM_INVENTARIO_DEVOLUTIVOWC" ;
         }
         if ( GXutil.len( WebComp_Alm_inventario_devolutivowc_Component) != 0 )
         {
            WebComp_Alm_inventario_devolutivowc.setjustcreated();
            WebComp_Alm_inventario_devolutivowc.componentprepare(new Object[] {"W0053","",new Long(AV13Cuen_Identificacion)});
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Alm_transaccionwc_Component), GXutil.lower( "ALM_CUENTADANTEALM_TRANSACCIONWC")) != 0 )
         {
            WebComp_Alm_transaccionwc = WebUtils.getWebComponent(getClass(), "com.orions2.alm_cuentadantealm_transaccionwc_impl", remoteHandle, context);
            WebComp_Alm_transaccionwc_Component = "ALM_CUENTADANTEALM_TRANSACCIONWC" ;
         }
         if ( GXutil.len( WebComp_Alm_transaccionwc_Component) != 0 )
         {
            WebComp_Alm_transaccionwc.setjustcreated();
            WebComp_Alm_transaccionwc.componentprepare(new Object[] {"W0061","",new Long(AV13Cuen_Identificacion)});
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Alm_transaccion1wc_Component), GXutil.lower( "ALM_CUENTADANTEALM_TRANSACCION1WC")) != 0 )
         {
            WebComp_Alm_transaccion1wc = WebUtils.getWebComponent(getClass(), "com.orions2.alm_cuentadantealm_transaccion1wc_impl", remoteHandle, context);
            WebComp_Alm_transaccion1wc_Component = "ALM_CUENTADANTEALM_TRANSACCION1WC" ;
         }
         if ( GXutil.len( WebComp_Alm_transaccion1wc_Component) != 0 )
         {
            WebComp_Alm_transaccion1wc.setjustcreated();
            WebComp_Alm_transaccion1wc.componentprepare(new Object[] {"W0069","",new Long(AV13Cuen_Identificacion)});
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Alm_transaccion2wc_Component), GXutil.lower( "ALM_CUENTADANTEALM_TRANSACCION2WC")) != 0 )
         {
            WebComp_Alm_transaccion2wc = WebUtils.getWebComponent(getClass(), "com.orions2.alm_cuentadantealm_transaccion2wc_impl", remoteHandle, context);
            WebComp_Alm_transaccion2wc_Component = "ALM_CUENTADANTEALM_TRANSACCION2WC" ;
         }
         if ( GXutil.len( WebComp_Alm_transaccion2wc_Component) != 0 )
         {
            WebComp_Alm_transaccion2wc.setjustcreated();
            WebComp_Alm_transaccion2wc.componentprepare(new Object[] {"W0077","",new Long(AV13Cuen_Identificacion)});
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Alm_transaccion3wc_Component), GXutil.lower( "ALM_CUENTADANTEALM_TRANSACCION3WC")) != 0 )
         {
            WebComp_Alm_transaccion3wc = WebUtils.getWebComponent(getClass(), "com.orions2.alm_cuentadantealm_transaccion3wc_impl", remoteHandle, context);
            WebComp_Alm_transaccion3wc_Component = "ALM_CUENTADANTEALM_TRANSACCION3WC" ;
         }
         if ( GXutil.len( WebComp_Alm_transaccion3wc_Component) != 0 )
         {
            WebComp_Alm_transaccion3wc.setjustcreated();
            WebComp_Alm_transaccion3wc.componentprepare(new Object[] {"W0085","",new Long(AV13Cuen_Identificacion)});
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20186141418234");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("viewalm_cuentadante.js", "?20186141418234");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "");
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "View ALM_CUENTADANTE" );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   public void initialize( )
   {
      ...
      AV16Pgmname = "" ;
      scmdbuf = "" ;
      H001I2_A43Cuen_Identificacion = new long[1] ;
      H001I2_A44Cuen_Nombre = new String[] {""} ;
      H001I2_n44Cuen_Nombre = new boolean[] {false} ;
      hsh = "" ;
      H001I3_A43Cuen_Identificacion = new long[1] ;
      H001I3_A44Cuen_Nombre = new String[] {""} ;
      H001I3_n44Cuen_Nombre = new boolean[] {false} ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.viewalm_cuentadante__default(),
         new Object[] {
             new Object[] {
            H001I2_A43Cuen_Identificacion, H001I2_A44Cuen_Nombre, H001I2_n44Cuen_Nombre
            }
            , new Object[] {
            H001I3_A43Cuen_Identificacion, H001I3_A44Cuen_Nombre, H001I3_n44Cuen_Nombre
            }
         }
      );
      AV16Pgmname = "ViewALM_CUENTADANTE" ;
   ...
   private long[] H001I2_A43Cuen_Identificacion ;
   private String[] H001I2_A44Cuen_Nombre ;
   private boolean[] H001I2_n44Cuen_Nombre ;
   private long[] H001I3_A43Cuen_Identificacion ;
   private String[] H001I3_A44Cuen_Nombre ;
   private boolean[] H001I3_n44Cuen_Nombre ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class viewalm_cuentadante__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H001I2", "SELECT Cuen_Identificacion, Cuen_Nombre FROM ALM_CUENTADANTE WHERE Cuen_Identificacion = ? ORDER BY Cuen_Identificacion ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H001I3", "SELECT Cuen_Identificacion, Cuen_Nombre FROM ALM_CUENTADANTE WHERE Cuen_Identificacion = ? ORDER BY Cuen_Identificacion ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
