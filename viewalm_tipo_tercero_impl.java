/*
               File: viewalm_tipo_tercero_impl
        Description: View ALM_TIPO_TERCERO
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:19:51.96
...
public final  class viewalm_tipo_tercero_impl extends GXDataArea
{
   public viewalm_tipo_tercero_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public viewalm_tipo_tercero_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( viewalm_tipo_tercero_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV13Tpte_Codigo = gxfirstwebparm ;
            httpContext.ajax_rsp_assign_attri("", false, "AV13Tpte_Codigo", AV13Tpte_Codigo);
            httpContext.ajax_rsp_assign_attri("", false, "gxhash_vTPTE_CODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13Tpte_Codigo, "@!"))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414195199");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.viewalm_tipo_tercero") + "?" + GXutil.URLEncode(GXutil.rtrim(AV13Tpte_Codigo)) + "," + GXutil.URLEncode(GXutil.rtrim(AV7TabCode))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vTPTE_CODIGO", GXutil.rtrim( AV13Tpte_Codigo));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_vTPTE_CODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13Tpte_Codigo, "@!"))));
      ...
      forbiddenHiddens = "hsh" + "ViewALM_TIPO_TERCERO" ;
      forbiddenHiddens = forbiddenHiddens + GXutil.rtrim( localUtil.format( A321Tpte_Descripcion, "@!")) ;
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "hsh", GXutil.getEncryptedSignature( forbiddenHiddens, GXKey));
      GXutil.writeLogln("viewalm_tipo_tercero:[SendSecurityCheck]"+forbiddenHiddens);
   }
   ...
   {
      return formatLink("com.orions2.viewalm_tipo_tercero") + "?" + GXutil.URLEncode(GXutil.rtrim(AV13Tpte_Codigo)) + "," + GXutil.URLEncode(GXutil.rtrim(AV7TabCode)) ;
   }

   public String getPgmname( )
   {
      return "ViewALM_TIPO_TERCERO" ;
   }

   public String getPgmdesc( )
   {
      return "View ALM_TIPO_TERCERO" ;
   }
   ...
   public void wb530( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, "Tipo de tercero Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_ViewALM_TIPO_TERCERO.htm");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblViewall_Internalname, "Work With Tipo de terceroes", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, (short)(0), "HLP_ViewALM_TIPO_TERCERO.htm");
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtTpte_Descripcion_Internalname, A321Tpte_Descripcion, GXutil.rtrim( localUtil.format( A321Tpte_Descripcion, "@!")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTpte_Descripcion_Jsonclick, 0, "ReadonlyAttribute", "", "", "", 1, edtTpte_Descripcion_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "Nombres", "left", true, "HLP_ViewALM_TIPO_TERCERO.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewALM_TIPO_TERCERO.htm");
         /* Div Control */
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblAlm_cuentadante_title_Internalname, "Cuentadante", "", "", lblAlm_cuentadante_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewALM_TIPO_TERCERO.htm");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         ...
         {
            /* WebComponent */
            com.orions2.GxWebStd.gx_hidden_field( httpContext, "W0037"+"", GXutil.rtrim( WebComp_Alm_cuentadantewc_Component));
            httpContext.writeText( "<div") ;
            com.orions2.GxWebStd.classAttribute( httpContext, "gxwebcomponent");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblAlm_cuentadante_multi_title_Internalname, "ALM_CUENTADANTE_MULTI", "", "", lblAlm_cuentadante_multi_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewALM_TIPO_TERCERO.htm");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         ...
         {
            /* WebComponent */
            com.orions2.GxWebStd.gx_hidden_field( httpContext, "W0045"+"", GXutil.rtrim( WebComp_Alm_cuentadante_multiwc_Component));
            httpContext.writeText( "<div") ;
            com.orions2.GxWebStd.classAttribute( httpContext, "gxwebcomponent");
   ...
   public void start532( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "View ALM_TIPO_TERCERO", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
            ...
            if ( GXutil.len( sEvt) > 0 )
            {
               ...
               if ( GXutil.strcmp(sEvtType, "M") != 0 )
               {
                  ...
                  else if ( GXutil.strcmp(sEvtType, "W") == 0 )
                  {
                     ...
                     {
                        OldAlm_cuentadantewc = httpContext.cgiGet( "W0037") ;
                        ...
                        if ( GXutil.len( WebComp_Alm_cuentadantewc_Component) != 0 )
                        {
                           WebComp_Alm_cuentadantewc.componentprocess("W0037", "", sEvt);
                        }
                        WebComp_Alm_cuentadantewc_Component = OldAlm_cuentadantewc ;
                     }
                     else if ( nCmpId == 45 )
                     {
                        OldAlm_cuentadante_multiwc = httpContext.cgiGet( "W0045") ;
                        ...
                        if ( GXutil.len( WebComp_Alm_cuentadante_multiwc_Component) != 0 )
                        {
                           WebComp_Alm_cuentadante_multiwc.componentprocess("W0045", "", sEvt);
                        }
                        WebComp_Alm_cuentadante_multiwc_Component = OldAlm_cuentadante_multiwc ;
                     }
                  }
   ...
   {
      /* GeneXus formulas. */
      AV16Pgmname = "ViewALM_TIPO_TERCERO" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf532( )
   {
      ...
      {
         /* Using cursor H00532 */
         pr_default.execute(0, new Object[] {AV13Tpte_Codigo});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A42Tpte_Codigo = H00532_A42Tpte_Codigo[0] ;
            A321Tpte_Descripcion = H00532_A321Tpte_Descripcion[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A321Tpte_Descripcion", A321Tpte_Descripcion);
            httpContext.ajax_rsp_assign_attri("", false, "gxhash_TPTE_DESCRIPCION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A321Tpte_Descripcion, "@!"))));
            /* Execute user event: Load */
            e12532 ();
   ...
   public void strup530( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         httpContext.ajax_rsp_assign_attri("", false, "gxhash_TPTE_DESCRIPCION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A321Tpte_Descripcion, "@!"))));
         /* Read saved values. */
         AV13Tpte_Codigo = httpContext.cgiGet( "vTPTE_CODIGO") ;
         ...
         GXKey = com.genexus.util.Encryption.decrypt64( httpContext.getCookie( "GX_SESSION_ID"), context.getServerKey( )) ;
         forbiddenHiddens = "hsh" + "ViewALM_TIPO_TERCERO" ;
         A321Tpte_Descripcion = httpContext.cgiGet( edtTpte_Descripcion_Internalname) ;
         httpContext.ajax_rsp_assign_attri("", false, "A321Tpte_Descripcion", A321Tpte_Descripcion);
         httpContext.ajax_rsp_assign_attri("", false, "gxhash_TPTE_DESCRIPCION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A321Tpte_Descripcion, "@!"))));
         forbiddenHiddens = forbiddenHiddens + GXutil.rtrim( localUtil.format( A321Tpte_Descripcion, "@!")) ;
         ...
         if ( ! GXutil.checkEncryptedSignature( forbiddenHiddens, hsh, GXKey) )
         {
            ...
            GXutil.writeLog("viewalm_tipo_tercero:[SecurityCheckFailed]"+forbiddenHiddens);
            return  ;
         }
      }
      else
   ...
   public void e11532( )
   {
      ...
      AV17GXLvl6 = (byte)(0) ;
      /* Using cursor H00533 */
      pr_default.execute(1, new Object[] {AV13Tpte_Codigo});
      while ( (pr_default.getStatus(1) != 101) )
      {
         A42Tpte_Codigo = H00533_A42Tpte_Codigo[0] ;
         A321Tpte_Descripcion = H00533_A321Tpte_Descripcion[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A321Tpte_Descripcion", A321Tpte_Descripcion);
         httpContext.ajax_rsp_assign_attri("", false, "gxhash_TPTE_DESCRIPCION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A321Tpte_Descripcion, "@!"))));
         AV17GXLvl6 = (byte)(1) ;
         Form.setCaption( A321Tpte_Descripcion );
         httpContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.getCaption(), true);
         lblViewall_Link = formatLink("com.orions2.wwalm_tipo_tercero")  ;
   ...
   public void S112( )
   {
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "ALM_TIPO_TERCEROGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.orions2.alm_tipo_tercerogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "ALM_TIPO_TERCEROGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0029","",AV13Tpte_Codigo});
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Alm_cuentadantewc_Component), GXutil.lower( "ALM_TIPO_TERCEROALM_CUENTADANTEWC")) != 0 )
         {
            WebComp_Alm_cuentadantewc = WebUtils.getWebComponent(getClass(), "com.orions2.alm_tipo_terceroalm_cuentadantewc_impl", remoteHandle, context);
            WebComp_Alm_cuentadantewc_Component = "ALM_TIPO_TERCEROALM_CUENTADANTEWC" ;
         }
         if ( GXutil.len( WebComp_Alm_cuentadantewc_Component) != 0 )
         {
            WebComp_Alm_cuentadantewc.setjustcreated();
            WebComp_Alm_cuentadantewc.componentprepare(new Object[] {"W0037","",AV13Tpte_Codigo});
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Alm_cuentadante_multiwc_Component), GXutil.lower( "ALM_TIPO_TERCEROALM_CUENTADANTE_MULTIWC")) != 0 )
         {
            WebComp_Alm_cuentadante_multiwc = WebUtils.getWebComponent(getClass(), "com.orions2.alm_tipo_terceroalm_cuentadante_multiwc_impl", remoteHandle, context);
            WebComp_Alm_cuentadante_multiwc_Component = "ALM_TIPO_TERCEROALM_CUENTADANTE_MULTIWC" ;
         }
         if ( GXutil.len( WebComp_Alm_cuentadante_multiwc_Component) != 0 )
         {
            WebComp_Alm_cuentadante_multiwc.setjustcreated();
            WebComp_Alm_cuentadante_multiwc.componentprepare(new Object[] {"W0045","",AV13Tpte_Codigo});
   ...
   {
      AV13Tpte_Codigo = (String)getParm(obj,0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV13Tpte_Codigo", AV13Tpte_Codigo);
      httpContext.ajax_rsp_assign_attri("", false, "gxhash_vTPTE_CODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13Tpte_Codigo, "@!"))));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414195236");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("viewalm_tipo_tercero.js", "?201861414195236");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "");
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "View ALM_TIPO_TERCERO" );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   public void initialize( )
   {
      ...
      AV16Pgmname = "" ;
      scmdbuf = "" ;
      H00532_A42Tpte_Codigo = new String[] {""} ;
      H00532_A321Tpte_Descripcion = new String[] {""} ;
      A42Tpte_Codigo = "" ;
      hsh = "" ;
      H00533_A42Tpte_Codigo = new String[] {""} ;
      H00533_A321Tpte_Descripcion = new String[] {""} ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.viewalm_tipo_tercero__default(),
         new Object[] {
             new Object[] {
            H00532_A42Tpte_Codigo, H00532_A321Tpte_Descripcion
            }
            , new Object[] {
            H00533_A42Tpte_Codigo, H00533_A321Tpte_Descripcion
            }
         }
      );
      AV16Pgmname = "ViewALM_TIPO_TERCERO" ;
   ...
   private String[] H00532_A42Tpte_Codigo ;
   private String[] H00532_A321Tpte_Descripcion ;
   private String[] H00533_A42Tpte_Codigo ;
   private String[] H00533_A321Tpte_Descripcion ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class viewalm_tipo_tercero__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00532", "SELECT Tpte_Codigo, Tpte_Descripcion FROM ALM_TIPO_TERCERO WHERE Tpte_Codigo = ? ORDER BY Tpte_Codigo ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H00533", "SELECT Tpte_Codigo, Tpte_Descripcion FROM ALM_TIPO_TERCERO WHERE Tpte_Codigo = ? ORDER BY Tpte_Codigo ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
