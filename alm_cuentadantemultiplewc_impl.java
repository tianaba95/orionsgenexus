/*
               File: alm_cuentadantemultiplewc_impl
        Description: ALM_CUENTADANTEMULTIPLEWC
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:10:48.62
...
public final  class alm_cuentadantemultiplewc_impl extends GXWebComponent
{
   public alm_cuentadantemultiplewc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public alm_cuentadantemultiplewc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( alm_cuentadantemultiplewc_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "ALM_CUENTADANTEMULTIPLEWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414104866");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.alm_cuentadantemultiplewc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Cuen_Identificacion,18,0)))+"\">") ;
   ...
   public void renderHtmlCloseForm1B2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("alm_cuentadantemultiplewc.js", "?201861414104866");
      }
   ...
   {
      return "ALM_CUENTADANTEMULTIPLEWC" ;
   }
   ...
   public void wb1B0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.alm_cuentadantemultiplewc");
         }
         /* Div Control */
   ...
   public void start1B2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "ALM_CUENTADANTEMULTIPLEWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV15Pgmname = "ALM_CUENTADANTEMULTIPLEWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf1B2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A43Cuen_Identificacion = H001B2_A43Cuen_Identificacion[0] ;
            ...
            A692Cuen_Multi_Estado = H001B2_A692Cuen_Multi_Estado[0] ;
            A691Cuen_Cedula_Multi = H001B2_A691Cuen_Cedula_Multi[0] ;
            n691Cuen_Cedula_Multi = H001B2_n691Cuen_Cedula_Multi[0] ;
            A690Cuen_Nombre_Multi = H001B2_A690Cuen_Nombre_Multi[0] ;
            n690Cuen_Nombre_Multi = H001B2_n690Cuen_Nombre_Multi[0] ;
            A45Cuen_Identificacion_Multi = H001B2_A45Cuen_Identificacion_Multi[0] ;
            A691Cuen_Cedula_Multi = H001B2_A691Cuen_Cedula_Multi[0] ;
            n691Cuen_Cedula_Multi = H001B2_n691Cuen_Cedula_Multi[0] ;
            A690Cuen_Nombre_Multi = H001B2_A690Cuen_Nombre_Multi[0] ;
            n690Cuen_Nombre_Multi = H001B2_n690Cuen_Nombre_Multi[0] ;
   ...
   public void S112( )
   {
      ...
      AV10TrnContext.setgxTv_SdtTransactionContext_Transactionname( "ALM_CUENTADANTE" );
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "alm_cuentadantemultiplewc");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414104894");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("alm_cuentadantemultiplewc.js", "?201861414104894");
      }
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e121B2',iparms:[],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV15Pgmname = "" ;
      scmdbuf = "" ;
      H001B2_A43Cuen_Identificacion = new long[1] ;
      H001B2_A692Cuen_Multi_Estado = new String[] {""} ;
      H001B2_A691Cuen_Cedula_Multi = new long[1] ;
      H001B2_n691Cuen_Cedula_Multi = new boolean[] {false} ;
      H001B2_A690Cuen_Nombre_Multi = new String[] {""} ;
      H001B2_n690Cuen_Nombre_Multi = new boolean[] {false} ;
      H001B2_A45Cuen_Identificacion_Multi = new long[1] ;
      ...
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.alm_cuentadantemultiplewc__default(),
         new Object[] {
             new Object[] {
            H001B2_A43Cuen_Identificacion, H001B2_A692Cuen_Multi_Estado, H001B2_A691Cuen_Cedula_Multi, H001B2_n691Cuen_Cedula_Multi, H001B2_A690Cuen_Nombre_Multi, H001B2_n690Cuen_Nombre_Multi, H001B2_A45Cuen_Identificacion_Multi
            }
            , new Object[] {
   ...
   private long[] H001B2_A43Cuen_Identificacion ;
   private String[] H001B2_A692Cuen_Multi_Estado ;
   private long[] H001B2_A691Cuen_Cedula_Multi ;
   private boolean[] H001B2_n691Cuen_Cedula_Multi ;
   private String[] H001B2_A690Cuen_Nombre_Multi ;
   private boolean[] H001B2_n690Cuen_Nombre_Multi ;
   private long[] H001B2_A45Cuen_Identificacion_Multi ;
...
final  class alm_cuentadantemultiplewc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H001B2", "SELECT T1.Cuen_Identificacion, T1.Cuen_Multi_Estado, T2.Cuen_Cedula AS Cuen_Cedula_Multi, T2.Cuen_Nombre AS Cuen_Nombre_Multi, T1.Cuen_Identificacion_Multi AS Cuen_Identificacion_Multi FROM (ALM_CUENTADANTEMULTIPLE T1 INNER JOIN ALM_CUENTADANTE T2 ON T2.Cuen_Identificacion = T1.Cuen_Identificacion_Multi) WHERE T1.Cuen_Identificacion = ? ORDER BY T1.Cuen_Identificacion  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H001B3", "SELECT COUNT(*) FROM (ALM_CUENTADANTEMULTIPLE T1 INNER JOIN ALM_CUENTADANTE T2 ON T2.Cuen_Identificacion = T1.Cuen_Identificacion_Multi) WHERE T1.Cuen_Identificacion = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
