/*
               File: alm_tipo_novedadroleswc_impl
...
public final  class alm_tipo_novedadroleswc_impl extends GXWebComponent
{
   public alm_tipo_novedadroleswc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public alm_tipo_novedadroleswc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( alm_tipo_novedadroleswc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7TNov_Codigo, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "ALM_TIPO_NOVEDADROLESWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414104330");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.alm_tipo_novedadroleswc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7TNov_Codigo,6,0)))+"\">") ;
   ...
   public void renderHtmlCloseForm3G2( )
   {
      sendCloseFormHiddens( ) ;
      if ( ( GXutil.len( sPrefix) != 0 ) && httpContext.isAjaxRequest( ) )
      {
         httpContext.AddJavascriptSource("alm_tipo_novedadroleswc.js", "?201861414104330");
      }
   ...
   public void wb3G0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.alm_tipo_novedadroleswc");
         }
         /* Div Control */
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", GXutil.ltrim( localUtil.ntoc( A105TNov_Rol_Id, (byte)(11), (byte)(0), ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", A779TNov_Rol_Descripcion);
            GridContainer.AddColumnProperties(GridColumn);
   ...
   public void start3G2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "ALM_TIPO_NOVEDADROLESWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TNOV_ROL_ID", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(A105TNov_Rol_Id), "ZZZZZZZZZZ9")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TNOV_ROL_ID", GXutil.ltrim( localUtil.ntoc( A105TNov_Rol_Id, (byte)(11), (byte)(0), ".", "")));
   }
   ...
   {
      /* GeneXus formulas. */
      AV15Pgmname = "ALM_TIPO_NOVEDADROLESWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf3G2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A104TNov_Codigo = H003G2_A104TNov_Codigo[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A104TNov_Codigo", GXutil.ltrim( GXutil.str( A104TNov_Codigo, 6, 0)));
            A779TNov_Rol_Descripcion = H003G2_A779TNov_Rol_Descripcion[0] ;
            n779TNov_Rol_Descripcion = H003G2_n779TNov_Rol_Descripcion[0] ;
            A105TNov_Rol_Id = H003G2_A105TNov_Rol_Id[0] ;
            A779TNov_Rol_Descripcion = H003G2_A779TNov_Rol_Descripcion[0] ;
            n779TNov_Rol_Descripcion = H003G2_n779TNov_Rol_Descripcion[0] ;
            e123G2 ();
   ...
   public void S112( )
   {
      ...
      AV10TrnContext.setgxTv_SdtTransactionContext_Transactionname( "ALM_TIPO_NOVEDAD" );
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "alm_tipo_novedadroleswc");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414104356");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("alm_tipo_novedadroleswc.js", "?201861414104356");
      }
   ...
   {
      edtTNov_Rol_Id_Internalname = sPrefix+"TNOV_ROL_ID_"+sGXsfl_12_idx ;
      edtTNov_Rol_Descripcion_Internalname = sPrefix+"TNOV_ROL_DESCRIPCION_"+sGXsfl_12_idx ;
   }

   public void subsflControlProps_fel_122( )
   {
      edtTNov_Rol_Id_Internalname = sPrefix+"TNOV_ROL_ID_"+sGXsfl_12_fel_idx ;
      edtTNov_Rol_Descripcion_Internalname = sPrefix+"TNOV_ROL_DESCRIPCION_"+sGXsfl_12_fel_idx ;
   }
   ...
   public void sendrow_122( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_12_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTNov_Rol_Id_Internalname,GXutil.ltrim( localUtil.ntoc( A105TNov_Rol_Id, (byte)(11), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A105TNov_Rol_Id), "ZZZZZZZZZZ9"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtTNov_Rol_Id_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(11),new Integer(0),new Integer(0),new Integer(12),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"Identificador","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTNov_Rol_Descripcion_Internalname,A779TNov_Rol_Descripcion,GXutil.rtrim( localUtil.format( A779TNov_Rol_Descripcion, "@!")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtTNov_Rol_Descripcion_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(12),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TNOV_ROL_ID"+"_"+sGXsfl_12_idx, getSecureSignedToken( sPrefix+sGXsfl_12_idx, localUtil.format( DecimalUtil.doubleToDec(A105TNov_Rol_Id), "ZZZZZZZZZZ9")));
   ...
   {
      edtTNov_Rol_Id_Internalname = sPrefix+"TNOV_ROL_ID" ;
      edtTNov_Rol_Descripcion_Internalname = sPrefix+"TNOV_ROL_DESCRIPCION" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7TNov_Codigo',fld:'vTNOV_CODIGO',pic:'ZZZZZ9',nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e123G2',iparms:[],oparms:[]}");
      setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7TNov_Codigo',fld:'vTNOV_CODIGO',pic:'ZZZZZ9',nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7TNov_Codigo',fld:'vTNOV_CODIGO',pic:'ZZZZZ9',nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7TNov_Codigo',fld:'vTNOV_CODIGO',pic:'ZZZZZ9',nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7TNov_Codigo',fld:'vTNOV_CODIGO',pic:'ZZZZZ9',nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
   }
   ...
   public void initialize( )
   {
      ...
      AV15Pgmname = "" ;
      scmdbuf = "" ;
      H003G2_A104TNov_Codigo = new int[1] ;
      H003G2_A779TNov_Rol_Descripcion = new String[] {""} ;
      H003G2_n779TNov_Rol_Descripcion = new boolean[] {false} ;
      H003G2_A105TNov_Rol_Id = new long[1] ;
      ...
      sCtrlAV7TNov_Codigo = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.alm_tipo_novedadroleswc__default(),
         new Object[] {
             new Object[] {
            H003G2_A104TNov_Codigo, H003G2_A779TNov_Rol_Descripcion, H003G2_n779TNov_Rol_Descripcion, H003G2_A105TNov_Rol_Id
            }
            , new Object[] {
   ...
   private int[] H003G2_A104TNov_Codigo ;
   private String[] H003G2_A779TNov_Rol_Descripcion ;
   private boolean[] H003G2_n779TNov_Rol_Descripcion ;
   private long[] H003G2_A105TNov_Rol_Id ;
...
final  class alm_tipo_novedadroleswc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H003G2", "SELECT T1.TNov_Codigo, T2.Rol_Descripcion AS TNov_Rol_Descripcion, T1.TNov_Rol_Id AS TNov_Rol_Id FROM (ALM_TIPO_NOVEDADROLES T1 INNER JOIN SEG_ROL T2 ON T2.Rol_Id = T1.TNov_Rol_Id) WHERE T1.TNov_Codigo = ? ORDER BY T1.TNov_Codigo  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H003G3", "SELECT COUNT(*) FROM (ALM_TIPO_NOVEDADROLES T1 INNER JOIN SEG_ROL T2 ON T2.Rol_Id = T1.TNov_Rol_Id) WHERE T1.TNov_Codigo = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
