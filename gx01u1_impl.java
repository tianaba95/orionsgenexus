...
public final  class gx01u1_impl extends GXDataArea
{
   ...
   public void wb9K0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblrpt_par_idfilter_Internalname, "Id Parámetro", "", "", lblLblrpt_par_idfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e119k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx01U1.htm");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblrpt_rep_parm_ordenfilter_Internalname, "Órden", "", "", lblLblrpt_rep_parm_ordenfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e129k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx01U1.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
         /* Attribute/Variable Label */
         com.orions2.GxWebStd.gx_label_element( httpContext, edtavCrpt_rep_parm_orden_Internalname, "Órden", "col-sm-3 AttributeLabel", 0, true);
         /* Single line edit */
   ...
   {
      /* Start Routine */
      Form.setCaption( GXutil.format( "Lista de Selección %1", "REPORTE PARAMETROS", "", "", "", "", "", "", "", "") );
