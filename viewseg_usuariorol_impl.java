...
public final  class viewseg_usuariorol_impl extends GXDataArea
{
   public viewseg_usuariorol_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public viewseg_usuariorol_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( viewseg_usuariorol_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414175385");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.viewseg_usuariorol") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13Usua_Id,18,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV7TabCode))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      forbiddenHiddens = "hsh" + "ViewSEG_USUARIOROL" ;
      forbiddenHiddens = forbiddenHiddens + GXutil.rtrim( localUtil.format( A25Usua_Nombre, "")) ;
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "hsh", GXutil.getEncryptedSignature( forbiddenHiddens, GXKey));
      GXutil.writeLogln("viewseg_usuariorol:[SendSecurityCheck]"+forbiddenHiddens);
   }
   ...
   {
      return formatLink("com.orions2.viewseg_usuariorol") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13Usua_Id,18,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV7TabCode)) ;
   }

   public String getPgmname( )
   {
      return "ViewSEG_USUARIOROL" ;
   }
   ...
   public void wb0V0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, "Usuario y Roles Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_ViewSEG_USUARIOROL.htm");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblViewall_Internalname, "Work With Usuario y Roles", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, (short)(0), "HLP_ViewSEG_USUARIOROL.htm");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewSEG_USUARIOROL.htm");
         /* Div Control */
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblSeg_usuario_rol_title_Internalname, "USUARIO Y ROLES", "", "", lblSeg_usuario_rol_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewSEG_USUARIOROL.htm");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblSeg_usuario_centro_title_Internalname, "SEG_USUARIO_CENTRO", "", "", lblSeg_usuario_centro_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewSEG_USUARIOROL.htm");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         ...
         {
            /* WebComponent */
            com.orions2.GxWebStd.gx_hidden_field( httpContext, "W0045"+"", GXutil.rtrim( WebComp_Seg_usuario_centrowc_Component));
            httpContext.writeText( "<div") ;
            com.orions2.GxWebStd.classAttribute( httpContext, "gxwebcomponent");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblAlm_transaccion_title_Internalname, "Usuario Transaccion", "", "", lblAlm_transaccion_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewSEG_USUARIOROL.htm");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
   ...
   public void start0V2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "View SEG_USUARIOROL", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
            ...
            if ( GXutil.len( sEvt) > 0 )
            {
               ...
               if ( GXutil.strcmp(sEvtType, "M") != 0 )
               {
                  ...
                  else if ( GXutil.strcmp(sEvtType, "W") == 0 )
                  {
                     ...
                     {
                        OldSeg_usuario_centrowc = httpContext.cgiGet( "W0045") ;
                        ...
                        if ( GXutil.len( WebComp_Seg_usuario_centrowc_Component) != 0 )
                        {
                           WebComp_Seg_usuario_centrowc.componentprocess("W0045", "", sEvt);
                        }
                        WebComp_Seg_usuario_centrowc_Component = OldSeg_usuario_centrowc ;
                     }
                     else if ( nCmpId == 53 )
   ...
   {
      /* GeneXus formulas. */
      AV16Pgmname = "ViewSEG_USUARIOROL" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf0V2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A23Usua_Id = H000V2_A23Usua_Id[0] ;
            A25Usua_Nombre = H000V2_A25Usua_Nombre[0] ;
   ...
   public void strup0V0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         if ( ! GXutil.checkEncryptedSignature( forbiddenHiddens, hsh, GXKey) )
         {
            ...
            GXutil.writeLog("viewseg_usuariorol:[SecurityCheckFailed]"+forbiddenHiddens);
            return  ;
         }
      }
      else
   ...
   public void e110V2( )
   {
      ...
      {
         A23Usua_Id = H000V3_A23Usua_Id[0] ;
         A25Usua_Nombre = H000V3_A25Usua_Nombre[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A25Usua_Nombre", A25Usua_Nombre);
         httpContext.ajax_rsp_assign_attri("", false, "gxhash_USUA_NOMBRE", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A25Usua_Nombre, ""))));
         AV17GXLvl6 = (byte)(1) ;
         Form.setCaption( A25Usua_Nombre );
         httpContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.getCaption(), true);
         lblViewall_Link = formatLink("com.orions2.wwseg_usuariorol")  ;
   ...
   public void S112( )
   {
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "SEG_USUARIOROLGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.orions2.seg_usuariorolgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "SEG_USUARIOROLGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Seg_usuario_rolwc_Component), GXutil.lower( "SEG_USUARIOROLSEG_USUARIO_ROLWC")) != 0 )
         {
            WebComp_Seg_usuario_rolwc = WebUtils.getWebComponent(getClass(), "com.orions2.seg_usuariorolseg_usuario_rolwc_impl", remoteHandle, context);
            WebComp_Seg_usuario_rolwc_Component = "SEG_USUARIOROLSEG_USUARIO_ROLWC" ;
         }
         if ( GXutil.len( WebComp_Seg_usuario_rolwc_Component) != 0 )
         {
            WebComp_Seg_usuario_rolwc.setjustcreated();
            WebComp_Seg_usuario_rolwc.componentprepare(new Object[] {"W0037","",new Long(AV13Usua_Id)});
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Seg_usuario_centrowc_Component), GXutil.lower( "SEG_USUARIOROLSEG_USUARIO_CENTROWC")) != 0 )
         {
            WebComp_Seg_usuario_centrowc = WebUtils.getWebComponent(getClass(), "com.orions2.seg_usuariorolseg_usuario_centrowc_impl", remoteHandle, context);
            WebComp_Seg_usuario_centrowc_Component = "SEG_USUARIOROLSEG_USUARIO_CENTROWC" ;
         }
         if ( GXutil.len( WebComp_Seg_usuario_centrowc_Component) != 0 )
         {
            WebComp_Seg_usuario_centrowc.setjustcreated();
            WebComp_Seg_usuario_centrowc.componentprepare(new Object[] {"W0045","",new Long(AV13Usua_Id)});
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Alm_transaccionwc_Component), GXutil.lower( "SEG_USUARIOROLALM_TRANSACCIONWC")) != 0 )
         {
            WebComp_Alm_transaccionwc = WebUtils.getWebComponent(getClass(), "com.orions2.seg_usuariorolalm_transaccionwc_impl", remoteHandle, context);
            WebComp_Alm_transaccionwc_Component = "SEG_USUARIOROLALM_TRANSACCIONWC" ;
         }
         if ( GXutil.len( WebComp_Alm_transaccionwc_Component) != 0 )
         {
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414175431");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("viewseg_usuariorol.js", "?201861414175431");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "");
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "View SEG_USUARIOROL" );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   public void initialize( )
   {
      ...
      AV16Pgmname = "" ;
      scmdbuf = "" ;
      H000V2_A23Usua_Id = new long[1] ;
      H000V2_A25Usua_Nombre = new String[] {""} ;
      hsh = "" ;
      H000V3_A23Usua_Id = new long[1] ;
      H000V3_A25Usua_Nombre = new String[] {""} ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.viewseg_usuariorol__default(),
         new Object[] {
             new Object[] {
            H000V2_A23Usua_Id, H000V2_A25Usua_Nombre
            }
            , new Object[] {
            H000V3_A23Usua_Id, H000V3_A25Usua_Nombre
            }
         }
      );
      AV16Pgmname = "ViewSEG_USUARIOROL" ;
   ...
   private long[] H000V2_A23Usua_Id ;
   private String[] H000V2_A25Usua_Nombre ;
   private long[] H000V3_A23Usua_Id ;
   private String[] H000V3_A25Usua_Nombre ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class viewseg_usuariorol__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H000V2", "SELECT Usua_Id, Usua_Nombre FROM SEG_USUARIO WHERE Usua_Id = ? ORDER BY Usua_Id ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H000V3", "SELECT Usua_Id, Usua_Nombre FROM SEG_USUARIO WHERE Usua_Id = ? ORDER BY Usua_Id ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
