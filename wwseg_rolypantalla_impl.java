...
public final  class wwseg_rolypantalla_impl extends GXDataArea
{
   public wwseg_rolypantalla_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wwseg_rolypantalla_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wwseg_rolypantalla_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            nRC_GXsfl_23 = (short)(GXutil.lval( httpContext.GetNextPar( ))) ;
            nGXsfl_23_idx = (short)(GXutil.lval( httpContext.GetNextPar( ))) ;
            sGXsfl_23_idx = httpContext.GetNextPar( ) ;
            AV15Update = httpContext.GetNextPar( ) ;
            edtavUpdate_Tooltiptext = httpContext.GetNextPar( ) ;
            httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Tooltiptext", edtavUpdate_Tooltiptext, !bGXsfl_23_Refreshing);
            AV16Delete = httpContext.GetNextPar( ) ;
            edtavDelete_Tooltiptext = httpContext.GetNextPar( ) ;
            httpContext.ajax_rsp_assign_prop("", false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext, !bGXsfl_23_Refreshing);
            httpContext.setAjaxCallMode();
            if ( ! httpContext.IsValidAjaxCall( true) )
            {
               GxWebError = (byte)(1) ;
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
         {
            ...
            gxgrgrid_refresh( subGrid_Rows, AV14Rol_Descripcion, AV15Update, AV16Delete, AV20Pgmname, A21Rol_Id) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414192270");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( nGXWrapped != 1 )
      {
         httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.wwseg_rolypantalla") +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      /* Send saved values. */
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "nRC_GXsfl_23", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_23, (byte)(4), (byte)(0), ",", "")));
   ...
   {
      return formatLink("com.orions2.wwseg_rolypantalla")  ;
   }

   public String getPgmname( )
   {
      return "WWSEG_ROLYPANTALLA" ;
   }
   ...
   public void wb380( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblTitletext_Internalname, "Asignar pantallas a un rol", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_WWSEG_ROLYPANTALLA.htm");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavRol_descripcion_Internalname, AV14Rol_Descripcion, GXutil.rtrim( localUtil.format( AV14Rol_Descripcion, "@!")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,14);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Descripción del rol", edtavRol_descripcion_Jsonclick, 0, "FilterSearchAttribute", "", "", "", 1, edtavRol_descripcion_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_WWSEG_ROLYPANTALLA.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start382( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Work With Rol y pantall", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
               ...
               if ( GXutil.strcmp(sEvtType, "M") != 0 )
               {
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 10), "'DOINSERT'") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           nGXsfl_23_idx = (short)(GXutil.lval( sEvtType)) ;
                           sGXsfl_23_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_23_idx, 4, 0)), (short)(4), "0") ;
                           ...
                           httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Bitmap", ((GXutil.strcmp("", AV15Update)==0) ? AV21Update_GXI : httpContext.convertURL( httpContext.getResourceRelative(AV15Update))), !bGXsfl_23_Refreshing);
                           ...
                           httpContext.ajax_rsp_assign_prop("", false, edtavDelete_Internalname, "Bitmap", ((GXutil.strcmp("", AV16Delete)==0) ? AV22Delete_GXI : httpContext.convertURL( httpContext.getResourceRelative(AV16Delete))), !bGXsfl_23_Refreshing);
   ...
   {
      /* GeneXus formulas. */
      AV20Pgmname = "WWSEG_ROLYPANTALLA" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf382( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A22Rol_Descripcion = H00382_A22Rol_Descripcion[0] ;
            A21Rol_Id = H00382_A21Rol_Id[0] ;
   ...
   public void strup380( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         /* Read saved values. */
         nRC_GXsfl_23 = (short)(localUtil.ctol( httpContext.cgiGet( "nRC_GXsfl_23"), ",", ".")) ;
   ...
   public void e11382( )
   {
      ...
      httpContext.ajax_rsp_assign_prop("", false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext, !bGXsfl_23_Refreshing);
      Form.setCaption( "Asignar pantallas a un rol" );
   ...
   public void S122( )
   {
      ...
      if ( GXutil.strcmp(AV8HTTPRequest.getMethod(), "GET") == 0 )
      {
         ...
         {
            AV14Rol_Descripcion = ((com.orions2.SdtGridState_FilterValue)AV9GridState.getgxTv_SdtGridState_Filtervalues().elementAt(-1+1)).getgxTv_SdtGridState_FilterValue_Value() ;
            httpContext.ajax_rsp_assign_attri("", false, "AV14Rol_Descripcion", AV14Rol_Descripcion);
         }
   ...
   public void S132( )
   {
      ...
      AV10GridStateFilterValue.setgxTv_SdtGridState_FilterValue_Value( AV14Rol_Descripcion );
   ...
   public void S112( )
   {
      ...
      AV12TrnContext.setgxTv_SdtTransactionContext_Transactionname( "SEG_ROLYPANTALLA" );
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20186141419236");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         ...
         httpContext.AddJavascriptSource("wwseg_rolypantalla.js", "?20186141419236");
      }
   ...
   {
      edtRol_Id_Internalname = "ROL_ID_"+sGXsfl_23_idx ;
      edtRol_Descripcion_Internalname = "ROL_DESCRIPCION_"+sGXsfl_23_idx ;
   ...
   {
      edtRol_Id_Internalname = "ROL_ID_"+sGXsfl_23_fel_idx ;
      edtRol_Descripcion_Internalname = "ROL_DESCRIPCION_"+sGXsfl_23_fel_idx ;
   ...
   public void sendrow_232( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_23_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRol_Id_Internalname,GXutil.ltrim( localUtil.ntoc( A21Rol_Id, (byte)(11), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A21Rol_Id), "ZZZZZZZZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtRol_Id_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(11),new Integer(0),new Integer(0),new Integer(23),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"Identificador","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRol_Descripcion_Internalname,A22Rol_Descripcion,GXutil.rtrim( localUtil.format( A22Rol_Descripcion, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtRol_Descripcion_Jsonclick,new Integer(0),"DescriptionAttribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(23),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_ROL_ID"+"_"+sGXsfl_23_idx, getSecureSignedToken( sGXsfl_23_idx, localUtil.format( DecimalUtil.doubleToDec(A21Rol_Id), "ZZZZZZZZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_ROL_DESCRIPCION"+"_"+sGXsfl_23_idx, getSecureSignedToken( sGXsfl_23_idx, GXutil.rtrim( localUtil.format( A22Rol_Descripcion, "@!"))));
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Work With Rol y pantall" );
      subGrid_Rows = 0 ;
      edtavDelete_Tooltiptext = "Eliminar" ;
      edtavUpdate_Tooltiptext = "Modificar" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV15Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV16Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A21Rol_Id',fld:'ROL_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'AV20Pgmname',fld:'vPGMNAME',pic:'',nv:''},{av:'AV14Rol_Descripcion',fld:'vROL_DESCRIPCION',pic:'@!',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e13382',iparms:[{av:'A21Rol_Id',fld:'ROL_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e14382',iparms:[{av:'A21Rol_Id',fld:'ROL_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV22Delete_GXI = "" ;
      scmdbuf = "" ;
      H00382_A22Rol_Descripcion = new String[] {""} ;
      H00382_A21Rol_Id = new long[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.wwseg_rolypantalla__default(),
         new Object[] {
             new Object[] {
            H00382_A22Rol_Descripcion, H00382_A21Rol_Id
            }
         }
      );
      AV20Pgmname = "WWSEG_ROLYPANTALLA" ;
   ...
   private String[] H00382_A22Rol_Descripcion ;
   private long[] H00382_A21Rol_Id ;
...
final  class wwseg_rolypantalla__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00382", "SELECT Rol_Descripcion, Rol_Id FROM SEG_ROL ORDER BY Rol_Descripcion ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
      };
   }
