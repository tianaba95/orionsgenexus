...
public final  class gen_ciudad_impl extends GXDataArea
{
   ...
   public void checkExtendedTable0E17( )
   {
      ...
      {
         httpContext.GX_msglist.addItem("Debe ingresar el código de la Ciudad", 1, "CIUD_CODIGO");
         AnyError = (short)(1) ;
         GX_FocusControl = edtCiud_Codigo_Internalname ;
         httpContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
      }
      ...
      {
         httpContext.GX_msglist.addItem("Debe ingresar la descripción de la Ciudad", 1, "CIUD_DESCRIPCION");
         AnyError = (short)(1) ;
