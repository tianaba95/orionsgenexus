/*
               File: alm_cat_tipalm_cat_segwc_impl
...
public final  class alm_cat_tipalm_cat_segwc_impl extends GXWebComponent
{
   public alm_cat_tipalm_cat_segwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public alm_cat_tipalm_cat_segwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( alm_cat_tipalm_cat_segwc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7TIP_Codigo", AV7TIP_Codigo);
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,AV7TIP_Codigo});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7TIP_Codigo, AV12Update, AV13Delete, A75SEG_Codigo, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "ALM_CAT_TIPALM_CAT_SEGWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20186141417173");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.alm_cat_tipalm_cat_segwc") + "?" + GXutil.URLEncode(GXutil.rtrim(AV7TIP_Codigo))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV7TIP_Codigo", wcpOAV7TIP_Codigo);
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vTIP_CODIGO", AV7TIP_Codigo);
   ...
   public void renderHtmlCloseForm5B2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("alm_cat_tipalm_cat_segwc.js", "?20186141417175");
      }
   ...
   public void wb5B0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.alm_cat_tipalm_cat_segwc");
         }
         /* Div Control */
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_ALM_CAT_TIPALM_CAT_SEGWC.htm");
      ...
      if ( wbEnd == 20 )
      {
         ...
         com.orions2.GxWebStd.gx_label_element( httpContext, edtTIP_Codigo_Internalname, "Tipo Codigo", "col-sm-3 AttributeLabel", 0, true);
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtTIP_Codigo_Internalname, A74TIP_Codigo, GXutil.rtrim( localUtil.format( A74TIP_Codigo, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTIP_Codigo_Jsonclick, 0, "Attribute", "", "", "", edtTIP_Codigo_Visible, edtTIP_Codigo_Enabled, 0, "text", "", 2, "chr", 1, "row", 2, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_ALM_CAT_TIPALM_CAT_SEGWC.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start5B2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "ALM_CAT_TIPALM_CAT_SEGWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"SEG_CODIGO", A75SEG_Codigo);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"SEG_USUARIOCREACION", A443SEG_UsuarioCreacion);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"SEG_FECHACREACION", localUtil.ttoc( A444SEG_FechaCreacion, 10, 8, 0, 3, "/", ":", " "));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"SEG_USUARIOMODIFICA", A445SEG_UsuarioModifica);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"SEG_FECHAMODIFICA", localUtil.ttoc( A446SEG_FechaModifica, 10, 8, 0, 3, "/", ":", " "));
   }
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "ALM_CAT_TIPALM_CAT_SEGWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf5B2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H005B2 */
         pr_default.execute(0, new Object[] {AV7TIP_Codigo, new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_20_idx = (short)(1) ;
         sGXsfl_20_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_20_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_202( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A74TIP_Codigo = H005B2_A74TIP_Codigo[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A74TIP_Codigo", A74TIP_Codigo);
            A446SEG_FechaModifica = H005B2_A446SEG_FechaModifica[0] ;
            A445SEG_UsuarioModifica = H005B2_A445SEG_UsuarioModifica[0] ;
            A444SEG_FechaCreacion = H005B2_A444SEG_FechaCreacion[0] ;
            A443SEG_UsuarioCreacion = H005B2_A443SEG_UsuarioCreacion[0] ;
            A442SEG_Descripcion = H005B2_A442SEG_Descripcion[0] ;
            A75SEG_Codigo = H005B2_A75SEG_Codigo[0] ;
            e135B2 ();
   ...
   {
      /* Using cursor H005B3 */
      pr_default.execute(1, new Object[] {AV7TIP_Codigo});
      GRID_nRecordCount = H005B3_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void strup5B0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV7TIP_Codigo = httpContext.cgiGet( sPrefix+"wcpOAV7TIP_Codigo") ;
   ...
   public void e125B2( )
   {
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext, !bGXsfl_20_Refreshing);
      edtTIP_Codigo_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtTIP_Codigo_Internalname, "Visible", GXutil.ltrim( GXutil.str( edtTIP_Codigo_Visible, 5, 0)), true);
   ...
   public void S112( )
   {
      ...
      AV10TrnContext.setgxTv_SdtTransactionContext_Transactionname( "ALM_CAT_SEG" );
      ...
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributename( "TIP_Codigo" );
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( AV7TIP_Codigo );
   ...
   {
      AV7TIP_Codigo = (String)getParm(obj,0,TypeConstants.STRING) ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7TIP_Codigo", AV7TIP_Codigo);
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV7TIP_Codigo = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "alm_cat_tipalm_cat_segwc");
      ...
      {
         AV7TIP_Codigo = (String)getParm(obj,2,TypeConstants.STRING) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7TIP_Codigo", AV7TIP_Codigo);
      }
      wcpOAV7TIP_Codigo = httpContext.cgiGet( sPrefix+"wcpOAV7TIP_Codigo") ;
      if ( ! GetJustCreated( ) && ( ( GXutil.strcmp(AV7TIP_Codigo, wcpOAV7TIP_Codigo) != 0 ) ) )
      {
         setjustcreated();
      }
      wcpOAV7TIP_Codigo = AV7TIP_Codigo ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV7TIP_Codigo = httpContext.cgiGet( sPrefix+"AV7TIP_Codigo_CTRL") ;
      if ( GXutil.len( sCtrlAV7TIP_Codigo) > 0 )
      {
         AV7TIP_Codigo = httpContext.cgiGet( sCtrlAV7TIP_Codigo) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7TIP_Codigo", AV7TIP_Codigo);
      }
      else
      {
         AV7TIP_Codigo = httpContext.cgiGet( sPrefix+"AV7TIP_Codigo_PARM") ;
      }
   }
   ...
   {
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7TIP_Codigo_PARM", AV7TIP_Codigo);
      if ( GXutil.len( GXutil.rtrim( sCtrlAV7TIP_Codigo)) > 0 )
      {
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7TIP_Codigo_CTRL", GXutil.rtrim( sCtrlAV7TIP_Codigo));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414171748");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("alm_cat_tipalm_cat_segwc.js", "?201861414171748");
      }
   ...
   public void subsflControlProps_202( )
   {
      ...
      edtSEG_UsuarioCreacion_Internalname = sPrefix+"SEG_USUARIOCREACION_"+sGXsfl_20_idx ;
      edtSEG_FechaCreacion_Internalname = sPrefix+"SEG_FECHACREACION_"+sGXsfl_20_idx ;
      edtSEG_UsuarioModifica_Internalname = sPrefix+"SEG_USUARIOMODIFICA_"+sGXsfl_20_idx ;
      edtSEG_FechaModifica_Internalname = sPrefix+"SEG_FECHAMODIFICA_"+sGXsfl_20_idx ;
   ...
   public void subsflControlProps_fel_202( )
   {
      ...
      edtSEG_UsuarioCreacion_Internalname = sPrefix+"SEG_USUARIOCREACION_"+sGXsfl_20_fel_idx ;
      edtSEG_FechaCreacion_Internalname = sPrefix+"SEG_FECHACREACION_"+sGXsfl_20_fel_idx ;
      edtSEG_UsuarioModifica_Internalname = sPrefix+"SEG_USUARIOMODIFICA_"+sGXsfl_20_fel_idx ;
      edtSEG_FechaModifica_Internalname = sPrefix+"SEG_FECHAMODIFICA_"+sGXsfl_20_fel_idx ;
   ...
   public void sendrow_202( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtSEG_Descripcion_Internalname,A442SEG_Descripcion,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'",edtSEG_Descripcion_Link,"","","",edtSEG_Descripcion_Jsonclick,new Integer(0),"DescriptionAttribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(100),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtSEG_UsuarioCreacion_Internalname,A443SEG_UsuarioCreacion,GXutil.rtrim( localUtil.format( A443SEG_UsuarioCreacion, "@!")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtSEG_UsuarioCreacion_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtSEG_FechaCreacion_Internalname,localUtil.ttoc( A444SEG_FechaCreacion, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A444SEG_FechaCreacion, "99/99/99 99:99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtSEG_FechaCreacion_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtSEG_UsuarioModifica_Internalname,A445SEG_UsuarioModifica,GXutil.rtrim( localUtil.format( A445SEG_UsuarioModifica, "@!")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtSEG_UsuarioModifica_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtSEG_FechaModifica_Internalname,localUtil.ttoc( A446SEG_FechaModifica, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A446SEG_FechaModifica, "99/99/99 99:99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtSEG_FechaModifica_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_SEG_CODIGO"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A75SEG_Codigo, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_SEG_USUARIOCREACION"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A443SEG_UsuarioCreacion, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_SEG_FECHACREACION"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, localUtil.format( A444SEG_FechaCreacion, "99/99/99 99:99")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_SEG_USUARIOMODIFICA"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A445SEG_UsuarioModifica, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_SEG_FECHAMODIFICA"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, localUtil.format( A446SEG_FechaModifica, "99/99/99 99:99")));
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7TIP_Codigo',fld:'vTIP_CODIGO',pic:'',nv:''},{av:'AV12Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV13Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A75SEG_Codigo',fld:'SEG_CODIGO',pic:'',hsh:true,nv:''},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e135B2',iparms:[{av:'A75SEG_Codigo',fld:'SEG_CODIGO',pic:'',hsh:true,nv:''}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtSEG_Descripcion_Link',ctrl:'SEG_DESCRIPCION',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e115B2',iparms:[{av:'A75SEG_Codigo',fld:'SEG_CODIGO',pic:'',hsh:true,nv:''}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H005B2_A74TIP_Codigo = new String[] {""} ;
      H005B2_A446SEG_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H005B2_A445SEG_UsuarioModifica = new String[] {""} ;
      H005B2_A444SEG_FechaCreacion = new java.util.Date[] {GXutil.nullDate()} ;
      H005B2_A443SEG_UsuarioCreacion = new String[] {""} ;
      H005B2_A442SEG_Descripcion = new String[] {""} ;
      H005B2_A75SEG_Codigo = new String[] {""} ;
      H005B3_AGRID_nRecordCount = new long[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.alm_cat_tipalm_cat_segwc__default(),
         new Object[] {
             new Object[] {
            H005B2_A74TIP_Codigo, H005B2_A446SEG_FechaModifica, H005B2_A445SEG_UsuarioModifica, H005B2_A444SEG_FechaCreacion, H005B2_A443SEG_UsuarioCreacion, H005B2_A442SEG_Descripcion, H005B2_A75SEG_Codigo
            }
            , new Object[] {
            H005B3_AGRID_nRecordCount
            }
         }
      );
      AV17Pgmname = "ALM_CAT_TIPALM_CAT_SEGWC" ;
   ...
   private int edtTIP_Codigo_Visible ;
   ...
   private String sCtrlAV7TIP_Codigo ;
   ...
   private String[] H005B2_A74TIP_Codigo ;
   private java.util.Date[] H005B2_A446SEG_FechaModifica ;
   private String[] H005B2_A445SEG_UsuarioModifica ;
   private java.util.Date[] H005B2_A444SEG_FechaCreacion ;
   private String[] H005B2_A443SEG_UsuarioCreacion ;
   private String[] H005B2_A442SEG_Descripcion ;
   private String[] H005B2_A75SEG_Codigo ;
   private long[] H005B3_AGRID_nRecordCount ;
...
final  class alm_cat_tipalm_cat_segwc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H005B2", "SELECT TIP_Codigo, SEG_FechaModifica, SEG_UsuarioModifica, SEG_FechaCreacion, SEG_UsuarioCreacion, SEG_Descripcion, SEG_Codigo FROM ALM_CAT_SEG WHERE TIP_Codigo = ? ORDER BY TIP_Codigo  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H005B3", "SELECT COUNT(*) FROM ALM_CAT_SEG WHERE TIP_Codigo = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
