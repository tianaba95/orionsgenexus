...
public final  class wwalm_origen_bienes_impl extends GXDataArea
{
   ...
   public void wb5W0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblTitletext_Internalname, "Orígen de los bienes ", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_WWALM_ORIGEN_BIENES.htm");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavOrig_descripcion_Internalname, AV14Orig_Descripcion, GXutil.rtrim( localUtil.format( AV14Orig_Descripcion, "@!")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Descripción", edtavOrig_descripcion_Jsonclick, 0, "FilterSearchAttribute", "", "", "", 1, edtavOrig_descripcion_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_WWALM_ORIGEN_BIENES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start5W2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Work With Orígen de los bienes y destinaciones de las bajas", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Work With Orígen de los bienes y destinaciones de las bajas" );
      subGrid_Rows = 0 ;
      edtavUpdate_Tooltiptext = "Modificar" ;
