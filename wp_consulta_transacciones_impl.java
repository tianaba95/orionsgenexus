/*
               File: wp_consulta_transacciones_impl
        Description: Consulta Transacciones
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:21:19.71
...
public final  class wp_consulta_transacciones_impl extends GXDataArea
{
   public wp_consulta_transacciones_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wp_consulta_transacciones_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wp_consulta_transacciones_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxNewRow_"+"Grid") == 0 )
         {
            ...
            httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Tooltiptext", edtavUpdate_Tooltiptext, !bGXsfl_168_Refreshing);
            AV41Reporte = httpContext.GetNextPar( ) ;
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
         {
            ...
            AV45Tran_RegionCodigo = (short)(GXutil.lval( httpContext.GetNextPar( ))) ;
            AV44Tran_RegionDescripcion = httpContext.GetNextPar( ) ;
            ...
            AV48Pgmname = httpContext.GetNextPar( ) ;
            ...
            gxgrgrid_refresh( subGrid_Rows, AV27Tran_ConsecutivoCC, AV26Tran_CodigoMovimiento, AV29Tran_DescripcionMovimiento, AV45Tran_RegionCodigo, AV44Tran_RegionDescripcion, AV25Tran_CentroCostoCodigo, AV30Tran_FechaRegistro, AV34Tran_Observaciones, AV33Tran_NombreIngreso, AV32Tran_IdProveedor, AV21Proveedor, AV31Tran_IdCuentadanteDestino, AV12Cuentadante, AV24Tran_AreadanteCodigo, AV28Tran_CursoCodigo, AV35Tran_TipoIngreso, AV38Update, AV41Reporte, AV8ADVANCED_LABEL_TEMPLATE, AV48Pgmname, A48Tran_CentroCostoId, A50Tran_CentroCostoIdDestino, A23Usua_Id, A1Cent_Id, AV39Usua_Id, AV5Tran_CentroCostoId) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414212026");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.wp_consulta_transacciones") +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "GXH_vTRAN_REGIONCODIGO", GXutil.ltrim( localUtil.ntoc( AV45Tran_RegionCodigo, (byte)(4), (byte)(0), ",", "")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "GXH_vTRAN_REGIONDESCRIPCION", AV44Tran_RegionDescripcion);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV48Pgmname));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vWINDOWSID", GXutil.ltrim( localUtil.ntoc( AV43WindowsId, (byte)(4), (byte)(0), ",", "")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vURL", AV42url);
   ...
   {
      return formatLink("com.orions2.wp_consulta_transacciones")  ;
   }

   public String getPgmname( )
   {
      return "WP_CONSULTA_TRANSACCIONES" ;
   }

   public String getPgmdesc( )
   {
      return "Consulta Transacciones" ;
   }
   ...
   public void wb6K0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 168, 3, 0)+","+"null"+");", bttBtntoggle_Caption, bttBtntoggle_Jsonclick, 7, "Otros Filtros", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e116k1_client"+"'", TempTags, "", 2, "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-6 col-sm-2", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblTitletext_Internalname, "Consulta de Transacciones", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavTran_consecutivocc_Internalname, GXutil.ltrim( localUtil.ntoc( AV27Tran_ConsecutivoCC, (byte)(18), (byte)(0), ",", "")), ((edtavTran_consecutivocc_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV27Tran_ConsecutivoCC), "ZZZZZZZZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV27Tran_ConsecutivoCC), "ZZZZZZZZZZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,14);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "No. Transación", edtavTran_consecutivocc_Jsonclick, 0, "FilterSearchAttribute", "", "", "", 1, edtavTran_consecutivocc_Enabled, 0, "text", "", 18, "chr", 1, "row", 18, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-4 col-sm-5 WWActionsCell", "Right", "top", "", "", "div");
         /* Div Control */
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_codigomovimientofilter_Internalname, lblLbltran_codigomovimientofilter_Caption, "", "", lblLbltran_codigomovimientofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e126k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_descripcionmovimientofilter_Internalname, lblLbltran_descripcionmovimientofilter_Caption, "", "", lblLbltran_descripcionmovimientofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e136k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavTran_descripcionmovimiento_Internalname, AV29Tran_DescripcionMovimiento, GXutil.rtrim( localUtil.format( AV29Tran_DescripcionMovimiento, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTran_descripcionmovimiento_Jsonclick, 0, "FilterComboAttribute", "", "", "", edtavTran_descripcionmovimiento_Visible, edtavTran_descripcionmovimiento_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_regioncodigofilter_Internalname, "Código Regional", "", "", lblLbltran_regioncodigofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e146k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavTran_regioncodigo_Internalname, GXutil.ltrim( localUtil.ntoc( AV45Tran_RegionCodigo, (byte)(4), (byte)(0), ",", "")), ((edtavTran_regioncodigo_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV45Tran_RegionCodigo), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV45Tran_RegionCodigo), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,49);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTran_regioncodigo_Jsonclick, 0, "FilterComboAttribute", "", "", "", edtavTran_regioncodigo_Visible, edtavTran_regioncodigo_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_regiondescripcionfilter_Internalname, "Nombre Regional", "", "", lblLbltran_regiondescripcionfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e156k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavTran_regiondescripcion_Internalname, AV44Tran_RegionDescripcion, GXutil.rtrim( localUtil.format( AV44Tran_RegionDescripcion, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,59);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTran_regiondescripcion_Jsonclick, 0, "FilterComboAttribute", "", "", "", edtavTran_regiondescripcion_Visible, edtavTran_regiondescripcion_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_centrocostocodigofilter_Internalname, "Código C.C.", "", "", lblLbltran_centrocostocodigofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e166k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_fecharegistrofilter_Internalname, lblLbltran_fecharegistrofilter_Caption, "", "", lblLbltran_fecharegistrofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e176k1_client"+"'", "", "WWAdvancedLabel WWDateFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_observacionesfilter_Internalname, lblLbltran_observacionesfilter_Caption, "", "", lblLbltran_observacionesfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e186k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 ViewAdvancedBarCell", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_tipoingresofilter_Internalname, lblLbltran_tipoingresofilter_Caption, "", "", lblLbltran_tipoingresofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e196k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavTran_nombreingreso_Internalname, AV33Tran_NombreIngreso, GXutil.rtrim( localUtil.format( AV33Tran_NombreIngreso, "@!")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,99);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTran_nombreingreso_Jsonclick, 0, "FilterComboAttribute", "", "", "", edtavTran_nombreingreso_Visible, edtavTran_nombreingreso_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_idproveedorfilter_Internalname, lblLbltran_idproveedorfilter_Caption, "", "", lblLbltran_idproveedorfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e206k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavTran_idproveedor_Internalname, GXutil.ltrim( localUtil.ntoc( AV32Tran_IdProveedor, (byte)(18), (byte)(0), ",", "")), ((edtavTran_idproveedor_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV32Tran_IdProveedor), "ZZZZZZZZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV32Tran_IdProveedor), "ZZZZZZZZZZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,109);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTran_idproveedor_Jsonclick, 0, "FilterComboAttribute", "", "", "", edtavTran_idproveedor_Visible, edtavTran_idproveedor_Enabled, 0, "text", "", 18, "chr", 1, "row", 18, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_nombreproveedorfilter_Internalname, lblLbltran_nombreproveedorfilter_Caption, "", "", lblLbltran_nombreproveedorfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e216k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavProveedor_Internalname, AV21Proveedor, GXutil.rtrim( localUtil.format( AV21Proveedor, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,119);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavProveedor_Jsonclick, 0, "FilterComboAttribute", "", "", "", edtavProveedor_Visible, edtavProveedor_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "Nombres", "left", true, "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_idcuentadantedestinofilter_Internalname, lblLbltran_idcuentadantedestinofilter_Caption, "", "", lblLbltran_idcuentadantedestinofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e226k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_nombrecuentadantefilter_Internalname, lblLbltran_nombrecuentadantefilter_Caption, "", "", lblLbltran_nombrecuentadantefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e236k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_areadantecodigofilter_Internalname, lblLbltran_areadantecodigofilter_Caption, "", "", lblLbltran_areadantecodigofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e246k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavTran_areadantecodigo_Internalname, AV24Tran_AreadanteCodigo, GXutil.rtrim( localUtil.format( AV24Tran_AreadanteCodigo, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,149);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTran_areadantecodigo_Jsonclick, 0, "FilterComboAttribute", "", "", "", edtavTran_areadantecodigo_Visible, edtavTran_areadantecodigo_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_cursocodigofilter_Internalname, lblLbltran_cursocodigofilter_Caption, "", "", lblLbltran_cursocodigofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e256k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            httpContext.writeText( "<th align=\""+""+"\" "+" width="+GXutil.ltrim( GXutil.str( 46, 4, 0))+"px"+" class=\""+"DisplayAttribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            ...
            httpContext.writeValue( "No. Transacción") ;
            httpContext.writeTextNL( "</th>") ;
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", httpContext.convertURL( AV41Reporte));
      ...
      if ( wbEnd == 168 )
      {
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblUrl_Internalname, lblUrl_Caption, "", "", lblUrl_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", lblUrl_Visible, 1, (short)(1), "HLP_WP_CONSULTA_TRANSACCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start6K2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Consulta Transacciones", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           AV41Reporte = httpContext.cgiGet( edtavReporte_Internalname) ;
                           httpContext.ajax_rsp_assign_prop("", false, edtavReporte_Internalname, "Bitmap", ((GXutil.strcmp("", AV41Reporte)==0) ? AV50Reporte_GXI : httpContext.convertURL( httpContext.getResourceRelative(AV41Reporte))), !bGXsfl_168_Refreshing);
                           httpContext.ajax_rsp_assign_prop("", false, edtavReporte_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( AV41Reporte), true);
                           AV38Update = httpContext.cgiGet( edtavUpdate_Internalname) ;
                           httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Bitmap", ((GXutil.strcmp("", AV38Update)==0) ? AV49Update_GXI : httpContext.convertURL( httpContext.getResourceRelative(AV38Update))), !bGXsfl_168_Refreshing);
                           ...
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 if ( ! wbErr )
                                 {
                                    ...
                                    if ( localUtil.ctol( httpContext.cgiGet( "GXH_vTRAN_REGIONCODIGO"), ",", ".") != AV45Tran_RegionCodigo )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    /* Set Refresh If Tran_regiondescripcion Changed */
                                    if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vTRAN_REGIONDESCRIPCION"), AV44Tran_RegionDescripcion) != 0 )
                                    {
                                       Rfr0gs = true ;
                                    }
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 ...
                                 short AV45Tran_RegionCodigo ,
                                 String AV44Tran_RegionDescripcion ,
   ...
   {
      /* GeneXus formulas. */
      AV48Pgmname = "WP_CONSULTA_TRANSACCIONES" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf6K2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              new Short(AV45Tran_RegionCodigo) ,
         ...
         /* Using cursor H006K2 */
         pr_default.execute(0, new Object[] {new Long(AV27Tran_ConsecutivoCC), lV26Tran_CodigoMovimiento, new Short(AV45Tran_RegionCodigo), new Long(AV35Tran_TipoIngreso), new Long(AV32Tran_IdProveedor), new Long(AV31Tran_IdCuentadanteDestino), AV24Tran_AreadanteCodigo, AV28Tran_CursoCodigo});
         nGXsfl_168_idx = (short)(1) ;
         sGXsfl_168_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_168_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_1682( ) ;
         GRID_nEOF = (byte)(0) ;
         ...
         {
            brk6K2 = false ;
            A416Tran_Observaciones = H006K2_A416Tran_Observaciones[0] ;
            n416Tran_Observaciones = H006K2_n416Tran_Observaciones[0] ;
            A513Tran_ConsecutivoCC = H006K2_A513Tran_ConsecutivoCC[0] ;
            n513Tran_ConsecutivoCC = H006K2_n513Tran_ConsecutivoCC[0] ;
            A49Tran_CodigoMovimiento = H006K2_A49Tran_CodigoMovimiento[0] ;
            A381Tran_DescripcionMovimiento = H006K2_A381Tran_DescripcionMovimiento[0] ;
            n381Tran_DescripcionMovimiento = H006K2_n381Tran_DescripcionMovimiento[0] ;
            A421Tran_RegionCodigo = H006K2_A421Tran_RegionCodigo[0] ;
            n421Tran_RegionCodigo = H006K2_n421Tran_RegionCodigo[0] ;
            A422Tran_RegionDescripcion = H006K2_A422Tran_RegionDescripcion[0] ;
            n422Tran_RegionDescripcion = H006K2_n422Tran_RegionDescripcion[0] ;
            A419Tran_CentroCostoCodigo = H006K2_A419Tran_CentroCostoCodigo[0] ;
            n419Tran_CentroCostoCodigo = H006K2_n419Tran_CentroCostoCodigo[0] ;
            A55Tran_FechaRegistro = H006K2_A55Tran_FechaRegistro[0] ;
            A54Tran_TipoIngreso = H006K2_A54Tran_TipoIngreso[0] ;
            n54Tran_TipoIngreso = H006K2_n54Tran_TipoIngreso[0] ;
            A53Tran_IdProveedor = H006K2_A53Tran_IdProveedor[0] ;
            n53Tran_IdProveedor = H006K2_n53Tran_IdProveedor[0] ;
            A52Tran_IdCuentadanteDestino = H006K2_A52Tran_IdCuentadanteDestino[0] ;
            n52Tran_IdCuentadanteDestino = H006K2_n52Tran_IdCuentadanteDestino[0] ;
            A407Tran_AreadanteCodigo = H006K2_A407Tran_AreadanteCodigo[0] ;
            n407Tran_AreadanteCodigo = H006K2_n407Tran_AreadanteCodigo[0] ;
            A408Tran_CursoCodigo = H006K2_A408Tran_CursoCodigo[0] ;
            n408Tran_CursoCodigo = H006K2_n408Tran_CursoCodigo[0] ;
            A575Tran_NombreProveedor = H006K2_A575Tran_NombreProveedor[0] ;
            n575Tran_NombreProveedor = H006K2_n575Tran_NombreProveedor[0] ;
            A389Tran_NombCuentadanteDestino = H006K2_A389Tran_NombCuentadanteDestino[0] ;
            n389Tran_NombCuentadanteDestino = H006K2_n389Tran_NombCuentadanteDestino[0] ;
            A672Tran_NombreIngreso = H006K2_A672Tran_NombreIngreso[0] ;
            n672Tran_NombreIngreso = H006K2_n672Tran_NombreIngreso[0] ;
            A58Tran_Estado = H006K2_A58Tran_Estado[0] ;
            n58Tran_Estado = H006K2_n58Tran_Estado[0] ;
            A48Tran_CentroCostoId = H006K2_A48Tran_CentroCostoId[0] ;
            A50Tran_CentroCostoIdDestino = H006K2_A50Tran_CentroCostoIdDestino[0] ;
            n50Tran_CentroCostoIdDestino = H006K2_n50Tran_CentroCostoIdDestino[0] ;
            A667Tran_NumeroGrupo = H006K2_A667Tran_NumeroGrupo[0] ;
            n667Tran_NumeroGrupo = H006K2_n667Tran_NumeroGrupo[0] ;
            A524Tran_Detalle = H006K2_A524Tran_Detalle[0] ;
            n524Tran_Detalle = H006K2_n524Tran_Detalle[0] ;
            A608Tran_RegionAbrevDestino = H006K2_A608Tran_RegionAbrevDestino[0] ;
            n608Tran_RegionAbrevDestino = H006K2_n608Tran_RegionAbrevDestino[0] ;
            A594Tran_RegionAbrev = H006K2_A594Tran_RegionAbrev[0] ;
            n594Tran_RegionAbrev = H006K2_n594Tran_RegionAbrev[0] ;
            A568Tran_CantidadPadres = H006K2_A568Tran_CantidadPadres[0] ;
            n568Tran_CantidadPadres = H006K2_n568Tran_CantidadPadres[0] ;
            A527Tran_TipoEntra = H006K2_A527Tran_TipoEntra[0] ;
            n527Tran_TipoEntra = H006K2_n527Tran_TipoEntra[0] ;
            A519Tran_RegionCodigoDestino = H006K2_A519Tran_RegionCodigoDestino[0] ;
            n519Tran_RegionCodigoDestino = H006K2_n519Tran_RegionCodigoDestino[0] ;
            A518Tran_RegionIdDestino = H006K2_A518Tran_RegionIdDestino[0] ;
            n518Tran_RegionIdDestino = H006K2_n518Tran_RegionIdDestino[0] ;
            A517Tran_CentroCostoDescripcionDes = H006K2_A517Tran_CentroCostoDescripcionDes[0] ;
            n517Tran_CentroCostoDescripcionDes = H006K2_n517Tran_CentroCostoDescripcionDes[0] ;
            A516Tran_CentroCostoCodigoDestino = H006K2_A516Tran_CentroCostoCodigoDestino[0] ;
            n516Tran_CentroCostoCodigoDestino = H006K2_n516Tran_CentroCostoCodigoDestino[0] ;
            A520Tran_RegionDescripcionDestino = H006K2_A520Tran_RegionDescripcionDestino[0] ;
            n520Tran_RegionDescripcionDestino = H006K2_n520Tran_RegionDescripcionDestino[0] ;
            A514Tran_NumeroIngreso = H006K2_A514Tran_NumeroIngreso[0] ;
            n514Tran_NumeroIngreso = H006K2_n514Tran_NumeroIngreso[0] ;
            A482Tran_TipoElemento = H006K2_A482Tran_TipoElemento[0] ;
            A499Tran_CodTipoElemento = H006K2_A499Tran_CodTipoElemento[0] ;
            n499Tran_CodTipoElemento = H006K2_n499Tran_CodTipoElemento[0] ;
            A483Tran_ValorTransaccion = H006K2_A483Tran_ValorTransaccion[0] ;
            n483Tran_ValorTransaccion = H006K2_n483Tran_ValorTransaccion[0] ;
            A481Tran_IndE_S = H006K2_A481Tran_IndE_S[0] ;
            n481Tran_IndE_S = H006K2_n481Tran_IndE_S[0] ;
            A57Tran_RegionId = H006K2_A57Tran_RegionId[0] ;
            n57Tran_RegionId = H006K2_n57Tran_RegionId[0] ;
            A420Tran_CentroCostoDescripcion = H006K2_A420Tran_CentroCostoDescripcion[0] ;
            n420Tran_CentroCostoDescripcion = H006K2_n420Tran_CentroCostoDescripcion[0] ;
            A418Tran_UsuarioNombre = H006K2_A418Tran_UsuarioNombre[0] ;
            n418Tran_UsuarioNombre = H006K2_n418Tran_UsuarioNombre[0] ;
            A417Tran_UsuarioCodigo = H006K2_A417Tran_UsuarioCodigo[0] ;
            n417Tran_UsuarioCodigo = H006K2_n417Tran_UsuarioCodigo[0] ;
            A47Tran_UsuarioId = H006K2_A47Tran_UsuarioId[0] ;
            n47Tran_UsuarioId = H006K2_n47Tran_UsuarioId[0] ;
            A391Tran_UsuarioRatifica = H006K2_A391Tran_UsuarioRatifica[0] ;
            n391Tran_UsuarioRatifica = H006K2_n391Tran_UsuarioRatifica[0] ;
            A390Tran_FechaRatificacion = H006K2_A390Tran_FechaRatificacion[0] ;
            n390Tran_FechaRatificacion = H006K2_n390Tran_FechaRatificacion[0] ;
            A46Tran_Id = H006K2_A46Tran_Id[0] ;
            A51Tran_IdCuentadanteOrigen = H006K2_A51Tran_IdCuentadanteOrigen[0] ;
            n51Tran_IdCuentadanteOrigen = H006K2_n51Tran_IdCuentadanteOrigen[0] ;
            A387Tran_CodBodeDestino = H006K2_A387Tran_CodBodeDestino[0] ;
            A111Tran_CodAlmaDestino = H006K2_A111Tran_CodAlmaDestino[0] ;
            A385Tran_ModuloDestino = H006K2_A385Tran_ModuloDestino[0] ;
            A112Tran_CodBodeOrigen = H006K2_A112Tran_CodBodeOrigen[0] ;
            A109Tran_CodAlmaOrigen = H006K2_A109Tran_CodAlmaOrigen[0] ;
            A110Tran_ModuloOrigen = H006K2_A110Tran_ModuloOrigen[0] ;
            A381Tran_DescripcionMovimiento = H006K2_A381Tran_DescripcionMovimiento[0] ;
            n381Tran_DescripcionMovimiento = H006K2_n381Tran_DescripcionMovimiento[0] ;
            A499Tran_CodTipoElemento = H006K2_A499Tran_CodTipoElemento[0] ;
            n499Tran_CodTipoElemento = H006K2_n499Tran_CodTipoElemento[0] ;
            ...
            {
               if ( (GXutil.strcmp("", AV44Tran_RegionDescripcion)==0) || ( GXutil.like( GXutil.upper( A422Tran_RegionDescripcion) , GXutil.padr( GXutil.concat( "%", GXutil.upper( AV44Tran_RegionDescripcion), "") , 254 , "%"),  ' ' ) ) )
               {
   ...
   public void strup6K0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         if ( ( ( localUtil.ctol( httpContext.cgiGet( edtavTran_regioncodigo_Internalname), ",", ".") < 0 ) ) || ( ( localUtil.ctol( httpContext.cgiGet( edtavTran_regioncodigo_Internalname), ",", ".") > 9999 ) ) )
         {
            ...
            httpContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
            wbErr = true ;
            AV45Tran_RegionCodigo = (short)(0) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV45Tran_RegionCodigo", GXutil.ltrim( GXutil.str( AV45Tran_RegionCodigo, 4, 0)));
         }
         else
         {
            AV45Tran_RegionCodigo = (short)(localUtil.ctol( httpContext.cgiGet( edtavTran_regioncodigo_Internalname), ",", ".")) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV45Tran_RegionCodigo", GXutil.ltrim( GXutil.str( AV45Tran_RegionCodigo, 4, 0)));
         }
         AV44Tran_RegionDescripcion = httpContext.cgiGet( edtavTran_regiondescripcion_Internalname) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV44Tran_RegionDescripcion", AV44Tran_RegionDescripcion);
         ...
         AV43WindowsId = (short)(localUtil.ctol( httpContext.cgiGet( "vWINDOWSID"), ",", ".")) ;
         AV42url = httpContext.cgiGet( "vURL") ;
   ...
   public void e266K2( )
   {
      ...
      if ( ! new com.orions2.isauthorized(remoteHandle, context).executeUdp( AV48Pgmname) )
      {
         callWebObject(formatLink("com.orions2.notauthorized") + "?" + GXutil.URLEncode(GXutil.rtrim(AV48Pgmname)));
      ...
      subGrid_Rows = 10 ;
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "GRID_Rows", GXutil.ltrim( localUtil.ntoc( subGrid_Rows, (byte)(6), (byte)(0), ".", "")));
      AV38Update = context.getHttpContext().getImagePath( "f11923b6-6acd-4a79-bfc0-0cfc6f3bced5", "", context.getHttpContext().getTheme( )) ;
      httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Bitmap", ((GXutil.strcmp("", AV38Update)==0) ? AV49Update_GXI : httpContext.convertURL( httpContext.getResourceRelative(AV38Update))), !bGXsfl_168_Refreshing);
      httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( AV38Update), true);
      AV49Update_GXI = GXDbFile.pathToUrl( context.getHttpContext().getImagePath( "f11923b6-6acd-4a79-bfc0-0cfc6f3bced5", "", context.getHttpContext().getTheme( )), context.getHttpContext()) ;
      httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Bitmap", ((GXutil.strcmp("", AV38Update)==0) ? AV49Update_GXI : httpContext.convertURL( httpContext.getResourceRelative(AV38Update))), !bGXsfl_168_Refreshing);
      httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( AV38Update), true);
      edtavUpdate_Tooltiptext = "Consultar" ;
      httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Tooltiptext", edtavUpdate_Tooltiptext, !bGXsfl_168_Refreshing);
      AV41Reporte = context.getHttpContext().getImagePath( "546fc62f-713c-44a9-b57b-fb633fb105bd", "", context.getHttpContext().getTheme( )) ;
      httpContext.ajax_rsp_assign_prop("", false, edtavReporte_Internalname, "Bitmap", ((GXutil.strcmp("", AV41Reporte)==0) ? AV50Reporte_GXI : httpContext.convertURL( httpContext.getResourceRelative(AV41Reporte))), !bGXsfl_168_Refreshing);
      httpContext.ajax_rsp_assign_prop("", false, edtavReporte_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( AV41Reporte), true);
      ...
      Form.setCaption( "Consulta Transacciones" );
   ...
   private void e286K2( )
   {
      ...
      GRID_nEOF = (byte)(0) ;
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "GRID_nEOF", GXutil.ltrim( localUtil.ntoc( GRID_nEOF, (byte)(1), (byte)(0), ".", "")));
      while ( ( (pr_default.getStatus(0) != 101) && GXutil.dateCompare(H006K2_A55Tran_FechaRegistro[0], A55Tran_FechaRegistro) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < GRID_nFirstRecordOnPage + subgrid_recordsperpage( ) ) ) ) )
      {
         brk6K2 = false ;
         A416Tran_Observaciones = H006K2_A416Tran_Observaciones[0] ;
         n416Tran_Observaciones = H006K2_n416Tran_Observaciones[0] ;
   ...
   public void S122( )
   {
      ...
      {
         AV15GridState.fromxml(AV22Session.getValue(AV48Pgmname+"GridState"), null, null);
   ...
   public void S132( )
   {
      ...
      AV15GridState.getgxTv_SdtGridState_Filtervalues().add(AV16GridStateFilterValue, 0);
      AV22Session.setValue(AV48Pgmname+"GridState", AV15GridState.toxml(false, true, "GridState", "ACBSENA"));
   }
   ...
   public void S112( )
   {
      ...
      AV36TrnContext.setgxTv_SdtTransactionContext_Callerobject( AV48Pgmname );
      ...
      AV36TrnContext.setgxTv_SdtTransactionContext_Transactionname( "Transacción" );
   ...
   public void S143( )
   {
      ...
      {
         A1Cent_Id = H006K3_A1Cent_Id[0] ;
         A23Usua_Id = H006K3_A23Usua_Id[0] ;
         AV7Acceso = "SI" ;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20186141421296");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("wp_consulta_transacciones.js", "?20186141421296");
      httpContext.AddJavascriptSource("Shared/jquery/jquery-1.9.0.js", "");
      httpContext.AddJavascriptSource("Alertify/js/alertify.min.js", "");
      httpContext.AddJavascriptSource("Alertify/GlobalAlerts.js", "");
      httpContext.AddJavascriptSource("Alertify/AlertifyRender.js", "");
   ...
   public void sendrow_1682( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_168_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         StyleString = "" ;
         AV41Reporte_IsBlob = (boolean)(((GXutil.strcmp("", AV41Reporte)==0)&&(GXutil.strcmp("", AV50Reporte_GXI)==0))||!(GXutil.strcmp("", AV41Reporte)==0)) ;
         sImgUrl = ((GXutil.strcmp("", AV41Reporte)==0) ? AV50Reporte_GXI : httpContext.getResourceRelative(AV41Reporte)) ;
         GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {edtavReporte_Internalname,sImgUrl,"","","",context.getHttpContext().getTheme( ),new Integer(-1),new Integer(1),"",edtavReporte_Tooltiptext,new Integer(1),new Integer(1),new Integer(0),"px",new Integer(0),"px",new Integer(0),new Integer(0),new Integer(7),edtavReporte_Jsonclick,"'"+""+"'"+",false,"+"'"+"e296k2_client"+"'",StyleString,ClassString,"WWActionColumn","","",""+TempTags,"","",new Integer(1),new Boolean(AV41Reporte_IsBlob),new Boolean(false),context.getHttpContext().getImageSrcSet( sImgUrl)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+""+"\""+" style=\""+""+"\">") ;
         ...
         ClassString = "DisplayAttribute" ;
         StyleString = "" ;
         AV38Update_IsBlob = (boolean)(((GXutil.strcmp("", AV38Update)==0)&&(GXutil.strcmp("", AV49Update_GXI)==0))||!(GXutil.strcmp("", AV38Update)==0)) ;
         sImgUrl = ((GXutil.strcmp("", AV38Update)==0) ? AV49Update_GXI : httpContext.getResourceRelative(AV38Update)) ;
         GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {edtavUpdate_Internalname,sImgUrl,"","","",context.getHttpContext().getTheme( ),new Integer(-1),new Integer(1),"",edtavUpdate_Tooltiptext,new Integer(1),new Integer(-1),new Integer(0),"px",new Integer(0),"px",new Integer(0),new Integer(0),new Integer(7),edtavUpdate_Jsonclick,"'"+""+"'"+",false,"+"'"+"e306k2_client"+"'",StyleString,ClassString,"WWActionColumn","","",""+TempTags,"","",new Integer(1),new Boolean(AV38Update_IsBlob),new Boolean(false),context.getHttpContext().getImageSrcSet( sImgUrl)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV45Tran_RegionCodigo',fld:'vTRAN_REGIONCODIGO',pic:'ZZZ9',nv:0},{av:'AV44Tran_RegionDescripcion',fld:'vTRAN_REGIONDESCRIPCION',pic:'',nv:''},{av:'AV25Tran_CentroCostoCodigo',fld:'vTRAN_CENTROCOSTOCODIGO',pic:'',nv:''},{av:'AV33Tran_NombreIngreso',fld:'vTRAN_NOMBREINGRESO',pic:'@!',nv:''},{av:'AV38Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV41Reporte',fld:'vREPORTE',pic:'',nv:''},{av:'edtavReporte_Tooltiptext',ctrl:'vREPORTE',prop:'Tooltiptext'},{av:'A48Tran_CentroCostoId',fld:'TRAN_CENTROCOSTOID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'A50Tran_CentroCostoIdDestino',fld:'TRAN_CENTROCOSTOIDDESTINO',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'A23Usua_Id',fld:'USUA_ID',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'A1Cent_Id',fld:'CENT_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV39Usua_Id',fld:'vUSUA_ID',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV5Tran_CentroCostoId',fld:'vTRAN_CENTROCOSTOID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV26Tran_CodigoMovimiento',fld:'vTRAN_CODIGOMOVIMIENTO',pic:'',nv:''},{av:'AV8ADVANCED_LABEL_TEMPLATE',fld:'vADVANCED_LABEL_TEMPLATE',pic:'',nv:''},{av:'AV29Tran_DescripcionMovimiento',fld:'vTRAN_DESCRIPCIONMOVIMIENTO',pic:'',nv:''},{av:'AV30Tran_FechaRegistro',fld:'vTRAN_FECHAREGISTRO',pic:'',nv:''},{av:'AV34Tran_Observaciones',fld:'vTRAN_OBSERVACIONES',pic:'',nv:''},{av:'AV35Tran_TipoIngreso',fld:'vTRAN_TIPOINGRESO',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV32Tran_IdProveedor',fld:'vTRAN_IDPROVEEDOR',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV21Proveedor',fld:'vPROVEEDOR',pic:'',nv:''},{av:'AV31Tran_IdCuentadanteDestino',fld:'vTRAN_IDCUENTADANTEDESTINO',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV12Cuentadante',fld:'vCUENTADANTE',pic:'',nv:''},{av:'AV24Tran_AreadanteCodigo',fld:'vTRAN_AREADANTECODIGO',pic:'',nv:''},{av:'AV28Tran_CursoCodigo',fld:'vTRAN_CURSOCODIGO',pic:'',nv:''},{av:'AV48Pgmname',fld:'vPGMNAME',pic:'',nv:''},{av:'AV27Tran_ConsecutivoCC',fld:'vTRAN_CONSECUTIVOCC',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0}],oparms:[{av:'lblLbltran_codigomovimientofilter_Caption',ctrl:'LBLTRAN_CODIGOMOVIMIENTOFILTER',prop:'Caption'},{av:'lblLbltran_descripcionmovimientofilter_Caption',ctrl:'LBLTRAN_DESCRIPCIONMOVIMIENTOFILTER',prop:'Caption'},{av:'lblLbltran_fecharegistrofilter_Caption',ctrl:'LBLTRAN_FECHAREGISTROFILTER',prop:'Caption'},{av:'lblLbltran_observacionesfilter_Caption',ctrl:'LBLTRAN_OBSERVACIONESFILTER',prop:'Caption'},{av:'lblLbltran_tipoingresofilter_Caption',ctrl:'LBLTRAN_TIPOINGRESOFILTER',prop:'Caption'},{av:'lblLbltran_idproveedorfilter_Caption',ctrl:'LBLTRAN_IDPROVEEDORFILTER',prop:'Caption'},{av:'lblLbltran_nombreproveedorfilter_Caption',ctrl:'LBLTRAN_NOMBREPROVEEDORFILTER',prop:'Caption'},{av:'lblLbltran_idcuentadantedestinofilter_Caption',ctrl:'LBLTRAN_IDCUENTADANTEDESTINOFILTER',prop:'Caption'},{av:'lblLbltran_nombrecuentadantefilter_Caption',ctrl:'LBLTRAN_NOMBRECUENTADANTEFILTER',prop:'Caption'},{av:'lblLbltran_areadantecodigofilter_Caption',ctrl:'LBLTRAN_AREADANTECODIGOFILTER',prop:'Caption'},{av:'lblLbltran_cursocodigofilter_Caption',ctrl:'LBLTRAN_CURSOCODIGOFILTER',prop:'Caption'}]}");
      setEventMetadata("'TOGGLE'","{handler:'e116K1',iparms:[{av:'divFilterscontainer_Class',ctrl:'FILTERSCONTAINER',prop:'Class'}],oparms:[{av:'divFilterscontainer_Class',ctrl:'FILTERSCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Caption'},{av:'divGridcell_Class',ctrl:'GRIDCELL',prop:'Class'}]}");
      setEventMetadata("LBLTRAN_CODIGOMOVIMIENTOFILTER.CLICK","{handler:'e126K1',iparms:[{av:'divTran_codigomovimientofiltercontainer_Class',ctrl:'TRAN_CODIGOMOVIMIENTOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_codigomovimientofiltercontainer_Class',ctrl:'TRAN_CODIGOMOVIMIENTOFILTERCONTAINER',prop:'Class'},{av:'edtavTran_codigomovimiento_Visible',ctrl:'vTRAN_CODIGOMOVIMIENTO',prop:'Visible'}]}");
      setEventMetadata("LBLTRAN_DESCRIPCIONMOVIMIENTOFILTER.CLICK","{handler:'e136K1',iparms:[{av:'divTran_descripcionmovimientofiltercontainer_Class',ctrl:'TRAN_DESCRIPCIONMOVIMIENTOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_descripcionmovimientofiltercontainer_Class',ctrl:'TRAN_DESCRIPCIONMOVIMIENTOFILTERCONTAINER',prop:'Class'},{av:'edtavTran_descripcionmovimiento_Visible',ctrl:'vTRAN_DESCRIPCIONMOVIMIENTO',prop:'Visible'}]}");
      setEventMetadata("LBLTRAN_REGIONCODIGOFILTER.CLICK","{handler:'e146K1',iparms:[{av:'divTran_regioncodigofiltercontainer_Class',ctrl:'TRAN_REGIONCODIGOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_regioncodigofiltercontainer_Class',ctrl:'TRAN_REGIONCODIGOFILTERCONTAINER',prop:'Class'},{av:'edtavTran_regioncodigo_Visible',ctrl:'vTRAN_REGIONCODIGO',prop:'Visible'}]}");
      setEventMetadata("LBLTRAN_REGIONDESCRIPCIONFILTER.CLICK","{handler:'e156K1',iparms:[{av:'divTran_regiondescripcionfiltercontainer_Class',ctrl:'TRAN_REGIONDESCRIPCIONFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_regiondescripcionfiltercontainer_Class',ctrl:'TRAN_REGIONDESCRIPCIONFILTERCONTAINER',prop:'Class'},{av:'edtavTran_regiondescripcion_Visible',ctrl:'vTRAN_REGIONDESCRIPCION',prop:'Visible'}]}");
      setEventMetadata("LBLTRAN_CENTROCOSTOCODIGOFILTER.CLICK","{handler:'e166K1',iparms:[{av:'divTran_centrocostocodigofiltercontainer_Class',ctrl:'TRAN_CENTROCOSTOCODIGOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_centrocostocodigofiltercontainer_Class',ctrl:'TRAN_CENTROCOSTOCODIGOFILTERCONTAINER',prop:'Class'},{av:'edtavTran_centrocostocodigo_Visible',ctrl:'vTRAN_CENTROCOSTOCODIGO',prop:'Visible'}]}");
      setEventMetadata("LBLTRAN_FECHAREGISTROFILTER.CLICK","{handler:'e176K1',iparms:[{av:'divTran_fecharegistrofiltercontainer_Class',ctrl:'TRAN_FECHAREGISTROFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_fecharegistrofiltercontainer_Class',ctrl:'TRAN_FECHAREGISTROFILTERCONTAINER',prop:'Class'}]}");
      setEventMetadata("LBLTRAN_OBSERVACIONESFILTER.CLICK","{handler:'e186K1',iparms:[{av:'divTran_observacionesfiltercontainer_Class',ctrl:'TRAN_OBSERVACIONESFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_observacionesfiltercontainer_Class',ctrl:'TRAN_OBSERVACIONESFILTERCONTAINER',prop:'Class'},{av:'edtavTran_observaciones_Visible',ctrl:'vTRAN_OBSERVACIONES',prop:'Visible'}]}");
      setEventMetadata("LBLTRAN_TIPOINGRESOFILTER.CLICK","{handler:'e196K1',iparms:[{av:'divTran_tipoingresofiltercontainer_Class',ctrl:'TRAN_TIPOINGRESOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_tipoingresofiltercontainer_Class',ctrl:'TRAN_TIPOINGRESOFILTERCONTAINER',prop:'Class'},{av:'edtavTran_nombreingreso_Visible',ctrl:'vTRAN_NOMBREINGRESO',prop:'Visible'}]}");
      setEventMetadata("LBLTRAN_IDPROVEEDORFILTER.CLICK","{handler:'e206K1',iparms:[{av:'divTran_idproveedorfiltercontainer_Class',ctrl:'TRAN_IDPROVEEDORFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_idproveedorfiltercontainer_Class',ctrl:'TRAN_IDPROVEEDORFILTERCONTAINER',prop:'Class'},{av:'edtavTran_idproveedor_Visible',ctrl:'vTRAN_IDPROVEEDOR',prop:'Visible'}]}");
      setEventMetadata("LBLTRAN_NOMBREPROVEEDORFILTER.CLICK","{handler:'e216K1',iparms:[{av:'divTran_nombreproveedorfiltercontainer_Class',ctrl:'TRAN_NOMBREPROVEEDORFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_nombreproveedorfiltercontainer_Class',ctrl:'TRAN_NOMBREPROVEEDORFILTERCONTAINER',prop:'Class'},{av:'edtavProveedor_Visible',ctrl:'vPROVEEDOR',prop:'Visible'}]}");
      setEventMetadata("LBLTRAN_IDCUENTADANTEDESTINOFILTER.CLICK","{handler:'e226K1',iparms:[{av:'divTran_idcuentadantedestinofiltercontainer_Class',ctrl:'TRAN_IDCUENTADANTEDESTINOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_idcuentadantedestinofiltercontainer_Class',ctrl:'TRAN_IDCUENTADANTEDESTINOFILTERCONTAINER',prop:'Class'},{av:'edtavTran_idcuentadantedestino_Visible',ctrl:'vTRAN_IDCUENTADANTEDESTINO',prop:'Visible'}]}");
      setEventMetadata("LBLTRAN_NOMBRECUENTADANTEFILTER.CLICK","{handler:'e236K1',iparms:[{av:'divTran_nombrecuentadantefiltercontainer_Class',ctrl:'TRAN_NOMBRECUENTADANTEFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_nombrecuentadantefiltercontainer_Class',ctrl:'TRAN_NOMBRECUENTADANTEFILTERCONTAINER',prop:'Class'},{av:'edtavCuentadante_Visible',ctrl:'vCUENTADANTE',prop:'Visible'}]}");
      setEventMetadata("LBLTRAN_AREADANTECODIGOFILTER.CLICK","{handler:'e246K1',iparms:[{av:'divTran_areadantecodigofiltercontainer_Class',ctrl:'TRAN_AREADANTECODIGOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_areadantecodigofiltercontainer_Class',ctrl:'TRAN_AREADANTECODIGOFILTERCONTAINER',prop:'Class'},{av:'edtavTran_areadantecodigo_Visible',ctrl:'vTRAN_AREADANTECODIGO',prop:'Visible'}]}");
      setEventMetadata("LBLTRAN_CURSOCODIGOFILTER.CLICK","{handler:'e256K1',iparms:[{av:'divTran_cursocodigofiltercontainer_Class',ctrl:'TRAN_CURSOCODIGOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_cursocodigofiltercontainer_Class',ctrl:'TRAN_CURSOCODIGOFILTERCONTAINER',prop:'Class'},{av:'edtavTran_cursocodigo_Visible',ctrl:'vTRAN_CURSOCODIGO',prop:'Visible'}]}");
      setEventMetadata("GRID.LOAD","{handler:'e286K2',iparms:[{av:'A48Tran_CentroCostoId',fld:'TRAN_CENTROCOSTOID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'A50Tran_CentroCostoIdDestino',fld:'TRAN_CENTROCOSTOIDDESTINO',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'A23Usua_Id',fld:'USUA_ID',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'A1Cent_Id',fld:'CENT_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV39Usua_Id',fld:'vUSUA_ID',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV5Tran_CentroCostoId',fld:'vTRAN_CENTROCOSTOID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV29Tran_DescripcionMovimiento',fld:'vTRAN_DESCRIPCIONMOVIMIENTO',pic:'',nv:''},{av:'AV44Tran_RegionDescripcion',fld:'vTRAN_REGIONDESCRIPCION',pic:'',nv:''},{av:'AV25Tran_CentroCostoCodigo',fld:'vTRAN_CENTROCOSTOCODIGO',pic:'',nv:''},{av:'AV30Tran_FechaRegistro',fld:'vTRAN_FECHAREGISTRO',pic:'',nv:''},{av:'AV34Tran_Observaciones',fld:'vTRAN_OBSERVACIONES',pic:'',nv:''},{av:'AV21Proveedor',fld:'vPROVEEDOR',pic:'',nv:''},{av:'AV12Cuentadante',fld:'vCUENTADANTE',pic:'',nv:''},{av:'AV33Tran_NombreIngreso',fld:'vTRAN_NOMBREINGRESO',pic:'@!',nv:''}],oparms:[{av:'AV5Tran_CentroCostoId',fld:'vTRAN_CENTROCOSTOID',pic:'ZZZZZZZZZZ9',nv:0}]}");
      setEventMetadata("'CONSULTAR'","{handler:'e306K2',iparms:[{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}]}");
      setEventMetadata("'REPORTE'","{handler:'e296K2',iparms:[{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'lblUrl_Caption',ctrl:'URL',prop:'Caption'}]}");
   ...
   public void initialize( )
   {
      ...
      H006K2_A416Tran_Observaciones = new String[] {""} ;
      H006K2_n416Tran_Observaciones = new boolean[] {false} ;
      H006K2_A513Tran_ConsecutivoCC = new long[1] ;
      H006K2_n513Tran_ConsecutivoCC = new boolean[] {false} ;
      H006K2_A49Tran_CodigoMovimiento = new String[] {""} ;
      H006K2_A381Tran_DescripcionMovimiento = new String[] {""} ;
      H006K2_n381Tran_DescripcionMovimiento = new boolean[] {false} ;
      H006K2_A421Tran_RegionCodigo = new short[1] ;
      H006K2_n421Tran_RegionCodigo = new boolean[] {false} ;
      H006K2_A422Tran_RegionDescripcion = new String[] {""} ;
      H006K2_n422Tran_RegionDescripcion = new boolean[] {false} ;
      H006K2_A419Tran_CentroCostoCodigo = new String[] {""} ;
      H006K2_n419Tran_CentroCostoCodigo = new boolean[] {false} ;
      H006K2_A55Tran_FechaRegistro = new java.util.Date[] {GXutil.nullDate()} ;
      H006K2_A54Tran_TipoIngreso = new long[1] ;
      H006K2_n54Tran_TipoIngreso = new boolean[] {false} ;
      H006K2_A53Tran_IdProveedor = new long[1] ;
      H006K2_n53Tran_IdProveedor = new boolean[] {false} ;
      H006K2_A52Tran_IdCuentadanteDestino = new long[1] ;
      H006K2_n52Tran_IdCuentadanteDestino = new boolean[] {false} ;
      H006K2_A407Tran_AreadanteCodigo = new String[] {""} ;
      H006K2_n407Tran_AreadanteCodigo = new boolean[] {false} ;
      H006K2_A408Tran_CursoCodigo = new String[] {""} ;
      H006K2_n408Tran_CursoCodigo = new boolean[] {false} ;
      H006K2_A575Tran_NombreProveedor = new String[] {""} ;
      H006K2_n575Tran_NombreProveedor = new boolean[] {false} ;
      H006K2_A389Tran_NombCuentadanteDestino = new String[] {""} ;
      H006K2_n389Tran_NombCuentadanteDestino = new boolean[] {false} ;
      H006K2_A672Tran_NombreIngreso = new String[] {""} ;
      H006K2_n672Tran_NombreIngreso = new boolean[] {false} ;
      H006K2_A58Tran_Estado = new String[] {""} ;
      H006K2_n58Tran_Estado = new boolean[] {false} ;
      H006K2_A48Tran_CentroCostoId = new long[1] ;
      H006K2_A50Tran_CentroCostoIdDestino = new long[1] ;
      H006K2_n50Tran_CentroCostoIdDestino = new boolean[] {false} ;
      H006K2_A667Tran_NumeroGrupo = new short[1] ;
      H006K2_n667Tran_NumeroGrupo = new boolean[] {false} ;
      H006K2_A524Tran_Detalle = new String[] {""} ;
      H006K2_n524Tran_Detalle = new boolean[] {false} ;
      H006K2_A608Tran_RegionAbrevDestino = new String[] {""} ;
      H006K2_n608Tran_RegionAbrevDestino = new boolean[] {false} ;
      H006K2_A594Tran_RegionAbrev = new String[] {""} ;
      H006K2_n594Tran_RegionAbrev = new boolean[] {false} ;
      H006K2_A568Tran_CantidadPadres = new int[1] ;
      H006K2_n568Tran_CantidadPadres = new boolean[] {false} ;
      H006K2_A527Tran_TipoEntra = new String[] {""} ;
      H006K2_n527Tran_TipoEntra = new boolean[] {false} ;
      H006K2_A519Tran_RegionCodigoDestino = new short[1] ;
      H006K2_n519Tran_RegionCodigoDestino = new boolean[] {false} ;
      H006K2_A518Tran_RegionIdDestino = new long[1] ;
      H006K2_n518Tran_RegionIdDestino = new boolean[] {false} ;
      H006K2_A517Tran_CentroCostoDescripcionDes = new String[] {""} ;
      H006K2_n517Tran_CentroCostoDescripcionDes = new boolean[] {false} ;
      H006K2_A516Tran_CentroCostoCodigoDestino = new String[] {""} ;
      H006K2_n516Tran_CentroCostoCodigoDestino = new boolean[] {false} ;
      H006K2_A520Tran_RegionDescripcionDestino = new String[] {""} ;
      H006K2_n520Tran_RegionDescripcionDestino = new boolean[] {false} ;
      H006K2_A514Tran_NumeroIngreso = new String[] {""} ;
      H006K2_n514Tran_NumeroIngreso = new boolean[] {false} ;
      H006K2_A482Tran_TipoElemento = new String[] {""} ;
      H006K2_A499Tran_CodTipoElemento = new long[1] ;
      H006K2_n499Tran_CodTipoElemento = new boolean[] {false} ;
      H006K2_A483Tran_ValorTransaccion = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H006K2_n483Tran_ValorTransaccion = new boolean[] {false} ;
      H006K2_A481Tran_IndE_S = new String[] {""} ;
      H006K2_n481Tran_IndE_S = new boolean[] {false} ;
      H006K2_A57Tran_RegionId = new long[1] ;
      H006K2_n57Tran_RegionId = new boolean[] {false} ;
      H006K2_A420Tran_CentroCostoDescripcion = new String[] {""} ;
      H006K2_n420Tran_CentroCostoDescripcion = new boolean[] {false} ;
      H006K2_A418Tran_UsuarioNombre = new String[] {""} ;
      H006K2_n418Tran_UsuarioNombre = new boolean[] {false} ;
      H006K2_A417Tran_UsuarioCodigo = new String[] {""} ;
      H006K2_n417Tran_UsuarioCodigo = new boolean[] {false} ;
      H006K2_A47Tran_UsuarioId = new long[1] ;
      H006K2_n47Tran_UsuarioId = new boolean[] {false} ;
      H006K2_A391Tran_UsuarioRatifica = new String[] {""} ;
      H006K2_n391Tran_UsuarioRatifica = new boolean[] {false} ;
      H006K2_A390Tran_FechaRatificacion = new java.util.Date[] {GXutil.nullDate()} ;
      H006K2_n390Tran_FechaRatificacion = new boolean[] {false} ;
      H006K2_A46Tran_Id = new long[1] ;
      H006K2_A51Tran_IdCuentadanteOrigen = new long[1] ;
      H006K2_n51Tran_IdCuentadanteOrigen = new boolean[] {false} ;
      H006K2_A387Tran_CodBodeDestino = new String[] {""} ;
      H006K2_A111Tran_CodAlmaDestino = new String[] {""} ;
      H006K2_A385Tran_ModuloDestino = new String[] {""} ;
      H006K2_A112Tran_CodBodeOrigen = new String[] {""} ;
      H006K2_A109Tran_CodAlmaOrigen = new String[] {""} ;
      H006K2_A110Tran_ModuloOrigen = new String[] {""} ;
      AV40Usuario = "" ;
      ...
      H006K3_A1Cent_Id = new long[1] ;
      H006K3_A23Usua_Id = new long[1] ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      sImgUrl = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.wp_consulta_transacciones__default(),
         new Object[] {
             new Object[] {
            H006K2_A416Tran_Observaciones, H006K2_n416Tran_Observaciones, H006K2_A513Tran_ConsecutivoCC, H006K2_n513Tran_ConsecutivoCC, H006K2_A49Tran_CodigoMovimiento, H006K2_A381Tran_DescripcionMovimiento, H006K2_n381Tran_DescripcionMovimiento, H006K2_A421Tran_RegionCodigo, H006K2_n421Tran_RegionCodigo, H006K2_A422Tran_RegionDescripcion,
            H006K2_n422Tran_RegionDescripcion, H006K2_A419Tran_CentroCostoCodigo, H006K2_n419Tran_CentroCostoCodigo, H006K2_A55Tran_FechaRegistro, H006K2_A54Tran_TipoIngreso, H006K2_n54Tran_TipoIngreso, H006K2_A53Tran_IdProveedor, H006K2_n53Tran_IdProveedor, H006K2_A52Tran_IdCuentadanteDestino, H006K2_n52Tran_IdCuentadanteDestino,
            H006K2_A407Tran_AreadanteCodigo, H006K2_n407Tran_AreadanteCodigo, H006K2_A408Tran_CursoCodigo, H006K2_n408Tran_CursoCodigo, H006K2_A575Tran_NombreProveedor, H006K2_n575Tran_NombreProveedor, H006K2_A389Tran_NombCuentadanteDestino, H006K2_n389Tran_NombCuentadanteDestino, H006K2_A672Tran_NombreIngreso, H006K2_n672Tran_NombreIngreso,
            H006K2_A58Tran_Estado, H006K2_n58Tran_Estado, H006K2_A48Tran_CentroCostoId, H006K2_A50Tran_CentroCostoIdDestino, H006K2_n50Tran_CentroCostoIdDestino, H006K2_A667Tran_NumeroGrupo, H006K2_n667Tran_NumeroGrupo, H006K2_A524Tran_Detalle, H006K2_n524Tran_Detalle, H006K2_A608Tran_RegionAbrevDestino,
            H006K2_n608Tran_RegionAbrevDestino, H006K2_A594Tran_RegionAbrev, H006K2_n594Tran_RegionAbrev, H006K2_A568Tran_CantidadPadres, H006K2_n568Tran_CantidadPadres, H006K2_A527Tran_TipoEntra, H006K2_n527Tran_TipoEntra, H006K2_A519Tran_RegionCodigoDestino, H006K2_n519Tran_RegionCodigoDestino, H006K2_A518Tran_RegionIdDestino,
            H006K2_n518Tran_RegionIdDestino, H006K2_A517Tran_CentroCostoDescripcionDes, H006K2_n517Tran_CentroCostoDescripcionDes, H006K2_A516Tran_CentroCostoCodigoDestino, H006K2_n516Tran_CentroCostoCodigoDestino, H006K2_A520Tran_RegionDescripcionDestino, H006K2_n520Tran_RegionDescripcionDestino, H006K2_A514Tran_NumeroIngreso, H006K2_n514Tran_NumeroIngreso, H006K2_A482Tran_TipoElemento,
            H006K2_A499Tran_CodTipoElemento, H006K2_n499Tran_CodTipoElemento, H006K2_A483Tran_ValorTransaccion, H006K2_n483Tran_ValorTransaccion, H006K2_A481Tran_IndE_S, H006K2_n481Tran_IndE_S, H006K2_A57Tran_RegionId, H006K2_n57Tran_RegionId, H006K2_A420Tran_CentroCostoDescripcion, H006K2_n420Tran_CentroCostoDescripcion,
            H006K2_A418Tran_UsuarioNombre, H006K2_n418Tran_UsuarioNombre, H006K2_A417Tran_UsuarioCodigo, H006K2_n417Tran_UsuarioCodigo, H006K2_A47Tran_UsuarioId, H006K2_n47Tran_UsuarioId, H006K2_A391Tran_UsuarioRatifica, H006K2_n391Tran_UsuarioRatifica, H006K2_A390Tran_FechaRatificacion, H006K2_n390Tran_FechaRatificacion,
            H006K2_A46Tran_Id, H006K2_A51Tran_IdCuentadanteOrigen, H006K2_n51Tran_IdCuentadanteOrigen, H006K2_A387Tran_CodBodeDestino, H006K2_A111Tran_CodAlmaDestino, H006K2_A385Tran_ModuloDestino, H006K2_A112Tran_CodBodeOrigen, H006K2_A109Tran_CodAlmaOrigen, H006K2_A110Tran_ModuloOrigen
            }
            , new Object[] {
            H006K3_A1Cent_Id, H006K3_A23Usua_Id
            }
         }
      );
      AV48Pgmname = "WP_CONSULTA_TRANSACCIONES" ;
   ...
   private short AV45Tran_RegionCodigo ;
   private short AV43WindowsId ;
   private short wbEnd ;
   ...
   private boolean AV41Reporte_IsBlob ;
   ...
   private String AV44Tran_RegionDescripcion ;
   ...
   private String[] H006K2_A416Tran_Observaciones ;
   private boolean[] H006K2_n416Tran_Observaciones ;
   private long[] H006K2_A513Tran_ConsecutivoCC ;
   private boolean[] H006K2_n513Tran_ConsecutivoCC ;
   private String[] H006K2_A49Tran_CodigoMovimiento ;
   private String[] H006K2_A381Tran_DescripcionMovimiento ;
   private boolean[] H006K2_n381Tran_DescripcionMovimiento ;
   private short[] H006K2_A421Tran_RegionCodigo ;
   private boolean[] H006K2_n421Tran_RegionCodigo ;
   private String[] H006K2_A422Tran_RegionDescripcion ;
   private boolean[] H006K2_n422Tran_RegionDescripcion ;
   private String[] H006K2_A419Tran_CentroCostoCodigo ;
   private boolean[] H006K2_n419Tran_CentroCostoCodigo ;
   private java.util.Date[] H006K2_A55Tran_FechaRegistro ;
   private long[] H006K2_A54Tran_TipoIngreso ;
   private boolean[] H006K2_n54Tran_TipoIngreso ;
   private long[] H006K2_A53Tran_IdProveedor ;
   private boolean[] H006K2_n53Tran_IdProveedor ;
   private long[] H006K2_A52Tran_IdCuentadanteDestino ;
   private boolean[] H006K2_n52Tran_IdCuentadanteDestino ;
   private String[] H006K2_A407Tran_AreadanteCodigo ;
   private boolean[] H006K2_n407Tran_AreadanteCodigo ;
   private String[] H006K2_A408Tran_CursoCodigo ;
   private boolean[] H006K2_n408Tran_CursoCodigo ;
   private String[] H006K2_A575Tran_NombreProveedor ;
   private boolean[] H006K2_n575Tran_NombreProveedor ;
   private String[] H006K2_A389Tran_NombCuentadanteDestino ;
   private boolean[] H006K2_n389Tran_NombCuentadanteDestino ;
   private String[] H006K2_A672Tran_NombreIngreso ;
   private boolean[] H006K2_n672Tran_NombreIngreso ;
   private String[] H006K2_A58Tran_Estado ;
   private boolean[] H006K2_n58Tran_Estado ;
   private long[] H006K2_A48Tran_CentroCostoId ;
   private long[] H006K2_A50Tran_CentroCostoIdDestino ;
   private boolean[] H006K2_n50Tran_CentroCostoIdDestino ;
   private short[] H006K2_A667Tran_NumeroGrupo ;
   private boolean[] H006K2_n667Tran_NumeroGrupo ;
   private String[] H006K2_A524Tran_Detalle ;
   private boolean[] H006K2_n524Tran_Detalle ;
   private String[] H006K2_A608Tran_RegionAbrevDestino ;
   private boolean[] H006K2_n608Tran_RegionAbrevDestino ;
   private String[] H006K2_A594Tran_RegionAbrev ;
   private boolean[] H006K2_n594Tran_RegionAbrev ;
   private int[] H006K2_A568Tran_CantidadPadres ;
   private boolean[] H006K2_n568Tran_CantidadPadres ;
   private String[] H006K2_A527Tran_TipoEntra ;
   private boolean[] H006K2_n527Tran_TipoEntra ;
   private short[] H006K2_A519Tran_RegionCodigoDestino ;
   private boolean[] H006K2_n519Tran_RegionCodigoDestino ;
   private long[] H006K2_A518Tran_RegionIdDestino ;
   private boolean[] H006K2_n518Tran_RegionIdDestino ;
   private String[] H006K2_A517Tran_CentroCostoDescripcionDes ;
   private boolean[] H006K2_n517Tran_CentroCostoDescripcionDes ;
   private String[] H006K2_A516Tran_CentroCostoCodigoDestino ;
   private boolean[] H006K2_n516Tran_CentroCostoCodigoDestino ;
   private String[] H006K2_A520Tran_RegionDescripcionDestino ;
   private boolean[] H006K2_n520Tran_RegionDescripcionDestino ;
   private String[] H006K2_A514Tran_NumeroIngreso ;
   private boolean[] H006K2_n514Tran_NumeroIngreso ;
   private String[] H006K2_A482Tran_TipoElemento ;
   private long[] H006K2_A499Tran_CodTipoElemento ;
   private boolean[] H006K2_n499Tran_CodTipoElemento ;
   private java.math.BigDecimal[] H006K2_A483Tran_ValorTransaccion ;
   private boolean[] H006K2_n483Tran_ValorTransaccion ;
   private String[] H006K2_A481Tran_IndE_S ;
   private boolean[] H006K2_n481Tran_IndE_S ;
   private long[] H006K2_A57Tran_RegionId ;
   private boolean[] H006K2_n57Tran_RegionId ;
   private String[] H006K2_A420Tran_CentroCostoDescripcion ;
   private boolean[] H006K2_n420Tran_CentroCostoDescripcion ;
   private String[] H006K2_A418Tran_UsuarioNombre ;
   private boolean[] H006K2_n418Tran_UsuarioNombre ;
   private String[] H006K2_A417Tran_UsuarioCodigo ;
   private boolean[] H006K2_n417Tran_UsuarioCodigo ;
   private long[] H006K2_A47Tran_UsuarioId ;
   private boolean[] H006K2_n47Tran_UsuarioId ;
   private String[] H006K2_A391Tran_UsuarioRatifica ;
   private boolean[] H006K2_n391Tran_UsuarioRatifica ;
   private java.util.Date[] H006K2_A390Tran_FechaRatificacion ;
   private boolean[] H006K2_n390Tran_FechaRatificacion ;
   private long[] H006K2_A46Tran_Id ;
   private long[] H006K2_A51Tran_IdCuentadanteOrigen ;
   private boolean[] H006K2_n51Tran_IdCuentadanteOrigen ;
   private String[] H006K2_A387Tran_CodBodeDestino ;
   private String[] H006K2_A111Tran_CodAlmaDestino ;
   private String[] H006K2_A385Tran_ModuloDestino ;
   private String[] H006K2_A112Tran_CodBodeOrigen ;
   private String[] H006K2_A109Tran_CodAlmaOrigen ;
   private String[] H006K2_A110Tran_ModuloOrigen ;
   private long[] H006K3_A1Cent_Id ;
   private long[] H006K3_A23Usua_Id ;
...
final  class wp_consulta_transacciones__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          String A58Tran_Estado )
   {
      ...
      scmdbuf = scmdbuf + " AS Tran_RegionCodigo, T9.Regi_Descripcion AS Tran_RegionDescripcion, T6.Cent_Codigo" ;
      ...
      scmdbuf = scmdbuf + " T1.Tran_Estado, T1.Tran_CentroCostoId AS Tran_CentroCostoId, T1.Tran_CentroCostoIdDestino" ;
      ...
      scmdbuf = scmdbuf + " T7.Cent_Codigo AS Tran_CentroCostoCodigoDestino, T8.Regi_Descripcion AS Tran_RegionDescripcionDestino," ;
      scmdbuf = scmdbuf + " T1.Tran_NumeroIngreso, T1.Tran_TipoElemento, T2.Tipo_Codigo AS Tran_CodTipoElemento," ;
      scmdbuf = scmdbuf + " T1.Tran_ValorTransaccion, T1.Tran_IndE_S AS Tran_IndE_S, T1.Tran_RegionId AS Tran_RegionId," ;
      scmdbuf = scmdbuf + " T6.Cent_Descripcion AS Tran_CentroCostoDescripcion, T10.Usua_Nombre AS Tran_UsuarioNombre," ;
      scmdbuf = scmdbuf + " T10.Usua_Codigo AS Tran_UsuarioCodigo, T1.Tran_UsuarioId AS Tran_UsuarioId, T1.Tran_UsuarioRatifica," ;
      scmdbuf = scmdbuf + " T1.Tran_FechaRatificacion, T1.Tran_Id, T1.Tran_IdCuentadanteOrigen, T1.Tran_CodBodeDestino," ;
      scmdbuf = scmdbuf + " T1.Tran_CodAlmaDestino, T1.Tran_ModuloDestino, T1.Tran_CodBodeOrigen, T1.Tran_CodAlmaOrigen," ;
      scmdbuf = scmdbuf + " T1.Tran_ModuloOrigen FROM (((((((((ALM_TRANSACCION T1 INNER JOIN ALM_TIPO_MOVIMIENTO" ;
      scmdbuf = scmdbuf + " T2 ON T2.Tpmo_Codigo = T1.Tran_CodigoMovimiento) LEFT JOIN ALM_ORIGEN_BIENES T3" ;
      scmdbuf = scmdbuf + " ON T3.Orig_Identificador = T1.Tran_TipoIngreso) LEFT JOIN ALM_CUENTADANTE T4 ON" ;
      scmdbuf = scmdbuf + " T4.Cuen_Identificacion = T1.Tran_IdProveedor) LEFT JOIN ALM_CUENTADANTE T5 ON T5.Cuen_Identificacion" ;
      scmdbuf = scmdbuf + " = T1.Tran_IdCuentadanteDestino) INNER JOIN GEN_CENTROCOSTO T6 ON T6.Cent_Id = T1.Tran_CentroCostoId)" ;
      scmdbuf = scmdbuf + " LEFT JOIN GEN_CENTROCOSTO T7 ON T7.Cent_Id = T1.Tran_CentroCostoIdDestino) LEFT" ;
      scmdbuf = scmdbuf + " JOIN GEN_REGIONAL T8 ON T8.Regi_Id = T1.Tran_RegionIdDestino) LEFT JOIN GEN_REGIONAL" ;
      scmdbuf = scmdbuf + " T9 ON T9.Regi_Id = T1.Tran_RegionId) LEFT JOIN SEG_USUARIO T10 ON T10.Usua_Id =" ;
      scmdbuf = scmdbuf + " T1.Tran_UsuarioId)" ;
      scmdbuf = scmdbuf + " WHERE (T1.Tran_Estado = 'R' or T1.Tran_Estado = 'A')" ;
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H006K2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100,0,false )
         ,new ForEachCursor("H006K3", "SELECT Cent_Id, Usua_Id FROM SEG_USUARIO_CENTRO WHERE Usua_Id = ? and Cent_Id = ? ORDER BY Usua_Id, Cent_Id ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
