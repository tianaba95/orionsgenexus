/*
               File: alm_bodegaalm_inv_conwc_impl
...
public final  class alm_bodegaalm_inv_conwc_impl extends GXWebComponent
{
   public alm_bodegaalm_inv_conwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public alm_bodegaalm_inv_conwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( alm_bodegaalm_inv_conwc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Bode_Codigo", AV7Bode_Codigo);
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,AV7Bode_Codigo});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Bode_Codigo, AV12Update, AV13Delete, A91Regional, A92Centro_Id, A27Alma_Modulo, A28Alma_Codigo, A93Trans_Id, A66Elem_Consecutivo, A94Num_Linea, A31Bode_Codigo, A37Cata_Codigo, sPrefix) ;
               GXKey = com.genexus.util.Encryption.decrypt64( httpContext.getCookie( "GX_SESSION_ID"), context.getServerKey( )) ;
               GXKey = com.genexus.util.Encryption.decrypt64( httpContext.getCookie( "GX_SESSION_ID"), context.getServerKey( )) ;
               forbiddenHiddens = sPrefix + "hsh" + "ALM_BODEGAALM_INV_CONWC" ;
               forbiddenHiddens = forbiddenHiddens + GXutil.rtrim( localUtil.format( A31Bode_Codigo, "")) ;
               com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"hsh", GXutil.getEncryptedSignature( forbiddenHiddens, GXKey));
               GXutil.writeLogln("alm_bodegaalm_inv_conwc:[SendSecurityCheck]"+forbiddenHiddens);
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "ALM_BODEGAALM_INV_CONWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2018614141554");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.alm_bodegaalm_inv_conwc") + "?" + GXutil.URLEncode(GXutil.rtrim(AV7Bode_Codigo))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV7Bode_Codigo", wcpOAV7Bode_Codigo);
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vBODE_CODIGO", AV7Bode_Codigo);
   ...
   public void renderHtmlCloseForm3X2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("alm_bodegaalm_inv_conwc.js", "?2018614141554");
      }
   ...
   public void wb3X0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.alm_bodegaalm_inv_conwc");
         }
         /* Div Control */
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_ALM_BODEGAALM_INV_CONWC.htm");
      ...
      if ( wbEnd == 20 )
      {
         ...
         com.orions2.GxWebStd.gx_label_element( httpContext, edtBode_Codigo_Internalname, "Código Bodega", "col-sm-3 AttributeLabel", 0, true);
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtBode_Codigo_Internalname, A31Bode_Codigo, GXutil.rtrim( localUtil.format( A31Bode_Codigo, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBode_Codigo_Jsonclick, 0, "Attribute", "", "", "", edtBode_Codigo_Visible, edtBode_Codigo_Enabled, 0, "text", "", 3, "chr", 1, "row", 3, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_ALM_BODEGAALM_INV_CONWC.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start3X2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "ALM_BODEGAALM_INV_CONWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TRANS_ID", getSecureSignedToken( sPrefix, localUtil.format( DecimalUtil.doubleToDec(A93Trans_Id), "ZZZZZZZZZZ9")));
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "ALM_BODEGAALM_INV_CONWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf3X2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H003X2 */
         pr_default.execute(0, new Object[] {AV7Bode_Codigo, new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_20_idx = (short)(1) ;
         sGXsfl_20_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_20_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_202( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A623Descrip_Atributos = H003X2_A623Descrip_Atributos[0] ;
            n623Descrip_Atributos = H003X2_n623Descrip_Atributos[0] ;
            A31Bode_Codigo = H003X2_A31Bode_Codigo[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A31Bode_Codigo", A31Bode_Codigo);
            A709Trans_FechaRatificacion = H003X2_A709Trans_FechaRatificacion[0] ;
            n709Trans_FechaRatificacion = H003X2_n709Trans_FechaRatificacion[0] ;
            A710Trans_ConsecutivoCC = H003X2_A710Trans_ConsecutivoCC[0] ;
            n710Trans_ConsecutivoCC = H003X2_n710Trans_ConsecutivoCC[0] ;
            A622Costo_Total = H003X2_A622Costo_Total[0] ;
            A621Otros_Costos = H003X2_A621Otros_Costos[0] ;
            n621Otros_Costos = H003X2_n621Otros_Costos[0] ;
            A620Valor_Unitario = H003X2_A620Valor_Unitario[0] ;
            A619Cantidad_Transito = H003X2_A619Cantidad_Transito[0] ;
            n619Cantidad_Transito = H003X2_n619Cantidad_Transito[0] ;
            A618Cantidad_Diponible = H003X2_A618Cantidad_Diponible[0] ;
            n618Cantidad_Diponible = H003X2_n618Cantidad_Diponible[0] ;
            A298Cata_Descripcion = H003X2_A298Cata_Descripcion[0] ;
            A37Cata_Codigo = H003X2_A37Cata_Codigo[0] ;
            A557Elem_Descripcion = H003X2_A557Elem_Descripcion[0] ;
            A94Num_Linea = H003X2_A94Num_Linea[0] ;
            A66Elem_Consecutivo = H003X2_A66Elem_Consecutivo[0] ;
            A93Trans_Id = H003X2_A93Trans_Id[0] ;
            A28Alma_Codigo = H003X2_A28Alma_Codigo[0] ;
            A27Alma_Modulo = H003X2_A27Alma_Modulo[0] ;
            A92Centro_Id = H003X2_A92Centro_Id[0] ;
            A91Regional = H003X2_A91Regional[0] ;
            A37Cata_Codigo = H003X2_A37Cata_Codigo[0] ;
            A557Elem_Descripcion = H003X2_A557Elem_Descripcion[0] ;
            A298Cata_Descripcion = H003X2_A298Cata_Descripcion[0] ;
            A709Trans_FechaRatificacion = H003X2_A709Trans_FechaRatificacion[0] ;
   ...
   {
      /* Using cursor H003X3 */
      pr_default.execute(1, new Object[] {AV7Bode_Codigo});
   ...
   public void strup3X0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV7Bode_Codigo = httpContext.cgiGet( sPrefix+"wcpOAV7Bode_Codigo") ;
         ...
         if ( ! GXutil.checkEncryptedSignature( forbiddenHiddens, hsh, GXKey) )
         {
            ...
            GXutil.writeLog("alm_bodegaalm_inv_conwc:[SecurityCheckFailed]"+forbiddenHiddens);
            return  ;
         }
   ...
   public void e123X2( )
   {
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext, !bGXsfl_20_Refreshing);
      edtBode_Codigo_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtBode_Codigo_Internalname, "Visible", GXutil.ltrim( GXutil.str( edtBode_Codigo_Visible, 5, 0)), true);
   ...
   {
      /* 'DoInsert' Routine */
      callWebObject(formatLink("com.orions2.alm_inv_con") + "?" + GXutil.URLEncode(GXutil.rtrim("INS")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(0,9,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(0,9,0))) + "," + GXutil.URLEncode(GXutil.rtrim("")) + "," + GXutil.URLEncode(GXutil.rtrim("")) + "," + GXutil.URLEncode(GXutil.rtrim(AV7Bode_Codigo)) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(0,9,0))) + "," + GXutil.URLEncode(GXutil.rtrim("")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(0,9,0))));
      httpContext.wjLocDisableFrm = (byte)(1) ;
   }
   ...
   public void S112( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributename( "Bode_Codigo" );
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( AV7Bode_Codigo );
   ...
   {
      AV7Bode_Codigo = (String)getParm(obj,0,TypeConstants.STRING) ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Bode_Codigo", AV7Bode_Codigo);
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV7Bode_Codigo = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "alm_bodegaalm_inv_conwc");
      ...
      {
         AV7Bode_Codigo = (String)getParm(obj,2,TypeConstants.STRING) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Bode_Codigo", AV7Bode_Codigo);
      }
      wcpOAV7Bode_Codigo = httpContext.cgiGet( sPrefix+"wcpOAV7Bode_Codigo") ;
      if ( ! GetJustCreated( ) && ( ( GXutil.strcmp(AV7Bode_Codigo, wcpOAV7Bode_Codigo) != 0 ) ) )
      {
         setjustcreated();
      }
      wcpOAV7Bode_Codigo = AV7Bode_Codigo ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV7Bode_Codigo = httpContext.cgiGet( sPrefix+"AV7Bode_Codigo_CTRL") ;
      if ( GXutil.len( sCtrlAV7Bode_Codigo) > 0 )
      {
         AV7Bode_Codigo = httpContext.cgiGet( sCtrlAV7Bode_Codigo) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Bode_Codigo", AV7Bode_Codigo);
      }
      else
      {
         AV7Bode_Codigo = httpContext.cgiGet( sPrefix+"AV7Bode_Codigo_PARM") ;
      }
   }
   ...
   {
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Bode_Codigo_PARM", AV7Bode_Codigo);
      if ( GXutil.len( GXutil.rtrim( sCtrlAV7Bode_Codigo)) > 0 )
      {
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Bode_Codigo_CTRL", GXutil.rtrim( sCtrlAV7Bode_Codigo));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20186141415576");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("alm_bodegaalm_inv_conwc.js", "?20186141415576");
      }
   ...
   public void subsflControlProps_202( )
   {
      ...
      edtTrans_Id_Internalname = sPrefix+"TRANS_ID_"+sGXsfl_20_idx ;
      ...
      edtTrans_ConsecutivoCC_Internalname = sPrefix+"TRANS_CONSECUTIVOCC_"+sGXsfl_20_idx ;
      edtTrans_FechaRatificacion_Internalname = sPrefix+"TRANS_FECHARATIFICACION_"+sGXsfl_20_idx ;
   ...
   public void subsflControlProps_fel_202( )
   {
      ...
      edtTrans_Id_Internalname = sPrefix+"TRANS_ID_"+sGXsfl_20_fel_idx ;
      ...
      edtTrans_ConsecutivoCC_Internalname = sPrefix+"TRANS_CONSECUTIVOCC_"+sGXsfl_20_fel_idx ;
      edtTrans_FechaRatificacion_Internalname = sPrefix+"TRANS_FECHARATIFICACION_"+sGXsfl_20_fel_idx ;
   ...
   public void sendrow_202( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTrans_Id_Internalname,GXutil.ltrim( localUtil.ntoc( A93Trans_Id, (byte)(11), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A93Trans_Id), "ZZZZZZZZZZ9"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtTrans_Id_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(11),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"Identificador","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTrans_FechaRatificacion_Internalname,localUtil.ttoc( A709Trans_FechaRatificacion, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A709Trans_FechaRatificacion, "99/99/9999 99:99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtTrans_FechaRatificacion_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(16),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TRANS_ID"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, localUtil.format( DecimalUtil.doubleToDec(A93Trans_Id), "ZZZZZZZZZZ9")));
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Bode_Codigo',fld:'vBODE_CODIGO',pic:'',nv:''},{av:'AV12Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV13Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A91Regional',fld:'REGIONAL',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'A92Centro_Id',fld:'CENTRO_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'cmbAlma_Modulo'},{av:'A27Alma_Modulo',fld:'ALMA_MODULO',pic:'',hsh:true,nv:''},{av:'A28Alma_Codigo',fld:'ALMA_CODIGO',pic:'',hsh:true,nv:''},{av:'A93Trans_Id',fld:'TRANS_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'A66Elem_Consecutivo',fld:'ELEM_CONSECUTIVO',pic:'',hsh:true,nv:''},{av:'A94Num_Linea',fld:'NUM_LINEA',pic:'ZZZZZZZ9',hsh:true,nv:0},{av:'A31Bode_Codigo',fld:'BODE_CODIGO',pic:'',nv:''},{av:'A37Cata_Codigo',fld:'CATA_CODIGO',pic:'',nv:''},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e133X2',iparms:[{av:'A91Regional',fld:'REGIONAL',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'A92Centro_Id',fld:'CENTRO_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'cmbAlma_Modulo'},{av:'A27Alma_Modulo',fld:'ALMA_MODULO',pic:'',hsh:true,nv:''},{av:'A28Alma_Codigo',fld:'ALMA_CODIGO',pic:'',hsh:true,nv:''},{av:'AV7Bode_Codigo',fld:'vBODE_CODIGO',pic:'',nv:''},{av:'A93Trans_Id',fld:'TRANS_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'A66Elem_Consecutivo',fld:'ELEM_CONSECUTIVO',pic:'',hsh:true,nv:''},{av:'A94Num_Linea',fld:'NUM_LINEA',pic:'ZZZZZZZ9',hsh:true,nv:0},{av:'A31Bode_Codigo',fld:'BODE_CODIGO',pic:'',nv:''},{av:'A37Cata_Codigo',fld:'CATA_CODIGO',pic:'',nv:''}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtElem_Descripcion_Link',ctrl:'ELEM_DESCRIPCION',prop:'Link'},{av:'edtCata_Descripcion_Link',ctrl:'CATA_DESCRIPCION',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e113X2',iparms:[{av:'A91Regional',fld:'REGIONAL',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'A92Centro_Id',fld:'CENTRO_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'cmbAlma_Modulo'},{av:'A27Alma_Modulo',fld:'ALMA_MODULO',pic:'',hsh:true,nv:''},{av:'A28Alma_Codigo',fld:'ALMA_CODIGO',pic:'',hsh:true,nv:''},{av:'AV7Bode_Codigo',fld:'vBODE_CODIGO',pic:'',nv:''},{av:'A93Trans_Id',fld:'TRANS_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'A66Elem_Consecutivo',fld:'ELEM_CONSECUTIVO',pic:'',hsh:true,nv:''},{av:'A94Num_Linea',fld:'NUM_LINEA',pic:'ZZZZZZZ9',hsh:true,nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H003X2_A623Descrip_Atributos = new String[] {""} ;
      H003X2_n623Descrip_Atributos = new boolean[] {false} ;
      H003X2_A31Bode_Codigo = new String[] {""} ;
      H003X2_A709Trans_FechaRatificacion = new java.util.Date[] {GXutil.nullDate()} ;
      H003X2_n709Trans_FechaRatificacion = new boolean[] {false} ;
      H003X2_A710Trans_ConsecutivoCC = new long[1] ;
      H003X2_n710Trans_ConsecutivoCC = new boolean[] {false} ;
      H003X2_A622Costo_Total = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H003X2_A621Otros_Costos = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H003X2_n621Otros_Costos = new boolean[] {false} ;
      H003X2_A620Valor_Unitario = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H003X2_A619Cantidad_Transito = new int[1] ;
      H003X2_n619Cantidad_Transito = new boolean[] {false} ;
      H003X2_A618Cantidad_Diponible = new int[1] ;
      H003X2_n618Cantidad_Diponible = new boolean[] {false} ;
      H003X2_A298Cata_Descripcion = new String[] {""} ;
      H003X2_A37Cata_Codigo = new String[] {""} ;
      H003X2_A557Elem_Descripcion = new String[] {""} ;
      H003X2_A94Num_Linea = new int[1] ;
      H003X2_A66Elem_Consecutivo = new String[] {""} ;
      H003X2_A93Trans_Id = new long[1] ;
      H003X2_A28Alma_Codigo = new String[] {""} ;
      H003X2_A27Alma_Modulo = new String[] {""} ;
      H003X2_A92Centro_Id = new long[1] ;
      H003X2_A91Regional = new long[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.alm_bodegaalm_inv_conwc__default(),
         new Object[] {
             new Object[] {
            H003X2_A623Descrip_Atributos, H003X2_n623Descrip_Atributos, H003X2_A31Bode_Codigo, H003X2_A709Trans_FechaRatificacion, H003X2_n709Trans_FechaRatificacion, H003X2_A710Trans_ConsecutivoCC, H003X2_n710Trans_ConsecutivoCC, H003X2_A622Costo_Total, H003X2_A621Otros_Costos, H003X2_n621Otros_Costos,
            H003X2_A620Valor_Unitario, H003X2_A619Cantidad_Transito, H003X2_n619Cantidad_Transito, H003X2_A618Cantidad_Diponible, H003X2_n618Cantidad_Diponible, H003X2_A298Cata_Descripcion, H003X2_A37Cata_Codigo, H003X2_A557Elem_Descripcion, H003X2_A94Num_Linea, H003X2_A66Elem_Consecutivo,
            H003X2_A93Trans_Id, H003X2_A28Alma_Codigo, H003X2_A27Alma_Modulo, H003X2_A92Centro_Id, H003X2_A91Regional
            }
            , new Object[] {
   ...
   private int edtBode_Codigo_Visible ;
   ...
   private String hsh ;
   private String sCtrlAV7Bode_Codigo ;
   ...
   private String[] H003X2_A623Descrip_Atributos ;
   private boolean[] H003X2_n623Descrip_Atributos ;
   private String[] H003X2_A31Bode_Codigo ;
   private java.util.Date[] H003X2_A709Trans_FechaRatificacion ;
   private boolean[] H003X2_n709Trans_FechaRatificacion ;
   private long[] H003X2_A710Trans_ConsecutivoCC ;
   private boolean[] H003X2_n710Trans_ConsecutivoCC ;
   private java.math.BigDecimal[] H003X2_A622Costo_Total ;
   private java.math.BigDecimal[] H003X2_A621Otros_Costos ;
   private boolean[] H003X2_n621Otros_Costos ;
   private java.math.BigDecimal[] H003X2_A620Valor_Unitario ;
   private int[] H003X2_A619Cantidad_Transito ;
   private boolean[] H003X2_n619Cantidad_Transito ;
   private int[] H003X2_A618Cantidad_Diponible ;
   private boolean[] H003X2_n618Cantidad_Diponible ;
   private String[] H003X2_A298Cata_Descripcion ;
   private String[] H003X2_A37Cata_Codigo ;
   private String[] H003X2_A557Elem_Descripcion ;
   private int[] H003X2_A94Num_Linea ;
   private String[] H003X2_A66Elem_Consecutivo ;
   private long[] H003X2_A93Trans_Id ;
   private String[] H003X2_A28Alma_Codigo ;
   private String[] H003X2_A27Alma_Modulo ;
   private long[] H003X2_A92Centro_Id ;
   private long[] H003X2_A91Regional ;
...
final  class alm_bodegaalm_inv_conwc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H003X2", "SELECT T1.Descrip_Atributos, T1.Bode_Codigo, T4.Tran_FechaRatificacion AS Trans_FechaRatificacion, T4.Tran_ConsecutivoCC AS Trans_ConsecutivoCC, T1.Costo_Total, T1.Otros_Costos, T1.Valor_Unitario, T1.Cantidad_Transito, T1.Cantidad_Diponible, T3.Cata_Descripcion, T2.Cata_Codigo, T2.Elem_Descripcion, T1.Num_Linea, T1.Elem_Consecutivo, T1.Trans_Id AS Trans_Id, T1.Alma_Codigo, T1.Alma_Modulo, T1.Centro_Id, T1.Regional FROM (((ALM_INV_CON T1 INNER JOIN ALM_ELEMENTO T2 ON T2.Elem_Consecutivo = T1.Elem_Consecutivo) INNER JOIN ALM_CATALOGO T3 ON T3.Cata_Codigo = T2.Cata_Codigo) INNER JOIN ALM_TRANSACCION T4 ON T4.Tran_Id = T1.Trans_Id) WHERE T1.Bode_Codigo = ? ORDER BY T1.Bode_Codigo  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H003X3", "SELECT COUNT(*) FROM (((ALM_INV_CON T1 INNER JOIN ALM_ELEMENTO T2 ON T2.Elem_Consecutivo = T1.Elem_Consecutivo) INNER JOIN ALM_CATALOGO T3 ON T3.Cata_Codigo = T2.Cata_Codigo) INNER JOIN ALM_TRANSACCION T4 ON T4.Tran_Id = T1.Trans_Id) WHERE T1.Bode_Codigo = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
