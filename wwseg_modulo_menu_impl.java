/*
               File: wwseg_modulo_menu_impl
        Description: Work With Módulo
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:19:17.66
...
public final  class wwseg_modulo_menu_impl extends GXDataArea
{
   public wwseg_modulo_menu_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wwseg_modulo_menu_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wwseg_modulo_menu_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
         {
            ...
            AV14Modu_Descripcion = httpContext.GetNextPar( ) ;
            AV15Update = httpContext.GetNextPar( ) ;
            edtavUpdate_Tooltiptext = httpContext.GetNextPar( ) ;
            httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Tooltiptext", edtavUpdate_Tooltiptext, !bGXsfl_25_Refreshing);
            AV16Delete = httpContext.GetNextPar( ) ;
            ...
            gxgrgrid_refresh( subGrid_Rows, AV14Modu_Descripcion, AV15Update, AV16Delete, AV20Pgmname, A16Modu_Id) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414191770");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( nGXWrapped != 1 )
      {
         httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.wwseg_modulo_menu") +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "GXH_vMODU_DESCRIPCION", AV14Modu_Descripcion);
      /* Send saved values. */
   ...
   {
      return formatLink("com.orions2.wwseg_modulo_menu")  ;
   }

   public String getPgmname( )
   {
      return "WWSEG_MODULO_MENU" ;
   }

   public String getPgmdesc( )
   {
      return "Work With Módulo" ;
   }
   ...
   public void wb2W0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblTitletext_Internalname, "Work With Móduloes", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_WWSEG_MODULO_MENU.htm");
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 25, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWSEG_MODULO_MENU.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_label_element( httpContext, edtavModu_descripcion_Internalname, "Modu_Descripcion", "col-sm-3 FilterSearchAttributeLabel", 0, true);
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"" ;
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavModu_descripcion_Internalname, AV14Modu_Descripcion, GXutil.rtrim( localUtil.format( AV14Modu_Descripcion, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Descripción Módulo", edtavModu_descripcion_Jsonclick, 0, "FilterSearchAttribute", "", "", "", 1, edtavModu_descripcion_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_WWSEG_MODULO_MENU.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start2W2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Work With Módulo", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 {
                                    Rfr0gs = false ;
                                    /* Set Refresh If Modu_descripcion Changed */
                                    if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vMODU_DESCRIPCION"), AV14Modu_Descripcion) != 0 )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    if ( ! Rfr0gs )
   ...
   public void pa2W2( )
   {
      if ( nDonePA == 0 )
      {
         ...
         if ( ! httpContext.isAjaxRequest( ) )
         {
            GX_FocusControl = edtavModu_descripcion_Internalname ;
   ...
   public void rf2W2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV14Modu_Descripcion ,
                                              A17Modu_Descripcion } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.STRING
                                              }
         } ) ;
         lV14Modu_Descripcion = GXutil.concat( GXutil.rtrim( AV14Modu_Descripcion), "%", "") ;
         httpContext.ajax_rsp_assign_attri("", false, "AV14Modu_Descripcion", AV14Modu_Descripcion);
         /* Using cursor H002W2 */
         pr_default.execute(0, new Object[] {lV14Modu_Descripcion, new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_25_idx = (short)(1) ;
         sGXsfl_25_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_25_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_252( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A17Modu_Descripcion = H002W2_A17Modu_Descripcion[0] ;
            A16Modu_Id = H002W2_A16Modu_Id[0] ;
            e142W2 ();
   ...
   public int subgrid_recordcount( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV14Modu_Descripcion", AV14Modu_Descripcion);
      /* Using cursor H002W3 */
      pr_default.execute(1, new Object[] {lV14Modu_Descripcion});
   ...
   public void strup2W0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV14Modu_Descripcion = httpContext.cgiGet( edtavModu_descripcion_Internalname) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV14Modu_Descripcion", AV14Modu_Descripcion);
         /* Read saved values. */
   ...
   public void e122W2( )
   {
      ...
      httpContext.ajax_rsp_assign_prop("", false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext, !bGXsfl_25_Refreshing);
      Form.setCaption( "Work With Móduloes" );
   ...
   {
      /* Grid_Load Routine */
      edtavUpdate_Link = formatLink("com.orions2.seg_modulo_menu") + "?" + GXutil.URLEncode(GXutil.rtrim("UPD")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A16Modu_Id,11,0))) ;
      edtavDelete_Link = formatLink("com.orions2.seg_modulo_menu") + "?" + GXutil.URLEncode(GXutil.rtrim("DLT")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A16Modu_Id,11,0))) ;
   ...
   {
      /* 'DoInsert' Routine */
      callWebObject(formatLink("com.orions2.seg_modulo_menu") + "?" + GXutil.URLEncode(GXutil.rtrim("INS")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(0,9,0))));
      httpContext.wjLocDisableFrm = (byte)(1) ;
   }
   ...
   public void S122( )
   {
      ...
      if ( GXutil.strcmp(AV8HTTPRequest.getMethod(), "GET") == 0 )
      {
         ...
         {
            AV14Modu_Descripcion = ((com.orions2.SdtGridState_FilterValue)AV9GridState.getgxTv_SdtGridState_Filtervalues().elementAt(-1+1)).getgxTv_SdtGridState_FilterValue_Value() ;
            httpContext.ajax_rsp_assign_attri("", false, "AV14Modu_Descripcion", AV14Modu_Descripcion);
         }
   ...
   public void S132( )
   {
      ...
      AV10GridStateFilterValue.setgxTv_SdtGridState_FilterValue_Value( AV14Modu_Descripcion );
   ...
   public void S112( )
   {
      ...
      AV12TrnContext.setgxTv_SdtTransactionContext_Transactionname( "SEG_MODULO_MENU" );
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20186141419189");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         ...
         httpContext.AddJavascriptSource("wwseg_modulo_menu.js", "?20186141419189");
      }
   ...
   public void sendrow_252( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtModu_Descripcion_Internalname,A17Modu_Descripcion,"","","'"+""+"'"+",false,"+"'"+""+"'",edtModu_Descripcion_Link,"","","",edtModu_Descripcion_Jsonclick,new Integer(0),"DescriptionAttribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
   ...
   public void init_default_properties( )
   {
      ...
      edtavModu_descripcion_Internalname = "vMODU_DESCRIPCION" ;
   ...
   public void initialize_properties( )
   {
      ...
      edtavModu_descripcion_Jsonclick = "" ;
      edtavModu_descripcion_Enabled = 1 ;
      Form.setHeaderrawhtml( "" );
      Form.setBackground( "" );
      Form.setTextcolor( 0 );
      Form.setIBackground( (int)(0xFFFFFF) );
      Form.setCaption( "Work With Módulo" );
      subGrid_Rows = 0 ;
      edtavDelete_Tooltiptext = "Eliminar" ;
      edtavUpdate_Tooltiptext = "Modificar" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV15Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV16Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A16Modu_Id',fld:'MODU_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'AV20Pgmname',fld:'vPGMNAME',pic:'',nv:''},{av:'AV14Modu_Descripcion',fld:'vMODU_DESCRIPCION',pic:'',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e142W2',iparms:[{av:'A16Modu_Id',fld:'MODU_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtModu_Descripcion_Link',ctrl:'MODU_DESCRIPCION',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e112W2',iparms:[{av:'A16Modu_Id',fld:'MODU_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV22Delete_GXI = "" ;
      scmdbuf = "" ;
      lV14Modu_Descripcion = "" ;
      H002W2_A17Modu_Descripcion = new String[] {""} ;
      H002W2_A16Modu_Id = new long[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.wwseg_modulo_menu__default(),
         new Object[] {
             new Object[] {
            H002W2_A17Modu_Descripcion, H002W2_A16Modu_Id
            }
            , new Object[] {
   ...
   private int edtavModu_descripcion_Enabled ;
   ...
   private String edtavModu_descripcion_Internalname ;
   private String edtavModu_descripcion_Jsonclick ;
   ...
   private String[] H002W2_A17Modu_Descripcion ;
   private long[] H002W2_A16Modu_Id ;
...
final  class wwseg_modulo_menu__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          String A17Modu_Descripcion )
   {
      ...
      String sFromString ;
      String sOrderString ;
      sSelectString = " Modu_Descripcion, Modu_Id" ;
      sFromString = " FROM SEG_MODULO_MENU" ;
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV14Modu_Descripcion)==0) )
      {
         ...
         {
            sWhereString = sWhereString + " (Modu_Descripcion like ?)" ;
         }
      }
      else
      {
      ...
      sOrderString = sOrderString + " ORDER BY Modu_Descripcion" ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H002W2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
            case 1 :
                  return conditional_H002W3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H002W2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H002W3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
