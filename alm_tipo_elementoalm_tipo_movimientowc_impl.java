/*
               File: alm_tipo_elementoalm_tipo_movimientowc_impl
...
public final  class alm_tipo_elementoalm_tipo_movimientowc_impl extends GXWebComponent
{
   public alm_tipo_elementoalm_tipo_movimientowc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public alm_tipo_elementoalm_tipo_movimientowc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( alm_tipo_elementoalm_tipo_movimientowc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Tipo_Codigo, AV12Update, AV13Delete, A38Tpmo_Codigo, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "ALM_TIPO_ELEMENTOALM_TIPO_MOVIMIENTOWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414164177");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.alm_tipo_elementoalm_tipo_movimientowc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Tipo_Codigo,18,0)))+"\">") ;
   ...
   public void renderHtmlCloseForm432( )
   {
      ...
      {
         httpContext.AddJavascriptSource("alm_tipo_elementoalm_tipo_movimientowc.js", "?201861414164181");
      }
   ...
   public void wb430( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.alm_tipo_elementoalm_tipo_movimientowc");
         }
         /* Div Control */
   ...
   public void start432( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "ALM_TIPO_ELEMENTOALM_TIPO_MOVIMIENTOWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "ALM_TIPO_ELEMENTOALM_TIPO_MOVIMIENTOWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf432( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A33Tipo_Codigo = H00432_A33Tipo_Codigo[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A33Tipo_Codigo", GXutil.ltrim( GXutil.str( A33Tipo_Codigo, 18, 0)));
            A718Tmpo_ImprimeResponsable = H00432_A718Tmpo_ImprimeResponsable[0] ;
            n718Tmpo_ImprimeResponsable = H00432_n718Tmpo_ImprimeResponsable[0] ;
            A717Tpmo_ImprimeDestino = H00432_A717Tpmo_ImprimeDestino[0] ;
            n717Tpmo_ImprimeDestino = H00432_n717Tpmo_ImprimeDestino[0] ;
            A716Tpmo_ImprimeOrigen = H00432_A716Tpmo_ImprimeOrigen[0] ;
            n716Tpmo_ImprimeOrigen = H00432_n716Tpmo_ImprimeOrigen[0] ;
            A706Tpmo_SolicitaCentroDestino = H00432_A706Tpmo_SolicitaCentroDestino[0] ;
            n706Tpmo_SolicitaCentroDestino = H00432_n706Tpmo_SolicitaCentroDestino[0] ;
            A705Tpmo_SolicitaRegionDestino = H00432_A705Tpmo_SolicitaRegionDestino[0] ;
            n705Tpmo_SolicitaRegionDestino = H00432_n705Tpmo_SolicitaRegionDestino[0] ;
            A680Tpmo_CuentaResponsabilidad = H00432_A680Tpmo_CuentaResponsabilidad[0] ;
            n680Tpmo_CuentaResponsabilidad = H00432_n680Tpmo_CuentaResponsabilidad[0] ;
            A679Tpmo_Estado = H00432_A679Tpmo_Estado[0] ;
            n679Tpmo_Estado = H00432_n679Tpmo_Estado[0] ;
            A641Tpmo_VidaUtil = H00432_A641Tpmo_VidaUtil[0] ;
            n641Tpmo_VidaUtil = H00432_n641Tpmo_VidaUtil[0] ;
            A633Tpmo_Controlado = H00432_A633Tpmo_Controlado[0] ;
            n633Tpmo_Controlado = H00432_n633Tpmo_Controlado[0] ;
            A595Tpmo_ConsecutivoTrans = H00432_A595Tpmo_ConsecutivoTrans[0] ;
            n595Tpmo_ConsecutivoTrans = H00432_n595Tpmo_ConsecutivoTrans[0] ;
            A441Tpmo_IngresaCurso = H00432_A441Tpmo_IngresaCurso[0] ;
            A440Tpmo_IngresaAredante = H00432_A440Tpmo_IngresaAredante[0] ;
            A320Tpmo_FechaModifica = H00432_A320Tpmo_FechaModifica[0] ;
            n320Tpmo_FechaModifica = H00432_n320Tpmo_FechaModifica[0] ;
            A319Tpmo_UsuarioModifica = H00432_A319Tpmo_UsuarioModifica[0] ;
            n319Tpmo_UsuarioModifica = H00432_n319Tpmo_UsuarioModifica[0] ;
            A318Tpmo_FechaCrea = H00432_A318Tpmo_FechaCrea[0] ;
            A317Tpmo_UsuarioCrea = H00432_A317Tpmo_UsuarioCrea[0] ;
            A316Tpmo_Modulo = H00432_A316Tpmo_Modulo[0] ;
            A315Tpmo_TipoE_S = H00432_A315Tpmo_TipoE_S[0] ;
            A314Tpmo_AlmacenDestinoDescrip = H00432_A314Tpmo_AlmacenDestinoDescrip[0] ;
            n314Tpmo_AlmacenDestinoDescrip = H00432_n314Tpmo_AlmacenDestinoDescrip[0] ;
            A40Tpmo_AlmacenDestinoId = H00432_A40Tpmo_AlmacenDestinoId[0] ;
            A312Tpmo_AlmacenOrigenDescrip = H00432_A312Tpmo_AlmacenOrigenDescrip[0] ;
            n312Tpmo_AlmacenOrigenDescrip = H00432_n312Tpmo_AlmacenOrigenDescrip[0] ;
            A39Tpmo_AlmacenOrigenId = H00432_A39Tpmo_AlmacenOrigenId[0] ;
            A313Tpmo_Descripcion = H00432_A313Tpmo_Descripcion[0] ;
            A38Tpmo_Codigo = H00432_A38Tpmo_Codigo[0] ;
            A314Tpmo_AlmacenDestinoDescrip = H00432_A314Tpmo_AlmacenDestinoDescrip[0] ;
            n314Tpmo_AlmacenDestinoDescrip = H00432_n314Tpmo_AlmacenDestinoDescrip[0] ;
            A312Tpmo_AlmacenOrigenDescrip = H00432_A312Tpmo_AlmacenOrigenDescrip[0] ;
            n312Tpmo_AlmacenOrigenDescrip = H00432_n312Tpmo_AlmacenOrigenDescrip[0] ;
   ...
   public void S112( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributename( "Tipo_Codigo" );
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( GXutil.str( AV7Tipo_Codigo, 18, 0) );
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "alm_tipo_elementoalm_tipo_movimientowc");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414164268");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("alm_tipo_elementoalm_tipo_movimientowc.js", "?201861414164268");
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Tipo_Codigo',fld:'vTIPO_CODIGO',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV12Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV13Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A38Tpmo_Codigo',fld:'TPMO_CODIGO',pic:'',hsh:true,nv:''},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e13432',iparms:[{av:'A38Tpmo_Codigo',fld:'TPMO_CODIGO',pic:'',hsh:true,nv:''}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtTpmo_Descripcion_Link',ctrl:'TPMO_DESCRIPCION',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e11432',iparms:[{av:'A38Tpmo_Codigo',fld:'TPMO_CODIGO',pic:'',hsh:true,nv:''}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H00432_A33Tipo_Codigo = new long[1] ;
      H00432_A718Tmpo_ImprimeResponsable = new String[] {""} ;
      H00432_n718Tmpo_ImprimeResponsable = new boolean[] {false} ;
      H00432_A717Tpmo_ImprimeDestino = new String[] {""} ;
      H00432_n717Tpmo_ImprimeDestino = new boolean[] {false} ;
      H00432_A716Tpmo_ImprimeOrigen = new String[] {""} ;
      H00432_n716Tpmo_ImprimeOrigen = new boolean[] {false} ;
      H00432_A706Tpmo_SolicitaCentroDestino = new String[] {""} ;
      H00432_n706Tpmo_SolicitaCentroDestino = new boolean[] {false} ;
      H00432_A705Tpmo_SolicitaRegionDestino = new String[] {""} ;
      H00432_n705Tpmo_SolicitaRegionDestino = new boolean[] {false} ;
      H00432_A680Tpmo_CuentaResponsabilidad = new String[] {""} ;
      H00432_n680Tpmo_CuentaResponsabilidad = new boolean[] {false} ;
      H00432_A679Tpmo_Estado = new String[] {""} ;
      H00432_n679Tpmo_Estado = new boolean[] {false} ;
      H00432_A641Tpmo_VidaUtil = new String[] {""} ;
      H00432_n641Tpmo_VidaUtil = new boolean[] {false} ;
      H00432_A633Tpmo_Controlado = new String[] {""} ;
      H00432_n633Tpmo_Controlado = new boolean[] {false} ;
      H00432_A595Tpmo_ConsecutivoTrans = new long[1] ;
      H00432_n595Tpmo_ConsecutivoTrans = new boolean[] {false} ;
      H00432_A441Tpmo_IngresaCurso = new String[] {""} ;
      H00432_A440Tpmo_IngresaAredante = new String[] {""} ;
      H00432_A320Tpmo_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H00432_n320Tpmo_FechaModifica = new boolean[] {false} ;
      H00432_A319Tpmo_UsuarioModifica = new String[] {""} ;
      H00432_n319Tpmo_UsuarioModifica = new boolean[] {false} ;
      H00432_A318Tpmo_FechaCrea = new java.util.Date[] {GXutil.nullDate()} ;
      H00432_A317Tpmo_UsuarioCrea = new String[] {""} ;
      H00432_A316Tpmo_Modulo = new String[] {""} ;
      H00432_A315Tpmo_TipoE_S = new String[] {""} ;
      H00432_A314Tpmo_AlmacenDestinoDescrip = new String[] {""} ;
      H00432_n314Tpmo_AlmacenDestinoDescrip = new boolean[] {false} ;
      H00432_A40Tpmo_AlmacenDestinoId = new long[1] ;
      H00432_A312Tpmo_AlmacenOrigenDescrip = new String[] {""} ;
      H00432_n312Tpmo_AlmacenOrigenDescrip = new boolean[] {false} ;
      H00432_A39Tpmo_AlmacenOrigenId = new long[1] ;
      H00432_A313Tpmo_Descripcion = new String[] {""} ;
      H00432_A38Tpmo_Codigo = new String[] {""} ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.alm_tipo_elementoalm_tipo_movimientowc__default(),
         new Object[] {
             new Object[] {
            H00432_A33Tipo_Codigo, H00432_A718Tmpo_ImprimeResponsable, H00432_n718Tmpo_ImprimeResponsable, H00432_A717Tpmo_ImprimeDestino, H00432_n717Tpmo_ImprimeDestino, H00432_A716Tpmo_ImprimeOrigen, H00432_n716Tpmo_ImprimeOrigen, H00432_A706Tpmo_SolicitaCentroDestino, H00432_n706Tpmo_SolicitaCentroDestino, H00432_A705Tpmo_SolicitaRegionDestino,
            H00432_n705Tpmo_SolicitaRegionDestino, H00432_A680Tpmo_CuentaResponsabilidad, H00432_n680Tpmo_CuentaResponsabilidad, H00432_A679Tpmo_Estado, H00432_n679Tpmo_Estado, H00432_A641Tpmo_VidaUtil, H00432_n641Tpmo_VidaUtil, H00432_A633Tpmo_Controlado, H00432_n633Tpmo_Controlado, H00432_A595Tpmo_ConsecutivoTrans,
            H00432_n595Tpmo_ConsecutivoTrans, H00432_A441Tpmo_IngresaCurso, H00432_A440Tpmo_IngresaAredante, H00432_A320Tpmo_FechaModifica, H00432_n320Tpmo_FechaModifica, H00432_A319Tpmo_UsuarioModifica, H00432_n319Tpmo_UsuarioModifica, H00432_A318Tpmo_FechaCrea, H00432_A317Tpmo_UsuarioCrea, H00432_A316Tpmo_Modulo,
            H00432_A315Tpmo_TipoE_S, H00432_A314Tpmo_AlmacenDestinoDescrip, H00432_n314Tpmo_AlmacenDestinoDescrip, H00432_A40Tpmo_AlmacenDestinoId, H00432_A312Tpmo_AlmacenOrigenDescrip, H00432_n312Tpmo_AlmacenOrigenDescrip, H00432_A39Tpmo_AlmacenOrigenId, H00432_A313Tpmo_Descripcion, H00432_A38Tpmo_Codigo
            }
            , new Object[] {
   ...
   private long[] H00432_A33Tipo_Codigo ;
   private String[] H00432_A718Tmpo_ImprimeResponsable ;
   private boolean[] H00432_n718Tmpo_ImprimeResponsable ;
   private String[] H00432_A717Tpmo_ImprimeDestino ;
   private boolean[] H00432_n717Tpmo_ImprimeDestino ;
   private String[] H00432_A716Tpmo_ImprimeOrigen ;
   private boolean[] H00432_n716Tpmo_ImprimeOrigen ;
   private String[] H00432_A706Tpmo_SolicitaCentroDestino ;
   private boolean[] H00432_n706Tpmo_SolicitaCentroDestino ;
   private String[] H00432_A705Tpmo_SolicitaRegionDestino ;
   private boolean[] H00432_n705Tpmo_SolicitaRegionDestino ;
   private String[] H00432_A680Tpmo_CuentaResponsabilidad ;
   private boolean[] H00432_n680Tpmo_CuentaResponsabilidad ;
   private String[] H00432_A679Tpmo_Estado ;
   private boolean[] H00432_n679Tpmo_Estado ;
   private String[] H00432_A641Tpmo_VidaUtil ;
   private boolean[] H00432_n641Tpmo_VidaUtil ;
   private String[] H00432_A633Tpmo_Controlado ;
   private boolean[] H00432_n633Tpmo_Controlado ;
   private long[] H00432_A595Tpmo_ConsecutivoTrans ;
   private boolean[] H00432_n595Tpmo_ConsecutivoTrans ;
   private String[] H00432_A441Tpmo_IngresaCurso ;
   private String[] H00432_A440Tpmo_IngresaAredante ;
   private java.util.Date[] H00432_A320Tpmo_FechaModifica ;
   private boolean[] H00432_n320Tpmo_FechaModifica ;
   private String[] H00432_A319Tpmo_UsuarioModifica ;
   private boolean[] H00432_n319Tpmo_UsuarioModifica ;
   private java.util.Date[] H00432_A318Tpmo_FechaCrea ;
   private String[] H00432_A317Tpmo_UsuarioCrea ;
   private String[] H00432_A316Tpmo_Modulo ;
   private String[] H00432_A315Tpmo_TipoE_S ;
   private String[] H00432_A314Tpmo_AlmacenDestinoDescrip ;
   private boolean[] H00432_n314Tpmo_AlmacenDestinoDescrip ;
   private long[] H00432_A40Tpmo_AlmacenDestinoId ;
   private String[] H00432_A312Tpmo_AlmacenOrigenDescrip ;
   private boolean[] H00432_n312Tpmo_AlmacenOrigenDescrip ;
   private long[] H00432_A39Tpmo_AlmacenOrigenId ;
   private String[] H00432_A313Tpmo_Descripcion ;
   private String[] H00432_A38Tpmo_Codigo ;
...
final  class alm_tipo_elementoalm_tipo_movimientowc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00432", "SELECT T1.Tipo_Codigo, T1.Tmpo_ImprimeResponsable, T1.Tpmo_ImprimeDestino, T1.Tpmo_ImprimeOrigen, T1.Tpmo_SolicitaCentroDestino, T1.Tpmo_SolicitaRegionDestino, T1.Tpmo_CuentaResponsabilidad, T1.Tpmo_Estado, T1.Tpmo_VidaUtil, T1.Tpmo_Controlado, T1.Tpmo_ConsecutivoTrans, T1.Tpmo_IngresaCurso, T1.Tpmo_IngresaAredante, T1.Tpmo_FechaModifica, T1.Tpmo_UsuarioModifica, T1.Tpmo_FechaCrea, T1.Tpmo_UsuarioCrea, T1.Tpmo_Modulo, T1.Tpmo_TipoE_S, T2.Tpal_Descripcion AS Tpmo_AlmacenDestinoDescrip, T1.Tpmo_AlmacenDestinoId AS Tpmo_AlmacenDestinoId, T3.Tpal_Descripcion AS Tpmo_AlmacenOrigenDescrip, T1.Tpmo_AlmacenOrigenId AS Tpmo_AlmacenOrigenId, T1.Tpmo_Descripcion, T1.Tpmo_Codigo FROM ((ALM_TIPO_MOVIMIENTO T1 INNER JOIN ALM_TIPO_ALMACEN T2 ON T2.Tpal_Id = T1.Tpmo_AlmacenDestinoId) INNER JOIN ALM_TIPO_ALMACEN T3 ON T3.Tpal_Id = T1.Tpmo_AlmacenOrigenId) WHERE T1.Tipo_Codigo = ? ORDER BY T1.Tipo_Codigo  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H00433", "SELECT COUNT(*) FROM ((ALM_TIPO_MOVIMIENTO T1 INNER JOIN ALM_TIPO_ALMACEN T3 ON T3.Tpal_Id = T1.Tpmo_AlmacenDestinoId) INNER JOIN ALM_TIPO_ALMACEN T2 ON T2.Tpal_Id = T1.Tpmo_AlmacenOrigenId) WHERE T1.Tipo_Codigo = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
