/*
               File: wwalm_ratificar_traslados_impl
        Description: Ratificar Traslados entre Centros de Costo
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:22:52.98
...
public final  class wwalm_ratificar_traslados_impl extends GXDataArea
{
   public wwalm_ratificar_traslados_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wwalm_ratificar_traslados_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wwalm_ratificar_traslados_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            nRC_GXsfl_138 = (short)(GXutil.lval( httpContext.GetNextPar( ))) ;
            nGXsfl_138_idx = (short)(GXutil.lval( httpContext.GetNextPar( ))) ;
            sGXsfl_138_idx = httpContext.GetNextPar( ) ;
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
         {
            ...
            AV44Pgmname = httpContext.GetNextPar( ) ;
            ...
            gxgrgrid_refresh( subGrid_Rows, AV27Tran_ConsecutivoCC, AV26Tran_CodigoMovimiento, AV29Tran_DescripcionMovimiento, AV30Tran_FechaRegistro, AV34Tran_Observaciones, AV33Tran_NombreIngreso, AV32Tran_IdProveedor, AV21Proveedor, AV31Tran_IdCuentadanteDestino, AV12Cuentadante, AV24Tran_AreadanteCodigo, AV28Tran_CursoCodigo, AV35Tran_TipoIngreso, AV38Update, AV8ADVANCED_LABEL_TEMPLATE, AV44Pgmname, A50Tran_CentroCostoIdDestino, A48Tran_CentroCostoId, A23Usua_Id, A1Cent_Id, AV39Usua_Id, AV5Tran_CentroCostoId) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414225338");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.wwalm_ratificar_traslados") +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      /* Send saved values. */
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "nRC_GXsfl_138", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_138, (byte)(4), (byte)(0), ",", "")));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV44Pgmname));
   ...
   {
      return formatLink("com.orions2.wwalm_ratificar_traslados")  ;
   }

   public String getPgmname( )
   {
      return "WWALM_RATIFICAR_TRASLADOS" ;
   }

   public String getPgmdesc( )
   {
      return "Ratificar Traslados entre Centros de Costo" ;
   }
   ...
   public void wb7X0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 138, 3, 0)+","+"null"+");", bttBtntoggle_Caption, bttBtntoggle_Jsonclick, 7, "Otros Filtros", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e117x1_client"+"'", TempTags, "", 2, "HLP_WWALM_RATIFICAR_TRASLADOS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-6 col-sm-2", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblTitletext_Internalname, "Ratificar Traslados", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_WWALM_RATIFICAR_TRASLADOS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_codigomovimientofilter_Internalname, lblLbltran_codigomovimientofilter_Caption, "", "", lblLbltran_codigomovimientofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e127x1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WWALM_RATIFICAR_TRASLADOS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_descripcionmovimientofilter_Internalname, lblLbltran_descripcionmovimientofilter_Caption, "", "", lblLbltran_descripcionmovimientofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e137x1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WWALM_RATIFICAR_TRASLADOS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavTran_descripcionmovimiento_Internalname, AV29Tran_DescripcionMovimiento, GXutil.rtrim( localUtil.format( AV29Tran_DescripcionMovimiento, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTran_descripcionmovimiento_Jsonclick, 0, "FilterComboAttribute", "", "", "", edtavTran_descripcionmovimiento_Visible, edtavTran_descripcionmovimiento_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_WWALM_RATIFICAR_TRASLADOS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_fecharegistrofilter_Internalname, lblLbltran_fecharegistrofilter_Caption, "", "", lblLbltran_fecharegistrofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e147x1_client"+"'", "", "WWAdvancedLabel WWDateFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WWALM_RATIFICAR_TRASLADOS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 49,'',false,'" + sGXsfl_138_idx + "',0)\"" ;
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavTran_fecharegistro_Internalname, localUtil.format(AV30Tran_FechaRegistro, "99/99/99"), localUtil.format( AV30Tran_FechaRegistro, "99/99/99"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,49);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTran_fecharegistro_Jsonclick, 0, "FilterComboAttribute", "", "", "", 1, edtavTran_fecharegistro_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Fecha", "right", false, "HLP_WWALM_RATIFICAR_TRASLADOS.htm");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_observacionesfilter_Internalname, lblLbltran_observacionesfilter_Caption, "", "", lblLbltran_observacionesfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e157x1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WWALM_RATIFICAR_TRASLADOS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         ClassString = "FilterComboAttribute" ;
         StyleString = "" ;
         com.orions2.GxWebStd.gx_html_textarea( httpContext, edtavTran_observaciones_Internalname, AV34Tran_Observaciones, "", TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,59);\"", (short)(0), edtavTran_observaciones_Visible, edtavTran_observaciones_Enabled, 0, 80, "chr", 10, "row", StyleString, ClassString, "", "2097152", -1, 0, "", "", (byte)(-1), true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_WWALM_RATIFICAR_TRASLADOS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 ViewAdvancedBarCell", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_tipoingresofilter_Internalname, lblLbltran_tipoingresofilter_Caption, "", "", lblLbltran_tipoingresofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e167x1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WWALM_RATIFICAR_TRASLADOS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 69,'',false,'" + sGXsfl_138_idx + "',0)\"" ;
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavTran_nombreingreso_Internalname, AV33Tran_NombreIngreso, GXutil.rtrim( localUtil.format( AV33Tran_NombreIngreso, "@!")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,69);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTran_nombreingreso_Jsonclick, 0, "FilterComboAttribute", "", "", "", edtavTran_nombreingreso_Visible, edtavTran_nombreingreso_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_WWALM_RATIFICAR_TRASLADOS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_idproveedorfilter_Internalname, lblLbltran_idproveedorfilter_Caption, "", "", lblLbltran_idproveedorfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e177x1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WWALM_RATIFICAR_TRASLADOS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 79,'',false,'" + sGXsfl_138_idx + "',0)\"" ;
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavTran_idproveedor_Internalname, GXutil.ltrim( localUtil.ntoc( AV32Tran_IdProveedor, (byte)(18), (byte)(0), ",", "")), ((edtavTran_idproveedor_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV32Tran_IdProveedor), "ZZZZZZZZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV32Tran_IdProveedor), "ZZZZZZZZZZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,79);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTran_idproveedor_Jsonclick, 0, "FilterComboAttribute", "", "", "", edtavTran_idproveedor_Visible, edtavTran_idproveedor_Enabled, 0, "text", "", 18, "chr", 1, "row", 18, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "HLP_WWALM_RATIFICAR_TRASLADOS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_nombreproveedorfilter_Internalname, lblLbltran_nombreproveedorfilter_Caption, "", "", lblLbltran_nombreproveedorfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e187x1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WWALM_RATIFICAR_TRASLADOS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 89,'',false,'" + sGXsfl_138_idx + "',0)\"" ;
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavProveedor_Internalname, AV21Proveedor, GXutil.rtrim( localUtil.format( AV21Proveedor, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,89);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavProveedor_Jsonclick, 0, "FilterComboAttribute", "", "", "", edtavProveedor_Visible, edtavProveedor_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "Nombres", "left", true, "HLP_WWALM_RATIFICAR_TRASLADOS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_idcuentadantedestinofilter_Internalname, lblLbltran_idcuentadantedestinofilter_Caption, "", "", lblLbltran_idcuentadantedestinofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e197x1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WWALM_RATIFICAR_TRASLADOS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavTran_idcuentadantedestino_Internalname, GXutil.ltrim( localUtil.ntoc( AV31Tran_IdCuentadanteDestino, (byte)(18), (byte)(0), ",", "")), ((edtavTran_idcuentadantedestino_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV31Tran_IdCuentadanteDestino), "ZZZZZZZZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV31Tran_IdCuentadanteDestino), "ZZZZZZZZZZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,99);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTran_idcuentadantedestino_Jsonclick, 0, "FilterComboAttribute", "", "", "", edtavTran_idcuentadantedestino_Visible, edtavTran_idcuentadantedestino_Enabled, 0, "text", "", 18, "chr", 1, "row", 18, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "HLP_WWALM_RATIFICAR_TRASLADOS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_nombrecuentadantefilter_Internalname, lblLbltran_nombrecuentadantefilter_Caption, "", "", lblLbltran_nombrecuentadantefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e207x1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WWALM_RATIFICAR_TRASLADOS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 109,'',false,'" + sGXsfl_138_idx + "',0)\"" ;
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavCuentadante_Internalname, AV12Cuentadante, GXutil.rtrim( localUtil.format( AV12Cuentadante, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,109);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCuentadante_Jsonclick, 0, "FilterComboAttribute", "", "", "", edtavCuentadante_Visible, edtavCuentadante_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "Nombres", "left", true, "HLP_WWALM_RATIFICAR_TRASLADOS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_areadantecodigofilter_Internalname, lblLbltran_areadantecodigofilter_Caption, "", "", lblLbltran_areadantecodigofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e217x1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WWALM_RATIFICAR_TRASLADOS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 119,'',false,'" + sGXsfl_138_idx + "',0)\"" ;
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavTran_areadantecodigo_Internalname, AV24Tran_AreadanteCodigo, GXutil.rtrim( localUtil.format( AV24Tran_AreadanteCodigo, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,119);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTran_areadantecodigo_Jsonclick, 0, "FilterComboAttribute", "", "", "", edtavTran_areadantecodigo_Visible, edtavTran_areadantecodigo_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_WWALM_RATIFICAR_TRASLADOS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_cursocodigofilter_Internalname, lblLbltran_cursocodigofilter_Caption, "", "", lblLbltran_cursocodigofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e227x1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WWALM_RATIFICAR_TRASLADOS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 129,'',false,'" + sGXsfl_138_idx + "',0)\"" ;
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavTran_cursocodigo_Internalname, AV28Tran_CursoCodigo, GXutil.rtrim( localUtil.format( AV28Tran_CursoCodigo, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,129);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTran_cursocodigo_Jsonclick, 0, "FilterComboAttribute", "", "", "", edtavTran_cursocodigo_Visible, edtavTran_cursocodigo_Enabled, 0, "text", "", 41, "chr", 1, "row", 41, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_WWALM_RATIFICAR_TRASLADOS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
      ...
      {
         wbEnd = (short)(0) ;
         nRC_GXsfl_138 = (short)(nGXsfl_138_idx-1) ;
         if ( GridContainer.GetWrapped() == 1 )
         {
   ...
   public void start7X2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Ratificar Traslados entre Centros de Costo", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
               ...
               if ( GXutil.strcmp(sEvtType, "M") != 0 )
               {
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        {
                           nGXsfl_138_idx = (short)(GXutil.lval( sEvtType)) ;
                           sGXsfl_138_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_138_idx, 4, 0)), (short)(4), "0") ;
                           subsflControlProps_1382( ) ;
                           AV38Update = httpContext.cgiGet( edtavUpdate_Internalname) ;
                           httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Bitmap", ((GXutil.strcmp("", AV38Update)==0) ? AV45Update_GXI : httpContext.convertURL( httpContext.getResourceRelative(AV38Update))), !bGXsfl_138_Refreshing);
   ...
   public void pa7X2( )
   {
      if ( nDonePA == 0 )
      {
         ...
         GXCCtl = "TRAN_ESTADO_" + sGXsfl_138_idx ;
         ...
         GXCCtl = "TRAN_INDE_S_" + sGXsfl_138_idx ;
         ...
         GXCCtl = "TRAN_TIPOELEMENTO_" + sGXsfl_138_idx ;
         ...
         GXCCtl = "TRAN_TIPOENTRA_" + sGXsfl_138_idx ;
   ...
   public void gxnrgrid_newrow( )
   {
      ...
      {
         sendrow_1382( ) ;
         nGXsfl_138_idx = (short)(((subGrid_Islastpage==1)&&(nGXsfl_138_idx+1>subgrid_recordsperpage( )) ? 1 : nGXsfl_138_idx+1)) ;
         sGXsfl_138_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_138_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_1382( ) ;
      }
   ...
   {
      /* GeneXus formulas. */
      AV44Pgmname = "WWALM_RATIFICAR_TRASLADOS" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf7X2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              A58Tran_Estado } ,
                                              new int[]{
                                              TypeConstants.LONG, TypeConstants.STRING, TypeConstants.LONG, TypeConstants.LONG, TypeConstants.LONG, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.LONG, TypeConstants.BOOLEAN, TypeConstants.STRING,
                                              TypeConstants.LONG, TypeConstants.BOOLEAN, TypeConstants.LONG, TypeConstants.BOOLEAN, TypeConstants.LONG, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.BOOLEAN,
                                              TypeConstants.STRING, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.DATE, TypeConstants.DATE, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.STRING,
                                              TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.BOOLEAN
                                              }
         } ) ;
         ...
         /* Using cursor H007X2 */
         pr_default.execute(0, new Object[] {new Long(AV27Tran_ConsecutivoCC), lV26Tran_CodigoMovimiento, new Long(AV35Tran_TipoIngreso), new Long(AV32Tran_IdProveedor), new Long(AV31Tran_IdCuentadanteDestino), AV24Tran_AreadanteCodigo, AV28Tran_CursoCodigo});
         nGXsfl_138_idx = (short)(1) ;
         sGXsfl_138_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_138_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_1382( ) ;
         GRID_nEOF = (byte)(0) ;
         ...
         {
            brk7X2 = false ;
            A416Tran_Observaciones = H007X2_A416Tran_Observaciones[0] ;
            n416Tran_Observaciones = H007X2_n416Tran_Observaciones[0] ;
            A513Tran_ConsecutivoCC = H007X2_A513Tran_ConsecutivoCC[0] ;
            n513Tran_ConsecutivoCC = H007X2_n513Tran_ConsecutivoCC[0] ;
            A49Tran_CodigoMovimiento = H007X2_A49Tran_CodigoMovimiento[0] ;
            A381Tran_DescripcionMovimiento = H007X2_A381Tran_DescripcionMovimiento[0] ;
            n381Tran_DescripcionMovimiento = H007X2_n381Tran_DescripcionMovimiento[0] ;
            A55Tran_FechaRegistro = H007X2_A55Tran_FechaRegistro[0] ;
            A54Tran_TipoIngreso = H007X2_A54Tran_TipoIngreso[0] ;
            n54Tran_TipoIngreso = H007X2_n54Tran_TipoIngreso[0] ;
            A53Tran_IdProveedor = H007X2_A53Tran_IdProveedor[0] ;
            n53Tran_IdProveedor = H007X2_n53Tran_IdProveedor[0] ;
            A52Tran_IdCuentadanteDestino = H007X2_A52Tran_IdCuentadanteDestino[0] ;
            n52Tran_IdCuentadanteDestino = H007X2_n52Tran_IdCuentadanteDestino[0] ;
            A407Tran_AreadanteCodigo = H007X2_A407Tran_AreadanteCodigo[0] ;
            n407Tran_AreadanteCodigo = H007X2_n407Tran_AreadanteCodigo[0] ;
            A408Tran_CursoCodigo = H007X2_A408Tran_CursoCodigo[0] ;
            n408Tran_CursoCodigo = H007X2_n408Tran_CursoCodigo[0] ;
            A575Tran_NombreProveedor = H007X2_A575Tran_NombreProveedor[0] ;
            n575Tran_NombreProveedor = H007X2_n575Tran_NombreProveedor[0] ;
            A389Tran_NombCuentadanteDestino = H007X2_A389Tran_NombCuentadanteDestino[0] ;
            n389Tran_NombCuentadanteDestino = H007X2_n389Tran_NombCuentadanteDestino[0] ;
            A672Tran_NombreIngreso = H007X2_A672Tran_NombreIngreso[0] ;
            n672Tran_NombreIngreso = H007X2_n672Tran_NombreIngreso[0] ;
            A58Tran_Estado = H007X2_A58Tran_Estado[0] ;
            n58Tran_Estado = H007X2_n58Tran_Estado[0] ;
            A50Tran_CentroCostoIdDestino = H007X2_A50Tran_CentroCostoIdDestino[0] ;
            n50Tran_CentroCostoIdDestino = H007X2_n50Tran_CentroCostoIdDestino[0] ;
            A48Tran_CentroCostoId = H007X2_A48Tran_CentroCostoId[0] ;
            A667Tran_NumeroGrupo = H007X2_A667Tran_NumeroGrupo[0] ;
            n667Tran_NumeroGrupo = H007X2_n667Tran_NumeroGrupo[0] ;
            A524Tran_Detalle = H007X2_A524Tran_Detalle[0] ;
            n524Tran_Detalle = H007X2_n524Tran_Detalle[0] ;
            A608Tran_RegionAbrevDestino = H007X2_A608Tran_RegionAbrevDestino[0] ;
            n608Tran_RegionAbrevDestino = H007X2_n608Tran_RegionAbrevDestino[0] ;
            A594Tran_RegionAbrev = H007X2_A594Tran_RegionAbrev[0] ;
            n594Tran_RegionAbrev = H007X2_n594Tran_RegionAbrev[0] ;
            A568Tran_CantidadPadres = H007X2_A568Tran_CantidadPadres[0] ;
            n568Tran_CantidadPadres = H007X2_n568Tran_CantidadPadres[0] ;
            A527Tran_TipoEntra = H007X2_A527Tran_TipoEntra[0] ;
            n527Tran_TipoEntra = H007X2_n527Tran_TipoEntra[0] ;
            A519Tran_RegionCodigoDestino = H007X2_A519Tran_RegionCodigoDestino[0] ;
            n519Tran_RegionCodigoDestino = H007X2_n519Tran_RegionCodigoDestino[0] ;
            A518Tran_RegionIdDestino = H007X2_A518Tran_RegionIdDestino[0] ;
            n518Tran_RegionIdDestino = H007X2_n518Tran_RegionIdDestino[0] ;
            A517Tran_CentroCostoDescripcionDes = H007X2_A517Tran_CentroCostoDescripcionDes[0] ;
            n517Tran_CentroCostoDescripcionDes = H007X2_n517Tran_CentroCostoDescripcionDes[0] ;
            A516Tran_CentroCostoCodigoDestino = H007X2_A516Tran_CentroCostoCodigoDestino[0] ;
            n516Tran_CentroCostoCodigoDestino = H007X2_n516Tran_CentroCostoCodigoDestino[0] ;
            A520Tran_RegionDescripcionDestino = H007X2_A520Tran_RegionDescripcionDestino[0] ;
            n520Tran_RegionDescripcionDestino = H007X2_n520Tran_RegionDescripcionDestino[0] ;
            A514Tran_NumeroIngreso = H007X2_A514Tran_NumeroIngreso[0] ;
            n514Tran_NumeroIngreso = H007X2_n514Tran_NumeroIngreso[0] ;
            A482Tran_TipoElemento = H007X2_A482Tran_TipoElemento[0] ;
            A499Tran_CodTipoElemento = H007X2_A499Tran_CodTipoElemento[0] ;
            n499Tran_CodTipoElemento = H007X2_n499Tran_CodTipoElemento[0] ;
            A483Tran_ValorTransaccion = H007X2_A483Tran_ValorTransaccion[0] ;
            n483Tran_ValorTransaccion = H007X2_n483Tran_ValorTransaccion[0] ;
            A481Tran_IndE_S = H007X2_A481Tran_IndE_S[0] ;
            n481Tran_IndE_S = H007X2_n481Tran_IndE_S[0] ;
            A421Tran_RegionCodigo = H007X2_A421Tran_RegionCodigo[0] ;
            n421Tran_RegionCodigo = H007X2_n421Tran_RegionCodigo[0] ;
            A57Tran_RegionId = H007X2_A57Tran_RegionId[0] ;
            n57Tran_RegionId = H007X2_n57Tran_RegionId[0] ;
            A420Tran_CentroCostoDescripcion = H007X2_A420Tran_CentroCostoDescripcion[0] ;
            n420Tran_CentroCostoDescripcion = H007X2_n420Tran_CentroCostoDescripcion[0] ;
            A418Tran_UsuarioNombre = H007X2_A418Tran_UsuarioNombre[0] ;
            n418Tran_UsuarioNombre = H007X2_n418Tran_UsuarioNombre[0] ;
            A417Tran_UsuarioCodigo = H007X2_A417Tran_UsuarioCodigo[0] ;
            n417Tran_UsuarioCodigo = H007X2_n417Tran_UsuarioCodigo[0] ;
            A47Tran_UsuarioId = H007X2_A47Tran_UsuarioId[0] ;
            n47Tran_UsuarioId = H007X2_n47Tran_UsuarioId[0] ;
            A391Tran_UsuarioRatifica = H007X2_A391Tran_UsuarioRatifica[0] ;
            n391Tran_UsuarioRatifica = H007X2_n391Tran_UsuarioRatifica[0] ;
            A390Tran_FechaRatificacion = H007X2_A390Tran_FechaRatificacion[0] ;
            n390Tran_FechaRatificacion = H007X2_n390Tran_FechaRatificacion[0] ;
            A46Tran_Id = H007X2_A46Tran_Id[0] ;
            A51Tran_IdCuentadanteOrigen = H007X2_A51Tran_IdCuentadanteOrigen[0] ;
            n51Tran_IdCuentadanteOrigen = H007X2_n51Tran_IdCuentadanteOrigen[0] ;
            A387Tran_CodBodeDestino = H007X2_A387Tran_CodBodeDestino[0] ;
            A111Tran_CodAlmaDestino = H007X2_A111Tran_CodAlmaDestino[0] ;
            A385Tran_ModuloDestino = H007X2_A385Tran_ModuloDestino[0] ;
            A112Tran_CodBodeOrigen = H007X2_A112Tran_CodBodeOrigen[0] ;
            A109Tran_CodAlmaOrigen = H007X2_A109Tran_CodAlmaOrigen[0] ;
            A110Tran_ModuloOrigen = H007X2_A110Tran_ModuloOrigen[0] ;
            A419Tran_CentroCostoCodigo = H007X2_A419Tran_CentroCostoCodigo[0] ;
            n419Tran_CentroCostoCodigo = H007X2_n419Tran_CentroCostoCodigo[0] ;
            A422Tran_RegionDescripcion = H007X2_A422Tran_RegionDescripcion[0] ;
            n422Tran_RegionDescripcion = H007X2_n422Tran_RegionDescripcion[0] ;
            A381Tran_DescripcionMovimiento = H007X2_A381Tran_DescripcionMovimiento[0] ;
            n381Tran_DescripcionMovimiento = H007X2_n381Tran_DescripcionMovimiento[0] ;
            A499Tran_CodTipoElemento = H007X2_A499Tran_CodTipoElemento[0] ;
            n499Tran_CodTipoElemento = H007X2_n499Tran_CodTipoElemento[0] ;
   ...
   public void strup7X0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         /* Read saved values. */
         nRC_GXsfl_138 = (short)(localUtil.ctol( httpContext.cgiGet( "nRC_GXsfl_138"), ",", ".")) ;
   ...
   {
      /* Start Routine */
      if ( ! new com.orions2.isauthorized(remoteHandle, context).executeUdp( AV44Pgmname) )
      {
         callWebObject(formatLink("com.orions2.notauthorized") + "?" + GXutil.URLEncode(GXutil.rtrim(AV44Pgmname)));
      ...
      httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Bitmap", ((GXutil.strcmp("", AV38Update)==0) ? AV45Update_GXI : httpContext.convertURL( httpContext.getResourceRelative(AV38Update))), !bGXsfl_138_Refreshing);
      httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( AV38Update), true);
      AV45Update_GXI = GXDbFile.pathToUrl( context.getHttpContext().getImagePath( "7c63c2b9-483e-4035-b512-febf9186a274", "", context.getHttpContext().getTheme( )), context.getHttpContext()) ;
      httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Bitmap", ((GXutil.strcmp("", AV38Update)==0) ? AV45Update_GXI : httpContext.convertURL( httpContext.getResourceRelative(AV38Update))), !bGXsfl_138_Refreshing);
      httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( AV38Update), true);
      ...
      Form.setCaption( "Ratificar Traslados entre Centros de Costo" );
   ...
   private void e257X2( )
   {
      ...
      GRID_nEOF = (byte)(0) ;
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "GRID_nEOF", GXutil.ltrim( localUtil.ntoc( GRID_nEOF, (byte)(1), (byte)(0), ".", "")));
      while ( ( (pr_default.getStatus(0) != 101) && GXutil.dateCompare(H007X2_A55Tran_FechaRegistro[0], A55Tran_FechaRegistro) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < GRID_nFirstRecordOnPage + subgrid_recordsperpage( ) ) ) ) )
      {
         brk7X2 = false ;
         A416Tran_Observaciones = H007X2_A416Tran_Observaciones[0] ;
         n416Tran_Observaciones = H007X2_n416Tran_Observaciones[0] ;
   ...
   public void S122( )
   {
      ...
      {
         AV15GridState.fromxml(AV22Session.getValue(AV44Pgmname+"GridState"), null, null);
   ...
   public void S132( )
   {
      ...
      AV15GridState.getgxTv_SdtGridState_Filtervalues().add(AV16GridStateFilterValue, 0);
      AV22Session.setValue(AV44Pgmname+"GridState", AV15GridState.toxml(false, true, "GridState", "ACBSENA"));
   }
   ...
   public void S112( )
   {
      ...
      AV36TrnContext.setgxTv_SdtTransactionContext_Callerobject( AV44Pgmname );
   ...
   public void S143( )
   {
      ...
      {
         A1Cent_Id = H007X3_A1Cent_Id[0] ;
         A23Usua_Id = H007X3_A23Usua_Id[0] ;
         AV7Acceso = "SI" ;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20186141423044");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("wwalm_ratificar_traslados.js", "?20186141423044");
      httpContext.AddJavascriptSource("Shared/jquery/jquery-1.9.0.js", "");
      httpContext.AddJavascriptSource("Alertify/js/alertify.min.js", "");
      httpContext.AddJavascriptSource("Alertify/GlobalAlerts.js", "");
      httpContext.AddJavascriptSource("Alertify/AlertifyRender.js", "");
   ...
   {
      edtavUpdate_Internalname = "vUPDATE_"+sGXsfl_138_idx ;
      edtTran_ConsecutivoCC_Internalname = "TRAN_CONSECUTIVOCC_"+sGXsfl_138_idx ;
      edtTran_CodigoMovimiento_Internalname = "TRAN_CODIGOMOVIMIENTO_"+sGXsfl_138_idx ;
      edtTran_DescripcionMovimiento_Internalname = "TRAN_DESCRIPCIONMOVIMIENTO_"+sGXsfl_138_idx ;
      edtTran_RegionDescripcion_Internalname = "TRAN_REGIONDESCRIPCION_"+sGXsfl_138_idx ;
      edtTran_CentroCostoCodigo_Internalname = "TRAN_CENTROCOSTOCODIGO_"+sGXsfl_138_idx ;
      edtTran_ModuloOrigen_Internalname = "TRAN_MODULOORIGEN_"+sGXsfl_138_idx ;
      edtTran_CodAlmaOrigen_Internalname = "TRAN_CODALMAORIGEN_"+sGXsfl_138_idx ;
      edtTran_CodBodeOrigen_Internalname = "TRAN_CODBODEORIGEN_"+sGXsfl_138_idx ;
      edtTran_ModuloDestino_Internalname = "TRAN_MODULODESTINO_"+sGXsfl_138_idx ;
      edtTran_CodAlmaDestino_Internalname = "TRAN_CODALMADESTINO_"+sGXsfl_138_idx ;
      edtTran_CodBodeDestino_Internalname = "TRAN_CODBODEDESTINO_"+sGXsfl_138_idx ;
      edtTran_FechaRegistro_Internalname = "TRAN_FECHAREGISTRO_"+sGXsfl_138_idx ;
      edtTran_IdProveedor_Internalname = "TRAN_IDPROVEEDOR_"+sGXsfl_138_idx ;
      edtTran_NombreProveedor_Internalname = "TRAN_NOMBREPROVEEDOR_"+sGXsfl_138_idx ;
      edtTran_IdCuentadanteDestino_Internalname = "TRAN_IDCUENTADANTEDESTINO_"+sGXsfl_138_idx ;
      edtTran_NombCuentadanteDestino_Internalname = "TRAN_NOMBCUENTADANTEDESTINO_"+sGXsfl_138_idx ;
      edtTran_Observaciones_Internalname = "TRAN_OBSERVACIONES_"+sGXsfl_138_idx ;
      edtTran_AreadanteCodigo_Internalname = "TRAN_AREADANTECODIGO_"+sGXsfl_138_idx ;
      edtTran_CursoCodigo_Internalname = "TRAN_CURSOCODIGO_"+sGXsfl_138_idx ;
      edtTran_NombreIngreso_Internalname = "TRAN_NOMBREINGRESO_"+sGXsfl_138_idx ;
      cmbTran_Estado.setInternalname( "TRAN_ESTADO_"+sGXsfl_138_idx );
      edtTran_IdCuentadanteOrigen_Internalname = "TRAN_IDCUENTADANTEORIGEN_"+sGXsfl_138_idx ;
      edtTran_Id_Internalname = "TRAN_ID_"+sGXsfl_138_idx ;
      edtTran_FechaRatificacion_Internalname = "TRAN_FECHARATIFICACION_"+sGXsfl_138_idx ;
      edtTran_UsuarioRatifica_Internalname = "TRAN_USUARIORATIFICA_"+sGXsfl_138_idx ;
      edtTran_UsuarioId_Internalname = "TRAN_USUARIOID_"+sGXsfl_138_idx ;
      edtTran_UsuarioCodigo_Internalname = "TRAN_USUARIOCODIGO_"+sGXsfl_138_idx ;
      edtTran_UsuarioNombre_Internalname = "TRAN_USUARIONOMBRE_"+sGXsfl_138_idx ;
      edtTran_CentroCostoId_Internalname = "TRAN_CENTROCOSTOID_"+sGXsfl_138_idx ;
      edtTran_CentroCostoDescripcion_Internalname = "TRAN_CENTROCOSTODESCRIPCION_"+sGXsfl_138_idx ;
      edtTran_RegionId_Internalname = "TRAN_REGIONID_"+sGXsfl_138_idx ;
      edtTran_RegionCodigo_Internalname = "TRAN_REGIONCODIGO_"+sGXsfl_138_idx ;
      cmbTran_IndE_S.setInternalname( "TRAN_INDE_S_"+sGXsfl_138_idx );
      edtTran_ValorTransaccion_Internalname = "TRAN_VALORTRANSACCION_"+sGXsfl_138_idx ;
      edtTran_CodTipoElemento_Internalname = "TRAN_CODTIPOELEMENTO_"+sGXsfl_138_idx ;
      cmbTran_TipoElemento.setInternalname( "TRAN_TIPOELEMENTO_"+sGXsfl_138_idx );
      edtTran_NumeroIngreso_Internalname = "TRAN_NUMEROINGRESO_"+sGXsfl_138_idx ;
      edtTran_RegionDescripcionDestino_Internalname = "TRAN_REGIONDESCRIPCIONDESTINO_"+sGXsfl_138_idx ;
      edtTran_CentroCostoIdDestino_Internalname = "TRAN_CENTROCOSTOIDDESTINO_"+sGXsfl_138_idx ;
      edtTran_CentroCostoCodigoDestino_Internalname = "TRAN_CENTROCOSTOCODIGODESTINO_"+sGXsfl_138_idx ;
      edtTran_CentroCostoDescripcionDes_Internalname = "TRAN_CENTROCOSTODESCRIPCIONDES_"+sGXsfl_138_idx ;
      edtTran_RegionIdDestino_Internalname = "TRAN_REGIONIDDESTINO_"+sGXsfl_138_idx ;
      edtTran_RegionCodigoDestino_Internalname = "TRAN_REGIONCODIGODESTINO_"+sGXsfl_138_idx ;
      cmbTran_TipoEntra.setInternalname( "TRAN_TIPOENTRA_"+sGXsfl_138_idx );
      edtTran_CantidadPadres_Internalname = "TRAN_CANTIDADPADRES_"+sGXsfl_138_idx ;
      edtTran_RegionAbrev_Internalname = "TRAN_REGIONABREV_"+sGXsfl_138_idx ;
      edtTran_RegionAbrevDestino_Internalname = "TRAN_REGIONABREVDESTINO_"+sGXsfl_138_idx ;
      edtTran_Detalle_Internalname = "TRAN_DETALLE_"+sGXsfl_138_idx ;
      edtTran_NumeroGrupo_Internalname = "TRAN_NUMEROGRUPO_"+sGXsfl_138_idx ;
   }

   public void subsflControlProps_fel_1382( )
   {
      edtavUpdate_Internalname = "vUPDATE_"+sGXsfl_138_fel_idx ;
      edtTran_ConsecutivoCC_Internalname = "TRAN_CONSECUTIVOCC_"+sGXsfl_138_fel_idx ;
      edtTran_CodigoMovimiento_Internalname = "TRAN_CODIGOMOVIMIENTO_"+sGXsfl_138_fel_idx ;
      edtTran_DescripcionMovimiento_Internalname = "TRAN_DESCRIPCIONMOVIMIENTO_"+sGXsfl_138_fel_idx ;
      edtTran_RegionDescripcion_Internalname = "TRAN_REGIONDESCRIPCION_"+sGXsfl_138_fel_idx ;
      edtTran_CentroCostoCodigo_Internalname = "TRAN_CENTROCOSTOCODIGO_"+sGXsfl_138_fel_idx ;
      edtTran_ModuloOrigen_Internalname = "TRAN_MODULOORIGEN_"+sGXsfl_138_fel_idx ;
      edtTran_CodAlmaOrigen_Internalname = "TRAN_CODALMAORIGEN_"+sGXsfl_138_fel_idx ;
      edtTran_CodBodeOrigen_Internalname = "TRAN_CODBODEORIGEN_"+sGXsfl_138_fel_idx ;
      edtTran_ModuloDestino_Internalname = "TRAN_MODULODESTINO_"+sGXsfl_138_fel_idx ;
      edtTran_CodAlmaDestino_Internalname = "TRAN_CODALMADESTINO_"+sGXsfl_138_fel_idx ;
      edtTran_CodBodeDestino_Internalname = "TRAN_CODBODEDESTINO_"+sGXsfl_138_fel_idx ;
      edtTran_FechaRegistro_Internalname = "TRAN_FECHAREGISTRO_"+sGXsfl_138_fel_idx ;
      edtTran_IdProveedor_Internalname = "TRAN_IDPROVEEDOR_"+sGXsfl_138_fel_idx ;
      edtTran_NombreProveedor_Internalname = "TRAN_NOMBREPROVEEDOR_"+sGXsfl_138_fel_idx ;
      edtTran_IdCuentadanteDestino_Internalname = "TRAN_IDCUENTADANTEDESTINO_"+sGXsfl_138_fel_idx ;
      edtTran_NombCuentadanteDestino_Internalname = "TRAN_NOMBCUENTADANTEDESTINO_"+sGXsfl_138_fel_idx ;
      edtTran_Observaciones_Internalname = "TRAN_OBSERVACIONES_"+sGXsfl_138_fel_idx ;
      edtTran_AreadanteCodigo_Internalname = "TRAN_AREADANTECODIGO_"+sGXsfl_138_fel_idx ;
      edtTran_CursoCodigo_Internalname = "TRAN_CURSOCODIGO_"+sGXsfl_138_fel_idx ;
      edtTran_NombreIngreso_Internalname = "TRAN_NOMBREINGRESO_"+sGXsfl_138_fel_idx ;
      cmbTran_Estado.setInternalname( "TRAN_ESTADO_"+sGXsfl_138_fel_idx );
      edtTran_IdCuentadanteOrigen_Internalname = "TRAN_IDCUENTADANTEORIGEN_"+sGXsfl_138_fel_idx ;
      edtTran_Id_Internalname = "TRAN_ID_"+sGXsfl_138_fel_idx ;
      edtTran_FechaRatificacion_Internalname = "TRAN_FECHARATIFICACION_"+sGXsfl_138_fel_idx ;
      edtTran_UsuarioRatifica_Internalname = "TRAN_USUARIORATIFICA_"+sGXsfl_138_fel_idx ;
      edtTran_UsuarioId_Internalname = "TRAN_USUARIOID_"+sGXsfl_138_fel_idx ;
      edtTran_UsuarioCodigo_Internalname = "TRAN_USUARIOCODIGO_"+sGXsfl_138_fel_idx ;
      edtTran_UsuarioNombre_Internalname = "TRAN_USUARIONOMBRE_"+sGXsfl_138_fel_idx ;
      edtTran_CentroCostoId_Internalname = "TRAN_CENTROCOSTOID_"+sGXsfl_138_fel_idx ;
      edtTran_CentroCostoDescripcion_Internalname = "TRAN_CENTROCOSTODESCRIPCION_"+sGXsfl_138_fel_idx ;
      edtTran_RegionId_Internalname = "TRAN_REGIONID_"+sGXsfl_138_fel_idx ;
      edtTran_RegionCodigo_Internalname = "TRAN_REGIONCODIGO_"+sGXsfl_138_fel_idx ;
      cmbTran_IndE_S.setInternalname( "TRAN_INDE_S_"+sGXsfl_138_fel_idx );
      edtTran_ValorTransaccion_Internalname = "TRAN_VALORTRANSACCION_"+sGXsfl_138_fel_idx ;
      edtTran_CodTipoElemento_Internalname = "TRAN_CODTIPOELEMENTO_"+sGXsfl_138_fel_idx ;
      cmbTran_TipoElemento.setInternalname( "TRAN_TIPOELEMENTO_"+sGXsfl_138_fel_idx );
      edtTran_NumeroIngreso_Internalname = "TRAN_NUMEROINGRESO_"+sGXsfl_138_fel_idx ;
      edtTran_RegionDescripcionDestino_Internalname = "TRAN_REGIONDESCRIPCIONDESTINO_"+sGXsfl_138_fel_idx ;
      edtTran_CentroCostoIdDestino_Internalname = "TRAN_CENTROCOSTOIDDESTINO_"+sGXsfl_138_fel_idx ;
      edtTran_CentroCostoCodigoDestino_Internalname = "TRAN_CENTROCOSTOCODIGODESTINO_"+sGXsfl_138_fel_idx ;
      edtTran_CentroCostoDescripcionDes_Internalname = "TRAN_CENTROCOSTODESCRIPCIONDES_"+sGXsfl_138_fel_idx ;
      edtTran_RegionIdDestino_Internalname = "TRAN_REGIONIDDESTINO_"+sGXsfl_138_fel_idx ;
      edtTran_RegionCodigoDestino_Internalname = "TRAN_REGIONCODIGODESTINO_"+sGXsfl_138_fel_idx ;
      cmbTran_TipoEntra.setInternalname( "TRAN_TIPOENTRA_"+sGXsfl_138_fel_idx );
      edtTran_CantidadPadres_Internalname = "TRAN_CANTIDADPADRES_"+sGXsfl_138_fel_idx ;
      edtTran_RegionAbrev_Internalname = "TRAN_REGIONABREV_"+sGXsfl_138_fel_idx ;
      edtTran_RegionAbrevDestino_Internalname = "TRAN_REGIONABREVDESTINO_"+sGXsfl_138_fel_idx ;
      edtTran_Detalle_Internalname = "TRAN_DETALLE_"+sGXsfl_138_fel_idx ;
      edtTran_NumeroGrupo_Internalname = "TRAN_NUMEROGRUPO_"+sGXsfl_138_fel_idx ;
   }
   ...
   public void sendrow_1382( )
   {
      subsflControlProps_1382( ) ;
      wb7X0( ) ;
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_138_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_CodigoMovimiento_Internalname,A49Tran_CodigoMovimiento,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_CodigoMovimiento_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(70),"px",new Integer(17),"px",new Integer(3),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_DescripcionMovimiento_Internalname,A381Tran_DescripcionMovimiento,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_DescripcionMovimiento_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(100),"px",new Integer(17),"px",new Integer(100),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_RegionDescripcion_Internalname,A422Tran_RegionDescripcion,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_RegionDescripcion_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(100),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_CentroCostoCodigo_Internalname,A419Tran_CentroCostoCodigo,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_CentroCostoCodigo_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(106),"px",new Integer(17),"px",new Integer(16),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_ModuloOrigen_Internalname,A110Tran_ModuloOrigen,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_ModuloOrigen_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(114),"px",new Integer(17),"px",new Integer(8),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Modulo","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_CodAlmaOrigen_Internalname,A109Tran_CodAlmaOrigen,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_CodAlmaOrigen_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(150),"px",new Integer(17),"px",new Integer(2),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_CodBodeOrigen_Internalname,A112Tran_CodBodeOrigen,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_CodBodeOrigen_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(150),"px",new Integer(17),"px",new Integer(3),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_ModuloDestino_Internalname,A385Tran_ModuloDestino,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_ModuloDestino_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(114),"px",new Integer(17),"px",new Integer(8),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Modulo","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_CodBodeDestino_Internalname,A387Tran_CodBodeDestino,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_CodBodeDestino_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(150),"px",new Integer(17),"px",new Integer(3),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_FechaRegistro_Internalname,localUtil.ttoc( A55Tran_FechaRegistro, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A55Tran_FechaRegistro, "99/99/99 99:99"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_FechaRegistro_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(122),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_NombreProveedor_Internalname,A575Tran_NombreProveedor,GXutil.rtrim( localUtil.format( A575Tran_NombreProveedor, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_NombreProveedor_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(80),"px",new Integer(17),"px",new Integer(100),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Nombres","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_NombCuentadanteDestino_Internalname,A389Tran_NombCuentadanteDestino,GXutil.rtrim( localUtil.format( A389Tran_NombCuentadanteDestino, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_NombCuentadanteDestino_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(130),"px",new Integer(17),"px",new Integer(100),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Nombres","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_Observaciones_Internalname,A416Tran_Observaciones,A416Tran_Observaciones,"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_Observaciones_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(150),"px",new Integer(17),"px",new Integer(2097152),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(0),new Integer(-1),new Boolean(true),"","left",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_AreadanteCodigo_Internalname,A407Tran_AreadanteCodigo,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_AreadanteCodigo_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(130),"px",new Integer(17),"px",new Integer(20),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_CursoCodigo_Internalname,A408Tran_CursoCodigo,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_CursoCodigo_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(256),"px",new Integer(17),"px",new Integer(41),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_NombreIngreso_Internalname,A672Tran_NombreIngreso,GXutil.rtrim( localUtil.format( A672Tran_NombreIngreso, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_NombreIngreso_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(90),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         }
         if ( ( nGXsfl_138_idx == 1 ) && isAjaxCallMode( ) )
         {
            GXCCtl = "TRAN_ESTADO_" + sGXsfl_138_idx ;
            cmbTran_Estado.setName( GXCCtl );
            cmbTran_Estado.setWebtags( "" );
         ...
         httpContext.ajax_rsp_assign_prop("", false, cmbTran_Estado.getInternalname(), "Values", cmbTran_Estado.ToJavascriptSource(), !bGXsfl_138_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_Id_Internalname,GXutil.ltrim( localUtil.ntoc( A46Tran_Id, (byte)(11), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A46Tran_Id), "ZZZZZZZZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_Id_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(11),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"Identificador","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_FechaRatificacion_Internalname,localUtil.ttoc( A390Tran_FechaRatificacion, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A390Tran_FechaRatificacion, "99/99/9999 99:99"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_FechaRatificacion_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(16),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_UsuarioRatifica_Internalname,A391Tran_UsuarioRatifica,GXutil.rtrim( localUtil.format( A391Tran_UsuarioRatifica, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_UsuarioRatifica_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_UsuarioCodigo_Internalname,A417Tran_UsuarioCodigo,GXutil.rtrim( localUtil.format( A417Tran_UsuarioCodigo, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_UsuarioCodigo_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_UsuarioNombre_Internalname,A418Tran_UsuarioNombre,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_UsuarioNombre_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(100),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Nombres","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_CentroCostoId_Internalname,GXutil.ltrim( localUtil.ntoc( A48Tran_CentroCostoId, (byte)(11), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A48Tran_CentroCostoId), "ZZZZZZZZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_CentroCostoId_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(11),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"Identificador","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_CentroCostoDescripcion_Internalname,A420Tran_CentroCostoDescripcion,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_CentroCostoDescripcion_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_RegionId_Internalname,GXutil.ltrim( localUtil.ntoc( A57Tran_RegionId, (byte)(11), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A57Tran_RegionId), "ZZZZZZZZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_RegionId_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(11),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"Identificador","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_RegionCodigo_Internalname,GXutil.ltrim( localUtil.ntoc( A421Tran_RegionCodigo, (byte)(4), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A421Tran_RegionCodigo), "ZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_RegionCodigo_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(4),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         httpContext.ajax_rsp_assign_prop("", false, cmbTran_IndE_S.getInternalname(), "Values", cmbTran_IndE_S.ToJavascriptSource(), !bGXsfl_138_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_ValorTransaccion_Internalname,GXutil.ltrim( localUtil.ntoc( A483Tran_ValorTransaccion, (byte)(24), (byte)(2), ",", "")),localUtil.format( A483Tran_ValorTransaccion, "$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_ValorTransaccion_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(24),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"Valor","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         httpContext.ajax_rsp_assign_prop("", false, cmbTran_TipoElemento.getInternalname(), "Values", cmbTran_TipoElemento.ToJavascriptSource(), !bGXsfl_138_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_NumeroIngreso_Internalname,GXutil.rtrim( A514Tran_NumeroIngreso),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_NumeroIngreso_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_RegionDescripcionDestino_Internalname,A520Tran_RegionDescripcionDestino,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_RegionDescripcionDestino_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_CentroCostoIdDestino_Internalname,GXutil.ltrim( localUtil.ntoc( A50Tran_CentroCostoIdDestino, (byte)(11), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A50Tran_CentroCostoIdDestino), "ZZZZZZZZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_CentroCostoIdDestino_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(11),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"Identificador","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_CentroCostoCodigoDestino_Internalname,A516Tran_CentroCostoCodigoDestino,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_CentroCostoCodigoDestino_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(16),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_CentroCostoDescripcionDes_Internalname,A517Tran_CentroCostoDescripcionDes,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_CentroCostoDescripcionDes_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_RegionIdDestino_Internalname,GXutil.ltrim( localUtil.ntoc( A518Tran_RegionIdDestino, (byte)(11), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A518Tran_RegionIdDestino), "ZZZZZZZZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_RegionIdDestino_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(11),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"Identificador","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         httpContext.ajax_rsp_assign_prop("", false, cmbTran_TipoEntra.getInternalname(), "Values", cmbTran_TipoEntra.ToJavascriptSource(), !bGXsfl_138_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_CantidadPadres_Internalname,GXutil.ltrim( localUtil.ntoc( A568Tran_CantidadPadres, (byte)(8), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A568Tran_CantidadPadres), "ZZZZZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_CantidadPadres_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(8),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_RegionAbrev_Internalname,A594Tran_RegionAbrev,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_RegionAbrev_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(15),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_RegionAbrevDestino_Internalname,A608Tran_RegionAbrevDestino,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_RegionAbrevDestino_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(15),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_Detalle_Internalname,GXutil.rtrim( A524Tran_Detalle),"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_Detalle_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(1),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTran_NumeroGrupo_Internalname,GXutil.ltrim( localUtil.ntoc( A667Tran_NumeroGrupo, (byte)(4), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A667Tran_NumeroGrupo), "ZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTran_NumeroGrupo_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(4),new Integer(0),new Integer(0),new Integer(138),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_CONSECUTIVOCC"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, localUtil.format( DecimalUtil.doubleToDec(A513Tran_ConsecutivoCC), "ZZZZZZZZZZZZZZZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_CODIGOMOVIMIENTO"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, GXutil.rtrim( localUtil.format( A49Tran_CodigoMovimiento, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_MODULOORIGEN"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, GXutil.rtrim( localUtil.format( A110Tran_ModuloOrigen, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_CODALMAORIGEN"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, GXutil.rtrim( localUtil.format( A109Tran_CodAlmaOrigen, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_CODBODEORIGEN"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, GXutil.rtrim( localUtil.format( A112Tran_CodBodeOrigen, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_MODULODESTINO"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, GXutil.rtrim( localUtil.format( A385Tran_ModuloDestino, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_CODALMADESTINO"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, GXutil.rtrim( localUtil.format( A111Tran_CodAlmaDestino, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_CODBODEDESTINO"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, GXutil.rtrim( localUtil.format( A387Tran_CodBodeDestino, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_FECHAREGISTRO"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, localUtil.format( A55Tran_FechaRegistro, "99/99/99 99:99")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_IDPROVEEDOR"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, localUtil.format( DecimalUtil.doubleToDec(A53Tran_IdProveedor), "ZZZZZZZZZZZZZZZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_IDCUENTADANTEDESTINO"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, localUtil.format( DecimalUtil.doubleToDec(A52Tran_IdCuentadanteDestino), "ZZZZZZZZZZZZZZZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_OBSERVACIONES"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, A416Tran_Observaciones));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_AREADANTECODIGO"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, GXutil.rtrim( localUtil.format( A407Tran_AreadanteCodigo, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_CURSOCODIGO"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, GXutil.rtrim( localUtil.format( A408Tran_CursoCodigo, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_ESTADO"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, GXutil.rtrim( localUtil.format( A58Tran_Estado, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_IDCUENTADANTEORIGEN"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, localUtil.format( DecimalUtil.doubleToDec(A51Tran_IdCuentadanteOrigen), "ZZZZZZZZZZZZZZZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_ID"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, localUtil.format( DecimalUtil.doubleToDec(A46Tran_Id), "ZZZZZZZZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_FECHARATIFICACION"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, localUtil.format( A390Tran_FechaRatificacion, "99/99/9999 99:99")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_USUARIORATIFICA"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, GXutil.rtrim( localUtil.format( A391Tran_UsuarioRatifica, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_USUARIOID"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, localUtil.format( DecimalUtil.doubleToDec(A47Tran_UsuarioId), "ZZZZZZZZZZZZZZZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_CENTROCOSTOID"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, localUtil.format( DecimalUtil.doubleToDec(A48Tran_CentroCostoId), "ZZZZZZZZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_REGIONID"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, localUtil.format( DecimalUtil.doubleToDec(A57Tran_RegionId), "ZZZZZZZZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_INDE_S"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, GXutil.rtrim( localUtil.format( A481Tran_IndE_S, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_VALORTRANSACCION"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, localUtil.format( A483Tran_ValorTransaccion, "$ ZZZ,ZZZ,ZZZ,ZZZ,ZZ9.99")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_TIPOELEMENTO"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, GXutil.rtrim( localUtil.format( A482Tran_TipoElemento, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_NUMEROINGRESO"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, GXutil.rtrim( localUtil.format( A514Tran_NumeroIngreso, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_CENTROCOSTOIDDESTINO"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, localUtil.format( DecimalUtil.doubleToDec(A50Tran_CentroCostoIdDestino), "ZZZZZZZZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_REGIONIDDESTINO"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, localUtil.format( DecimalUtil.doubleToDec(A518Tran_RegionIdDestino), "ZZZZZZZZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_TIPOENTRA"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, GXutil.rtrim( localUtil.format( A527Tran_TipoEntra, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_CANTIDADPADRES"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, localUtil.format( DecimalUtil.doubleToDec(A568Tran_CantidadPadres), "ZZZZZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_DETALLE"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, GXutil.rtrim( localUtil.format( A524Tran_Detalle, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TRAN_NUMEROGRUPO"+"_"+sGXsfl_138_idx, getSecureSignedToken( sGXsfl_138_idx, localUtil.format( DecimalUtil.doubleToDec(A667Tran_NumeroGrupo), "ZZZ9")));
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV33Tran_NombreIngreso',fld:'vTRAN_NOMBREINGRESO',pic:'@!',nv:''},{av:'AV38Update',fld:'vUPDATE',pic:'',nv:''},{av:'A50Tran_CentroCostoIdDestino',fld:'TRAN_CENTROCOSTOIDDESTINO',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'A48Tran_CentroCostoId',fld:'TRAN_CENTROCOSTOID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'A23Usua_Id',fld:'USUA_ID',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'A1Cent_Id',fld:'CENT_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV39Usua_Id',fld:'vUSUA_ID',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV5Tran_CentroCostoId',fld:'vTRAN_CENTROCOSTOID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV26Tran_CodigoMovimiento',fld:'vTRAN_CODIGOMOVIMIENTO',pic:'',nv:''},{av:'AV8ADVANCED_LABEL_TEMPLATE',fld:'vADVANCED_LABEL_TEMPLATE',pic:'',nv:''},{av:'AV29Tran_DescripcionMovimiento',fld:'vTRAN_DESCRIPCIONMOVIMIENTO',pic:'',nv:''},{av:'AV30Tran_FechaRegistro',fld:'vTRAN_FECHAREGISTRO',pic:'',nv:''},{av:'AV34Tran_Observaciones',fld:'vTRAN_OBSERVACIONES',pic:'',nv:''},{av:'AV35Tran_TipoIngreso',fld:'vTRAN_TIPOINGRESO',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV32Tran_IdProveedor',fld:'vTRAN_IDPROVEEDOR',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV21Proveedor',fld:'vPROVEEDOR',pic:'',nv:''},{av:'AV31Tran_IdCuentadanteDestino',fld:'vTRAN_IDCUENTADANTEDESTINO',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV12Cuentadante',fld:'vCUENTADANTE',pic:'',nv:''},{av:'AV24Tran_AreadanteCodigo',fld:'vTRAN_AREADANTECODIGO',pic:'',nv:''},{av:'AV28Tran_CursoCodigo',fld:'vTRAN_CURSOCODIGO',pic:'',nv:''},{av:'AV44Pgmname',fld:'vPGMNAME',pic:'',nv:''},{av:'AV27Tran_ConsecutivoCC',fld:'vTRAN_CONSECUTIVOCC',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0}],oparms:[{av:'lblLbltran_codigomovimientofilter_Caption',ctrl:'LBLTRAN_CODIGOMOVIMIENTOFILTER',prop:'Caption'},{av:'lblLbltran_descripcionmovimientofilter_Caption',ctrl:'LBLTRAN_DESCRIPCIONMOVIMIENTOFILTER',prop:'Caption'},{av:'lblLbltran_fecharegistrofilter_Caption',ctrl:'LBLTRAN_FECHAREGISTROFILTER',prop:'Caption'},{av:'lblLbltran_observacionesfilter_Caption',ctrl:'LBLTRAN_OBSERVACIONESFILTER',prop:'Caption'},{av:'lblLbltran_tipoingresofilter_Caption',ctrl:'LBLTRAN_TIPOINGRESOFILTER',prop:'Caption'},{av:'lblLbltran_idproveedorfilter_Caption',ctrl:'LBLTRAN_IDPROVEEDORFILTER',prop:'Caption'},{av:'lblLbltran_nombreproveedorfilter_Caption',ctrl:'LBLTRAN_NOMBREPROVEEDORFILTER',prop:'Caption'},{av:'lblLbltran_idcuentadantedestinofilter_Caption',ctrl:'LBLTRAN_IDCUENTADANTEDESTINOFILTER',prop:'Caption'},{av:'lblLbltran_nombrecuentadantefilter_Caption',ctrl:'LBLTRAN_NOMBRECUENTADANTEFILTER',prop:'Caption'},{av:'lblLbltran_areadantecodigofilter_Caption',ctrl:'LBLTRAN_AREADANTECODIGOFILTER',prop:'Caption'},{av:'lblLbltran_cursocodigofilter_Caption',ctrl:'LBLTRAN_CURSOCODIGOFILTER',prop:'Caption'}]}");
      setEventMetadata("'TOGGLE'","{handler:'e117X1',iparms:[{av:'divFilterscontainer_Class',ctrl:'FILTERSCONTAINER',prop:'Class'}],oparms:[{av:'divFilterscontainer_Class',ctrl:'FILTERSCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Caption'},{av:'divGridcell_Class',ctrl:'GRIDCELL',prop:'Class'}]}");
      setEventMetadata("LBLTRAN_CODIGOMOVIMIENTOFILTER.CLICK","{handler:'e127X1',iparms:[{av:'divTran_codigomovimientofiltercontainer_Class',ctrl:'TRAN_CODIGOMOVIMIENTOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_codigomovimientofiltercontainer_Class',ctrl:'TRAN_CODIGOMOVIMIENTOFILTERCONTAINER',prop:'Class'},{av:'edtavTran_codigomovimiento_Visible',ctrl:'vTRAN_CODIGOMOVIMIENTO',prop:'Visible'}]}");
      setEventMetadata("LBLTRAN_DESCRIPCIONMOVIMIENTOFILTER.CLICK","{handler:'e137X1',iparms:[{av:'divTran_descripcionmovimientofiltercontainer_Class',ctrl:'TRAN_DESCRIPCIONMOVIMIENTOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_descripcionmovimientofiltercontainer_Class',ctrl:'TRAN_DESCRIPCIONMOVIMIENTOFILTERCONTAINER',prop:'Class'},{av:'edtavTran_descripcionmovimiento_Visible',ctrl:'vTRAN_DESCRIPCIONMOVIMIENTO',prop:'Visible'}]}");
      setEventMetadata("LBLTRAN_FECHAREGISTROFILTER.CLICK","{handler:'e147X1',iparms:[{av:'divTran_fecharegistrofiltercontainer_Class',ctrl:'TRAN_FECHAREGISTROFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_fecharegistrofiltercontainer_Class',ctrl:'TRAN_FECHAREGISTROFILTERCONTAINER',prop:'Class'}]}");
      setEventMetadata("LBLTRAN_OBSERVACIONESFILTER.CLICK","{handler:'e157X1',iparms:[{av:'divTran_observacionesfiltercontainer_Class',ctrl:'TRAN_OBSERVACIONESFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_observacionesfiltercontainer_Class',ctrl:'TRAN_OBSERVACIONESFILTERCONTAINER',prop:'Class'},{av:'edtavTran_observaciones_Visible',ctrl:'vTRAN_OBSERVACIONES',prop:'Visible'}]}");
      setEventMetadata("LBLTRAN_TIPOINGRESOFILTER.CLICK","{handler:'e167X1',iparms:[{av:'divTran_tipoingresofiltercontainer_Class',ctrl:'TRAN_TIPOINGRESOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_tipoingresofiltercontainer_Class',ctrl:'TRAN_TIPOINGRESOFILTERCONTAINER',prop:'Class'},{av:'edtavTran_nombreingreso_Visible',ctrl:'vTRAN_NOMBREINGRESO',prop:'Visible'}]}");
      setEventMetadata("LBLTRAN_IDPROVEEDORFILTER.CLICK","{handler:'e177X1',iparms:[{av:'divTran_idproveedorfiltercontainer_Class',ctrl:'TRAN_IDPROVEEDORFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_idproveedorfiltercontainer_Class',ctrl:'TRAN_IDPROVEEDORFILTERCONTAINER',prop:'Class'},{av:'edtavTran_idproveedor_Visible',ctrl:'vTRAN_IDPROVEEDOR',prop:'Visible'}]}");
      setEventMetadata("LBLTRAN_NOMBREPROVEEDORFILTER.CLICK","{handler:'e187X1',iparms:[{av:'divTran_nombreproveedorfiltercontainer_Class',ctrl:'TRAN_NOMBREPROVEEDORFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_nombreproveedorfiltercontainer_Class',ctrl:'TRAN_NOMBREPROVEEDORFILTERCONTAINER',prop:'Class'},{av:'edtavProveedor_Visible',ctrl:'vPROVEEDOR',prop:'Visible'}]}");
      setEventMetadata("LBLTRAN_IDCUENTADANTEDESTINOFILTER.CLICK","{handler:'e197X1',iparms:[{av:'divTran_idcuentadantedestinofiltercontainer_Class',ctrl:'TRAN_IDCUENTADANTEDESTINOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_idcuentadantedestinofiltercontainer_Class',ctrl:'TRAN_IDCUENTADANTEDESTINOFILTERCONTAINER',prop:'Class'},{av:'edtavTran_idcuentadantedestino_Visible',ctrl:'vTRAN_IDCUENTADANTEDESTINO',prop:'Visible'}]}");
      setEventMetadata("LBLTRAN_NOMBRECUENTADANTEFILTER.CLICK","{handler:'e207X1',iparms:[{av:'divTran_nombrecuentadantefiltercontainer_Class',ctrl:'TRAN_NOMBRECUENTADANTEFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_nombrecuentadantefiltercontainer_Class',ctrl:'TRAN_NOMBRECUENTADANTEFILTERCONTAINER',prop:'Class'},{av:'edtavCuentadante_Visible',ctrl:'vCUENTADANTE',prop:'Visible'}]}");
      setEventMetadata("LBLTRAN_AREADANTECODIGOFILTER.CLICK","{handler:'e217X1',iparms:[{av:'divTran_areadantecodigofiltercontainer_Class',ctrl:'TRAN_AREADANTECODIGOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_areadantecodigofiltercontainer_Class',ctrl:'TRAN_AREADANTECODIGOFILTERCONTAINER',prop:'Class'},{av:'edtavTran_areadantecodigo_Visible',ctrl:'vTRAN_AREADANTECODIGO',prop:'Visible'}]}");
      setEventMetadata("LBLTRAN_CURSOCODIGOFILTER.CLICK","{handler:'e227X1',iparms:[{av:'divTran_cursocodigofiltercontainer_Class',ctrl:'TRAN_CURSOCODIGOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTran_cursocodigofiltercontainer_Class',ctrl:'TRAN_CURSOCODIGOFILTERCONTAINER',prop:'Class'},{av:'edtavTran_cursocodigo_Visible',ctrl:'vTRAN_CURSOCODIGO',prop:'Visible'}]}");
      setEventMetadata("GRID.LOAD","{handler:'e257X2',iparms:[{av:'A50Tran_CentroCostoIdDestino',fld:'TRAN_CENTROCOSTOIDDESTINO',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'A48Tran_CentroCostoId',fld:'TRAN_CENTROCOSTOID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'A23Usua_Id',fld:'USUA_ID',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'A1Cent_Id',fld:'CENT_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV39Usua_Id',fld:'vUSUA_ID',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV5Tran_CentroCostoId',fld:'vTRAN_CENTROCOSTOID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV29Tran_DescripcionMovimiento',fld:'vTRAN_DESCRIPCIONMOVIMIENTO',pic:'',nv:''},{av:'AV30Tran_FechaRegistro',fld:'vTRAN_FECHAREGISTRO',pic:'',nv:''},{av:'AV34Tran_Observaciones',fld:'vTRAN_OBSERVACIONES',pic:'',nv:''},{av:'AV21Proveedor',fld:'vPROVEEDOR',pic:'',nv:''},{av:'AV12Cuentadante',fld:'vCUENTADANTE',pic:'',nv:''},{av:'AV33Tran_NombreIngreso',fld:'vTRAN_NOMBREINGRESO',pic:'@!',nv:''}],oparms:[{av:'AV5Tran_CentroCostoId',fld:'vTRAN_CENTROCOSTOID',pic:'ZZZZZZZZZZ9',nv:0}]}");
      setEventMetadata("'RATIFICAR'","{handler:'e267X2',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV27Tran_ConsecutivoCC',fld:'vTRAN_CONSECUTIVOCC',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV26Tran_CodigoMovimiento',fld:'vTRAN_CODIGOMOVIMIENTO',pic:'',nv:''},{av:'AV29Tran_DescripcionMovimiento',fld:'vTRAN_DESCRIPCIONMOVIMIENTO',pic:'',nv:''},{av:'AV30Tran_FechaRegistro',fld:'vTRAN_FECHAREGISTRO',pic:'',nv:''},{av:'AV34Tran_Observaciones',fld:'vTRAN_OBSERVACIONES',pic:'',nv:''},{av:'AV33Tran_NombreIngreso',fld:'vTRAN_NOMBREINGRESO',pic:'@!',nv:''},{av:'AV32Tran_IdProveedor',fld:'vTRAN_IDPROVEEDOR',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV21Proveedor',fld:'vPROVEEDOR',pic:'',nv:''},{av:'AV31Tran_IdCuentadanteDestino',fld:'vTRAN_IDCUENTADANTEDESTINO',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV12Cuentadante',fld:'vCUENTADANTE',pic:'',nv:''},{av:'AV24Tran_AreadanteCodigo',fld:'vTRAN_AREADANTECODIGO',pic:'',nv:''},{av:'AV28Tran_CursoCodigo',fld:'vTRAN_CURSOCODIGO',pic:'',nv:''},{av:'AV35Tran_TipoIngreso',fld:'vTRAN_TIPOINGRESO',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV38Update',fld:'vUPDATE',pic:'',nv:''},{av:'AV8ADVANCED_LABEL_TEMPLATE',fld:'vADVANCED_LABEL_TEMPLATE',pic:'',nv:''},{av:'AV44Pgmname',fld:'vPGMNAME',pic:'',nv:''},{av:'A50Tran_CentroCostoIdDestino',fld:'TRAN_CENTROCOSTOIDDESTINO',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'A48Tran_CentroCostoId',fld:'TRAN_CENTROCOSTOID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'A23Usua_Id',fld:'USUA_ID',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'A1Cent_Id',fld:'CENT_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV39Usua_Id',fld:'vUSUA_ID',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV5Tran_CentroCostoId',fld:'vTRAN_CENTROCOSTOID',pic:'ZZZZZZZZZZ9',nv:0},{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}]}");
   ...
   public void initialize( )
   {
      ...
      H007X2_A416Tran_Observaciones = new String[] {""} ;
      H007X2_n416Tran_Observaciones = new boolean[] {false} ;
      H007X2_A513Tran_ConsecutivoCC = new long[1] ;
      H007X2_n513Tran_ConsecutivoCC = new boolean[] {false} ;
      H007X2_A49Tran_CodigoMovimiento = new String[] {""} ;
      H007X2_A381Tran_DescripcionMovimiento = new String[] {""} ;
      H007X2_n381Tran_DescripcionMovimiento = new boolean[] {false} ;
      H007X2_A55Tran_FechaRegistro = new java.util.Date[] {GXutil.nullDate()} ;
      H007X2_A54Tran_TipoIngreso = new long[1] ;
      H007X2_n54Tran_TipoIngreso = new boolean[] {false} ;
      H007X2_A53Tran_IdProveedor = new long[1] ;
      H007X2_n53Tran_IdProveedor = new boolean[] {false} ;
      H007X2_A52Tran_IdCuentadanteDestino = new long[1] ;
      H007X2_n52Tran_IdCuentadanteDestino = new boolean[] {false} ;
      H007X2_A407Tran_AreadanteCodigo = new String[] {""} ;
      H007X2_n407Tran_AreadanteCodigo = new boolean[] {false} ;
      H007X2_A408Tran_CursoCodigo = new String[] {""} ;
      H007X2_n408Tran_CursoCodigo = new boolean[] {false} ;
      H007X2_A575Tran_NombreProveedor = new String[] {""} ;
      H007X2_n575Tran_NombreProveedor = new boolean[] {false} ;
      H007X2_A389Tran_NombCuentadanteDestino = new String[] {""} ;
      H007X2_n389Tran_NombCuentadanteDestino = new boolean[] {false} ;
      H007X2_A672Tran_NombreIngreso = new String[] {""} ;
      H007X2_n672Tran_NombreIngreso = new boolean[] {false} ;
      H007X2_A58Tran_Estado = new String[] {""} ;
      H007X2_n58Tran_Estado = new boolean[] {false} ;
      H007X2_A50Tran_CentroCostoIdDestino = new long[1] ;
      H007X2_n50Tran_CentroCostoIdDestino = new boolean[] {false} ;
      H007X2_A48Tran_CentroCostoId = new long[1] ;
      H007X2_A667Tran_NumeroGrupo = new short[1] ;
      H007X2_n667Tran_NumeroGrupo = new boolean[] {false} ;
      H007X2_A524Tran_Detalle = new String[] {""} ;
      H007X2_n524Tran_Detalle = new boolean[] {false} ;
      H007X2_A608Tran_RegionAbrevDestino = new String[] {""} ;
      H007X2_n608Tran_RegionAbrevDestino = new boolean[] {false} ;
      H007X2_A594Tran_RegionAbrev = new String[] {""} ;
      H007X2_n594Tran_RegionAbrev = new boolean[] {false} ;
      H007X2_A568Tran_CantidadPadres = new int[1] ;
      H007X2_n568Tran_CantidadPadres = new boolean[] {false} ;
      H007X2_A527Tran_TipoEntra = new String[] {""} ;
      H007X2_n527Tran_TipoEntra = new boolean[] {false} ;
      H007X2_A519Tran_RegionCodigoDestino = new short[1] ;
      H007X2_n519Tran_RegionCodigoDestino = new boolean[] {false} ;
      H007X2_A518Tran_RegionIdDestino = new long[1] ;
      H007X2_n518Tran_RegionIdDestino = new boolean[] {false} ;
      H007X2_A517Tran_CentroCostoDescripcionDes = new String[] {""} ;
      H007X2_n517Tran_CentroCostoDescripcionDes = new boolean[] {false} ;
      H007X2_A516Tran_CentroCostoCodigoDestino = new String[] {""} ;
      H007X2_n516Tran_CentroCostoCodigoDestino = new boolean[] {false} ;
      H007X2_A520Tran_RegionDescripcionDestino = new String[] {""} ;
      H007X2_n520Tran_RegionDescripcionDestino = new boolean[] {false} ;
      H007X2_A514Tran_NumeroIngreso = new String[] {""} ;
      H007X2_n514Tran_NumeroIngreso = new boolean[] {false} ;
      H007X2_A482Tran_TipoElemento = new String[] {""} ;
      H007X2_A499Tran_CodTipoElemento = new long[1] ;
      H007X2_n499Tran_CodTipoElemento = new boolean[] {false} ;
      H007X2_A483Tran_ValorTransaccion = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H007X2_n483Tran_ValorTransaccion = new boolean[] {false} ;
      H007X2_A481Tran_IndE_S = new String[] {""} ;
      H007X2_n481Tran_IndE_S = new boolean[] {false} ;
      H007X2_A421Tran_RegionCodigo = new short[1] ;
      H007X2_n421Tran_RegionCodigo = new boolean[] {false} ;
      H007X2_A57Tran_RegionId = new long[1] ;
      H007X2_n57Tran_RegionId = new boolean[] {false} ;
      H007X2_A420Tran_CentroCostoDescripcion = new String[] {""} ;
      H007X2_n420Tran_CentroCostoDescripcion = new boolean[] {false} ;
      H007X2_A418Tran_UsuarioNombre = new String[] {""} ;
      H007X2_n418Tran_UsuarioNombre = new boolean[] {false} ;
      H007X2_A417Tran_UsuarioCodigo = new String[] {""} ;
      H007X2_n417Tran_UsuarioCodigo = new boolean[] {false} ;
      H007X2_A47Tran_UsuarioId = new long[1] ;
      H007X2_n47Tran_UsuarioId = new boolean[] {false} ;
      H007X2_A391Tran_UsuarioRatifica = new String[] {""} ;
      H007X2_n391Tran_UsuarioRatifica = new boolean[] {false} ;
      H007X2_A390Tran_FechaRatificacion = new java.util.Date[] {GXutil.nullDate()} ;
      H007X2_n390Tran_FechaRatificacion = new boolean[] {false} ;
      H007X2_A46Tran_Id = new long[1] ;
      H007X2_A51Tran_IdCuentadanteOrigen = new long[1] ;
      H007X2_n51Tran_IdCuentadanteOrigen = new boolean[] {false} ;
      H007X2_A387Tran_CodBodeDestino = new String[] {""} ;
      H007X2_A111Tran_CodAlmaDestino = new String[] {""} ;
      H007X2_A385Tran_ModuloDestino = new String[] {""} ;
      H007X2_A112Tran_CodBodeOrigen = new String[] {""} ;
      H007X2_A109Tran_CodAlmaOrigen = new String[] {""} ;
      H007X2_A110Tran_ModuloOrigen = new String[] {""} ;
      H007X2_A419Tran_CentroCostoCodigo = new String[] {""} ;
      H007X2_n419Tran_CentroCostoCodigo = new boolean[] {false} ;
      H007X2_A422Tran_RegionDescripcion = new String[] {""} ;
      H007X2_n422Tran_RegionDescripcion = new boolean[] {false} ;
      AV40Usuario = "" ;
      ...
      H007X3_A1Cent_Id = new long[1] ;
      H007X3_A23Usua_Id = new long[1] ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      sImgUrl = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.wwalm_ratificar_traslados__default(),
         new Object[] {
             new Object[] {
            H007X2_A416Tran_Observaciones, H007X2_n416Tran_Observaciones, H007X2_A513Tran_ConsecutivoCC, H007X2_n513Tran_ConsecutivoCC, H007X2_A49Tran_CodigoMovimiento, H007X2_A381Tran_DescripcionMovimiento, H007X2_n381Tran_DescripcionMovimiento, H007X2_A55Tran_FechaRegistro, H007X2_A54Tran_TipoIngreso, H007X2_n54Tran_TipoIngreso,
            H007X2_A53Tran_IdProveedor, H007X2_n53Tran_IdProveedor, H007X2_A52Tran_IdCuentadanteDestino, H007X2_n52Tran_IdCuentadanteDestino, H007X2_A407Tran_AreadanteCodigo, H007X2_n407Tran_AreadanteCodigo, H007X2_A408Tran_CursoCodigo, H007X2_n408Tran_CursoCodigo, H007X2_A575Tran_NombreProveedor, H007X2_n575Tran_NombreProveedor,
            H007X2_A389Tran_NombCuentadanteDestino, H007X2_n389Tran_NombCuentadanteDestino, H007X2_A672Tran_NombreIngreso, H007X2_n672Tran_NombreIngreso, H007X2_A58Tran_Estado, H007X2_n58Tran_Estado, H007X2_A50Tran_CentroCostoIdDestino, H007X2_n50Tran_CentroCostoIdDestino, H007X2_A48Tran_CentroCostoId, H007X2_A667Tran_NumeroGrupo,
            H007X2_n667Tran_NumeroGrupo, H007X2_A524Tran_Detalle, H007X2_n524Tran_Detalle, H007X2_A608Tran_RegionAbrevDestino, H007X2_n608Tran_RegionAbrevDestino, H007X2_A594Tran_RegionAbrev, H007X2_n594Tran_RegionAbrev, H007X2_A568Tran_CantidadPadres, H007X2_n568Tran_CantidadPadres, H007X2_A527Tran_TipoEntra,
            H007X2_n527Tran_TipoEntra, H007X2_A519Tran_RegionCodigoDestino, H007X2_n519Tran_RegionCodigoDestino, H007X2_A518Tran_RegionIdDestino, H007X2_n518Tran_RegionIdDestino, H007X2_A517Tran_CentroCostoDescripcionDes, H007X2_n517Tran_CentroCostoDescripcionDes, H007X2_A516Tran_CentroCostoCodigoDestino, H007X2_n516Tran_CentroCostoCodigoDestino, H007X2_A520Tran_RegionDescripcionDestino,
            H007X2_n520Tran_RegionDescripcionDestino, H007X2_A514Tran_NumeroIngreso, H007X2_n514Tran_NumeroIngreso, H007X2_A482Tran_TipoElemento, H007X2_A499Tran_CodTipoElemento, H007X2_n499Tran_CodTipoElemento, H007X2_A483Tran_ValorTransaccion, H007X2_n483Tran_ValorTransaccion, H007X2_A481Tran_IndE_S, H007X2_n481Tran_IndE_S,
            H007X2_A421Tran_RegionCodigo, H007X2_n421Tran_RegionCodigo, H007X2_A57Tran_RegionId, H007X2_n57Tran_RegionId, H007X2_A420Tran_CentroCostoDescripcion, H007X2_n420Tran_CentroCostoDescripcion, H007X2_A418Tran_UsuarioNombre, H007X2_n418Tran_UsuarioNombre, H007X2_A417Tran_UsuarioCodigo, H007X2_n417Tran_UsuarioCodigo,
            H007X2_A47Tran_UsuarioId, H007X2_n47Tran_UsuarioId, H007X2_A391Tran_UsuarioRatifica, H007X2_n391Tran_UsuarioRatifica, H007X2_A390Tran_FechaRatificacion, H007X2_n390Tran_FechaRatificacion, H007X2_A46Tran_Id, H007X2_A51Tran_IdCuentadanteOrigen, H007X2_n51Tran_IdCuentadanteOrigen, H007X2_A387Tran_CodBodeDestino,
            H007X2_A111Tran_CodAlmaDestino, H007X2_A385Tran_ModuloDestino, H007X2_A112Tran_CodBodeOrigen, H007X2_A109Tran_CodAlmaOrigen, H007X2_A110Tran_ModuloOrigen, H007X2_A419Tran_CentroCostoCodigo, H007X2_n419Tran_CentroCostoCodigo, H007X2_A422Tran_RegionDescripcion, H007X2_n422Tran_RegionDescripcion
            }
            , new Object[] {
            H007X3_A1Cent_Id, H007X3_A23Usua_Id
            }
         }
      );
      AV44Pgmname = "WWALM_RATIFICAR_TRASLADOS" ;
   ...
   private short nRC_GXsfl_138 ;
   private short nGXsfl_138_idx=1 ;
   private short wbEnd ;
   ...
   private String[] H007X2_A416Tran_Observaciones ;
   private boolean[] H007X2_n416Tran_Observaciones ;
   private long[] H007X2_A513Tran_ConsecutivoCC ;
   private boolean[] H007X2_n513Tran_ConsecutivoCC ;
   private String[] H007X2_A49Tran_CodigoMovimiento ;
   private String[] H007X2_A381Tran_DescripcionMovimiento ;
   private boolean[] H007X2_n381Tran_DescripcionMovimiento ;
   private java.util.Date[] H007X2_A55Tran_FechaRegistro ;
   private long[] H007X2_A54Tran_TipoIngreso ;
   private boolean[] H007X2_n54Tran_TipoIngreso ;
   private long[] H007X2_A53Tran_IdProveedor ;
   private boolean[] H007X2_n53Tran_IdProveedor ;
   private long[] H007X2_A52Tran_IdCuentadanteDestino ;
   private boolean[] H007X2_n52Tran_IdCuentadanteDestino ;
   private String[] H007X2_A407Tran_AreadanteCodigo ;
   private boolean[] H007X2_n407Tran_AreadanteCodigo ;
   private String[] H007X2_A408Tran_CursoCodigo ;
   private boolean[] H007X2_n408Tran_CursoCodigo ;
   private String[] H007X2_A575Tran_NombreProveedor ;
   private boolean[] H007X2_n575Tran_NombreProveedor ;
   private String[] H007X2_A389Tran_NombCuentadanteDestino ;
   private boolean[] H007X2_n389Tran_NombCuentadanteDestino ;
   private String[] H007X2_A672Tran_NombreIngreso ;
   private boolean[] H007X2_n672Tran_NombreIngreso ;
   private String[] H007X2_A58Tran_Estado ;
   private boolean[] H007X2_n58Tran_Estado ;
   private long[] H007X2_A50Tran_CentroCostoIdDestino ;
   private boolean[] H007X2_n50Tran_CentroCostoIdDestino ;
   private long[] H007X2_A48Tran_CentroCostoId ;
   private short[] H007X2_A667Tran_NumeroGrupo ;
   private boolean[] H007X2_n667Tran_NumeroGrupo ;
   private String[] H007X2_A524Tran_Detalle ;
   private boolean[] H007X2_n524Tran_Detalle ;
   private String[] H007X2_A608Tran_RegionAbrevDestino ;
   private boolean[] H007X2_n608Tran_RegionAbrevDestino ;
   private String[] H007X2_A594Tran_RegionAbrev ;
   private boolean[] H007X2_n594Tran_RegionAbrev ;
   private int[] H007X2_A568Tran_CantidadPadres ;
   private boolean[] H007X2_n568Tran_CantidadPadres ;
   private String[] H007X2_A527Tran_TipoEntra ;
   private boolean[] H007X2_n527Tran_TipoEntra ;
   private short[] H007X2_A519Tran_RegionCodigoDestino ;
   private boolean[] H007X2_n519Tran_RegionCodigoDestino ;
   private long[] H007X2_A518Tran_RegionIdDestino ;
   private boolean[] H007X2_n518Tran_RegionIdDestino ;
   private String[] H007X2_A517Tran_CentroCostoDescripcionDes ;
   private boolean[] H007X2_n517Tran_CentroCostoDescripcionDes ;
   private String[] H007X2_A516Tran_CentroCostoCodigoDestino ;
   private boolean[] H007X2_n516Tran_CentroCostoCodigoDestino ;
   private String[] H007X2_A520Tran_RegionDescripcionDestino ;
   private boolean[] H007X2_n520Tran_RegionDescripcionDestino ;
   private String[] H007X2_A514Tran_NumeroIngreso ;
   private boolean[] H007X2_n514Tran_NumeroIngreso ;
   private String[] H007X2_A482Tran_TipoElemento ;
   private long[] H007X2_A499Tran_CodTipoElemento ;
   private boolean[] H007X2_n499Tran_CodTipoElemento ;
   private java.math.BigDecimal[] H007X2_A483Tran_ValorTransaccion ;
   private boolean[] H007X2_n483Tran_ValorTransaccion ;
   private String[] H007X2_A481Tran_IndE_S ;
   private boolean[] H007X2_n481Tran_IndE_S ;
   private short[] H007X2_A421Tran_RegionCodigo ;
   private boolean[] H007X2_n421Tran_RegionCodigo ;
   private long[] H007X2_A57Tran_RegionId ;
   private boolean[] H007X2_n57Tran_RegionId ;
   private String[] H007X2_A420Tran_CentroCostoDescripcion ;
   private boolean[] H007X2_n420Tran_CentroCostoDescripcion ;
   private String[] H007X2_A418Tran_UsuarioNombre ;
   private boolean[] H007X2_n418Tran_UsuarioNombre ;
   private String[] H007X2_A417Tran_UsuarioCodigo ;
   private boolean[] H007X2_n417Tran_UsuarioCodigo ;
   private long[] H007X2_A47Tran_UsuarioId ;
   private boolean[] H007X2_n47Tran_UsuarioId ;
   private String[] H007X2_A391Tran_UsuarioRatifica ;
   private boolean[] H007X2_n391Tran_UsuarioRatifica ;
   private java.util.Date[] H007X2_A390Tran_FechaRatificacion ;
   private boolean[] H007X2_n390Tran_FechaRatificacion ;
   private long[] H007X2_A46Tran_Id ;
   private long[] H007X2_A51Tran_IdCuentadanteOrigen ;
   private boolean[] H007X2_n51Tran_IdCuentadanteOrigen ;
   private String[] H007X2_A387Tran_CodBodeDestino ;
   private String[] H007X2_A111Tran_CodAlmaDestino ;
   private String[] H007X2_A385Tran_ModuloDestino ;
   private String[] H007X2_A112Tran_CodBodeOrigen ;
   private String[] H007X2_A109Tran_CodAlmaOrigen ;
   private String[] H007X2_A110Tran_ModuloOrigen ;
   private String[] H007X2_A419Tran_CentroCostoCodigo ;
   private boolean[] H007X2_n419Tran_CentroCostoCodigo ;
   private String[] H007X2_A422Tran_RegionDescripcion ;
   private boolean[] H007X2_n422Tran_RegionDescripcion ;
   private long[] H007X3_A1Cent_Id ;
   private long[] H007X3_A23Usua_Id ;
...
final  class wwalm_ratificar_traslados__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H007X2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          String A58Tran_Estado )
   {
      ...
      scmdbuf = scmdbuf + " Tran_CodigoMovimiento, T2.Tpmo_Descripcion AS Tran_DescripcionMovimiento, T1.Tran_FechaRegistro," ;
      scmdbuf = scmdbuf + " T1.Tran_TipoIngreso AS Tran_TipoIngreso, T1.Tran_IdProveedor AS Tran_IdProveedor," ;
      scmdbuf = scmdbuf + " T1.Tran_IdCuentadanteDestino AS Tran_IdCuentadanteDestino, T1.Tran_AreadanteCodigo," ;
      scmdbuf = scmdbuf + " T1.Tran_CursoCodigo, T4.Cuen_Nombre AS Tran_NombreProveedor, T5.Cuen_Nombre AS Tran_NombCuentadanteDestino," ;
      scmdbuf = scmdbuf + " T3.Orig_Descripcion AS Tran_NombreIngreso, T1.Tran_Estado, T1.Tran_CentroCostoIdDestino" ;
      scmdbuf = scmdbuf + " AS Tran_CentroCostoIdDestino, T1.Tran_CentroCostoId AS Tran_CentroCostoId, T1.Tran_NumeroGrupo," ;
      scmdbuf = scmdbuf + " T1.Tran_Detalle, T8.Regi_Abrev AS Tran_RegionAbrevDestino, T9.Regi_Abrev AS Tran_RegionAbrev," ;
      scmdbuf = scmdbuf + " T1.Tran_CantidadPadres, T1.Tran_TipoEntra, T8.Regi_Cod AS Tran_RegionCodigoDestino," ;
      scmdbuf = scmdbuf + " T1.Tran_RegionIdDestino AS Tran_RegionIdDestino, T6.Cent_Descripcion AS Tran_CentroCostoDescripcionDes," ;
      scmdbuf = scmdbuf + " T6.Cent_Codigo AS Tran_CentroCostoCodigoDestino, T8.Regi_Descripcion AS Tran_RegionDescripcionDestino," ;
      scmdbuf = scmdbuf + " T1.Tran_NumeroIngreso, T1.Tran_TipoElemento, T2.Tipo_Codigo AS Tran_CodTipoElemento," ;
      scmdbuf = scmdbuf + " T1.Tran_ValorTransaccion, T1.Tran_IndE_S AS Tran_IndE_S, T9.Regi_Cod AS Tran_RegionCodigo," ;
      scmdbuf = scmdbuf + " T1.Tran_RegionId AS Tran_RegionId, T7.Cent_Descripcion AS Tran_CentroCostoDescripcion," ;
      ...
      scmdbuf = scmdbuf + " T1.Tran_CodBodeOrigen, T1.Tran_CodAlmaOrigen, T1.Tran_ModuloOrigen, T7.Cent_Codigo" ;
      scmdbuf = scmdbuf + " AS Tran_CentroCostoCodigo, T9.Regi_Descripcion AS Tran_RegionDescripcion FROM (((((((((ALM_TRANSACCION" ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H007X2(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).longValue() , (String)dynConstraints[1] , ((Number) dynConstraints[2]).longValue() , ((Number) dynConstraints[3]).longValue() , ((Number) dynConstraints[4]).longValue() , (String)dynConstraints[5] , (String)dynConstraints[6] , ((Number) dynConstraints[7]).longValue() , (String)dynConstraints[8] , ((Number) dynConstraints[9]).longValue() , ((Number) dynConstraints[10]).longValue() , ((Number) dynConstraints[11]).longValue() , (String)dynConstraints[12] , (String)dynConstraints[13] , (String)dynConstraints[14] , (String)dynConstraints[15] , (java.util.Date)dynConstraints[16] , (java.util.Date)dynConstraints[17] , (String)dynConstraints[18] , (String)dynConstraints[19] , (String)dynConstraints[20] , (String)dynConstraints[21] , (String)dynConstraints[22] , (String)dynConstraints[23] , (String)dynConstraints[24] , (String)dynConstraints[25] , (String)dynConstraints[26] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H007X2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H007X3", "SELECT Cent_Id, Usua_Id FROM SEG_USUARIO_CENTRO WHERE Usua_Id = ? and Cent_Id = ? ORDER BY Usua_Id, Cent_Id ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
                           ...
                           Object[] buf ) throws SQLException
   {
      switch ( cursor )
      {
            case 0 :
               ...
               ((String[]) buf[39])[0] = rslt.getString(22, 4) ;
               ...
               ((java.util.Date[]) buf[74])[0] = rslt.getGXDateTime(40) ;
               ((boolean[]) buf[75])[0] = rslt.wasNull();
               ((long[]) buf[76])[0] = rslt.getLong(41) ;
               ((long[]) buf[77])[0] = rslt.getLong(42) ;
               ((boolean[]) buf[78])[0] = rslt.wasNull();
               ((String[]) buf[79])[0] = rslt.getVarchar(43) ;
               ((String[]) buf[80])[0] = rslt.getVarchar(44) ;
               ((String[]) buf[81])[0] = rslt.getVarchar(45) ;
               ((String[]) buf[82])[0] = rslt.getVarchar(46) ;
               ((String[]) buf[83])[0] = rslt.getVarchar(47) ;
               ((String[]) buf[84])[0] = rslt.getVarchar(48) ;
               ((String[]) buf[85])[0] = rslt.getVarchar(49) ;
                              ...
                              Object[] parms ) throws SQLException
   {
      ...
      switch ( cursor )
      {
            case 0 :
               ...
               {
                  sIdx = (short)(sIdx+1) ;
                  stmt.setVarchar(sIdx, (String)parms[13], 41);
               }
               return;
            case 1 :
