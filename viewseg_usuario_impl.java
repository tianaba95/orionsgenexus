...
public final  class viewseg_usuario_impl extends GXDataArea
{
   public viewseg_usuario_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public viewseg_usuario_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( viewseg_usuario_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV13Usua_Id = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV13Usua_Id", GXutil.ltrim( GXutil.str( AV13Usua_Id, 18, 0)));
            httpContext.ajax_rsp_assign_attri("", false, "gxhash_vUSUA_ID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV13Usua_Id), "ZZZZZZZZZZZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414193066");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.viewseg_usuario") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13Usua_Id,18,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV7TabCode))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vUSUA_ID", GXutil.ltrim( localUtil.ntoc( AV13Usua_Id, (byte)(18), (byte)(0), ",", "")));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_vUSUA_ID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV13Usua_Id), "ZZZZZZZZZZZZZZZZZ9")));
      ...
      forbiddenHiddens = "hsh" + "ViewSEG_USUARIO" ;
      forbiddenHiddens = forbiddenHiddens + GXutil.rtrim( localUtil.format( A25Usua_Nombre, "")) ;
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "hsh", GXutil.getEncryptedSignature( forbiddenHiddens, GXKey));
      GXutil.writeLogln("viewseg_usuario:[SendSecurityCheck]"+forbiddenHiddens);
   }
   ...
   {
      return formatLink("com.orions2.viewseg_usuario") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13Usua_Id,18,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV7TabCode)) ;
   }

   public String getPgmname( )
   {
      return "ViewSEG_USUARIO" ;
   }
   ...
   public void wb3T0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, "Usuario Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_ViewSEG_USUARIO.htm");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblViewall_Internalname, "Work With Usuarios", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, (short)(0), "HLP_ViewSEG_USUARIO.htm");
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtUsua_Nombre_Internalname, A25Usua_Nombre, GXutil.rtrim( localUtil.format( A25Usua_Nombre, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtUsua_Nombre_Jsonclick, 0, "ReadonlyAttribute", "", "", "", 1, edtUsua_Nombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "Nombres", "left", true, "HLP_ViewSEG_USUARIO.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewSEG_USUARIO.htm");
         /* Div Control */
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblSeg_usuario_centro_title_Internalname, "Usuario y Roles", "", "", lblSeg_usuario_centro_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewSEG_USUARIO.htm");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         ...
         {
            /* WebComponent */
            com.orions2.GxWebStd.gx_hidden_field( httpContext, "W0037"+"", GXutil.rtrim( WebComp_Seg_usuario_centrowc_Component));
            httpContext.writeText( "<div") ;
            com.orions2.GxWebStd.classAttribute( httpContext, "gxwebcomponent");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblSeg_usuario_rol_title_Internalname, "Usuario y Roles", "", "", lblSeg_usuario_rol_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewSEG_USUARIO.htm");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         ...
         {
            /* WebComponent */
            com.orions2.GxWebStd.gx_hidden_field( httpContext, "W0045"+"", GXutil.rtrim( WebComp_Seg_usuario_rolwc_Component));
            httpContext.writeText( "<div") ;
            com.orions2.GxWebStd.classAttribute( httpContext, "gxwebcomponent");
            httpContext.writeText( " id=\""+"gxHTMLWrpW0045"+""+"\""+"") ;
            httpContext.writeText( ">") ;
            if ( GXutil.len( WebComp_Seg_usuario_rolwc_Component) != 0 )
            {
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblAlm_transaccion_title_Internalname, "Usuario Transaccion", "", "", lblAlm_transaccion_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewSEG_USUARIO.htm");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblSeg_usuariocentro_title_Internalname, "Usuario Centro de Costo", "", "", lblSeg_usuariocentro_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewSEG_USUARIO.htm");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         ...
         {
            /* WebComponent */
            com.orions2.GxWebStd.gx_hidden_field( httpContext, "W0061"+"", GXutil.rtrim( WebComp_Seg_usuariocentrowc_Component));
            httpContext.writeText( "<div") ;
            com.orions2.GxWebStd.classAttribute( httpContext, "gxwebcomponent");
   ...
   public void start3T2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "View SEG_USUARIO", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
            ...
            if ( GXutil.len( sEvt) > 0 )
            {
               ...
               if ( GXutil.strcmp(sEvtType, "M") != 0 )
               {
                  ...
                  else if ( GXutil.strcmp(sEvtType, "W") == 0 )
                  {
                     ...
                     {
                        OldSeg_usuario_centrowc = httpContext.cgiGet( "W0037") ;
                        ...
                        if ( GXutil.len( WebComp_Seg_usuario_centrowc_Component) != 0 )
                        {
                           WebComp_Seg_usuario_centrowc.componentprocess("W0037", "", sEvt);
                        }
                        WebComp_Seg_usuario_centrowc_Component = OldSeg_usuario_centrowc ;
                     }
                     else if ( nCmpId == 45 )
                     {
                        OldSeg_usuario_rolwc = httpContext.cgiGet( "W0045") ;
                        ...
                        if ( GXutil.len( WebComp_Seg_usuario_rolwc_Component) != 0 )
                        {
                           WebComp_Seg_usuario_rolwc.componentprocess("W0045", "", sEvt);
                        }
                        WebComp_Seg_usuario_rolwc_Component = OldSeg_usuario_rolwc ;
                     }
                     else if ( nCmpId == 53 )
                     ...
                     {
                        OldSeg_usuariocentrowc = httpContext.cgiGet( "W0061") ;
                        ...
                        if ( GXutil.len( WebComp_Seg_usuariocentrowc_Component) != 0 )
                        {
                           WebComp_Seg_usuariocentrowc.componentprocess("W0061", "", sEvt);
                        }
                        WebComp_Seg_usuariocentrowc_Component = OldSeg_usuariocentrowc ;
                     }
                  }
   ...
   public void rf3T2( )
   {
      ...
      {
         /* Using cursor H003T2 */
         pr_default.execute(0, new Object[] {new Long(AV13Usua_Id)});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A23Usua_Id = H003T2_A23Usua_Id[0] ;
            A25Usua_Nombre = H003T2_A25Usua_Nombre[0] ;
   ...
   public void strup3T0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         httpContext.ajax_rsp_assign_attri("", false, "gxhash_USUA_NOMBRE", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A25Usua_Nombre, ""))));
         /* Read saved values. */
         AV13Usua_Id = localUtil.ctol( httpContext.cgiGet( "vUSUA_ID"), ",", ".") ;
         ...
         if ( ! GXutil.checkEncryptedSignature( forbiddenHiddens, hsh, GXKey) )
         {
            ...
            GXutil.writeLog("viewseg_usuario:[SecurityCheckFailed]"+forbiddenHiddens);
            return  ;
         }
      }
      else
   ...
   public void e113T2( )
   {
      ...
      AV17GXLvl6 = (byte)(0) ;
      /* Using cursor H003T3 */
      pr_default.execute(1, new Object[] {new Long(AV13Usua_Id)});
      while ( (pr_default.getStatus(1) != 101) )
      {
         A23Usua_Id = H003T3_A23Usua_Id[0] ;
         A25Usua_Nombre = H003T3_A25Usua_Nombre[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A25Usua_Nombre", A25Usua_Nombre);
         httpContext.ajax_rsp_assign_attri("", false, "gxhash_USUA_NOMBRE", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A25Usua_Nombre, ""))));
         AV17GXLvl6 = (byte)(1) ;
         Form.setCaption( A25Usua_Nombre );
         httpContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.getCaption(), true);
         lblViewall_Link = formatLink("com.orions2.wwseg_usuario")  ;
   ...
   public void S112( )
   {
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "SEG_USUARIOGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.orions2.seg_usuariogeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "SEG_USUARIOGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0029","",new Long(AV13Usua_Id)});
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Seg_usuario_centrowc_Component), GXutil.lower( "SEG_USUARIOSEG_USUARIO_CENTROWC")) != 0 )
         {
            WebComp_Seg_usuario_centrowc = WebUtils.getWebComponent(getClass(), "com.orions2.seg_usuarioseg_usuario_centrowc_impl", remoteHandle, context);
            WebComp_Seg_usuario_centrowc_Component = "SEG_USUARIOSEG_USUARIO_CENTROWC" ;
         }
         if ( GXutil.len( WebComp_Seg_usuario_centrowc_Component) != 0 )
         {
            WebComp_Seg_usuario_centrowc.setjustcreated();
            WebComp_Seg_usuario_centrowc.componentprepare(new Object[] {"W0037","",new Long(AV13Usua_Id)});
      ...
      if ( AV12LoadAllTabs || ( GXutil.strcmp(AV8SelectedTabCode, "SEG_USUARIO_ROL") == 0 ) )
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Seg_usuario_rolwc_Component), GXutil.lower( "SEG_USUARIOSEG_USUARIO_ROLWC")) != 0 )
         {
            WebComp_Seg_usuario_rolwc = WebUtils.getWebComponent(getClass(), "com.orions2.seg_usuarioseg_usuario_rolwc_impl", remoteHandle, context);
            WebComp_Seg_usuario_rolwc_Component = "SEG_USUARIOSEG_USUARIO_ROLWC" ;
         }
         if ( GXutil.len( WebComp_Seg_usuario_rolwc_Component) != 0 )
         {
            WebComp_Seg_usuario_rolwc.setjustcreated();
            WebComp_Seg_usuario_rolwc.componentprepare(new Object[] {"W0045","",new Long(AV13Usua_Id)});
            WebComp_Seg_usuario_rolwc.componentbind(new Object[] {""});
         }
         if ( isFullAjaxMode( ) )
         {
            httpContext.ajax_rspStartCmp("gxHTMLWrpW0045"+"");
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Alm_transaccionwc_Component), GXutil.lower( "SEG_USUARIOALM_TRANSACCIONWC")) != 0 )
         {
            WebComp_Alm_transaccionwc = WebUtils.getWebComponent(getClass(), "com.orions2.seg_usuarioalm_transaccionwc_impl", remoteHandle, context);
            WebComp_Alm_transaccionwc_Component = "SEG_USUARIOALM_TRANSACCIONWC" ;
         }
         if ( GXutil.len( WebComp_Alm_transaccionwc_Component) != 0 )
         {
            WebComp_Alm_transaccionwc.setjustcreated();
            WebComp_Alm_transaccionwc.componentprepare(new Object[] {"W0053","",new Long(AV13Usua_Id)});
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Seg_usuariocentrowc_Component), GXutil.lower( "SEG_USUARIOSEG_USUARIOCENTROWC")) != 0 )
         {
            WebComp_Seg_usuariocentrowc = WebUtils.getWebComponent(getClass(), "com.orions2.seg_usuarioseg_usuariocentrowc_impl", remoteHandle, context);
            WebComp_Seg_usuariocentrowc_Component = "SEG_USUARIOSEG_USUARIOCENTROWC" ;
         }
         if ( GXutil.len( WebComp_Seg_usuariocentrowc_Component) != 0 )
         {
            WebComp_Seg_usuariocentrowc.setjustcreated();
            WebComp_Seg_usuariocentrowc.componentprepare(new Object[] {"W0061","",new Long(AV13Usua_Id)});
   ...
   {
      AV13Usua_Id = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV13Usua_Id", GXutil.ltrim( GXutil.str( AV13Usua_Id, 18, 0)));
      httpContext.ajax_rsp_assign_attri("", false, "gxhash_vUSUA_ID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV13Usua_Id), "ZZZZZZZZZZZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414193118");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("viewseg_usuario.js", "?201861414193118");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "");
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "View SEG_USUARIO" );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   public void initialize( )
   {
      ...
      AV16Pgmname = "" ;
      scmdbuf = "" ;
      H003T2_A23Usua_Id = new long[1] ;
      H003T2_A25Usua_Nombre = new String[] {""} ;
      hsh = "" ;
      H003T3_A23Usua_Id = new long[1] ;
      H003T3_A25Usua_Nombre = new String[] {""} ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.viewseg_usuario__default(),
         new Object[] {
             new Object[] {
            H003T2_A23Usua_Id, H003T2_A25Usua_Nombre
            }
            , new Object[] {
            H003T3_A23Usua_Id, H003T3_A25Usua_Nombre
            }
         }
      );
      AV16Pgmname = "ViewSEG_USUARIO" ;
   ...
   private int idxLst ;
   private long wcpOAV13Usua_Id ;
   private long AV13Usua_Id ;
   ...
   private long[] H003T2_A23Usua_Id ;
   private String[] H003T2_A25Usua_Nombre ;
   private long[] H003T3_A23Usua_Id ;
   private String[] H003T3_A25Usua_Nombre ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class viewseg_usuario__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H003T2", "SELECT Usua_Id, Usua_Nombre FROM SEG_USUARIO WHERE Usua_Id = ? ORDER BY Usua_Id ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H003T3", "SELECT Usua_Id, Usua_Nombre FROM SEG_USUARIO WHERE Usua_Id = ? ORDER BY Usua_Id ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
