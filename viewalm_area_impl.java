/*
               File: viewalm_area_impl
        Description: View ALM_AREA
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:18:1.1
...
public final  class viewalm_area_impl extends GXDataArea
{
   public viewalm_area_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public viewalm_area_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( viewalm_area_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV13BArea_Codigo = gxfirstwebparm ;
            httpContext.ajax_rsp_assign_attri("", false, "AV13BArea_Codigo", AV13BArea_Codigo);
            httpContext.ajax_rsp_assign_attri("", false, "gxhash_vBAREA_CODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13BArea_Codigo, ""))));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2018614141815");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.viewalm_area") + "?" + GXutil.URLEncode(GXutil.rtrim(AV13BArea_Codigo)) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV14Cent_Id,11,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV7TabCode))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vBAREA_CODIGO", AV13BArea_Codigo);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_vBAREA_CODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13BArea_Codigo, ""))));
      ...
      forbiddenHiddens = "hsh" + "ViewALM_AREA" ;
      forbiddenHiddens = forbiddenHiddens + GXutil.rtrim( localUtil.format( A610BArea_Descripcion, "")) ;
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "hsh", GXutil.getEncryptedSignature( forbiddenHiddens, GXKey));
      GXutil.writeLogln("viewalm_area:[SendSecurityCheck]"+forbiddenHiddens);
   }
   ...
   {
      return formatLink("com.orions2.viewalm_area") + "?" + GXutil.URLEncode(GXutil.rtrim(AV13BArea_Codigo)) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV14Cent_Id,11,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV7TabCode)) ;
   }
   ...
   public void wb180( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, "ALAMCEN AREA Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_ViewALM_AREA.htm");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblViewall_Internalname, "Work With ALAMCEN AREAS", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, (short)(0), "HLP_ViewALM_AREA.htm");
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtBArea_Descripcion_Internalname, A610BArea_Descripcion, GXutil.rtrim( localUtil.format( A610BArea_Descripcion, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBArea_Descripcion_Jsonclick, 0, "ReadonlyAttribute", "", "", "", 1, edtBArea_Descripcion_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_ViewALM_AREA.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewALM_AREA.htm");
         /* Div Control */
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblBodegas_title_Internalname, "Almacén", "", "", lblBodegas_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewALM_AREA.htm");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
   ...
   public void start182( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "View ALM_AREA", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf182( )
   {
      ...
      {
         /* Using cursor H00182 */
         pr_default.execute(0, new Object[] {AV13BArea_Codigo, new Long(AV14Cent_Id)});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A1Cent_Id = H00182_A1Cent_Id[0] ;
            A32BArea_Codigo = H00182_A32BArea_Codigo[0] ;
            A610BArea_Descripcion = H00182_A610BArea_Descripcion[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A610BArea_Descripcion", A610BArea_Descripcion);
            httpContext.ajax_rsp_assign_attri("", false, "gxhash_BAREA_DESCRIPCION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A610BArea_Descripcion, ""))));
            /* Execute user event: Load */
            e12182 ();
   ...
   public void strup180( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         httpContext.ajax_rsp_assign_attri("", false, "gxhash_BAREA_DESCRIPCION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A610BArea_Descripcion, ""))));
         /* Read saved values. */
         AV13BArea_Codigo = httpContext.cgiGet( "vBAREA_CODIGO") ;
         ...
         if ( ! GXutil.checkEncryptedSignature( forbiddenHiddens, hsh, GXKey) )
         {
            ...
            GXutil.writeLog("viewalm_area:[SecurityCheckFailed]"+forbiddenHiddens);
            return  ;
         }
      }
      else
   ...
   public void e11182( )
   {
      ...
      AV18GXLvl6 = (byte)(0) ;
      /* Using cursor H00183 */
      pr_default.execute(1, new Object[] {AV13BArea_Codigo, new Long(AV14Cent_Id), AV13BArea_Codigo, new Long(AV14Cent_Id)});
      while ( (pr_default.getStatus(1) != 101) )
      {
         A1Cent_Id = H00183_A1Cent_Id[0] ;
         A32BArea_Codigo = H00183_A32BArea_Codigo[0] ;
         A610BArea_Descripcion = H00183_A610BArea_Descripcion[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A610BArea_Descripcion", A610BArea_Descripcion);
         httpContext.ajax_rsp_assign_attri("", false, "gxhash_BAREA_DESCRIPCION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A610BArea_Descripcion, ""))));
         AV18GXLvl6 = (byte)(1) ;
         Form.setCaption( A610BArea_Descripcion );
         httpContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.getCaption(), true);
         lblViewall_Link = formatLink("com.orions2.wwalm_area")  ;
   ...
   public void S112( )
   {
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "ALM_AREAGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.orions2.alm_areageneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "ALM_AREAGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0029","",AV13BArea_Codigo,new Long(AV14Cent_Id)});
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Bodegaswc_Component), GXutil.lower( "ALM_AREABODEGASWC")) != 0 )
         {
            WebComp_Bodegaswc = WebUtils.getWebComponent(getClass(), "com.orions2.alm_areabodegaswc_impl", remoteHandle, context);
            WebComp_Bodegaswc_Component = "ALM_AREABODEGASWC" ;
         }
         if ( GXutil.len( WebComp_Bodegaswc_Component) != 0 )
         {
            WebComp_Bodegaswc.setjustcreated();
            WebComp_Bodegaswc.componentprepare(new Object[] {"W0037","",AV13BArea_Codigo,new Long(AV14Cent_Id)});
   ...
   {
      AV13BArea_Codigo = (String)getParm(obj,0) ;
      httpContext.ajax_rsp_assign_attri("", false, "AV13BArea_Codigo", AV13BArea_Codigo);
      httpContext.ajax_rsp_assign_attri("", false, "gxhash_vBAREA_CODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV13BArea_Codigo, ""))));
      AV14Cent_Id = ((Number) GXutil.testNumericType( getParm(obj,1), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV14Cent_Id", GXutil.ltrim( GXutil.str( AV14Cent_Id, 11, 0)));
      httpContext.ajax_rsp_assign_attri("", false, "gxhash_vCENT_ID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV14Cent_Id), "ZZZZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20186141418137");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("viewalm_area.js", "?20186141418139");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H00182_A1Cent_Id = new long[1] ;
      H00182_A32BArea_Codigo = new String[] {""} ;
      H00182_A610BArea_Descripcion = new String[] {""} ;
      A32BArea_Codigo = "" ;
      hsh = "" ;
      H00183_A1Cent_Id = new long[1] ;
      H00183_A32BArea_Codigo = new String[] {""} ;
      H00183_A610BArea_Descripcion = new String[] {""} ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.viewalm_area__default(),
         new Object[] {
             new Object[] {
            H00182_A1Cent_Id, H00182_A32BArea_Codigo, H00182_A610BArea_Descripcion
            }
            , new Object[] {
            H00183_A1Cent_Id, H00183_A32BArea_Codigo, H00183_A610BArea_Descripcion
            }
         }
      );
      AV17Pgmname = "ViewALM_AREA" ;
   ...
   private String wcpOAV13BArea_Codigo ;
   private String AV13BArea_Codigo ;
   ...
   private long[] H00182_A1Cent_Id ;
   private String[] H00182_A32BArea_Codigo ;
   private String[] H00182_A610BArea_Descripcion ;
   private long[] H00183_A1Cent_Id ;
   private String[] H00183_A32BArea_Codigo ;
   private String[] H00183_A610BArea_Descripcion ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class viewalm_area__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00182", "SELECT Cent_Id, BArea_Codigo, BArea_Descripcion FROM ALM_AREA WHERE BArea_Codigo = ? and Cent_Id = ? ORDER BY BArea_Codigo, Cent_Id ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H00183", "SELECT Cent_Id, BArea_Codigo, BArea_Descripcion FROM ALM_AREA WHERE (BArea_Codigo = ? and Cent_Id = ?) AND (BArea_Codigo = ? and Cent_Id = ?) ORDER BY BArea_Codigo, Cent_Id ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
