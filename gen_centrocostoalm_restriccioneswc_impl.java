/*
               File: gen_centrocostoalm_restriccioneswc_impl
        Description: GEN_CENTROCOSTOALM_RESTRICCIONESWC
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:14:19.52
...
public final  class gen_centrocostoalm_restriccioneswc_impl extends GXWebComponent
{
   public gen_centrocostoalm_restriccioneswc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public gen_centrocostoalm_restriccioneswc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( gen_centrocostoalm_restriccioneswc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV7Mbod_CentCostoId = GXutil.lval( httpContext.GetNextPar( )) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Mbod_CentCostoId", GXutil.ltrim( GXutil.str( AV7Mbod_CentCostoId, 11, 0)));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,new Long(AV7Mbod_CentCostoId)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Mbod_CentCostoId, AV12Update, AV13Delete, A60Mbod_Id, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "GEN_CENTROCOSTOALM_RESTRICCIONESWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414141960");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.gen_centrocostoalm_restriccioneswc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Mbod_CentCostoId,11,0)))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV7Mbod_CentCostoId", GXutil.ltrim( localUtil.ntoc( wcpOAV7Mbod_CentCostoId, (byte)(11), (byte)(0), ",", "")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vMBOD_CENTCOSTOID", GXutil.ltrim( localUtil.ntoc( AV7Mbod_CentCostoId, (byte)(11), (byte)(0), ",", "")));
   ...
   public void renderHtmlCloseForm0H2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("gen_centrocostoalm_restriccioneswc.js", "?201861414141962");
      }
   ...
   {
      return "GEN_CENTROCOSTOALM_RESTRICCIONESWC" ;
   }
   ...
   public void wb0H0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.gen_centrocostoalm_restriccioneswc");
         }
         /* Div Control */
      ...
      if ( wbEnd == 20 )
      {
         ...
         com.orions2.GxWebStd.gx_label_element( httpContext, edtMbod_CentCostoId_Internalname, "Centro de Costo Id", "col-sm-3 AttributeLabel", 0, true);
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtMbod_CentCostoId_Internalname, GXutil.ltrim( localUtil.ntoc( A63Mbod_CentCostoId, (byte)(11), (byte)(0), ",", "")), ((edtMbod_CentCostoId_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A63Mbod_CentCostoId), "ZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A63Mbod_CentCostoId), "ZZZZZZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtMbod_CentCostoId_Jsonclick, 0, "Attribute", "", "", "", edtMbod_CentCostoId_Visible, edtMbod_CentCostoId_Enabled, 0, "text", "", 11, "chr", 1, "row", 11, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Identificador", "right", false, "HLP_GEN_CENTROCOSTOALM_RESTRICCIONESWC.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start0H2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "GEN_CENTROCOSTOALM_RESTRICCIONESWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "GEN_CENTROCOSTOALM_RESTRICCIONESWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf0H2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H000H2 */
         pr_default.execute(0, new Object[] {new Long(AV7Mbod_CentCostoId), new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_20_idx = (short)(1) ;
         sGXsfl_20_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_20_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_202( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A63Mbod_CentCostoId = H000H2_A63Mbod_CentCostoId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A63Mbod_CentCostoId", GXutil.ltrim( GXutil.str( A63Mbod_CentCostoId, 11, 0)));
            A361Mbod_UsuarioModifica = H000H2_A361Mbod_UsuarioModifica[0] ;
            A362Mbod_FechaModifica = H000H2_A362Mbod_FechaModifica[0] ;
            A359Mbod_UsuarioCrea = H000H2_A359Mbod_UsuarioCrea[0] ;
            A433Mbod_FechaCrea = H000H2_A433Mbod_FechaCrea[0] ;
            A434Mbod_Estado = H000H2_A434Mbod_Estado[0] ;
            A65Mbod_BodDestinoCodigo = H000H2_A65Mbod_BodDestinoCodigo[0] ;
            A345Mbod_AlmDestinoCodigo = H000H2_A345Mbod_AlmDestinoCodigo[0] ;
            A368Mbod_AlmModDestino = H000H2_A368Mbod_AlmModDestino[0] ;
            A64Mbod_BodOrigenCodigo = H000H2_A64Mbod_BodOrigenCodigo[0] ;
            A342Mbod_AlmOrigenCodigo = H000H2_A342Mbod_AlmOrigenCodigo[0] ;
            A364Mbod_AlmModOrigen = H000H2_A364Mbod_AlmModOrigen[0] ;
            A427Mbod_RegionDescripcion = H000H2_A427Mbod_RegionDescripcion[0] ;
            n427Mbod_RegionDescripcion = H000H2_n427Mbod_RegionDescripcion[0] ;
            A426Mbod_RegionCodigo = H000H2_A426Mbod_RegionCodigo[0] ;
            n426Mbod_RegionCodigo = H000H2_n426Mbod_RegionCodigo[0] ;
            A62Mbod_RegionId = H000H2_A62Mbod_RegionId[0] ;
            A432Mbod_TipoElementoDesc = H000H2_A432Mbod_TipoElementoDesc[0] ;
            n432Mbod_TipoElementoDesc = H000H2_n432Mbod_TipoElementoDesc[0] ;
            A431Mbod_TipoElementoCod = H000H2_A431Mbod_TipoElementoCod[0] ;
            n431Mbod_TipoElementoCod = H000H2_n431Mbod_TipoElementoCod[0] ;
            A428Mbod_TipoMovDescrip = H000H2_A428Mbod_TipoMovDescrip[0] ;
            n428Mbod_TipoMovDescrip = H000H2_n428Mbod_TipoMovDescrip[0] ;
            A61Mbod_TipoMovCodigo = H000H2_A61Mbod_TipoMovCodigo[0] ;
            A60Mbod_Id = H000H2_A60Mbod_Id[0] ;
            A427Mbod_RegionDescripcion = H000H2_A427Mbod_RegionDescripcion[0] ;
            n427Mbod_RegionDescripcion = H000H2_n427Mbod_RegionDescripcion[0] ;
            A426Mbod_RegionCodigo = H000H2_A426Mbod_RegionCodigo[0] ;
            n426Mbod_RegionCodigo = H000H2_n426Mbod_RegionCodigo[0] ;
   ...
   public void strup0H0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV7Mbod_CentCostoId = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV7Mbod_CentCostoId"), ",", ".") ;
   ...
   public void e120H2( )
   {
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext, !bGXsfl_20_Refreshing);
      edtMbod_CentCostoId_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtMbod_CentCostoId_Internalname, "Visible", GXutil.ltrim( GXutil.str( edtMbod_CentCostoId_Visible, 5, 0)), true);
   ...
   public void S112( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributename( "Mbod_CentCostoId" );
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( GXutil.str( AV7Mbod_CentCostoId, 11, 0) );
   ...
   {
      AV7Mbod_CentCostoId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Mbod_CentCostoId", GXutil.ltrim( GXutil.str( AV7Mbod_CentCostoId, 11, 0)));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV7Mbod_CentCostoId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "gen_centrocostoalm_restriccioneswc");
      ...
      {
         AV7Mbod_CentCostoId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Mbod_CentCostoId", GXutil.ltrim( GXutil.str( AV7Mbod_CentCostoId, 11, 0)));
      }
      wcpOAV7Mbod_CentCostoId = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV7Mbod_CentCostoId"), ",", ".") ;
      if ( ! GetJustCreated( ) && ( ( AV7Mbod_CentCostoId != wcpOAV7Mbod_CentCostoId ) ) )
      {
         setjustcreated();
      }
      wcpOAV7Mbod_CentCostoId = AV7Mbod_CentCostoId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV7Mbod_CentCostoId = httpContext.cgiGet( sPrefix+"AV7Mbod_CentCostoId_CTRL") ;
      if ( GXutil.len( sCtrlAV7Mbod_CentCostoId) > 0 )
      {
         AV7Mbod_CentCostoId = localUtil.ctol( httpContext.cgiGet( sCtrlAV7Mbod_CentCostoId), ",", ".") ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Mbod_CentCostoId", GXutil.ltrim( GXutil.str( AV7Mbod_CentCostoId, 11, 0)));
      }
      else
      {
         AV7Mbod_CentCostoId = localUtil.ctol( httpContext.cgiGet( sPrefix+"AV7Mbod_CentCostoId_PARM"), ",", ".") ;
      }
   }
   ...
   {
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Mbod_CentCostoId_PARM", GXutil.ltrim( localUtil.ntoc( AV7Mbod_CentCostoId, (byte)(11), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV7Mbod_CentCostoId)) > 0 )
      {
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Mbod_CentCostoId_CTRL", GXutil.rtrim( sCtrlAV7Mbod_CentCostoId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414142037");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("gen_centrocostoalm_restriccioneswc.js", "?201861414142037");
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Mbod_CentCostoId',fld:'vMBOD_CENTCOSTOID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV12Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV13Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A60Mbod_Id',fld:'MBOD_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e130H2',iparms:[{av:'A60Mbod_Id',fld:'MBOD_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtMbod_TipoMovCodigo_Link',ctrl:'MBOD_TIPOMOVCODIGO',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e110H2',iparms:[{av:'A60Mbod_Id',fld:'MBOD_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H000H2_A63Mbod_CentCostoId = new long[1] ;
      H000H2_A361Mbod_UsuarioModifica = new String[] {""} ;
      H000H2_A362Mbod_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H000H2_A359Mbod_UsuarioCrea = new String[] {""} ;
      H000H2_A433Mbod_FechaCrea = new java.util.Date[] {GXutil.nullDate()} ;
      H000H2_A434Mbod_Estado = new String[] {""} ;
      H000H2_A65Mbod_BodDestinoCodigo = new String[] {""} ;
      H000H2_A345Mbod_AlmDestinoCodigo = new String[] {""} ;
      H000H2_A368Mbod_AlmModDestino = new String[] {""} ;
      H000H2_A64Mbod_BodOrigenCodigo = new String[] {""} ;
      H000H2_A342Mbod_AlmOrigenCodigo = new String[] {""} ;
      H000H2_A364Mbod_AlmModOrigen = new String[] {""} ;
      H000H2_A427Mbod_RegionDescripcion = new String[] {""} ;
      H000H2_n427Mbod_RegionDescripcion = new boolean[] {false} ;
      H000H2_A426Mbod_RegionCodigo = new short[1] ;
      H000H2_n426Mbod_RegionCodigo = new boolean[] {false} ;
      H000H2_A62Mbod_RegionId = new long[1] ;
      H000H2_A432Mbod_TipoElementoDesc = new String[] {""} ;
      H000H2_n432Mbod_TipoElementoDesc = new boolean[] {false} ;
      H000H2_A431Mbod_TipoElementoCod = new long[1] ;
      H000H2_n431Mbod_TipoElementoCod = new boolean[] {false} ;
      H000H2_A428Mbod_TipoMovDescrip = new String[] {""} ;
      H000H2_n428Mbod_TipoMovDescrip = new boolean[] {false} ;
      H000H2_A61Mbod_TipoMovCodigo = new String[] {""} ;
      H000H2_A60Mbod_Id = new long[1] ;
      H000H3_A31Bode_Codigo = new String[] {""} ;
      H000H4_A31Bode_Codigo = new String[] {""} ;
      ...
      sCtrlAV7Mbod_CentCostoId = "" ;
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.gen_centrocostoalm_restriccioneswc__default(),
         new Object[] {
             new Object[] {
            H000H2_A63Mbod_CentCostoId, H000H2_A361Mbod_UsuarioModifica, H000H2_A362Mbod_FechaModifica, H000H2_A359Mbod_UsuarioCrea, H000H2_A433Mbod_FechaCrea, H000H2_A434Mbod_Estado, H000H2_A65Mbod_BodDestinoCodigo, H000H2_A345Mbod_AlmDestinoCodigo, H000H2_A368Mbod_AlmModDestino, H000H2_A64Mbod_BodOrigenCodigo,
            H000H2_A342Mbod_AlmOrigenCodigo, H000H2_A364Mbod_AlmModOrigen, H000H2_A427Mbod_RegionDescripcion, H000H2_n427Mbod_RegionDescripcion, H000H2_A426Mbod_RegionCodigo, H000H2_n426Mbod_RegionCodigo, H000H2_A62Mbod_RegionId, H000H2_A432Mbod_TipoElementoDesc, H000H2_n432Mbod_TipoElementoDesc, H000H2_A431Mbod_TipoElementoCod,
            H000H2_n431Mbod_TipoElementoCod, H000H2_A428Mbod_TipoMovDescrip, H000H2_n428Mbod_TipoMovDescrip, H000H2_A61Mbod_TipoMovCodigo, H000H2_A60Mbod_Id
            }
            , new Object[] {
            H000H3_A31Bode_Codigo
            }
            , new Object[] {
            H000H4_A31Bode_Codigo
            }
         }
      );
      AV17Pgmname = "GEN_CENTROCOSTOALM_RESTRICCIONESWC" ;
   ...
   private int edtMbod_CentCostoId_Visible ;
   private int subGrid_Islastpage ;
   private int GXPagingFrom2 ;
   private int GXPagingTo2 ;
   private int idxLst ;
   private int subGrid_Backcolor ;
   private long wcpOAV7Mbod_CentCostoId ;
   private long AV7Mbod_CentCostoId ;
   ...
   private String sCtrlAV7Mbod_CentCostoId ;
   ...
   private long[] H000H2_A63Mbod_CentCostoId ;
   private String[] H000H2_A361Mbod_UsuarioModifica ;
   private java.util.Date[] H000H2_A362Mbod_FechaModifica ;
   private String[] H000H2_A359Mbod_UsuarioCrea ;
   private java.util.Date[] H000H2_A433Mbod_FechaCrea ;
   private String[] H000H2_A434Mbod_Estado ;
   private String[] H000H2_A65Mbod_BodDestinoCodigo ;
   private String[] H000H2_A345Mbod_AlmDestinoCodigo ;
   private String[] H000H2_A368Mbod_AlmModDestino ;
   private String[] H000H2_A64Mbod_BodOrigenCodigo ;
   private String[] H000H2_A342Mbod_AlmOrigenCodigo ;
   private String[] H000H2_A364Mbod_AlmModOrigen ;
   private String[] H000H2_A427Mbod_RegionDescripcion ;
   private boolean[] H000H2_n427Mbod_RegionDescripcion ;
   private short[] H000H2_A426Mbod_RegionCodigo ;
   private boolean[] H000H2_n426Mbod_RegionCodigo ;
   private long[] H000H2_A62Mbod_RegionId ;
   private String[] H000H2_A432Mbod_TipoElementoDesc ;
   private boolean[] H000H2_n432Mbod_TipoElementoDesc ;
   private long[] H000H2_A431Mbod_TipoElementoCod ;
   private boolean[] H000H2_n431Mbod_TipoElementoCod ;
   private String[] H000H2_A428Mbod_TipoMovDescrip ;
   private boolean[] H000H2_n428Mbod_TipoMovDescrip ;
   private String[] H000H2_A61Mbod_TipoMovCodigo ;
   private long[] H000H2_A60Mbod_Id ;
   private String[] H000H3_A31Bode_Codigo ;
   private String[] H000H4_A31Bode_Codigo ;
...
final  class gen_centrocostoalm_restriccioneswc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H000H2", "SELECT T1.Mbod_CentCostoId, T1.Mbod_UsuarioModifica, T1.Mbod_FechaModifica, T1.Mbod_UsuarioCrea, T1.Mbod_FechaCrea, T1.Mbod_Estado, T1.Mbod_BodDestinoCodigo, T1.Mbod_AlmDestinoCodigo, T1.Mbod_AlmModDestino, T1.Mbod_BodOrigenCodigo, T1.Mbod_AlmOrigenCodigo, T1.Mbod_AlmModOrigen, T2.Regi_Descripcion AS Mbod_RegionDescripcion, T2.Regi_Cod AS Mbod_RegionCodigo, T1.Mbod_RegionId AS Mbod_RegionId, T4.Tipo_Descripcion AS Mbod_TipoElementoDesc, T3.Tipo_Codigo AS Mbod_TipoElementoCod, T3.Tpmo_Descripcion AS Mbod_TipoMovDescrip, T1.Mbod_TipoMovCodigo AS Mbod_TipoMovCodigo, T1.Mbod_Id FROM (((ALM_RESTRICCIONES T1 INNER JOIN GEN_REGIONAL T2 ON T2.Regi_Id = T1.Mbod_RegionId) INNER JOIN ALM_TIPO_MOVIMIENTO T3 ON T3.Tpmo_Codigo = T1.Mbod_TipoMovCodigo) LEFT JOIN ALM_TIPO_ELEMENTO T4 ON T4.Tipo_Codigo = T3.Tipo_Codigo) WHERE T1.Mbod_CentCostoId = ? ORDER BY T1.Mbod_CentCostoId  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H000H3", "SELECT Bode_Codigo FROM ALM_BODEGA WHERE Bode_Codigo = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
         ,new ForEachCursor("H000H4", "SELECT Bode_Codigo FROM ALM_BODEGA WHERE Bode_Codigo = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
