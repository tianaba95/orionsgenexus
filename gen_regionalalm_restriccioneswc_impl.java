/*
               File: gen_regionalalm_restriccioneswc_impl
...
public final  class gen_regionalalm_restriccioneswc_impl extends GXWebComponent
{
   public gen_regionalalm_restriccioneswc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public gen_regionalalm_restriccioneswc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( gen_regionalalm_restriccioneswc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV7Mbod_RegionId = GXutil.lval( httpContext.GetNextPar( )) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Mbod_RegionId", GXutil.ltrim( GXutil.str( AV7Mbod_RegionId, 11, 0)));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,new Long(AV7Mbod_RegionId)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Mbod_RegionId, AV12Update, AV13Delete, A60Mbod_Id, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "GEN_REGIONALALM_RESTRICCIONESWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414141615");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.gen_regionalalm_restriccioneswc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Mbod_RegionId,11,0)))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV7Mbod_RegionId", GXutil.ltrim( localUtil.ntoc( wcpOAV7Mbod_RegionId, (byte)(11), (byte)(0), ",", "")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vMBOD_REGIONID", GXutil.ltrim( localUtil.ntoc( AV7Mbod_RegionId, (byte)(11), (byte)(0), ",", "")));
   ...
   public void renderHtmlCloseForm2M2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("gen_regionalalm_restriccioneswc.js", "?201861414141616");
      }
   ...
   public void wb2M0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.gen_regionalalm_restriccioneswc");
         }
         /* Div Control */
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_GEN_REGIONALALM_RESTRICCIONESWC.htm");
      ...
      if ( wbEnd == 20 )
      {
         ...
         com.orions2.GxWebStd.gx_label_element( httpContext, edtMbod_RegionId_Internalname, "Region Id", "col-sm-3 AttributeLabel", 0, true);
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtMbod_RegionId_Internalname, GXutil.ltrim( localUtil.ntoc( A62Mbod_RegionId, (byte)(11), (byte)(0), ",", "")), ((edtMbod_RegionId_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A62Mbod_RegionId), "ZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A62Mbod_RegionId), "ZZZZZZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtMbod_RegionId_Jsonclick, 0, "Attribute", "", "", "", edtMbod_RegionId_Visible, edtMbod_RegionId_Enabled, 0, "text", "", 11, "chr", 1, "row", 11, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Identificador", "right", false, "HLP_GEN_REGIONALALM_RESTRICCIONESWC.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start2M2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "GEN_REGIONALALM_RESTRICCIONESWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "GEN_REGIONALALM_RESTRICCIONESWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf2M2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H002M2 */
         pr_default.execute(0, new Object[] {new Long(AV7Mbod_RegionId), new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_20_idx = (short)(1) ;
         sGXsfl_20_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_20_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_202( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A62Mbod_RegionId = H002M2_A62Mbod_RegionId[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A62Mbod_RegionId", GXutil.ltrim( GXutil.str( A62Mbod_RegionId, 11, 0)));
            A361Mbod_UsuarioModifica = H002M2_A361Mbod_UsuarioModifica[0] ;
            A362Mbod_FechaModifica = H002M2_A362Mbod_FechaModifica[0] ;
            A359Mbod_UsuarioCrea = H002M2_A359Mbod_UsuarioCrea[0] ;
            A433Mbod_FechaCrea = H002M2_A433Mbod_FechaCrea[0] ;
            A434Mbod_Estado = H002M2_A434Mbod_Estado[0] ;
            A65Mbod_BodDestinoCodigo = H002M2_A65Mbod_BodDestinoCodigo[0] ;
            A345Mbod_AlmDestinoCodigo = H002M2_A345Mbod_AlmDestinoCodigo[0] ;
            A368Mbod_AlmModDestino = H002M2_A368Mbod_AlmModDestino[0] ;
            A64Mbod_BodOrigenCodigo = H002M2_A64Mbod_BodOrigenCodigo[0] ;
            A342Mbod_AlmOrigenCodigo = H002M2_A342Mbod_AlmOrigenCodigo[0] ;
            A364Mbod_AlmModOrigen = H002M2_A364Mbod_AlmModOrigen[0] ;
            A430Mbod_CentroCostoDescrip = H002M2_A430Mbod_CentroCostoDescrip[0] ;
            n430Mbod_CentroCostoDescrip = H002M2_n430Mbod_CentroCostoDescrip[0] ;
            A429Mbod_CentCostoCodigo = H002M2_A429Mbod_CentCostoCodigo[0] ;
            n429Mbod_CentCostoCodigo = H002M2_n429Mbod_CentCostoCodigo[0] ;
            A63Mbod_CentCostoId = H002M2_A63Mbod_CentCostoId[0] ;
            A432Mbod_TipoElementoDesc = H002M2_A432Mbod_TipoElementoDesc[0] ;
            n432Mbod_TipoElementoDesc = H002M2_n432Mbod_TipoElementoDesc[0] ;
            A431Mbod_TipoElementoCod = H002M2_A431Mbod_TipoElementoCod[0] ;
            n431Mbod_TipoElementoCod = H002M2_n431Mbod_TipoElementoCod[0] ;
            A428Mbod_TipoMovDescrip = H002M2_A428Mbod_TipoMovDescrip[0] ;
            n428Mbod_TipoMovDescrip = H002M2_n428Mbod_TipoMovDescrip[0] ;
            A61Mbod_TipoMovCodigo = H002M2_A61Mbod_TipoMovCodigo[0] ;
            A60Mbod_Id = H002M2_A60Mbod_Id[0] ;
            A430Mbod_CentroCostoDescrip = H002M2_A430Mbod_CentroCostoDescrip[0] ;
            n430Mbod_CentroCostoDescrip = H002M2_n430Mbod_CentroCostoDescrip[0] ;
            A429Mbod_CentCostoCodigo = H002M2_A429Mbod_CentCostoCodigo[0] ;
            n429Mbod_CentCostoCodigo = H002M2_n429Mbod_CentCostoCodigo[0] ;
   ...
   public void strup2M0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV7Mbod_RegionId = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV7Mbod_RegionId"), ",", ".") ;
   ...
   public void e122M2( )
   {
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext, !bGXsfl_20_Refreshing);
      edtMbod_RegionId_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtMbod_RegionId_Internalname, "Visible", GXutil.ltrim( GXutil.str( edtMbod_RegionId_Visible, 5, 0)), true);
   ...
   public void S112( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributename( "Mbod_RegionId" );
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( GXutil.str( AV7Mbod_RegionId, 11, 0) );
   ...
   {
      AV7Mbod_RegionId = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Mbod_RegionId", GXutil.ltrim( GXutil.str( AV7Mbod_RegionId, 11, 0)));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV7Mbod_RegionId = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "gen_regionalalm_restriccioneswc");
      ...
      {
         AV7Mbod_RegionId = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Mbod_RegionId", GXutil.ltrim( GXutil.str( AV7Mbod_RegionId, 11, 0)));
      }
      wcpOAV7Mbod_RegionId = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV7Mbod_RegionId"), ",", ".") ;
      if ( ! GetJustCreated( ) && ( ( AV7Mbod_RegionId != wcpOAV7Mbod_RegionId ) ) )
      {
         setjustcreated();
      }
      wcpOAV7Mbod_RegionId = AV7Mbod_RegionId ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV7Mbod_RegionId = httpContext.cgiGet( sPrefix+"AV7Mbod_RegionId_CTRL") ;
      if ( GXutil.len( sCtrlAV7Mbod_RegionId) > 0 )
      {
         AV7Mbod_RegionId = localUtil.ctol( httpContext.cgiGet( sCtrlAV7Mbod_RegionId), ",", ".") ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Mbod_RegionId", GXutil.ltrim( GXutil.str( AV7Mbod_RegionId, 11, 0)));
      }
      else
      {
         AV7Mbod_RegionId = localUtil.ctol( httpContext.cgiGet( sPrefix+"AV7Mbod_RegionId_PARM"), ",", ".") ;
      }
   }
   ...
   {
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Mbod_RegionId_PARM", GXutil.ltrim( localUtil.ntoc( AV7Mbod_RegionId, (byte)(11), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV7Mbod_RegionId)) > 0 )
      {
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Mbod_RegionId_CTRL", GXutil.rtrim( sCtrlAV7Mbod_RegionId));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414141694");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("gen_regionalalm_restriccioneswc.js", "?201861414141694");
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Mbod_RegionId',fld:'vMBOD_REGIONID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV12Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV13Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A60Mbod_Id',fld:'MBOD_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e132M2',iparms:[{av:'A60Mbod_Id',fld:'MBOD_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtMbod_TipoMovCodigo_Link',ctrl:'MBOD_TIPOMOVCODIGO',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e112M2',iparms:[{av:'A60Mbod_Id',fld:'MBOD_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H002M2_A62Mbod_RegionId = new long[1] ;
      H002M2_A361Mbod_UsuarioModifica = new String[] {""} ;
      H002M2_A362Mbod_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H002M2_A359Mbod_UsuarioCrea = new String[] {""} ;
      H002M2_A433Mbod_FechaCrea = new java.util.Date[] {GXutil.nullDate()} ;
      H002M2_A434Mbod_Estado = new String[] {""} ;
      H002M2_A65Mbod_BodDestinoCodigo = new String[] {""} ;
      H002M2_A345Mbod_AlmDestinoCodigo = new String[] {""} ;
      H002M2_A368Mbod_AlmModDestino = new String[] {""} ;
      H002M2_A64Mbod_BodOrigenCodigo = new String[] {""} ;
      H002M2_A342Mbod_AlmOrigenCodigo = new String[] {""} ;
      H002M2_A364Mbod_AlmModOrigen = new String[] {""} ;
      H002M2_A430Mbod_CentroCostoDescrip = new String[] {""} ;
      H002M2_n430Mbod_CentroCostoDescrip = new boolean[] {false} ;
      H002M2_A429Mbod_CentCostoCodigo = new String[] {""} ;
      H002M2_n429Mbod_CentCostoCodigo = new boolean[] {false} ;
      H002M2_A63Mbod_CentCostoId = new long[1] ;
      H002M2_A432Mbod_TipoElementoDesc = new String[] {""} ;
      H002M2_n432Mbod_TipoElementoDesc = new boolean[] {false} ;
      H002M2_A431Mbod_TipoElementoCod = new long[1] ;
      H002M2_n431Mbod_TipoElementoCod = new boolean[] {false} ;
      H002M2_A428Mbod_TipoMovDescrip = new String[] {""} ;
      H002M2_n428Mbod_TipoMovDescrip = new boolean[] {false} ;
      H002M2_A61Mbod_TipoMovCodigo = new String[] {""} ;
      H002M2_A60Mbod_Id = new long[1] ;
      H002M3_A31Bode_Codigo = new String[] {""} ;
      H002M4_A31Bode_Codigo = new String[] {""} ;
      ...
      sCtrlAV7Mbod_RegionId = "" ;
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.gen_regionalalm_restriccioneswc__default(),
         new Object[] {
             new Object[] {
            H002M2_A62Mbod_RegionId, H002M2_A361Mbod_UsuarioModifica, H002M2_A362Mbod_FechaModifica, H002M2_A359Mbod_UsuarioCrea, H002M2_A433Mbod_FechaCrea, H002M2_A434Mbod_Estado, H002M2_A65Mbod_BodDestinoCodigo, H002M2_A345Mbod_AlmDestinoCodigo, H002M2_A368Mbod_AlmModDestino, H002M2_A64Mbod_BodOrigenCodigo,
            H002M2_A342Mbod_AlmOrigenCodigo, H002M2_A364Mbod_AlmModOrigen, H002M2_A430Mbod_CentroCostoDescrip, H002M2_n430Mbod_CentroCostoDescrip, H002M2_A429Mbod_CentCostoCodigo, H002M2_n429Mbod_CentCostoCodigo, H002M2_A63Mbod_CentCostoId, H002M2_A432Mbod_TipoElementoDesc, H002M2_n432Mbod_TipoElementoDesc, H002M2_A431Mbod_TipoElementoCod,
            H002M2_n431Mbod_TipoElementoCod, H002M2_A428Mbod_TipoMovDescrip, H002M2_n428Mbod_TipoMovDescrip, H002M2_A61Mbod_TipoMovCodigo, H002M2_A60Mbod_Id
            }
            , new Object[] {
            H002M3_A31Bode_Codigo
            }
            , new Object[] {
            H002M4_A31Bode_Codigo
            }
         }
      );
      AV17Pgmname = "GEN_REGIONALALM_RESTRICCIONESWC" ;
   ...
   private int edtMbod_RegionId_Visible ;
   private int subGrid_Islastpage ;
   private int GXPagingFrom2 ;
   private int GXPagingTo2 ;
   private int idxLst ;
   private int subGrid_Backcolor ;
   private long wcpOAV7Mbod_RegionId ;
   private long AV7Mbod_RegionId ;
   ...
   private String sCtrlAV7Mbod_RegionId ;
   ...
   private long[] H002M2_A62Mbod_RegionId ;
   private String[] H002M2_A361Mbod_UsuarioModifica ;
   private java.util.Date[] H002M2_A362Mbod_FechaModifica ;
   private String[] H002M2_A359Mbod_UsuarioCrea ;
   private java.util.Date[] H002M2_A433Mbod_FechaCrea ;
   private String[] H002M2_A434Mbod_Estado ;
   private String[] H002M2_A65Mbod_BodDestinoCodigo ;
   private String[] H002M2_A345Mbod_AlmDestinoCodigo ;
   private String[] H002M2_A368Mbod_AlmModDestino ;
   private String[] H002M2_A64Mbod_BodOrigenCodigo ;
   private String[] H002M2_A342Mbod_AlmOrigenCodigo ;
   private String[] H002M2_A364Mbod_AlmModOrigen ;
   private String[] H002M2_A430Mbod_CentroCostoDescrip ;
   private boolean[] H002M2_n430Mbod_CentroCostoDescrip ;
   private String[] H002M2_A429Mbod_CentCostoCodigo ;
   private boolean[] H002M2_n429Mbod_CentCostoCodigo ;
   private long[] H002M2_A63Mbod_CentCostoId ;
   private String[] H002M2_A432Mbod_TipoElementoDesc ;
   private boolean[] H002M2_n432Mbod_TipoElementoDesc ;
   private long[] H002M2_A431Mbod_TipoElementoCod ;
   private boolean[] H002M2_n431Mbod_TipoElementoCod ;
   private String[] H002M2_A428Mbod_TipoMovDescrip ;
   private boolean[] H002M2_n428Mbod_TipoMovDescrip ;
   private String[] H002M2_A61Mbod_TipoMovCodigo ;
   private long[] H002M2_A60Mbod_Id ;
   private String[] H002M3_A31Bode_Codigo ;
   private String[] H002M4_A31Bode_Codigo ;
...
final  class gen_regionalalm_restriccioneswc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H002M2", "SELECT T1.Mbod_RegionId, T1.Mbod_UsuarioModifica, T1.Mbod_FechaModifica, T1.Mbod_UsuarioCrea, T1.Mbod_FechaCrea, T1.Mbod_Estado, T1.Mbod_BodDestinoCodigo, T1.Mbod_AlmDestinoCodigo, T1.Mbod_AlmModDestino, T1.Mbod_BodOrigenCodigo, T1.Mbod_AlmOrigenCodigo, T1.Mbod_AlmModOrigen, T2.Cent_Descripcion AS Mbod_CentroCostoDescrip, T2.Cent_Codigo AS Mbod_CentCostoCodigo, T1.Mbod_CentCostoId AS Mbod_CentCostoId, T4.Tipo_Descripcion AS Mbod_TipoElementoDesc, T3.Tipo_Codigo AS Mbod_TipoElementoCod, T3.Tpmo_Descripcion AS Mbod_TipoMovDescrip, T1.Mbod_TipoMovCodigo AS Mbod_TipoMovCodigo, T1.Mbod_Id FROM (((ALM_RESTRICCIONES T1 INNER JOIN GEN_CENTROCOSTO T2 ON T2.Cent_Id = T1.Mbod_CentCostoId) INNER JOIN ALM_TIPO_MOVIMIENTO T3 ON T3.Tpmo_Codigo = T1.Mbod_TipoMovCodigo) LEFT JOIN ALM_TIPO_ELEMENTO T4 ON T4.Tipo_Codigo = T3.Tipo_Codigo) WHERE T1.Mbod_RegionId = ? ORDER BY T1.Mbod_RegionId  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H002M3", "SELECT Bode_Codigo FROM ALM_BODEGA WHERE Bode_Codigo = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
         ,new ForEachCursor("H002M4", "SELECT Bode_Codigo FROM ALM_BODEGA WHERE Bode_Codigo = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
