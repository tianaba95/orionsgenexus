/*
               File: gen_centrocostoalm_almacenwc_impl
...
public final  class gen_centrocostoalm_almacenwc_impl extends GXWebComponent
{
   public gen_centrocostoalm_almacenwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public gen_centrocostoalm_almacenwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( gen_centrocostoalm_almacenwc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Cent_Id, AV12Update, AV13Delete, A27Alma_Modulo, A28Alma_Codigo, A1Cent_Id, A29Tpal_Id, sPrefix) ;
               GXKey = com.genexus.util.Encryption.decrypt64( httpContext.getCookie( "GX_SESSION_ID"), context.getServerKey( )) ;
               GXKey = com.genexus.util.Encryption.decrypt64( httpContext.getCookie( "GX_SESSION_ID"), context.getServerKey( )) ;
               forbiddenHiddens = sPrefix + "hsh" + "GEN_CENTROCOSTOALM_ALMACENWC" ;
               ...
               GXutil.writeLogln("gen_centrocostoalm_almacenwc:[SendSecurityCheck]"+forbiddenHiddens);
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "GEN_CENTROCOSTOALM_ALMACENWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20186141411401");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.gen_centrocostoalm_almacenwc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Cent_Id,11,0)))+"\">") ;
   ...
   public void renderHtmlCloseForm0C2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("gen_centrocostoalm_almacenwc.js", "?20186141411403");
      }
   ...
   public void wb0C0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.gen_centrocostoalm_almacenwc");
         }
         /* Div Control */
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_GEN_CENTROCOSTOALM_ALMACENWC.htm");
      ...
      if ( wbEnd == 20 )
      {
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtCent_Id_Internalname, GXutil.ltrim( localUtil.ntoc( A1Cent_Id, (byte)(11), (byte)(0), ",", "")), ((edtCent_Id_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1Cent_Id), "ZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A1Cent_Id), "ZZZZZZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCent_Id_Jsonclick, 0, "Attribute", "", "", "", edtCent_Id_Visible, edtCent_Id_Enabled, 0, "text", "", 11, "chr", 1, "row", 11, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Identificador", "right", false, "HLP_GEN_CENTROCOSTOALM_ALMACENWC.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start0C2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "GEN_CENTROCOSTOALM_ALMACENWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "GEN_CENTROCOSTOALM_ALMACENWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf0C2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A1Cent_Id = H000C2_A1Cent_Id[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1Cent_Id", GXutil.ltrim( GXutil.str( A1Cent_Id, 11, 0)));
            A265Alma_CedulaResponsable = H000C2_A265Alma_CedulaResponsable[0] ;
            n265Alma_CedulaResponsable = H000C2_n265Alma_CedulaResponsable[0] ;
            A673Alma_Estado = H000C2_A673Alma_Estado[0] ;
            n673Alma_Estado = H000C2_n673Alma_Estado[0] ;
            A258Alma_UsuarioModifica = H000C2_A258Alma_UsuarioModifica[0] ;
            n258Alma_UsuarioModifica = H000C2_n258Alma_UsuarioModifica[0] ;
            A257Alma_FechaModifica = H000C2_A257Alma_FechaModifica[0] ;
            n257Alma_FechaModifica = H000C2_n257Alma_FechaModifica[0] ;
            A256Alma_UsuarioCrea = H000C2_A256Alma_UsuarioCrea[0] ;
            n256Alma_UsuarioCrea = H000C2_n256Alma_UsuarioCrea[0] ;
            A255Alma_FechaCrea = H000C2_A255Alma_FechaCrea[0] ;
            n255Alma_FechaCrea = H000C2_n255Alma_FechaCrea[0] ;
            A264Alma_CuentaCredito = H000C2_A264Alma_CuentaCredito[0] ;
            n264Alma_CuentaCredito = H000C2_n264Alma_CuentaCredito[0] ;
            A263Alma_CuentaDebito = H000C2_A263Alma_CuentaDebito[0] ;
            n263Alma_CuentaDebito = H000C2_n263Alma_CuentaDebito[0] ;
            A268Alma_EmailResponsable = H000C2_A268Alma_EmailResponsable[0] ;
            n268Alma_EmailResponsable = H000C2_n268Alma_EmailResponsable[0] ;
            A266Alma_NombreResponsable = H000C2_A266Alma_NombreResponsable[0] ;
            n266Alma_NombreResponsable = H000C2_n266Alma_NombreResponsable[0] ;
            A30Alma_IdResponsable = H000C2_A30Alma_IdResponsable[0] ;
            A262Alma_Fax = H000C2_A262Alma_Fax[0] ;
            n262Alma_Fax = H000C2_n262Alma_Fax[0] ;
            A261Alma_Telefono2 = H000C2_A261Alma_Telefono2[0] ;
            n261Alma_Telefono2 = H000C2_n261Alma_Telefono2[0] ;
            A260Alma_Telefono1 = H000C2_A260Alma_Telefono1[0] ;
            n260Alma_Telefono1 = H000C2_n260Alma_Telefono1[0] ;
            A259Alma_Direccion = H000C2_A259Alma_Direccion[0] ;
            n259Alma_Direccion = H000C2_n259Alma_Direccion[0] ;
            A307Tpal_Descripcion = H000C2_A307Tpal_Descripcion[0] ;
            A29Tpal_Id = H000C2_A29Tpal_Id[0] ;
            A252Alma_Descripcion = H000C2_A252Alma_Descripcion[0] ;
            A28Alma_Codigo = H000C2_A28Alma_Codigo[0] ;
            A27Alma_Modulo = H000C2_A27Alma_Modulo[0] ;
            A265Alma_CedulaResponsable = H000C2_A265Alma_CedulaResponsable[0] ;
            n265Alma_CedulaResponsable = H000C2_n265Alma_CedulaResponsable[0] ;
            A268Alma_EmailResponsable = H000C2_A268Alma_EmailResponsable[0] ;
            n268Alma_EmailResponsable = H000C2_n268Alma_EmailResponsable[0] ;
   ...
   public void strup0C0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         if ( ! GXutil.checkEncryptedSignature( forbiddenHiddens, hsh, GXKey) )
         {
            ...
            GXutil.writeLog("gen_centrocostoalm_almacenwc:[SecurityCheckFailed]"+forbiddenHiddens);
            return  ;
         }
   ...
   {
      /* Grid_Load Routine */
      edtavUpdate_Link = formatLink("com.orions2.alm_almacen") + "?" + GXutil.URLEncode(GXutil.rtrim("UPD")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Cent_Id,11,0))) + "," + GXutil.URLEncode(GXutil.rtrim(A27Alma_Modulo)) + "," + GXutil.URLEncode(GXutil.rtrim(A28Alma_Codigo)) ;
      edtavDelete_Link = formatLink("com.orions2.alm_almacen") + "?" + GXutil.URLEncode(GXutil.rtrim("DLT")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Cent_Id,11,0))) + "," + GXutil.URLEncode(GXutil.rtrim(A27Alma_Modulo)) + "," + GXutil.URLEncode(GXutil.rtrim(A28Alma_Codigo)) ;
   ...
   {
      /* 'DoInsert' Routine */
      callWebObject(formatLink("com.orions2.alm_almacen") + "?" + GXutil.URLEncode(GXutil.rtrim("INS")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Cent_Id,11,0))) + "," + GXutil.URLEncode(GXutil.rtrim("")) + "," + GXutil.URLEncode(GXutil.rtrim("")));
      httpContext.wjLocDisableFrm = (byte)(1) ;
   }
   ...
   public void S112( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( GXutil.str( AV7Cent_Id, 11, 0) );
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "gen_centrocostoalm_almacenwc");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414114079");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("gen_centrocostoalm_almacenwc.js", "?201861414114079");
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Cent_Id',fld:'vCENT_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV12Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV13Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'cmbAlma_Modulo'},{av:'A27Alma_Modulo',fld:'ALMA_MODULO',pic:'',hsh:true,nv:''},{av:'A28Alma_Codigo',fld:'ALMA_CODIGO',pic:'',hsh:true,nv:''},{av:'A1Cent_Id',fld:'CENT_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'A29Tpal_Id',fld:'TPAL_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e130C2',iparms:[{av:'AV7Cent_Id',fld:'vCENT_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'cmbAlma_Modulo'},{av:'A27Alma_Modulo',fld:'ALMA_MODULO',pic:'',hsh:true,nv:''},{av:'A28Alma_Codigo',fld:'ALMA_CODIGO',pic:'',hsh:true,nv:''},{av:'A1Cent_Id',fld:'CENT_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'A29Tpal_Id',fld:'TPAL_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtAlma_Descripcion_Link',ctrl:'ALMA_DESCRIPCION',prop:'Link'},{av:'edtTpal_Descripcion_Link',ctrl:'TPAL_DESCRIPCION',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e110C2',iparms:[{av:'AV7Cent_Id',fld:'vCENT_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'cmbAlma_Modulo'},{av:'A27Alma_Modulo',fld:'ALMA_MODULO',pic:'',hsh:true,nv:''},{av:'A28Alma_Codigo',fld:'ALMA_CODIGO',pic:'',hsh:true,nv:''}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H000C2_A1Cent_Id = new long[1] ;
      H000C2_A265Alma_CedulaResponsable = new long[1] ;
      H000C2_n265Alma_CedulaResponsable = new boolean[] {false} ;
      H000C2_A673Alma_Estado = new String[] {""} ;
      H000C2_n673Alma_Estado = new boolean[] {false} ;
      H000C2_A258Alma_UsuarioModifica = new String[] {""} ;
      H000C2_n258Alma_UsuarioModifica = new boolean[] {false} ;
      H000C2_A257Alma_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H000C2_n257Alma_FechaModifica = new boolean[] {false} ;
      H000C2_A256Alma_UsuarioCrea = new String[] {""} ;
      H000C2_n256Alma_UsuarioCrea = new boolean[] {false} ;
      H000C2_A255Alma_FechaCrea = new java.util.Date[] {GXutil.nullDate()} ;
      H000C2_n255Alma_FechaCrea = new boolean[] {false} ;
      H000C2_A264Alma_CuentaCredito = new String[] {""} ;
      H000C2_n264Alma_CuentaCredito = new boolean[] {false} ;
      H000C2_A263Alma_CuentaDebito = new String[] {""} ;
      H000C2_n263Alma_CuentaDebito = new boolean[] {false} ;
      H000C2_A268Alma_EmailResponsable = new String[] {""} ;
      H000C2_n268Alma_EmailResponsable = new boolean[] {false} ;
      H000C2_A266Alma_NombreResponsable = new String[] {""} ;
      H000C2_n266Alma_NombreResponsable = new boolean[] {false} ;
      H000C2_A30Alma_IdResponsable = new long[1] ;
      H000C2_A262Alma_Fax = new long[1] ;
      H000C2_n262Alma_Fax = new boolean[] {false} ;
      H000C2_A261Alma_Telefono2 = new long[1] ;
      H000C2_n261Alma_Telefono2 = new boolean[] {false} ;
      H000C2_A260Alma_Telefono1 = new long[1] ;
      H000C2_n260Alma_Telefono1 = new boolean[] {false} ;
      H000C2_A259Alma_Direccion = new String[] {""} ;
      H000C2_n259Alma_Direccion = new boolean[] {false} ;
      H000C2_A307Tpal_Descripcion = new String[] {""} ;
      H000C2_A29Tpal_Id = new long[1] ;
      H000C2_A252Alma_Descripcion = new String[] {""} ;
      H000C2_A28Alma_Codigo = new String[] {""} ;
      H000C2_A27Alma_Modulo = new String[] {""} ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.gen_centrocostoalm_almacenwc__default(),
         new Object[] {
             new Object[] {
            H000C2_A1Cent_Id, H000C2_A265Alma_CedulaResponsable, H000C2_n265Alma_CedulaResponsable, H000C2_A673Alma_Estado, H000C2_n673Alma_Estado, H000C2_A258Alma_UsuarioModifica, H000C2_n258Alma_UsuarioModifica, H000C2_A257Alma_FechaModifica, H000C2_n257Alma_FechaModifica, H000C2_A256Alma_UsuarioCrea,
            H000C2_n256Alma_UsuarioCrea, H000C2_A255Alma_FechaCrea, H000C2_n255Alma_FechaCrea, H000C2_A264Alma_CuentaCredito, H000C2_n264Alma_CuentaCredito, H000C2_A263Alma_CuentaDebito, H000C2_n263Alma_CuentaDebito, H000C2_A268Alma_EmailResponsable, H000C2_n268Alma_EmailResponsable, H000C2_A266Alma_NombreResponsable,
            H000C2_n266Alma_NombreResponsable, H000C2_A30Alma_IdResponsable, H000C2_A262Alma_Fax, H000C2_n262Alma_Fax, H000C2_A261Alma_Telefono2, H000C2_n261Alma_Telefono2, H000C2_A260Alma_Telefono1, H000C2_n260Alma_Telefono1, H000C2_A259Alma_Direccion, H000C2_n259Alma_Direccion,
            H000C2_A307Tpal_Descripcion, H000C2_A29Tpal_Id, H000C2_A252Alma_Descripcion, H000C2_A28Alma_Codigo, H000C2_A27Alma_Modulo
            }
            , new Object[] {
   ...
   private long[] H000C2_A1Cent_Id ;
   private long[] H000C2_A265Alma_CedulaResponsable ;
   private boolean[] H000C2_n265Alma_CedulaResponsable ;
   private String[] H000C2_A673Alma_Estado ;
   private boolean[] H000C2_n673Alma_Estado ;
   private String[] H000C2_A258Alma_UsuarioModifica ;
   private boolean[] H000C2_n258Alma_UsuarioModifica ;
   private java.util.Date[] H000C2_A257Alma_FechaModifica ;
   private boolean[] H000C2_n257Alma_FechaModifica ;
   private String[] H000C2_A256Alma_UsuarioCrea ;
   private boolean[] H000C2_n256Alma_UsuarioCrea ;
   private java.util.Date[] H000C2_A255Alma_FechaCrea ;
   private boolean[] H000C2_n255Alma_FechaCrea ;
   private String[] H000C2_A264Alma_CuentaCredito ;
   private boolean[] H000C2_n264Alma_CuentaCredito ;
   private String[] H000C2_A263Alma_CuentaDebito ;
   private boolean[] H000C2_n263Alma_CuentaDebito ;
   private String[] H000C2_A268Alma_EmailResponsable ;
   private boolean[] H000C2_n268Alma_EmailResponsable ;
   private String[] H000C2_A266Alma_NombreResponsable ;
   private boolean[] H000C2_n266Alma_NombreResponsable ;
   private long[] H000C2_A30Alma_IdResponsable ;
   private long[] H000C2_A262Alma_Fax ;
   private boolean[] H000C2_n262Alma_Fax ;
   private long[] H000C2_A261Alma_Telefono2 ;
   private boolean[] H000C2_n261Alma_Telefono2 ;
   private long[] H000C2_A260Alma_Telefono1 ;
   private boolean[] H000C2_n260Alma_Telefono1 ;
   private String[] H000C2_A259Alma_Direccion ;
   private boolean[] H000C2_n259Alma_Direccion ;
   private String[] H000C2_A307Tpal_Descripcion ;
   private long[] H000C2_A29Tpal_Id ;
   private String[] H000C2_A252Alma_Descripcion ;
   private String[] H000C2_A28Alma_Codigo ;
   private String[] H000C2_A27Alma_Modulo ;
...
final  class gen_centrocostoalm_almacenwc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H000C2", "SELECT T1.Cent_Id, T2.Cuen_Cedula AS Alma_CedulaResponsable, T1.Alma_Estado, T1.Alma_UsuarioModifica, T1.Alma_FechaModifica, T1.Alma_UsuarioCrea, T1.Alma_FechaCrea, T1.Alma_CuentaCredito, T1.Alma_CuentaDebito, T2.Cuen_Email AS Alma_EmailResponsable, T2.Cuen_Nombre AS Alma_NombreResponsable, T1.Alma_IdResponsable AS Alma_IdResponsable, T1.Alma_Fax, T1.Alma_Telefono2, T1.Alma_Telefono1, T1.Alma_Direccion, T3.Tpal_Descripcion, T1.Tpal_Id, T1.Alma_Descripcion, T1.Alma_Codigo, T1.Alma_Modulo FROM ((ALM_ALMACEN T1 INNER JOIN ALM_CUENTADANTE T2 ON T2.Cuen_Identificacion = T1.Alma_IdResponsable) INNER JOIN ALM_TIPO_ALMACEN T3 ON T3.Tpal_Id = T1.Tpal_Id) WHERE T1.Cent_Id = ? ORDER BY T1.Cent_Id  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H000C3", "SELECT COUNT(*) FROM ((ALM_ALMACEN T1 INNER JOIN ALM_CUENTADANTE T3 ON T3.Cuen_Identificacion = T1.Alma_IdResponsable) INNER JOIN ALM_TIPO_ALMACEN T2 ON T2.Tpal_Id = T1.Tpal_Id) WHERE T1.Cent_Id = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
