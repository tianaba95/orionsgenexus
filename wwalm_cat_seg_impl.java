...
public final  class wwalm_cat_seg_impl extends GXDataArea
{
   public wwalm_cat_seg_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wwalm_cat_seg_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wwalm_cat_seg_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
         {
            ...
            AV14SEG_Descripcion = httpContext.GetNextPar( ) ;
            AV15Update = httpContext.GetNextPar( ) ;
            edtavUpdate_Tooltiptext = httpContext.GetNextPar( ) ;
            httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Tooltiptext", edtavUpdate_Tooltiptext, !bGXsfl_25_Refreshing);
            AV16Delete = httpContext.GetNextPar( ) ;
            ...
            gxgrgrid_refresh( subGrid_Rows, AV14SEG_Descripcion, AV15Update, AV16Delete, AV20Pgmname, A75SEG_Codigo, A74TIP_Codigo) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414195555");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( nGXWrapped != 1 )
      {
         httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.wwalm_cat_seg") +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "GXH_vSEG_DESCRIPCION", AV14SEG_Descripcion);
      /* Send saved values. */
   ...
   {
      return formatLink("com.orions2.wwalm_cat_seg")  ;
   }

   public String getPgmname( )
   {
      return "WWALM_CAT_SEG" ;
   }
   ...
   public void wb5D0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblTitletext_Internalname, "Segmento del catálogo", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_WWALM_CAT_SEG.htm");
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 25, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWALM_CAT_SEG.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_label_element( httpContext, edtavSeg_descripcion_Internalname, "SEG_Descripcion", "col-sm-3 FilterSearchAttributeLabel", 0, true);
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"" ;
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavSeg_descripcion_Internalname, AV14SEG_Descripcion, GXutil.rtrim( localUtil.format( AV14SEG_Descripcion, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Descripcion", edtavSeg_descripcion_Jsonclick, 0, "FilterSearchAttribute", "", "", "", 1, edtavSeg_descripcion_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_WWALM_CAT_SEG.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", A443SEG_UsuarioCreacion);
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", localUtil.ttoc( A444SEG_FechaCreacion, 10, 8, 0, 3, "/", ":", " "));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", A445SEG_UsuarioModifica);
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", localUtil.ttoc( A446SEG_FechaModifica, 10, 8, 0, 3, "/", ":", " "));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
   ...
   public void start5D2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Work With Segmento del catálogo", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                           ...
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 if ( ! wbErr )
                                 {
                                    ...
                                    if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vSEG_DESCRIPCION"), AV14SEG_Descripcion) != 0 )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    if ( ! Rfr0gs )
   ...
   public void pa5D2( )
   {
      if ( nDonePA == 0 )
      {
         ...
         if ( ! httpContext.isAjaxRequest( ) )
         {
            GX_FocusControl = edtavSeg_descripcion_Internalname ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_SEG_USUARIOCREACION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A443SEG_UsuarioCreacion, "@!"))));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "SEG_USUARIOCREACION", A443SEG_UsuarioCreacion);
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_SEG_FECHACREACION", getSecureSignedToken( "", localUtil.format( A444SEG_FechaCreacion, "99/99/99 99:99")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "SEG_FECHACREACION", localUtil.ttoc( A444SEG_FechaCreacion, 10, 8, 0, 3, "/", ":", " "));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_SEG_USUARIOMODIFICA", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A445SEG_UsuarioModifica, "@!"))));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "SEG_USUARIOMODIFICA", A445SEG_UsuarioModifica);
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_SEG_FECHAMODIFICA", getSecureSignedToken( "", localUtil.format( A446SEG_FechaModifica, "99/99/99 99:99")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "SEG_FECHAMODIFICA", localUtil.ttoc( A446SEG_FechaModifica, 10, 8, 0, 3, "/", ":", " "));
   ...
   public void rf5D2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV14SEG_Descripcion = GXutil.concat( GXutil.rtrim( AV14SEG_Descripcion), "%", "") ;
         httpContext.ajax_rsp_assign_attri("", false, "AV14SEG_Descripcion", AV14SEG_Descripcion);
         /* Using cursor H005D2 */
         pr_default.execute(0, new Object[] {lV14SEG_Descripcion, new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_25_idx = (short)(1) ;
         sGXsfl_25_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_25_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_252( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A435TIP_Descripcion = H005D2_A435TIP_Descripcion[0] ;
            A74TIP_Codigo = H005D2_A74TIP_Codigo[0] ;
            A446SEG_FechaModifica = H005D2_A446SEG_FechaModifica[0] ;
            A445SEG_UsuarioModifica = H005D2_A445SEG_UsuarioModifica[0] ;
            A444SEG_FechaCreacion = H005D2_A444SEG_FechaCreacion[0] ;
            A443SEG_UsuarioCreacion = H005D2_A443SEG_UsuarioCreacion[0] ;
            A442SEG_Descripcion = H005D2_A442SEG_Descripcion[0] ;
            A75SEG_Codigo = H005D2_A75SEG_Codigo[0] ;
            A435TIP_Descripcion = H005D2_A435TIP_Descripcion[0] ;
            e145D2 ();
   ...
   public int subgrid_recordcount( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV14SEG_Descripcion", AV14SEG_Descripcion);
      /* Using cursor H005D3 */
      pr_default.execute(1, new Object[] {lV14SEG_Descripcion});
   ...
   public void strup5D0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV14SEG_Descripcion = httpContext.cgiGet( edtavSeg_descripcion_Internalname) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV14SEG_Descripcion", AV14SEG_Descripcion);
         /* Read saved values. */
   ...
   {
      /* Grid_Load Routine */
      edtavUpdate_Link = formatLink("com.orions2.alm_cat_seg") + "?" + GXutil.URLEncode(GXutil.rtrim("UPD")) + "," + GXutil.URLEncode(GXutil.rtrim(A75SEG_Codigo)) ;
      edtavDelete_Link = formatLink("com.orions2.alm_cat_seg") + "?" + GXutil.URLEncode(GXutil.rtrim("DLT")) + "," + GXutil.URLEncode(GXutil.rtrim(A75SEG_Codigo)) ;
   ...
   {
      /* 'DoInsert' Routine */
      callWebObject(formatLink("com.orions2.alm_cat_seg") + "?" + GXutil.URLEncode(GXutil.rtrim("INS")) + "," + GXutil.URLEncode(GXutil.rtrim("")));
      httpContext.wjLocDisableFrm = (byte)(1) ;
   }
   ...
   public void S122( )
   {
      ...
      if ( GXutil.strcmp(AV8HTTPRequest.getMethod(), "GET") == 0 )
      {
         ...
         {
            AV14SEG_Descripcion = ((com.orions2.SdtGridState_FilterValue)AV9GridState.getgxTv_SdtGridState_Filtervalues().elementAt(-1+1)).getgxTv_SdtGridState_FilterValue_Value() ;
            httpContext.ajax_rsp_assign_attri("", false, "AV14SEG_Descripcion", AV14SEG_Descripcion);
         }
   ...
   public void S132( )
   {
      ...
      AV10GridStateFilterValue.setgxTv_SdtGridState_FilterValue_Value( AV14SEG_Descripcion );
   ...
   public void S112( )
   {
      ...
      AV12TrnContext.setgxTv_SdtTransactionContext_Transactionname( "ALM_CAT_SEG" );
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20186141419568");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         ...
         httpContext.AddJavascriptSource("wwalm_cat_seg.js", "?20186141419568");
      }
   ...
   public void subsflControlProps_252( )
   {
      ...
      edtSEG_UsuarioCreacion_Internalname = "SEG_USUARIOCREACION_"+sGXsfl_25_idx ;
      edtSEG_FechaCreacion_Internalname = "SEG_FECHACREACION_"+sGXsfl_25_idx ;
      edtSEG_UsuarioModifica_Internalname = "SEG_USUARIOMODIFICA_"+sGXsfl_25_idx ;
      edtSEG_FechaModifica_Internalname = "SEG_FECHAMODIFICA_"+sGXsfl_25_idx ;
   ...
   public void subsflControlProps_fel_252( )
   {
      ...
      edtSEG_UsuarioCreacion_Internalname = "SEG_USUARIOCREACION_"+sGXsfl_25_fel_idx ;
      edtSEG_FechaCreacion_Internalname = "SEG_FECHACREACION_"+sGXsfl_25_fel_idx ;
      edtSEG_UsuarioModifica_Internalname = "SEG_USUARIOMODIFICA_"+sGXsfl_25_fel_idx ;
      edtSEG_FechaModifica_Internalname = "SEG_FECHAMODIFICA_"+sGXsfl_25_fel_idx ;
   ...
   public void sendrow_252( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtSEG_Descripcion_Internalname,A442SEG_Descripcion,"","","'"+""+"'"+",false,"+"'"+""+"'",edtSEG_Descripcion_Link,"","","",edtSEG_Descripcion_Jsonclick,new Integer(0),"DescriptionAttribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(100),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtSEG_UsuarioCreacion_Internalname,A443SEG_UsuarioCreacion,GXutil.rtrim( localUtil.format( A443SEG_UsuarioCreacion, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtSEG_UsuarioCreacion_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtSEG_FechaCreacion_Internalname,localUtil.ttoc( A444SEG_FechaCreacion, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A444SEG_FechaCreacion, "99/99/99 99:99"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtSEG_FechaCreacion_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtSEG_UsuarioModifica_Internalname,A445SEG_UsuarioModifica,GXutil.rtrim( localUtil.format( A445SEG_UsuarioModifica, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtSEG_UsuarioModifica_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtSEG_FechaModifica_Internalname,localUtil.ttoc( A446SEG_FechaModifica, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A446SEG_FechaModifica, "99/99/99 99:99"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtSEG_FechaModifica_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_SEG_USUARIOCREACION"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, GXutil.rtrim( localUtil.format( A443SEG_UsuarioCreacion, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_SEG_FECHACREACION"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, localUtil.format( A444SEG_FechaCreacion, "99/99/99 99:99")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_SEG_USUARIOMODIFICA"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, GXutil.rtrim( localUtil.format( A445SEG_UsuarioModifica, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_SEG_FECHAMODIFICA"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, localUtil.format( A446SEG_FechaModifica, "99/99/99 99:99")));
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Work With Segmento del catálogo" );
      subGrid_Rows = 0 ;
      edtavDelete_Tooltiptext = "Eliminar" ;
      edtavUpdate_Tooltiptext = "Modificar" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV15Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV16Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A75SEG_Codigo',fld:'SEG_CODIGO',pic:'',hsh:true,nv:''},{av:'A74TIP_Codigo',fld:'TIP_CODIGO',pic:'',hsh:true,nv:''},{av:'AV20Pgmname',fld:'vPGMNAME',pic:'',nv:''},{av:'AV14SEG_Descripcion',fld:'vSEG_DESCRIPCION',pic:'',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e145D2',iparms:[{av:'A75SEG_Codigo',fld:'SEG_CODIGO',pic:'',hsh:true,nv:''},{av:'A74TIP_Codigo',fld:'TIP_CODIGO',pic:'',hsh:true,nv:''}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtSEG_Descripcion_Link',ctrl:'SEG_DESCRIPCION',prop:'Link'},{av:'edtTIP_Descripcion_Link',ctrl:'TIP_DESCRIPCION',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e115D2',iparms:[{av:'A75SEG_Codigo',fld:'SEG_CODIGO',pic:'',hsh:true,nv:''}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV14SEG_Descripcion = "" ;
      H005D2_A435TIP_Descripcion = new String[] {""} ;
      H005D2_A74TIP_Codigo = new String[] {""} ;
      H005D2_A446SEG_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H005D2_A445SEG_UsuarioModifica = new String[] {""} ;
      H005D2_A444SEG_FechaCreacion = new java.util.Date[] {GXutil.nullDate()} ;
      H005D2_A443SEG_UsuarioCreacion = new String[] {""} ;
      H005D2_A442SEG_Descripcion = new String[] {""} ;
      H005D2_A75SEG_Codigo = new String[] {""} ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.wwalm_cat_seg__default(),
         new Object[] {
             new Object[] {
            H005D2_A435TIP_Descripcion, H005D2_A74TIP_Codigo, H005D2_A446SEG_FechaModifica, H005D2_A445SEG_UsuarioModifica, H005D2_A444SEG_FechaCreacion, H005D2_A443SEG_UsuarioCreacion, H005D2_A442SEG_Descripcion, H005D2_A75SEG_Codigo
            }
            , new Object[] {
   ...
   private String AV14SEG_Descripcion ;
   ...
   private String lV14SEG_Descripcion ;
   ...
   private String[] H005D2_A435TIP_Descripcion ;
   private String[] H005D2_A74TIP_Codigo ;
   private java.util.Date[] H005D2_A446SEG_FechaModifica ;
   private String[] H005D2_A445SEG_UsuarioModifica ;
   private java.util.Date[] H005D2_A444SEG_FechaCreacion ;
   private String[] H005D2_A443SEG_UsuarioCreacion ;
   private String[] H005D2_A442SEG_Descripcion ;
   private String[] H005D2_A75SEG_Codigo ;
...
final  class wwalm_cat_seg__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H005D2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          String A442SEG_Descripcion )
   {
      ...
      String sFromString ;
      String sOrderString ;
      sSelectString = " T2.TIP_Descripcion, T1.TIP_Codigo, T1.SEG_FechaModifica, T1.SEG_UsuarioModifica," ;
      sSelectString = sSelectString + " T1.SEG_FechaCreacion, T1.SEG_UsuarioCreacion, T1.SEG_Descripcion, T1.SEG_Codigo" ;
      sFromString = " FROM (ALM_CAT_SEG T1 INNER JOIN ALM_CAT_TIP T2 ON T2.TIP_Codigo = T1.TIP_Codigo)" ;
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV14SEG_Descripcion)==0) )
      {
         if ( GXutil.strcmp("", sWhereString) != 0 )
         {
            sWhereString = sWhereString + " and (T1.SEG_Descripcion like ?)" ;
         }
         else
         {
            sWhereString = sWhereString + " (T1.SEG_Descripcion like ?)" ;
         }
      }
      else
      {
      ...
      sOrderString = sOrderString + " ORDER BY T1.SEG_Descripcion" ;
   ...
   protected Object[] conditional_H005D3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.internet.HttpContext httpContext ,
                                          String AV14SEG_Descripcion ,
                                          String A442SEG_Descripcion )
   {
      ...
      scmdbuf = "SELECT COUNT(*) FROM (ALM_CAT_SEG T1 INNER JOIN ALM_CAT_TIP T2 ON T2.TIP_Codigo =" ;
      scmdbuf = scmdbuf + " T1.TIP_Codigo)" ;
      if ( ! (GXutil.strcmp("", AV14SEG_Descripcion)==0) )
      {
         if ( GXutil.strcmp("", sWhereString) != 0 )
         {
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H005D2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
            case 1 :
                  return conditional_H005D3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H005D2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H005D3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
