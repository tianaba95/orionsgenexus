...
public final  class wwalm_cuentadante_impl extends GXDataArea
{
   public wwalm_cuentadante_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wwalm_cuentadante_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wwalm_cuentadante_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414182012");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.wwalm_cuentadante") +"\">") ;
   ...
   {
      return formatLink("com.orions2.wwalm_cuentadante")  ;
   }

   public String getPgmname( )
   {
      return "WWALM_CUENTADANTE" ;
   }
   ...
   public void wb190( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 59, 2, 0)+","+"null"+");", bttBtntoggle_Caption, bttBtntoggle_Jsonclick, 7, "Otros Filtros", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e11191_client"+"'", TempTags, "", 2, "HLP_WWALM_CUENTADANTE.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-6 col-sm-2", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblTitletext_Internalname, "Lista Cuentadantes", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_WWALM_CUENTADANTE.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 59, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWALM_CUENTADANTE.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblcuen_nombrefilter_Internalname, lblLblcuen_nombrefilter_Caption, "", "", lblLblcuen_nombrefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e12191_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WWALM_CUENTADANTE.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblregi_descripcionfilter_Internalname, lblLblregi_descripcionfilter_Caption, "", "", lblLblregi_descripcionfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e13191_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WWALM_CUENTADANTE.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblcuen_estadofilter_Internalname, lblLblcuen_estadofilter_Caption, "", "", lblLblcuen_estadofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e14191_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WWALM_CUENTADANTE.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
   ...
   public void start192( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Work With Cuentadante", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void rf192( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A340Cuen_FechaModifica = H00192_A340Cuen_FechaModifica[0] ;
            n340Cuen_FechaModifica = H00192_n340Cuen_FechaModifica[0] ;
            A339Cuen_UsuarioModifica = H00192_A339Cuen_UsuarioModifica[0] ;
            n339Cuen_UsuarioModifica = H00192_n339Cuen_UsuarioModifica[0] ;
            A338Cuen_FechaCrea = H00192_A338Cuen_FechaCrea[0] ;
            A337Cuen_UsuarioCrea = H00192_A337Cuen_UsuarioCrea[0] ;
            A12Regi_Cod = H00192_A12Regi_Cod[0] ;
            A2Regi_Id = H00192_A2Regi_Id[0] ;
            A4Cent_Descripcion = H00192_A4Cent_Descripcion[0] ;
            A3Cent_Codigo = H00192_A3Cent_Codigo[0] ;
            A1Cent_Id = H00192_A1Cent_Id[0] ;
            A10Dept_Descripcion = H00192_A10Dept_Descripcion[0] ;
            A6Dept_Codigo = H00192_A6Dept_Codigo[0] ;
            A7Ciud_Descripcion = H00192_A7Ciud_Descripcion[0] ;
            A5Ciud_Codigo = H00192_A5Ciud_Codigo[0] ;
            A328Cuen_Clase = H00192_A328Cuen_Clase[0] ;
            n328Cuen_Clase = H00192_n328Cuen_Clase[0] ;
            A333Cuen_Estado = H00192_A333Cuen_Estado[0] ;
            n333Cuen_Estado = H00192_n333Cuen_Estado[0] ;
            A13Regi_Descripcion = H00192_A13Regi_Descripcion[0] ;
            A321Tpte_Descripcion = H00192_A321Tpte_Descripcion[0] ;
            A42Tpte_Codigo = H00192_A42Tpte_Codigo[0] ;
            A336Cuen_Email = H00192_A336Cuen_Email[0] ;
            n336Cuen_Email = H00192_n336Cuen_Email[0] ;
            A335Cuen_Telefono = H00192_A335Cuen_Telefono[0] ;
            n335Cuen_Telefono = H00192_n335Cuen_Telefono[0] ;
            A334Cuen_Direccion = H00192_A334Cuen_Direccion[0] ;
            n334Cuen_Direccion = H00192_n334Cuen_Direccion[0] ;
            A44Cuen_Nombre = H00192_A44Cuen_Nombre[0] ;
            n44Cuen_Nombre = H00192_n44Cuen_Nombre[0] ;
            A330Cuen_SegundoApellido = H00192_A330Cuen_SegundoApellido[0] ;
            n330Cuen_SegundoApellido = H00192_n330Cuen_SegundoApellido[0] ;
            A329Cuen_PrimerApellido = H00192_A329Cuen_PrimerApellido[0] ;
            n329Cuen_PrimerApellido = H00192_n329Cuen_PrimerApellido[0] ;
            A332Cuen_SegundoNombre = H00192_A332Cuen_SegundoNombre[0] ;
            n332Cuen_SegundoNombre = H00192_n332Cuen_SegundoNombre[0] ;
            A331Cuen_PrimerNombre = H00192_A331Cuen_PrimerNombre[0] ;
            n331Cuen_PrimerNombre = H00192_n331Cuen_PrimerNombre[0] ;
            A326Cuen_DigitoVerificacion = H00192_A326Cuen_DigitoVerificacion[0] ;
            n326Cuen_DigitoVerificacion = H00192_n326Cuen_DigitoVerificacion[0] ;
            A688Cuen_Cedula = H00192_A688Cuen_Cedula[0] ;
            A43Cuen_Identificacion = H00192_A43Cuen_Identificacion[0] ;
            A12Regi_Cod = H00192_A12Regi_Cod[0] ;
            A5Ciud_Codigo = H00192_A5Ciud_Codigo[0] ;
            A13Regi_Descripcion = H00192_A13Regi_Descripcion[0] ;
            A6Dept_Codigo = H00192_A6Dept_Codigo[0] ;
   ...
   {
      /* Grid_Load Routine */
      edtavUpdate_Link = formatLink("com.orions2.alm_cuentadante") + "?" + GXutil.URLEncode(GXutil.rtrim("UPD")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A43Cuen_Identificacion,18,0))) ;
      /* Load Method */
      if ( wbStart != -1 )
      {
         wbStart = (short)(59) ;
   ...
   {
      /* 'DoInsert' Routine */
      callWebObject(formatLink("com.orions2.alm_cuentadante") + "?" + GXutil.URLEncode(GXutil.rtrim("INS")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(0,9,0))));
      httpContext.wjLocDisableFrm = (byte)(1) ;
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414182195");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("wwalm_cuentadante.js", "?201861414182195");
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Work With Cuentadante" );
      subGrid_Rows = 0 ;
      edtavUpdate_Tooltiptext = "Modificar" ;
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("'TOGGLE'","{handler:'e11191',iparms:[{av:'divFilterscontainer_Class',ctrl:'FILTERSCONTAINER',prop:'Class'}],oparms:[{av:'divFilterscontainer_Class',ctrl:'FILTERSCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Caption'},{av:'divGridcell_Class',ctrl:'GRIDCELL',prop:'Class'}]}");
      setEventMetadata("LBLCUEN_NOMBREFILTER.CLICK","{handler:'e12191',iparms:[{av:'divCuen_nombrefiltercontainer_Class',ctrl:'CUEN_NOMBREFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divCuen_nombrefiltercontainer_Class',ctrl:'CUEN_NOMBREFILTERCONTAINER',prop:'Class'},{av:'edtavCuen_nombre_Visible',ctrl:'vCUEN_NOMBRE',prop:'Visible'}]}");
      setEventMetadata("LBLREGI_DESCRIPCIONFILTER.CLICK","{handler:'e13191',iparms:[{av:'divRegi_descripcionfiltercontainer_Class',ctrl:'REGI_DESCRIPCIONFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divRegi_descripcionfiltercontainer_Class',ctrl:'REGI_DESCRIPCIONFILTERCONTAINER',prop:'Class'},{av:'edtavRegi_descripcion_Visible',ctrl:'vREGI_DESCRIPCION',prop:'Visible'}]}");
      setEventMetadata("LBLCUEN_ESTADOFILTER.CLICK","{handler:'e14191',iparms:[{av:'divCuen_estadofiltercontainer_Class',ctrl:'CUEN_ESTADOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divCuen_estadofiltercontainer_Class',ctrl:'CUEN_ESTADOFILTERCONTAINER',prop:'Class'},{av:'cmbavCuen_estado'}]}");
      setEventMetadata("GRID.LOAD","{handler:'e18192',iparms:[{av:'A43Cuen_Identificacion',fld:'CUEN_IDENTIFICACION',pic:'ZZZZZZZZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e15192',iparms:[{av:'A43Cuen_Identificacion',fld:'CUEN_IDENTIFICACION',pic:'ZZZZZZZZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV17Cuen_Estado = "" ;
      H00192_A340Cuen_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H00192_n340Cuen_FechaModifica = new boolean[] {false} ;
      H00192_A339Cuen_UsuarioModifica = new String[] {""} ;
      H00192_n339Cuen_UsuarioModifica = new boolean[] {false} ;
      H00192_A338Cuen_FechaCrea = new java.util.Date[] {GXutil.nullDate()} ;
      H00192_A337Cuen_UsuarioCrea = new String[] {""} ;
      H00192_A12Regi_Cod = new short[1] ;
      H00192_A2Regi_Id = new long[1] ;
      H00192_A4Cent_Descripcion = new String[] {""} ;
      H00192_A3Cent_Codigo = new String[] {""} ;
      H00192_A1Cent_Id = new long[1] ;
      H00192_A10Dept_Descripcion = new String[] {""} ;
      H00192_A6Dept_Codigo = new short[1] ;
      H00192_A7Ciud_Descripcion = new String[] {""} ;
      H00192_A5Ciud_Codigo = new short[1] ;
      H00192_A328Cuen_Clase = new String[] {""} ;
      H00192_n328Cuen_Clase = new boolean[] {false} ;
      H00192_A333Cuen_Estado = new String[] {""} ;
      H00192_n333Cuen_Estado = new boolean[] {false} ;
      H00192_A13Regi_Descripcion = new String[] {""} ;
      H00192_A321Tpte_Descripcion = new String[] {""} ;
      H00192_A42Tpte_Codigo = new String[] {""} ;
      H00192_A336Cuen_Email = new String[] {""} ;
      H00192_n336Cuen_Email = new boolean[] {false} ;
      H00192_A335Cuen_Telefono = new String[] {""} ;
      H00192_n335Cuen_Telefono = new boolean[] {false} ;
      H00192_A334Cuen_Direccion = new String[] {""} ;
      H00192_n334Cuen_Direccion = new boolean[] {false} ;
      H00192_A44Cuen_Nombre = new String[] {""} ;
      H00192_n44Cuen_Nombre = new boolean[] {false} ;
      H00192_A330Cuen_SegundoApellido = new String[] {""} ;
      H00192_n330Cuen_SegundoApellido = new boolean[] {false} ;
      H00192_A329Cuen_PrimerApellido = new String[] {""} ;
      H00192_n329Cuen_PrimerApellido = new boolean[] {false} ;
      H00192_A332Cuen_SegundoNombre = new String[] {""} ;
      H00192_n332Cuen_SegundoNombre = new boolean[] {false} ;
      H00192_A331Cuen_PrimerNombre = new String[] {""} ;
      H00192_n331Cuen_PrimerNombre = new boolean[] {false} ;
      H00192_A326Cuen_DigitoVerificacion = new byte[1] ;
      H00192_n326Cuen_DigitoVerificacion = new boolean[] {false} ;
      H00192_A688Cuen_Cedula = new long[1] ;
      H00192_A43Cuen_Identificacion = new long[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.wwalm_cuentadante__default(),
         new Object[] {
             new Object[] {
            H00192_A340Cuen_FechaModifica, H00192_n340Cuen_FechaModifica, H00192_A339Cuen_UsuarioModifica, H00192_n339Cuen_UsuarioModifica, H00192_A338Cuen_FechaCrea, H00192_A337Cuen_UsuarioCrea, H00192_A12Regi_Cod, H00192_A2Regi_Id, H00192_A4Cent_Descripcion, H00192_A3Cent_Codigo,
            H00192_A1Cent_Id, H00192_A10Dept_Descripcion, H00192_A6Dept_Codigo, H00192_A7Ciud_Descripcion, H00192_A5Ciud_Codigo, H00192_A328Cuen_Clase, H00192_n328Cuen_Clase, H00192_A333Cuen_Estado, H00192_n333Cuen_Estado, H00192_A13Regi_Descripcion,
            H00192_A321Tpte_Descripcion, H00192_A42Tpte_Codigo, H00192_A336Cuen_Email, H00192_n336Cuen_Email, H00192_A335Cuen_Telefono, H00192_n335Cuen_Telefono, H00192_A334Cuen_Direccion, H00192_n334Cuen_Direccion, H00192_A44Cuen_Nombre, H00192_n44Cuen_Nombre,
            H00192_A330Cuen_SegundoApellido, H00192_n330Cuen_SegundoApellido, H00192_A329Cuen_PrimerApellido, H00192_n329Cuen_PrimerApellido, H00192_A332Cuen_SegundoNombre, H00192_n332Cuen_SegundoNombre, H00192_A331Cuen_PrimerNombre, H00192_n331Cuen_PrimerNombre, H00192_A326Cuen_DigitoVerificacion, H00192_n326Cuen_DigitoVerificacion,
            H00192_A688Cuen_Cedula, H00192_A43Cuen_Identificacion
            }
         }
      );
      AV22Pgmname = "WWALM_CUENTADANTE" ;
   ...
   private java.util.Date[] H00192_A340Cuen_FechaModifica ;
   private boolean[] H00192_n340Cuen_FechaModifica ;
   private String[] H00192_A339Cuen_UsuarioModifica ;
   private boolean[] H00192_n339Cuen_UsuarioModifica ;
   private java.util.Date[] H00192_A338Cuen_FechaCrea ;
   private String[] H00192_A337Cuen_UsuarioCrea ;
   private short[] H00192_A12Regi_Cod ;
   private long[] H00192_A2Regi_Id ;
   private String[] H00192_A4Cent_Descripcion ;
   private String[] H00192_A3Cent_Codigo ;
   private long[] H00192_A1Cent_Id ;
   private String[] H00192_A10Dept_Descripcion ;
   private short[] H00192_A6Dept_Codigo ;
   private String[] H00192_A7Ciud_Descripcion ;
   private short[] H00192_A5Ciud_Codigo ;
   private String[] H00192_A328Cuen_Clase ;
   private boolean[] H00192_n328Cuen_Clase ;
   private String[] H00192_A333Cuen_Estado ;
   private boolean[] H00192_n333Cuen_Estado ;
   private String[] H00192_A13Regi_Descripcion ;
   private String[] H00192_A321Tpte_Descripcion ;
   private String[] H00192_A42Tpte_Codigo ;
   private String[] H00192_A336Cuen_Email ;
   private boolean[] H00192_n336Cuen_Email ;
   private String[] H00192_A335Cuen_Telefono ;
   private boolean[] H00192_n335Cuen_Telefono ;
   private String[] H00192_A334Cuen_Direccion ;
   private boolean[] H00192_n334Cuen_Direccion ;
   private String[] H00192_A44Cuen_Nombre ;
   private boolean[] H00192_n44Cuen_Nombre ;
   private String[] H00192_A330Cuen_SegundoApellido ;
   private boolean[] H00192_n330Cuen_SegundoApellido ;
   private String[] H00192_A329Cuen_PrimerApellido ;
   private boolean[] H00192_n329Cuen_PrimerApellido ;
   private String[] H00192_A332Cuen_SegundoNombre ;
   private boolean[] H00192_n332Cuen_SegundoNombre ;
   private String[] H00192_A331Cuen_PrimerNombre ;
   private boolean[] H00192_n331Cuen_PrimerNombre ;
   private byte[] H00192_A326Cuen_DigitoVerificacion ;
   private boolean[] H00192_n326Cuen_DigitoVerificacion ;
   private long[] H00192_A688Cuen_Cedula ;
   private long[] H00192_A43Cuen_Identificacion ;
...
final  class wwalm_cuentadante__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00192(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).longValue() , (String)dynConstraints[1] , ((Number) dynConstraints[2]).longValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] , (String)dynConstraints[8] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00192", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
      };
   }
