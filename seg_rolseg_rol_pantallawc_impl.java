/*
               File: seg_rolseg_rol_pantallawc_impl
        Description: SEG_ROLSEG_ROL_PANTALLAWC
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:16:2.97
...
public final  class seg_rolseg_rol_pantallawc_impl extends GXWebComponent
{
   public seg_rolseg_rol_pantallawc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public seg_rolseg_rol_pantallawc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( seg_rolseg_rol_pantallawc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV9Rol_Id", GXutil.ltrim( GXutil.str( AV9Rol_Id, 11, 0)));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,new Long(AV9Rol_Id)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV9Rol_Id, AV13Update, AV6Delete, A18Pant_Id, A16Modu_Id, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "SEG_ROLSEG_ROL_PANTALLAWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2018614141632");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.seg_rolseg_rol_pantallawc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV9Rol_Id,11,0)))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV9Rol_Id", GXutil.ltrim( localUtil.ntoc( wcpOAV9Rol_Id, (byte)(11), (byte)(0), ",", "")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vROL_ID", GXutil.ltrim( localUtil.ntoc( AV9Rol_Id, (byte)(11), (byte)(0), ",", "")));
   ...
   public void renderHtmlCloseForm6A2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("seg_rolseg_rol_pantallawc.js", "?2018614141634");
      }
   ...
   {
      return "SEG_ROLSEG_ROL_PANTALLAWC" ;
   }
   ...
   public void wb6A0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.seg_rolseg_rol_pantallawc");
         }
         /* Div Control */
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_SEG_ROLSEG_ROL_PANTALLAWC.htm");
         ...
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            httpContext.writeValue( "Id Pantalla") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            httpContext.writeValue( "Descr Pantalla") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            ...
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            httpContext.writeValue( "Id Módulo") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            httpContext.writeValue( "Descr Módulo") ;
            httpContext.writeTextNL( "</th>") ;
      ...
      if ( wbEnd == 20 )
      {
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtRol_Id_Internalname, GXutil.ltrim( localUtil.ntoc( A21Rol_Id, (byte)(11), (byte)(0), ",", "")), ((edtRol_Id_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A21Rol_Id), "ZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A21Rol_Id), "ZZZZZZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtRol_Id_Jsonclick, 0, "Attribute", "", "", "", edtRol_Id_Visible, edtRol_Id_Enabled, 0, "text", "", 11, "chr", 1, "row", 11, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Identificador", "right", false, "HLP_SEG_ROLSEG_ROL_PANTALLAWC.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start6A2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "SEG_ROLSEG_ROL_PANTALLAWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "SEG_ROLSEG_ROL_PANTALLAWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf6A2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H006A2 */
         pr_default.execute(0, new Object[] {new Long(AV9Rol_Id), new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_20_idx = (short)(1) ;
         sGXsfl_20_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_20_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_202( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A21Rol_Id = H006A2_A21Rol_Id[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A21Rol_Id", GXutil.ltrim( GXutil.str( A21Rol_Id, 11, 0)));
            A17Modu_Descripcion = H006A2_A17Modu_Descripcion[0] ;
            A16Modu_Id = H006A2_A16Modu_Id[0] ;
            A218RolP_FechaModifica = H006A2_A218RolP_FechaModifica[0] ;
            A217RolP_UsuarioModifica = H006A2_A217RolP_UsuarioModifica[0] ;
            A216RolP_FechaCrea = H006A2_A216RolP_FechaCrea[0] ;
            A215RolP_UsuarioCrea = H006A2_A215RolP_UsuarioCrea[0] ;
            A19Pant_Descripcion = H006A2_A19Pant_Descripcion[0] ;
            A18Pant_Id = H006A2_A18Pant_Id[0] ;
            A16Modu_Id = H006A2_A16Modu_Id[0] ;
            A19Pant_Descripcion = H006A2_A19Pant_Descripcion[0] ;
            A17Modu_Descripcion = H006A2_A17Modu_Descripcion[0] ;
            e136A2 ();
   ...
   public void strup6A0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV9Rol_Id = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV9Rol_Id"), ",", ".") ;
   ...
   {
      /* Grid_Load Routine */
      edtavUpdate_Link = formatLink("com.orions2.seg_rol_pantalla") + "?" + GXutil.URLEncode(GXutil.rtrim("UPD")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV9Rol_Id,11,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A18Pant_Id,6,0))) ;
      edtavDelete_Link = formatLink("com.orions2.seg_rol_pantalla") + "?" + GXutil.URLEncode(GXutil.rtrim("DLT")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV9Rol_Id,11,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A18Pant_Id,6,0))) ;
   ...
   {
      /* 'DoInsert' Routine */
      callWebObject(formatLink("com.orions2.seg_rol_pantalla") + "?" + GXutil.URLEncode(GXutil.rtrim("INS")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV9Rol_Id,11,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(0,9,0))));
      httpContext.wjLocDisableFrm = (byte)(1) ;
   }
   ...
   public void S112( )
   {
      ...
      AV12TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributename( "Rol_Id" );
      AV12TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( GXutil.str( AV9Rol_Id, 11, 0) );
   ...
   {
      AV9Rol_Id = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV9Rol_Id", GXutil.ltrim( GXutil.str( AV9Rol_Id, 11, 0)));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV9Rol_Id = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "seg_rolseg_rol_pantallawc");
      ...
      {
         AV9Rol_Id = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.LONG), TypeConstants.LONG)).longValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV9Rol_Id", GXutil.ltrim( GXutil.str( AV9Rol_Id, 11, 0)));
      }
      wcpOAV9Rol_Id = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV9Rol_Id"), ",", ".") ;
      if ( ! GetJustCreated( ) && ( ( AV9Rol_Id != wcpOAV9Rol_Id ) ) )
      {
         setjustcreated();
      }
      wcpOAV9Rol_Id = AV9Rol_Id ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV9Rol_Id = httpContext.cgiGet( sPrefix+"AV9Rol_Id_CTRL") ;
      if ( GXutil.len( sCtrlAV9Rol_Id) > 0 )
      {
         AV9Rol_Id = localUtil.ctol( httpContext.cgiGet( sCtrlAV9Rol_Id), ",", ".") ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV9Rol_Id", GXutil.ltrim( GXutil.str( AV9Rol_Id, 11, 0)));
      }
      else
      {
         AV9Rol_Id = localUtil.ctol( httpContext.cgiGet( sPrefix+"AV9Rol_Id_PARM"), ",", ".") ;
      }
   }
   ...
   {
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV9Rol_Id_PARM", GXutil.ltrim( localUtil.ntoc( AV9Rol_Id, (byte)(11), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV9Rol_Id)) > 0 )
      {
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV9Rol_Id_CTRL", GXutil.rtrim( sCtrlAV9Rol_Id));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20186141416353");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("seg_rolseg_rol_pantallawc.js", "?20186141416353");
      }
   ...
   public void subsflControlProps_202( )
   {
      ...
      edtModu_Id_Internalname = sPrefix+"MODU_ID_"+sGXsfl_20_idx ;
      edtModu_Descripcion_Internalname = sPrefix+"MODU_DESCRIPCION_"+sGXsfl_20_idx ;
   ...
   public void subsflControlProps_fel_202( )
   {
      ...
      edtModu_Id_Internalname = sPrefix+"MODU_ID_"+sGXsfl_20_fel_idx ;
      edtModu_Descripcion_Internalname = sPrefix+"MODU_DESCRIPCION_"+sGXsfl_20_fel_idx ;
   ...
   public void sendrow_202( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRolP_UsuarioModifica_Internalname,A217RolP_UsuarioModifica,GXutil.rtrim( localUtil.format( A217RolP_UsuarioModifica, "@!")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtRolP_UsuarioModifica_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRolP_FechaModifica_Internalname,localUtil.ttoc( A218RolP_FechaModifica, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A218RolP_FechaModifica, "99/99/99 99:99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtRolP_FechaModifica_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtModu_Id_Internalname,GXutil.ltrim( localUtil.ntoc( A16Modu_Id, (byte)(11), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A16Modu_Id), "ZZZZZZZZZZ9"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtModu_Id_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(11),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"Identificador","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtModu_Descripcion_Internalname,A17Modu_Descripcion,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'",edtModu_Descripcion_Link,"","","",edtModu_Descripcion_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV9Rol_Id',fld:'vROL_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV13Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV6Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A18Pant_Id',fld:'PANT_ID',pic:'ZZZZZ9',hsh:true,nv:0},{av:'A16Modu_Id',fld:'MODU_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e136A2',iparms:[{av:'AV9Rol_Id',fld:'vROL_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'A18Pant_Id',fld:'PANT_ID',pic:'ZZZZZ9',hsh:true,nv:0},{av:'A16Modu_Id',fld:'MODU_ID',pic:'ZZZZZZZZZZ9',nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtPant_Descripcion_Link',ctrl:'PANT_DESCRIPCION',prop:'Link'},{av:'edtModu_Descripcion_Link',ctrl:'MODU_DESCRIPCION',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e116A2',iparms:[{av:'AV9Rol_Id',fld:'vROL_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'A18Pant_Id',fld:'PANT_ID',pic:'ZZZZZ9',hsh:true,nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H006A2_A21Rol_Id = new long[1] ;
      H006A2_A17Modu_Descripcion = new String[] {""} ;
      H006A2_A16Modu_Id = new long[1] ;
      H006A2_A218RolP_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H006A2_A217RolP_UsuarioModifica = new String[] {""} ;
      H006A2_A216RolP_FechaCrea = new java.util.Date[] {GXutil.nullDate()} ;
      H006A2_A215RolP_UsuarioCrea = new String[] {""} ;
      H006A2_A19Pant_Descripcion = new String[] {""} ;
      H006A2_A18Pant_Id = new int[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.seg_rolseg_rol_pantallawc__default(),
         new Object[] {
             new Object[] {
            H006A2_A21Rol_Id, H006A2_A17Modu_Descripcion, H006A2_A16Modu_Id, H006A2_A218RolP_FechaModifica, H006A2_A217RolP_UsuarioModifica, H006A2_A216RolP_FechaCrea, H006A2_A215RolP_UsuarioCrea, H006A2_A19Pant_Descripcion, H006A2_A18Pant_Id
            }
            , new Object[] {
   ...
   private long[] H006A2_A21Rol_Id ;
   private String[] H006A2_A17Modu_Descripcion ;
   private long[] H006A2_A16Modu_Id ;
   private java.util.Date[] H006A2_A218RolP_FechaModifica ;
   private String[] H006A2_A217RolP_UsuarioModifica ;
   private java.util.Date[] H006A2_A216RolP_FechaCrea ;
   private String[] H006A2_A215RolP_UsuarioCrea ;
   private String[] H006A2_A19Pant_Descripcion ;
   private int[] H006A2_A18Pant_Id ;
...
final  class seg_rolseg_rol_pantallawc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H006A2", "SELECT T1.Rol_Id, T3.Modu_Descripcion, T2.Modu_Id, T1.RolP_FechaModifica, T1.RolP_UsuarioModifica, T1.RolP_FechaCrea, T1.RolP_UsuarioCrea, T2.Pant_Descripcion, T1.Pant_Id FROM ((SEG_ROL_PANTALLA T1 INNER JOIN SEG_PANTALLA T2 ON T2.Pant_Id = T1.Pant_Id) INNER JOIN SEG_MODULO_MENU T3 ON T3.Modu_Id = T2.Modu_Id) WHERE T1.Rol_Id = ? ORDER BY T1.Rol_Id  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H006A3", "SELECT COUNT(*) FROM ((SEG_ROL_PANTALLA T1 INNER JOIN SEG_PANTALLA T2 ON T2.Pant_Id = T1.Pant_Id) INNER JOIN SEG_MODULO_MENU T3 ON T3.Modu_Id = T2.Modu_Id) WHERE T1.Rol_Id = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
