/*
               File: alm_transaccionalm_detalle_transaccionwc_impl
        Description: ALM_TRANSACCIONALM_DETALLE_TRANSACCIONWC
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:14:56.56
...
public final  class alm_transaccionalm_detalle_transaccionwc_impl extends GXWebComponent
{
   public alm_transaccionalm_detalle_transaccionwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public alm_transaccionalm_detalle_transaccionwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( alm_transaccionalm_detalle_transaccionwc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,new Long(AV7Tran_Id)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Tran_Id, AV12Update, AV13Delete, A69TDet_Consecutivo, A37Cata_Codigo, A46Tran_Id, sPrefix) ;
               GXKey = com.genexus.util.Encryption.decrypt64( httpContext.getCookie( "GX_SESSION_ID"), context.getServerKey( )) ;
               GXKey = com.genexus.util.Encryption.decrypt64( httpContext.getCookie( "GX_SESSION_ID"), context.getServerKey( )) ;
               forbiddenHiddens = sPrefix + "hsh" + "ALM_TRANSACCIONALM_DETALLE_TRANSACCIONWC" ;
               forbiddenHiddens = forbiddenHiddens + localUtil.format( DecimalUtil.doubleToDec(A46Tran_Id), "ZZZZZZZZZZ9") ;
               com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"hsh", GXutil.getEncryptedSignature( forbiddenHiddens, GXKey));
               GXutil.writeLogln("alm_transaccionalm_detalle_transaccionwc:[SendSecurityCheck]"+forbiddenHiddens);
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "ALM_TRANSACCIONALM_DETALLE_TRANSACCIONWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414145664");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.alm_transaccionalm_detalle_transaccionwc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Tran_Id,11,0)))+"\">") ;
   ...
   public void renderHtmlCloseForm0Y2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("alm_transaccionalm_detalle_transaccionwc.js", "?201861414145666");
      }
   ...
   {
      return "ALM_TRANSACCIONALM_DETALLE_TRANSACCIONWC" ;
   }
   ...
   public void wb0Y0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.alm_transaccionalm_detalle_transaccionwc");
         }
         /* Div Control */
   ...
   public void start0Y2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "ALM_TRANSACCIONALM_DETALLE_TRANSACCIONWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"TDET_PLACARECUPERADA", A817TDet_PlacaRecuperada);
   }
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "ALM_TRANSACCIONALM_DETALLE_TRANSACCIONWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf0Y2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H000Y2 */
         pr_default.execute(0, new Object[] {new Long(AV7Tran_Id), new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_20_idx = (short)(1) ;
         sGXsfl_20_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_20_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_202( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A34Clas_Codigo = H000Y2_A34Clas_Codigo[0] ;
            A35FAM_Codigo = H000Y2_A35FAM_Codigo[0] ;
            A37Cata_Codigo = H000Y2_A37Cata_Codigo[0] ;
            A46Tran_Id = H000Y2_A46Tran_Id[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A46Tran_Id", GXutil.ltrim( GXutil.str( A46Tran_Id, 11, 0)));
            A33Tipo_Codigo = H000Y2_A33Tipo_Codigo[0] ;
            A817TDet_PlacaRecuperada = H000Y2_A817TDet_PlacaRecuperada[0] ;
            n817TDet_PlacaRecuperada = H000Y2_n817TDet_PlacaRecuperada[0] ;
            A77UNIMED_COD = H000Y2_A77UNIMED_COD[0] ;
            A75SEG_Codigo = H000Y2_A75SEG_Codigo[0] ;
            A658TDet_Agrupado = H000Y2_A658TDet_Agrupado[0] ;
            n658TDet_Agrupado = H000Y2_n658TDet_Agrupado[0] ;
            A657TDet_Otros_Costos = H000Y2_A657TDet_Otros_Costos[0] ;
            n657TDet_Otros_Costos = H000Y2_n657TDet_Otros_Costos[0] ;
            A656TDet_Plazo_N = H000Y2_A656TDet_Plazo_N[0] ;
            n656TDet_Plazo_N = H000Y2_n656TDet_Plazo_N[0] ;
            A655TDet_Taza = H000Y2_A655TDet_Taza[0] ;
            n655TDet_Taza = H000Y2_n655TDet_Taza[0] ;
            A654TDet_Valor_Futuro = H000Y2_A654TDet_Valor_Futuro[0] ;
            n654TDet_Valor_Futuro = H000Y2_n654TDet_Valor_Futuro[0] ;
            A653TDet_Valor_Presente = H000Y2_A653TDet_Valor_Presente[0] ;
            n653TDet_Valor_Presente = H000Y2_n653TDet_Valor_Presente[0] ;
            A525TDet_Atributos = H000Y2_A525TDet_Atributos[0] ;
            A505TDet_EsPadre = H000Y2_A505TDet_EsPadre[0] ;
            A491TDet_PlacaPadre = H000Y2_A491TDet_PlacaPadre[0] ;
            n491TDet_PlacaPadre = H000Y2_n491TDet_PlacaPadre[0] ;
            A504TDet_Observaciones = H000Y2_A504TDet_Observaciones[0] ;
            n504TDet_Observaciones = H000Y2_n504TDet_Observaciones[0] ;
            A490TDet_PlacaNumero = H000Y2_A490TDet_PlacaNumero[0] ;
            n490TDet_PlacaNumero = H000Y2_n490TDet_PlacaNumero[0] ;
            A489TDet_ValorTotal = H000Y2_A489TDet_ValorTotal[0] ;
            A488TDet_ValorUnitario = H000Y2_A488TDet_ValorUnitario[0] ;
            A487TDet_Cantidad = H000Y2_A487TDet_Cantidad[0] ;
            A298Cata_Descripcion = H000Y2_A298Cata_Descripcion[0] ;
            A557Elem_Descripcion = H000Y2_A557Elem_Descripcion[0] ;
            A66Elem_Consecutivo = H000Y2_A66Elem_Consecutivo[0] ;
            A69TDet_Consecutivo = H000Y2_A69TDet_Consecutivo[0] ;
            A37Cata_Codigo = H000Y2_A37Cata_Codigo[0] ;
            A33Tipo_Codigo = H000Y2_A33Tipo_Codigo[0] ;
            A77UNIMED_COD = H000Y2_A77UNIMED_COD[0] ;
            A557Elem_Descripcion = H000Y2_A557Elem_Descripcion[0] ;
   ...
   {
      /* Using cursor H000Y3 */
      pr_default.execute(1, new Object[] {new Long(AV7Tran_Id)});
   ...
   public void strup0Y0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         if ( ! GXutil.checkEncryptedSignature( forbiddenHiddens, hsh, GXKey) )
         {
            ...
            GXutil.writeLog("alm_transaccionalm_detalle_transaccionwc:[SecurityCheckFailed]"+forbiddenHiddens);
            return  ;
         }
   ...
   {
      /* Grid_Load Routine */
      edtavUpdate_Link = formatLink("com.orions2.alm_detalle_transaccion") + "?" + GXutil.URLEncode(GXutil.rtrim("UPD")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Tran_Id,11,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A69TDet_Consecutivo,18,0))) ;
      edtavDelete_Link = formatLink("com.orions2.alm_detalle_transaccion") + "?" + GXutil.URLEncode(GXutil.rtrim("DLT")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Tran_Id,11,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A69TDet_Consecutivo,18,0))) ;
   ...
   {
      /* 'DoInsert' Routine */
      callWebObject(formatLink("com.orions2.alm_detalle_transaccion") + "?" + GXutil.URLEncode(GXutil.rtrim("INS")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Tran_Id,11,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(0,9,0))));
      httpContext.wjLocDisableFrm = (byte)(1) ;
   }
   ...
   public void S112( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributename( "Tran_Id" );
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( GXutil.str( AV7Tran_Id, 11, 0) );
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "alm_transaccionalm_detalle_transaccionwc");
      ...
      wcpOAV7Tran_Id = localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV7Tran_Id"), ",", ".") ;
      if ( ! GetJustCreated( ) && ( ( AV7Tran_Id != wcpOAV7Tran_Id ) ) )
      {
         setjustcreated();
      }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414145759");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("alm_transaccionalm_detalle_transaccionwc.js", "?201861414145759");
      }
   ...
   public void sendrow_202( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_TDET_PLACARECUPERADA"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A817TDet_PlacaRecuperada, ""))));
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Tran_Id',fld:'vTRAN_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'AV12Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV13Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A69TDet_Consecutivo',fld:'TDET_CONSECUTIVO',pic:'ZZZZZZZZZZZZZZZZZ9',hsh:true,nv:0},{av:'A37Cata_Codigo',fld:'CATA_CODIGO',pic:'',nv:''},{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e130Y2',iparms:[{av:'AV7Tran_Id',fld:'vTRAN_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'A69TDet_Consecutivo',fld:'TDET_CONSECUTIVO',pic:'ZZZZZZZZZZZZZZZZZ9',hsh:true,nv:0},{av:'A37Cata_Codigo',fld:'CATA_CODIGO',pic:'',nv:''},{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtCata_Descripcion_Link',ctrl:'CATA_DESCRIPCION',prop:'Link'},{av:'edtTDet_Cantidad_Link',ctrl:'TDET_CANTIDAD',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e110Y2',iparms:[{av:'AV7Tran_Id',fld:'vTRAN_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'A69TDet_Consecutivo',fld:'TDET_CONSECUTIVO',pic:'ZZZZZZZZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H000Y2_A34Clas_Codigo = new String[] {""} ;
      H000Y2_A35FAM_Codigo = new String[] {""} ;
      H000Y2_A37Cata_Codigo = new String[] {""} ;
      H000Y2_A46Tran_Id = new long[1] ;
      H000Y2_A33Tipo_Codigo = new long[1] ;
      H000Y2_A817TDet_PlacaRecuperada = new String[] {""} ;
      H000Y2_n817TDet_PlacaRecuperada = new boolean[] {false} ;
      H000Y2_A77UNIMED_COD = new int[1] ;
      H000Y2_A75SEG_Codigo = new String[] {""} ;
      H000Y2_A658TDet_Agrupado = new short[1] ;
      H000Y2_n658TDet_Agrupado = new boolean[] {false} ;
      H000Y2_A657TDet_Otros_Costos = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H000Y2_n657TDet_Otros_Costos = new boolean[] {false} ;
      H000Y2_A656TDet_Plazo_N = new byte[1] ;
      H000Y2_n656TDet_Plazo_N = new boolean[] {false} ;
      H000Y2_A655TDet_Taza = new short[1] ;
      H000Y2_n655TDet_Taza = new boolean[] {false} ;
      H000Y2_A654TDet_Valor_Futuro = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H000Y2_n654TDet_Valor_Futuro = new boolean[] {false} ;
      H000Y2_A653TDet_Valor_Presente = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H000Y2_n653TDet_Valor_Presente = new boolean[] {false} ;
      H000Y2_A525TDet_Atributos = new String[] {""} ;
      H000Y2_A505TDet_EsPadre = new String[] {""} ;
      H000Y2_A491TDet_PlacaPadre = new String[] {""} ;
      H000Y2_n491TDet_PlacaPadre = new boolean[] {false} ;
      H000Y2_A504TDet_Observaciones = new String[] {""} ;
      H000Y2_n504TDet_Observaciones = new boolean[] {false} ;
      H000Y2_A490TDet_PlacaNumero = new String[] {""} ;
      H000Y2_n490TDet_PlacaNumero = new boolean[] {false} ;
      H000Y2_A489TDet_ValorTotal = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H000Y2_A488TDet_ValorUnitario = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H000Y2_A487TDet_Cantidad = new long[1] ;
      H000Y2_A298Cata_Descripcion = new String[] {""} ;
      H000Y2_A557Elem_Descripcion = new String[] {""} ;
      H000Y2_A66Elem_Consecutivo = new String[] {""} ;
      H000Y2_A69TDet_Consecutivo = new long[1] ;
      A34Clas_Codigo = "" ;
      A35FAM_Codigo = "" ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.alm_transaccionalm_detalle_transaccionwc__default(),
         new Object[] {
             new Object[] {
            H000Y2_A34Clas_Codigo, H000Y2_A35FAM_Codigo, H000Y2_A37Cata_Codigo, H000Y2_A46Tran_Id, H000Y2_A33Tipo_Codigo, H000Y2_A817TDet_PlacaRecuperada, H000Y2_n817TDet_PlacaRecuperada, H000Y2_A77UNIMED_COD, H000Y2_A75SEG_Codigo, H000Y2_A658TDet_Agrupado,
            H000Y2_n658TDet_Agrupado, H000Y2_A657TDet_Otros_Costos, H000Y2_n657TDet_Otros_Costos, H000Y2_A656TDet_Plazo_N, H000Y2_n656TDet_Plazo_N, H000Y2_A655TDet_Taza, H000Y2_n655TDet_Taza, H000Y2_A654TDet_Valor_Futuro, H000Y2_n654TDet_Valor_Futuro, H000Y2_A653TDet_Valor_Presente,
            H000Y2_n653TDet_Valor_Presente, H000Y2_A525TDet_Atributos, H000Y2_A505TDet_EsPadre, H000Y2_A491TDet_PlacaPadre, H000Y2_n491TDet_PlacaPadre, H000Y2_A504TDet_Observaciones, H000Y2_n504TDet_Observaciones, H000Y2_A490TDet_PlacaNumero, H000Y2_n490TDet_PlacaNumero, H000Y2_A489TDet_ValorTotal,
            H000Y2_A488TDet_ValorUnitario, H000Y2_A487TDet_Cantidad, H000Y2_A298Cata_Descripcion, H000Y2_A557Elem_Descripcion, H000Y2_A66Elem_Consecutivo, H000Y2_A69TDet_Consecutivo
            }
            , new Object[] {
   ...
   private String[] H000Y2_A34Clas_Codigo ;
   private String[] H000Y2_A35FAM_Codigo ;
   private String[] H000Y2_A37Cata_Codigo ;
   private long[] H000Y2_A46Tran_Id ;
   private long[] H000Y2_A33Tipo_Codigo ;
   private String[] H000Y2_A817TDet_PlacaRecuperada ;
   private boolean[] H000Y2_n817TDet_PlacaRecuperada ;
   private int[] H000Y2_A77UNIMED_COD ;
   private String[] H000Y2_A75SEG_Codigo ;
   private short[] H000Y2_A658TDet_Agrupado ;
   private boolean[] H000Y2_n658TDet_Agrupado ;
   private java.math.BigDecimal[] H000Y2_A657TDet_Otros_Costos ;
   private boolean[] H000Y2_n657TDet_Otros_Costos ;
   private byte[] H000Y2_A656TDet_Plazo_N ;
   private boolean[] H000Y2_n656TDet_Plazo_N ;
   private short[] H000Y2_A655TDet_Taza ;
   private boolean[] H000Y2_n655TDet_Taza ;
   private java.math.BigDecimal[] H000Y2_A654TDet_Valor_Futuro ;
   private boolean[] H000Y2_n654TDet_Valor_Futuro ;
   private java.math.BigDecimal[] H000Y2_A653TDet_Valor_Presente ;
   private boolean[] H000Y2_n653TDet_Valor_Presente ;
   private String[] H000Y2_A525TDet_Atributos ;
   private String[] H000Y2_A505TDet_EsPadre ;
   private String[] H000Y2_A491TDet_PlacaPadre ;
   private boolean[] H000Y2_n491TDet_PlacaPadre ;
   private String[] H000Y2_A504TDet_Observaciones ;
   private boolean[] H000Y2_n504TDet_Observaciones ;
   private String[] H000Y2_A490TDet_PlacaNumero ;
   private boolean[] H000Y2_n490TDet_PlacaNumero ;
   private java.math.BigDecimal[] H000Y2_A489TDet_ValorTotal ;
   private java.math.BigDecimal[] H000Y2_A488TDet_ValorUnitario ;
   private long[] H000Y2_A487TDet_Cantidad ;
   private String[] H000Y2_A298Cata_Descripcion ;
   private String[] H000Y2_A557Elem_Descripcion ;
   private String[] H000Y2_A66Elem_Consecutivo ;
   private long[] H000Y2_A69TDet_Consecutivo ;
...
final  class alm_transaccionalm_detalle_transaccionwc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H000Y2", "SELECT T3.Clas_Codigo, T4.FAM_Codigo, T2.Cata_Codigo, T1.Tran_Id, T2.Tipo_Codigo, T1.TDet_PlacaRecuperada, T2.UNIMED_COD, T5.SEG_Codigo, T1.TDet_Agrupado, T1.TDet_Otros_Costos, T1.TDet_Plazo_N, T1.TDet_Taza, T1.TDet_Valor_Futuro, T1.TDet_Valor_Presente, T1.TDet_Atributos, T1.TDet_EsPadre, T1.TDet_PlacaPadre, T1.TDet_Observaciones, T1.TDet_PlacaNumero, T1.TDet_ValorTotal, T1.TDet_ValorUnitario, T1.TDet_Cantidad, T3.Cata_Descripcion, T2.Elem_Descripcion, T1.Elem_Consecutivo, T1.TDet_Consecutivo FROM ((((ALM_DETALLE_TRANSACCION T1 INNER JOIN ALM_ELEMENTO T2 ON T2.Elem_Consecutivo = T1.Elem_Consecutivo) INNER JOIN ALM_CATALOGO T3 ON T3.Cata_Codigo = T2.Cata_Codigo) INNER JOIN ALM_CLASE T4 ON T4.Clas_Codigo = T3.Clas_Codigo) INNER JOIN ALM_CAT_FAM T5 ON T5.FAM_Codigo = T4.FAM_Codigo) WHERE T1.Tran_Id = ? ORDER BY T1.Tran_Id  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H000Y3", "SELECT COUNT(*) FROM ((((ALM_DETALLE_TRANSACCION T1 INNER JOIN ALM_ELEMENTO T2 ON T2.Elem_Consecutivo = T1.Elem_Consecutivo) INNER JOIN ALM_CATALOGO T3 ON T3.Cata_Codigo = T2.Cata_Codigo) INNER JOIN ALM_CLASE T4 ON T4.Clas_Codigo = T3.Clas_Codigo) INNER JOIN ALM_CAT_FAM T5 ON T5.FAM_Codigo = T4.FAM_Codigo) WHERE T1.Tran_Id = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
