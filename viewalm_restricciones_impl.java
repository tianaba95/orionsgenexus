/*
               File: viewalm_restricciones_impl
...
public final  class viewalm_restricciones_impl extends GXDataArea
{
   public viewalm_restricciones_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public viewalm_restricciones_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( viewalm_restricciones_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV13Mbod_Id = GXutil.lval( gxfirstwebparm) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV13Mbod_Id", GXutil.ltrim( GXutil.str( AV13Mbod_Id, 11, 0)));
            httpContext.ajax_rsp_assign_attri("", false, "gxhash_vMBOD_ID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV13Mbod_Id), "ZZZZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414175521");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.viewalm_restricciones") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13Mbod_Id,11,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV7TabCode))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vMBOD_ID", GXutil.ltrim( localUtil.ntoc( AV13Mbod_Id, (byte)(11), (byte)(0), ",", "")));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_vMBOD_ID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV13Mbod_Id), "ZZZZZZZZZZ9")));
      ...
      forbiddenHiddens = "hsh" + "ViewALM_RESTRICCIONES" ;
      forbiddenHiddens = forbiddenHiddens + GXutil.rtrim( localUtil.format( A61Mbod_TipoMovCodigo, "")) ;
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "hsh", GXutil.getEncryptedSignature( forbiddenHiddens, GXKey));
      GXutil.writeLogln("viewalm_restricciones:[SendSecurityCheck]"+forbiddenHiddens);
   }
   ...
   {
      return formatLink("com.orions2.viewalm_restricciones") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13Mbod_Id,11,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV7TabCode)) ;
   }

   public String getPgmname( )
   {
      return "ViewALM_RESTRICCIONES" ;
   }
   ...
   public void wb140( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, "Restricciones Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_ViewALM_RESTRICCIONES.htm");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblViewall_Internalname, "Restricciones", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, (short)(0), "HLP_ViewALM_RESTRICCIONES.htm");
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtMbod_TipoMovCodigo_Internalname, A61Mbod_TipoMovCodigo, GXutil.rtrim( localUtil.format( A61Mbod_TipoMovCodigo, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtMbod_TipoMovCodigo_Jsonclick, 0, "ReadonlyAttribute", "", "", "", 1, edtMbod_TipoMovCodigo_Enabled, 0, "text", "", 3, "chr", 1, "row", 3, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_ViewALM_RESTRICCIONES.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewALM_RESTRICCIONES.htm");
         /* Div Control */
   ...
   public void start142( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "View ALM_RESTRICCIONES", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV16Pgmname = "ViewALM_RESTRICCIONES" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf142( )
   {
      ...
      {
         /* Using cursor H00142 */
         pr_default.execute(0, new Object[] {new Long(AV13Mbod_Id)});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A60Mbod_Id = H00142_A60Mbod_Id[0] ;
            A61Mbod_TipoMovCodigo = H00142_A61Mbod_TipoMovCodigo[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A61Mbod_TipoMovCodigo", A61Mbod_TipoMovCodigo);
            httpContext.ajax_rsp_assign_attri("", false, "gxhash_MBOD_TIPOMOVCODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A61Mbod_TipoMovCodigo, ""))));
            /* Execute user event: Load */
            e12142 ();
   ...
   public void strup140( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         httpContext.ajax_rsp_assign_attri("", false, "gxhash_MBOD_TIPOMOVCODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A61Mbod_TipoMovCodigo, ""))));
         /* Read saved values. */
         AV13Mbod_Id = localUtil.ctol( httpContext.cgiGet( "vMBOD_ID"), ",", ".") ;
         ...
         if ( ! GXutil.checkEncryptedSignature( forbiddenHiddens, hsh, GXKey) )
         {
            ...
            GXutil.writeLog("viewalm_restricciones:[SecurityCheckFailed]"+forbiddenHiddens);
            return  ;
         }
      }
      else
   ...
   public void e11142( )
   {
      ...
      AV17GXLvl6 = (byte)(0) ;
      /* Using cursor H00143 */
      pr_default.execute(1, new Object[] {new Long(AV13Mbod_Id)});
      while ( (pr_default.getStatus(1) != 101) )
      {
         A60Mbod_Id = H00143_A60Mbod_Id[0] ;
         A61Mbod_TipoMovCodigo = H00143_A61Mbod_TipoMovCodigo[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A61Mbod_TipoMovCodigo", A61Mbod_TipoMovCodigo);
         httpContext.ajax_rsp_assign_attri("", false, "gxhash_MBOD_TIPOMOVCODIGO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A61Mbod_TipoMovCodigo, ""))));
         AV17GXLvl6 = (byte)(1) ;
         Form.setCaption( A61Mbod_TipoMovCodigo );
         httpContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.getCaption(), true);
         lblViewall_Link = formatLink("com.orions2.wwalm_restricciones")  ;
   ...
   public void S112( )
   {
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "ALM_RESTRICCIONESGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.orions2.alm_restriccionesgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "ALM_RESTRICCIONESGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0029","",new Long(AV13Mbod_Id)});
   ...
   {
      AV13Mbod_Id = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.LONG)).longValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV13Mbod_Id", GXutil.ltrim( GXutil.str( AV13Mbod_Id, 11, 0)));
      httpContext.ajax_rsp_assign_attri("", false, "gxhash_vMBOD_ID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV13Mbod_Id), "ZZZZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414175548");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("viewalm_restricciones.js", "?201861414175548");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "");
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "View ALM_RESTRICCIONES" );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   public void initialize( )
   {
      ...
      AV16Pgmname = "" ;
      scmdbuf = "" ;
      H00142_A60Mbod_Id = new long[1] ;
      H00142_A61Mbod_TipoMovCodigo = new String[] {""} ;
      hsh = "" ;
      H00143_A60Mbod_Id = new long[1] ;
      H00143_A61Mbod_TipoMovCodigo = new String[] {""} ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.viewalm_restricciones__default(),
         new Object[] {
             new Object[] {
            H00142_A60Mbod_Id, H00142_A61Mbod_TipoMovCodigo
            }
            , new Object[] {
            H00143_A60Mbod_Id, H00143_A61Mbod_TipoMovCodigo
            }
         }
      );
      AV16Pgmname = "ViewALM_RESTRICCIONES" ;
   ...
   private int idxLst ;
   private long wcpOAV13Mbod_Id ;
   private long AV13Mbod_Id ;
   ...
   private long[] H00142_A60Mbod_Id ;
   private String[] H00142_A61Mbod_TipoMovCodigo ;
   private long[] H00143_A60Mbod_Id ;
   private String[] H00143_A61Mbod_TipoMovCodigo ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class viewalm_restricciones__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00142", "SELECT Mbod_Id, Mbod_TipoMovCodigo FROM ALM_RESTRICCIONES WHERE Mbod_Id = ? ORDER BY Mbod_Id ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H00143", "SELECT Mbod_Id, Mbod_TipoMovCodigo FROM ALM_RESTRICCIONES WHERE Mbod_Id = ? ORDER BY Mbod_Id ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
