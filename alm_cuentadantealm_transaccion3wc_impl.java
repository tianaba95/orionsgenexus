/*
               File: alm_cuentadantealm_transaccion3wc_impl
...
public final  class alm_cuentadantealm_transaccion3wc_impl extends GXWebComponent
{
   public alm_cuentadantealm_transaccion3wc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public alm_cuentadantealm_transaccion3wc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( alm_cuentadantealm_transaccion3wc_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "ALM_CUENTADANTEALM_TRANSACCION3 WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414124379");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.alm_cuentadantealm_transaccion3wc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Tran_IdCuentadanteResponsabilidad,18,0)))+"\">") ;
   ...
   public void renderHtmlCloseForm1H2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("alm_cuentadantealm_transaccion3wc.js", "?201861414124383");
      }
   ...
   {
      return "ALM_CUENTADANTEALM_TRANSACCION3WC" ;
   }
   ...
   public void wb1H0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.alm_cuentadantealm_transaccion3wc");
         }
         /* Div Control */
   ...
   public void start1H2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "ALM_CUENTADANTEALM_TRANSACCION3 WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "ALM_CUENTADANTEALM_TRANSACCION3WC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf1H2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A416Tran_Observaciones = H001H2_A416Tran_Observaciones[0] ;
            n416Tran_Observaciones = H001H2_n416Tran_Observaciones[0] ;
            A56Tran_IdCuentadanteResponsabili = H001H2_A56Tran_IdCuentadanteResponsabili[0] ;
            ...
            n56Tran_IdCuentadanteResponsabili = H001H2_n56Tran_IdCuentadanteResponsabili[0] ;
            A859Tran_EntidadGobierno = H001H2_A859Tran_EntidadGobierno[0] ;
            n859Tran_EntidadGobierno = H001H2_n859Tran_EntidadGobierno[0] ;
            A758Tran_TablaResponsabilidad = H001H2_A758Tran_TablaResponsabilidad[0] ;
            n758Tran_TablaResponsabilidad = H001H2_n758Tran_TablaResponsabilidad[0] ;
            A756Tran_Abreviado = H001H2_A756Tran_Abreviado[0] ;
            n756Tran_Abreviado = H001H2_n756Tran_Abreviado[0] ;
            A754Tran_CuentaResponsabilidad = H001H2_A754Tran_CuentaResponsabilidad[0] ;
            n754Tran_CuentaResponsabilidad = H001H2_n754Tran_CuentaResponsabilidad[0] ;
            A720Tran_FechaResponsabilidad = H001H2_A720Tran_FechaResponsabilidad[0] ;
            n720Tran_FechaResponsabilidad = H001H2_n720Tran_FechaResponsabilidad[0] ;
            A719Tran_TransaccResponsabilidad = H001H2_A719Tran_TransaccResponsabilidad[0] ;
            n719Tran_TransaccResponsabilidad = H001H2_n719Tran_TransaccResponsabilidad[0] ;
            A670Tran_ObservacionesAnula = H001H2_A670Tran_ObservacionesAnula[0] ;
            n670Tran_ObservacionesAnula = H001H2_n670Tran_ObservacionesAnula[0] ;
            A669Tran_FechaEliminaoAnula = H001H2_A669Tran_FechaEliminaoAnula[0] ;
            n669Tran_FechaEliminaoAnula = H001H2_n669Tran_FechaEliminaoAnula[0] ;
            A668Tran_UsuarioEliminaoAnula = H001H2_A668Tran_UsuarioEliminaoAnula[0] ;
            n668Tran_UsuarioEliminaoAnula = H001H2_n668Tran_UsuarioEliminaoAnula[0] ;
            A667Tran_NumeroGrupo = H001H2_A667Tran_NumeroGrupo[0] ;
            n667Tran_NumeroGrupo = H001H2_n667Tran_NumeroGrupo[0] ;
            A568Tran_CantidadPadres = H001H2_A568Tran_CantidadPadres[0] ;
            n568Tran_CantidadPadres = H001H2_n568Tran_CantidadPadres[0] ;
            A527Tran_TipoEntra = H001H2_A527Tran_TipoEntra[0] ;
            n527Tran_TipoEntra = H001H2_n527Tran_TipoEntra[0] ;
            A524Tran_Detalle = H001H2_A524Tran_Detalle[0] ;
            n524Tran_Detalle = H001H2_n524Tran_Detalle[0] ;
            A608Tran_RegionAbrevDestino = H001H2_A608Tran_RegionAbrevDestino[0] ;
            n608Tran_RegionAbrevDestino = H001H2_n608Tran_RegionAbrevDestino[0] ;
            A520Tran_RegionDescripcionDestino = H001H2_A520Tran_RegionDescripcionDestino[0] ;
            n520Tran_RegionDescripcionDestino = H001H2_n520Tran_RegionDescripcionDestino[0] ;
            A519Tran_RegionCodigoDestino = H001H2_A519Tran_RegionCodigoDestino[0] ;
            n519Tran_RegionCodigoDestino = H001H2_n519Tran_RegionCodigoDestino[0] ;
            A518Tran_RegionIdDestino = H001H2_A518Tran_RegionIdDestino[0] ;
            n518Tran_RegionIdDestino = H001H2_n518Tran_RegionIdDestino[0] ;
            A517Tran_CentroCostoDescripcionDes = H001H2_A517Tran_CentroCostoDescripcionDes[0] ;
            n517Tran_CentroCostoDescripcionDes = H001H2_n517Tran_CentroCostoDescripcionDes[0] ;
            A516Tran_CentroCostoCodigoDestino = H001H2_A516Tran_CentroCostoCodigoDestino[0] ;
            n516Tran_CentroCostoCodigoDestino = H001H2_n516Tran_CentroCostoCodigoDestino[0] ;
            A50Tran_CentroCostoIdDestino = H001H2_A50Tran_CentroCostoIdDestino[0] ;
            n50Tran_CentroCostoIdDestino = H001H2_n50Tran_CentroCostoIdDestino[0] ;
            A515Tran_FechaIngreso = H001H2_A515Tran_FechaIngreso[0] ;
            n515Tran_FechaIngreso = H001H2_n515Tran_FechaIngreso[0] ;
            A514Tran_NumeroIngreso = H001H2_A514Tran_NumeroIngreso[0] ;
            n514Tran_NumeroIngreso = H001H2_n514Tran_NumeroIngreso[0] ;
            A672Tran_NombreIngreso = H001H2_A672Tran_NombreIngreso[0] ;
            n672Tran_NombreIngreso = H001H2_n672Tran_NombreIngreso[0] ;
            A54Tran_TipoIngreso = H001H2_A54Tran_TipoIngreso[0] ;
            n54Tran_TipoIngreso = H001H2_n54Tran_TipoIngreso[0] ;
            A513Tran_ConsecutivoCC = H001H2_A513Tran_ConsecutivoCC[0] ;
            n513Tran_ConsecutivoCC = H001H2_n513Tran_ConsecutivoCC[0] ;
            A391Tran_UsuarioRatifica = H001H2_A391Tran_UsuarioRatifica[0] ;
            n391Tran_UsuarioRatifica = H001H2_n391Tran_UsuarioRatifica[0] ;
            A390Tran_FechaRatificacion = H001H2_A390Tran_FechaRatificacion[0] ;
            n390Tran_FechaRatificacion = H001H2_n390Tran_FechaRatificacion[0] ;
            A58Tran_Estado = H001H2_A58Tran_Estado[0] ;
            n58Tran_Estado = H001H2_n58Tran_Estado[0] ;
            A498Tran_NumeroLineas = H001H2_A498Tran_NumeroLineas[0] ;
            n498Tran_NumeroLineas = H001H2_n498Tran_NumeroLineas[0] ;
            A483Tran_ValorTransaccion = H001H2_A483Tran_ValorTransaccion[0] ;
            n483Tran_ValorTransaccion = H001H2_n483Tran_ValorTransaccion[0] ;
            A408Tran_CursoCodigo = H001H2_A408Tran_CursoCodigo[0] ;
            n408Tran_CursoCodigo = H001H2_n408Tran_CursoCodigo[0] ;
            A407Tran_AreadanteCodigo = H001H2_A407Tran_AreadanteCodigo[0] ;
            n407Tran_AreadanteCodigo = H001H2_n407Tran_AreadanteCodigo[0] ;
            A715Tran_EmailCuentadanteDestino = H001H2_A715Tran_EmailCuentadanteDestino[0] ;
            n715Tran_EmailCuentadanteDestino = H001H2_n715Tran_EmailCuentadanteDestino[0] ;
            A704Tran_CedulaCuentadanteDestino = H001H2_A704Tran_CedulaCuentadanteDestino[0] ;
            n704Tran_CedulaCuentadanteDestino = H001H2_n704Tran_CedulaCuentadanteDestino[0] ;
            A389Tran_NombCuentadanteDestino = H001H2_A389Tran_NombCuentadanteDestino[0] ;
            n389Tran_NombCuentadanteDestino = H001H2_n389Tran_NombCuentadanteDestino[0] ;
            A52Tran_IdCuentadanteDestino = H001H2_A52Tran_IdCuentadanteDestino[0] ;
            n52Tran_IdCuentadanteDestino = H001H2_n52Tran_IdCuentadanteDestino[0] ;
            A387Tran_CodBodeDestino = H001H2_A387Tran_CodBodeDestino[0] ;
            A111Tran_CodAlmaDestino = H001H2_A111Tran_CodAlmaDestino[0] ;
            A385Tran_ModuloDestino = H001H2_A385Tran_ModuloDestino[0] ;
            A703Tran_CedulaProveedor = H001H2_A703Tran_CedulaProveedor[0] ;
            n703Tran_CedulaProveedor = H001H2_n703Tran_CedulaProveedor[0] ;
            A575Tran_NombreProveedor = H001H2_A575Tran_NombreProveedor[0] ;
            n575Tran_NombreProveedor = H001H2_n575Tran_NombreProveedor[0] ;
            A53Tran_IdProveedor = H001H2_A53Tran_IdProveedor[0] ;
            n53Tran_IdProveedor = H001H2_n53Tran_IdProveedor[0] ;
            A714Tran_EmailCuentadanteOrigen = H001H2_A714Tran_EmailCuentadanteOrigen[0] ;
            n714Tran_EmailCuentadanteOrigen = H001H2_n714Tran_EmailCuentadanteOrigen[0] ;
            A702Tran_CedulaCuentadanteOrigen = H001H2_A702Tran_CedulaCuentadanteOrigen[0] ;
            n702Tran_CedulaCuentadanteOrigen = H001H2_n702Tran_CedulaCuentadanteOrigen[0] ;
            A384Tran_NombCuentadanteOrigen = H001H2_A384Tran_NombCuentadanteOrigen[0] ;
            n384Tran_NombCuentadanteOrigen = H001H2_n384Tran_NombCuentadanteOrigen[0] ;
            A51Tran_IdCuentadanteOrigen = H001H2_A51Tran_IdCuentadanteOrigen[0] ;
            n51Tran_IdCuentadanteOrigen = H001H2_n51Tran_IdCuentadanteOrigen[0] ;
            A112Tran_CodBodeOrigen = H001H2_A112Tran_CodBodeOrigen[0] ;
            A109Tran_CodAlmaOrigen = H001H2_A109Tran_CodAlmaOrigen[0] ;
            A110Tran_ModuloOrigen = H001H2_A110Tran_ModuloOrigen[0] ;
            A708Tran_SolicitaRegionDestino = H001H2_A708Tran_SolicitaRegionDestino[0] ;
            n708Tran_SolicitaRegionDestino = H001H2_n708Tran_SolicitaRegionDestino[0] ;
            A707Tran_SolicitaCCDestino = H001H2_A707Tran_SolicitaCCDestino[0] ;
            n707Tran_SolicitaCCDestino = H001H2_n707Tran_SolicitaCCDestino[0] ;
            A482Tran_TipoElemento = H001H2_A482Tran_TipoElemento[0] ;
            A499Tran_CodTipoElemento = H001H2_A499Tran_CodTipoElemento[0] ;
            n499Tran_CodTipoElemento = H001H2_n499Tran_CodTipoElemento[0] ;
            A479Tran_IndCurso = H001H2_A479Tran_IndCurso[0] ;
            n479Tran_IndCurso = H001H2_n479Tran_IndCurso[0] ;
            A481Tran_IndE_S = H001H2_A481Tran_IndE_S[0] ;
            n481Tran_IndE_S = H001H2_n481Tran_IndE_S[0] ;
            A478Tran_IndAreadante = H001H2_A478Tran_IndAreadante[0] ;
            n478Tran_IndAreadante = H001H2_n478Tran_IndAreadante[0] ;
            A381Tran_DescripcionMovimiento = H001H2_A381Tran_DescripcionMovimiento[0] ;
            n381Tran_DescripcionMovimiento = H001H2_n381Tran_DescripcionMovimiento[0] ;
            A49Tran_CodigoMovimiento = H001H2_A49Tran_CodigoMovimiento[0] ;
            A594Tran_RegionAbrev = H001H2_A594Tran_RegionAbrev[0] ;
            n594Tran_RegionAbrev = H001H2_n594Tran_RegionAbrev[0] ;
            A422Tran_RegionDescripcion = H001H2_A422Tran_RegionDescripcion[0] ;
            n422Tran_RegionDescripcion = H001H2_n422Tran_RegionDescripcion[0] ;
            A421Tran_RegionCodigo = H001H2_A421Tran_RegionCodigo[0] ;
            n421Tran_RegionCodigo = H001H2_n421Tran_RegionCodigo[0] ;
            A57Tran_RegionId = H001H2_A57Tran_RegionId[0] ;
            n57Tran_RegionId = H001H2_n57Tran_RegionId[0] ;
            A420Tran_CentroCostoDescripcion = H001H2_A420Tran_CentroCostoDescripcion[0] ;
            n420Tran_CentroCostoDescripcion = H001H2_n420Tran_CentroCostoDescripcion[0] ;
            A419Tran_CentroCostoCodigo = H001H2_A419Tran_CentroCostoCodigo[0] ;
            n419Tran_CentroCostoCodigo = H001H2_n419Tran_CentroCostoCodigo[0] ;
            A48Tran_CentroCostoId = H001H2_A48Tran_CentroCostoId[0] ;
            A418Tran_UsuarioNombre = H001H2_A418Tran_UsuarioNombre[0] ;
            n418Tran_UsuarioNombre = H001H2_n418Tran_UsuarioNombre[0] ;
            A417Tran_UsuarioCodigo = H001H2_A417Tran_UsuarioCodigo[0] ;
            n417Tran_UsuarioCodigo = H001H2_n417Tran_UsuarioCodigo[0] ;
            A47Tran_UsuarioId = H001H2_A47Tran_UsuarioId[0] ;
            n47Tran_UsuarioId = H001H2_n47Tran_UsuarioId[0] ;
            A55Tran_FechaRegistro = H001H2_A55Tran_FechaRegistro[0] ;
            A46Tran_Id = H001H2_A46Tran_Id[0] ;
            A608Tran_RegionAbrevDestino = H001H2_A608Tran_RegionAbrevDestino[0] ;
            n608Tran_RegionAbrevDestino = H001H2_n608Tran_RegionAbrevDestino[0] ;
            A520Tran_RegionDescripcionDestino = H001H2_A520Tran_RegionDescripcionDestino[0] ;
            n520Tran_RegionDescripcionDestino = H001H2_n520Tran_RegionDescripcionDestino[0] ;
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "alm_cuentadantealm_transaccion3wc");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414124653");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("alm_cuentadantealm_transaccion3wc.js", "?201861414124653");
      }
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e131H2',iparms:[{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtTran_ConsecutivoCC_Link',ctrl:'TRAN_CONSECUTIVOCC',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e111H2',iparms:[{av:'A46Tran_Id',fld:'TRAN_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H001H2_A416Tran_Observaciones = new String[] {""} ;
      H001H2_n416Tran_Observaciones = new boolean[] {false} ;
      H001H2_A56Tran_IdCuentadanteResponsabili = new long[1] ;
      H001H2_n56Tran_IdCuentadanteResponsabili = new boolean[] {false} ;
      H001H2_A859Tran_EntidadGobierno = new String[] {""} ;
      H001H2_n859Tran_EntidadGobierno = new boolean[] {false} ;
      H001H2_A758Tran_TablaResponsabilidad = new short[1] ;
      H001H2_n758Tran_TablaResponsabilidad = new boolean[] {false} ;
      H001H2_A756Tran_Abreviado = new String[] {""} ;
      H001H2_n756Tran_Abreviado = new boolean[] {false} ;
      H001H2_A754Tran_CuentaResponsabilidad = new String[] {""} ;
      H001H2_n754Tran_CuentaResponsabilidad = new boolean[] {false} ;
      H001H2_A720Tran_FechaResponsabilidad = new java.util.Date[] {GXutil.nullDate()} ;
      H001H2_n720Tran_FechaResponsabilidad = new boolean[] {false} ;
      H001H2_A719Tran_TransaccResponsabilidad = new long[1] ;
      H001H2_n719Tran_TransaccResponsabilidad = new boolean[] {false} ;
      H001H2_A670Tran_ObservacionesAnula = new String[] {""} ;
      H001H2_n670Tran_ObservacionesAnula = new boolean[] {false} ;
      H001H2_A669Tran_FechaEliminaoAnula = new java.util.Date[] {GXutil.nullDate()} ;
      H001H2_n669Tran_FechaEliminaoAnula = new boolean[] {false} ;
      H001H2_A668Tran_UsuarioEliminaoAnula = new String[] {""} ;
      H001H2_n668Tran_UsuarioEliminaoAnula = new boolean[] {false} ;
      H001H2_A667Tran_NumeroGrupo = new short[1] ;
      H001H2_n667Tran_NumeroGrupo = new boolean[] {false} ;
      H001H2_A568Tran_CantidadPadres = new int[1] ;
      H001H2_n568Tran_CantidadPadres = new boolean[] {false} ;
      H001H2_A527Tran_TipoEntra = new String[] {""} ;
      H001H2_n527Tran_TipoEntra = new boolean[] {false} ;
      H001H2_A524Tran_Detalle = new String[] {""} ;
      H001H2_n524Tran_Detalle = new boolean[] {false} ;
      H001H2_A608Tran_RegionAbrevDestino = new String[] {""} ;
      H001H2_n608Tran_RegionAbrevDestino = new boolean[] {false} ;
      H001H2_A520Tran_RegionDescripcionDestino = new String[] {""} ;
      H001H2_n520Tran_RegionDescripcionDestino = new boolean[] {false} ;
      H001H2_A519Tran_RegionCodigoDestino = new short[1] ;
      H001H2_n519Tran_RegionCodigoDestino = new boolean[] {false} ;
      H001H2_A518Tran_RegionIdDestino = new long[1] ;
      H001H2_n518Tran_RegionIdDestino = new boolean[] {false} ;
      H001H2_A517Tran_CentroCostoDescripcionDes = new String[] {""} ;
      H001H2_n517Tran_CentroCostoDescripcionDes = new boolean[] {false} ;
      H001H2_A516Tran_CentroCostoCodigoDestino = new String[] {""} ;
      H001H2_n516Tran_CentroCostoCodigoDestino = new boolean[] {false} ;
      H001H2_A50Tran_CentroCostoIdDestino = new long[1] ;
      H001H2_n50Tran_CentroCostoIdDestino = new boolean[] {false} ;
      H001H2_A515Tran_FechaIngreso = new java.util.Date[] {GXutil.nullDate()} ;
      H001H2_n515Tran_FechaIngreso = new boolean[] {false} ;
      H001H2_A514Tran_NumeroIngreso = new String[] {""} ;
      H001H2_n514Tran_NumeroIngreso = new boolean[] {false} ;
      H001H2_A672Tran_NombreIngreso = new String[] {""} ;
      H001H2_n672Tran_NombreIngreso = new boolean[] {false} ;
      H001H2_A54Tran_TipoIngreso = new long[1] ;
      H001H2_n54Tran_TipoIngreso = new boolean[] {false} ;
      H001H2_A513Tran_ConsecutivoCC = new long[1] ;
      H001H2_n513Tran_ConsecutivoCC = new boolean[] {false} ;
      H001H2_A391Tran_UsuarioRatifica = new String[] {""} ;
      H001H2_n391Tran_UsuarioRatifica = new boolean[] {false} ;
      H001H2_A390Tran_FechaRatificacion = new java.util.Date[] {GXutil.nullDate()} ;
      H001H2_n390Tran_FechaRatificacion = new boolean[] {false} ;
      H001H2_A58Tran_Estado = new String[] {""} ;
      H001H2_n58Tran_Estado = new boolean[] {false} ;
      H001H2_A498Tran_NumeroLineas = new long[1] ;
      H001H2_n498Tran_NumeroLineas = new boolean[] {false} ;
      H001H2_A483Tran_ValorTransaccion = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H001H2_n483Tran_ValorTransaccion = new boolean[] {false} ;
      H001H2_A408Tran_CursoCodigo = new String[] {""} ;
      H001H2_n408Tran_CursoCodigo = new boolean[] {false} ;
      H001H2_A407Tran_AreadanteCodigo = new String[] {""} ;
      H001H2_n407Tran_AreadanteCodigo = new boolean[] {false} ;
      H001H2_A715Tran_EmailCuentadanteDestino = new String[] {""} ;
      H001H2_n715Tran_EmailCuentadanteDestino = new boolean[] {false} ;
      H001H2_A704Tran_CedulaCuentadanteDestino = new long[1] ;
      H001H2_n704Tran_CedulaCuentadanteDestino = new boolean[] {false} ;
      H001H2_A389Tran_NombCuentadanteDestino = new String[] {""} ;
      H001H2_n389Tran_NombCuentadanteDestino = new boolean[] {false} ;
      H001H2_A52Tran_IdCuentadanteDestino = new long[1] ;
      H001H2_n52Tran_IdCuentadanteDestino = new boolean[] {false} ;
      H001H2_A387Tran_CodBodeDestino = new String[] {""} ;
      H001H2_A111Tran_CodAlmaDestino = new String[] {""} ;
      H001H2_A385Tran_ModuloDestino = new String[] {""} ;
      H001H2_A703Tran_CedulaProveedor = new long[1] ;
      H001H2_n703Tran_CedulaProveedor = new boolean[] {false} ;
      H001H2_A575Tran_NombreProveedor = new String[] {""} ;
      H001H2_n575Tran_NombreProveedor = new boolean[] {false} ;
      H001H2_A53Tran_IdProveedor = new long[1] ;
      H001H2_n53Tran_IdProveedor = new boolean[] {false} ;
      H001H2_A714Tran_EmailCuentadanteOrigen = new String[] {""} ;
      H001H2_n714Tran_EmailCuentadanteOrigen = new boolean[] {false} ;
      H001H2_A702Tran_CedulaCuentadanteOrigen = new long[1] ;
      H001H2_n702Tran_CedulaCuentadanteOrigen = new boolean[] {false} ;
      H001H2_A384Tran_NombCuentadanteOrigen = new String[] {""} ;
      H001H2_n384Tran_NombCuentadanteOrigen = new boolean[] {false} ;
      H001H2_A51Tran_IdCuentadanteOrigen = new long[1] ;
      H001H2_n51Tran_IdCuentadanteOrigen = new boolean[] {false} ;
      H001H2_A112Tran_CodBodeOrigen = new String[] {""} ;
      H001H2_A109Tran_CodAlmaOrigen = new String[] {""} ;
      H001H2_A110Tran_ModuloOrigen = new String[] {""} ;
      H001H2_A708Tran_SolicitaRegionDestino = new String[] {""} ;
      H001H2_n708Tran_SolicitaRegionDestino = new boolean[] {false} ;
      H001H2_A707Tran_SolicitaCCDestino = new String[] {""} ;
      H001H2_n707Tran_SolicitaCCDestino = new boolean[] {false} ;
      H001H2_A482Tran_TipoElemento = new String[] {""} ;
      H001H2_A499Tran_CodTipoElemento = new long[1] ;
      H001H2_n499Tran_CodTipoElemento = new boolean[] {false} ;
      H001H2_A479Tran_IndCurso = new String[] {""} ;
      H001H2_n479Tran_IndCurso = new boolean[] {false} ;
      H001H2_A481Tran_IndE_S = new String[] {""} ;
      H001H2_n481Tran_IndE_S = new boolean[] {false} ;
      H001H2_A478Tran_IndAreadante = new String[] {""} ;
      H001H2_n478Tran_IndAreadante = new boolean[] {false} ;
      H001H2_A381Tran_DescripcionMovimiento = new String[] {""} ;
      H001H2_n381Tran_DescripcionMovimiento = new boolean[] {false} ;
      H001H2_A49Tran_CodigoMovimiento = new String[] {""} ;
      H001H2_A594Tran_RegionAbrev = new String[] {""} ;
      H001H2_n594Tran_RegionAbrev = new boolean[] {false} ;
      H001H2_A422Tran_RegionDescripcion = new String[] {""} ;
      H001H2_n422Tran_RegionDescripcion = new boolean[] {false} ;
      H001H2_A421Tran_RegionCodigo = new short[1] ;
      H001H2_n421Tran_RegionCodigo = new boolean[] {false} ;
      H001H2_A57Tran_RegionId = new long[1] ;
      H001H2_n57Tran_RegionId = new boolean[] {false} ;
      H001H2_A420Tran_CentroCostoDescripcion = new String[] {""} ;
      H001H2_n420Tran_CentroCostoDescripcion = new boolean[] {false} ;
      H001H2_A419Tran_CentroCostoCodigo = new String[] {""} ;
      H001H2_n419Tran_CentroCostoCodigo = new boolean[] {false} ;
      H001H2_A48Tran_CentroCostoId = new long[1] ;
      H001H2_A418Tran_UsuarioNombre = new String[] {""} ;
      H001H2_n418Tran_UsuarioNombre = new boolean[] {false} ;
      H001H2_A417Tran_UsuarioCodigo = new String[] {""} ;
      H001H2_n417Tran_UsuarioCodigo = new boolean[] {false} ;
      H001H2_A47Tran_UsuarioId = new long[1] ;
      H001H2_n47Tran_UsuarioId = new boolean[] {false} ;
      H001H2_A55Tran_FechaRegistro = new java.util.Date[] {GXutil.nullDate()} ;
      H001H2_A46Tran_Id = new long[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.alm_cuentadantealm_transaccion3wc__default(),
         new Object[] {
             new Object[] {
            H001H2_A416Tran_Observaciones, H001H2_n416Tran_Observaciones, H001H2_A56Tran_IdCuentadanteResponsabili, H001H2_n56Tran_IdCuentadanteResponsabili, H001H2_A859Tran_EntidadGobierno, H001H2_n859Tran_EntidadGobierno, H001H2_A758Tran_TablaResponsabilidad, H001H2_n758Tran_TablaResponsabilidad, H001H2_A756Tran_Abreviado, H001H2_n756Tran_Abreviado,
            H001H2_A754Tran_CuentaResponsabilidad, H001H2_n754Tran_CuentaResponsabilidad, H001H2_A720Tran_FechaResponsabilidad, H001H2_n720Tran_FechaResponsabilidad, H001H2_A719Tran_TransaccResponsabilidad, H001H2_n719Tran_TransaccResponsabilidad, H001H2_A670Tran_ObservacionesAnula, H001H2_n670Tran_ObservacionesAnula, H001H2_A669Tran_FechaEliminaoAnula, H001H2_n669Tran_FechaEliminaoAnula,
            H001H2_A668Tran_UsuarioEliminaoAnula, H001H2_n668Tran_UsuarioEliminaoAnula, H001H2_A667Tran_NumeroGrupo, H001H2_n667Tran_NumeroGrupo, H001H2_A568Tran_CantidadPadres, H001H2_n568Tran_CantidadPadres, H001H2_A527Tran_TipoEntra, H001H2_n527Tran_TipoEntra, H001H2_A524Tran_Detalle, H001H2_n524Tran_Detalle,
            H001H2_A608Tran_RegionAbrevDestino, H001H2_n608Tran_RegionAbrevDestino, H001H2_A520Tran_RegionDescripcionDestino, H001H2_n520Tran_RegionDescripcionDestino, H001H2_A519Tran_RegionCodigoDestino, H001H2_n519Tran_RegionCodigoDestino, H001H2_A518Tran_RegionIdDestino, H001H2_n518Tran_RegionIdDestino, H001H2_A517Tran_CentroCostoDescripcionDes, H001H2_n517Tran_CentroCostoDescripcionDes,
            H001H2_A516Tran_CentroCostoCodigoDestino, H001H2_n516Tran_CentroCostoCodigoDestino, H001H2_A50Tran_CentroCostoIdDestino, H001H2_n50Tran_CentroCostoIdDestino, H001H2_A515Tran_FechaIngreso, H001H2_n515Tran_FechaIngreso, H001H2_A514Tran_NumeroIngreso, H001H2_n514Tran_NumeroIngreso, H001H2_A672Tran_NombreIngreso, H001H2_n672Tran_NombreIngreso,
            H001H2_A54Tran_TipoIngreso, H001H2_n54Tran_TipoIngreso, H001H2_A513Tran_ConsecutivoCC, H001H2_n513Tran_ConsecutivoCC, H001H2_A391Tran_UsuarioRatifica, H001H2_n391Tran_UsuarioRatifica, H001H2_A390Tran_FechaRatificacion, H001H2_n390Tran_FechaRatificacion, H001H2_A58Tran_Estado, H001H2_n58Tran_Estado,
            H001H2_A498Tran_NumeroLineas, H001H2_n498Tran_NumeroLineas, H001H2_A483Tran_ValorTransaccion, H001H2_n483Tran_ValorTransaccion, H001H2_A408Tran_CursoCodigo, H001H2_n408Tran_CursoCodigo, H001H2_A407Tran_AreadanteCodigo, H001H2_n407Tran_AreadanteCodigo, H001H2_A715Tran_EmailCuentadanteDestino, H001H2_n715Tran_EmailCuentadanteDestino,
            H001H2_A704Tran_CedulaCuentadanteDestino, H001H2_n704Tran_CedulaCuentadanteDestino, H001H2_A389Tran_NombCuentadanteDestino, H001H2_n389Tran_NombCuentadanteDestino, H001H2_A52Tran_IdCuentadanteDestino, H001H2_n52Tran_IdCuentadanteDestino, H001H2_A387Tran_CodBodeDestino, H001H2_A111Tran_CodAlmaDestino, H001H2_A385Tran_ModuloDestino, H001H2_A703Tran_CedulaProveedor,
            H001H2_n703Tran_CedulaProveedor, H001H2_A575Tran_NombreProveedor, H001H2_n575Tran_NombreProveedor, H001H2_A53Tran_IdProveedor, H001H2_n53Tran_IdProveedor, H001H2_A714Tran_EmailCuentadanteOrigen, H001H2_n714Tran_EmailCuentadanteOrigen, H001H2_A702Tran_CedulaCuentadanteOrigen, H001H2_n702Tran_CedulaCuentadanteOrigen, H001H2_A384Tran_NombCuentadanteOrigen,
            H001H2_n384Tran_NombCuentadanteOrigen, H001H2_A51Tran_IdCuentadanteOrigen, H001H2_n51Tran_IdCuentadanteOrigen, H001H2_A112Tran_CodBodeOrigen, H001H2_A109Tran_CodAlmaOrigen, H001H2_A110Tran_ModuloOrigen, H001H2_A708Tran_SolicitaRegionDestino, H001H2_n708Tran_SolicitaRegionDestino, H001H2_A707Tran_SolicitaCCDestino, H001H2_n707Tran_SolicitaCCDestino,
            H001H2_A482Tran_TipoElemento, H001H2_A499Tran_CodTipoElemento, H001H2_n499Tran_CodTipoElemento, H001H2_A479Tran_IndCurso, H001H2_n479Tran_IndCurso, H001H2_A481Tran_IndE_S, H001H2_n481Tran_IndE_S, H001H2_A478Tran_IndAreadante, H001H2_n478Tran_IndAreadante, H001H2_A381Tran_DescripcionMovimiento,
            H001H2_n381Tran_DescripcionMovimiento, H001H2_A49Tran_CodigoMovimiento, H001H2_A594Tran_RegionAbrev, H001H2_n594Tran_RegionAbrev, H001H2_A422Tran_RegionDescripcion, H001H2_n422Tran_RegionDescripcion, H001H2_A421Tran_RegionCodigo, H001H2_n421Tran_RegionCodigo, H001H2_A57Tran_RegionId, H001H2_n57Tran_RegionId,
            H001H2_A420Tran_CentroCostoDescripcion, H001H2_n420Tran_CentroCostoDescripcion, H001H2_A419Tran_CentroCostoCodigo, H001H2_n419Tran_CentroCostoCodigo, H001H2_A48Tran_CentroCostoId, H001H2_A418Tran_UsuarioNombre, H001H2_n418Tran_UsuarioNombre, H001H2_A417Tran_UsuarioCodigo, H001H2_n417Tran_UsuarioCodigo, H001H2_A47Tran_UsuarioId,
            H001H2_n47Tran_UsuarioId, H001H2_A55Tran_FechaRegistro, H001H2_A46Tran_Id
            }
            , new Object[] {
   ...
   private String[] H001H2_A416Tran_Observaciones ;
   private boolean[] H001H2_n416Tran_Observaciones ;
   private long[] H001H2_A56Tran_IdCuentadanteResponsabili ;
   private boolean[] H001H2_n56Tran_IdCuentadanteResponsabili ;
   private String[] H001H2_A859Tran_EntidadGobierno ;
   private boolean[] H001H2_n859Tran_EntidadGobierno ;
   private short[] H001H2_A758Tran_TablaResponsabilidad ;
   private boolean[] H001H2_n758Tran_TablaResponsabilidad ;
   private String[] H001H2_A756Tran_Abreviado ;
   private boolean[] H001H2_n756Tran_Abreviado ;
   private String[] H001H2_A754Tran_CuentaResponsabilidad ;
   private boolean[] H001H2_n754Tran_CuentaResponsabilidad ;
   private java.util.Date[] H001H2_A720Tran_FechaResponsabilidad ;
   private boolean[] H001H2_n720Tran_FechaResponsabilidad ;
   private long[] H001H2_A719Tran_TransaccResponsabilidad ;
   private boolean[] H001H2_n719Tran_TransaccResponsabilidad ;
   private String[] H001H2_A670Tran_ObservacionesAnula ;
   private boolean[] H001H2_n670Tran_ObservacionesAnula ;
   private java.util.Date[] H001H2_A669Tran_FechaEliminaoAnula ;
   private boolean[] H001H2_n669Tran_FechaEliminaoAnula ;
   private String[] H001H2_A668Tran_UsuarioEliminaoAnula ;
   private boolean[] H001H2_n668Tran_UsuarioEliminaoAnula ;
   private short[] H001H2_A667Tran_NumeroGrupo ;
   private boolean[] H001H2_n667Tran_NumeroGrupo ;
   private int[] H001H2_A568Tran_CantidadPadres ;
   private boolean[] H001H2_n568Tran_CantidadPadres ;
   private String[] H001H2_A527Tran_TipoEntra ;
   private boolean[] H001H2_n527Tran_TipoEntra ;
   private String[] H001H2_A524Tran_Detalle ;
   private boolean[] H001H2_n524Tran_Detalle ;
   private String[] H001H2_A608Tran_RegionAbrevDestino ;
   private boolean[] H001H2_n608Tran_RegionAbrevDestino ;
   private String[] H001H2_A520Tran_RegionDescripcionDestino ;
   private boolean[] H001H2_n520Tran_RegionDescripcionDestino ;
   private short[] H001H2_A519Tran_RegionCodigoDestino ;
   private boolean[] H001H2_n519Tran_RegionCodigoDestino ;
   private long[] H001H2_A518Tran_RegionIdDestino ;
   private boolean[] H001H2_n518Tran_RegionIdDestino ;
   private String[] H001H2_A517Tran_CentroCostoDescripcionDes ;
   private boolean[] H001H2_n517Tran_CentroCostoDescripcionDes ;
   private String[] H001H2_A516Tran_CentroCostoCodigoDestino ;
   private boolean[] H001H2_n516Tran_CentroCostoCodigoDestino ;
   private long[] H001H2_A50Tran_CentroCostoIdDestino ;
   private boolean[] H001H2_n50Tran_CentroCostoIdDestino ;
   private java.util.Date[] H001H2_A515Tran_FechaIngreso ;
   private boolean[] H001H2_n515Tran_FechaIngreso ;
   private String[] H001H2_A514Tran_NumeroIngreso ;
   private boolean[] H001H2_n514Tran_NumeroIngreso ;
   private String[] H001H2_A672Tran_NombreIngreso ;
   private boolean[] H001H2_n672Tran_NombreIngreso ;
   private long[] H001H2_A54Tran_TipoIngreso ;
   private boolean[] H001H2_n54Tran_TipoIngreso ;
   private long[] H001H2_A513Tran_ConsecutivoCC ;
   private boolean[] H001H2_n513Tran_ConsecutivoCC ;
   private String[] H001H2_A391Tran_UsuarioRatifica ;
   private boolean[] H001H2_n391Tran_UsuarioRatifica ;
   private java.util.Date[] H001H2_A390Tran_FechaRatificacion ;
   private boolean[] H001H2_n390Tran_FechaRatificacion ;
   private String[] H001H2_A58Tran_Estado ;
   private boolean[] H001H2_n58Tran_Estado ;
   private long[] H001H2_A498Tran_NumeroLineas ;
   private boolean[] H001H2_n498Tran_NumeroLineas ;
   private java.math.BigDecimal[] H001H2_A483Tran_ValorTransaccion ;
   private boolean[] H001H2_n483Tran_ValorTransaccion ;
   private String[] H001H2_A408Tran_CursoCodigo ;
   private boolean[] H001H2_n408Tran_CursoCodigo ;
   private String[] H001H2_A407Tran_AreadanteCodigo ;
   private boolean[] H001H2_n407Tran_AreadanteCodigo ;
   private String[] H001H2_A715Tran_EmailCuentadanteDestino ;
   private boolean[] H001H2_n715Tran_EmailCuentadanteDestino ;
   private long[] H001H2_A704Tran_CedulaCuentadanteDestino ;
   private boolean[] H001H2_n704Tran_CedulaCuentadanteDestino ;
   private String[] H001H2_A389Tran_NombCuentadanteDestino ;
   private boolean[] H001H2_n389Tran_NombCuentadanteDestino ;
   private long[] H001H2_A52Tran_IdCuentadanteDestino ;
   private boolean[] H001H2_n52Tran_IdCuentadanteDestino ;
   private String[] H001H2_A387Tran_CodBodeDestino ;
   private String[] H001H2_A111Tran_CodAlmaDestino ;
   private String[] H001H2_A385Tran_ModuloDestino ;
   private long[] H001H2_A703Tran_CedulaProveedor ;
   private boolean[] H001H2_n703Tran_CedulaProveedor ;
   private String[] H001H2_A575Tran_NombreProveedor ;
   private boolean[] H001H2_n575Tran_NombreProveedor ;
   private long[] H001H2_A53Tran_IdProveedor ;
   private boolean[] H001H2_n53Tran_IdProveedor ;
   private String[] H001H2_A714Tran_EmailCuentadanteOrigen ;
   private boolean[] H001H2_n714Tran_EmailCuentadanteOrigen ;
   private long[] H001H2_A702Tran_CedulaCuentadanteOrigen ;
   private boolean[] H001H2_n702Tran_CedulaCuentadanteOrigen ;
   private String[] H001H2_A384Tran_NombCuentadanteOrigen ;
   private boolean[] H001H2_n384Tran_NombCuentadanteOrigen ;
   private long[] H001H2_A51Tran_IdCuentadanteOrigen ;
   private boolean[] H001H2_n51Tran_IdCuentadanteOrigen ;
   private String[] H001H2_A112Tran_CodBodeOrigen ;
   private String[] H001H2_A109Tran_CodAlmaOrigen ;
   private String[] H001H2_A110Tran_ModuloOrigen ;
   private String[] H001H2_A708Tran_SolicitaRegionDestino ;
   private boolean[] H001H2_n708Tran_SolicitaRegionDestino ;
   private String[] H001H2_A707Tran_SolicitaCCDestino ;
   private boolean[] H001H2_n707Tran_SolicitaCCDestino ;
   private String[] H001H2_A482Tran_TipoElemento ;
   private long[] H001H2_A499Tran_CodTipoElemento ;
   private boolean[] H001H2_n499Tran_CodTipoElemento ;
   private String[] H001H2_A479Tran_IndCurso ;
   private boolean[] H001H2_n479Tran_IndCurso ;
   private String[] H001H2_A481Tran_IndE_S ;
   private boolean[] H001H2_n481Tran_IndE_S ;
   private String[] H001H2_A478Tran_IndAreadante ;
   private boolean[] H001H2_n478Tran_IndAreadante ;
   private String[] H001H2_A381Tran_DescripcionMovimiento ;
   private boolean[] H001H2_n381Tran_DescripcionMovimiento ;
   private String[] H001H2_A49Tran_CodigoMovimiento ;
   private String[] H001H2_A594Tran_RegionAbrev ;
   private boolean[] H001H2_n594Tran_RegionAbrev ;
   private String[] H001H2_A422Tran_RegionDescripcion ;
   private boolean[] H001H2_n422Tran_RegionDescripcion ;
   private short[] H001H2_A421Tran_RegionCodigo ;
   private boolean[] H001H2_n421Tran_RegionCodigo ;
   private long[] H001H2_A57Tran_RegionId ;
   private boolean[] H001H2_n57Tran_RegionId ;
   private String[] H001H2_A420Tran_CentroCostoDescripcion ;
   private boolean[] H001H2_n420Tran_CentroCostoDescripcion ;
   private String[] H001H2_A419Tran_CentroCostoCodigo ;
   private boolean[] H001H2_n419Tran_CentroCostoCodigo ;
   private long[] H001H2_A48Tran_CentroCostoId ;
   private String[] H001H2_A418Tran_UsuarioNombre ;
   private boolean[] H001H2_n418Tran_UsuarioNombre ;
   private String[] H001H2_A417Tran_UsuarioCodigo ;
   private boolean[] H001H2_n417Tran_UsuarioCodigo ;
   private long[] H001H2_A47Tran_UsuarioId ;
   private boolean[] H001H2_n47Tran_UsuarioId ;
   private java.util.Date[] H001H2_A55Tran_FechaRegistro ;
   private long[] H001H2_A46Tran_Id ;
                           ...
                           Object[] buf ) throws SQLException
   {
      switch ( cursor )
      {
            case 0 :
               ...
               ((String[]) buf[26])[0] = rslt.getString(14, 4) ;
               ...
               ((String[]) buf[46])[0] = rslt.getString(24, 30) ;
               ...
               ((java.util.Date[]) buf[56])[0] = rslt.getGXDateTime(29) ;
               ((boolean[]) buf[57])[0] = rslt.wasNull();
               ((String[]) buf[58])[0] = rslt.getString(30, 1) ;
               ((boolean[]) buf[59])[0] = rslt.wasNull();
               ((long[]) buf[60])[0] = rslt.getLong(31) ;
               ((boolean[]) buf[61])[0] = rslt.wasNull();
               ((java.math.BigDecimal[]) buf[62])[0] = rslt.getBigDecimal(32,2) ;
               ...
               ((String[]) buf[95])[0] = rslt.getVarchar(51) ;
