/*
               File: gen_centrocostoalm_areawc_impl
...
public final  class gen_centrocostoalm_areawc_impl extends GXWebComponent
{
   public gen_centrocostoalm_areawc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public gen_centrocostoalm_areawc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( gen_centrocostoalm_areawc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Cent_Id, AV12Update, AV13Delete, A32BArea_Codigo, A1Cent_Id, sPrefix) ;
               GXKey = com.genexus.util.Encryption.decrypt64( httpContext.getCookie( "GX_SESSION_ID"), context.getServerKey( )) ;
               GXKey = com.genexus.util.Encryption.decrypt64( httpContext.getCookie( "GX_SESSION_ID"), context.getServerKey( )) ;
               forbiddenHiddens = sPrefix + "hsh" + "GEN_CENTROCOSTOALM_AREAWC" ;
               ...
               GXutil.writeLogln("gen_centrocostoalm_areawc:[SendSecurityCheck]"+forbiddenHiddens);
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "GEN_CENTROCOSTOALM_AREAWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414142371");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.gen_centrocostoalm_areawc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Cent_Id,11,0)))+"\">") ;
   ...
   public void renderHtmlCloseForm0I2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("gen_centrocostoalm_areawc.js", "?201861414142374");
      }
   ...
   public void wb0I0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.gen_centrocostoalm_areawc");
         }
         /* Div Control */
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_GEN_CENTROCOSTOALM_AREAWC.htm");
      ...
      if ( wbEnd == 20 )
      {
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtCent_Id_Internalname, GXutil.ltrim( localUtil.ntoc( A1Cent_Id, (byte)(11), (byte)(0), ",", "")), ((edtCent_Id_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1Cent_Id), "ZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A1Cent_Id), "ZZZZZZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCent_Id_Jsonclick, 0, "Attribute", "", "", "", edtCent_Id_Visible, edtCent_Id_Enabled, 0, "text", "", 11, "chr", 1, "row", 11, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Identificador", "right", false, "HLP_GEN_CENTROCOSTOALM_AREAWC.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start0I2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "GEN_CENTROCOSTOALM_AREAWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void pa0I2( )
   {
      if ( nDonePA == 0 )
      {
         ...
         GXCCtl = "BAREA_ESTADO_" + sGXsfl_20_idx ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"BAREA_ESTADO", GXutil.rtrim( A611BArea_Estado));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"BAREA_USUARIO_CREA", A612BArea_Usuario_Crea);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"BAREA_FECHA_CREA", localUtil.ttoc( A613BArea_Fecha_Crea, 10, 8, 0, 3, "/", ":", " "));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"BAREA_USUARIO_MODIFICA", A614BArea_Usuario_Modifica);
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_BAREA_FECHA", getSecureSignedToken( sPrefix, A615BArea_Fecha));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"BAREA_FECHA", localUtil.format(A615BArea_Fecha, "99/99/99"));
   }
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "GEN_CENTROCOSTOALM_AREAWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf0I2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A1Cent_Id = H000I2_A1Cent_Id[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1Cent_Id", GXutil.ltrim( GXutil.str( A1Cent_Id, 11, 0)));
            A615BArea_Fecha = H000I2_A615BArea_Fecha[0] ;
            n615BArea_Fecha = H000I2_n615BArea_Fecha[0] ;
            A614BArea_Usuario_Modifica = H000I2_A614BArea_Usuario_Modifica[0] ;
            n614BArea_Usuario_Modifica = H000I2_n614BArea_Usuario_Modifica[0] ;
            A613BArea_Fecha_Crea = H000I2_A613BArea_Fecha_Crea[0] ;
            n613BArea_Fecha_Crea = H000I2_n613BArea_Fecha_Crea[0] ;
            A612BArea_Usuario_Crea = H000I2_A612BArea_Usuario_Crea[0] ;
            n612BArea_Usuario_Crea = H000I2_n612BArea_Usuario_Crea[0] ;
            A611BArea_Estado = H000I2_A611BArea_Estado[0] ;
            A610BArea_Descripcion = H000I2_A610BArea_Descripcion[0] ;
            A32BArea_Codigo = H000I2_A32BArea_Codigo[0] ;
            e130I2 ();
   ...
   public void strup0I0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         if ( ! GXutil.checkEncryptedSignature( forbiddenHiddens, hsh, GXKey) )
         {
            ...
            GXutil.writeLog("gen_centrocostoalm_areawc:[SecurityCheckFailed]"+forbiddenHiddens);
            return  ;
         }
   ...
   {
      /* Grid_Load Routine */
      edtavUpdate_Link = formatLink("com.orions2.alm_area") + "?" + GXutil.URLEncode(GXutil.rtrim("UPD")) + "," + GXutil.URLEncode(GXutil.rtrim(A32BArea_Codigo)) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Cent_Id,11,0))) ;
      edtavDelete_Link = formatLink("com.orions2.alm_area") + "?" + GXutil.URLEncode(GXutil.rtrim("DLT")) + "," + GXutil.URLEncode(GXutil.rtrim(A32BArea_Codigo)) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Cent_Id,11,0))) ;
   ...
   {
      /* 'DoInsert' Routine */
      callWebObject(formatLink("com.orions2.alm_area") + "?" + GXutil.URLEncode(GXutil.rtrim("INS")) + "," + GXutil.URLEncode(GXutil.rtrim("")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Cent_Id,11,0))));
      httpContext.wjLocDisableFrm = (byte)(1) ;
   }
   ...
   public void S112( )
   {
      ...
      AV10TrnContext.setgxTv_SdtTransactionContext_Transactionname( "ALM_AREA" );
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "gen_centrocostoalm_areawc");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414142418");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("gen_centrocostoalm_areawc.js", "?201861414142420");
      }
   ...
   {
      edtBArea_Codigo_Internalname = sPrefix+"BAREA_CODIGO_"+sGXsfl_20_idx ;
      edtBArea_Descripcion_Internalname = sPrefix+"BAREA_DESCRIPCION_"+sGXsfl_20_idx ;
      cmbBArea_Estado.setInternalname( sPrefix+"BAREA_ESTADO_"+sGXsfl_20_idx );
      edtBArea_Usuario_Crea_Internalname = sPrefix+"BAREA_USUARIO_CREA_"+sGXsfl_20_idx ;
      edtBArea_Fecha_Crea_Internalname = sPrefix+"BAREA_FECHA_CREA_"+sGXsfl_20_idx ;
      edtBArea_Usuario_Modifica_Internalname = sPrefix+"BAREA_USUARIO_MODIFICA_"+sGXsfl_20_idx ;
      edtBArea_Fecha_Internalname = sPrefix+"BAREA_FECHA_"+sGXsfl_20_idx ;
   ...
   {
      edtBArea_Codigo_Internalname = sPrefix+"BAREA_CODIGO_"+sGXsfl_20_fel_idx ;
      edtBArea_Descripcion_Internalname = sPrefix+"BAREA_DESCRIPCION_"+sGXsfl_20_fel_idx ;
      cmbBArea_Estado.setInternalname( sPrefix+"BAREA_ESTADO_"+sGXsfl_20_fel_idx );
      edtBArea_Usuario_Crea_Internalname = sPrefix+"BAREA_USUARIO_CREA_"+sGXsfl_20_fel_idx ;
      edtBArea_Fecha_Crea_Internalname = sPrefix+"BAREA_FECHA_CREA_"+sGXsfl_20_fel_idx ;
      edtBArea_Usuario_Modifica_Internalname = sPrefix+"BAREA_USUARIO_MODIFICA_"+sGXsfl_20_fel_idx ;
      edtBArea_Fecha_Internalname = sPrefix+"BAREA_FECHA_"+sGXsfl_20_fel_idx ;
   ...
   public void sendrow_202( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtBArea_Descripcion_Internalname,A610BArea_Descripcion,"","","'"+sPrefix+"'"+",false,"+"'"+""+"'",edtBArea_Descripcion_Link,"","","",edtBArea_Descripcion_Jsonclick,new Integer(0),"DescriptionAttribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(40),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbBArea_Estado,cmbBArea_Estado.getInternalname(),GXutil.rtrim( A611BArea_Estado),new Integer(1),cmbBArea_Estado.getJsonclick(),new Integer(0),"'"+sPrefix+"'"+",false,"+"'"+""+"'","char","",new Integer(-1),new Integer(0),new Integer(0),new Integer(0),new Integer(0),"px",new Integer(0),"px","","Attribute","WWColumn WWOptionalColumn","","",new Boolean(true)});
         cmbBArea_Estado.setValue( GXutil.rtrim( A611BArea_Estado) );
         httpContext.ajax_rsp_assign_prop(sPrefix, false, cmbBArea_Estado.getInternalname(), "Values", cmbBArea_Estado.ToJavascriptSource(), !bGXsfl_20_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtBArea_Usuario_Crea_Internalname,A612BArea_Usuario_Crea,GXutil.rtrim( localUtil.format( A612BArea_Usuario_Crea, "@!")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtBArea_Usuario_Crea_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtBArea_Fecha_Internalname,localUtil.format(A615BArea_Fecha, "99/99/99"),localUtil.format( A615BArea_Fecha, "99/99/99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtBArea_Fecha_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(8),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"Fecha","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_BAREA_CODIGO"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A32BArea_Codigo, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_BAREA_ESTADO"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A611BArea_Estado, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_BAREA_USUARIO_CREA"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A612BArea_Usuario_Crea, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_BAREA_FECHA_CREA"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, localUtil.format( A613BArea_Fecha_Crea, "99/99/99 99:99")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_BAREA_USUARIO_MODIFICA"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A614BArea_Usuario_Modifica, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_BAREA_FECHA"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, A615BArea_Fecha));
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e130I2',iparms:[{av:'A32BArea_Codigo',fld:'BAREA_CODIGO',pic:'',hsh:true,nv:''},{av:'AV7Cent_Id',fld:'vCENT_ID',pic:'ZZZZZZZZZZ9',nv:0},{av:'A1Cent_Id',fld:'CENT_ID',pic:'ZZZZZZZZZZ9',nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtBArea_Descripcion_Link',ctrl:'BAREA_DESCRIPCION',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e110I2',iparms:[{av:'A32BArea_Codigo',fld:'BAREA_CODIGO',pic:'',hsh:true,nv:''},{av:'AV7Cent_Id',fld:'vCENT_ID',pic:'ZZZZZZZZZZ9',nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H000I2_A1Cent_Id = new long[1] ;
      H000I2_A615BArea_Fecha = new java.util.Date[] {GXutil.nullDate()} ;
      H000I2_n615BArea_Fecha = new boolean[] {false} ;
      H000I2_A614BArea_Usuario_Modifica = new String[] {""} ;
      H000I2_n614BArea_Usuario_Modifica = new boolean[] {false} ;
      H000I2_A613BArea_Fecha_Crea = new java.util.Date[] {GXutil.nullDate()} ;
      H000I2_n613BArea_Fecha_Crea = new boolean[] {false} ;
      H000I2_A612BArea_Usuario_Crea = new String[] {""} ;
      H000I2_n612BArea_Usuario_Crea = new boolean[] {false} ;
      H000I2_A611BArea_Estado = new String[] {""} ;
      H000I2_A610BArea_Descripcion = new String[] {""} ;
      H000I2_A32BArea_Codigo = new String[] {""} ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.gen_centrocostoalm_areawc__default(),
         new Object[] {
             new Object[] {
            H000I2_A1Cent_Id, H000I2_A615BArea_Fecha, H000I2_n615BArea_Fecha, H000I2_A614BArea_Usuario_Modifica, H000I2_n614BArea_Usuario_Modifica, H000I2_A613BArea_Fecha_Crea, H000I2_n613BArea_Fecha_Crea, H000I2_A612BArea_Usuario_Crea, H000I2_n612BArea_Usuario_Crea, H000I2_A611BArea_Estado,
            H000I2_A610BArea_Descripcion, H000I2_A32BArea_Codigo
            }
            , new Object[] {
   ...
   private long[] H000I2_A1Cent_Id ;
   private java.util.Date[] H000I2_A615BArea_Fecha ;
   private boolean[] H000I2_n615BArea_Fecha ;
   private String[] H000I2_A614BArea_Usuario_Modifica ;
   private boolean[] H000I2_n614BArea_Usuario_Modifica ;
   private java.util.Date[] H000I2_A613BArea_Fecha_Crea ;
   private boolean[] H000I2_n613BArea_Fecha_Crea ;
   private String[] H000I2_A612BArea_Usuario_Crea ;
   private boolean[] H000I2_n612BArea_Usuario_Crea ;
   private String[] H000I2_A611BArea_Estado ;
   private String[] H000I2_A610BArea_Descripcion ;
   private String[] H000I2_A32BArea_Codigo ;
...
final  class gen_centrocostoalm_areawc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H000I2", "SELECT Cent_Id, BArea_Fecha, BArea_Usuario_Modifica, BArea_Fecha_Crea, BArea_Usuario_Crea, BArea_Estado, BArea_Descripcion, BArea_Codigo FROM ALM_AREA WHERE Cent_Id = ? ORDER BY Cent_Id  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H000I3", "SELECT COUNT(*) FROM ALM_AREA WHERE Cent_Id = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
