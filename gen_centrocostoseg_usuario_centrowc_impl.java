/*
               File: gen_centrocostoseg_usuario_centrowc_impl
        Description: GEN_CENTROCOSTOSEG_USUARIO_CENTROWC
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:11:49.81
...
public final  class gen_centrocostoseg_usuario_centrowc_impl extends GXWebComponent
{
   public gen_centrocostoseg_usuario_centrowc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public gen_centrocostoseg_usuario_centrowc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( gen_centrocostoseg_usuario_centrowc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Cent_Id, AV12Update, AV13Delete, A23Usua_Id, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "GEN_CENTROCOSTOSEG_USUARIO_CENTROWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414114986");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.gen_centrocostoseg_usuario_centrowc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Cent_Id,11,0)))+"\">") ;
   ...
   public void renderHtmlCloseForm0E2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("gen_centrocostoseg_usuario_centrowc.js", "?201861414114987");
      }
   ...
   {
      return "GEN_CENTROCOSTOSEG_USUARIO_CENTROWC" ;
   }
   ...
   public void wb0E0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.gen_centrocostoseg_usuario_centrowc");
         }
         /* Div Control */
      ...
      if ( wbEnd == 20 )
      {
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtCent_Id_Internalname, GXutil.ltrim( localUtil.ntoc( A1Cent_Id, (byte)(11), (byte)(0), ",", "")), ((edtCent_Id_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A1Cent_Id), "ZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A1Cent_Id), "ZZZZZZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCent_Id_Jsonclick, 0, "Attribute", "", "", "", edtCent_Id_Visible, edtCent_Id_Enabled, 0, "text", "", 11, "chr", 1, "row", 11, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "Identificador", "right", false, "HLP_GEN_CENTROCOSTOSEG_USUARIO_CENTROWC.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start0E2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "GEN_CENTROCOSTOSEG_USUARIO_CENTROWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "GEN_CENTROCOSTOSEG_USUARIO_CENTROWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf0E2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A1Cent_Id = H000E2_A1Cent_Id[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A1Cent_Id", GXutil.ltrim( GXutil.str( A1Cent_Id, 11, 0)));
            A26Usua_Cedula = H000E2_A26Usua_Cedula[0] ;
            A219Usua_Email = H000E2_A219Usua_Email[0] ;
            A25Usua_Nombre = H000E2_A25Usua_Nombre[0] ;
            A24Usua_Codigo = H000E2_A24Usua_Codigo[0] ;
            A23Usua_Id = H000E2_A23Usua_Id[0] ;
            A26Usua_Cedula = H000E2_A26Usua_Cedula[0] ;
            A219Usua_Email = H000E2_A219Usua_Email[0] ;
            A25Usua_Nombre = H000E2_A25Usua_Nombre[0] ;
            A24Usua_Codigo = H000E2_A24Usua_Codigo[0] ;
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "gen_centrocostoseg_usuario_centrowc");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414115029");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("gen_centrocostoseg_usuario_centrowc.js", "?201861414115029");
      }
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e130E2',iparms:[{av:'A23Usua_Id',fld:'USUA_ID',pic:'ZZZZZZZZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtUsua_Nombre_Link',ctrl:'USUA_NOMBRE',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e110E2',iparms:[{av:'A23Usua_Id',fld:'USUA_ID',pic:'ZZZZZZZZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H000E2_A1Cent_Id = new long[1] ;
      H000E2_A26Usua_Cedula = new long[1] ;
      H000E2_A219Usua_Email = new String[] {""} ;
      H000E2_A25Usua_Nombre = new String[] {""} ;
      H000E2_A24Usua_Codigo = new String[] {""} ;
      H000E2_A23Usua_Id = new long[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.gen_centrocostoseg_usuario_centrowc__default(),
         new Object[] {
             new Object[] {
            H000E2_A1Cent_Id, H000E2_A26Usua_Cedula, H000E2_A219Usua_Email, H000E2_A25Usua_Nombre, H000E2_A24Usua_Codigo, H000E2_A23Usua_Id
            }
            , new Object[] {
   ...
   private long[] H000E2_A1Cent_Id ;
   private long[] H000E2_A26Usua_Cedula ;
   private String[] H000E2_A219Usua_Email ;
   private String[] H000E2_A25Usua_Nombre ;
   private String[] H000E2_A24Usua_Codigo ;
   private long[] H000E2_A23Usua_Id ;
...
final  class gen_centrocostoseg_usuario_centrowc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H000E2", "SELECT T1.Cent_Id, T2.Usua_Cedula, T2.Usua_Email, T2.Usua_Nombre, T2.Usua_Codigo, T1.Usua_Id FROM (SEG_USUARIO_CENTRO T1 INNER JOIN SEG_USUARIO T2 ON T2.Usua_Id = T1.Usua_Id) WHERE T1.Cent_Id = ? ORDER BY T1.Cent_Id  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H000E3", "SELECT COUNT(*) FROM (SEG_USUARIO_CENTRO T1 INNER JOIN SEG_USUARIO T2 ON T2.Usua_Id = T1.Usua_Id) WHERE T1.Cent_Id = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
