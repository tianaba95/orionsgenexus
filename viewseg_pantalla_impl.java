/*
               File: viewseg_pantalla_impl
        Description: View SEG_PANTALLA
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:19:18.90
...
public final  class viewseg_pantalla_impl extends GXDataArea
{
   public viewseg_pantalla_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public viewseg_pantalla_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( viewseg_pantalla_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV9Pant_Id = (int)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV9Pant_Id", GXutil.ltrim( GXutil.str( AV9Pant_Id, 6, 0)));
            httpContext.ajax_rsp_assign_attri("", false, "gxhash_vPANT_ID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV9Pant_Id), "ZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414191892");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.viewseg_pantalla") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV9Pant_Id,6,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV12TabCode))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      /* Send saved values. */
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "vPANT_ID", GXutil.ltrim( localUtil.ntoc( AV9Pant_Id, (byte)(6), (byte)(0), ",", "")));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPANT_ID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV9Pant_Id), "ZZZZZ9")));
      ...
      forbiddenHiddens = "hsh" + "ViewSEG_PANTALLA" ;
      forbiddenHiddens = forbiddenHiddens + GXutil.rtrim( localUtil.format( A19Pant_Descripcion, "")) ;
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "hsh", GXutil.getEncryptedSignature( forbiddenHiddens, GXKey));
      GXutil.writeLogln("viewseg_pantalla:[SendSecurityCheck]"+forbiddenHiddens);
   }
   ...
   {
      return formatLink("com.orions2.viewseg_pantalla") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV9Pant_Id,6,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV12TabCode)) ;
   }

   public String getPgmname( )
   {
      return "ViewSEG_PANTALLA" ;
   }
   ...
   public void wb340( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, "PANTALLA Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_ViewSEG_PANTALLA.htm");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblViewall_Internalname, "Lista Pantallas", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, (short)(0), "HLP_ViewSEG_PANTALLA.htm");
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtPant_Descripcion_Internalname, A19Pant_Descripcion, GXutil.rtrim( localUtil.format( A19Pant_Descripcion, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPant_Descripcion_Jsonclick, 0, "ReadonlyAttribute", "", "", "", 1, edtPant_Descripcion_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "Descripcion", "left", true, "HLP_ViewSEG_PANTALLA.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewSEG_PANTALLA.htm");
         /* Div Control */
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblSeg_rol_pantalla_title_Internalname, "ROLES Y PANTALLAS", "", "", lblSeg_rol_pantalla_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewSEG_PANTALLA.htm");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         ...
         {
            /* WebComponent */
            com.orions2.GxWebStd.gx_hidden_field( httpContext, "W0037"+"", GXutil.rtrim( WebComp_Seg_rol_pantallawc_Component));
            httpContext.writeText( "<div") ;
            com.orions2.GxWebStd.classAttribute( httpContext, "gxwebcomponent");
   ...
   public void start342( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "View SEG_PANTALLA", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
            ...
            if ( GXutil.len( sEvt) > 0 )
            {
               ...
               if ( GXutil.strcmp(sEvtType, "M") != 0 )
               {
                  ...
                  else if ( GXutil.strcmp(sEvtType, "W") == 0 )
                  {
                     ...
                     {
                        OldSeg_rol_pantallawc = httpContext.cgiGet( "W0037") ;
                        ...
                        WebComp_Seg_rol_pantallawc.componentprocess("W0037", "", sEvt);
                        WebComp_Seg_rol_pantallawc_Component = OldSeg_rol_pantallawc ;
                     }
                  }
                  httpContext.wbHandled = (byte)(1) ;
   ...
   public void rf342( )
   {
      ...
      {
         /* Using cursor H00342 */
         pr_default.execute(0, new Object[] {new Integer(AV9Pant_Id)});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A18Pant_Id = H00342_A18Pant_Id[0] ;
            A19Pant_Descripcion = H00342_A19Pant_Descripcion[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A19Pant_Descripcion", A19Pant_Descripcion);
            httpContext.ajax_rsp_assign_attri("", false, "gxhash_PANT_DESCRIPCION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A19Pant_Descripcion, ""))));
            /* Execute user event: Load */
            e12342 ();
   ...
   public void strup340( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         if ( ! GXutil.checkEncryptedSignature( forbiddenHiddens, hsh, GXKey) )
         {
            ...
            GXutil.writeLog("viewseg_pantalla:[SecurityCheckFailed]"+forbiddenHiddens);
            return  ;
         }
      }
      else
   ...
   public void e11342( )
   {
      ...
      {
         A18Pant_Id = H00343_A18Pant_Id[0] ;
         A19Pant_Descripcion = H00343_A19Pant_Descripcion[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A19Pant_Descripcion", A19Pant_Descripcion);
         httpContext.ajax_rsp_assign_attri("", false, "gxhash_PANT_DESCRIPCION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A19Pant_Descripcion, ""))));
         AV18GXLvl6 = (byte)(1) ;
         Form.setCaption( A19Pant_Descripcion );
         httpContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.getCaption(), true);
         lblViewall_Link = formatLink("com.orions2.wwseg_pantalla")  ;
   ...
   public void S112( )
   {
      ...
      AV11Tab.setgxTv_SdtTabOptions_TabOptionsItem_Webcomponent( formatLink("com.orions2.seg_pantallageneral") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV9Pant_Id,6,0))) );
      AV11Tab.setgxTv_SdtTabOptions_TabOptionsItem_Link( formatLink("com.orions2.viewseg_pantalla") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV9Pant_Id,6,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV11Tab.getgxTv_SdtTabOptions_TabOptionsItem_Code())) );
      ...
      AV11Tab.setgxTv_SdtTabOptions_TabOptionsItem_Webcomponent( formatLink("com.orions2.seg_pantallaseg_rol_pantallawc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV9Pant_Id,6,0))) );
      AV11Tab.setgxTv_SdtTabOptions_TabOptionsItem_Link( formatLink("com.orions2.viewseg_pantalla") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV9Pant_Id,6,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV11Tab.getgxTv_SdtTabOptions_TabOptionsItem_Code())) );
      AV13Tabs.add(AV11Tab, 0);
   }
   ...
   {
      AV9Pant_Id = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV9Pant_Id", GXutil.ltrim( GXutil.str( AV9Pant_Id, 6, 0)));
      httpContext.ajax_rsp_assign_attri("", false, "gxhash_vPANT_ID", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV9Pant_Id), "ZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414191925");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("viewseg_pantalla.js", "?201861414191925");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "");
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "View SEG_PANTALLA" );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H00342_A18Pant_Id = new int[1] ;
      H00342_A19Pant_Descripcion = new String[] {""} ;
      hsh = "" ;
      H00343_A18Pant_Id = new int[1] ;
      H00343_A19Pant_Descripcion = new String[] {""} ;
      AV13Tabs = new GXBaseCollection<com.orions2.SdtTabOptions_TabOptionsItem>(com.orions2.SdtTabOptions_TabOptionsItem.class, "TabOptions.TabOptionsItem", "ACBSENA", remoteHandle);
      AV11Tab = new com.orions2.SdtTabOptions_TabOptionsItem(remoteHandle, context);
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.viewseg_pantalla__default(),
         new Object[] {
             new Object[] {
            H00342_A18Pant_Id, H00342_A19Pant_Descripcion
            }
            , new Object[] {
            H00343_A18Pant_Id, H00343_A19Pant_Descripcion
            }
         }
      );
      AV17Pgmname = "ViewSEG_PANTALLA" ;
   ...
   private int[] H00342_A18Pant_Id ;
   private String[] H00342_A19Pant_Descripcion ;
   private int[] H00343_A18Pant_Id ;
   private String[] H00343_A19Pant_Descripcion ;
...
final  class viewseg_pantalla__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00342", "SELECT Pant_Id, Pant_Descripcion FROM SEG_PANTALLA WHERE Pant_Id = ? ORDER BY Pant_Id ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H00343", "SELECT Pant_Id, Pant_Descripcion FROM SEG_PANTALLA WHERE Pant_Id = ? ORDER BY Pant_Id ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
