...
public final  class wwalm_transaccion_impl extends GXDataArea
{
   ...
   public void wb0W0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavTran_consecutivocc_Internalname, GXutil.ltrim( localUtil.ntoc( AV29Tran_ConsecutivoCC, (byte)(18), (byte)(0), ",", "")), ((edtavTran_consecutivocc_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV29Tran_ConsecutivoCC), "ZZZZZZZZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV29Tran_ConsecutivoCC), "ZZZZZZZZZZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,14);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Número Transacción", edtavTran_consecutivocc_Jsonclick, 0, "FilterSearchAttribute", "", "", "", 1, edtavTran_consecutivocc_Enabled, 0, "text", "", 18, "chr", 1, "row", 18, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "HLP_WWALM_TRANSACCION.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_regioncodigofilter_Internalname, "Código Regional", "", "", lblLbltran_regioncodigofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e150w1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WWALM_TRANSACCION.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLbltran_centrocostocodigofilter_Internalname, "Código C.C.", "", "", lblLbltran_centrocostocodigofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e170w1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WWALM_TRANSACCION.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
   ...
   public void start0W2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Work With TRANSACCIÓN", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public void e290W2( )
   {
      ...
      {
         lblLbltran_codigomovimientofilter_Caption = GXutil.format( AV8ADVANCED_LABEL_TEMPLATE, "Código Movimiento", AV28Tran_CodigoMovimiento, "", "", "", "", "", "", "") ;
         httpContext.ajax_rsp_assign_prop("", false, lblLbltran_codigomovimientofilter_Internalname, "Caption", lblLbltran_codigomovimientofilter_Caption, true);
      }
      ...
      {
         lblLbltran_descripcionmovimientofilter_Caption = GXutil.format( AV8ADVANCED_LABEL_TEMPLATE, "Descripción Movimiento", AV31Tran_DescripcionMovimiento, "", "", "", "", "", "", "") ;
         httpContext.ajax_rsp_assign_prop("", false, lblLbltran_descripcionmovimientofilter_Internalname, "Caption", lblLbltran_descripcionmovimientofilter_Caption, true);
      }
      ...
      {
         lblLbltran_idcuentadantedestinofilter_Caption = GXutil.format( AV8ADVANCED_LABEL_TEMPLATE, "Cédula Cuentadante", GXutil.ltrim( GXutil.str( AV33Tran_IdCuentadanteDestino, 18, 0)), "", "", "", "", "", "", "") ;
         httpContext.ajax_rsp_assign_prop("", false, lblLbltran_idcuentadantedestinofilter_Internalname, "Caption", lblLbltran_idcuentadantedestinofilter_Caption, true);
      }
   ...
   public void S112( )
   {
      ...
      AV40TrnContext.setgxTv_SdtTransactionContext_Transactionname( "Transacción" );
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Work With TRANSACCIÓN" );
      subGrid_Rows = 0 ;
