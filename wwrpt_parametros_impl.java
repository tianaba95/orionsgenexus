/*
               File: wwrpt_parametros_impl
        Description: Work With PARAMETROS DE REPORTES
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:23:22.91
...
public final  class wwrpt_parametros_impl extends GXDataArea
{
   public wwrpt_parametros_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wwrpt_parametros_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wwrpt_parametros_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
         {
            ...
            AV14RPT_PAR_DESCRIPCION = httpContext.GetNextPar( ) ;
            AV15Update = httpContext.GetNextPar( ) ;
            edtavUpdate_Tooltiptext = httpContext.GetNextPar( ) ;
            httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Tooltiptext", edtavUpdate_Tooltiptext, !bGXsfl_25_Refreshing);
            AV16Delete = httpContext.GetNextPar( ) ;
            ...
            gxgrgrid_refresh( subGrid_Rows, AV14RPT_PAR_DESCRIPCION, AV15Update, AV16Delete, AV20Pgmname, A840RPT_PAR_ID) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414232294");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( nGXWrapped != 1 )
      {
         httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.wwrpt_parametros") +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "GXH_vRPT_PAR_DESCRIPCION", AV14RPT_PAR_DESCRIPCION);
      /* Send saved values. */
   ...
   {
      return formatLink("com.orions2.wwrpt_parametros")  ;
   }

   public String getPgmname( )
   {
      return "WWRPT_PARAMETROS" ;
   }
   ...
   public void wb9N0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblTitletext_Internalname, "Parámetros de reportes", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_WWRPT_PARAMETROS.htm");
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 25, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWRPT_PARAMETROS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_label_element( httpContext, edtavRpt_par_descripcion_Internalname, "RPT_PAR_DESCRIPCION", "col-sm-3 FilterSearchAttributeLabel", 0, true);
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"" ;
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavRpt_par_descripcion_Internalname, AV14RPT_PAR_DESCRIPCION, GXutil.rtrim( localUtil.format( AV14RPT_PAR_DESCRIPCION, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Parámetro", edtavRpt_par_descripcion_Jsonclick, 0, "FilterSearchAttribute", "", "", "", 1, edtavRpt_par_descripcion_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_WWRPT_PARAMETROS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", GXutil.rtrim( A842RPT_PAR_ESTADO));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", A854RPT_PAR_USUARIOCREA);
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", localUtil.ttoc( A855RPT_PAR_FECHACREA, 10, 8, 0, 3, "/", ":", " "));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", A856RPT_PAR_USUARIOMODIF);
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", localUtil.ttoc( A857RPT_PAR_FECHAMODIF, 10, 8, 0, 3, "/", ":", " "));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
   ...
   public void start9N2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Work With PARAMETROS DE REPORTES", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 {
                                    Rfr0gs = false ;
                                    /* Set Refresh If Rpt_par_descripcion Changed */
                                    if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vRPT_PAR_DESCRIPCION"), AV14RPT_PAR_DESCRIPCION) != 0 )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    if ( ! Rfr0gs )
   ...
   public void pa9N2( )
   {
      if ( nDonePA == 0 )
      {
         ...
         GXCCtl = "RPT_PAR_ESTADO_" + sGXsfl_25_idx ;
         ...
         if ( ! httpContext.isAjaxRequest( ) )
         {
            GX_FocusControl = edtavRpt_par_descripcion_Internalname ;
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 String AV14RPT_PAR_DESCRIPCION ,
                                 String AV15Update ,
                                 String AV16Delete ,
                                 String AV20Pgmname ,
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_PAR_NOMBREINTERNO", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A860RPT_PAR_NOMBREINTERNO, ""))));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_PAR_USUARIOMODIF", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A856RPT_PAR_USUARIOMODIF, "@!"))));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "RPT_PAR_USUARIOMODIF", A856RPT_PAR_USUARIOMODIF);
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_PAR_FECHAMODIF", getSecureSignedToken( "", localUtil.format( A857RPT_PAR_FECHAMODIF, "99/99/99 99:99")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "RPT_PAR_FECHAMODIF", localUtil.ttoc( A857RPT_PAR_FECHAMODIF, 10, 8, 0, 3, "/", ":", " "));
   }
   ...
   public void rf9N2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV14RPT_PAR_DESCRIPCION ,
                                              A841RPT_PAR_DESCRIPCION } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.STRING, TypeConstants.BOOLEAN
                                              }
         } ) ;
         lV14RPT_PAR_DESCRIPCION = GXutil.concat( GXutil.rtrim( AV14RPT_PAR_DESCRIPCION), "%", "") ;
         httpContext.ajax_rsp_assign_attri("", false, "AV14RPT_PAR_DESCRIPCION", AV14RPT_PAR_DESCRIPCION);
         /* Using cursor H009N2 */
         pr_default.execute(0, new Object[] {lV14RPT_PAR_DESCRIPCION, new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_25_idx = (short)(1) ;
         sGXsfl_25_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_25_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_252( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A857RPT_PAR_FECHAMODIF = H009N2_A857RPT_PAR_FECHAMODIF[0] ;
            n857RPT_PAR_FECHAMODIF = H009N2_n857RPT_PAR_FECHAMODIF[0] ;
            A856RPT_PAR_USUARIOMODIF = H009N2_A856RPT_PAR_USUARIOMODIF[0] ;
            n856RPT_PAR_USUARIOMODIF = H009N2_n856RPT_PAR_USUARIOMODIF[0] ;
            A855RPT_PAR_FECHACREA = H009N2_A855RPT_PAR_FECHACREA[0] ;
            n855RPT_PAR_FECHACREA = H009N2_n855RPT_PAR_FECHACREA[0] ;
            A854RPT_PAR_USUARIOCREA = H009N2_A854RPT_PAR_USUARIOCREA[0] ;
            n854RPT_PAR_USUARIOCREA = H009N2_n854RPT_PAR_USUARIOCREA[0] ;
            A842RPT_PAR_ESTADO = H009N2_A842RPT_PAR_ESTADO[0] ;
            n842RPT_PAR_ESTADO = H009N2_n842RPT_PAR_ESTADO[0] ;
            A860RPT_PAR_NOMBREINTERNO = H009N2_A860RPT_PAR_NOMBREINTERNO[0] ;
            n860RPT_PAR_NOMBREINTERNO = H009N2_n860RPT_PAR_NOMBREINTERNO[0] ;
            A841RPT_PAR_DESCRIPCION = H009N2_A841RPT_PAR_DESCRIPCION[0] ;
            n841RPT_PAR_DESCRIPCION = H009N2_n841RPT_PAR_DESCRIPCION[0] ;
            A840RPT_PAR_ID = H009N2_A840RPT_PAR_ID[0] ;
            e149N2 ();
   ...
   public int subgrid_recordcount( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV14RPT_PAR_DESCRIPCION", AV14RPT_PAR_DESCRIPCION);
      /* Using cursor H009N3 */
      pr_default.execute(1, new Object[] {lV14RPT_PAR_DESCRIPCION});
   ...
   public void strup9N0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV14RPT_PAR_DESCRIPCION = httpContext.cgiGet( edtavRpt_par_descripcion_Internalname) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV14RPT_PAR_DESCRIPCION", AV14RPT_PAR_DESCRIPCION);
         /* Read saved values. */
   ...
   public void e129N2( )
   {
      ...
      httpContext.ajax_rsp_assign_prop("", false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext, !bGXsfl_25_Refreshing);
      Form.setCaption( "Parámetros de reportes" );
   ...
   {
      /* Grid_Load Routine */
      edtavUpdate_Link = formatLink("com.orions2.rpt_parametros") + "?" + GXutil.URLEncode(GXutil.rtrim("UPD")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A840RPT_PAR_ID,4,0))) ;
      edtavDelete_Link = formatLink("com.orions2.rpt_parametros") + "?" + GXutil.URLEncode(GXutil.rtrim("DLT")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A840RPT_PAR_ID,4,0))) ;
      /* Load Method */
      if ( wbStart != -1 )
      {
         wbStart = (short)(25) ;
   ...
   {
      /* 'DoInsert' Routine */
      callWebObject(formatLink("com.orions2.rpt_parametros") + "?" + GXutil.URLEncode(GXutil.rtrim("INS")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(0,9,0))));
      httpContext.wjLocDisableFrm = (byte)(1) ;
   }
   ...
   public void S122( )
   {
      ...
      if ( GXutil.strcmp(AV8HTTPRequest.getMethod(), "GET") == 0 )
      {
         ...
         {
            AV14RPT_PAR_DESCRIPCION = ((com.orions2.SdtGridState_FilterValue)AV9GridState.getgxTv_SdtGridState_Filtervalues().elementAt(-1+1)).getgxTv_SdtGridState_FilterValue_Value() ;
            httpContext.ajax_rsp_assign_attri("", false, "AV14RPT_PAR_DESCRIPCION", AV14RPT_PAR_DESCRIPCION);
         }
   ...
   public void S132( )
   {
      ...
      AV10GridStateFilterValue.setgxTv_SdtGridState_FilterValue_Value( AV14RPT_PAR_DESCRIPCION );
   ...
   public void S112( )
   {
      ...
      AV12TrnContext.setgxTv_SdtTransactionContext_Transactionname( "Parámetros de reportes" );
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414232349");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         ...
         httpContext.AddJavascriptSource("wwrpt_parametros.js", "?201861414232349");
      }
   ...
   {
      edtRPT_PAR_ID_Internalname = "RPT_PAR_ID_"+sGXsfl_25_idx ;
      edtRPT_PAR_DESCRIPCION_Internalname = "RPT_PAR_DESCRIPCION_"+sGXsfl_25_idx ;
      edtRPT_PAR_NOMBREINTERNO_Internalname = "RPT_PAR_NOMBREINTERNO_"+sGXsfl_25_idx ;
      cmbRPT_PAR_ESTADO.setInternalname( "RPT_PAR_ESTADO_"+sGXsfl_25_idx );
      edtRPT_PAR_USUARIOCREA_Internalname = "RPT_PAR_USUARIOCREA_"+sGXsfl_25_idx ;
      edtRPT_PAR_FECHACREA_Internalname = "RPT_PAR_FECHACREA_"+sGXsfl_25_idx ;
      edtRPT_PAR_USUARIOMODIF_Internalname = "RPT_PAR_USUARIOMODIF_"+sGXsfl_25_idx ;
      edtRPT_PAR_FECHAMODIF_Internalname = "RPT_PAR_FECHAMODIF_"+sGXsfl_25_idx ;
   ...
   {
      edtRPT_PAR_ID_Internalname = "RPT_PAR_ID_"+sGXsfl_25_fel_idx ;
      edtRPT_PAR_DESCRIPCION_Internalname = "RPT_PAR_DESCRIPCION_"+sGXsfl_25_fel_idx ;
      edtRPT_PAR_NOMBREINTERNO_Internalname = "RPT_PAR_NOMBREINTERNO_"+sGXsfl_25_fel_idx ;
      cmbRPT_PAR_ESTADO.setInternalname( "RPT_PAR_ESTADO_"+sGXsfl_25_fel_idx );
      edtRPT_PAR_USUARIOCREA_Internalname = "RPT_PAR_USUARIOCREA_"+sGXsfl_25_fel_idx ;
      edtRPT_PAR_FECHACREA_Internalname = "RPT_PAR_FECHACREA_"+sGXsfl_25_fel_idx ;
      edtRPT_PAR_USUARIOMODIF_Internalname = "RPT_PAR_USUARIOMODIF_"+sGXsfl_25_fel_idx ;
      edtRPT_PAR_FECHAMODIF_Internalname = "RPT_PAR_FECHAMODIF_"+sGXsfl_25_fel_idx ;
   ...
   public void sendrow_252( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRPT_PAR_ID_Internalname,GXutil.ltrim( localUtil.ntoc( A840RPT_PAR_ID, (byte)(4), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A840RPT_PAR_ID), "ZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtRPT_PAR_ID_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(4),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRPT_PAR_DESCRIPCION_Internalname,A841RPT_PAR_DESCRIPCION,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtRPT_PAR_DESCRIPCION_Jsonclick,new Integer(0),"DescriptionAttribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRPT_PAR_NOMBREINTERNO_Internalname,A860RPT_PAR_NOMBREINTERNO,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtRPT_PAR_NOMBREINTERNO_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* ComboBox */
         GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {cmbRPT_PAR_ESTADO,cmbRPT_PAR_ESTADO.getInternalname(),GXutil.rtrim( A842RPT_PAR_ESTADO),new Integer(1),cmbRPT_PAR_ESTADO.getJsonclick(),new Integer(0),"'"+""+"'"+",false,"+"'"+""+"'","char","",new Integer(-1),new Integer(0),new Integer(0),new Integer(0),new Integer(0),"px",new Integer(0),"px","","Attribute","WWColumn","","",new Boolean(true)});
         cmbRPT_PAR_ESTADO.setValue( GXutil.rtrim( A842RPT_PAR_ESTADO) );
         httpContext.ajax_rsp_assign_prop("", false, cmbRPT_PAR_ESTADO.getInternalname(), "Values", cmbRPT_PAR_ESTADO.ToJavascriptSource(), !bGXsfl_25_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRPT_PAR_FECHACREA_Internalname,localUtil.ttoc( A855RPT_PAR_FECHACREA, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A855RPT_PAR_FECHACREA, "99/99/99 99:99"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtRPT_PAR_FECHACREA_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRPT_PAR_USUARIOMODIF_Internalname,A856RPT_PAR_USUARIOMODIF,GXutil.rtrim( localUtil.format( A856RPT_PAR_USUARIOMODIF, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtRPT_PAR_USUARIOMODIF_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRPT_PAR_FECHAMODIF_Internalname,localUtil.ttoc( A857RPT_PAR_FECHAMODIF, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A857RPT_PAR_FECHAMODIF, "99/99/99 99:99"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtRPT_PAR_FECHAMODIF_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(25),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_PAR_ID"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, localUtil.format( DecimalUtil.doubleToDec(A840RPT_PAR_ID), "ZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_PAR_DESCRIPCION"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, GXutil.rtrim( localUtil.format( A841RPT_PAR_DESCRIPCION, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_PAR_NOMBREINTERNO"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, GXutil.rtrim( localUtil.format( A860RPT_PAR_NOMBREINTERNO, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_PAR_ESTADO"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, GXutil.rtrim( localUtil.format( A842RPT_PAR_ESTADO, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_PAR_USUARIOCREA"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, GXutil.rtrim( localUtil.format( A854RPT_PAR_USUARIOCREA, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_PAR_FECHACREA"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, localUtil.format( A855RPT_PAR_FECHACREA, "99/99/99 99:99")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_PAR_USUARIOMODIF"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, GXutil.rtrim( localUtil.format( A856RPT_PAR_USUARIOMODIF, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_RPT_PAR_FECHAMODIF"+"_"+sGXsfl_25_idx, getSecureSignedToken( sGXsfl_25_idx, localUtil.format( A857RPT_PAR_FECHAMODIF, "99/99/99 99:99")));
   ...
   public void init_default_properties( )
   {
      ...
      edtavRpt_par_descripcion_Internalname = "vRPT_PAR_DESCRIPCION" ;
      ...
      edtRPT_PAR_USUARIOMODIF_Internalname = "RPT_PAR_USUARIOMODIF" ;
      edtRPT_PAR_FECHAMODIF_Internalname = "RPT_PAR_FECHAMODIF" ;
   ...
   public void initialize_properties( )
   {
      ...
      edtavRpt_par_descripcion_Jsonclick = "" ;
      edtavRpt_par_descripcion_Enabled = 1 ;
      Form.setHeaderrawhtml( "" );
      Form.setBackground( "" );
      Form.setTextcolor( 0 );
      Form.setIBackground( (int)(0xFFFFFF) );
      Form.setCaption( "Work With PARAMETROS DE REPORTES" );
      subGrid_Rows = 0 ;
      edtavDelete_Tooltiptext = "Eliminar" ;
      edtavUpdate_Tooltiptext = "Modificar" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV15Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV16Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A840RPT_PAR_ID',fld:'RPT_PAR_ID',pic:'ZZZ9',hsh:true,nv:0},{av:'AV20Pgmname',fld:'vPGMNAME',pic:'',nv:''},{av:'AV14RPT_PAR_DESCRIPCION',fld:'vRPT_PAR_DESCRIPCION',pic:'',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e149N2',iparms:[{av:'A840RPT_PAR_ID',fld:'RPT_PAR_ID',pic:'ZZZ9',hsh:true,nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e119N2',iparms:[{av:'A840RPT_PAR_ID',fld:'RPT_PAR_ID',pic:'ZZZ9',hsh:true,nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      GXCCtl = "" ;
      scmdbuf = "" ;
      lV14RPT_PAR_DESCRIPCION = "" ;
      H009N2_A857RPT_PAR_FECHAMODIF = new java.util.Date[] {GXutil.nullDate()} ;
      H009N2_n857RPT_PAR_FECHAMODIF = new boolean[] {false} ;
      H009N2_A856RPT_PAR_USUARIOMODIF = new String[] {""} ;
      H009N2_n856RPT_PAR_USUARIOMODIF = new boolean[] {false} ;
      H009N2_A855RPT_PAR_FECHACREA = new java.util.Date[] {GXutil.nullDate()} ;
      H009N2_n855RPT_PAR_FECHACREA = new boolean[] {false} ;
      H009N2_A854RPT_PAR_USUARIOCREA = new String[] {""} ;
      H009N2_n854RPT_PAR_USUARIOCREA = new boolean[] {false} ;
      H009N2_A842RPT_PAR_ESTADO = new String[] {""} ;
      H009N2_n842RPT_PAR_ESTADO = new boolean[] {false} ;
      H009N2_A860RPT_PAR_NOMBREINTERNO = new String[] {""} ;
      H009N2_n860RPT_PAR_NOMBREINTERNO = new boolean[] {false} ;
      H009N2_A841RPT_PAR_DESCRIPCION = new String[] {""} ;
      H009N2_n841RPT_PAR_DESCRIPCION = new boolean[] {false} ;
      H009N2_A840RPT_PAR_ID = new short[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.wwrpt_parametros__default(),
         new Object[] {
             new Object[] {
            H009N2_A857RPT_PAR_FECHAMODIF, H009N2_n857RPT_PAR_FECHAMODIF, H009N2_A856RPT_PAR_USUARIOMODIF, H009N2_n856RPT_PAR_USUARIOMODIF, H009N2_A855RPT_PAR_FECHACREA, H009N2_n855RPT_PAR_FECHACREA, H009N2_A854RPT_PAR_USUARIOCREA, H009N2_n854RPT_PAR_USUARIOCREA, H009N2_A842RPT_PAR_ESTADO, H009N2_n842RPT_PAR_ESTADO,
            H009N2_A860RPT_PAR_NOMBREINTERNO, H009N2_n860RPT_PAR_NOMBREINTERNO, H009N2_A841RPT_PAR_DESCRIPCION, H009N2_n841RPT_PAR_DESCRIPCION, H009N2_A840RPT_PAR_ID
            }
            , new Object[] {
   ...
   private int edtavRpt_par_descripcion_Enabled ;
   ...
   private String edtavRpt_par_descripcion_Internalname ;
   private String edtavRpt_par_descripcion_Jsonclick ;
   ...
   private String AV14RPT_PAR_DESCRIPCION ;
   ...
   private String lV14RPT_PAR_DESCRIPCION ;
   ...
   private java.util.Date[] H009N2_A857RPT_PAR_FECHAMODIF ;
   private boolean[] H009N2_n857RPT_PAR_FECHAMODIF ;
   private String[] H009N2_A856RPT_PAR_USUARIOMODIF ;
   private boolean[] H009N2_n856RPT_PAR_USUARIOMODIF ;
   private java.util.Date[] H009N2_A855RPT_PAR_FECHACREA ;
   private boolean[] H009N2_n855RPT_PAR_FECHACREA ;
   private String[] H009N2_A854RPT_PAR_USUARIOCREA ;
   private boolean[] H009N2_n854RPT_PAR_USUARIOCREA ;
   private String[] H009N2_A842RPT_PAR_ESTADO ;
   private boolean[] H009N2_n842RPT_PAR_ESTADO ;
   private String[] H009N2_A860RPT_PAR_NOMBREINTERNO ;
   private boolean[] H009N2_n860RPT_PAR_NOMBREINTERNO ;
   private String[] H009N2_A841RPT_PAR_DESCRIPCION ;
   private boolean[] H009N2_n841RPT_PAR_DESCRIPCION ;
   private short[] H009N2_A840RPT_PAR_ID ;
...
final  class wwrpt_parametros__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          String A841RPT_PAR_DESCRIPCION )
   {
      ...
      String sFromString ;
      String sOrderString ;
      sSelectString = " RPT_PAR_FECHAMODIF, RPT_PAR_USUARIOMODIF, RPT_PAR_FECHACREA, RPT_PAR_USUARIOCREA," ;
      sSelectString = sSelectString + " RPT_PAR_ESTADO, RPT_PAR_NOMBREINTERNO, RPT_PAR_DESCRIPCION, RPT_PAR_ID" ;
      sFromString = " FROM RPT_PARAMETROS" ;
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV14RPT_PAR_DESCRIPCION)==0) )
      {
         ...
         {
            sWhereString = sWhereString + " (RPT_PAR_DESCRIPCION like ?)" ;
         }
      }
      else
      {
      ...
      sOrderString = sOrderString + " ORDER BY RPT_PAR_DESCRIPCION" ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H009N2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
            case 1 :
                  return conditional_H009N3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H009N2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H009N3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
