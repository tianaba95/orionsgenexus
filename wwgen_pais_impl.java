...
public final  class wwgen_pais_impl extends GXDataArea
{
   public wwgen_pais_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wwgen_pais_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wwgen_pais_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
         {
            ...
            AV14Pais_Descripcion = httpContext.GetNextPar( ) ;
            AV18Update = httpContext.GetNextPar( ) ;
            edtavUpdate_Tooltiptext = httpContext.GetNextPar( ) ;
            httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Tooltiptext", edtavUpdate_Tooltiptext, !bGXsfl_27_Refreshing);
            AV6Delete = httpContext.GetNextPar( ) ;
            ...
            gxgrgrid_refresh( subGrid_Rows, AV14Pais_Descripcion, AV18Update, AV6Delete, AV22Pgmname, A9Pais_Codigo) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414191620");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( nGXWrapped != 1 )
      {
         httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.wwgen_pais") +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "GXH_vPAIS_DESCRIPCION", AV14Pais_Descripcion);
      /* Send saved values. */
   ...
   {
      return formatLink("com.orions2.wwgen_pais")  ;
   }
   ...
   public void wb2S0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblTitletext_Internalname, "País", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_WWGEN_PAIS.htm");
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 27, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWGEN_PAIS.htm");
         httpContext.writeText( "</li>") ;
         httpContext.writeText( "<li>") ;
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 15,'',false,'',0)\"" ;
         ClassString = "ActionButtons" ;
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtnexport_Internalname, "gx.evt.setGridEvt("+GXutil.str( 27, 2, 0)+","+"null"+");", "Export", bttBtnexport_Jsonclick, 5, "Export to Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOEXPORT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWGEN_PAIS.htm");
         httpContext.writeText( "</li>") ;
         ...
         com.orions2.GxWebStd.gx_label_element( httpContext, edtavPais_descripcion_Internalname, "Pais_Descripcion", "col-sm-3 FilterSearchAttributeLabel", 0, true);
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"" ;
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavPais_descripcion_Internalname, AV14Pais_Descripcion, GXutil.rtrim( localUtil.format( AV14Pais_Descripcion, "@!")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Descripción del País", edtavPais_descripcion_Jsonclick, 0, "FilterSearchAttribute", "", "", "", 1, edtavPais_descripcion_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_WWGEN_PAIS.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            httpContext.writeValue( "Usuario Modifica País") ;
            httpContext.writeTextNL( "</th>") ;
            httpContext.writeText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
            httpContext.writeValue( "Fecha Modifica País") ;
            httpContext.writeTextNL( "</th>") ;
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", A136Pais_UsuarioCrea);
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", localUtil.ttoc( A137Pais_FechaCrea, 10, 8, 0, 3, "/", ":", " "));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", A138Pais_UsuarioModifica);
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            GridColumn.AddObjectProperty("Value", localUtil.ttoc( A139Pais_FechaModifica, 10, 8, 0, 3, "/", ":", " "));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
   ...
   public void start2S2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Work With País", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 {
                                    Rfr0gs = false ;
                                    /* Set Refresh If Pais_descripcion Changed */
                                    if ( GXutil.strcmp(httpContext.cgiGet( "GXH_vPAIS_DESCRIPCION"), AV14Pais_Descripcion) != 0 )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    if ( ! Rfr0gs )
   ...
   public void pa2S2( )
   {
      if ( nDonePA == 0 )
      {
         ...
         if ( ! httpContext.isAjaxRequest( ) )
         {
            GX_FocusControl = edtavPais_descripcion_Internalname ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_PAIS_USUARIOMODIFICA", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A138Pais_UsuarioModifica, "@!"))));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "PAIS_USUARIOMODIFICA", A138Pais_UsuarioModifica);
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_PAIS_FECHAMODIFICA", getSecureSignedToken( "", localUtil.format( A139Pais_FechaModifica, "99/99/99 99:99")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "PAIS_FECHAMODIFICA", localUtil.ttoc( A139Pais_FechaModifica, 10, 8, 0, 3, "/", ":", " "));
   }
   ...
   public void rf2S2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              AV14Pais_Descripcion ,
                                              A11Pais_Descripcion } ,
                                              new int[]{
                                              TypeConstants.STRING, TypeConstants.STRING
                                              }
         } ) ;
         lV14Pais_Descripcion = GXutil.concat( GXutil.rtrim( AV14Pais_Descripcion), "%", "") ;
         httpContext.ajax_rsp_assign_attri("", false, "AV14Pais_Descripcion", AV14Pais_Descripcion);
         /* Using cursor H002S2 */
         pr_default.execute(0, new Object[] {lV14Pais_Descripcion, new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_27_idx = (short)(1) ;
         sGXsfl_27_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_27_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_272( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A139Pais_FechaModifica = H002S2_A139Pais_FechaModifica[0] ;
            A138Pais_UsuarioModifica = H002S2_A138Pais_UsuarioModifica[0] ;
            A137Pais_FechaCrea = H002S2_A137Pais_FechaCrea[0] ;
            A136Pais_UsuarioCrea = H002S2_A136Pais_UsuarioCrea[0] ;
            A11Pais_Descripcion = H002S2_A11Pais_Descripcion[0] ;
            A9Pais_Codigo = H002S2_A9Pais_Codigo[0] ;
            e152S2 ();
   ...
   public int subgrid_recordcount( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV14Pais_Descripcion", AV14Pais_Descripcion);
      /* Using cursor H002S3 */
      pr_default.execute(1, new Object[] {lV14Pais_Descripcion});
   ...
   public void strup2S0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         AV14Pais_Descripcion = GXutil.upper( httpContext.cgiGet( edtavPais_descripcion_Internalname)) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV14Pais_Descripcion", AV14Pais_Descripcion);
         /* Read saved values. */
   ...
   {
      /* Grid_Load Routine */
      edtavUpdate_Link = formatLink("com.orions2.gen_pais") + "?" + GXutil.URLEncode(GXutil.rtrim("UPD")) + "," + GXutil.URLEncode(GXutil.rtrim(A9Pais_Codigo)) ;
      edtavDelete_Link = formatLink("com.orions2.gen_pais") + "?" + GXutil.URLEncode(GXutil.rtrim("DLT")) + "," + GXutil.URLEncode(GXutil.rtrim(A9Pais_Codigo)) ;
   ...
   {
      /* 'DoInsert' Routine */
      callWebObject(formatLink("com.orions2.gen_pais") + "?" + GXutil.URLEncode(GXutil.rtrim("INS")) + "," + GXutil.URLEncode(GXutil.rtrim("")));
      httpContext.wjLocDisableFrm = (byte)(1) ;
   }
   ...
   public void S122( )
   {
      ...
      {
         AV10GridState.fromxml(AV15Session.getValue(AV22Pgmname+"GridState"), null, null);
         if ( AV10GridState.getgxTv_SdtGridState_Filtervalues().size() >= 1 )
         {
            AV14Pais_Descripcion = ((com.orions2.SdtGridState_FilterValue)AV10GridState.getgxTv_SdtGridState_Filtervalues().elementAt(-1+1)).getgxTv_SdtGridState_FilterValue_Value() ;
            httpContext.ajax_rsp_assign_attri("", false, "AV14Pais_Descripcion", AV14Pais_Descripcion);
         }
   ...
   public void S132( )
   {
      ...
      AV11GridStateFilterValue.setgxTv_SdtGridState_FilterValue_Value( AV14Pais_Descripcion );
      AV10GridState.getgxTv_SdtGridState_Filtervalues().add(AV11GridStateFilterValue, 0);
      AV15Session.setValue(AV22Pgmname+"GridState", AV10GridState.toxml(false, true, "GridState", "ACBSENA"));
   }
   ...
   public void S112( )
   {
      ...
      AV16TrnContext.setgxTv_SdtTransactionContext_Transactionname( "GEN_PAIS" );
   ...
   {
      /* 'DoExport' Routine */
      GXv_char1[0] = AV8ExcelFilename ;
      GXv_char2[0] = AV7ErrorMessage ;
      new com.orions2.exportwwgen_pais(remoteHandle, context).execute( AV14Pais_Descripcion, GXv_char1, GXv_char2) ;
      wwgen_pais_impl.this.AV8ExcelFilename = GXv_char1[0] ;
      wwgen_pais_impl.this.AV7ErrorMessage = GXv_char2[0] ;
      httpContext.ajax_rsp_assign_attri("", false, "AV14Pais_Descripcion", AV14Pais_Descripcion);
      if ( GXutil.strcmp(AV8ExcelFilename, "") != 0 )
      {
         httpContext.wjLoc = formatLink(AV8ExcelFilename)  ;
      }
      else
      {
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414191673");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         ...
         httpContext.AddJavascriptSource("wwgen_pais.js", "?201861414191673");
      }
   ...
   public void subsflControlProps_272( )
   {
      ...
      edtPais_UsuarioCrea_Internalname = "PAIS_USUARIOCREA_"+sGXsfl_27_idx ;
      edtPais_FechaCrea_Internalname = "PAIS_FECHACREA_"+sGXsfl_27_idx ;
      edtPais_UsuarioModifica_Internalname = "PAIS_USUARIOMODIFICA_"+sGXsfl_27_idx ;
      edtPais_FechaModifica_Internalname = "PAIS_FECHAMODIFICA_"+sGXsfl_27_idx ;
   ...
   public void subsflControlProps_fel_272( )
   {
      ...
      edtPais_UsuarioCrea_Internalname = "PAIS_USUARIOCREA_"+sGXsfl_27_fel_idx ;
      edtPais_FechaCrea_Internalname = "PAIS_FECHACREA_"+sGXsfl_27_fel_idx ;
      edtPais_UsuarioModifica_Internalname = "PAIS_USUARIOMODIFICA_"+sGXsfl_27_fel_idx ;
      edtPais_FechaModifica_Internalname = "PAIS_FECHAMODIFICA_"+sGXsfl_27_fel_idx ;
   ...
   public void sendrow_272( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPais_Descripcion_Internalname,A11Pais_Descripcion,GXutil.rtrim( localUtil.format( A11Pais_Descripcion, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'",edtPais_Descripcion_Link,"","","",edtPais_Descripcion_Jsonclick,new Integer(0),"DescriptionAttribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(27),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPais_UsuarioCrea_Internalname,A136Pais_UsuarioCrea,GXutil.rtrim( localUtil.format( A136Pais_UsuarioCrea, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtPais_UsuarioCrea_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(27),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPais_FechaCrea_Internalname,localUtil.ttoc( A137Pais_FechaCrea, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A137Pais_FechaCrea, "99/99/99 99:99"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtPais_FechaCrea_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(27),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPais_UsuarioModifica_Internalname,A138Pais_UsuarioModifica,GXutil.rtrim( localUtil.format( A138Pais_UsuarioModifica, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtPais_UsuarioModifica_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(27),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtPais_FechaModifica_Internalname,localUtil.ttoc( A139Pais_FechaModifica, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A139Pais_FechaModifica, "99/99/99 99:99"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtPais_FechaModifica_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(27),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_PAIS_USUARIOCREA"+"_"+sGXsfl_27_idx, getSecureSignedToken( sGXsfl_27_idx, GXutil.rtrim( localUtil.format( A136Pais_UsuarioCrea, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_PAIS_FECHACREA"+"_"+sGXsfl_27_idx, getSecureSignedToken( sGXsfl_27_idx, localUtil.format( A137Pais_FechaCrea, "99/99/99 99:99")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_PAIS_USUARIOMODIFICA"+"_"+sGXsfl_27_idx, getSecureSignedToken( sGXsfl_27_idx, GXutil.rtrim( localUtil.format( A138Pais_UsuarioModifica, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_PAIS_FECHAMODIFICA"+"_"+sGXsfl_27_idx, getSecureSignedToken( sGXsfl_27_idx, localUtil.format( A139Pais_FechaModifica, "99/99/99 99:99")));
   ...
   public void init_default_properties( )
   {
      ...
      edtavPais_descripcion_Internalname = "vPAIS_DESCRIPCION" ;
      ...
      edtPais_UsuarioModifica_Internalname = "PAIS_USUARIOMODIFICA" ;
      edtPais_FechaModifica_Internalname = "PAIS_FECHAMODIFICA" ;
   ...
   public void initialize_properties( )
   {
      ...
      edtavPais_descripcion_Jsonclick = "" ;
      edtavPais_descripcion_Enabled = 1 ;
      Form.setHeaderrawhtml( "" );
      Form.setBackground( "" );
      Form.setTextcolor( 0 );
      Form.setIBackground( (int)(0xFFFFFF) );
      Form.setCaption( "Work With País" );
      subGrid_Rows = 0 ;
      edtavDelete_Tooltiptext = "Eliminar" ;
      edtavUpdate_Tooltiptext = "Modificar" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV18Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV6Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A9Pais_Codigo',fld:'PAIS_CODIGO',pic:'',hsh:true,nv:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',nv:''},{av:'AV14Pais_Descripcion',fld:'vPAIS_DESCRIPCION',pic:'@!',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e152S2',iparms:[{av:'A9Pais_Codigo',fld:'PAIS_CODIGO',pic:'',hsh:true,nv:''}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtPais_Descripcion_Link',ctrl:'PAIS_DESCRIPCION',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e112S2',iparms:[{av:'A9Pais_Codigo',fld:'PAIS_CODIGO',pic:'',hsh:true,nv:''}],oparms:[]}");
      setEventMetadata("'DOEXPORT'","{handler:'e122S2',iparms:[{av:'AV14Pais_Descripcion',fld:'vPAIS_DESCRIPCION',pic:'@!',nv:''}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV24Delete_GXI = "" ;
      scmdbuf = "" ;
      lV14Pais_Descripcion = "" ;
      H002S2_A139Pais_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H002S2_A138Pais_UsuarioModifica = new String[] {""} ;
      H002S2_A137Pais_FechaCrea = new java.util.Date[] {GXutil.nullDate()} ;
      H002S2_A136Pais_UsuarioCrea = new String[] {""} ;
      H002S2_A11Pais_Descripcion = new String[] {""} ;
      H002S2_A9Pais_Codigo = new String[] {""} ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.wwgen_pais__default(),
         new Object[] {
             new Object[] {
            H002S2_A139Pais_FechaModifica, H002S2_A138Pais_UsuarioModifica, H002S2_A137Pais_FechaCrea, H002S2_A136Pais_UsuarioCrea, H002S2_A11Pais_Descripcion, H002S2_A9Pais_Codigo
            }
            , new Object[] {
   ...
   private int edtavPais_descripcion_Enabled ;
   ...
   private String edtavPais_descripcion_Internalname ;
   private String edtavPais_descripcion_Jsonclick ;
   ...
   private String AV14Pais_Descripcion ;
   ...
   private String lV14Pais_Descripcion ;
   ...
   private java.util.Date[] H002S2_A139Pais_FechaModifica ;
   private String[] H002S2_A138Pais_UsuarioModifica ;
   private java.util.Date[] H002S2_A137Pais_FechaCrea ;
   private String[] H002S2_A136Pais_UsuarioCrea ;
   private String[] H002S2_A11Pais_Descripcion ;
   private String[] H002S2_A9Pais_Codigo ;
...
final  class wwgen_pais__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H002S2( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          String A11Pais_Descripcion )
   {
      ...
      String sFromString ;
      String sOrderString ;
      sSelectString = " Pais_FechaModifica, Pais_UsuarioModifica, Pais_FechaCrea, Pais_UsuarioCrea, Pais_Descripcion," ;
      sSelectString = sSelectString + " Pais_Codigo" ;
      sFromString = " FROM GEN_PAIS" ;
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV14Pais_Descripcion)==0) )
      {
      ...
      sOrderString = sOrderString + " ORDER BY Pais_Descripcion" ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H002S2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
            case 1 :
                  return conditional_H002S3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H002S2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H002S3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
