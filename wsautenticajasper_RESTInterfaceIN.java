/*
               File: wsautenticajasper_RESTInterfaceIN
...
@XmlType(name =  "wsautenticajasper_RESTInterfaceIN" , namespace = "http://tempuri.org/" , propOrder={  })
@JsonPropertyOrder(alphabetic=true)
@JsonAutoDetect(fieldVisibility=JsonAutoDetect.Visibility.NONE, getterVisibility=JsonAutoDetect.Visibility.NONE, isGetterVisibility=JsonAutoDetect.Visibility.NONE)
public final  class wsautenticajasper_RESTInterfaceIN
{
   String AV14lvc ;
   @XmlElement(name="lvc")
   @JsonProperty("lvc")
