/*
               File: alm_clasealm_catalogowc_impl
        Description: ALM_CLASEALM_CATALOGOWC
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:17:3.94
...
public final  class alm_clasealm_catalogowc_impl extends GXWebComponent
{
   public alm_clasealm_catalogowc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public alm_clasealm_catalogowc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( alm_clasealm_catalogowc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Clas_Codigo", AV7Clas_Codigo);
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,AV7Clas_Codigo});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Clas_Codigo, AV12Update, AV13Delete, A37Cata_Codigo, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "ALM_CLASEALM_CATALOGOWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20186141417397");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.alm_clasealm_catalogowc") + "?" + GXutil.URLEncode(GXutil.rtrim(AV7Clas_Codigo))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV7Clas_Codigo", wcpOAV7Clas_Codigo);
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vCLAS_CODIGO", AV7Clas_Codigo);
   ...
   public void renderHtmlCloseForm4M2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("alm_clasealm_catalogowc.js", "?20186141417399");
      }
   ...
   {
      return "ALM_CLASEALM_CATALOGOWC" ;
   }
   ...
   public void wb4M0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.alm_clasealm_catalogowc");
         }
         /* Div Control */
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_ALM_CLASEALM_CATALOGOWC.htm");
      ...
      if ( wbEnd == 20 )
      {
         ...
         com.orions2.GxWebStd.gx_label_element( httpContext, edtClas_Codigo_Internalname, "Código Clase", "col-sm-3 AttributeLabel", 0, true);
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtClas_Codigo_Internalname, A34Clas_Codigo, GXutil.rtrim( localUtil.format( A34Clas_Codigo, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtClas_Codigo_Jsonclick, 0, "Attribute", "", "", "", edtClas_Codigo_Visible, edtClas_Codigo_Enabled, 0, "text", "", 7, "chr", 1, "row", 7, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_ALM_CLASEALM_CATALOGOWC.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start4M2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "ALM_CLASEALM_CATALOGOWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"CATA_USUARIOCREACION", A303Cata_UsuarioCreacion);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"CATA_FECHACREACION", localUtil.ttoc( A304Cata_FechaCreacion, 10, 8, 0, 3, "/", ":", " "));
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"CATA_USUARIOMODIFICACION", A305Cata_UsuarioModificacion);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"CATA_FECHAMODIFICACION", localUtil.ttoc( A306Cata_FechaModificacion, 10, 8, 0, 3, "/", ":", " "));
   }
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "ALM_CLASEALM_CATALOGOWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf4M2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H004M2 */
         pr_default.execute(0, new Object[] {AV7Clas_Codigo, new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_20_idx = (short)(1) ;
         sGXsfl_20_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_20_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_202( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A34Clas_Codigo = H004M2_A34Clas_Codigo[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A34Clas_Codigo", A34Clas_Codigo);
            A306Cata_FechaModificacion = H004M2_A306Cata_FechaModificacion[0] ;
            A305Cata_UsuarioModificacion = H004M2_A305Cata_UsuarioModificacion[0] ;
            A304Cata_FechaCreacion = H004M2_A304Cata_FechaCreacion[0] ;
            A303Cata_UsuarioCreacion = H004M2_A303Cata_UsuarioCreacion[0] ;
            A298Cata_Descripcion = H004M2_A298Cata_Descripcion[0] ;
            A37Cata_Codigo = H004M2_A37Cata_Codigo[0] ;
            e134M2 ();
   ...
   {
      /* Using cursor H004M3 */
      pr_default.execute(1, new Object[] {AV7Clas_Codigo});
   ...
   public void strup4M0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV7Clas_Codigo = httpContext.cgiGet( sPrefix+"wcpOAV7Clas_Codigo") ;
   ...
   public void e124M2( )
   {
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext, !bGXsfl_20_Refreshing);
      edtClas_Codigo_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtClas_Codigo_Internalname, "Visible", GXutil.ltrim( GXutil.str( edtClas_Codigo_Visible, 5, 0)), true);
   ...
   {
      /* Grid_Load Routine */
      edtavUpdate_Link = formatLink("com.orions2.alm_catalogo") + "?" + GXutil.URLEncode(GXutil.rtrim("UPD")) + "," + GXutil.URLEncode(GXutil.rtrim(A37Cata_Codigo)) ;
      edtavDelete_Link = formatLink("com.orions2.alm_catalogo") + "?" + GXutil.URLEncode(GXutil.rtrim("DLT")) + "," + GXutil.URLEncode(GXutil.rtrim(A37Cata_Codigo)) ;
   ...
   {
      /* 'DoInsert' Routine */
      callWebObject(formatLink("com.orions2.alm_catalogo") + "?" + GXutil.URLEncode(GXutil.rtrim("INS")) + "," + GXutil.URLEncode(GXutil.rtrim("")));
      httpContext.wjLocDisableFrm = (byte)(1) ;
   }
   ...
   public void S112( )
   {
      ...
      AV10TrnContext.setgxTv_SdtTransactionContext_Transactionname( "ALM_CATALOGO" );
      ...
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributename( "Clas_Codigo" );
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( AV7Clas_Codigo );
   ...
   {
      AV7Clas_Codigo = (String)getParm(obj,0,TypeConstants.STRING) ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Clas_Codigo", AV7Clas_Codigo);
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV7Clas_Codigo = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "alm_clasealm_catalogowc");
      ...
      {
         AV7Clas_Codigo = (String)getParm(obj,2,TypeConstants.STRING) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Clas_Codigo", AV7Clas_Codigo);
      }
      wcpOAV7Clas_Codigo = httpContext.cgiGet( sPrefix+"wcpOAV7Clas_Codigo") ;
      if ( ! GetJustCreated( ) && ( ( GXutil.strcmp(AV7Clas_Codigo, wcpOAV7Clas_Codigo) != 0 ) ) )
      {
         setjustcreated();
      }
      wcpOAV7Clas_Codigo = AV7Clas_Codigo ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV7Clas_Codigo = httpContext.cgiGet( sPrefix+"AV7Clas_Codigo_CTRL") ;
      if ( GXutil.len( sCtrlAV7Clas_Codigo) > 0 )
      {
         AV7Clas_Codigo = httpContext.cgiGet( sCtrlAV7Clas_Codigo) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Clas_Codigo", AV7Clas_Codigo);
      }
      else
      {
         AV7Clas_Codigo = httpContext.cgiGet( sPrefix+"AV7Clas_Codigo_PARM") ;
      }
   }
   ...
   {
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Clas_Codigo_PARM", AV7Clas_Codigo);
      if ( GXutil.len( GXutil.rtrim( sCtrlAV7Clas_Codigo)) > 0 )
      {
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Clas_Codigo_CTRL", GXutil.rtrim( sCtrlAV7Clas_Codigo));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20186141417443");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("alm_clasealm_catalogowc.js", "?20186141417443");
      }
   ...
   public void subsflControlProps_202( )
   {
      ...
      edtCata_UsuarioCreacion_Internalname = sPrefix+"CATA_USUARIOCREACION_"+sGXsfl_20_idx ;
      edtCata_FechaCreacion_Internalname = sPrefix+"CATA_FECHACREACION_"+sGXsfl_20_idx ;
      edtCata_UsuarioModificacion_Internalname = sPrefix+"CATA_USUARIOMODIFICACION_"+sGXsfl_20_idx ;
      edtCata_FechaModificacion_Internalname = sPrefix+"CATA_FECHAMODIFICACION_"+sGXsfl_20_idx ;
   ...
   public void subsflControlProps_fel_202( )
   {
      ...
      edtCata_UsuarioCreacion_Internalname = sPrefix+"CATA_USUARIOCREACION_"+sGXsfl_20_fel_idx ;
      edtCata_FechaCreacion_Internalname = sPrefix+"CATA_FECHACREACION_"+sGXsfl_20_fel_idx ;
      edtCata_UsuarioModificacion_Internalname = sPrefix+"CATA_USUARIOMODIFICACION_"+sGXsfl_20_fel_idx ;
      edtCata_FechaModificacion_Internalname = sPrefix+"CATA_FECHAMODIFICACION_"+sGXsfl_20_fel_idx ;
   ...
   public void sendrow_202( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCata_Descripcion_Internalname,A298Cata_Descripcion,GXutil.rtrim( localUtil.format( A298Cata_Descripcion, "@!")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'",edtCata_Descripcion_Link,"","","",edtCata_Descripcion_Jsonclick,new Integer(0),"DescriptionAttribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(200),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCata_UsuarioCreacion_Internalname,A303Cata_UsuarioCreacion,GXutil.rtrim( localUtil.format( A303Cata_UsuarioCreacion, "@!")),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtCata_UsuarioCreacion_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCata_FechaCreacion_Internalname,localUtil.ttoc( A304Cata_FechaCreacion, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A304Cata_FechaCreacion, "99/99/99 99:99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtCata_FechaCreacion_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCata_FechaModificacion_Internalname,localUtil.ttoc( A306Cata_FechaModificacion, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A306Cata_FechaModificacion, "99/99/99 99:99"),"","'"+sPrefix+"'"+",false,"+"'"+""+"'","","","","",edtCata_FechaModificacion_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(20),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_CATA_USUARIOCREACION"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A303Cata_UsuarioCreacion, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_CATA_FECHACREACION"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, localUtil.format( A304Cata_FechaCreacion, "99/99/99 99:99")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_CATA_USUARIOMODIFICACION"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A305Cata_UsuarioModificacion, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_CATA_FECHAMODIFICACION"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, localUtil.format( A306Cata_FechaModificacion, "99/99/99 99:99")));
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Clas_Codigo',fld:'vCLAS_CODIGO',pic:'',nv:''},{av:'AV12Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV13Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A37Cata_Codigo',fld:'CATA_CODIGO',pic:'',hsh:true,nv:''},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e134M2',iparms:[{av:'A37Cata_Codigo',fld:'CATA_CODIGO',pic:'',hsh:true,nv:''}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtCata_Descripcion_Link',ctrl:'CATA_DESCRIPCION',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e114M2',iparms:[{av:'A37Cata_Codigo',fld:'CATA_CODIGO',pic:'',hsh:true,nv:''}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H004M2_A34Clas_Codigo = new String[] {""} ;
      H004M2_A306Cata_FechaModificacion = new java.util.Date[] {GXutil.nullDate()} ;
      H004M2_A305Cata_UsuarioModificacion = new String[] {""} ;
      H004M2_A304Cata_FechaCreacion = new java.util.Date[] {GXutil.nullDate()} ;
      H004M2_A303Cata_UsuarioCreacion = new String[] {""} ;
      H004M2_A298Cata_Descripcion = new String[] {""} ;
      H004M2_A37Cata_Codigo = new String[] {""} ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.alm_clasealm_catalogowc__default(),
         new Object[] {
             new Object[] {
            H004M2_A34Clas_Codigo, H004M2_A306Cata_FechaModificacion, H004M2_A305Cata_UsuarioModificacion, H004M2_A304Cata_FechaCreacion, H004M2_A303Cata_UsuarioCreacion, H004M2_A298Cata_Descripcion, H004M2_A37Cata_Codigo
            }
            , new Object[] {
   ...
   private int edtClas_Codigo_Visible ;
   ...
   private String sCtrlAV7Clas_Codigo ;
   ...
   private String[] H004M2_A34Clas_Codigo ;
   private java.util.Date[] H004M2_A306Cata_FechaModificacion ;
   private String[] H004M2_A305Cata_UsuarioModificacion ;
   private java.util.Date[] H004M2_A304Cata_FechaCreacion ;
   private String[] H004M2_A303Cata_UsuarioCreacion ;
   private String[] H004M2_A298Cata_Descripcion ;
   private String[] H004M2_A37Cata_Codigo ;
...
final  class alm_clasealm_catalogowc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H004M2", "SELECT Clas_Codigo, Cata_FechaModificacion, Cata_UsuarioModificacion, Cata_FechaCreacion, Cata_UsuarioCreacion, Cata_Descripcion, Cata_Codigo FROM ALM_CATALOGO WHERE Clas_Codigo = ? ORDER BY Clas_Codigo  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H004M3", "SELECT COUNT(*) FROM ALM_CATALOGO WHERE Clas_Codigo = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
