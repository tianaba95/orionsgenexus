/*
               File: alm_bodegaalm_restricciones1wc_impl
        Description: ALM_BODEGAALM_RESTRICCIONES1 WC
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:14:8.24
...
public final  class alm_bodegaalm_restricciones1wc_impl extends GXWebComponent
{
   public alm_bodegaalm_restricciones1wc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public alm_bodegaalm_restricciones1wc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( alm_bodegaalm_restricciones1wc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV7Mbod_BodDestinoCodigo = httpContext.GetNextPar( ) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Mbod_BodDestinoCodigo", AV7Mbod_BodDestinoCodigo);
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,AV7Mbod_BodDestinoCodigo});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Mbod_BodDestinoCodigo, AV12Update, AV13Delete, A60Mbod_Id, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "ALM_BODEGAALM_RESTRICCIONES1 WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20186141414830");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.alm_bodegaalm_restricciones1wc") + "?" + GXutil.URLEncode(GXutil.rtrim(AV7Mbod_BodDestinoCodigo))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV7Mbod_BodDestinoCodigo", wcpOAV7Mbod_BodDestinoCodigo);
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vMBOD_BODDESTINOCODIGO", AV7Mbod_BodDestinoCodigo);
   ...
   public void renderHtmlCloseForm3Z2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("alm_bodegaalm_restricciones1wc.js", "?20186141414832");
      }
   ...
   {
      return "ALM_BODEGAALM_RESTRICCIONES1WC" ;
   }

   public String getPgmdesc( )
   {
      return "ALM_BODEGAALM_RESTRICCIONES1 WC" ;
   }
   ...
   public void wb3Z0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.alm_bodegaalm_restricciones1wc");
         }
         /* Div Control */
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_ALM_BODEGAALM_RESTRICCIONES1WC.htm");
      ...
      if ( wbEnd == 20 )
      {
         ...
         com.orions2.GxWebStd.gx_label_element( httpContext, edtMbod_BodDestinoCodigo_Internalname, "Codigo Bodega Destino", "col-sm-3 AttributeLabel", 0, true);
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtMbod_BodDestinoCodigo_Internalname, A65Mbod_BodDestinoCodigo, GXutil.rtrim( localUtil.format( A65Mbod_BodDestinoCodigo, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtMbod_BodDestinoCodigo_Jsonclick, 0, "Attribute", "", "", "", edtMbod_BodDestinoCodigo_Visible, edtMbod_BodDestinoCodigo_Enabled, 0, "text", "", 3, "chr", 1, "row", 3, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_ALM_BODEGAALM_RESTRICCIONES1WC.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start3Z2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "ALM_BODEGAALM_RESTRICCIONES1 WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void gxgrgrid_refresh( int subGrid_Rows ,
                                 String AV7Mbod_BodDestinoCodigo ,
                                 String AV12Update ,
                                 String AV13Delete ,
                                 long A60Mbod_Id ,
                                 String sPrefix )
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "ALM_BODEGAALM_RESTRICCIONES1WC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf3Z2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H003Z2 */
         pr_default.execute(0, new Object[] {AV7Mbod_BodDestinoCodigo, new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_20_idx = (short)(1) ;
         sGXsfl_20_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_20_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_202( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A65Mbod_BodDestinoCodigo = H003Z2_A65Mbod_BodDestinoCodigo[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A65Mbod_BodDestinoCodigo", A65Mbod_BodDestinoCodigo);
            A361Mbod_UsuarioModifica = H003Z2_A361Mbod_UsuarioModifica[0] ;
            A362Mbod_FechaModifica = H003Z2_A362Mbod_FechaModifica[0] ;
            A359Mbod_UsuarioCrea = H003Z2_A359Mbod_UsuarioCrea[0] ;
            A433Mbod_FechaCrea = H003Z2_A433Mbod_FechaCrea[0] ;
            A434Mbod_Estado = H003Z2_A434Mbod_Estado[0] ;
            A345Mbod_AlmDestinoCodigo = H003Z2_A345Mbod_AlmDestinoCodigo[0] ;
            A368Mbod_AlmModDestino = H003Z2_A368Mbod_AlmModDestino[0] ;
            A64Mbod_BodOrigenCodigo = H003Z2_A64Mbod_BodOrigenCodigo[0] ;
            A342Mbod_AlmOrigenCodigo = H003Z2_A342Mbod_AlmOrigenCodigo[0] ;
            A364Mbod_AlmModOrigen = H003Z2_A364Mbod_AlmModOrigen[0] ;
            A430Mbod_CentroCostoDescrip = H003Z2_A430Mbod_CentroCostoDescrip[0] ;
            n430Mbod_CentroCostoDescrip = H003Z2_n430Mbod_CentroCostoDescrip[0] ;
            A429Mbod_CentCostoCodigo = H003Z2_A429Mbod_CentCostoCodigo[0] ;
            n429Mbod_CentCostoCodigo = H003Z2_n429Mbod_CentCostoCodigo[0] ;
            A63Mbod_CentCostoId = H003Z2_A63Mbod_CentCostoId[0] ;
            A427Mbod_RegionDescripcion = H003Z2_A427Mbod_RegionDescripcion[0] ;
            n427Mbod_RegionDescripcion = H003Z2_n427Mbod_RegionDescripcion[0] ;
            A426Mbod_RegionCodigo = H003Z2_A426Mbod_RegionCodigo[0] ;
            n426Mbod_RegionCodigo = H003Z2_n426Mbod_RegionCodigo[0] ;
            A62Mbod_RegionId = H003Z2_A62Mbod_RegionId[0] ;
            A432Mbod_TipoElementoDesc = H003Z2_A432Mbod_TipoElementoDesc[0] ;
            n432Mbod_TipoElementoDesc = H003Z2_n432Mbod_TipoElementoDesc[0] ;
            A431Mbod_TipoElementoCod = H003Z2_A431Mbod_TipoElementoCod[0] ;
            n431Mbod_TipoElementoCod = H003Z2_n431Mbod_TipoElementoCod[0] ;
            A428Mbod_TipoMovDescrip = H003Z2_A428Mbod_TipoMovDescrip[0] ;
            n428Mbod_TipoMovDescrip = H003Z2_n428Mbod_TipoMovDescrip[0] ;
            A61Mbod_TipoMovCodigo = H003Z2_A61Mbod_TipoMovCodigo[0] ;
            A60Mbod_Id = H003Z2_A60Mbod_Id[0] ;
            A430Mbod_CentroCostoDescrip = H003Z2_A430Mbod_CentroCostoDescrip[0] ;
            n430Mbod_CentroCostoDescrip = H003Z2_n430Mbod_CentroCostoDescrip[0] ;
            A429Mbod_CentCostoCodigo = H003Z2_A429Mbod_CentCostoCodigo[0] ;
            n429Mbod_CentCostoCodigo = H003Z2_n429Mbod_CentCostoCodigo[0] ;
            ...
            A251Bode_Descripcion = H003Z4_A251Bode_Descripcion[0] ;
            pr_default.close(2);
            e133Z2 ();
   ...
   public void strup3Z0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV7Mbod_BodDestinoCodigo = httpContext.cgiGet( sPrefix+"wcpOAV7Mbod_BodDestinoCodigo") ;
   ...
   public void e123Z2( )
   {
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext, !bGXsfl_20_Refreshing);
      edtMbod_BodDestinoCodigo_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtMbod_BodDestinoCodigo_Internalname, "Visible", GXutil.ltrim( GXutil.str( edtMbod_BodDestinoCodigo_Visible, 5, 0)), true);
   ...
   public void S112( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributename( "Mbod_BodDestinoCodigo" );
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( AV7Mbod_BodDestinoCodigo );
   ...
   {
      AV7Mbod_BodDestinoCodigo = (String)getParm(obj,0,TypeConstants.STRING) ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Mbod_BodDestinoCodigo", AV7Mbod_BodDestinoCodigo);
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV7Mbod_BodDestinoCodigo = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "alm_bodegaalm_restricciones1wc");
      ...
      {
         AV7Mbod_BodDestinoCodigo = (String)getParm(obj,2,TypeConstants.STRING) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Mbod_BodDestinoCodigo", AV7Mbod_BodDestinoCodigo);
      }
      wcpOAV7Mbod_BodDestinoCodigo = httpContext.cgiGet( sPrefix+"wcpOAV7Mbod_BodDestinoCodigo") ;
      if ( ! GetJustCreated( ) && ( ( GXutil.strcmp(AV7Mbod_BodDestinoCodigo, wcpOAV7Mbod_BodDestinoCodigo) != 0 ) ) )
      {
         setjustcreated();
      }
      wcpOAV7Mbod_BodDestinoCodigo = AV7Mbod_BodDestinoCodigo ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV7Mbod_BodDestinoCodigo = httpContext.cgiGet( sPrefix+"AV7Mbod_BodDestinoCodigo_CTRL") ;
      if ( GXutil.len( sCtrlAV7Mbod_BodDestinoCodigo) > 0 )
      {
         AV7Mbod_BodDestinoCodigo = httpContext.cgiGet( sCtrlAV7Mbod_BodDestinoCodigo) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Mbod_BodDestinoCodigo", AV7Mbod_BodDestinoCodigo);
      }
      else
      {
         AV7Mbod_BodDestinoCodigo = httpContext.cgiGet( sPrefix+"AV7Mbod_BodDestinoCodigo_PARM") ;
      }
   }
   ...
   {
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Mbod_BodDestinoCodigo_PARM", AV7Mbod_BodDestinoCodigo);
      if ( GXutil.len( GXutil.rtrim( sCtrlAV7Mbod_BodDestinoCodigo)) > 0 )
      {
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Mbod_BodDestinoCodigo_CTRL", GXutil.rtrim( sCtrlAV7Mbod_BodDestinoCodigo));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2018614141499");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("alm_bodegaalm_restricciones1wc.js", "?20186141414910");
      }
   ...
   public void initialize_properties( )
   {
      ...
      edtMbod_BodDestinoCodigo_Visible = 1 ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Mbod_BodDestinoCodigo',fld:'vMBOD_BODDESTINOCODIGO',pic:'',nv:''},{av:'AV12Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV13Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A60Mbod_Id',fld:'MBOD_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e133Z2',iparms:[{av:'A60Mbod_Id',fld:'MBOD_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtMbod_TipoMovCodigo_Link',ctrl:'MBOD_TIPOMOVCODIGO',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e113Z2',iparms:[{av:'A60Mbod_Id',fld:'MBOD_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[]}");
   ...
   {
      wcpOAV7Mbod_BodDestinoCodigo = "" ;
      gxfirstwebparm = "" ;
      gxfirstwebparm_bkp = "" ;
      sPrefix = "" ;
      AV7Mbod_BodDestinoCodigo = "" ;
      AV12Update = "" ;
      AV13Delete = "" ;
      GXKey = "" ;
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H003Z2_A65Mbod_BodDestinoCodigo = new String[] {""} ;
      H003Z2_A361Mbod_UsuarioModifica = new String[] {""} ;
      H003Z2_A362Mbod_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H003Z2_A359Mbod_UsuarioCrea = new String[] {""} ;
      H003Z2_A433Mbod_FechaCrea = new java.util.Date[] {GXutil.nullDate()} ;
      H003Z2_A434Mbod_Estado = new String[] {""} ;
      H003Z2_A345Mbod_AlmDestinoCodigo = new String[] {""} ;
      H003Z2_A368Mbod_AlmModDestino = new String[] {""} ;
      H003Z2_A64Mbod_BodOrigenCodigo = new String[] {""} ;
      H003Z2_A342Mbod_AlmOrigenCodigo = new String[] {""} ;
      H003Z2_A364Mbod_AlmModOrigen = new String[] {""} ;
      H003Z2_A430Mbod_CentroCostoDescrip = new String[] {""} ;
      H003Z2_n430Mbod_CentroCostoDescrip = new boolean[] {false} ;
      H003Z2_A429Mbod_CentCostoCodigo = new String[] {""} ;
      H003Z2_n429Mbod_CentCostoCodigo = new boolean[] {false} ;
      H003Z2_A63Mbod_CentCostoId = new long[1] ;
      H003Z2_A427Mbod_RegionDescripcion = new String[] {""} ;
      H003Z2_n427Mbod_RegionDescripcion = new boolean[] {false} ;
      H003Z2_A426Mbod_RegionCodigo = new short[1] ;
      H003Z2_n426Mbod_RegionCodigo = new boolean[] {false} ;
      H003Z2_A62Mbod_RegionId = new long[1] ;
      H003Z2_A432Mbod_TipoElementoDesc = new String[] {""} ;
      H003Z2_n432Mbod_TipoElementoDesc = new boolean[] {false} ;
      H003Z2_A431Mbod_TipoElementoCod = new long[1] ;
      H003Z2_n431Mbod_TipoElementoCod = new boolean[] {false} ;
      H003Z2_A428Mbod_TipoMovDescrip = new String[] {""} ;
      H003Z2_n428Mbod_TipoMovDescrip = new boolean[] {false} ;
      H003Z2_A61Mbod_TipoMovCodigo = new String[] {""} ;
      H003Z2_A60Mbod_Id = new long[1] ;
      H003Z3_A31Bode_Codigo = new String[] {""} ;
      H003Z4_A251Bode_Descripcion = new String[] {""} ;
      ...
      sCtrlAV7Mbod_BodDestinoCodigo = "" ;
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.alm_bodegaalm_restricciones1wc__default(),
         new Object[] {
             new Object[] {
            H003Z2_A65Mbod_BodDestinoCodigo, H003Z2_A361Mbod_UsuarioModifica, H003Z2_A362Mbod_FechaModifica, H003Z2_A359Mbod_UsuarioCrea, H003Z2_A433Mbod_FechaCrea, H003Z2_A434Mbod_Estado, H003Z2_A345Mbod_AlmDestinoCodigo, H003Z2_A368Mbod_AlmModDestino, H003Z2_A64Mbod_BodOrigenCodigo, H003Z2_A342Mbod_AlmOrigenCodigo,
            H003Z2_A364Mbod_AlmModOrigen, H003Z2_A430Mbod_CentroCostoDescrip, H003Z2_n430Mbod_CentroCostoDescrip, H003Z2_A429Mbod_CentCostoCodigo, H003Z2_n429Mbod_CentCostoCodigo, H003Z2_A63Mbod_CentCostoId, H003Z2_A427Mbod_RegionDescripcion, H003Z2_n427Mbod_RegionDescripcion, H003Z2_A426Mbod_RegionCodigo, H003Z2_n426Mbod_RegionCodigo,
            H003Z2_A62Mbod_RegionId, H003Z2_A432Mbod_TipoElementoDesc, H003Z2_n432Mbod_TipoElementoDesc, H003Z2_A431Mbod_TipoElementoCod, H003Z2_n431Mbod_TipoElementoCod, H003Z2_A428Mbod_TipoMovDescrip, H003Z2_n428Mbod_TipoMovDescrip, H003Z2_A61Mbod_TipoMovCodigo, H003Z2_A60Mbod_Id
            }
            , new Object[] {
            H003Z3_A31Bode_Codigo
            }
            , new Object[] {
            H003Z4_A251Bode_Descripcion
            }
         }
      );
      AV17Pgmname = "ALM_BODEGAALM_RESTRICCIONES1WC" ;
   ...
   private int edtMbod_BodDestinoCodigo_Visible ;
   ...
   private String sCtrlAV7Mbod_BodDestinoCodigo ;
   ...
   private String wcpOAV7Mbod_BodDestinoCodigo ;
   private String AV7Mbod_BodDestinoCodigo ;
   ...
   private String[] H003Z2_A65Mbod_BodDestinoCodigo ;
   private String[] H003Z2_A361Mbod_UsuarioModifica ;
   private java.util.Date[] H003Z2_A362Mbod_FechaModifica ;
   private String[] H003Z2_A359Mbod_UsuarioCrea ;
   private java.util.Date[] H003Z2_A433Mbod_FechaCrea ;
   private String[] H003Z2_A434Mbod_Estado ;
   private String[] H003Z2_A345Mbod_AlmDestinoCodigo ;
   private String[] H003Z2_A368Mbod_AlmModDestino ;
   private String[] H003Z2_A64Mbod_BodOrigenCodigo ;
   private String[] H003Z2_A342Mbod_AlmOrigenCodigo ;
   private String[] H003Z2_A364Mbod_AlmModOrigen ;
   private String[] H003Z2_A430Mbod_CentroCostoDescrip ;
   private boolean[] H003Z2_n430Mbod_CentroCostoDescrip ;
   private String[] H003Z2_A429Mbod_CentCostoCodigo ;
   private boolean[] H003Z2_n429Mbod_CentCostoCodigo ;
   private long[] H003Z2_A63Mbod_CentCostoId ;
   private String[] H003Z2_A427Mbod_RegionDescripcion ;
   private boolean[] H003Z2_n427Mbod_RegionDescripcion ;
   private short[] H003Z2_A426Mbod_RegionCodigo ;
   private boolean[] H003Z2_n426Mbod_RegionCodigo ;
   private long[] H003Z2_A62Mbod_RegionId ;
   private String[] H003Z2_A432Mbod_TipoElementoDesc ;
   private boolean[] H003Z2_n432Mbod_TipoElementoDesc ;
   private long[] H003Z2_A431Mbod_TipoElementoCod ;
   private boolean[] H003Z2_n431Mbod_TipoElementoCod ;
   private String[] H003Z2_A428Mbod_TipoMovDescrip ;
   private boolean[] H003Z2_n428Mbod_TipoMovDescrip ;
   private String[] H003Z2_A61Mbod_TipoMovCodigo ;
   private long[] H003Z2_A60Mbod_Id ;
   private String[] H003Z3_A31Bode_Codigo ;
   private String[] H003Z4_A251Bode_Descripcion ;
