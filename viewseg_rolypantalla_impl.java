/*
               File: viewseg_rolypantalla_impl
        Description: View SEG_ROLYPANTALLA
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:19:22.9
...
public final  class viewseg_rolypantalla_impl extends GXDataArea
{
   public viewseg_rolypantalla_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public viewseg_rolypantalla_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( viewseg_rolypantalla_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414192211");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.viewseg_rolypantalla") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13Rol_Id,11,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV7TabCode))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      forbiddenHiddens = "hsh" + "ViewSEG_ROLYPANTALLA" ;
      forbiddenHiddens = forbiddenHiddens + GXutil.rtrim( localUtil.format( A22Rol_Descripcion, "@!")) ;
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "hsh", GXutil.getEncryptedSignature( forbiddenHiddens, GXKey));
      GXutil.writeLogln("viewseg_rolypantalla:[SendSecurityCheck]"+forbiddenHiddens);
   }
   ...
   public void renderHtmlCloseForm( )
   {
      ...
      if ( ! ( WebComp_Pantwc == null ) )
      {
         WebComp_Pantwc.componentjscripts();
      }
   ...
   {
      return formatLink("com.orions2.viewseg_rolypantalla") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13Rol_Id,11,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV7TabCode)) ;
   }

   public String getPgmname( )
   {
      return "ViewSEG_ROLYPANTALLA" ;
   }
   ...
   public void wb3D0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, "Rol y pantall Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_ViewSEG_ROLYPANTALLA.htm");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblViewall_Internalname, "Work With Rol y pantalls", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, (short)(0), "HLP_ViewSEG_ROLYPANTALLA.htm");
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtRol_Descripcion_Internalname, A22Rol_Descripcion, GXutil.rtrim( localUtil.format( A22Rol_Descripcion, "@!")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtRol_Descripcion_Jsonclick, 0, "ReadonlyAttribute", "", "", "", 1, edtRol_Descripcion_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "Descripcion", "left", true, "HLP_ViewSEG_ROLYPANTALLA.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewSEG_ROLYPANTALLA.htm");
         /* Div Control */
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblPant_title_Internalname, "Pant", "", "", lblPant_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewSEG_ROLYPANTALLA.htm");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
         httpContext.writeText( "Pant") ;
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         httpContext.writeText( "</div>") ;
         httpContext.writeText( "<div class=\"gx_usercontrol_child\" id=\""+"TABContainer"+"panel2"+"\" style=\"display:none;\">") ;
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, divTablepant_Internalname, 1, 0, "px", 0, "px", "TabsFormContainer", "left", "top", "", "", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         ...
         {
            /* WebComponent */
            com.orions2.GxWebStd.gx_hidden_field( httpContext, "W0037"+"", GXutil.rtrim( WebComp_Pantwc_Component));
            httpContext.writeText( "<div") ;
            com.orions2.GxWebStd.classAttribute( httpContext, "gxwebcomponent");
            httpContext.writeText( " id=\""+"gxHTMLWrpW0037"+""+"\""+"") ;
            httpContext.writeText( ">") ;
            if ( GXutil.len( WebComp_Pantwc_Component) != 0 )
            {
               if ( GXutil.strcmp(GXutil.lower( OldPantwc), GXutil.lower( WebComp_Pantwc_Component)) != 0 )
               {
                  httpContext.ajax_rspStartCmp("gxHTMLWrpW0037"+"");
               }
               WebComp_Pantwc.componentdraw();
               if ( GXutil.strcmp(GXutil.lower( OldPantwc), GXutil.lower( WebComp_Pantwc_Component)) != 0 )
               {
                  httpContext.ajax_rspEndCmp();
               }
         ...
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblSeg_usuario_rol_title_Internalname, "Usuario y Roles", "", "", lblSeg_usuario_rol_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewSEG_ROLYPANTALLA.htm");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
   ...
   public void start3D2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "View SEG_ROLYPANTALLA", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
            ...
            if ( GXutil.len( sEvt) > 0 )
            {
               ...
               if ( GXutil.strcmp(sEvtType, "M") != 0 )
               {
                  ...
                  else if ( GXutil.strcmp(sEvtType, "W") == 0 )
                  {
                     ...
                     {
                        OldPantwc = httpContext.cgiGet( "W0037") ;
                        if ( ( GXutil.len( OldPantwc) == 0 ) || ( GXutil.strcmp(OldPantwc, WebComp_Pantwc_Component) != 0 ) )
                        {
                           WebComp_Pantwc = WebUtils.getWebComponent(getClass(), "com.orions2." + OldPantwc + "_impl", remoteHandle, context);
                           WebComp_Pantwc_Component = OldPantwc ;
                        }
                        if ( GXutil.len( WebComp_Pantwc_Component) != 0 )
                        {
                           WebComp_Pantwc.componentprocess("W0037", "", sEvt);
                        }
                        WebComp_Pantwc_Component = OldPantwc ;
                     }
                     else if ( nCmpId == 45 )
   ...
   {
      /* GeneXus formulas. */
      AV16Pgmname = "ViewSEG_ROLYPANTALLA" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf3D2( )
   {
      ...
      {
         /* Using cursor H003D2 */
         pr_default.execute(0, new Object[] {new Long(AV13Rol_Id)});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A21Rol_Id = H003D2_A21Rol_Id[0] ;
            A22Rol_Descripcion = H003D2_A22Rol_Descripcion[0] ;
   ...
   public void strup3D0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         if ( ! GXutil.checkEncryptedSignature( forbiddenHiddens, hsh, GXKey) )
         {
            ...
            GXutil.writeLog("viewseg_rolypantalla:[SecurityCheckFailed]"+forbiddenHiddens);
            return  ;
         }
      }
      else
   ...
   public void e113D2( )
   {
      ...
      AV17GXLvl6 = (byte)(0) ;
      /* Using cursor H003D3 */
      pr_default.execute(1, new Object[] {new Long(AV13Rol_Id)});
      while ( (pr_default.getStatus(1) != 101) )
      {
         A21Rol_Id = H003D3_A21Rol_Id[0] ;
         A22Rol_Descripcion = H003D3_A22Rol_Descripcion[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A22Rol_Descripcion", A22Rol_Descripcion);
         httpContext.ajax_rsp_assign_attri("", false, "gxhash_ROL_DESCRIPCION", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A22Rol_Descripcion, "@!"))));
         AV17GXLvl6 = (byte)(1) ;
         Form.setCaption( A22Rol_Descripcion );
         httpContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.getCaption(), true);
         lblViewall_Link = formatLink("com.orions2.wwseg_rolypantalla")  ;
   ...
   public void S112( )
   {
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "SEG_ROLYPANTALLAGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.orions2.seg_rolypantallageneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "SEG_ROLYPANTALLAGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0029","",new Long(AV13Rol_Id)});
      ...
      if ( AV12LoadAllTabs || ( GXutil.strcmp(AV8SelectedTabCode, "Pant") == 0 ) )
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Pantwc_Component), GXutil.lower( "SEG_ROLYPANTALLAPantWC")) != 0 )
         {
            WebComp_Pantwc = WebUtils.getWebComponent(getClass(), "com.orions2.seg_rolypantallapantwc_impl", remoteHandle, context);
            WebComp_Pantwc_Component = "SEG_ROLYPANTALLAPantWC" ;
         }
         if ( GXutil.len( WebComp_Pantwc_Component) != 0 )
         {
            WebComp_Pantwc.setjustcreated();
            WebComp_Pantwc.componentprepare(new Object[] {"W0037","",new Long(AV13Rol_Id)});
            WebComp_Pantwc.componentbind(new Object[] {""});
         }
         if ( isFullAjaxMode( ) )
         {
            httpContext.ajax_rspStartCmp("gxHTMLWrpW0037"+"");
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Seg_usuario_rolwc_Component), GXutil.lower( "SEG_ROLYPANTALLASEG_USUARIO_ROLWC")) != 0 )
         {
            WebComp_Seg_usuario_rolwc = WebUtils.getWebComponent(getClass(), "com.orions2.seg_rolypantallaseg_usuario_rolwc_impl", remoteHandle, context);
            WebComp_Seg_usuario_rolwc_Component = "SEG_ROLYPANTALLASEG_USUARIO_ROLWC" ;
         }
         if ( GXutil.len( WebComp_Seg_usuario_rolwc_Component) != 0 )
         {
            WebComp_Seg_usuario_rolwc.setjustcreated();
            WebComp_Seg_usuario_rolwc.componentprepare(new Object[] {"W0045","",new Long(AV13Rol_Id)});
   ...
   public void define_styles( )
   {
      ...
      if ( ! ( WebComp_Pantwc == null ) )
      {
         if ( GXutil.len( WebComp_Pantwc_Component) != 0 )
         {
            WebComp_Pantwc.componentthemes();
         }
      }
      if ( ! ( WebComp_Seg_usuario_rolwc == null ) )
      {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414192250");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("viewseg_rolypantalla.js", "?201861414192250");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "");
   ...
   public void init_default_properties( )
   {
      ...
      lblPant_title_Internalname = "PANT_TITLE" ;
      divTablepant_Internalname = "TABLEPANT" ;
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "View SEG_ROLYPANTALLA" );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   public void initialize( )
   {
      ...
      OldGeneralwc = "" ;
      lblPant_title_Jsonclick = "" ;
      WebComp_Pantwc_Component = "" ;
      OldPantwc = "" ;
      ...
      AV16Pgmname = "" ;
      scmdbuf = "" ;
      H003D2_A21Rol_Id = new long[1] ;
      H003D2_A22Rol_Descripcion = new String[] {""} ;
      hsh = "" ;
      H003D3_A21Rol_Id = new long[1] ;
      H003D3_A22Rol_Descripcion = new String[] {""} ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.viewseg_rolypantalla__default(),
         new Object[] {
             new Object[] {
            H003D2_A21Rol_Id, H003D2_A22Rol_Descripcion
            }
            , new Object[] {
            H003D3_A21Rol_Id, H003D3_A22Rol_Descripcion
            }
         }
      );
      AV16Pgmname = "ViewSEG_ROLYPANTALLA" ;
      ...
      WebComp_Pantwc = new com.genexus.webpanels.GXWebComponentNull(remoteHandle, context);
   ...
   private String lblPant_title_Internalname ;
   private String lblPant_title_Jsonclick ;
   private String divTablepant_Internalname ;
   private String WebComp_Pantwc_Component ;
   private String OldPantwc ;
   ...
   private GXWebComponent WebComp_Pantwc ;
   private GXWebComponent WebComp_Seg_usuario_rolwc ;
   private IDataStoreProvider pr_default ;
   private long[] H003D2_A21Rol_Id ;
   private String[] H003D2_A22Rol_Descripcion ;
   private long[] H003D3_A21Rol_Id ;
   private String[] H003D3_A22Rol_Descripcion ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class viewseg_rolypantalla__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H003D2", "SELECT Rol_Id, Rol_Descripcion FROM SEG_ROL WHERE Rol_Id = ? ORDER BY Rol_Id ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H003D3", "SELECT Rol_Id, Rol_Descripcion FROM SEG_ROL WHERE Rol_Id = ? ORDER BY Rol_Id ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
