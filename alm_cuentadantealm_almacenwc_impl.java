/*
               File: alm_cuentadantealm_almacenwc_impl
...
public final  class alm_cuentadantealm_almacenwc_impl extends GXWebComponent
{
   public alm_cuentadantealm_almacenwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public alm_cuentadantealm_almacenwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( alm_cuentadantealm_almacenwc_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "ALM_CUENTADANTEALM_ALMACENWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414113473");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.alm_cuentadantealm_almacenwc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Alma_IdResponsable,18,0)))+"\">") ;
   ...
   public void renderHtmlCloseForm1C2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("alm_cuentadantealm_almacenwc.js", "?201861414113477");
      }
   ...
   public void wb1C0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.alm_cuentadantealm_almacenwc");
         }
         /* Div Control */
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_ALM_CUENTADANTEALM_ALMACENWC.htm");
   ...
   public void start1C2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "ALM_CUENTADANTEALM_ALMACENWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "ALM_CUENTADANTEALM_ALMACENWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf1C2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A30Alma_IdResponsable = H001C2_A30Alma_IdResponsable[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A30Alma_IdResponsable", GXutil.ltrim( GXutil.str( A30Alma_IdResponsable, 18, 0)));
            A673Alma_Estado = H001C2_A673Alma_Estado[0] ;
            n673Alma_Estado = H001C2_n673Alma_Estado[0] ;
            A258Alma_UsuarioModifica = H001C2_A258Alma_UsuarioModifica[0] ;
            n258Alma_UsuarioModifica = H001C2_n258Alma_UsuarioModifica[0] ;
            A257Alma_FechaModifica = H001C2_A257Alma_FechaModifica[0] ;
            n257Alma_FechaModifica = H001C2_n257Alma_FechaModifica[0] ;
            A256Alma_UsuarioCrea = H001C2_A256Alma_UsuarioCrea[0] ;
            n256Alma_UsuarioCrea = H001C2_n256Alma_UsuarioCrea[0] ;
            A255Alma_FechaCrea = H001C2_A255Alma_FechaCrea[0] ;
            n255Alma_FechaCrea = H001C2_n255Alma_FechaCrea[0] ;
            A264Alma_CuentaCredito = H001C2_A264Alma_CuentaCredito[0] ;
            n264Alma_CuentaCredito = H001C2_n264Alma_CuentaCredito[0] ;
            A263Alma_CuentaDebito = H001C2_A263Alma_CuentaDebito[0] ;
            n263Alma_CuentaDebito = H001C2_n263Alma_CuentaDebito[0] ;
            A262Alma_Fax = H001C2_A262Alma_Fax[0] ;
            n262Alma_Fax = H001C2_n262Alma_Fax[0] ;
            A261Alma_Telefono2 = H001C2_A261Alma_Telefono2[0] ;
            n261Alma_Telefono2 = H001C2_n261Alma_Telefono2[0] ;
            A260Alma_Telefono1 = H001C2_A260Alma_Telefono1[0] ;
            n260Alma_Telefono1 = H001C2_n260Alma_Telefono1[0] ;
            A259Alma_Direccion = H001C2_A259Alma_Direccion[0] ;
            n259Alma_Direccion = H001C2_n259Alma_Direccion[0] ;
            A307Tpal_Descripcion = H001C2_A307Tpal_Descripcion[0] ;
            A29Tpal_Id = H001C2_A29Tpal_Id[0] ;
            A252Alma_Descripcion = H001C2_A252Alma_Descripcion[0] ;
            A28Alma_Codigo = H001C2_A28Alma_Codigo[0] ;
            A27Alma_Modulo = H001C2_A27Alma_Modulo[0] ;
            A4Cent_Descripcion = H001C2_A4Cent_Descripcion[0] ;
            A3Cent_Codigo = H001C2_A3Cent_Codigo[0] ;
            A1Cent_Id = H001C2_A1Cent_Id[0] ;
            A307Tpal_Descripcion = H001C2_A307Tpal_Descripcion[0] ;
            A4Cent_Descripcion = H001C2_A4Cent_Descripcion[0] ;
            A3Cent_Codigo = H001C2_A3Cent_Codigo[0] ;
            e131C2 ();
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "alm_cuentadantealm_almacenwc");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414113548");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("alm_cuentadantealm_almacenwc.js", "?201861414113548");
      }
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H001C2_A30Alma_IdResponsable = new long[1] ;
      H001C2_A673Alma_Estado = new String[] {""} ;
      H001C2_n673Alma_Estado = new boolean[] {false} ;
      H001C2_A258Alma_UsuarioModifica = new String[] {""} ;
      H001C2_n258Alma_UsuarioModifica = new boolean[] {false} ;
      H001C2_A257Alma_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H001C2_n257Alma_FechaModifica = new boolean[] {false} ;
      H001C2_A256Alma_UsuarioCrea = new String[] {""} ;
      H001C2_n256Alma_UsuarioCrea = new boolean[] {false} ;
      H001C2_A255Alma_FechaCrea = new java.util.Date[] {GXutil.nullDate()} ;
      H001C2_n255Alma_FechaCrea = new boolean[] {false} ;
      H001C2_A264Alma_CuentaCredito = new String[] {""} ;
      H001C2_n264Alma_CuentaCredito = new boolean[] {false} ;
      H001C2_A263Alma_CuentaDebito = new String[] {""} ;
      H001C2_n263Alma_CuentaDebito = new boolean[] {false} ;
      H001C2_A262Alma_Fax = new long[1] ;
      H001C2_n262Alma_Fax = new boolean[] {false} ;
      H001C2_A261Alma_Telefono2 = new long[1] ;
      H001C2_n261Alma_Telefono2 = new boolean[] {false} ;
      H001C2_A260Alma_Telefono1 = new long[1] ;
      H001C2_n260Alma_Telefono1 = new boolean[] {false} ;
      H001C2_A259Alma_Direccion = new String[] {""} ;
      H001C2_n259Alma_Direccion = new boolean[] {false} ;
      H001C2_A307Tpal_Descripcion = new String[] {""} ;
      H001C2_A29Tpal_Id = new long[1] ;
      H001C2_A252Alma_Descripcion = new String[] {""} ;
      H001C2_A28Alma_Codigo = new String[] {""} ;
      H001C2_A27Alma_Modulo = new String[] {""} ;
      H001C2_A4Cent_Descripcion = new String[] {""} ;
      H001C2_A3Cent_Codigo = new String[] {""} ;
      H001C2_A1Cent_Id = new long[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.alm_cuentadantealm_almacenwc__default(),
         new Object[] {
             new Object[] {
            H001C2_A30Alma_IdResponsable, H001C2_A673Alma_Estado, H001C2_n673Alma_Estado, H001C2_A258Alma_UsuarioModifica, H001C2_n258Alma_UsuarioModifica, H001C2_A257Alma_FechaModifica, H001C2_n257Alma_FechaModifica, H001C2_A256Alma_UsuarioCrea, H001C2_n256Alma_UsuarioCrea, H001C2_A255Alma_FechaCrea,
            H001C2_n255Alma_FechaCrea, H001C2_A264Alma_CuentaCredito, H001C2_n264Alma_CuentaCredito, H001C2_A263Alma_CuentaDebito, H001C2_n263Alma_CuentaDebito, H001C2_A262Alma_Fax, H001C2_n262Alma_Fax, H001C2_A261Alma_Telefono2, H001C2_n261Alma_Telefono2, H001C2_A260Alma_Telefono1,
            H001C2_n260Alma_Telefono1, H001C2_A259Alma_Direccion, H001C2_n259Alma_Direccion, H001C2_A307Tpal_Descripcion, H001C2_A29Tpal_Id, H001C2_A252Alma_Descripcion, H001C2_A28Alma_Codigo, H001C2_A27Alma_Modulo, H001C2_A4Cent_Descripcion, H001C2_A3Cent_Codigo,
            H001C2_A1Cent_Id
            }
            , new Object[] {
   ...
   private long[] H001C2_A30Alma_IdResponsable ;
   private String[] H001C2_A673Alma_Estado ;
   private boolean[] H001C2_n673Alma_Estado ;
   private String[] H001C2_A258Alma_UsuarioModifica ;
   private boolean[] H001C2_n258Alma_UsuarioModifica ;
   private java.util.Date[] H001C2_A257Alma_FechaModifica ;
   private boolean[] H001C2_n257Alma_FechaModifica ;
   private String[] H001C2_A256Alma_UsuarioCrea ;
   private boolean[] H001C2_n256Alma_UsuarioCrea ;
   private java.util.Date[] H001C2_A255Alma_FechaCrea ;
   private boolean[] H001C2_n255Alma_FechaCrea ;
   private String[] H001C2_A264Alma_CuentaCredito ;
   private boolean[] H001C2_n264Alma_CuentaCredito ;
   private String[] H001C2_A263Alma_CuentaDebito ;
   private boolean[] H001C2_n263Alma_CuentaDebito ;
   private long[] H001C2_A262Alma_Fax ;
   private boolean[] H001C2_n262Alma_Fax ;
   private long[] H001C2_A261Alma_Telefono2 ;
   private boolean[] H001C2_n261Alma_Telefono2 ;
   private long[] H001C2_A260Alma_Telefono1 ;
   private boolean[] H001C2_n260Alma_Telefono1 ;
   private String[] H001C2_A259Alma_Direccion ;
   private boolean[] H001C2_n259Alma_Direccion ;
   private String[] H001C2_A307Tpal_Descripcion ;
   private long[] H001C2_A29Tpal_Id ;
   private String[] H001C2_A252Alma_Descripcion ;
   private String[] H001C2_A28Alma_Codigo ;
   private String[] H001C2_A27Alma_Modulo ;
   private String[] H001C2_A4Cent_Descripcion ;
   private String[] H001C2_A3Cent_Codigo ;
   private long[] H001C2_A1Cent_Id ;
