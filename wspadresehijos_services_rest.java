/*
               File: wspadresehijos_services_rest
        Description: WSPadrese Hijos
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:10:57.43
...
@Path("/WSPadreseHijos")
public final  class wspadresehijos_services_rest extends GxRestService
{
   @Context
   ...
   public Response execute( com.orions2.wspadresehijos_RESTInterfaceIN entity )
   {
      ...
      if ( ! processHeaders("wspadresehijos",myServletRequest,myServletResponse) )
      {
      ...
      try
      {
         com.orions2.wspadresehijos worker = new com.orions2.wspadresehijos(remoteHandle, context) ;
         worker.execute(AV8Tran_Id );
         com.orions2.wspadresehijos_RESTInterfaceOUT data = new com.orions2.wspadresehijos_RESTInterfaceOUT();
