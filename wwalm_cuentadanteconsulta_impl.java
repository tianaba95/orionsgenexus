/*
               File: wwalm_cuentadanteconsulta_impl
        Description: WWALM_CUENTADANTECONSULTA
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:23:15.74
...
public final  class wwalm_cuentadanteconsulta_impl extends GXDataArea
{
   public wwalm_cuentadanteconsulta_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wwalm_cuentadanteconsulta_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wwalm_cuentadanteconsulta_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            nRC_GXsfl_57 = (short)(GXutil.lval( httpContext.GetNextPar( ))) ;
            nGXsfl_57_idx = (short)(GXutil.lval( httpContext.GetNextPar( ))) ;
            sGXsfl_57_idx = httpContext.GetNextPar( ) ;
            AV18Update = httpContext.GetNextPar( ) ;
            edtavUpdate_Tooltiptext = httpContext.GetNextPar( ) ;
            httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Tooltiptext", edtavUpdate_Tooltiptext, !bGXsfl_57_Refreshing);
            httpContext.setAjaxCallMode();
            if ( ! httpContext.IsValidAjaxCall( true) )
            {
               GxWebError = (byte)(1) ;
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
         {
            ...
            gxgrgrid_refresh( subGrid_Rows, AV14Cuen_Cedula, AV15Cuen_Nombre, AV16Regi_Descripcion, AV17Cuen_Estado, AV18Update, AV19ADVANCED_LABEL_TEMPLATE, AV22Pgmname, A42Tpte_Codigo, A43Cuen_Identificacion) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414231586");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.wwalm_cuentadanteconsulta") +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      /* Send saved values. */
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "nRC_GXsfl_57", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_57, (byte)(4), (byte)(0), ",", "")));
   ...
   {
      return formatLink("com.orions2.wwalm_cuentadanteconsulta")  ;
   }

   public String getPgmname( )
   {
      return "WWALM_CUENTADANTECONSULTA" ;
   }
   ...
   public void wb820( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 57, 2, 0)+","+"null"+");", bttBtntoggle_Caption, bttBtntoggle_Jsonclick, 7, "Otros Filtros", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e11821_client"+"'", TempTags, "", 2, "HLP_WWALM_CUENTADANTECONSULTA.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-6 col-sm-2", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblTitletext_Internalname, "Lista Cuentadantes", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_WWALM_CUENTADANTECONSULTA.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblcuen_nombrefilter_Internalname, lblLblcuen_nombrefilter_Caption, "", "", lblLblcuen_nombrefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e12821_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WWALM_CUENTADANTECONSULTA.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavCuen_nombre_Internalname, AV15Cuen_Nombre, GXutil.rtrim( localUtil.format( AV15Cuen_Nombre, "@!")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,29);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCuen_nombre_Jsonclick, 0, "FilterComboAttribute", "", "", "", edtavCuen_nombre_Visible, edtavCuen_nombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_WWALM_CUENTADANTECONSULTA.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblregi_descripcionfilter_Internalname, lblLblregi_descripcionfilter_Caption, "", "", lblLblregi_descripcionfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e13821_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WWALM_CUENTADANTECONSULTA.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtavRegi_descripcion_Internalname, AV16Regi_Descripcion, GXutil.rtrim( localUtil.format( AV16Regi_Descripcion, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavRegi_descripcion_Jsonclick, 0, "FilterComboAttribute", "", "", "", edtavRegi_descripcion_Visible, edtavRegi_descripcion_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", true, "HLP_WWALM_CUENTADANTECONSULTA.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.orions2.GxWebStd.gx_label_ctrl( httpContext, lblLblcuen_estadofilter_Internalname, lblLblcuen_estadofilter_Caption, "", "", lblLblcuen_estadofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e14821_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_WWALM_CUENTADANTECONSULTA.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.orions2.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 49,'',false,'" + sGXsfl_57_idx + "',0)\"" ;
         /* ComboBox */
         com.orions2.GxWebStd.gx_combobox_ctrl1( httpContext, cmbavCuen_estado, cmbavCuen_estado.getInternalname(), GXutil.rtrim( AV17Cuen_Estado), 1, cmbavCuen_estado.getJsonclick(), 0, "'"+""+"'"+",false,"+"'"+""+"'", "char", "", cmbavCuen_estado.getVisible(), cmbavCuen_estado.getEnabled(), 0, (short)(0), 0, "em", 0, "", "", "FilterComboAttribute", "", TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,49);\"", "", true, "HLP_WWALM_CUENTADANTECONSULTA.htm");
         ...
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            httpContext.writeValue( "No, Axiliar") ;
   ...
   public void start822( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "WWALM_CUENTADANTECONSULTA", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
               ...
               if ( GXutil.strcmp(sEvtType, "M") != 0 )
               {
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        {
                           nGXsfl_57_idx = (short)(GXutil.lval( sEvtType)) ;
                           sGXsfl_57_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_57_idx, 4, 0)), (short)(4), "0") ;
                           ...
                           httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Bitmap", ((GXutil.strcmp("", AV18Update)==0) ? AV23Update_GXI : httpContext.convertURL( httpContext.getResourceRelative(AV18Update))), !bGXsfl_57_Refreshing);
   ...
   public void pa822( )
   {
      if ( nDonePA == 0 )
      {
         ...
         GXCCtl = "CUEN_ESTADO_" + sGXsfl_57_idx ;
   ...
   {
      /* GeneXus formulas. */
      AV22Pgmname = "WWALM_CUENTADANTECONSULTA" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf822( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV17Cuen_Estado = GXutil.padr( GXutil.rtrim( AV17Cuen_Estado), 1, "%") ;
         httpContext.ajax_rsp_assign_attri("", false, "AV17Cuen_Estado", AV17Cuen_Estado);
         /* Using cursor H00822 */
         pr_default.execute(0, new Object[] {new Long(AV14Cuen_Cedula), lV17Cuen_Estado});
         nGXsfl_57_idx = (short)(1) ;
         sGXsfl_57_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_57_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_572( ) ;
         GRID_nEOF = (byte)(0) ;
         ...
         {
            A340Cuen_FechaModifica = H00822_A340Cuen_FechaModifica[0] ;
            n340Cuen_FechaModifica = H00822_n340Cuen_FechaModifica[0] ;
            A339Cuen_UsuarioModifica = H00822_A339Cuen_UsuarioModifica[0] ;
            n339Cuen_UsuarioModifica = H00822_n339Cuen_UsuarioModifica[0] ;
            A338Cuen_FechaCrea = H00822_A338Cuen_FechaCrea[0] ;
            A337Cuen_UsuarioCrea = H00822_A337Cuen_UsuarioCrea[0] ;
            A12Regi_Cod = H00822_A12Regi_Cod[0] ;
            A2Regi_Id = H00822_A2Regi_Id[0] ;
            A4Cent_Descripcion = H00822_A4Cent_Descripcion[0] ;
            A3Cent_Codigo = H00822_A3Cent_Codigo[0] ;
            A1Cent_Id = H00822_A1Cent_Id[0] ;
            A10Dept_Descripcion = H00822_A10Dept_Descripcion[0] ;
            A6Dept_Codigo = H00822_A6Dept_Codigo[0] ;
            A7Ciud_Descripcion = H00822_A7Ciud_Descripcion[0] ;
            A5Ciud_Codigo = H00822_A5Ciud_Codigo[0] ;
            A328Cuen_Clase = H00822_A328Cuen_Clase[0] ;
            n328Cuen_Clase = H00822_n328Cuen_Clase[0] ;
            A333Cuen_Estado = H00822_A333Cuen_Estado[0] ;
            n333Cuen_Estado = H00822_n333Cuen_Estado[0] ;
            A13Regi_Descripcion = H00822_A13Regi_Descripcion[0] ;
            A321Tpte_Descripcion = H00822_A321Tpte_Descripcion[0] ;
            A42Tpte_Codigo = H00822_A42Tpte_Codigo[0] ;
            A336Cuen_Email = H00822_A336Cuen_Email[0] ;
            n336Cuen_Email = H00822_n336Cuen_Email[0] ;
            A335Cuen_Telefono = H00822_A335Cuen_Telefono[0] ;
            n335Cuen_Telefono = H00822_n335Cuen_Telefono[0] ;
            A334Cuen_Direccion = H00822_A334Cuen_Direccion[0] ;
            n334Cuen_Direccion = H00822_n334Cuen_Direccion[0] ;
            A44Cuen_Nombre = H00822_A44Cuen_Nombre[0] ;
            n44Cuen_Nombre = H00822_n44Cuen_Nombre[0] ;
            A330Cuen_SegundoApellido = H00822_A330Cuen_SegundoApellido[0] ;
            n330Cuen_SegundoApellido = H00822_n330Cuen_SegundoApellido[0] ;
            A329Cuen_PrimerApellido = H00822_A329Cuen_PrimerApellido[0] ;
            n329Cuen_PrimerApellido = H00822_n329Cuen_PrimerApellido[0] ;
            A332Cuen_SegundoNombre = H00822_A332Cuen_SegundoNombre[0] ;
            n332Cuen_SegundoNombre = H00822_n332Cuen_SegundoNombre[0] ;
            A331Cuen_PrimerNombre = H00822_A331Cuen_PrimerNombre[0] ;
            n331Cuen_PrimerNombre = H00822_n331Cuen_PrimerNombre[0] ;
            A326Cuen_DigitoVerificacion = H00822_A326Cuen_DigitoVerificacion[0] ;
            n326Cuen_DigitoVerificacion = H00822_n326Cuen_DigitoVerificacion[0] ;
            A688Cuen_Cedula = H00822_A688Cuen_Cedula[0] ;
            A43Cuen_Identificacion = H00822_A43Cuen_Identificacion[0] ;
            A12Regi_Cod = H00822_A12Regi_Cod[0] ;
            A5Ciud_Codigo = H00822_A5Ciud_Codigo[0] ;
            A13Regi_Descripcion = H00822_A13Regi_Descripcion[0] ;
            A6Dept_Codigo = H00822_A6Dept_Codigo[0] ;
   ...
   public void strup820( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         httpContext.ajax_rsp_assign_attri("", false, "AV17Cuen_Estado", AV17Cuen_Estado);
         /* Read saved values. */
         nRC_GXsfl_57 = (short)(localUtil.ctol( httpContext.cgiGet( "nRC_GXsfl_57"), ",", ".")) ;
   ...
   public void e15822( )
   {
      ...
      subGrid_Rows = 10 ;
      com.orions2.GxWebStd.gx_hidden_field( httpContext, "GRID_Rows", GXutil.ltrim( localUtil.ntoc( subGrid_Rows, (byte)(6), (byte)(0), ".", "")));
      AV18Update = context.getHttpContext().getImagePath( "f11923b6-6acd-4a79-bfc0-0cfc6f3bced5", "", context.getHttpContext().getTheme( )) ;
      httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Bitmap", ((GXutil.strcmp("", AV18Update)==0) ? AV23Update_GXI : httpContext.convertURL( httpContext.getResourceRelative(AV18Update))), !bGXsfl_57_Refreshing);
      httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( AV18Update), true);
      AV23Update_GXI = GXDbFile.pathToUrl( context.getHttpContext().getImagePath( "f11923b6-6acd-4a79-bfc0-0cfc6f3bced5", "", context.getHttpContext().getTheme( )), context.getHttpContext()) ;
      httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Bitmap", ((GXutil.strcmp("", AV18Update)==0) ? AV23Update_GXI : httpContext.convertURL( httpContext.getResourceRelative(AV18Update))), !bGXsfl_57_Refreshing);
      httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "SrcSet", context.getHttpContext().getImageSrcSet( AV18Update), true);
      edtavUpdate_Tooltiptext = "Consulta" ;
      httpContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Tooltiptext", edtavUpdate_Tooltiptext, !bGXsfl_57_Refreshing);
      AV17Cuen_Estado = "" ;
      httpContext.ajax_rsp_assign_attri("", false, "AV17Cuen_Estado", AV17Cuen_Estado);
      Form.setCaption( "Lista Cuentadantes" );
   ...
   public void e16822( )
   {
      ...
      {
         lblLblcuen_nombrefilter_Caption = "Cuentadante" ;
         httpContext.ajax_rsp_assign_prop("", false, lblLblcuen_nombrefilter_Internalname, "Caption", lblLblcuen_nombrefilter_Caption, true);
      }
      else
      {
         lblLblcuen_nombrefilter_Caption = GXutil.format( AV19ADVANCED_LABEL_TEMPLATE, "Cuentadante", AV15Cuen_Nombre, "", "", "", "", "", "", "") ;
         httpContext.ajax_rsp_assign_prop("", false, lblLblcuen_nombrefilter_Internalname, "Caption", lblLblcuen_nombrefilter_Caption, true);
      }
   ...
   {
      /* Grid_Load Routine */
      if ( GXutil.strcmp(A42Tpte_Codigo, "MU") == 0 )
      {
         edtavUpdate_Link = formatLink("com.orions2.alm_cuentadante_multi") + "?" + GXutil.URLEncode(GXutil.rtrim("DSP")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A43Cuen_Identificacion,18,0))) ;
      }
      if ( GXutil.strcmp(A42Tpte_Codigo, "MU") != 0 )
      {
         edtavUpdate_Link = formatLink("com.orions2.alm_cuentadante") + "?" + GXutil.URLEncode(GXutil.rtrim("DSP")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A43Cuen_Identificacion,18,0))) ;
      }
      /* Load Method */
      if ( wbStart != -1 )
      {
   ...
   public void S112( )
   {
      ...
      AV12TrnContext.setgxTv_SdtTransactionContext_Transactionname( "ALM_CUENTADANTE" );
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414231772");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("wwalm_cuentadanteconsulta.js", "?201861414231772");
      /* End function include_jscripts */
   }

   public void subsflControlProps_572( )
   {
      edtCuen_Identificacion_Internalname = "CUEN_IDENTIFICACION_"+sGXsfl_57_idx ;
      edtCuen_Cedula_Internalname = "CUEN_CEDULA_"+sGXsfl_57_idx ;
      edtCuen_DigitoVerificacion_Internalname = "CUEN_DIGITOVERIFICACION_"+sGXsfl_57_idx ;
      edtCuen_PrimerNombre_Internalname = "CUEN_PRIMERNOMBRE_"+sGXsfl_57_idx ;
      edtCuen_SegundoNombre_Internalname = "CUEN_SEGUNDONOMBRE_"+sGXsfl_57_idx ;
      edtCuen_PrimerApellido_Internalname = "CUEN_PRIMERAPELLIDO_"+sGXsfl_57_idx ;
      edtCuen_SegundoApellido_Internalname = "CUEN_SEGUNDOAPELLIDO_"+sGXsfl_57_idx ;
      edtCuen_Nombre_Internalname = "CUEN_NOMBRE_"+sGXsfl_57_idx ;
      edtCuen_Direccion_Internalname = "CUEN_DIRECCION_"+sGXsfl_57_idx ;
      edtCuen_Telefono_Internalname = "CUEN_TELEFONO_"+sGXsfl_57_idx ;
      edtCuen_Email_Internalname = "CUEN_EMAIL_"+sGXsfl_57_idx ;
      edtTpte_Codigo_Internalname = "TPTE_CODIGO_"+sGXsfl_57_idx ;
      edtTpte_Descripcion_Internalname = "TPTE_DESCRIPCION_"+sGXsfl_57_idx ;
      edtRegi_Descripcion_Internalname = "REGI_DESCRIPCION_"+sGXsfl_57_idx ;
      cmbCuen_Estado.setInternalname( "CUEN_ESTADO_"+sGXsfl_57_idx );
      edtCuen_Clase_Internalname = "CUEN_CLASE_"+sGXsfl_57_idx ;
      edtCiud_Codigo_Internalname = "CIUD_CODIGO_"+sGXsfl_57_idx ;
      edtCiud_Descripcion_Internalname = "CIUD_DESCRIPCION_"+sGXsfl_57_idx ;
      edtDept_Codigo_Internalname = "DEPT_CODIGO_"+sGXsfl_57_idx ;
      edtDept_Descripcion_Internalname = "DEPT_DESCRIPCION_"+sGXsfl_57_idx ;
      edtCent_Id_Internalname = "CENT_ID_"+sGXsfl_57_idx ;
      edtCent_Codigo_Internalname = "CENT_CODIGO_"+sGXsfl_57_idx ;
      edtCent_Descripcion_Internalname = "CENT_DESCRIPCION_"+sGXsfl_57_idx ;
      edtRegi_Id_Internalname = "REGI_ID_"+sGXsfl_57_idx ;
      edtRegi_Cod_Internalname = "REGI_COD_"+sGXsfl_57_idx ;
      edtCuen_UsuarioCrea_Internalname = "CUEN_USUARIOCREA_"+sGXsfl_57_idx ;
      edtCuen_FechaCrea_Internalname = "CUEN_FECHACREA_"+sGXsfl_57_idx ;
      edtCuen_UsuarioModifica_Internalname = "CUEN_USUARIOMODIFICA_"+sGXsfl_57_idx ;
      edtCuen_FechaModifica_Internalname = "CUEN_FECHAMODIFICA_"+sGXsfl_57_idx ;
      edtavUpdate_Internalname = "vUPDATE_"+sGXsfl_57_idx ;
   }

   public void subsflControlProps_fel_572( )
   {
      edtCuen_Identificacion_Internalname = "CUEN_IDENTIFICACION_"+sGXsfl_57_fel_idx ;
      edtCuen_Cedula_Internalname = "CUEN_CEDULA_"+sGXsfl_57_fel_idx ;
      edtCuen_DigitoVerificacion_Internalname = "CUEN_DIGITOVERIFICACION_"+sGXsfl_57_fel_idx ;
      edtCuen_PrimerNombre_Internalname = "CUEN_PRIMERNOMBRE_"+sGXsfl_57_fel_idx ;
      edtCuen_SegundoNombre_Internalname = "CUEN_SEGUNDONOMBRE_"+sGXsfl_57_fel_idx ;
      edtCuen_PrimerApellido_Internalname = "CUEN_PRIMERAPELLIDO_"+sGXsfl_57_fel_idx ;
      edtCuen_SegundoApellido_Internalname = "CUEN_SEGUNDOAPELLIDO_"+sGXsfl_57_fel_idx ;
      edtCuen_Nombre_Internalname = "CUEN_NOMBRE_"+sGXsfl_57_fel_idx ;
      edtCuen_Direccion_Internalname = "CUEN_DIRECCION_"+sGXsfl_57_fel_idx ;
      edtCuen_Telefono_Internalname = "CUEN_TELEFONO_"+sGXsfl_57_fel_idx ;
      edtCuen_Email_Internalname = "CUEN_EMAIL_"+sGXsfl_57_fel_idx ;
      edtTpte_Codigo_Internalname = "TPTE_CODIGO_"+sGXsfl_57_fel_idx ;
      edtTpte_Descripcion_Internalname = "TPTE_DESCRIPCION_"+sGXsfl_57_fel_idx ;
      edtRegi_Descripcion_Internalname = "REGI_DESCRIPCION_"+sGXsfl_57_fel_idx ;
      cmbCuen_Estado.setInternalname( "CUEN_ESTADO_"+sGXsfl_57_fel_idx );
      edtCuen_Clase_Internalname = "CUEN_CLASE_"+sGXsfl_57_fel_idx ;
      edtCiud_Codigo_Internalname = "CIUD_CODIGO_"+sGXsfl_57_fel_idx ;
      edtCiud_Descripcion_Internalname = "CIUD_DESCRIPCION_"+sGXsfl_57_fel_idx ;
      edtDept_Codigo_Internalname = "DEPT_CODIGO_"+sGXsfl_57_fel_idx ;
      edtDept_Descripcion_Internalname = "DEPT_DESCRIPCION_"+sGXsfl_57_fel_idx ;
      edtCent_Id_Internalname = "CENT_ID_"+sGXsfl_57_fel_idx ;
      edtCent_Codigo_Internalname = "CENT_CODIGO_"+sGXsfl_57_fel_idx ;
      edtCent_Descripcion_Internalname = "CENT_DESCRIPCION_"+sGXsfl_57_fel_idx ;
      edtRegi_Id_Internalname = "REGI_ID_"+sGXsfl_57_fel_idx ;
      edtRegi_Cod_Internalname = "REGI_COD_"+sGXsfl_57_fel_idx ;
      edtCuen_UsuarioCrea_Internalname = "CUEN_USUARIOCREA_"+sGXsfl_57_fel_idx ;
      edtCuen_FechaCrea_Internalname = "CUEN_FECHACREA_"+sGXsfl_57_fel_idx ;
      edtCuen_UsuarioModifica_Internalname = "CUEN_USUARIOMODIFICA_"+sGXsfl_57_fel_idx ;
      edtCuen_FechaModifica_Internalname = "CUEN_FECHAMODIFICA_"+sGXsfl_57_fel_idx ;
   ...
   public void sendrow_572( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_57_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCuen_DigitoVerificacion_Internalname,GXutil.ltrim( localUtil.ntoc( A326Cuen_DigitoVerificacion, (byte)(1), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A326Cuen_DigitoVerificacion), "9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCuen_DigitoVerificacion_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(1),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCuen_PrimerNombre_Internalname,A331Cuen_PrimerNombre,GXutil.rtrim( localUtil.format( A331Cuen_PrimerNombre, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCuen_PrimerNombre_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCuen_SegundoNombre_Internalname,A332Cuen_SegundoNombre,GXutil.rtrim( localUtil.format( A332Cuen_SegundoNombre, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCuen_SegundoNombre_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCuen_PrimerApellido_Internalname,A329Cuen_PrimerApellido,GXutil.rtrim( localUtil.format( A329Cuen_PrimerApellido, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCuen_PrimerApellido_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCuen_SegundoApellido_Internalname,A330Cuen_SegundoApellido,GXutil.rtrim( localUtil.format( A330Cuen_SegundoApellido, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCuen_SegundoApellido_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCuen_Nombre_Internalname,A44Cuen_Nombre,GXutil.rtrim( localUtil.format( A44Cuen_Nombre, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCuen_Nombre_Jsonclick,new Integer(0),"DescriptionAttribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(100),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Nombres","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCuen_Direccion_Internalname,A334Cuen_Direccion,"","","'"+""+"'"+",false,"+"'"+""+"'","http://maps.google.com/maps?q="+PrivateUtilities.encodeURL( A334Cuen_Direccion),"_blank","","",edtCuen_Direccion_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(1024),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"GeneXus\\Address","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCuen_Telefono_Internalname,A335Cuen_Telefono,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCuen_Telefono_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(15),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCuen_Email_Internalname,A336Cuen_Email,"","","'"+""+"'"+",false,"+"'"+""+"'","mailto:"+A336Cuen_Email,"","","",edtCuen_Email_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"email","",new Integer(0),"px",new Integer(17),"px",new Integer(100),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"GeneXus\\Email","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTpte_Codigo_Internalname,GXutil.rtrim( A42Tpte_Codigo),GXutil.rtrim( localUtil.format( A42Tpte_Codigo, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTpte_Codigo_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(2),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtTpte_Descripcion_Internalname,A321Tpte_Descripcion,GXutil.rtrim( localUtil.format( A321Tpte_Descripcion, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtTpte_Descripcion_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(100),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Nombres","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRegi_Descripcion_Internalname,A13Regi_Descripcion,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtRegi_Descripcion_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
         ...
         httpContext.ajax_rsp_assign_prop("", false, cmbCuen_Estado.getInternalname(), "Values", cmbCuen_Estado.ToJavascriptSource(), !bGXsfl_57_Refreshing);
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCuen_Clase_Internalname,A328Cuen_Clase,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCuen_Clase_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(1),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCiud_Codigo_Internalname,GXutil.ltrim( localUtil.ntoc( A5Ciud_Codigo, (byte)(4), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A5Ciud_Codigo), "ZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCiud_Codigo_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(4),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtDept_Codigo_Internalname,GXutil.ltrim( localUtil.ntoc( A6Dept_Codigo, (byte)(4), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A6Dept_Codigo), "ZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtDept_Codigo_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(4),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtDept_Descripcion_Internalname,A10Dept_Descripcion,GXutil.rtrim( localUtil.format( A10Dept_Descripcion, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtDept_Descripcion_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCent_Id_Internalname,GXutil.ltrim( localUtil.ntoc( A1Cent_Id, (byte)(11), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A1Cent_Id), "ZZZZZZZZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCent_Id_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(11),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"Identificador","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCent_Codigo_Internalname,A3Cent_Codigo,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCent_Codigo_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(16),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCent_Descripcion_Internalname,A4Cent_Descripcion,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCent_Descripcion_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(50),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Descripcion","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRegi_Id_Internalname,GXutil.ltrim( localUtil.ntoc( A2Regi_Id, (byte)(11), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A2Regi_Id), "ZZZZZZZZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtRegi_Id_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(11),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"Identificador","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRegi_Cod_Internalname,GXutil.ltrim( localUtil.ntoc( A12Regi_Cod, (byte)(4), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A12Regi_Cod), "ZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtRegi_Cod_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(4),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCuen_UsuarioCrea_Internalname,A337Cuen_UsuarioCrea,GXutil.rtrim( localUtil.format( A337Cuen_UsuarioCrea, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCuen_UsuarioCrea_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCuen_FechaCrea_Internalname,localUtil.ttoc( A338Cuen_FechaCrea, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A338Cuen_FechaCrea, "99/99/99 99:99"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCuen_FechaCrea_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCuen_UsuarioModifica_Internalname,A339Cuen_UsuarioModifica,GXutil.rtrim( localUtil.format( A339Cuen_UsuarioModifica, "@!")),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCuen_UsuarioModifica_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(30),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(true),"Usuario","left",new Boolean(true)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtCuen_FechaModifica_Internalname,localUtil.ttoc( A340Cuen_FechaModifica, 10, 8, 0, 3, "/", ":", " "),localUtil.format( A340Cuen_FechaModifica, "99/99/99 99:99"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtCuen_FechaModifica_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn WWOptionalColumn",new Integer(0),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(14),new Integer(0),new Integer(0),new Integer(57),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"FechaHora","right",new Boolean(false)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
         ...
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CUEN_IDENTIFICACION"+"_"+sGXsfl_57_idx, getSecureSignedToken( sGXsfl_57_idx, localUtil.format( DecimalUtil.doubleToDec(A43Cuen_Identificacion), "ZZZZZZZZZZZZZZZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CUEN_CEDULA"+"_"+sGXsfl_57_idx, getSecureSignedToken( sGXsfl_57_idx, localUtil.format( DecimalUtil.doubleToDec(A688Cuen_Cedula), "ZZZZZZZZZZZZZZZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CUEN_DIGITOVERIFICACION"+"_"+sGXsfl_57_idx, getSecureSignedToken( sGXsfl_57_idx, localUtil.format( DecimalUtil.doubleToDec(A326Cuen_DigitoVerificacion), "9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CUEN_PRIMERNOMBRE"+"_"+sGXsfl_57_idx, getSecureSignedToken( sGXsfl_57_idx, GXutil.rtrim( localUtil.format( A331Cuen_PrimerNombre, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CUEN_SEGUNDONOMBRE"+"_"+sGXsfl_57_idx, getSecureSignedToken( sGXsfl_57_idx, GXutil.rtrim( localUtil.format( A332Cuen_SegundoNombre, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CUEN_PRIMERAPELLIDO"+"_"+sGXsfl_57_idx, getSecureSignedToken( sGXsfl_57_idx, GXutil.rtrim( localUtil.format( A329Cuen_PrimerApellido, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CUEN_SEGUNDOAPELLIDO"+"_"+sGXsfl_57_idx, getSecureSignedToken( sGXsfl_57_idx, GXutil.rtrim( localUtil.format( A330Cuen_SegundoApellido, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CUEN_NOMBRE"+"_"+sGXsfl_57_idx, getSecureSignedToken( sGXsfl_57_idx, GXutil.rtrim( localUtil.format( A44Cuen_Nombre, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CUEN_DIRECCION"+"_"+sGXsfl_57_idx, getSecureSignedToken( sGXsfl_57_idx, GXutil.rtrim( localUtil.format( A334Cuen_Direccion, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CUEN_TELEFONO"+"_"+sGXsfl_57_idx, getSecureSignedToken( sGXsfl_57_idx, GXutil.rtrim( localUtil.format( A335Cuen_Telefono, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CUEN_EMAIL"+"_"+sGXsfl_57_idx, getSecureSignedToken( sGXsfl_57_idx, GXutil.rtrim( localUtil.format( A336Cuen_Email, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_TPTE_CODIGO"+"_"+sGXsfl_57_idx, getSecureSignedToken( sGXsfl_57_idx, GXutil.rtrim( localUtil.format( A42Tpte_Codigo, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CUEN_ESTADO"+"_"+sGXsfl_57_idx, getSecureSignedToken( sGXsfl_57_idx, GXutil.rtrim( localUtil.format( A333Cuen_Estado, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CUEN_CLASE"+"_"+sGXsfl_57_idx, getSecureSignedToken( sGXsfl_57_idx, GXutil.rtrim( localUtil.format( A328Cuen_Clase, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CENT_ID"+"_"+sGXsfl_57_idx, getSecureSignedToken( sGXsfl_57_idx, localUtil.format( DecimalUtil.doubleToDec(A1Cent_Id), "ZZZZZZZZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_REGI_ID"+"_"+sGXsfl_57_idx, getSecureSignedToken( sGXsfl_57_idx, localUtil.format( DecimalUtil.doubleToDec(A2Regi_Id), "ZZZZZZZZZZ9")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CUEN_USUARIOCREA"+"_"+sGXsfl_57_idx, getSecureSignedToken( sGXsfl_57_idx, GXutil.rtrim( localUtil.format( A337Cuen_UsuarioCrea, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CUEN_FECHACREA"+"_"+sGXsfl_57_idx, getSecureSignedToken( sGXsfl_57_idx, localUtil.format( A338Cuen_FechaCrea, "99/99/99 99:99")));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CUEN_USUARIOMODIFICA"+"_"+sGXsfl_57_idx, getSecureSignedToken( sGXsfl_57_idx, GXutil.rtrim( localUtil.format( A339Cuen_UsuarioModifica, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, "gxhash_CUEN_FECHAMODIFICA"+"_"+sGXsfl_57_idx, getSecureSignedToken( sGXsfl_57_idx, localUtil.format( A340Cuen_FechaModifica, "99/99/99 99:99")));
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "WWALM_CUENTADANTECONSULTA" );
      subGrid_Rows = 0 ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV18Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'A42Tpte_Codigo',fld:'TPTE_CODIGO',pic:'@!',hsh:true,nv:''},{av:'A43Cuen_Identificacion',fld:'CUEN_IDENTIFICACION',pic:'ZZZZZZZZZZZZZZZZZ9',hsh:true,nv:0},{av:'AV15Cuen_Nombre',fld:'vCUEN_NOMBRE',pic:'@!',nv:''},{av:'AV19ADVANCED_LABEL_TEMPLATE',fld:'vADVANCED_LABEL_TEMPLATE',pic:'',nv:''},{av:'AV16Regi_Descripcion',fld:'vREGI_DESCRIPCION',pic:'',nv:''},{av:'cmbavCuen_estado'},{av:'AV17Cuen_Estado',fld:'vCUEN_ESTADO',pic:'',nv:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',nv:''},{av:'AV14Cuen_Cedula',fld:'vCUEN_CEDULA',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0}],oparms:[{av:'lblLblcuen_nombrefilter_Caption',ctrl:'LBLCUEN_NOMBREFILTER',prop:'Caption'},{av:'lblLblregi_descripcionfilter_Caption',ctrl:'LBLREGI_DESCRIPCIONFILTER',prop:'Caption'},{av:'lblLblcuen_estadofilter_Caption',ctrl:'LBLCUEN_ESTADOFILTER',prop:'Caption'}]}");
      setEventMetadata("'TOGGLE'","{handler:'e11821',iparms:[{av:'divFilterscontainer_Class',ctrl:'FILTERSCONTAINER',prop:'Class'}],oparms:[{av:'divFilterscontainer_Class',ctrl:'FILTERSCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Caption'},{av:'divGridcell_Class',ctrl:'GRIDCELL',prop:'Class'}]}");
      setEventMetadata("LBLCUEN_NOMBREFILTER.CLICK","{handler:'e12821',iparms:[{av:'divCuen_nombrefiltercontainer_Class',ctrl:'CUEN_NOMBREFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divCuen_nombrefiltercontainer_Class',ctrl:'CUEN_NOMBREFILTERCONTAINER',prop:'Class'},{av:'edtavCuen_nombre_Visible',ctrl:'vCUEN_NOMBRE',prop:'Visible'}]}");
      setEventMetadata("LBLREGI_DESCRIPCIONFILTER.CLICK","{handler:'e13821',iparms:[{av:'divRegi_descripcionfiltercontainer_Class',ctrl:'REGI_DESCRIPCIONFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divRegi_descripcionfiltercontainer_Class',ctrl:'REGI_DESCRIPCIONFILTERCONTAINER',prop:'Class'},{av:'edtavRegi_descripcion_Visible',ctrl:'vREGI_DESCRIPCION',prop:'Visible'}]}");
      setEventMetadata("LBLCUEN_ESTADOFILTER.CLICK","{handler:'e14821',iparms:[{av:'divCuen_estadofiltercontainer_Class',ctrl:'CUEN_ESTADOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divCuen_estadofiltercontainer_Class',ctrl:'CUEN_ESTADOFILTERCONTAINER',prop:'Class'},{av:'cmbavCuen_estado'}]}");
      setEventMetadata("GRID.LOAD","{handler:'e17822',iparms:[{av:'A42Tpte_Codigo',fld:'TPTE_CODIGO',pic:'@!',hsh:true,nv:''},{av:'A43Cuen_Identificacion',fld:'CUEN_IDENTIFICACION',pic:'ZZZZZZZZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'}]}");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV17Cuen_Estado = "" ;
      H00822_A340Cuen_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H00822_n340Cuen_FechaModifica = new boolean[] {false} ;
      H00822_A339Cuen_UsuarioModifica = new String[] {""} ;
      H00822_n339Cuen_UsuarioModifica = new boolean[] {false} ;
      H00822_A338Cuen_FechaCrea = new java.util.Date[] {GXutil.nullDate()} ;
      H00822_A337Cuen_UsuarioCrea = new String[] {""} ;
      H00822_A12Regi_Cod = new short[1] ;
      H00822_A2Regi_Id = new long[1] ;
      H00822_A4Cent_Descripcion = new String[] {""} ;
      H00822_A3Cent_Codigo = new String[] {""} ;
      H00822_A1Cent_Id = new long[1] ;
      H00822_A10Dept_Descripcion = new String[] {""} ;
      H00822_A6Dept_Codigo = new short[1] ;
      H00822_A7Ciud_Descripcion = new String[] {""} ;
      H00822_A5Ciud_Codigo = new short[1] ;
      H00822_A328Cuen_Clase = new String[] {""} ;
      H00822_n328Cuen_Clase = new boolean[] {false} ;
      H00822_A333Cuen_Estado = new String[] {""} ;
      H00822_n333Cuen_Estado = new boolean[] {false} ;
      H00822_A13Regi_Descripcion = new String[] {""} ;
      H00822_A321Tpte_Descripcion = new String[] {""} ;
      H00822_A42Tpte_Codigo = new String[] {""} ;
      H00822_A336Cuen_Email = new String[] {""} ;
      H00822_n336Cuen_Email = new boolean[] {false} ;
      H00822_A335Cuen_Telefono = new String[] {""} ;
      H00822_n335Cuen_Telefono = new boolean[] {false} ;
      H00822_A334Cuen_Direccion = new String[] {""} ;
      H00822_n334Cuen_Direccion = new boolean[] {false} ;
      H00822_A44Cuen_Nombre = new String[] {""} ;
      H00822_n44Cuen_Nombre = new boolean[] {false} ;
      H00822_A330Cuen_SegundoApellido = new String[] {""} ;
      H00822_n330Cuen_SegundoApellido = new boolean[] {false} ;
      H00822_A329Cuen_PrimerApellido = new String[] {""} ;
      H00822_n329Cuen_PrimerApellido = new boolean[] {false} ;
      H00822_A332Cuen_SegundoNombre = new String[] {""} ;
      H00822_n332Cuen_SegundoNombre = new boolean[] {false} ;
      H00822_A331Cuen_PrimerNombre = new String[] {""} ;
      H00822_n331Cuen_PrimerNombre = new boolean[] {false} ;
      H00822_A326Cuen_DigitoVerificacion = new byte[1] ;
      H00822_n326Cuen_DigitoVerificacion = new boolean[] {false} ;
      H00822_A688Cuen_Cedula = new long[1] ;
      H00822_A43Cuen_Identificacion = new long[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.wwalm_cuentadanteconsulta__default(),
         new Object[] {
             new Object[] {
            H00822_A340Cuen_FechaModifica, H00822_n340Cuen_FechaModifica, H00822_A339Cuen_UsuarioModifica, H00822_n339Cuen_UsuarioModifica, H00822_A338Cuen_FechaCrea, H00822_A337Cuen_UsuarioCrea, H00822_A12Regi_Cod, H00822_A2Regi_Id, H00822_A4Cent_Descripcion, H00822_A3Cent_Codigo,
            H00822_A1Cent_Id, H00822_A10Dept_Descripcion, H00822_A6Dept_Codigo, H00822_A7Ciud_Descripcion, H00822_A5Ciud_Codigo, H00822_A328Cuen_Clase, H00822_n328Cuen_Clase, H00822_A333Cuen_Estado, H00822_n333Cuen_Estado, H00822_A13Regi_Descripcion,
            H00822_A321Tpte_Descripcion, H00822_A42Tpte_Codigo, H00822_A336Cuen_Email, H00822_n336Cuen_Email, H00822_A335Cuen_Telefono, H00822_n335Cuen_Telefono, H00822_A334Cuen_Direccion, H00822_n334Cuen_Direccion, H00822_A44Cuen_Nombre, H00822_n44Cuen_Nombre,
            H00822_A330Cuen_SegundoApellido, H00822_n330Cuen_SegundoApellido, H00822_A329Cuen_PrimerApellido, H00822_n329Cuen_PrimerApellido, H00822_A332Cuen_SegundoNombre, H00822_n332Cuen_SegundoNombre, H00822_A331Cuen_PrimerNombre, H00822_n331Cuen_PrimerNombre, H00822_A326Cuen_DigitoVerificacion, H00822_n326Cuen_DigitoVerificacion,
            H00822_A688Cuen_Cedula, H00822_A43Cuen_Identificacion
            }
         }
      );
      AV22Pgmname = "WWALM_CUENTADANTECONSULTA" ;
   ...
   private String lV17Cuen_Estado ;
   ...
   private java.util.Date[] H00822_A340Cuen_FechaModifica ;
   private boolean[] H00822_n340Cuen_FechaModifica ;
   private String[] H00822_A339Cuen_UsuarioModifica ;
   private boolean[] H00822_n339Cuen_UsuarioModifica ;
   private java.util.Date[] H00822_A338Cuen_FechaCrea ;
   private String[] H00822_A337Cuen_UsuarioCrea ;
   private short[] H00822_A12Regi_Cod ;
   private long[] H00822_A2Regi_Id ;
   private String[] H00822_A4Cent_Descripcion ;
   private String[] H00822_A3Cent_Codigo ;
   private long[] H00822_A1Cent_Id ;
   private String[] H00822_A10Dept_Descripcion ;
   private short[] H00822_A6Dept_Codigo ;
   private String[] H00822_A7Ciud_Descripcion ;
   private short[] H00822_A5Ciud_Codigo ;
   private String[] H00822_A328Cuen_Clase ;
   private boolean[] H00822_n328Cuen_Clase ;
   private String[] H00822_A333Cuen_Estado ;
   private boolean[] H00822_n333Cuen_Estado ;
   private String[] H00822_A13Regi_Descripcion ;
   private String[] H00822_A321Tpte_Descripcion ;
   private String[] H00822_A42Tpte_Codigo ;
   private String[] H00822_A336Cuen_Email ;
   private boolean[] H00822_n336Cuen_Email ;
   private String[] H00822_A335Cuen_Telefono ;
   private boolean[] H00822_n335Cuen_Telefono ;
   private String[] H00822_A334Cuen_Direccion ;
   private boolean[] H00822_n334Cuen_Direccion ;
   private String[] H00822_A44Cuen_Nombre ;
   private boolean[] H00822_n44Cuen_Nombre ;
   private String[] H00822_A330Cuen_SegundoApellido ;
   private boolean[] H00822_n330Cuen_SegundoApellido ;
   private String[] H00822_A329Cuen_PrimerApellido ;
   private boolean[] H00822_n329Cuen_PrimerApellido ;
   private String[] H00822_A332Cuen_SegundoNombre ;
   private boolean[] H00822_n332Cuen_SegundoNombre ;
   private String[] H00822_A331Cuen_PrimerNombre ;
   private boolean[] H00822_n331Cuen_PrimerNombre ;
   private byte[] H00822_A326Cuen_DigitoVerificacion ;
   private boolean[] H00822_n326Cuen_DigitoVerificacion ;
   private long[] H00822_A688Cuen_Cedula ;
   private long[] H00822_A43Cuen_Identificacion ;
...
final  class wwalm_cuentadanteconsulta__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H00822( ModelContext context ,
                                          int remoteHandle ,
                                          ...
                                          String A13Regi_Descripcion )
   {
      ...
      scmdbuf = scmdbuf + " T2.Regi_Cod, T1.Regi_Id, T5.Cent_Descripcion, T5.Cent_Codigo, T1.Cent_Id, T4.Dept_Descripcion," ;
      scmdbuf = scmdbuf + " T3.Dept_Codigo, T3.Ciud_Descripcion, T2.Ciud_Codigo, T1.Cuen_Clase, T1.Cuen_Estado," ;
      scmdbuf = scmdbuf + " T2.Regi_Descripcion, T6.Tpte_Descripcion, T1.Tpte_Codigo, T1.Cuen_Email, T1.Cuen_Telefono," ;
      scmdbuf = scmdbuf + " T1.Cuen_Direccion, T1.Cuen_Nombre, T1.Cuen_SegundoApellido, T1.Cuen_PrimerApellido," ;
      ...
      if ( ! (0==AV14Cuen_Cedula) )
      {
         ...
         {
            sWhereString = sWhereString + " (T1.Cuen_Cedula = ?)" ;
         }
      }
      else
      {
      ...
      if ( ! (GXutil.strcmp("", AV17Cuen_Estado)==0) )
      {
         if ( GXutil.strcmp("", sWhereString) != 0 )
         {
            sWhereString = sWhereString + " and (T1.Cuen_Estado like ?)" ;
         }
         else
         {
            sWhereString = sWhereString + " (T1.Cuen_Estado like ?)" ;
         }
      }
      else
      {
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00822(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).longValue() , (String)dynConstraints[1] , ((Number) dynConstraints[2]).longValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00822", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
      };
   }
                           ...
                           Object[] buf ) throws SQLException
   {
      switch ( cursor )
      {
            case 0 :
               ...
               ((String[]) buf[21])[0] = rslt.getString(18, 2) ;
