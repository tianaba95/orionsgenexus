/*
               File: alm_cuentadante_multialm_inventario_devolutivowc_impl
        Description: ALM_CUENTADANTE_MULTIALM_INVENTARIO_DEVOLUTIVOWC
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:15:34.81
...
public final  class alm_cuentadante_multialm_inventario_devolutivowc_impl extends GXWebComponent
{
   public alm_cuentadante_multialm_inventario_devolutivowc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public alm_cuentadante_multialm_inventario_devolutivowc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( alm_cuentadante_multialm_inventario_devolutivowc_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "ALM_CUENTADANTE_MULTIALM_INVENTARIO_DEVOLUTIVOWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414153488");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.alm_cuentadante_multialm_inventario_devolutivowc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Cuen_Identificacion,18,0)))+"\">") ;
   ...
   public void renderHtmlCloseForm1M2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("alm_cuentadante_multialm_inventario_devolutivowc.js", "?201861414153491");
      }
   ...
   {
      return "ALM_CUENTADANTE_MULTIALM_INVENTARIO_DEVOLUTIVOWC" ;
   }
   ...
   public void wb1M0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.alm_cuentadante_multialm_inventario_devolutivowc");
         }
         /* Div Control */
   ...
   public void start1M2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "ALM_CUENTADANTE_MULTIALM_INVENTARIO_DEVOLUTIVOWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "ALM_CUENTADANTE_MULTIALM_INVENTARIO_DEVOLUTIVOWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf1M2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A37Cata_Codigo = H001M2_A37Cata_Codigo[0] ;
            A43Cuen_Identificacion = H001M2_A43Cuen_Identificacion[0] ;
            ...
            n43Cuen_Identificacion = H001M2_n43Cuen_Identificacion[0] ;
            A858Invd_EntidadGobierno = H001M2_A858Invd_EntidadGobierno[0] ;
            n858Invd_EntidadGobierno = H001M2_n858Invd_EntidadGobierno[0] ;
            A818Invd_PlacaRecuperada = H001M2_A818Invd_PlacaRecuperada[0] ;
            n818Invd_PlacaRecuperada = H001M2_n818Invd_PlacaRecuperada[0] ;
            A711Invd_AreadanteCodigo = H001M2_A711Invd_AreadanteCodigo[0] ;
            n711Invd_AreadanteCodigo = H001M2_n711Invd_AreadanteCodigo[0] ;
            A631Vida_Util_Actual = H001M2_A631Vida_Util_Actual[0] ;
            n631Vida_Util_Actual = H001M2_n631Vida_Util_Actual[0] ;
            A630Vida_Util_Inicial = H001M2_A630Vida_Util_Inicial[0] ;
            n630Vida_Util_Inicial = H001M2_n630Vida_Util_Inicial[0] ;
            A629Costo_Total_Dev = H001M2_A629Costo_Total_Dev[0] ;
            A627Variable_N = H001M2_A627Variable_N[0] ;
            n627Variable_N = H001M2_n627Variable_N[0] ;
            A626Variable_I = H001M2_A626Variable_I[0] ;
            n626Variable_I = H001M2_n626Variable_I[0] ;
            A625Variable_VF = H001M2_A625Variable_VF[0] ;
            n625Variable_VF = H001M2_n625Variable_VF[0] ;
            A624Costo_Desmante = H001M2_A624Costo_Desmante[0] ;
            n624Costo_Desmante = H001M2_n624Costo_Desmante[0] ;
            A628Otros_Costos_Dev = H001M2_A628Otros_Costos_Dev[0] ;
            n628Otros_Costos_Dev = H001M2_n628Otros_Costos_Dev[0] ;
            A467Invd_FechaServicio = H001M2_A467Invd_FechaServicio[0] ;
            n467Invd_FechaServicio = H001M2_n467Invd_FechaServicio[0] ;
            A501Invd_EsPlacaPadre = H001M2_A501Invd_EsPlacaPadre[0] ;
            n501Invd_EsPlacaPadre = H001M2_n501Invd_EsPlacaPadre[0] ;
            A68Invd_PlacaPadre = H001M2_A68Invd_PlacaPadre[0] ;
            n68Invd_PlacaPadre = H001M2_n68Invd_PlacaPadre[0] ;
            A466Invd_FechaAdquisicion = H001M2_A466Invd_FechaAdquisicion[0] ;
            n466Invd_FechaAdquisicion = H001M2_n466Invd_FechaAdquisicion[0] ;
            A465Invd_ValorAdquisicion = H001M2_A465Invd_ValorAdquisicion[0] ;
            n465Invd_ValorAdquisicion = H001M2_n465Invd_ValorAdquisicion[0] ;
            A463Invd_Estado = H001M2_A463Invd_Estado[0] ;
            n463Invd_Estado = H001M2_n463Invd_Estado[0] ;
            A414Invd_BodegaCodigo = H001M2_A414Invd_BodegaCodigo[0] ;
            A413Invd_AlmacenCodigo = H001M2_A413Invd_AlmacenCodigo[0] ;
            A412Invd_ModuloAlmacen = H001M2_A412Invd_ModuloAlmacen[0] ;
            A411Invd_CentroCostoId = H001M2_A411Invd_CentroCostoId[0] ;
            A410Invd_RegionalId = H001M2_A410Invd_RegionalId[0] ;
            A67Invd_NumeroPlaca = H001M2_A67Invd_NumeroPlaca[0] ;
            A33Tipo_Codigo = H001M2_A33Tipo_Codigo[0] ;
            A291Clas_Descripcion = H001M2_A291Clas_Descripcion[0] ;
            A34Clas_Codigo = H001M2_A34Clas_Codigo[0] ;
            A298Cata_Descripcion = H001M2_A298Cata_Descripcion[0] ;
            A66Elem_Consecutivo = H001M2_A66Elem_Consecutivo[0] ;
            A37Cata_Codigo = H001M2_A37Cata_Codigo[0] ;
            A33Tipo_Codigo = H001M2_A33Tipo_Codigo[0] ;
            A34Clas_Codigo = H001M2_A34Clas_Codigo[0] ;
            A298Cata_Descripcion = H001M2_A298Cata_Descripcion[0] ;
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "alm_cuentadante_multialm_inventario_devolutivowc");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414153592");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("alm_cuentadante_multialm_inventario_devolutivowc.js", "?201861414153592");
      }
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("GRID.LOAD","{handler:'e131M2',iparms:[{av:'A66Elem_Consecutivo',fld:'ELEM_CONSECUTIVO',pic:'',hsh:true,nv:''},{av:'A67Invd_NumeroPlaca',fld:'INVD_NUMEROPLACA',pic:'',nv:''},{av:'A37Cata_Codigo',fld:'CATA_CODIGO',pic:'',nv:''},{av:'A34Clas_Codigo',fld:'CLAS_CODIGO',pic:'',nv:''}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtCata_Descripcion_Link',ctrl:'CATA_DESCRIPCION',prop:'Link'},{av:'edtClas_Descripcion_Link',ctrl:'CLAS_DESCRIPCION',prop:'Link'},{av:'edtInvd_NumeroPlaca_Link',ctrl:'INVD_NUMEROPLACA',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e111M2',iparms:[{av:'A66Elem_Consecutivo',fld:'ELEM_CONSECUTIVO',pic:'',hsh:true,nv:''},{av:'A67Invd_NumeroPlaca',fld:'INVD_NUMEROPLACA',pic:'',nv:''}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H001M2_A37Cata_Codigo = new String[] {""} ;
      H001M2_A43Cuen_Identificacion = new long[1] ;
      H001M2_n43Cuen_Identificacion = new boolean[] {false} ;
      H001M2_A858Invd_EntidadGobierno = new String[] {""} ;
      H001M2_n858Invd_EntidadGobierno = new boolean[] {false} ;
      H001M2_A818Invd_PlacaRecuperada = new String[] {""} ;
      H001M2_n818Invd_PlacaRecuperada = new boolean[] {false} ;
      H001M2_A711Invd_AreadanteCodigo = new String[] {""} ;
      H001M2_n711Invd_AreadanteCodigo = new boolean[] {false} ;
      H001M2_A631Vida_Util_Actual = new short[1] ;
      H001M2_n631Vida_Util_Actual = new boolean[] {false} ;
      H001M2_A630Vida_Util_Inicial = new short[1] ;
      H001M2_n630Vida_Util_Inicial = new boolean[] {false} ;
      H001M2_A629Costo_Total_Dev = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H001M2_A627Variable_N = new short[1] ;
      H001M2_n627Variable_N = new boolean[] {false} ;
      H001M2_A626Variable_I = new short[1] ;
      H001M2_n626Variable_I = new boolean[] {false} ;
      H001M2_A625Variable_VF = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H001M2_n625Variable_VF = new boolean[] {false} ;
      H001M2_A624Costo_Desmante = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H001M2_n624Costo_Desmante = new boolean[] {false} ;
      H001M2_A628Otros_Costos_Dev = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H001M2_n628Otros_Costos_Dev = new boolean[] {false} ;
      H001M2_A467Invd_FechaServicio = new java.util.Date[] {GXutil.nullDate()} ;
      H001M2_n467Invd_FechaServicio = new boolean[] {false} ;
      H001M2_A501Invd_EsPlacaPadre = new String[] {""} ;
      H001M2_n501Invd_EsPlacaPadre = new boolean[] {false} ;
      H001M2_A68Invd_PlacaPadre = new String[] {""} ;
      H001M2_n68Invd_PlacaPadre = new boolean[] {false} ;
      H001M2_A466Invd_FechaAdquisicion = new java.util.Date[] {GXutil.nullDate()} ;
      H001M2_n466Invd_FechaAdquisicion = new boolean[] {false} ;
      H001M2_A465Invd_ValorAdquisicion = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H001M2_n465Invd_ValorAdquisicion = new boolean[] {false} ;
      H001M2_A463Invd_Estado = new String[] {""} ;
      H001M2_n463Invd_Estado = new boolean[] {false} ;
      H001M2_A414Invd_BodegaCodigo = new String[] {""} ;
      H001M2_A413Invd_AlmacenCodigo = new String[] {""} ;
      H001M2_A412Invd_ModuloAlmacen = new String[] {""} ;
      H001M2_A411Invd_CentroCostoId = new long[1] ;
      H001M2_A410Invd_RegionalId = new long[1] ;
      H001M2_A67Invd_NumeroPlaca = new String[] {""} ;
      H001M2_A33Tipo_Codigo = new long[1] ;
      H001M2_A291Clas_Descripcion = new String[] {""} ;
      H001M2_A34Clas_Codigo = new String[] {""} ;
      H001M2_A298Cata_Descripcion = new String[] {""} ;
      H001M2_A66Elem_Consecutivo = new String[] {""} ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.alm_cuentadante_multialm_inventario_devolutivowc__default(),
         new Object[] {
             new Object[] {
            H001M2_A37Cata_Codigo, H001M2_A43Cuen_Identificacion, H001M2_n43Cuen_Identificacion, H001M2_A858Invd_EntidadGobierno, H001M2_n858Invd_EntidadGobierno, H001M2_A818Invd_PlacaRecuperada, H001M2_n818Invd_PlacaRecuperada, H001M2_A711Invd_AreadanteCodigo, H001M2_n711Invd_AreadanteCodigo, H001M2_A631Vida_Util_Actual,
            H001M2_n631Vida_Util_Actual, H001M2_A630Vida_Util_Inicial, H001M2_n630Vida_Util_Inicial, H001M2_A629Costo_Total_Dev, H001M2_A627Variable_N, H001M2_n627Variable_N, H001M2_A626Variable_I, H001M2_n626Variable_I, H001M2_A625Variable_VF, H001M2_n625Variable_VF,
            H001M2_A624Costo_Desmante, H001M2_n624Costo_Desmante, H001M2_A628Otros_Costos_Dev, H001M2_n628Otros_Costos_Dev, H001M2_A467Invd_FechaServicio, H001M2_n467Invd_FechaServicio, H001M2_A501Invd_EsPlacaPadre, H001M2_n501Invd_EsPlacaPadre, H001M2_A68Invd_PlacaPadre, H001M2_n68Invd_PlacaPadre,
            H001M2_A466Invd_FechaAdquisicion, H001M2_n466Invd_FechaAdquisicion, H001M2_A465Invd_ValorAdquisicion, H001M2_n465Invd_ValorAdquisicion, H001M2_A463Invd_Estado, H001M2_n463Invd_Estado, H001M2_A414Invd_BodegaCodigo, H001M2_A413Invd_AlmacenCodigo, H001M2_A412Invd_ModuloAlmacen, H001M2_A411Invd_CentroCostoId,
            H001M2_A410Invd_RegionalId, H001M2_A67Invd_NumeroPlaca, H001M2_A33Tipo_Codigo, H001M2_A291Clas_Descripcion, H001M2_A34Clas_Codigo, H001M2_A298Cata_Descripcion, H001M2_A66Elem_Consecutivo
            }
            , new Object[] {
   ...
   private String[] H001M2_A37Cata_Codigo ;
   private long[] H001M2_A43Cuen_Identificacion ;
   private boolean[] H001M2_n43Cuen_Identificacion ;
   private String[] H001M2_A858Invd_EntidadGobierno ;
   private boolean[] H001M2_n858Invd_EntidadGobierno ;
   private String[] H001M2_A818Invd_PlacaRecuperada ;
   private boolean[] H001M2_n818Invd_PlacaRecuperada ;
   private String[] H001M2_A711Invd_AreadanteCodigo ;
   private boolean[] H001M2_n711Invd_AreadanteCodigo ;
   private short[] H001M2_A631Vida_Util_Actual ;
   private boolean[] H001M2_n631Vida_Util_Actual ;
   private short[] H001M2_A630Vida_Util_Inicial ;
   private boolean[] H001M2_n630Vida_Util_Inicial ;
   private java.math.BigDecimal[] H001M2_A629Costo_Total_Dev ;
   private short[] H001M2_A627Variable_N ;
   private boolean[] H001M2_n627Variable_N ;
   private short[] H001M2_A626Variable_I ;
   private boolean[] H001M2_n626Variable_I ;
   private java.math.BigDecimal[] H001M2_A625Variable_VF ;
   private boolean[] H001M2_n625Variable_VF ;
   private java.math.BigDecimal[] H001M2_A624Costo_Desmante ;
   private boolean[] H001M2_n624Costo_Desmante ;
   private java.math.BigDecimal[] H001M2_A628Otros_Costos_Dev ;
   private boolean[] H001M2_n628Otros_Costos_Dev ;
   private java.util.Date[] H001M2_A467Invd_FechaServicio ;
   private boolean[] H001M2_n467Invd_FechaServicio ;
   private String[] H001M2_A501Invd_EsPlacaPadre ;
   private boolean[] H001M2_n501Invd_EsPlacaPadre ;
   private String[] H001M2_A68Invd_PlacaPadre ;
   private boolean[] H001M2_n68Invd_PlacaPadre ;
   private java.util.Date[] H001M2_A466Invd_FechaAdquisicion ;
   private boolean[] H001M2_n466Invd_FechaAdquisicion ;
   private java.math.BigDecimal[] H001M2_A465Invd_ValorAdquisicion ;
   private boolean[] H001M2_n465Invd_ValorAdquisicion ;
   private String[] H001M2_A463Invd_Estado ;
   private boolean[] H001M2_n463Invd_Estado ;
   private String[] H001M2_A414Invd_BodegaCodigo ;
   private String[] H001M2_A413Invd_AlmacenCodigo ;
   private String[] H001M2_A412Invd_ModuloAlmacen ;
   private long[] H001M2_A411Invd_CentroCostoId ;
   private long[] H001M2_A410Invd_RegionalId ;
   private String[] H001M2_A67Invd_NumeroPlaca ;
   private long[] H001M2_A33Tipo_Codigo ;
   private String[] H001M2_A291Clas_Descripcion ;
   private String[] H001M2_A34Clas_Codigo ;
   private String[] H001M2_A298Cata_Descripcion ;
   private String[] H001M2_A66Elem_Consecutivo ;
                           ...
                           Object[] buf ) throws SQLException
   {
      switch ( cursor )
      {
            case 0 :
               ...
               ((String[]) buf[26])[0] = rslt.getString(15, 2) ;
