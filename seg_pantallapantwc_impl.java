...
public final  class seg_pantallapantwc_impl extends GXWebComponent
{
   public seg_pantallapantwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public seg_pantallapantwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( seg_pantallapantwc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV7Pant_Id = (int)(GXutil.lval( httpContext.GetNextPar( ))) ;
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Pant_Id", GXutil.ltrim( GXutil.str( AV7Pant_Id, 6, 0)));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,new Integer(AV7Pant_Id)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Pant_Id, AV12Update, AV13Delete, A21Rol_Id, A18Pant_Id, sPrefix) ;
               GXKey = com.genexus.util.Encryption.decrypt64( httpContext.getCookie( "GX_SESSION_ID"), context.getServerKey( )) ;
               GXKey = com.genexus.util.Encryption.decrypt64( httpContext.getCookie( "GX_SESSION_ID"), context.getServerKey( )) ;
               forbiddenHiddens = sPrefix + "hsh" + "SEG_PANTALLAPantWC" ;
               forbiddenHiddens = forbiddenHiddens + localUtil.format( DecimalUtil.doubleToDec(A18Pant_Id), "ZZZZZ9") ;
               com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"hsh", GXutil.getEncryptedSignature( forbiddenHiddens, GXKey));
               GXutil.writeLogln("seg_pantallapantwc:[SendSecurityCheck]"+forbiddenHiddens);
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "SEG_PANTALLAPant WC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2018614141692");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.seg_pantallapantwc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Pant_Id,6,0)))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV7Pant_Id", GXutil.ltrim( localUtil.ntoc( wcpOAV7Pant_Id, (byte)(6), (byte)(0), ",", "")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vPANT_ID", GXutil.ltrim( localUtil.ntoc( AV7Pant_Id, (byte)(6), (byte)(0), ",", "")));
   ...
   public void renderHtmlCloseForm332( )
   {
      sendCloseFormHiddens( ) ;
      if ( ( GXutil.len( sPrefix) != 0 ) && httpContext.isAjaxRequest( ) )
      {
         httpContext.AddJavascriptSource("seg_pantallapantwc.js", "?2018614141694");
      }
   ...
   public void wb330( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.seg_pantallapantwc");
         }
         /* Div Control */
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_SEG_PANTALLAPantWC.htm");
   ...
   public void start332( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "SEG_PANTALLAPant WC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "SEG_PANTALLAPantWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf332( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H00332 */
         pr_default.execute(0, new Object[] {new Integer(AV7Pant_Id), new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_20_idx = (short)(1) ;
         sGXsfl_20_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_20_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_202( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A18Pant_Id = H00332_A18Pant_Id[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A18Pant_Id", GXutil.ltrim( GXutil.str( A18Pant_Id, 6, 0)));
            A22Rol_Descripcion = H00332_A22Rol_Descripcion[0] ;
            A21Rol_Id = H00332_A21Rol_Id[0] ;
            A22Rol_Descripcion = H00332_A22Rol_Descripcion[0] ;
            e13332 ();
   ...
   {
      /* Using cursor H00333 */
      pr_default.execute(1, new Object[] {new Integer(AV7Pant_Id)});
   ...
   public void strup330( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV7Pant_Id = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV7Pant_Id"), ",", ".")) ;
         ...
         if ( ! GXutil.checkEncryptedSignature( forbiddenHiddens, hsh, GXKey) )
         {
            ...
            GXutil.writeLog("seg_pantallapantwc:[SecurityCheckFailed]"+forbiddenHiddens);
            return  ;
         }
   ...
   {
      /* Grid_Load Routine */
      edtavUpdate_Link = formatLink("com.orions2.seg_rolypantalla") + "?" + GXutil.URLEncode(GXutil.rtrim("UPD")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A21Rol_Id,11,0))) ;
      edtavDelete_Link = formatLink("com.orions2.seg_rolypantalla") + "?" + GXutil.URLEncode(GXutil.rtrim("DLT")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A21Rol_Id,11,0))) ;
      edtRol_Descripcion_Link = formatLink("com.orions2.viewseg_rol_pantalla") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A21Rol_Id,11,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(A18Pant_Id,6,0))) + "," + GXutil.URLEncode(GXutil.rtrim("")) ;
      /* Load Method */
      if ( wbStart != -1 )
      {
         wbStart = (short)(20) ;
   ...
   {
      /* 'DoInsert' Routine */
      callWebObject(formatLink("com.orions2.seg_rolypantalla") + "?" + GXutil.URLEncode(GXutil.rtrim("INS")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(0,9,0))));
      httpContext.wjLocDisableFrm = (byte)(1) ;
   }
   ...
   public void S112( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( GXutil.str( AV7Pant_Id, 6, 0) );
   ...
   {
      AV7Pant_Id = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.INT), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Pant_Id", GXutil.ltrim( GXutil.str( AV7Pant_Id, 6, 0)));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV7Pant_Id = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "seg_pantallapantwc");
      ...
      {
         AV7Pant_Id = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.INT), TypeConstants.INT)).intValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Pant_Id", GXutil.ltrim( GXutil.str( AV7Pant_Id, 6, 0)));
      }
      wcpOAV7Pant_Id = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV7Pant_Id"), ",", ".")) ;
      if ( ! GetJustCreated( ) && ( ( AV7Pant_Id != wcpOAV7Pant_Id ) ) )
      {
         setjustcreated();
      }
      wcpOAV7Pant_Id = AV7Pant_Id ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV7Pant_Id = httpContext.cgiGet( sPrefix+"AV7Pant_Id_CTRL") ;
      if ( GXutil.len( sCtrlAV7Pant_Id) > 0 )
      {
         AV7Pant_Id = (int)(localUtil.ctol( httpContext.cgiGet( sCtrlAV7Pant_Id), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Pant_Id", GXutil.ltrim( GXutil.str( AV7Pant_Id, 6, 0)));
      }
      else
      {
         AV7Pant_Id = (int)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV7Pant_Id_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Pant_Id_PARM", GXutil.ltrim( localUtil.ntoc( AV7Pant_Id, (byte)(6), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV7Pant_Id)) > 0 )
      {
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Pant_Id_CTRL", GXutil.rtrim( sCtrlAV7Pant_Id));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20186141416940");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("seg_pantallapantwc.js", "?20186141416941");
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Pant_Id',fld:'vPANT_ID',pic:'ZZZZZ9',nv:0},{av:'AV12Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV13Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A21Rol_Id',fld:'ROL_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'A18Pant_Id',fld:'PANT_ID',pic:'ZZZZZ9',nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e13332',iparms:[{av:'A21Rol_Id',fld:'ROL_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0},{av:'A18Pant_Id',fld:'PANT_ID',pic:'ZZZZZ9',nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtRol_Descripcion_Link',ctrl:'ROL_DESCRIPCION',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e11332',iparms:[{av:'A21Rol_Id',fld:'ROL_ID',pic:'ZZZZZZZZZZ9',hsh:true,nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H00332_A18Pant_Id = new int[1] ;
      H00332_A22Rol_Descripcion = new String[] {""} ;
      H00332_A21Rol_Id = new long[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.seg_pantallapantwc__default(),
         new Object[] {
             new Object[] {
            H00332_A18Pant_Id, H00332_A22Rol_Descripcion, H00332_A21Rol_Id
            }
            , new Object[] {
   ...
   private int wcpOAV7Pant_Id ;
   private int AV7Pant_Id ;
   ...
   private String hsh ;
   private String sCtrlAV7Pant_Id ;
   ...
   private int[] H00332_A18Pant_Id ;
   private String[] H00332_A22Rol_Descripcion ;
   private long[] H00332_A21Rol_Id ;
...
final  class seg_pantallapantwc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00332", "SELECT T1.Pant_Id, T2.Rol_Descripcion, T1.Rol_Id FROM (SEG_ROL_PANTALLA T1 INNER JOIN SEG_ROL T2 ON T2.Rol_Id = T1.Rol_Id) WHERE T1.Pant_Id = ? ORDER BY T1.Pant_Id  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H00333", "SELECT COUNT(*) FROM (SEG_ROL_PANTALLA T1 INNER JOIN SEG_ROL T2 ON T2.Rol_Id = T1.Rol_Id) WHERE T1.Pant_Id = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
