/*
               File: seg_usuarioseg_usuario_rolwc_impl
        Description: SEG_USUARIOSEG_USUARIO_ROLWC
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:11:43.7
...
public final  class seg_usuarioseg_usuario_rolwc_impl extends GXWebComponent
{
   public seg_usuarioseg_usuario_rolwc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public seg_usuarioseg_usuario_rolwc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( seg_usuarioseg_usuario_rolwc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Usua_Id, AV12Update, AV13Delete, A23Usua_Id, sPrefix) ;
               GXKey = com.genexus.util.Encryption.decrypt64( httpContext.getCookie( "GX_SESSION_ID"), context.getServerKey( )) ;
               GXKey = com.genexus.util.Encryption.decrypt64( httpContext.getCookie( "GX_SESSION_ID"), context.getServerKey( )) ;
               forbiddenHiddens = sPrefix + "hsh" + "SEG_USUARIOSEG_USUARIO_ROLWC" ;
               forbiddenHiddens = forbiddenHiddens + localUtil.format( DecimalUtil.doubleToDec(A23Usua_Id), "ZZZZZZZZZZZZZZZZZ9") ;
               com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"hsh", GXutil.getEncryptedSignature( forbiddenHiddens, GXKey));
               GXutil.writeLogln("seg_usuarioseg_usuario_rolwc:[SendSecurityCheck]"+forbiddenHiddens);
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "SEG_USUARIOSEG_USUARIO_ROLWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414114313");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.seg_usuarioseg_usuario_rolwc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Usua_Id,18,0)))+"\">") ;
   ...
   public void renderHtmlCloseForm3Q2( )
   {
      ...
      {
         httpContext.AddJavascriptSource("seg_usuarioseg_usuario_rolwc.js", "?201861414114315");
      }
   ...
   {
      return "SEG_USUARIOSEG_USUARIO_ROLWC" ;
   }
   ...
   public void wb3Q0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.seg_usuarioseg_usuario_rolwc");
         }
         /* Div Control */
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 7, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e113q1_client"+"'", TempTags, "", 2, "HLP_SEG_USUARIOSEG_USUARIO_ROLWC.htm");
      ...
      if ( wbEnd == 20 )
      {
         ...
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtUsua_Id_Internalname, GXutil.ltrim( localUtil.ntoc( A23Usua_Id, (byte)(18), (byte)(0), ",", "")), ((edtUsua_Id_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A23Usua_Id), "ZZZZZZZZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A23Usua_Id), "ZZZZZZZZZZZZZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtUsua_Id_Jsonclick, 0, "Attribute", "", "", "", edtUsua_Id_Visible, edtUsua_Id_Enabled, 0, "text", "", 18, "chr", 1, "row", 18, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "IdLargo", "right", false, "HLP_SEG_USUARIOSEG_USUARIO_ROLWC.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start3Q2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "SEG_USUARIOSEG_USUARIO_ROLWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   public void send_integrity_hashes( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"USUA_CODIGO", A24Usua_Codigo);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"USUA_EMAIL", A219Usua_Email);
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"USUA_CEDULA", GXutil.ltrim( localUtil.ntoc( A26Usua_Cedula, (byte)(18), (byte)(0), ".", "")));
   }
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "SEG_USUARIOSEG_USUARIO_ROLWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf3Q2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A23Usua_Id = H003Q2_A23Usua_Id[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A23Usua_Id", GXutil.ltrim( GXutil.str( A23Usua_Id, 18, 0)));
            A26Usua_Cedula = H003Q2_A26Usua_Cedula[0] ;
            A219Usua_Email = H003Q2_A219Usua_Email[0] ;
            A25Usua_Nombre = H003Q2_A25Usua_Nombre[0] ;
            A24Usua_Codigo = H003Q2_A24Usua_Codigo[0] ;
            e133Q2 ();
   ...
   public void strup3Q0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         AV7Usua_Id = localUtil.ctol( httpContext.cgiGet( sPrefix+"vUSUA_ID"), ",", ".") ;
         ...
         if ( ! GXutil.checkEncryptedSignature( forbiddenHiddens, hsh, GXKey) )
         {
            ...
            GXutil.writeLog("seg_usuarioseg_usuario_rolwc:[SecurityCheckFailed]"+forbiddenHiddens);
            return  ;
         }
   ...
   {
      /* Grid_Load Routine */
      edtavUpdate_Link = formatLink("com.orions2.seg_usuariorol") + "?" + GXutil.URLEncode(GXutil.rtrim("UPD")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Usua_Id,18,0))) ;
      edtavDelete_Link = formatLink("com.orions2.seg_usuariorol") + "?" + GXutil.URLEncode(GXutil.rtrim("DLT")) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Usua_Id,18,0))) ;
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "seg_usuarioseg_usuario_rolwc");
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414114354");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("seg_usuarioseg_usuario_rolwc.js", "?201861414114354");
      }
   ...
   public void sendrow_202( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subgrid_recordsperpage( ) * 1 ) )
      {
         ...
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_USUA_CODIGO"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A24Usua_Codigo, "@!"))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_USUA_EMAIL"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, GXutil.rtrim( localUtil.format( A219Usua_Email, ""))));
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"gxhash_USUA_CEDULA"+"_"+sGXsfl_20_idx, getSecureSignedToken( sPrefix+sGXsfl_20_idx, localUtil.format( DecimalUtil.doubleToDec(A26Usua_Cedula), "ZZZZZZZZZZZZZZZZZ9")));
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Usua_Id',fld:'vUSUA_ID',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'AV12Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV13Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A23Usua_Id',fld:'USUA_ID',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e133Q2',iparms:[{av:'AV7Usua_Id',fld:'vUSUA_ID',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'A23Usua_Id',fld:'USUA_ID',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtUsua_Nombre_Link',ctrl:'USUA_NOMBRE',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e113Q1',iparms:[{av:'AV7Usua_Id',fld:'vUSUA_ID',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H003Q2_A23Usua_Id = new long[1] ;
      H003Q2_A26Usua_Cedula = new long[1] ;
      H003Q2_A219Usua_Email = new String[] {""} ;
      H003Q2_A25Usua_Nombre = new String[] {""} ;
      H003Q2_A24Usua_Codigo = new String[] {""} ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.seg_usuarioseg_usuario_rolwc__default(),
         new Object[] {
             new Object[] {
            H003Q2_A23Usua_Id, H003Q2_A26Usua_Cedula, H003Q2_A219Usua_Email, H003Q2_A25Usua_Nombre, H003Q2_A24Usua_Codigo
            }
            , new Object[] {
   ...
   private long[] H003Q2_A23Usua_Id ;
   private long[] H003Q2_A26Usua_Cedula ;
   private String[] H003Q2_A219Usua_Email ;
   private String[] H003Q2_A25Usua_Nombre ;
   private String[] H003Q2_A24Usua_Codigo ;
...
final  class seg_usuarioseg_usuario_rolwc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H003Q2", "SELECT Usua_Id, Usua_Cedula, Usua_Email, Usua_Nombre, Usua_Codigo FROM SEG_USUARIO WHERE Usua_Id = ? ORDER BY Usua_Id  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H003Q3", "SELECT COUNT(*) FROM SEG_USUARIO WHERE Usua_Id = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
