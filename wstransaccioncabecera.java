/*
               File: WSTransaccionCabecera
        Description: WSTransaccion Cabecera
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:10:57.21
...
public final  class wstransaccioncabecera extends GXProcedure
{
   public wstransaccioncabecera( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wstransaccioncabecera.class ), "" );
   }
   ...
   {
      wstransaccioncabecera.this.AV8Tran_Id = aP0[0];
      this.aP0 = aP0;
      wstransaccioncabecera.this.aP0 = new long[] {0};
      initialize();
      privateExecute();
      return aP0[0];
   }
   ...
   private void privateExecute( )
   {
      ...
      wstransaccioncabecera.this.AV12Host = GXv_char1[0] ;
      wstransaccioncabecera.this.AV18URL = GXv_char2[0] ;
      wstransaccioncabecera.this.AV16Puerto = GXv_int3[0] ;
      AV13HttpClient.setHost( AV12Host );
      AV13HttpClient.setPort( AV16Puerto );
      AV13HttpClient.setBaseURL( AV18URL );
      GXt_SdtSDTTransaccionCabecera4 = AV17SDTTransaccionCabecera;
      GXv_SdtSDTTransaccionCabecera5[0] = GXt_SdtSDTTransaccionCabecera4;
      new com.orions2.dptransaccioncabecera(remoteHandle, context).execute( AV8Tran_Id, GXv_SdtSDTTransaccionCabecera5) ;
      GXt_SdtSDTTransaccionCabecera4 = GXv_SdtSDTTransaccionCabecera5[0] ;
      AV17SDTTransaccionCabecera = GXt_SdtSDTTransaccionCabecera4;
      AV9body = AV17SDTTransaccionCabecera.toJSonString(false) ;
      ...
      wstransaccioncabecera.this.AV10cons_Numero = GXv_int6[0] ;
      /*
   ...
   {
      this.aP0[0] = wstransaccioncabecera.this.AV8Tran_Id;
      Application.commit(context, remoteHandle, "DEFAULT",pr_default, "wstransaccioncabecera");
      CloseOpenCursors();
   ...
   public void initialize( )
   {
      ...
      AV17SDTTransaccionCabecera = new com.orions2.SdtSDTTransaccionCabecera(remoteHandle, context);
      GXt_SdtSDTTransaccionCabecera4 = new com.orions2.SdtSDTTransaccionCabecera(remoteHandle, context);
      GXv_SdtSDTTransaccionCabecera5 = new com.orions2.SdtSDTTransaccionCabecera [1] ;
      AV9body = "" ;
      AV14lvc = "" ;
      AV11Estado = "" ;
      ...
      A188Control_Usuario = "" ;
      Gx_emsg = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.wstransaccioncabecera__default(),
         new Object[] {
             new Object[] {
            }
         }
   ...
   private com.orions2.SdtSDTTransaccionCabecera AV17SDTTransaccionCabecera ;
   private com.orions2.SdtSDTTransaccionCabecera GXt_SdtSDTTransaccionCabecera4 ;
   private com.orions2.SdtSDTTransaccionCabecera GXv_SdtSDTTransaccionCabecera5[] ;
}

final  class wstransaccioncabecera__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new UpdateCursor("P000G2", "INSERT INTO SEG_CONTROL_WEBSERVICES(Control_Id, Control_FechaHora, Control_IdUsuario, Control_Usuario, Control_Programa, Control_Body, Control_Lvc, Control_Estado, Control_CodUsuario) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ' ')", GX_NOMASK + GX_MASKLOOPLOCK, "SEG_CONTROL_WEBSERVICES")
      };
   }
