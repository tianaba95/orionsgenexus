/*
               File: alm_documentosdocumentowc_impl
        Description: ALM_DOCUMENTOSDOCUMENTOWC
             Author: GeneXus Java Generator version 15_0_4-113785
       Generated on: June 14, 2018 14:16:23.89
...
public final  class alm_documentosdocumentowc_impl extends GXWebComponent
{
   public alm_documentosdocumentowc_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public alm_documentosdocumentowc_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( alm_documentosdocumentowc_impl.class ));
   }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( nGotPars == 0 )
         {
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Docu_Nro", GXutil.ltrim( GXutil.str( AV7Docu_Nro, 4, 0)));
               setjustcreated();
               componentprepare(new Object[] {sCompPrefix,sSFPrefix,new Short(AV7Docu_Nro)});
               componentstart();
            ...
            else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrgrid_refresh( subGrid_Rows, AV7Docu_Nro, AV12Update, AV13Delete, A38Tpmo_Codigo, A33Tipo_Codigo, sPrefix) ;
   ...
   public void renderHtmlOpenForm( )
   {
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeValue( "ALM_DOCUMENTOSDOCUMENTOWC") ;
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201861414162395");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.orions2.alm_documentosdocumentowc") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7Docu_Nro,4,0)))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV7Docu_Nro", GXutil.ltrim( localUtil.ntoc( wcpOAV7Docu_Nro, (byte)(4), (byte)(0), ",", "")));
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vDOCU_NRO", GXutil.ltrim( localUtil.ntoc( AV7Docu_Nro, (byte)(4), (byte)(0), ",", "")));
   ...
   public void renderHtmlCloseForm9B2( )
   {
      sendCloseFormHiddens( ) ;
      if ( ( GXutil.len( sPrefix) != 0 ) && httpContext.isAjaxRequest( ) )
      {
         httpContext.AddJavascriptSource("alm_documentosdocumentowc.js", "?201861414162397");
      }
   ...
   {
      return "ALM_DOCUMENTOSDOCUMENTOWC" ;
   }
   ...
   public void wb9B0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.orions2.alm_documentosdocumentowc");
         }
         /* Div Control */
         ...
         StyleString = "" ;
         com.orions2.GxWebStd.gx_button_ctrl( httpContext, bttBtninsert_Internalname, "gx.evt.setGridEvt("+GXutil.str( 20, 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_ALM_DOCUMENTOSDOCUMENTOWC.htm");
      ...
      if ( wbEnd == 20 )
      {
         ...
         com.orions2.GxWebStd.gx_label_element( httpContext, edtDocu_Nro_Internalname, "Número de documento", "col-sm-3 AttributeLabel", 0, true);
         /* Single line edit */
         com.orions2.GxWebStd.gx_single_line_edit( httpContext, edtDocu_Nro_Internalname, GXutil.ltrim( localUtil.ntoc( A819Docu_Nro, (byte)(4), (byte)(0), ",", "")), ((edtDocu_Nro_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A819Docu_Nro), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A819Docu_Nro), "ZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtDocu_Nro_Jsonclick, 0, "Attribute", "", "", "", edtDocu_Nro_Visible, edtDocu_Nro_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", false, "HLP_ALM_DOCUMENTOSDOCUMENTOWC.htm");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.orions2.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start9B2( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         if ( ! httpContext.isSpaRequest( ) )
         {
            ...
            Form.getMeta().addItem("description", "ALM_DOCUMENTOSDOCUMENTOWC", (short)(0)) ;
         }
         httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV17Pgmname = "ALM_DOCUMENTOSDOCUMENTOWC" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf9B2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H009B2 */
         pr_default.execute(0, new Object[] {new Short(AV7Docu_Nro), new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_20_idx = (short)(1) ;
         sGXsfl_20_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_20_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_202( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_recordsperpage( ) ) ) ) )
         {
            A819Docu_Nro = H009B2_A819Docu_Nro[0] ;
            httpContext.ajax_rsp_assign_attri(sPrefix, false, "A819Docu_Nro", GXutil.ltrim( GXutil.str( A819Docu_Nro, 4, 0)));
            A718Tmpo_ImprimeResponsable = H009B2_A718Tmpo_ImprimeResponsable[0] ;
            n718Tmpo_ImprimeResponsable = H009B2_n718Tmpo_ImprimeResponsable[0] ;
            A717Tpmo_ImprimeDestino = H009B2_A717Tpmo_ImprimeDestino[0] ;
            n717Tpmo_ImprimeDestino = H009B2_n717Tpmo_ImprimeDestino[0] ;
            A716Tpmo_ImprimeOrigen = H009B2_A716Tpmo_ImprimeOrigen[0] ;
            n716Tpmo_ImprimeOrigen = H009B2_n716Tpmo_ImprimeOrigen[0] ;
            A706Tpmo_SolicitaCentroDestino = H009B2_A706Tpmo_SolicitaCentroDestino[0] ;
            n706Tpmo_SolicitaCentroDestino = H009B2_n706Tpmo_SolicitaCentroDestino[0] ;
            A705Tpmo_SolicitaRegionDestino = H009B2_A705Tpmo_SolicitaRegionDestino[0] ;
            n705Tpmo_SolicitaRegionDestino = H009B2_n705Tpmo_SolicitaRegionDestino[0] ;
            A680Tpmo_CuentaResponsabilidad = H009B2_A680Tpmo_CuentaResponsabilidad[0] ;
            n680Tpmo_CuentaResponsabilidad = H009B2_n680Tpmo_CuentaResponsabilidad[0] ;
            A679Tpmo_Estado = H009B2_A679Tpmo_Estado[0] ;
            n679Tpmo_Estado = H009B2_n679Tpmo_Estado[0] ;
            A641Tpmo_VidaUtil = H009B2_A641Tpmo_VidaUtil[0] ;
            n641Tpmo_VidaUtil = H009B2_n641Tpmo_VidaUtil[0] ;
            A633Tpmo_Controlado = H009B2_A633Tpmo_Controlado[0] ;
            n633Tpmo_Controlado = H009B2_n633Tpmo_Controlado[0] ;
            A595Tpmo_ConsecutivoTrans = H009B2_A595Tpmo_ConsecutivoTrans[0] ;
            n595Tpmo_ConsecutivoTrans = H009B2_n595Tpmo_ConsecutivoTrans[0] ;
            A320Tpmo_FechaModifica = H009B2_A320Tpmo_FechaModifica[0] ;
            n320Tpmo_FechaModifica = H009B2_n320Tpmo_FechaModifica[0] ;
            A319Tpmo_UsuarioModifica = H009B2_A319Tpmo_UsuarioModifica[0] ;
            n319Tpmo_UsuarioModifica = H009B2_n319Tpmo_UsuarioModifica[0] ;
            A318Tpmo_FechaCrea = H009B2_A318Tpmo_FechaCrea[0] ;
            A317Tpmo_UsuarioCrea = H009B2_A317Tpmo_UsuarioCrea[0] ;
            A441Tpmo_IngresaCurso = H009B2_A441Tpmo_IngresaCurso[0] ;
            A440Tpmo_IngresaAredante = H009B2_A440Tpmo_IngresaAredante[0] ;
            A316Tpmo_Modulo = H009B2_A316Tpmo_Modulo[0] ;
            A315Tpmo_TipoE_S = H009B2_A315Tpmo_TipoE_S[0] ;
            A314Tpmo_AlmacenDestinoDescrip = H009B2_A314Tpmo_AlmacenDestinoDescrip[0] ;
            n314Tpmo_AlmacenDestinoDescrip = H009B2_n314Tpmo_AlmacenDestinoDescrip[0] ;
            A40Tpmo_AlmacenDestinoId = H009B2_A40Tpmo_AlmacenDestinoId[0] ;
            A312Tpmo_AlmacenOrigenDescrip = H009B2_A312Tpmo_AlmacenOrigenDescrip[0] ;
            n312Tpmo_AlmacenOrigenDescrip = H009B2_n312Tpmo_AlmacenOrigenDescrip[0] ;
            A39Tpmo_AlmacenOrigenId = H009B2_A39Tpmo_AlmacenOrigenId[0] ;
            A480Tipo_Tipo = H009B2_A480Tipo_Tipo[0] ;
            A253Tipo_Descripcion = H009B2_A253Tipo_Descripcion[0] ;
            A33Tipo_Codigo = H009B2_A33Tipo_Codigo[0] ;
            A313Tpmo_Descripcion = H009B2_A313Tpmo_Descripcion[0] ;
            A38Tpmo_Codigo = H009B2_A38Tpmo_Codigo[0] ;
            A718Tmpo_ImprimeResponsable = H009B2_A718Tmpo_ImprimeResponsable[0] ;
            n718Tmpo_ImprimeResponsable = H009B2_n718Tmpo_ImprimeResponsable[0] ;
            A717Tpmo_ImprimeDestino = H009B2_A717Tpmo_ImprimeDestino[0] ;
            n717Tpmo_ImprimeDestino = H009B2_n717Tpmo_ImprimeDestino[0] ;
   ...
   {
      /* Using cursor H009B3 */
      pr_default.execute(1, new Object[] {new Short(AV7Docu_Nro)});
      GRID_nRecordCount = H009B3_AGRID_nRecordCount[0] ;
      pr_default.close(1);
   ...
   public void strup9B0( )
   {
      ...
      if ( ! GetJustCreated( ) && ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 ) )
      {
         ...
         wcpOAV7Docu_Nro = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV7Docu_Nro"), ",", ".")) ;
   ...
   public void e129B2( )
   {
      ...
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext, !bGXsfl_20_Refreshing);
      edtDocu_Nro_Visible = 0 ;
      httpContext.ajax_rsp_assign_prop(sPrefix, false, edtDocu_Nro_Internalname, "Visible", GXutil.ltrim( GXutil.str( edtDocu_Nro_Visible, 5, 0)), true);
   ...
   public void S112( )
   {
      ...
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributename( "Docu_Nro" );
      AV11TrnContextAtt.setgxTv_SdtTransactionContext_Attribute_Attributevalue( GXutil.str( AV7Docu_Nro, 4, 0) );
   ...
   {
      AV7Docu_Nro = ((Number) GXutil.testNumericType( getParm(obj,0,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Docu_Nro", GXutil.ltrim( GXutil.str( AV7Docu_Nro, 4, 0)));
   }
   ...
   public void componentbind( Object[] obj )
   {
      ...
      sCtrlAV7Docu_Nro = (String)getParm(obj,0,TypeConstants.STRING) ;
   }
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      httpContext.AddComponentObject(sPrefix, "alm_documentosdocumentowc");
      ...
      {
         AV7Docu_Nro = ((Number) GXutil.testNumericType( getParm(obj,2,TypeConstants.SHORT), TypeConstants.SHORT)).shortValue() ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Docu_Nro", GXutil.ltrim( GXutil.str( AV7Docu_Nro, 4, 0)));
      }
      wcpOAV7Docu_Nro = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"wcpOAV7Docu_Nro"), ",", ".")) ;
      if ( ! GetJustCreated( ) && ( ( AV7Docu_Nro != wcpOAV7Docu_Nro ) ) )
      {
         setjustcreated();
      }
      wcpOAV7Docu_Nro = AV7Docu_Nro ;
   }

   public void wcparametersget( )
   {
      /* Read Component Parameters. */
      sCtrlAV7Docu_Nro = httpContext.cgiGet( sPrefix+"AV7Docu_Nro_CTRL") ;
      if ( GXutil.len( sCtrlAV7Docu_Nro) > 0 )
      {
         AV7Docu_Nro = (short)(localUtil.ctol( httpContext.cgiGet( sCtrlAV7Docu_Nro), ",", ".")) ;
         httpContext.ajax_rsp_assign_attri(sPrefix, false, "AV7Docu_Nro", GXutil.ltrim( GXutil.str( AV7Docu_Nro, 4, 0)));
      }
      else
      {
         AV7Docu_Nro = (short)(localUtil.ctol( httpContext.cgiGet( sPrefix+"AV7Docu_Nro_PARM"), ",", ".")) ;
      }
   }
   ...
   {
      com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Docu_Nro_PARM", GXutil.ltrim( localUtil.ntoc( AV7Docu_Nro, (byte)(4), (byte)(0), ",", "")));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV7Docu_Nro)) > 0 )
      {
         com.orions2.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7Docu_Nro_CTRL", GXutil.rtrim( sCtrlAV7Docu_Nro));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201861414162496");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("alm_documentosdocumentowc.js", "?201861414162496");
      }
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage',nv:0},{av:'GRID_nEOF',nv:0},{av:'subGrid_Rows',nv:0},{av:'AV7Docu_Nro',fld:'vDOCU_NRO',pic:'ZZZ9',nv:0},{av:'AV12Update',fld:'vUPDATE',pic:'',nv:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV13Delete',fld:'vDELETE',pic:'',nv:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'A38Tpmo_Codigo',fld:'TPMO_CODIGO',pic:'',hsh:true,nv:''},{av:'A33Tipo_Codigo',fld:'TIPO_CODIGO',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0},{av:'sPrefix',nv:''}],oparms:[]}");
      setEventMetadata("GRID.LOAD","{handler:'e139B2',iparms:[{av:'A38Tpmo_Codigo',fld:'TPMO_CODIGO',pic:'',hsh:true,nv:''},{av:'A33Tipo_Codigo',fld:'TIPO_CODIGO',pic:'ZZZZZZZZZZZZZZZZZ9',nv:0}],oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtTpmo_Descripcion_Link',ctrl:'TPMO_DESCRIPCION',prop:'Link'},{av:'edtTipo_Descripcion_Link',ctrl:'TIPO_DESCRIPCION',prop:'Link'}]}");
      setEventMetadata("'DOINSERT'","{handler:'e119B2',iparms:[{av:'A38Tpmo_Codigo',fld:'TPMO_CODIGO',pic:'',hsh:true,nv:''}],oparms:[]}");
   ...
   public void initialize( )
   {
      ...
      AV17Pgmname = "" ;
      scmdbuf = "" ;
      H009B2_A819Docu_Nro = new short[1] ;
      H009B2_A718Tmpo_ImprimeResponsable = new String[] {""} ;
      H009B2_n718Tmpo_ImprimeResponsable = new boolean[] {false} ;
      H009B2_A717Tpmo_ImprimeDestino = new String[] {""} ;
      H009B2_n717Tpmo_ImprimeDestino = new boolean[] {false} ;
      H009B2_A716Tpmo_ImprimeOrigen = new String[] {""} ;
      H009B2_n716Tpmo_ImprimeOrigen = new boolean[] {false} ;
      H009B2_A706Tpmo_SolicitaCentroDestino = new String[] {""} ;
      H009B2_n706Tpmo_SolicitaCentroDestino = new boolean[] {false} ;
      H009B2_A705Tpmo_SolicitaRegionDestino = new String[] {""} ;
      H009B2_n705Tpmo_SolicitaRegionDestino = new boolean[] {false} ;
      H009B2_A680Tpmo_CuentaResponsabilidad = new String[] {""} ;
      H009B2_n680Tpmo_CuentaResponsabilidad = new boolean[] {false} ;
      H009B2_A679Tpmo_Estado = new String[] {""} ;
      H009B2_n679Tpmo_Estado = new boolean[] {false} ;
      H009B2_A641Tpmo_VidaUtil = new String[] {""} ;
      H009B2_n641Tpmo_VidaUtil = new boolean[] {false} ;
      H009B2_A633Tpmo_Controlado = new String[] {""} ;
      H009B2_n633Tpmo_Controlado = new boolean[] {false} ;
      H009B2_A595Tpmo_ConsecutivoTrans = new long[1] ;
      H009B2_n595Tpmo_ConsecutivoTrans = new boolean[] {false} ;
      H009B2_A320Tpmo_FechaModifica = new java.util.Date[] {GXutil.nullDate()} ;
      H009B2_n320Tpmo_FechaModifica = new boolean[] {false} ;
      H009B2_A319Tpmo_UsuarioModifica = new String[] {""} ;
      H009B2_n319Tpmo_UsuarioModifica = new boolean[] {false} ;
      H009B2_A318Tpmo_FechaCrea = new java.util.Date[] {GXutil.nullDate()} ;
      H009B2_A317Tpmo_UsuarioCrea = new String[] {""} ;
      H009B2_A441Tpmo_IngresaCurso = new String[] {""} ;
      H009B2_A440Tpmo_IngresaAredante = new String[] {""} ;
      H009B2_A316Tpmo_Modulo = new String[] {""} ;
      H009B2_A315Tpmo_TipoE_S = new String[] {""} ;
      H009B2_A314Tpmo_AlmacenDestinoDescrip = new String[] {""} ;
      H009B2_n314Tpmo_AlmacenDestinoDescrip = new boolean[] {false} ;
      H009B2_A40Tpmo_AlmacenDestinoId = new long[1] ;
      H009B2_A312Tpmo_AlmacenOrigenDescrip = new String[] {""} ;
      H009B2_n312Tpmo_AlmacenOrigenDescrip = new boolean[] {false} ;
      H009B2_A39Tpmo_AlmacenOrigenId = new long[1] ;
      H009B2_A480Tipo_Tipo = new String[] {""} ;
      H009B2_A253Tipo_Descripcion = new String[] {""} ;
      H009B2_A33Tipo_Codigo = new long[1] ;
      H009B2_A313Tpmo_Descripcion = new String[] {""} ;
      H009B2_A38Tpmo_Codigo = new String[] {""} ;
      H009B3_AGRID_nRecordCount = new long[1] ;
      ...
      ROClassString = "" ;
      sImgUrl = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.orions2.alm_documentosdocumentowc__default(),
         new Object[] {
             new Object[] {
            H009B2_A819Docu_Nro, H009B2_A718Tmpo_ImprimeResponsable, H009B2_n718Tmpo_ImprimeResponsable, H009B2_A717Tpmo_ImprimeDestino, H009B2_n717Tpmo_ImprimeDestino, H009B2_A716Tpmo_ImprimeOrigen, H009B2_n716Tpmo_ImprimeOrigen, H009B2_A706Tpmo_SolicitaCentroDestino, H009B2_n706Tpmo_SolicitaCentroDestino, H009B2_A705Tpmo_SolicitaRegionDestino,
            H009B2_n705Tpmo_SolicitaRegionDestino, H009B2_A680Tpmo_CuentaResponsabilidad, H009B2_n680Tpmo_CuentaResponsabilidad, H009B2_A679Tpmo_Estado, H009B2_n679Tpmo_Estado, H009B2_A641Tpmo_VidaUtil, H009B2_n641Tpmo_VidaUtil, H009B2_A633Tpmo_Controlado, H009B2_n633Tpmo_Controlado, H009B2_A595Tpmo_ConsecutivoTrans,
            H009B2_n595Tpmo_ConsecutivoTrans, H009B2_A320Tpmo_FechaModifica, H009B2_n320Tpmo_FechaModifica, H009B2_A319Tpmo_UsuarioModifica, H009B2_n319Tpmo_UsuarioModifica, H009B2_A318Tpmo_FechaCrea, H009B2_A317Tpmo_UsuarioCrea, H009B2_A441Tpmo_IngresaCurso, H009B2_A440Tpmo_IngresaAredante, H009B2_A316Tpmo_Modulo,
            H009B2_A315Tpmo_TipoE_S, H009B2_A314Tpmo_AlmacenDestinoDescrip, H009B2_n314Tpmo_AlmacenDestinoDescrip, H009B2_A40Tpmo_AlmacenDestinoId, H009B2_A312Tpmo_AlmacenOrigenDescrip, H009B2_n312Tpmo_AlmacenOrigenDescrip, H009B2_A39Tpmo_AlmacenOrigenId, H009B2_A480Tipo_Tipo, H009B2_A253Tipo_Descripcion, H009B2_A33Tipo_Codigo,
            H009B2_A313Tpmo_Descripcion, H009B2_A38Tpmo_Codigo
            }
            , new Object[] {
            H009B3_AGRID_nRecordCount
            }
         }
      );
      AV17Pgmname = "ALM_DOCUMENTOSDOCUMENTOWC" ;
   ...
   private int edtDocu_Nro_Visible ;
   ...
   private String sCtrlAV7Docu_Nro ;
   ...
   private short[] H009B2_A819Docu_Nro ;
   private String[] H009B2_A718Tmpo_ImprimeResponsable ;
   private boolean[] H009B2_n718Tmpo_ImprimeResponsable ;
   private String[] H009B2_A717Tpmo_ImprimeDestino ;
   private boolean[] H009B2_n717Tpmo_ImprimeDestino ;
   private String[] H009B2_A716Tpmo_ImprimeOrigen ;
   private boolean[] H009B2_n716Tpmo_ImprimeOrigen ;
   private String[] H009B2_A706Tpmo_SolicitaCentroDestino ;
   private boolean[] H009B2_n706Tpmo_SolicitaCentroDestino ;
   private String[] H009B2_A705Tpmo_SolicitaRegionDestino ;
   private boolean[] H009B2_n705Tpmo_SolicitaRegionDestino ;
   private String[] H009B2_A680Tpmo_CuentaResponsabilidad ;
   private boolean[] H009B2_n680Tpmo_CuentaResponsabilidad ;
   private String[] H009B2_A679Tpmo_Estado ;
   private boolean[] H009B2_n679Tpmo_Estado ;
   private String[] H009B2_A641Tpmo_VidaUtil ;
   private boolean[] H009B2_n641Tpmo_VidaUtil ;
   private String[] H009B2_A633Tpmo_Controlado ;
   private boolean[] H009B2_n633Tpmo_Controlado ;
   private long[] H009B2_A595Tpmo_ConsecutivoTrans ;
   private boolean[] H009B2_n595Tpmo_ConsecutivoTrans ;
   private java.util.Date[] H009B2_A320Tpmo_FechaModifica ;
   private boolean[] H009B2_n320Tpmo_FechaModifica ;
   private String[] H009B2_A319Tpmo_UsuarioModifica ;
   private boolean[] H009B2_n319Tpmo_UsuarioModifica ;
   private java.util.Date[] H009B2_A318Tpmo_FechaCrea ;
   private String[] H009B2_A317Tpmo_UsuarioCrea ;
   private String[] H009B2_A441Tpmo_IngresaCurso ;
   private String[] H009B2_A440Tpmo_IngresaAredante ;
   private String[] H009B2_A316Tpmo_Modulo ;
   private String[] H009B2_A315Tpmo_TipoE_S ;
   private String[] H009B2_A314Tpmo_AlmacenDestinoDescrip ;
   private boolean[] H009B2_n314Tpmo_AlmacenDestinoDescrip ;
   private long[] H009B2_A40Tpmo_AlmacenDestinoId ;
   private String[] H009B2_A312Tpmo_AlmacenOrigenDescrip ;
   private boolean[] H009B2_n312Tpmo_AlmacenOrigenDescrip ;
   private long[] H009B2_A39Tpmo_AlmacenOrigenId ;
   private String[] H009B2_A480Tipo_Tipo ;
   private String[] H009B2_A253Tipo_Descripcion ;
   private long[] H009B2_A33Tipo_Codigo ;
   private String[] H009B2_A313Tpmo_Descripcion ;
   private String[] H009B2_A38Tpmo_Codigo ;
   private long[] H009B3_AGRID_nRecordCount ;
...
final  class alm_documentosdocumentowc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H009B2", "SELECT T1.Docu_Nro, T2.Tmpo_ImprimeResponsable, T2.Tpmo_ImprimeDestino, T2.Tpmo_ImprimeOrigen, T2.Tpmo_SolicitaCentroDestino, T2.Tpmo_SolicitaRegionDestino, T2.Tpmo_CuentaResponsabilidad, T2.Tpmo_Estado, T2.Tpmo_VidaUtil, T2.Tpmo_Controlado, T2.Tpmo_ConsecutivoTrans, T2.Tpmo_FechaModifica, T2.Tpmo_UsuarioModifica, T2.Tpmo_FechaCrea, T2.Tpmo_UsuarioCrea, T2.Tpmo_IngresaCurso, T2.Tpmo_IngresaAredante, T2.Tpmo_Modulo, T2.Tpmo_TipoE_S, T3.Tpal_Descripcion AS Tpmo_AlmacenDestinoDescrip, T2.Tpmo_AlmacenDestinoId AS Tpmo_AlmacenDestinoId, T4.Tpal_Descripcion AS Tpmo_AlmacenOrigenDescrip, T2.Tpmo_AlmacenOrigenId AS Tpmo_AlmacenOrigenId, T5.Tipo_Tipo, T5.Tipo_Descripcion, T2.Tipo_Codigo, T2.Tpmo_Descripcion, T1.Tpmo_Codigo FROM ((((ALM_TIPO_MOVIMIENTO_DOCUMENTO T1 INNER JOIN ALM_TIPO_MOVIMIENTO T2 ON T2.Tpmo_Codigo = T1.Tpmo_Codigo) INNER JOIN ALM_TIPO_ALMACEN T3 ON T3.Tpal_Id = T2.Tpmo_AlmacenDestinoId) INNER JOIN ALM_TIPO_ALMACEN T4 ON T4.Tpal_Id = T2.Tpmo_AlmacenOrigenId) INNER JOIN ALM_TIPO_ELEMENTO T5 ON T5.Tipo_Codigo = T2.Tipo_Codigo) WHERE T1.Docu_Nro = ? ORDER BY T1.Docu_Nro  OFFSET ? ROWS FETCH NEXT (CASE WHEN ? > 0 THEN ? ELSE 1e9 END) ROWS ONLY",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H009B3", "SELECT COUNT(*) FROM ((((ALM_TIPO_MOVIMIENTO_DOCUMENTO T1 INNER JOIN ALM_TIPO_MOVIMIENTO T2 ON T2.Tpmo_Codigo = T1.Tpmo_Codigo) INNER JOIN ALM_TIPO_ALMACEN T5 ON T5.Tpal_Id = T2.Tpmo_AlmacenDestinoId) INNER JOIN ALM_TIPO_ALMACEN T4 ON T4.Tpal_Id = T2.Tpmo_AlmacenOrigenId) INNER JOIN ALM_TIPO_ELEMENTO T3 ON T3.Tipo_Codigo = T2.Tipo_Codigo) WHERE T1.Docu_Nro = ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
